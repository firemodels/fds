...
CALL EX2G3D(S11,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(S22,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(S33,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(SHAT11,S11,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT22,S22,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT33,S33,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT12,S12,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT13,S13,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT23,S23,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(BETAHAT11,BETA11,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT22,BETA22,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT33,BETA33,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT12,BETA12,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT13,BETA13,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT23,BETA23,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)

! test filter the density

RHOPHAT => WORK7
CALL TEST_FILTER(RHOPHAT,RHOP,N_LO,N_HI,ARRAY_LO,ARRAY_HI,RHOMIN,RHOMAX)
...
! extrapoloate to ghost

CALL EX2G3D(ML,ARRAY_LO,ARRAY_HI,0._EB,1.E10_EB)
CALL EX2G3D(MM,ARRAY_LO,ARRAY_HI,0._EB,1.E10_EB)

! do some smoothing

CALL TEST_FILTER(MLHAT,ML,N_LO,N_HI,ARRAY_LO,ARRAY_HI,0._EB,1.E10_EB)
CALL TEST_FILTER(MMHAT,MM,N_LO,N_HI,ARRAY_LO,ARRAY_HI,0._EB,1.E10_EB)
...
CALL EX2G3D(RUU,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL EX2G3D(RVV,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL EX2G3D(RWW,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL EX2G3D(RUV,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(RUW,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(RVW,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(RUU_HAT,RUU,N_LO,N_HI,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL TEST_FILTER(RVV_HAT,RVV,N_LO,N_HI,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL TEST_FILTER(RWW_HAT,RWW,N_LO,N_HI,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL TEST_FILTER(RUV_HAT,RUV,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RUW_HAT,RUW,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RVW_HAT,RVW,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL EX2G3D(RU,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(RV,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(RW,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(RU_HAT,RU,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RV_HAT,RV,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RW_HAT,RW,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
SUBROUTINE TEST_FILTER(PHIBAR,PHI,N_LO,N_HI,ARRAY_LO,ARRAY_HI,PHI_MIN,PHI_MAX)
IMPLICIT NONE
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: PHI_TMP
INTEGER I,J,K,II,JJ,KK
REAL(EB), PARAMETER :: WX(-1:1) = (/0.25_EB,0.5_EB,0.25_EB/)   ! trapezoid rule
REAL(EB), PARAMETER :: WY(-1:1) = (/0.25_EB,0.5_EB,0.25_EB/)
REAL(EB), PARAMETER :: WZ(-1:1) = (/0.25_EB,0.5_EB,0.25_EB/)

FILTER_SELECT: IF (.TRUE.) THEN
   ...
   DO K = N_LO(3),N_HI(3)
      DO J = N_LO(2),N_HI(2)
         DO I = N_LO(1),N_HI(1)
            ...
            FILTER_LOOP: DO KK=-1,1
               DO JJ=-1,1
                  DO II=-1,1
                     PHI_TMP(I,J,K) = PHI_TMP(I,J,K) + WX(II)*WY(JJ)*WZ(KK)*PHI(I+II,J+JJ,K+KK)
                  ENDDO
               ENDDO
            ENDDO FILTER_LOOP
...
SUBROUTINE EX2G3D(A,ARRAY_LO,ARRAY_HI,A_MIN,A_MAX)

! Second order extrapolation of 3D array to ghost cells

INTEGER, INTENT(IN) :: ARRAY_LO(3),ARRAY_HI(3)
REAL(EB), INTENT(IN) :: A_MIN,A_MAX
REAL(EB), INTENT(INOUT) :: A(ARRAY_LO(1):ARRAY_HI(1),ARRAY_LO(2):ARRAY_HI(2),ARRAY_LO(3):ARRAY_HI(3))
...
CALL TEST_FILTER(UP_HAT,UP,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(VP_HAT,VP,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(WP_HAT,WP,N_LO,N_HI,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
