...
CASE(.TRUE.) PREDICTOR_STEP
   ...
   !       MASS_FINITE_DIFFERENCES.
      ...
      IF (ENTHALPY_TRANSPORT) THEN
         !$OMP DO COLLAPSE(3) SCHEDULE(STATIC) PRIVATE(K,J,I,ZZ_GET,H_S)
         DO K=1,KBAR
            DO J=1,JBAR
               DO I=1,IBAR   
      ...
      DO K=1,KBAR
         DO J=1,JBAR
            DO I=1,IBAR   
               ...
               CALL GET_SENSIBLE_ENTHALPY(ZZ_GET,H_S,TMP(I,J,K))
               RHO_H_S_OVER_PBAR(I,J,K) = 0.5_EB*( RHOS(I,J,K)*H_S/PBAR_S(K,PRESSURE_ZONE(I,J,K)) + RHO_H_S_OVER_PBAR(I,J,K) )
            ENDDO
         ENDDO
      ENDDO
      !$OMP END DO
