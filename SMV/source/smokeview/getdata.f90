...
VOLUME = REAL(GET_TETRABOX_VOLUME(BOX_BOUNDS_EB,V0_EB,V1_EB,V2_EB,V3_EB,DUMMY),FB)
...
DO I = IBOX_MIN, IBOX_MAX
   ...
   VOL = VOL + GET_TETRABOX_VOLUME(BOX_BOUNDS_IJK_EB,V0_EB,V1_EB,V2_EB,V3_EB,DUMMY)
END DO
END DO
END DO
