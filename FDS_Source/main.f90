...
INTEGER :: COUNTS_LEAK(0:N_MPI_PROCESSES-1),DISPLS_LEAK(0:N_MPI_PROCESSES-1)
INTEGER :: COUNTS_LEAK2(0:N_MPI_PROCESSES-1),DISPLS_LEAK2(0:N_MPI_PROCESSES-1)
REAL(EB) :: TNOW
...
CALL MPI_GATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS_HVAC(MYID),MPI_INTEGER, &
                 NODE_ZONE,COUNTS_HVAC,DISPLS_HVAC,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
IF (N_TRACKED_SPECIES>0) THEN
