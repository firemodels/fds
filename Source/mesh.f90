...
TYPE MESH_TYPE
   ...
   INTEGER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_PROPERTY_DIM
...
INTEGER, POINTER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_PROPERTY_DIM
