...
EXTERNAL_WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS
   ...
   SELECT CASE(IOR)
      ...
      CASE( 1)
         ...
         UU(0,JJ,KK)  = UU_AVG
         IF (EWC%ONE_TO_ONE) OM_UU(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = UU_AVG
      ...
      CASE(-1)
         ...
         IF (EWC%ONE_TO_ONE) OM_UU(EWC%IIO_MIN-1:EWC%IIO_MAX-1,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = UU_AVG
      ...
      CASE( 2)
         ...
         VV(II,0,KK)  = VV_AVG
         IF (EWC%ONE_TO_ONE) OM_VV(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = VV_AVG
      ...
      CASE(-2)
         ...
         IF (EWC%ONE_TO_ONE) OM_VV(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN-1:EWC%JJO_MAX-1,EWC%KKO_MIN:EWC%KKO_MAX) = VV_AVG
      ...
      CASE( 3)
         ...
         WW(II,JJ,0)  = WW_AVG
         IF (EWC%ONE_TO_ONE) OM_WW(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = WW_AVG
      ...
      CASE(-3)
         ...
         IF (EWC%ONE_TO_ONE) OM_WW(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN-1:EWC%KKO_MAX-1) = WW_AVG
