...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=3.2in]{FIGURES/Beyler_Hood/Beyler_Hood_O_2} &
\includegraphics[height=3.2in]{FIGURES/Beyler_Hood/Beyler_Hood_CO_2} \\
\includegraphics[height=3.2in]{FIGURES/Beyler_Hood/Beyler_Hood_H_2O} &
