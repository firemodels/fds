...
INTEGER :: IOS,IZERO,N_HVAC_READ,NS,N,ND,NN,I_AIRCOIL=0,I_DUCT=0,I_DUCTNODE=0,I_FAN=0 ,I_FILTER=0,N_CELLS,DUCT_INTERP_TYPE
   ...
   SELECT CASE (TYPE_ID)
      CASE('DUCT')
         ...
         IF (HVAC_MASS_TRANSPORT) THEN
            ...
            ENDIF
            DU%DUCT_INTERP_TYPE = DUCT_INTERP_TYPE
         ENDIF
      CASE('NODE')
