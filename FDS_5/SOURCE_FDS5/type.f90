...
IMPLICIT NONE
CHARACTER(255), PARAMETER ::typeid='$Id: type.f90,v 1.41 2007/04/30 19:04:39 mcgratta Exp $'

TYPE PARTICLE_CLASS_TYPE
   REAL(EB) :: DENSITY,H_V,C_P,TMP_V,TMP_MELT,FTPR,MASS_PER_VOLUME, &
               HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               LIFETIME,DIAMETER,GAMMA,TMP_INITIAL,SIGMA,X1,X2,Y1,Y2,Z1,Z2,DT_INSERT,GAMMA_VAP,&
...
TYPE REACTION_TYPE
   ...
   REAL(EB) :: EPUMO2,HEAT_OF_COMBUSTION,BOF,E, &
      ...
      CRIT_FLAME_TMP,Y_O2_LL,O2_F_RATIO=0,Z_F=0,Z_F_CONS=0
...
TYPE MATERIAL_TYPE
   ...
   INTEGER :: N_REACTIONS
   REAL(EB), DIMENSION(1:MAX_REACTIONS) :: NU_RESIDUE,NU_FUEL,NU_WATER,A,E,H_V,N_S,N_T,TMP_REF,TMP_IGN
...
TYPE SURFACE_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:) :: RDX,RDXN,X_S,DX_WGT
