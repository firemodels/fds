...
The examples described in Part~\ref{part:samples} should help
...
Here is an example how fans can be specified. The actual case ({\bf fan\_test})
is discussed in Section~\ref{fan_test}. In it, two simple
...
Several other examples of solid phase reactions can be found in various examples. See Sections~\ref{thermoplastic} and \ref{charring_solid}.
...
Examples of how to use the {\ct BURN\_AWAY} feature are given in Section~\ref{box_burn_away} and Section~\ref{couch}.
...
Examples of nozzles can be found in Chapter~\ref{chapter:sprays}.
...
\subsection{Additional Solid Outputs}
\label{info:material_components} \index{Output!Material Components}
...
Thermodynamics and the equation of state.  The figures below show the results of this calculation.  As is seen density matches exactly showing
