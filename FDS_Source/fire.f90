      ...
      RICH_EX_LOOP: DO RICH_ITER =1,RICH_ITER_MAX
         ...
         ODE_LOOP1: DO NS = 1, SUB_DT1
            ...
            REACTION_LOOP1_2: DO NR = 1, N_REACTIONS
               ...
               IF (ANY( ZZ_CHECK < 0._EB)) THEN
                  DO NSS=0,N_TRACKED_SPECIES
                     IF (ZZ_CHECK(NSS) < 0._EB < 0._EB .AND. ABS(DZZDT(NSS))>TWO_EPSILON_EB) THEN
...
IF (RN%FAST_CHEMISTRY) THEN
   DO NRR = 1,N_REACTIONS
      ...
      IF (.NOT. RNN%FAST_CHEMISTRY) THEN
         EXTINCT(NRR) = .TRUE.      
      ELSE
         IF (ITER==0 .AND. SUPPRESSION .AND. RN%HEAT_OF_COMBUSTION > 0._EB) THEN
            IF (EXTINCT_N(I,J,K,ZZ_MIXED_IN,TMP_0,NR)) THEN
               EXTINCT(NRR) = .TRUE.
            ELSE
               EXTINCT(NRR) = .FALSE.   
            ENDIF
...
LOGICAL FUNCTION EXTINCT_1(I,J,K,ZZ_IN,TMP_0,NR)
...
LOGICAL FUNCTION EXTINCT_2(I,J,K,ZZ_MIXED_IN,TMP_0,NR)
USE PHYSICAL_FUNCTIONS,ONLY:GET_AVERAGE_SPECIFIC_HEAT
