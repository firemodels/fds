...
correlation predicts that the change in HGL height, $z$~(\si{m}), is given by
\be
...
\label{eq:ASET_2}
\ee
The volumetric expansion rate, $\dot V_{exp}$~(\si{m^3/s}), is given by
\be
...
The volumetric entrainment rate, $\dot V_{ent}$~(\si{m^3/s}), is given by
\be
