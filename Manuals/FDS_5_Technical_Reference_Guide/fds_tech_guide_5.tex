...
\Huge \flushright{Fire Dynamics Simulator (Version 5) \\ Technical Reference Guide \\ (Draft: July 26, 2007)}
...
and the local gas temperature, $T_g$.
...
\begin{eqnarray}
\frac{dm_l}{dt}               & = & - A_l \; h_m \, \rho \, (Y_l - Y_g) \\ [0.1in]
m_l \; c_l \; \frac{dT_l}{dt} & = &   A_l \, h   \, (T_g-T_l) + \frac{dm_l}{dt} \; h_v  \end{eqnarray}
Here, $m_l$ is the mass of the liquid droplet (or that fraction of the surface film associated with the formerly airborne droplet), $A_l$ is the surface area of the liquid droplet (or that fraction of the
film exposed to the gas), $h_m$ is the mass transfer coefficient to be discussed below,
$\rho$ is the gas density, $c_l$ is the liquid specific heat, $h$ is the heat transfer coefficient, and $h_v$ is the latent heat of vaporization.
The vapor mass fraction of the gas, $Y_g$, is obtained from the gas phase mass conservation equations, and the liquid equilibrium vapor mass fraction
...
\be X_l = \exp \left[ \frac{h_v \, W_l}{\cal R}
      ...
      Y_l = \frac{X_l}{X_l \, (1-W_a/W_l) + W_a/W_l}  \ee
