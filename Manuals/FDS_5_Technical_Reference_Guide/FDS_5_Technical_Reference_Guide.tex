...
of a fire. Orloff and De Ris~\cite{Orloff:19th_Symposium} suggest a value of 1200~kW/m$^3$, and FDS uses by default a value of 2000~kW/m$^3$ as an upper bound.
\be \dq_{\max,2}''' = \frac{ \overline{\dq_{\max}'''} - (1-\dt/\tau') \; \overline{\dq'''} }{\dt/\tau'} \quad ; \quad  \overline{\dq_{\max}'''}=2000 \; \; \hbox{kW/m}^3   \ee
