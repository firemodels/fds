...
IF (DYNSMAG) THEN
   ...
   ! 1D working arrays
   ALLOCATE(M%TURB_WORK11(MAX(NX,NY,NZ)),STAT=IZERO)
   CALL ChkMemErr('INIT_TURB_ARRAYS','TURB_WORK11',IZERO)
   M%TURB_WORK11 = 0._EB
   ALLOCATE(M%TURB_WORK12(MAX(NX,NY,NZ)),STAT=IZERO)
   CALL ChkMemErr('INIT_TURB_ARRAYS','TURB_WORK12',IZERO)
   M%TURB_WORK12 = 0._EB

   !NEW ARRAYS to prevent ThreadChecker warning
...
REAL(EB), DIMENSION(1:IBAR,1:JBAR,1:KBAR) :: RHOP !Because of ThreadChecker warning

REAL(EB), POINTER, DIMENSION(:,:,:) :: UU,VV,WW,UP,VP,WP,RHOPHAT
...
IF (PREDICTOR) THEN
   ...
   VV=>V
   WW=>W
   RHOP = RHO(1:IBAR,1:JBAR,1:KBAR) !Because of ThreadChecker warning
ELSE
   UU=>US
   VV=>VS
   WW=>WS
   RHOP = RHOS(1:IBAR,1:JBAR,1:KBAR) !Because of ThreadChecker warning
ENDIF
...
!S11 => WORK1(1:IBAR,1:JBAR,1:KBAR)
!S22 => WORK2(1:IBAR,1:JBAR,1:KBAR)
!S33 => WORK3(1:IBAR,1:JBAR,1:KBAR)
!S12 => WORK4(1:IBAR,1:JBAR,1:KBAR)
!S13 => WORK5(1:IBAR,1:JBAR,1:KBAR)
!S23 => WORK6(1:IBAR,1:JBAR,1:KBAR)
!SS  => WORK7(1:IBAR,1:JBAR,1:KBAR)

! Use new TURB_ARRAYS to prevent ThreadChecker warning (original code above)
...
!BETA11 => WORK1(1:IBAR,1:JBAR,1:KBAR)
!BETA22 => WORK2(1:IBAR,1:JBAR,1:KBAR)
!BETA33 => WORK3(1:IBAR,1:JBAR,1:KBAR)
!BETA12 => WORK4(1:IBAR,1:JBAR,1:KBAR)
!BETA13 => WORK5(1:IBAR,1:JBAR,1:KBAR)
!BETA23 => WORK6(1:IBAR,1:JBAR,1:KBAR)

! Use new TURB_ARRAYS to prevent ThreadChecker warning
...
!BETAHAT11 => WORK1(1:IBAR,1:JBAR,1:KBAR)
!BETAHAT22 => WORK2(1:IBAR,1:JBAR,1:KBAR)
!BETAHAT33 => WORK3(1:IBAR,1:JBAR,1:KBAR)
!BETAHAT12 => WORK4(1:IBAR,1:JBAR,1:KBAR)
!BETAHAT13 => WORK5(1:IBAR,1:JBAR,1:KBAR)
!BETAHAT23 => WORK6(1:IBAR,1:JBAR,1:KBAR)

! Use new TURB_ARRAYS to prevent ThreadChecker warning

BETAHAT11 => TURB_WORK13
BETAHAT22 => TURB_WORK14
BETAHAT33 => TURB_WORK15
BETAHAT12 => TURB_WORK16
BETAHAT13 => TURB_WORK17
BETAHAT23 => TURB_WORK18
...
!RHOPHAT => WORK7(1:IBAR,1:JBAR,1:KBAR)
...
!M11 => WORK1(1:IBAR,1:JBAR,1:KBAR)
!M22 => WORK2(1:IBAR,1:JBAR,1:KBAR)
!M33 => WORK3(1:IBAR,1:JBAR,1:KBAR)
!M12 => WORK4(1:IBAR,1:JBAR,1:KBAR)
!M13 => WORK5(1:IBAR,1:JBAR,1:KBAR)
!M23 => WORK6(1:IBAR,1:JBAR,1:KBAR)
...
ENDIF
RHOPHAT => M%WORK7(1:IBAR,1:JBAR,1:KBAR)
...
REAL(EB), INTENT(OUT) :: PHIBAR(N_LO(1):N_HI(1),N_LO(2):N_HI(2),N_LO(3):N_HI(3))
...
UP_HAT => WORK4(1:IBAR,1:JBAR,1:KBAR)
VP_HAT => WORK5(1:IBAR,1:JBAR,1:KBAR)
WP_HAT => WORK6(1:IBAR,1:JBAR,1:KBAR)

N_LO = 1
N_HI = (/IBAR,JBAR,KBAR/)

CALL TEST_FILTER(UP_HAT,UP,N_LO,N_HI)
CALL TEST_FILTER(VP_HAT,VP,N_LO,N_HI)
CALL TEST_FILTER(WP_HAT,WP,N_LO,N_HI)
