...
does not compute the maximum over the entire computational domain, just that particular mesh. Other {\ct STATISTICS} are discussed below.
Note that some are appropriate for gas phase output quantities, some for solid phase, and some for both.
