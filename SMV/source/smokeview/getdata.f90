...
SUBROUTINE GETVERTS2(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,FACES,FACE_ID,WHICH_POLY,NFACES2,NPOLYS,VOLUME,BOX_STATE,AREAS_FB,CENTROID_FB)
...
REAL(FB), INTENT(OUT) :: AREAS_FB(6),CENTROID_FB(3)
...
DO K = 0, KBOX_MAX
   ...
   DO J = 0, JBOX_MAX
      ...
      DO I = 0, IBOX_MAX
         ...
         VOL_BOX = VOL_BOX + GET_TETRABOX_VOLUME(BOX_BOUNDS_IJK_EB,V0_EB,V1_EB,V2_EB,V3_EB,AREAS_EB,CENTROID_EB)
      END DO
   END DO
END DO
