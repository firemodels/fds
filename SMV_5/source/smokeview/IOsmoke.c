...
// read in data
  ...
  if(smoke3di->use_lighting_file==1){
    ...
    for(i=0;i<smoke3di->n_times_full;i++){
      ...
      if(i%smoke3dframestep==0)printf("lighting time=%.2f",time);
...
void initcullplane(int cullflag, int dir){
  int ii;
  ...
  switch (dir){
    ...
    case -1:
      ...
      qsort((cullplanedata *)sort_cullplanexinfo,(size_t)ncullplanexinfo,
    ...
    case -2:
      ...
      qsort((cullplanedata *)sort_cullplaneyinfo,(size_t)ncullplaneyinfo,
        sizeof(cullplanedata *),cullplane_compare);
      break;
    case 3:
    case -3:
      ...
      qsort((cullplanedata *)sort_cullplanezinfo,(size_t)ncullplanezinfo,
        sizeof(cullplanedata *),cullplane_compare);
      break;
  }
...
void initcull(int cullflag){
  ...
  FREEMEMORY(sort_cullplanexinfo);
  FREEMEMORY(sort_cullplaneyinfo);
  FREEMEMORY(sort_cullplanezinfo);
  ncullplanexinfo=0;
  ncullplaneyinfo=0;
  ncullplanezinfo=0;
