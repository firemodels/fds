...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=27,N_PARTICLE_SCALAR_INTEGERS=8,N_PARTICLE_SCALAR_LOGICALS=4
...
TYPE WALL_TYPE
   ...
   REAL(EB) :: VEG_HEIGHT
   REAL(EB) :: AW=0._EB,DUWDT=0._EB,EW=0._EB,KW=1._EB, &
               RAW=0._EB,RDN=1._EB,RHO_F=1._EB, &
               U_TAU=0._EB,UVW_GHOST=0._EB,UW0=0._EB,XW=0._EB,YW=0._EB,ZW=0._EB
   ...
   INTEGER :: SURF_INDEX=0,NOM=0,NOM_IB(6)=0
END TYPE WALL_TYPE
