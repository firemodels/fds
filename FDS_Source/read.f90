...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                CFL_MAX,CFL_MIN,CFL_VELOCITY_NORM,CHECK_GR,CHECK_HT,CDF_CUTOFF,CHECK_VN,CLIP_MASS_FRACTION,&
                CONSTANT_SPECIFIC_HEAT,C_SMAGORINSKY,C_DEARDORFF,C_VREMAN,C_G,C_FORCED,&
                C_FORCED_CYLINDER,C_FORCED_SPHERE,C_HORIZONTAL,C_VERTICAL,DNS,ENTHALPY_TRANSPORT,&
                ...
                IMMERSED_BOUNDARY_METHOD,LAPSE_RATE,&
                ...
                RESTART,RESTART_CHID,SC,SHARED_FILE_SYSTEM,SMOKE_ALBEDO,SOLID_PHASE_ONLY,&
...
LOGICAL :: A_TMP,L_TMP,CHECK_ATOM_BALANCE,EDCM,REVERSIBLE
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,BETA_EDC,C,CHECK_ATOM_BALANCE,CO_PRODUCTION,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                E,EDCM,EPUMO2,EQUATION,FIXED_MIX_TIME,FORMULA,FUEL,FWD_ID,FYI,H,HEAT_OF_COMBUSTION,HRRPUA_SHEET,HRRPUV_AVERAGE,&
                HUMIDITY,ID,IDEAL,N,NU,N_S,N_T,O,ODE_SOLVER,REAC_ATOM_ERROR,REAC_MASS_ERROR,REVERSIBLE,SMIX_ID,&
...
INTEGER :: SAMPLING_FACTOR,N,NN,ILPC,IPC,RGB(3),I_DUMMY(6)
...
NAMELIST /PART/ AGE,BREAKUP,BREAKUP_CHILD_DIAMETER,BREAKUP_CHILD_GAMMA_D,BREAKUP_CHILD_SIGMA_D,CHECK_DISTRIBUTION,&
                ...
                ORIENTATION,PROP_ID,QUANTITIES,RADIATIVE_PROPERTY_TABLE,REAL_REFRACTIVE_INDEX,RGB,&
...
NAMELIST /INIT/ CTRL_ID,DENSITY,DEVC_ID,DT_INSERT,DX,DY,DZ,HRRPUV,ID,MASS_FRACTION,MASS_PER_TIME,MASS_PER_VOLUME,MULT_ID,&
                N_PARTICLES,NUMBER_INITIAL_PARTICLES,PART_ID,SHAPE,SPEC_ID,TEMPERATURE,UVW,XB,XYZ
...
NAMELIST /DEVC/ BYPASS_FLOWRATE,CONVERSION_FACTOR,CTRL_ID,DELAY,DEPTH,DEVC_ID,DRY,DUCT_ID,EVACUATION,FLOWRATE,FYI,&
                HIDE_COORDINATES,ID,INITIAL_STATE,INIT_ID,IOR,LATCH,MATL_ID,NODE_ID,ORIENTATION,OUTPUT,PART_ID,PIPE_INDEX,POINTS,&
                PROP_ID,QUANTITY,&
