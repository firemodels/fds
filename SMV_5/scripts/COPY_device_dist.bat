...
%svn_drive%
echo copying %ProgramFiles%\FDS\FDS5\bin\objects.svo to %svn_root%\SMV_5\for_bundle\objects.svo
pause
copy "%ProgramFiles%\FDS\FDS5\bin\objects.svo" %svn_root%\SMV_5\for_bundle\objects.svo
pause