...
SPEC_LOOP: DO N=1,N_TRACKED_SPECIES
   ...
   SPECIES_MIXTURE(N)%H_F = SS%H_L(ITMP) + (H_F_REFERENCE_TEMPERATURE-REAL(ITMP,EB))*(SS%H_L(ITMP+1)-SS%H_L(ITMP))
...
IF (SIMPLE_CHEMISTRY) THEN
   ...
   ELSEIF (N_SIMPLE_CHEMISTRY_REACTIONS==2) THEN
      IF (REACTION(1)%HOC_COMPLETE < 0._EB) THEN
      ...
      ELSE
         ...
         SMF%H_F = RN%HEAT_OF_COMBUSTION - REACTION(1)%HOC_COMPLETE
