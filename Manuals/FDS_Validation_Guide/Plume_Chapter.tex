...
\subsubsection{JIS Facade Experiments}
...
\includegraphics[height=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_exp_contours_600} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_exp_contours_750} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_exp_contours_900} \\
\includegraphics[height=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_contours_600} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_contours_750} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_contours_900} 
\end{tabular*}
\caption[TUS Facade, plume temperature, JIS A 1310 configuration]{TUS Facade, plume temperature, JIS A 1310 configuration. The upper three sets of plots display the measured temperature contours; the lower the simulated. The origin of the Height axis corresponds to the top of the 0.91~m by 0.91~m window. These contour plots are based on those shown in Fig.~8 of the paper by Sun~et~al.~\cite{Sun:FAM2024}.}
