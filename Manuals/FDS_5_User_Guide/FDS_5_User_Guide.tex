...
obstructions (an external boundary also suffices). It is possible to ``break'' pressure zones by removing obstructions between them.
\footnote{The ability to open pressure zones became available in FDS starting with version 5.3.0. Prior versions prevented it by issuing an
