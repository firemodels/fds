...
NAMELIST /SURF/ ADIABATIC,BACKING,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,&
                ...
                VEG_LSET_ROS_FLANK,VEG_LSET_ROS_HEAD,VEG_LSET_WIND_EXP,VEL,VEL_GRAD,VEL_T,VOLUME_FLUX,WIDTH,XYZ,Z0, &
...
NAMELIST /RADI/ ANGLE_INCREMENT,CH4_BANDS,KAPPA0,NMIEANG,NEW_ABSORPTION,NUMBER_RADIATION_ANGLES,PATH_LENGTH,&
