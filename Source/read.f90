...
NAMELIST /DUMP/ CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,DEVC_COLUMN_LIMIT,&
                ...
                SMV_PARALLEL_WRITE,STATUS_FILES,SUPPRESS_DIAGNOSTICS,TURB_INIT_CLOCK,VELOCITY_ERROR_FILE,VTK_BINARY,VTK_DIR,&
                WRITE_FORMAT,WRITE_XYZ,WRITE_STL
...
SELECT CASE(TRIM(SOLVER))
   ...
   CASE('UGLMAT','UGLMAT PARDISO','UGLMAT HYPRE','UGLMAT PETSC')
      PRES_METHOD = 'UGLMAT'
      ...
      IF (TRIM(SOLVER)=='UGLMAT PETSC') UGLMAT_SOLVER_LIBRARY = PETSC_FLAG

   CASE('GLMAT','GLMAT PARDISO','GLMAT HYPRE','GLMAT PETSC')
      PRES_METHOD = 'GLMAT'
      ...
      IF (TRIM(SOLVER)=='GLMAT PETSC') UGLMAT_SOLVER_LIBRARY = PETSC_FLAG
...
#ifndef WITH_HYPRE
#ifdef WITH_PETSC
IF (PRES_FLAG==ULMAT_FLAG ) ULMAT_SOLVER_LIBRARY=PETSC_FLAG
IF (PRES_FLAG==UGLMAT_FLAG) UGLMAT_SOLVER_LIBRARY=PETSC_FLAG
#endif
#endif
#endif
...
#ifndef WITH_PETSC
IF (PRES_FLAG==ULMAT_FLAG .AND. ULMAT_SOLVER_LIBRARY==PETSC_FLAG) THEN
   CALL SHUTDOWN('ERROR: PETSC selected for ULMAT solver without compiling and linking PETSC library.')
   RETURN
ENDIF
IF (PRES_FLAG==UGLMAT_FLAG .AND. UGLMAT_SOLVER_LIBRARY==PETSC_FLAG) THEN
   CALL SHUTDOWN('ERROR: PETSC selected for UGLMAT solver without compiling and linking PETSC library.')
   RETURN
ENDIF
#endif
#ifndef WITH_MKL
