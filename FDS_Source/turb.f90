...
DO K = 0,KBP1
   DO J = 0,JBP1
      CALL TOPHAT_FILTER_1D(PHIBAR(0:IBP1,J,K),PHI(0:IBP1,J,K),0,IBP1,PHI_MIN,PHI_MAX)
   ENDDO
ENDDO
!$OMP END DO NOWAIT
...
IF (.NOT.TWO_D) THEN
   ...
   DO K = 0,KBP1
      DO I = 0,IBP1
         CALL TOPHAT_FILTER_1D(PHIBAR(I,0:JBP1,K),PHIBAR(I,0:JBP1,K),0,JBP1,PHI_MIN,PHI_MAX)
      ENDDO
   ENDDO
   !$OMP END DO NOWAIT
ENDIF
...
DO J = 0,JBP1
   DO I = 0,IBP1
      CALL TOPHAT_FILTER_1D(PHIBAR(I,J,0:KBP1),PHIBAR(I,J,0:KBP1),0,KBP1,PHI_MIN,PHI_MAX)
   ENDDO
ENDDO
!$OMP END DO NOWAIT
!$OMP END PARALLEL
