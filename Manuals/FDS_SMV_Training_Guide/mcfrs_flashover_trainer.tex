...
\begin{tabular}{cc}
 ...
 \includegraphics[width=3.5in]{datafigures/MCFRS_Flashover_00case1_hrr}\\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case1_temp_0060}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case3_temp_0060}\\
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case1_temp_0120}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case3_temp_0120}\\
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case1_temp_0180}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case3_temp_0180}\\
\end{tabular}
\end{center}
\caption {FDS temperatures as a function of height
at 3 locations within the MCFRS flashover trainer at 60 s, 120 s and 180 s.  See Figure \ref{figflashoverplan}a for location details.}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00leak_temp_0360}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00open_temp_0360}\\
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00leak_temp_0720}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00open_temp_0720}\\
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00leak_temp_1080}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00open_temp_1080}\\
\end{tabular}
\end{center}
\caption {FDS temperatures as a function of height
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case1_temp_0360}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case3_temp_0360}\\
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case1_temp_0720}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case3_temp_0720}\\
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case1_temp_1080}&
\includegraphics[width=3.0in]{datafigures/MCFRS_Flashover_00case3_temp_1080}\\
\end{tabular}
\end{center}
\caption {FDS temperatures as a function of height
