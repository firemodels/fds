...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/Beyler_Hood/Beyler_UHC} &
\includegraphics[height=2.2in]{FIGURES/Beyler_Hood/Beyler_O2} \\
\includegraphics[height=2.2in]{FIGURES/Beyler_Hood/Beyler_CO} &
\includegraphics[height=2.2in]{FIGURES/Beyler_Hood/Beyler_CO2} \\
\end{tabular*}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=4.0in]{FIGURES/RSE_Pitts/RSE_Pitts_CO} \\
\vspace{0.25in} \\
\includegraphics[width=4.0in]{FIGURES/RSE_Pitts/RSE_Pitts_CO2} \\
\vspace{0.25in}
\end{tabular}
\end{center}
