...
REAL(EB)    VEG_FUEL_MPV_MIN,VEG_MOIST_MPV_MIN
!rm <-
...
!rm ->
                ...
                VEG_MOIST_MPV_MIN,VEG_REMOVE_CHARRED
!rm <-
...
OUTPUT_QUANTITY(97)%NAME = 'OPTICAL DENSITY'
OUTPUT_QUANTITY(97)%UNITS = '1/m'
OUTPUT_QUANTITY(97)%SHORT_NAME = 'OD'

OUTPUT_QUANTITY(98)%NAME = 'OPTICAL DEPTH'
...
IF (QUANTITY=='OPTICAL DEPTH'        .AND. SPEC_ID=='null' .AND. MIXTURE_FRACTION) SPEC_ID='soot'
