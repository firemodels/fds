...
Forensic reconstructions require the  model to simulate an actual fire based on  information that is collected  after the event,  such as eye witness
...
An extensive  amount of  flame spread validation work with  FDS version 4  has been performed    by   Hietaniemi,    Hostikka,   and    Vaari    at   VTT,
...
Xiao~\cite{Xiao:FT2012} compared FDS simulations with real scale compartment measurements for unsprinklered and sprinklered experiments. Numerical results for doorway mass flow rate and
temperature are compared with the experimental data for three fire sizes. 
...
The resulting validation cases indicated that predicted smoke concentrations were up to five times greater than measured
...
experiments. Cohan~\cite{Cohan:Masters} simulated two of the Hamins~{\em et al.}~\cite{Hamins:SP1013-1}~NRC experiments and the
Gottuk~\cite{Gottuk:IAFSS2008} corridor tests with soot deposition and found better results for well-ventilated fires than
closed compartment conditions. Riahi \cite{Riahi:2011} conducted bench-scale experiments to measure soot densities and soot
...
mechanism in the hot gas layer. Overholt~and~Ezekoye~\cite{Overholt:1} implemented gravitational settling of soot in the gas-phase
in FDS and quantified the effects of gravitational settling/deposition compared to thermophoretic and turbulent deposition in
small- and large-scale validation cases.
