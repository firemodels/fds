...
FDS uses by default a value of 2000~kW/m$^3$ as a local upper bound ({\ct HRRPUV\_AVERAGE} on the
{\ct REAC} line). Further discussion is found in the FDS Technical Reference Guide, Volume 1.
