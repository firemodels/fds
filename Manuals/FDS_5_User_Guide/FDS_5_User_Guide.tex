...
\item[{\bf Mac OS X}]
A Mac OS X zip archive is available for Intel architectures.
...
\item[{\bf Linux}]
Linux users can run FDS and Smokeview by downloading the appropriate pre-compiled
...
A solid boundary can consist of
...
\subsubsection{Special Topic: Non-Planar Walls and Targets}
