...
COLUMN_DUMP_LIMIT  = .FALSE.  ! Limit csv files to 255 columns
DEBUG              = .FALSE.
...
NAMELIST /PRES/ CHECK_POISSON,MAX_PRESSURE_ITERATIONS,PRESSIT_ACCELERATOR,PRESSIT_SCALE_FACTOR, &
...
NAMELIST /INIT/ CTRL_ID,DENSITY,DEVC_ID,DT_INSERT,DX,DY,DZ,HRRPUV,ID,MASS_FRACTION,MASS_PER_TIME,MASS_PER_VOLUME,MULT_ID,&
                N_PARTICLES,PART_ID,SHAPE,SPEC_ID,TEMPERATURE,UVW,XB,XYZ,&
