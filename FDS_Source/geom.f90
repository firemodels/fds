...
! reject if VERT is outside the bounding box of V1, V2 and V3

IF ( VERT(1)<MIN(V1(1),V2(1),V3(1)) .OR. VERT(2)<MIN(V1(2),V2(2),V3(2))) THEN
   IN_TRIANGLE = .FALSE.
   RETURN
ENDIF
IF ( VERT(1)>MAX(V1(1),V2(1),V3(1)) .OR. VERT(2)>MAX(V1(2),V2(2),V3(2))) THEN
   IN_TRIANGLE = .FALSE.
   RETURN
ENDIF
...
DO WHILE (NP >= 3)
   LOOP_I: DO I = 1, NP - 2
      ...
      IF (NP>3) THEN
         ...
         END DO LOOP_J
      ENDIF
      ! passed - copy triangle into list
      TRIS(3*NTRIS+1) = P(I)
