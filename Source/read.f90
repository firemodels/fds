...
REAL(EB) :: VALUE(10)
CHARACTER(LABEL_LENGTH) :: QUANTITY,QUANTITY_C,SPEC_ID,SPEC_ID_C
INTEGER :: N,VELO_INDEX,VELO_INDEX_C,SKIP
TYPE(ISOSURFACE_FILE_TYPE), POINTER :: IS=>NULL()
NAMELIST /ISOF/ FYI,QUANTITY,QUANTITY_C,SPEC_ID,SPEC_ID_C,SKIP,VALUE,VELO_INDEX,VELO_INDEX_C
...
READ_ISOF_LOOP: DO N=1,N_ISOF
   ...
   IF ( QUANTITY_C /= 'null' ) THEN
      CALL GET_QUANTITY_INDEX(IS%SMOKEVIEW_LABEL,IS%SMOKEVIEW_BAR_LABEL,IS%INDEX_C,I_DUM(1), &
                           IS%Y_INDEX_C,IS%Z_INDEX_C,I_DUM(2),I_DUM(3),I_DUM(4),I_DUM(5),I_DUM(6),'ISOF', &
                           QUANTITY_C,'null',SPEC_ID_C,'null','null','null','null','null',-1._EB,I_DUM(7))
   ENDIF
