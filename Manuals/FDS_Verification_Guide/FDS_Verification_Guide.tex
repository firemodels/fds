...
\begin{figure}
   \begin{center}
      \includegraphics[width=4.5in]{SCRIPT_FIGURES/poiseuille_convergence.pdf}
...
\begin{figure}[h!]
\begin{center}
   \includegraphics[width=4.5in]{SCRIPT_FIGURES/yplus}
