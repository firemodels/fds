...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, &
         ...
         WATER_EVAPORATION=.FALSE.,FUEL_EVAPORATION=.FALSE., &
...
REAL(EB) :: MW_AIR,MW_SOOT,HRRPUA_SHEET=200._EB,RHO_SOOT,VISIBILITY_FACTOR,MASS_EXTINCTION_COEFFICIENT,EC_LL
...
INTEGER                              :: LU_MASS,LU_HRR,LU_OUTPUT,LU_SMV,LU_END,LU_INPUT=55,LU_ERR=0
...
CHARACTER(50)                              :: FN_MASS,FN_HRR,FN_OUTPUT,FN_SMV,FN_END,FN_INPUT='null',FN_ERR
CHARACTER(50)                              :: FN_EVACCSV,FN_EVACEFF,FN_EVACFED
CHARACTER(50), ALLOCATABLE, DIMENSION(:)   :: FN_PART,FN_PROF,FN_XYZ,FN_PL3D,FN_DEVC,FN_STATE,FN_CTRL,FN_CORE,FN_RESTART
CHARACTER(50), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_BNDF,FN_ISOF,FN_SMOKE3D
