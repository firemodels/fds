...
Density                     & \unit{kg/m^3}      & 860                   & 950                   & 1100                  & 5         & Direct                &  \cite{Stoliarov:CF2009}      \\ \hline
Conductivity                & \unit{W/(m.K)}& 0.29                  & 0.22                  & 0.20                  & 15        & TLC                   &  \cite{Stoliarov:CF2009}      \\ \hline
Specific Heat               & \unit{kJ/(kg.K)}       & 3.5                   & 2.0                   & 2.2                   & 15        & DSC                   &  \cite{Stoliarov:PDS2008}     \\ \hline
...
Property                    & Units         & PP                    & PA66                  & POM                   & PET                   & Unc.      & Method    \\
                            &               &                       &                       &                       &                       & (\%)      &           \\ \hline \hline
Density                     & \unit{kg/m^3}      & 910                   & 1150                  & 1425                  & 1380                  & 5         & Direct    \\ \hline
Conductivity                & \unit{W/(m.K)}& 0.24                  & 0.34                  & 0.28                  & 0.29                  & 15        & TLC       \\ \hline
Specific Heat               & \unit{kJ/(kg.K)}       & 2.68                  & 2.54                  & 1.88                  & 2.01                  & 15        & DSC       \\ \hline
...
Polymer Density             & \unit{kg/m^3}      & 1180 $\pm$ 60                     & Direct                &  \cite{Stoliarov:CF2010}                  \\ \hline
Polymer Conductivity        & \unit{W/(m.K)}& 0.22 $\pm$ 0.03                   & Literature            &  \cite{Stoliarov:CF2010}                  \\ \hline
Polymer Specific Heat       & \unit{kJ/(kg.K)}       & 1.9 $\pm$ 0.3                     & DSC                   &  \cite{Stoliarov:PDS2008}                 \\ \hline
...
Char Density                & \unit{kg/m^3}      & 248                               & Cone Calorimeter      &  \cite{Stoliarov:CF2010}                  \\ \hline
Char Conductivity           & \unit{W/(m.K)}& 0.37                              & Cone Calorimeter      &  \cite{Stoliarov:CF2010}                  \\ \hline
Char Specific Heat          & \unit{kJ/(kg.K)}       & 1.72 $\pm$ 0.17                   & Pulsed Current        &  \cite{Stoliarov:CF2010,Matsumoto:1996}   \\ \hline
...
\hline
Property                    & Units         & Value                             & Method                    &  Reference                                \\ \hline \hline
Polymer Density             & \unit{kg/m^3}      & 1430 $\pm$ 70                     & Direct                    &  \cite{Stoliarov:CF2010}                  \\ \hline
Polymer Conductivity        & \unit{W/(m.K)}& 0.17 $\pm$ 0.01                   & Literature                &  \cite{Stoliarov:CF2010}                  \\ \hline
Polymer Specific Heat       & \unit{kJ/(kg.K)}       & 1.55 $\pm$ 0.25                   & DSC                       &  \cite{Stoliarov:PDS2008}                 \\ \hline
Polymer Emissivity          &               & 0.90 $\pm$ 0.05                   & IS                        &  \cite{Hallman:PES1974}                   \\ \hline
Polymer Absorption Coef.    & m$^{-1}$      & 2145 $\pm$ 715                    & FTIR                      &  \cite{Tsilingiris:ECM2003}               \\ \hline
Char 1 Density              & \unit{kg/m^3}      & 629                               & Constant Volume           &  \cite{Stoliarov:CF2010}                  \\ \hline
Char 1 Conductivity         & \unit{W/(m.K)}& 0.17                              & Inherited                 &  \cite{Stoliarov:CF2010}                  \\ \hline
Char 1 Specific Heat        & \unit{kJ/(kg.K)}       & 1.55 $\pm$ 0.25                   & Inherited                 &  \cite{Stoliarov:CF2010}                  \\ \hline
...
Char 2 Density              & \unit{kg/m^3}      & 296                               & Constant Volume           &  \cite{Stoliarov:CF2010}                  \\ \hline
Char 2 Conductivity         & \unit{W/(m.K)}& 0.26                              & Inverse Analysis          &  \cite{Stoliarov:CF2010}                  \\ \hline
Char 2 Specific Heat        & \unit{kJ/(kg.K)}       & 1.72 $\pm$ 0.17                   & Pulsed Current            &  \cite{Stoliarov:CF2010,Matsumoto:1996}   \\ \hline
...
\hline
Property                    & Units         & Value                             & Method                    &  Reference                              \\ \hline \hline
Polymer Density             & \unit{kg/m^3}      & 1300                              & Direct                    &  \cite{Oztekin:CF2012}                  \\ \hline
Polymer Conductivity        & \unit{W/(m.K)}& 0.28                              & Inverse Analysis          &  \cite{Oztekin:CF2012}                  \\ \hline
Polymer Specific Heat       & \unit{kJ/(kg.K)}       & 2.05                              & Inverse Analysis          &  \cite{Oztekin:CF2012}                  \\ \hline
...
Char 1 Density              & \unit{kg/m^3}      & 810                               & Constant Volume           &  \cite{Oztekin:CF2012}                  \\ \hline
Char 1 Conductivity         & \unit{W/(m.K)}& 0.37                              & Inverse Analysis          &  \cite{Oztekin:CF2012}                  \\ \hline
Char 1 Specific Heat        & \unit{kJ/(kg.K)}       & 0.24                              & Assumed                   &  \cite{Oztekin:CF2012}                  \\ \hline
...
Char 2 Density              & \unit{kg/m^3}      & 710                               & Constant Volume           &  \cite{Oztekin:CF2012}                  \\ \hline
Char 2 Conductivity         & \unit{W/(m.K)}& 0.37                              & Inverse Analysis          &  \cite{Oztekin:CF2012}                  \\ \hline
Char 2 Specific Heat        & \unit{kJ/(kg.K)}       & 0.27                              & Assumed                   &  \cite{Oztekin:CF2012}                  \\ \hline
...
The heat capacity value is increased by 0.13~\unit{kJ/(kg.K)} to account for the heat of melting (-46~kJ/kg), which takes place at 493~K.}
\begin{center}
\begin{tabular}{|l|c|c|l|l|}
\hline
Property                & Units     & Value                             & Method                                & Reference                     \\ \hline \hline
Density                 & \unit{kg/m^3}  & 1300 $\pm$ 70                     & Direct                                & \cite{Kempel:1}               \\ \hline
Specific Heat           & \unit{kJ/(kg.K)}   & 2.23 $\pm$ 0.34                   & DSC                                   & \cite{Kempel:1}               \\ \hline
Conductivity            & \unit{W/(m.K)} & 29 $\pm$ 0.05                   & TLS                                   & \cite{Kempel:1}               \\ \hline
...
The heat capacity value is increased by 0.09~\unit{kJ/(kg.K)} to account for the heat of melting (-32~kJ/kg), which takes place at 493~K.}
\begin{center}
\begin{tabular}{|l|c|c|l|l|}
\hline
Property                &      Units    &      Value                        & Method                                    & Reference                     \\ \hline \hline
Polymer Density         &     \unit{kg/m^3}  & 1520 $\pm$ 80                     & Direct                                    & \cite{Kempel:1}               \\ \hline
Polymer Specific Heat   &    \unit{kJ/(kg.K)}    & 1.68 $\pm$ 0.26                   & DSC                                       & \cite{Kempel:1}               \\ \hline
Polymer Conductivity    &    \unit{W/(m.K)}    & 0.36 $\pm$ 0.06                   & TLS                                       & \cite{Kempel:1}               \\ \hline
...
Char Density            &     \unit{kg/m^3}  &        482                        & Constant Volume                           & \cite{Kempel:1}               \\ \hline
Char Specific Heat      &    \unit{kJ/(kg.K)}    &        0.85                       & Literature                                & \cite{SCHOTT}                 \\ \hline
Char Conductivity       & \unit{W/(m.K)} & 0.07 $\pm$ 0.02                   & Laser Flash                               & \cite{Kempel:1}               \\ \hline
...
Density                     & \unit{kg/m^3}      & 1210                                                                                                                                         & 30             \\ \hline
Conductivity                & \unit{W/(m.K)} & $\begin{array}{ll} 0.16  & T<395 \; \hbox{K} \\  0.34 - 4.2 \times 10^{-4} \, T  & T>395 \; \hbox{K} \end{array}$                            &                \\ \hline
Specific Heat               & \unit{kJ/(kg.K)}       & $\begin{array}{ll} -1.39+ 8.33 \times 10^{-3} \, T & T<395 \; \hbox{K} \\ 0.851 + 3.07 \times 10^{-3} \, T & T>395 \; \hbox{K} \end{array}$  &                \\ \hline
...
Specific Heat (\unit{kJ/(kg.K)})                       & $\begin{array}{l} 1.48 @ 114 \; \unit{\degreeCelsius} \\ 1.90 @ 300 \; \unit{\degreeCelsius} \end{array}$        & \cite{chemeo}                     \\ \hline
...
Polymer Density             & \unit{kg/m^3}      & 1050                    & 1060                    & 1160                     \\ \hline
                            &               &                         &                         & $0.45-0.00038 \, T, \; T<378$~K      \\
\raisebox{1.5ex}[0pt]{Polymer Cond.}        & \raisebox{1.5ex}[0pt]{\unit{W/(m.K)}}         & \raisebox{1.5ex}[0pt]{$0.30-0.00028 \, T$}  & \raisebox{1.5ex}[0pt]{$0.10+0.0001  \, T$} & $0.27-0.00024 \, T, \; T\ge 378$~K  \\ \hline
Polymer Spec.~Heat          & \unit{kJ/(kg.K)}       & $1.58+0.0013  \, T$     & $0.59+0.0034  \, T$     & $0.60+0.0036  \, T$      \\ \hline
Polymer Emissivity          &               & 0.95                    & 0.95                    & 0.95                     \\ \hline
Polymer Abs.~Coef.          & m$^{-1}$      & 1800                    & 2250                    & 2240                     \\ \hline
Char Density                & \unit{kg/m^3}      & 80                      & Same as Polymer         & Same as Polymer          \\ \hline
Char Conductivity           & \unit{W/(m.K)}& $0.13-0.00054 \, T$     & Same as Polymer         & Same as Polymer          \\ \hline
Char Specific Heat          & \unit{kJ/(kg.K)}       & $0.82+0.00011 \, T$     & Same as Polymer         & Same as Polymer          \\ \hline
...
Polymer Density                          & \unit{kg/m^3}      & 1350                     \\ \hline
Polymer Cond.                            & \unit{W/(m.K)}& $0.28-0.00029 \, T$      \\ \hline
Polymer Spec.~Heat                       & \unit{kJ/(kg.K)}       & $-0.62+0.00593  \, T$    \\ \hline
Polymer, Int. Emissivity                 &               & 0.95                     \\ \hline
Polymer Abs.~Coef.                       & m$^{-1}$      & 2135                     \\ \hline
Int.~Density                             & \unit{kg/m^3}      & Same as Char             \\ \hline
Int.~Cond.                               & \unit{W/(m.K)}& $0.55+0.00003 \, T$      \\ \hline
Int.~Spec.~Heat                          & \unit{kJ/(kg.K)}       & $0.27+0.00301  \, T$     \\ \hline
Int.~Abs.~Coef.                          & m$^{-1}$      & 3000                     \\ \hline
Char Density                             & \unit{kg/m^3}      & 100                      \\ \hline
Char Conductivity                        & \unit{W/(m.K)}& $0.21+0.00034 \, T$      \\ \hline
Char Specific Heat                       & \unit{kJ/(kg.K)}       & $1.15+0.00010 \, T$      \\ \hline
...
Polymer, Melt Density                    & \unit{kg/m^3}      & 1285                    & 1385                    & 1424                     \\ \hline
Polymer Cond.                            & \unit{W/(m.K)}& $0.40-0.00040 \, T$     & $0.34-0.00046  \, T$    & $0.25+0.00002 \, T$      \\ \hline
Polymer Spec.~Heat                       & \unit{kJ/(kg.K)}       & $-0.04+0.00410  \, T$   & $-0.27+0.00464  \, T$   & $-1.86+0.0099  \, T$     \\ \hline
Polymer, Melt, Int. Emiss.               &               & 0.95                    & 0.95                    & 0.95                     \\ \hline
Polymer Abs.~Coef.                       & m$^{-1}$      & 1745                    & 1940                    & 3050                     \\ \hline
Melt Cond.                               & \unit{W/(m.K)}& $0.32-0.00033 \, T$     & $0.33-0.00002 \, T$     & $0.21+0.00001 \, T$      \\ \hline
Melt Spec.~Heat                          & \unit{kJ/(kg.K)}       & $1.88+0.00057  \, T$    & $2.05-0.00021 \, T$     & $1.65+0.00120  \, T$     \\ \hline
Melt Abs.~Coef.                          & m$^{-1}$      & 128500                  & Same as Polymer         & Same as Polymer          \\ \hline
Int.~Density                             & \unit{kg/m^3}      & Same as Char            & 730                     & Same as Polymer          \\ \hline
Int.~Cond.                               & \unit{W/(m.K)}& $0.45+0.00019 \, T$     & $0.45+0.00020  \, T$    & $0.19-0.00006 \, T$      \\ \hline
Int.~Spec.~Heat                          & \unit{kJ/(kg.K)}       & $1.59+0.00031  \, T$    & $1.44-0.00005  \, T$    & Same as Melt             \\ \hline
Int.~Abs.~Coef.                          & m$^{-1}$      & 8000                    & 1025                    & Same as Polymer          \\ \hline
Char Density                             & \unit{kg/m^3}      & 80                      & 80                      & Same as Int.             \\ \hline
Char Conductivity                        & \unit{W/(m.K)}& $0.45+0.00013 \, T$     & $0.34+0.00046  \, T$    & Same as Polymer          \\ \hline
Char Specific Heat                       & \unit{kJ/(kg.K)}       & $1.30+0.00004 \, T$     & $0.82+0.00011 \, T$     & Same as Int.             \\ \hline
...
\endhead
Property                          & Units         & Value                                   & Method                                    & Reference                             \\ \hline \hline
Moisture Density                  & \unit{kg/m^3}      & 1000                                    & Direct                                    & \cite{McKinnon:CF2013}                \\ \hline
Moisture Conductivity             & \unit{W/(m.K)}& 0.1                                       & Inherited                                & \cite{McKinnon:CF2013}                \\ \hline
Moisture Specific Heat             & \unit{kJ/(kg.K)}         & 4.19                                   & Literature                               & \cite{Coblentz:1}                     \\ \hline
Moisture Emissivity                 &               & 0.7                                       & Inherited                                & \cite{McKinnon:CF2013}                \\ \hline
LB Density                         & \unit{kg/m^3}      &   520                                       & Direct                                   & \cite{McKinnon:CF2013}                \\ \hline
LB Conductivity                     & \unit{W/(m.K)}& 0.1                                       & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
LB Specific Heat                 & \unit{kJ/(kg.K)}         & 1.8                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
LB Emissivity                     &               & 0.7                                       & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
LB Intermediary Density             & \unit{kg/m^3}     & 468                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
LB Intermediary Conductivity     & \unit{W/(m.K)}& $0.05 + 7.5\times 10^{-11}\times T^3$   & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
LB Intermediary Specific Heat     & \unit{kJ/(kg.K)}         & 1.55                                   & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
LB Intermediary Emissivity         &               & 0.775                                   & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
LB Char 1 Density                 & \unit{kg/m^3}     & 173                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
LB Char 1 Conductivity             & \unit{W/(m.K)}& $1.5\times 10^{-10}\times T^3$          & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
LB Char 1 Specific Heat             & \unit{kJ/(kg.K)}         & 1.3                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
LB Char 1 Emissivity             &               & 0.85                                   & Literature                               & \cite{Matsumoto:IJT1995}              \\ \hline
LB Char 2 Density                 & \unit{kg/m^3}     & 102                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
LB Char 2 Conductivity             & \unit{W/(m.K)}& $1.5\times 10^{-10}\times T^3$          & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
LB Char 2 Specific Heat             & \unit{kJ/(kg.K)}         & 1.3                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
LB Char 2 Emissivity             &               & 0.85                                   & Literature                               & \cite{Matsumoto:IJT1995}              \\ \hline
CFL Density                         & \unit{kg/m^3}     & 49                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
CFL Conductivity                 & \unit{W/(m.K)}& 0.1                                     & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
CFL Specific Heat                 & \unit{kJ/(kg.K)}         & 1.8                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
CFL Emissivity                     &               & 0.7                                    & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
CFL Intermediary Density         & \unit{kg/m^3}     & 44                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
CFL Intermediary Conductivity     & \unit{W/(m.K)}& $0.05 + 7.5\times 10^{-10}\times T^3$   & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
CFL Intermediary Specific Heat     & \unit{kJ/(kg.K)}         & 1.55                                   & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
CFL Intermediary Emissivity         &               & 0.775                                    & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 1 Density                 & \unit{kg/m^3}     & 16                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 1 Conductivity             & \unit{W/(m.K)}& $1.5\times 10^{-9}\times T^3$           & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 1 Specific Heat         & \unit{kJ/(kg.K)}         & 1.3                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 1 Emissivity             &               & 0.85                                   & Literature                               & \cite{Matsumoto:IJT1995}              \\ \hline
CFL Char 2 Density                 & \unit{kg/m^3}     & 9.4                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 2 Conductivity             & \unit{W/(m.K)}& $1.5\times 10^{-9}\times T^3$           & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 2 Specific Heat         & \unit{kJ/(kg.K)}         & 1.3                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
CFL Char 2 Emissivity             &               & 0.85                                   & Literature                               & \cite{Matsumoto:IJT1995}              \\ \hline
BFL Density                         & \unit{kg/m^3}     & 74                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
BFL Conductivity                 & \unit{W/(m.K)}& 0.1                                     & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
BFL Specific Heat                 & \unit{kJ/(kg.K)}         & 1.8                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
BFL Emissivity                     &               & 0.7                                    & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
BFL Intermediary Density         & \unit{kg/m^3}     & 67                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
BFL Intermediary Conductivity     & \unit{W/(m.K)}& $0.05 + 7.5\times 10^{-10}\times T^3$   & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
BFL Intermediary Specific Heat     & \unit{kJ/(kg.K)}         & 1.55                                   & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
BFL Intermediary Emissivity       &               & 0.775                                    & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
BFL Char 1 Density                 & \unit{kg/m^3}     & 25                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
BFL Char 1 Conductivity             & \unit{W/(m.K)}& $1.5\times 10^{-9}\times T^3$           & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
BFL Char 1 Specific Heat         & \unit{kJ/(kg.K)}         & 1.3                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
BFL Char 1 Emissivity             &               & 0.85                                   & Literature                               & \cite{Matsumoto:IJT1995}              \\ \hline
BFL Char 2 Density                 & \unit{kg/m^3}     & 15                                       & Constant Volume                           & \cite{McKinnon:CF2013}                \\ \hline
BFL Char 2 Conductivity             & \unit{W/(m.K)}& $1.5\times 10^{-9}\times T^3$           & Inverse Analysis                          & \cite{McKinnon:CF2013}                \\ \hline
BFL Char 2 Specific Heat         & \unit{kJ/(kg.K)}         & 1.3                                       & DSC                                       & \cite{McKinnon:CF2013}                \\ \hline
...
Density                      & \unit{kg/m^3}      & \multicolumn{2}{|c|}{1000}                                          \\ \hline
Conductivity                 & \unit{W/(m.K)}& \multicolumn{2}{|c|}{0.6}                                           \\ \hline
Specific Heat                & \unit{kJ/(kg.K)}       & \multicolumn{2}{|c|}{4.2}                                           \\ \hline
...
Density                      & \unit{kg/m^3}      & 408                             & 493                               \\ \hline
Conductivity                 & \unit{W/(m.K)}& $3.16\times 10^{-4}\, T-0.0305$ & $3.57\times 10^{-4}\, T-0.00462$  \\ \hline
Specific Heat                & \unit{kJ/(kg.K)}       & \multicolumn{2}{|c|}{$0.0044 \,T - 0.414$}                          \\ \hline
...
Density                      & \unit{kg/m^3}      & 52.5                            & 104                               \\ \hline
Conductivity                 & \unit{W/(m.K)}& \multicolumn{2}{|c|}{$8.2\times 10^{-5}\, T+0.091$}                 \\ \hline
Specific Heat                & \unit{kJ/(kg.K)}       & \multicolumn{2}{|c|}{$1.43+0.000355\,T-7.32\times 10^4/T^2$}        \\ \hline
...
For simulations of both room corner tests~\cite{Sundstrom:1998,Hietaniemi:2001}, concrete properties are assumed as given for lightweight concrete in~\cite{Hietaniemi:2001}: thickness of 20~cm, thermal conductivity of 0.1~\unit{W/(m.K)} and thermal diffusivity of 2 $\times$ 10$^{-7}$ m$^2$/s. Assuming a specific heat of 0.88~\unit{kJ/(kg.K)} for concrete~\cite{Drysdale:2011}, gives a density of 568~\unit{kg/m^3} from thermal diffusivity.
...
\end{tabular*}
\caption[Kashiwagi Gasification: weight loss mass flux]{Kashiwagi gasification mass flux (left) 25 \unit{kW/m^2} and (right) 40 \unit{kW/m^2}.}
...
\hline
            & $\Delta$                   & $\rho$                                   & $k$                                        & $c_{p}$                                       & $\varepsilon$     & $T_{\mathrm{ign}}^{a}$ & $\Delta H_{c}$                        & $Y_{s}^{b}$                         \\
Material    & (mm) & (\unit{kg/m^3}) & (\unit{W/(m.K)} & $\mathrm{\left(\frac{kJ}{(kg\cdot K}\right)}$ & $\mathrm{( - )}$  & (\unit{\degreeCelsius}) & $\left(\mathrm{\frac{MJ}{kg}}\right)$ & $\mathrm{\left(\frac{g}{g}\right)}$ \\ \hline
\hline
...
\hline
            & $\Delta^{a}$& $\rho$& $k$& $c_{p}$& $\varepsilon$& $T_{\mathrm{ign}}^{b}$&$\Delta H_{c}$& $Y_{s}$ \\
Material    & (mm) & (\unit{kg/m^3}) & (\unit{W/(m.K)} & $\mathrm{\left(\frac{kJ}{(kg\cdot K}\right)}$ & $\mathrm{( - )}$ &  (\unit{\degreeCelsius})   & $\left(\mathrm{\frac{MJ}{kg}}\right)$ & $\mathrm{\left(\frac{g}{g}\right)}$ \\ \hline
\hline
...
\hline
            & $\Delta$& $\rho$& $T_{\mathrm{ign}}^{a}$&$\Delta H_{c}$&$Y_{s}$ & Test \# \\
Material    & (mm) & (\unit{kg/m^3}) & (\unit{\degreeCelsius})   & $\left(\mathrm{\frac{MJ}{kg}}\right)$ & $\mathrm{\left(\frac{g}{g}\right)}$ & $\mathrm{( - )}$  \\ \hline
\hline
...
\hline
            & $\Delta$& $\rho$& $k$& $c_{p}$ &$T_{\mathrm{ign}}^{a}$&$\Delta H_{c}$& $Y_{s}$ \\
Material    & (mm) & (\unit{kg/m^3}) & (\unit{W/(m.K)} & $\mathrm{\left(\frac{kJ}{(kg\cdot K}\right)}$ & (\unit{\degreeCelsius})   & $\left(\mathrm{\frac{MJ}{kg}}\right)$ & $\mathrm{\left(\frac{g}{g}\right)}$ \\ \hline
\hline
...
Material    & (mm)      & (\unit{kg/m^3})   & (\unit{W/(m.K)})  & (kJ/(kg K)) &               & (\unit{\degreeCelsius})        & (MJ/kg)            & (g/g)       \\ \hline
\hline
...
Tables~\ref{Properties_RISE_Materials_Mixtures1} through \ref{Properties_RISE_Materials_Wood-Based} list the parameters for modeling the cone calorimeter experiments. Note that the test reports in this study did not provide thermal properties. Fixed values of specific heat capacity, 1.0~kJ/(kg~K), thermal conductivity, 0.4~\unit{W/(m.K)}, and emissivity, 1, are used to calculate an effective ignition temperature. The results of the simulations are shown on the following pages.
...
Material$^{c}$  & (mm)      & (\unit{kg/m^3}) & (\unit{\degreeCelsius})        & (MJ/kg)             & (g/g)           & Number  \\ \hline
\hline
...
\hline
            & $\Delta$  & $\rho$     & $T_{\rm{ign}}^{a}$  & $\Delta H_{\rm c}$ & $Y_{\rm s}^{b}$ & Test   \\
Material    & (mm)      & (\unit{kg/m^3}) & (\unit{\degreeCelsius})         & (MJ/kg)            & (g/g)           & Number \\ \hline
\hline
...
\hline
            & $\Delta$& $\rho$& $T_{\mathrm{ign}}^{a}$&$\Delta H_{c}$&$Y_{s}^{b}$ & Test \# \\
Material    & (mm) & (\unit{kg/m^3}) &  (\unit{\degreeCelsius})   & $\left(\mathrm{\frac{MJ}{kg}}\right)$ & $\mathrm{\left(\frac{g}{g}\right)}$ & $\mathrm{( - )}$  \\ \hline
\hline
