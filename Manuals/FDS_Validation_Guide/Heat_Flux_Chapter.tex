...
Heat flux gauges (Gardon Model 64-20-18) were placed at three locations in the compartment. The gauges were placed in the steel pipes of 25 mm inside diameter and were water cooled.  Results are shown in Fig.~\ref{NIST_E119_Compartment_Wall_Flux}. Locations of HG1 through HG3 were shown in Fig.~\ref{NIST_E119_Compartment_Drawing_1}
...
\includegraphics[height=2.15in]{SCRIPT_FIGURES/NIST_E119_Compartment/Test_3_Wall_Flux}
\end{tabular*}
...
Figure~\ref{NIST_Pool_Fire_Heat_Flux} displays measurements made by Hamins~et~al.~\cite{Hamins:CST1994,Kim:FSJ2019} of the radiative and total heat flux along a radial profile at the surface of a 30.5~cm diameter methanol pool fire originally studied by Weckman at the University of Waterloo~\cite{Weckman:CF1996}. Kim~et~al.~\cite{Kim:FSJ2019} measured radial and vertical profiles of total heat flux for this same fire, as shown in Fig.~\ref{NIST_Pool_Fire_Heat_Flux2}. Klassen~et~al.~\cite{Klassen:GCR1994} also made radial measurements.
...
\end{tabular*}
\caption[NIST Pool Fires, radial profile of radiative and total heat flux to liquid fuel surface]
{NIST Pool Fires, radial profile of radiative and total heat flux to the surface of a 30~cm methanol fire.}
...
\end{tabular*}
\caption[NIST Pool Fires, radial and vertical profiles of total heat flux]
{NIST Pool Fires, radial and vertical profiles of total heat flux from a 30~cm methanol fire.}
