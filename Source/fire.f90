...
TNOW=CURRENT_TIME()
DTCHEM = 0._EB ! Zero out time taken in chem.f90 for this call to COMBUSTION
...
T_USED(10)=T_USED(10)+CURRENT_TIME()-TNOW-DTCHEM !subract off CHEM time so FIRE time doesn't double count
T_USED(16)=T_USED(16)+DTCHEM
...
DTCHEM = DTCHEM+CURRENT_TIME()-TNOW2
