...
TYPE PARTICLE_CLASS_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:) :: R_CDF,CDF,CHILD_R_CDF,CHILD_CDF,W_CDF,R50,DMN
   REAL(EB), POINTER, DIMENSION(:,:) :: WQABS,WQSCA
   REAL(EB) :: H_V(0:5000)=-1._EB,C_P(0:5000)=-1._EB,C_P_BAR(0:5000)=-1._EB,H_L(0:5000), &
               H_V_REFERENCE_TEMPERATURE=-1._EB,H_V_CORRECTOR=0._EB
   REAL(EB), POINTER, DIMENSION(:,:) :: ORIENTATION
   INTEGER :: SAMPLING,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
...
TYPE SPECIES_TYPE
   REAL(EB) :: MW=0._EB,YY0=0._EB,RCON,MAXMASS,MASS_EXTINCTION_COEFFICIENT=0._EB,&
               SPECIFIC_HEAT=-1._EB,SPECIFIC_ENTHALPY=-1._EB,&
   ...
   LOGICAL :: ABSORBING=.FALSE.,ISFUEL=.FALSE.,BACKGROUND=.FALSE.,SMIX_COMPONENT_ONLY=.FALSE.,PRIMITIVE_ONLY=.TRUE.
...
TYPE SPECIES_MIXTURE_TYPE
   INTEGER :: N_SUB_SPECIES
   INTEGER, POINTER, DIMENSION(:) :: Y_INDEX
   REAL(EB), POINTER, DIMENSION(:) :: MASS_FRACTION,VOLUME_FRACTION
   REAL(EB) :: MW , RCON, ZZ0=0._EB, MASS_EXTINCTION_COEFFICIENT=0._EB
   CHARACTER(30), POINTER, DIMENSION(:) :: SPEC_ID
   CHARACTER(30) :: ID='null',FORMULA='null'
...
TYPE REACTION_TYPE
   ...
   CHARACTER(30), DIMENSION(:), POINTER :: SPEC_ID
   REAL(EB) :: EPUMO2,HEAT_OF_COMBUSTION,HOC_COMPLETE,BOF,E,N_F=0._EB,N_O=0._EB, &
      ...
      CRIT_FLAME_TMP,Y_F_LFL,Y_O2_LL,O2_F_RATIO=0._EB,Z_F=0._EB,Z_F_CONS=0._EB
   REAL(EB) :: COLLISION_EXPONENT=1._EB,AUTO_IGNITION_TEMPERATURE=0._EB,THRESHOLD_TEMP=0._EB
   REAL(EB), DIMENSION(:), POINTER :: NU,NU_SPECIES,N
   INTEGER :: FUEL_INDEX=-1,MODE,N_COLLISION_SPECIES=0,N_SPECIES=0
...
TYPE HUMAN_TYPE
   ...
   REAL(EB) :: T_FallenDown=0._EB, F_FallDown=0._EB, Angle_FallenDown=0._EB, SizeFac_FallenDown=0._EB
...
TYPE INITIALIZATION_TYPE
   ...
   INTEGER  :: PART_INDEX=0,NUMBER_INITIAL_DROPLETS,WALL_INDEX_START=-1,LU_DROPLET,PROF_INDEX=0,DEVC_INDEX=0,CTRL_INDEX=0
   LOGICAL :: ADJUST_DENSITY=.FALSE.,ADJUST_TEMPERATURE=.FALSE.,POINTWISE_DROPLET_INIT=.FALSE., &
              SINGLE_INSERTION=.TRUE.,ALREADY_INSERTED=.FALSE.
...
TYPE FILTER_TYPE
   ...
   CHARACTER(30) :: ID
   REAL(EB), DIMENSION(:), POINTER :: Z_INDEX
...
TYPE DUCTNODE_TYPE
   ...
   REAL(EB), DIMENSION(:), POINTER :: ZZ, FILTER_LOADING, DIR, BRANCH_LOSS, ZZ_V
