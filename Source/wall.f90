...
SELECT CASE(BC%IOR)
   ...
   CASE(-3) ; KK2=BC%KK+1
END SELECT
RHOP(II2,JJ2,KK2) = RHO_OTHER_2
ZZP(II2,JJ2,KK2,1:N_TOTAL_SCALARS) = MAX(0._EB,MIN(1._EB,RHO_ZZ_OTHER_2(1:N_TOTAL_SCALARS)/RHO_OTHER_2))
ZZ_GET(1:N_TRACKED_SPECIES) = ZZP(II2,JJ2,KK2,1:N_TRACKED_SPECIES)
CALL GET_SPECIFIC_GAS_CONSTANT(ZZ_GET,RSUM_TMP)
TMP(II2,JJ2,KK2) = PBAR_P(BC%KK,B1%PRESSURE_ZONE)/(RSUM_TMP*RHOP(II2,JJ2,KK2))
