...
IF (SF%VARIABLE_THICKNESS .OR. SF%HT_DIM>1) THEN
   ...
   DO NL=1,SF%N_LAYERS
      ...
      RAMP_IHS&MESH ID='mesh1', IJK=10,17,50, XB=0.0,0.1,0.0,0.17,0.0,0.30, COLOR='BLUE', CHECK_MESH_ALIGNMENT=T /
...
&OBST XB = 0.1,0.6,0.0,0.08,0.012,0.012, COLOR = 'GREEN', SURF_ID = 'PINE_NEEDLE_BED'/
...
&OBST XB = 0.0,0.7,0.0,0.08,0.0,0.0, COLOR = 'YELLOW', SURF_ID = 'ASBESTOS_SHEET'/
...
&OBST XB = 0.1,0.6,0.08,0.09,0.0,0.0, COLOR = 'ORANGE', SURF_ID = 'FIRE_CLAY'/

&OBST XB = 0.094,0.094,0.0,0.08,0.012,0.024, COLOR = 'BLUE', SURF_ID = 'IGNITER'/
&OBST XB = 0.098,0.098,0.0,0.08,0.012,0.024, COLOR = 'BLUE', SURF_ID = 'IGNITER'/
&OBST XB = 0.094,0.098,0.0,0.0,0.012,0.024, COLOR = 'BLUE', SURF_ID = 'IGNITER'/
&OBST XB = 0.094,0.098,0.08,0.08,0.012,0.024, COLOR = 'BLUE', SURF_ID = 'IGNITER'/
&OBST XB = 0.094,0.098,0.0,0.08,0.012,0.012, COLOR = 'BLUE', SURF_ID = 'IGNITER'/
&OBST XB = 0.094,0.098,0.0,0.08,0.024,0.024, COLOR = 'BLUE', SURF_ID = 'IGNITER'/

&REAC ID = 'CO_COMBUSTION',
FUEL = 'CARBON MONOXIDE',
SPEC_ID_NU = 'CARBON MONOXIDE','AIR','PRODUCT'
NU = -1,-0.47, 2.768095238/
...
&DEVC XB = 0.0,0.70,0.0,0.17,0.0,0.30, QUANTITY='MASS FRACTION', SPATIAL_STATISTIC='MEAN', SPEC_ID='CARBON MONOXIDE', ID='CO',TIME_AVERAGED=.FALSE. /
&DEVC XB = 0.0,0.70,0.0,0.17,0.0,0.30, QUANTITY='MASS FRACTION', SPATIAL_STATISTIC='MEAN', SPEC_ID='CARBON DIOXIDE', ID='CO2',TIME_AVERAGED=.FALSE. /
&DEVC XB = 0.0,0.70,0.0,0.17,0.0,0.30, QUANTITY='MASS FRACTION', SPATIAL_STATISTIC='MEAN', SPEC_ID='NITROGEN', ID='N2',TIME_AVERAGED=.FALSE. /
&DEVC XB = 0.0,0.70,0.0,0.17,0.0,0.30, QUANTITY='MASS FRACTION', SPATIAL_STATISTIC='MEAN', SPEC_ID='OXYGEN', ID='O2',TIME_AVERAGED=.FALSE. /
&DEVC XB = 0.0,0.70,0.0,0.17,0.0,0.30, QUANTITY='MASS FRACTION', SPATIAL_STATISTIC='MEAN', SPEC_ID='WATER VAPOR', ID='H2O',TIME_AVERAGED=.FALSE. /

&TAIL /(N_LAYERS)         = SF%RAMP_IHS_INDEX(N_LAYERS)
