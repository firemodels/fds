...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\large (FDS 5.2.0, Evac 2.0.1, SVN Revision 2225)}
  \end{center}
  \vspace{30pt}
  \begin{center}
...
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,
    width=80mm]{FIGURES/door_geometry2}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/FED_Test}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/Smoke_vs_speed}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=60mm]{FIGURES/DoorTestNoSmoke_Doors}
...
%
\begin{figure}[!bt]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/DoorTestSmokeDens}}
...
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=60mm]{FIGURES/DoorTestSmoke_Doors}
  x\includegraphics[clip=true,width=60mm]{FIGURES/DoorTestSmokeAlgorithm}}
...
%
\begin{figure}[!tb]
  \centerline{ \includegraphics[clip=true, width=75mm]{FIGURES/RCC_DoorCorr_new1} ~~
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/CorrFlowResults}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=60mm]{FIGURES/StairsType1Lam0p3}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=60mm]{FIGURES/StairsType2Lam0p3}
...
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=120mm]{FIGURES/Library_Kuva2}}
...
\begin{figure}[!tb]
  ...
  \caption{The geometry of the studied sports hall.  The open grey
    ...
    simulations.  The red rectangle shows the fire location, which is
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/EerikkilaResults}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/PankkiTulokset}}
...
%% \begin{figure}[!tb]
%%   \centerline{\includegraphics[clip=true,width=120mm]{FIGURES/Kaytava_fig}}
...
\item Assembly space: The second test case is a large fictitious
  ...
  Fig.~\ref{Fig_AssemblySnapshots}a.  The FDS+Evac results are
  compared to those of Simulex and buildingExodus~\cite{Exodus3} in
...
%
%% \begin{figure}[!tb]
%%   \centerline{\includegraphics[clip=true,width=120mm]{Door_Geom}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=120mm]{FIGURES/OviFlowRersults}}
...
%
\item[\Timts{DENS\_INIT}] If > 2.0~$\mathrm{\textrm{m}^\textrm{2}}$,
  then agents are tried to put on the initial positions so that they
  can be touching.  The default is to leave some space between agents
  and very large agent densities are not possible.  Note that FDS+Evac
  puts agents randomly in their initial positions and, thus, the
  initial density of agents can not be much larger than four agents
  per square meter. (Default is 0.0~$\mathrm{\textrm{m}^\textrm{2}}$.)
%
\item[\Timts{HUMAN\_SMOKE\_HEIGHT}] Specifies the level above the
  ...
  parameter \Timts{EVAC\_Z\_OFFSET} and the co-ordinates of the
  evacuation meshes define the floor levels.  (Default is 1.6~m.)
%
...
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,
    width=80mm]{FIGURES/evac_example1_EvacGeom}~~\includegraphics[clip=true,
    width=80mm]{FIGURES/evac_example1_FireGeom}}
...
%\begin{figure}[!tb]
%  \centerline{\includegraphics[clip=true,
%    width=120mm]{evac_example1_FireGeom}}
...
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,
    width=120mm]{FIGURES/evac_example2_EvacGeom}}
...
\bibitem{Hostikka07b} Hostikka, S., Paloposki, T., Rinne, T., Saari,
  J-M., Korhonen, T., Heli\"ovaara, S., ``Experimental Observations of
...
\bibitem{Helbing95} Helbing, D., and Moln\'ar, P., ``Social force model
  for pedestrian dynamics'', \emph{Physical Review E} 51: 4282-4286
  (1995).
%
...
\bibitem{Werner03} Werner, T. and Helbing, D., ``The social force
  ...
  International Conference}, University of Greenwich, London, 2003,
  pp.~17-26.
%
\bibitem{Langston06} Langston, P.A., Masling, R., Asmar, B.N., ``Crowd
  dynamics discrete element multi-circle model,'' \emph{Safety Science}
  44: 395-417 (2006).
%
