...
DO J0 = 0, N-1
DO K0 = 0, N-1
V0(0) = 0.01_EB + REAL(I0,EB)*0.2_EB/REAL(N-1,EB)
V0(1) = 0.01_EB + REAL(J0,EB)*0.2_EB/REAL(N-1,EB)
V0(2) = 0.01_EB + REAL(K0,EB)*0.2_EB/REAL(N-1,EB)
DO I1 = 0, N-1
DO J1 = 0, N-1
DO K1 = 0, N-1
V1(0) = 0.8_EB + REAL(I1,EB)*0.2_EB/REAL(N-1,EB)
V1(1) = 0.01_EB + REAL(J1,EB)*0.2_EB/REAL(N-1,EB)
V1(2) = 0.01_EB + REAL(K1,EB)*0.2_EB/REAL(N-1,EB)
DO I2 = 0, N-1
DO J2 = 0, N-1
DO K2 = 0, N-1
V2(0) = 0.01_EB + REAL(I2,EB)*0.98_EB/REAL(N-1,EB)
V2(1) = 0.8_EB + REAL(J2,EB)*0.2_EB/REAL(N-1,EB)
V2(2) = 0.01_EB + REAL(K2,EB)*0.2_EB/REAL(N-1,EB)
DO I3 = 0, N-1
DO J3 = 0, N-1
DO K3 = 0, N-1
V3(0) = 0.01_EB + REAL(I3,EB)*0.98_EB/REAL(N-1,EB)
V3(1) = 0.01_EB + REAL(J3,EB)*0.98_EB/REAL(N-1,EB)
V3(2) = 0.81_EB + REAL(K3,EB)*0.2_EB/REAL(N-1,EB)
...
END DO
COUNT=COUNT+1
IF(ABS(VOL_TETRA-VOL).GT.1.0E-5_EB*ABS(VOL_TETRA)+1.0E-5_EB)THEN
