...
!$OMP SHARED(N_EXTERNAL_WALL_CELLS,N_INTERNAL_WALL_CELLS,OMESH,PREDICTOR,MU,KRES,D,DS) &
...
!$OMP        WALL_INDEX,I_CELL,J_CELL,K_CELL,BOUNDARY_TYPE,NOM,SURFACE,VENT_INDEX,VENTS, &
...
!$OMP SHARED(N_EXTERNAL_WALL_CELLS,BOUNDARY_TYPE,OMESH,MESHES,PREDICTOR,CORRECTOR, &
...
!$OMP        N_EXTERNAL_WALL_CELLS,BOUNDARY_TYPE,VENT_INDEX,VENTS,TW,T_BEGIN,T,DUMMY,UU,VV,WW, &
