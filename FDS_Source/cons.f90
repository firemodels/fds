...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           PROJECTION=.FALSE.,CLIP_MASS_FRACTION=.FALSE.,CHECK_VN=.FALSE.,LIMIT_MU=.TRUE., &
           ...
           VELOCITY_ERROR_FILE=.FALSE.,CONSTANT_SPECIFIC_HEAT=.FALSE.,MEAN_FORCING(3)=.FALSE.,CHECK_HT=.FALSE., &
           ...
           COMPUTE_VISCOSITY_TWICE=.TRUE.,PARTICLE_CFL=.TRUE.,IBM_FEM_COUPLING=.FALSE.,FDS5_OPTIONS=.FALSE.,&
           ENTHALPY_TRANSPORT=.TRUE.
...
CHARACTER(30) :: COMPILE_DATE='null',VERSION_STRING='null'
...
REAL(EB) :: MW_AIR=28.84852_EB,MW_N2,MW_O2,MW_CO2,MW_H2O,MW_CO,MW_H2,&
            ...
            EC_LL,Y_P_MIN_EDC=0.01_EB,HRRPUV_AVERAGE,&
            FIXED_MIX_TIME=-1._EB,INITIAL_UNMIXED_FRACTION=1._EB,RICHARDSON_ERROR_TOLERANCE=1.E-3_EB
INTEGER :: N_SPECIES=0,N_REACTIONS,I_PRODUCTS=-1,I_WATER=-1,I_CO2=-1,N_TRACKED_SPECIES=0,N_SURFACE_DENSITY_SPECIES=0,SERIES_REAC=0
INTEGER :: COMBUSTION_ODE = -1,EXTINCT_MOD = -1
LOGICAL :: SIMPLE_CHEM = .TRUE.,TEMPERATURE_DEPENDENT_REACTION=.FALSE.,OUTPUT_CHEM_IT=.FALSE.
REAL(EB) :: RSUM0
...
INTEGER :: I_RAMP_AGT,I_RAMP_GX,I_RAMP_GY,I_RAMP_GZ,N_RAMP=0
...
INTEGER :: PRESSURE_ITERATIONS=0,MAX_PRESSURE_ITERATIONS=10
...
REAL(EB) :: BNDC_CLOCK,BNDE_CLOCK,GEOC_CLOCK,GEOM_CLOCK,UVW_CLOCK,UVW_TIMER(10)
REAL(EB) :: UVW_CLOCK_CBC(1:4)=(/0._EB,0.28_EB,0.67_EB,1.E10_EB/),MMS_CLOCK=1._EB
