...
TYPE GEOMETRY_TYPE
   ...
   LOGICAL :: COMPONENT_ONLY,IS_DYNAMIC=.TRUE.,HAVE_SURF,HAVE_MATL,AUTO_TEXTURE,HIDDEN,REMOVEABLE
...
TYPE IBM_RCEDGE_TYPE
   ...
   ! INT_VEL_IND = 1; INT_VELS_IND = 2; INT_FV_IND = 3; INT_DHDX_IND = 4; N_INT_VARS = 4;
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:)      :: INT_VARS       ! (1:N_INT_VARS,INT_NPE_LO+1:INT_NPE_LO+INT_NPE_HI)
