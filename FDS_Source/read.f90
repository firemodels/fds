...
NAMELIST /INIT/ CTRL_ID,DENSITY,DEVC_ID,DT_INSERT,HRRPUV,MASS_FRACTION,MASS_PER_TIME,MASS_PER_VOLUME,MULT_ID,&
                NUMBER_INITIAL_PARTICLES,ORIGIN,PART_ID,PROF_ID,SHAPE,SPEC_ID,TEMPERATURE,UNIFORM,UVW,XB
...
NAMELIST /ISOF/ AUTO_HRRPUV_VALUE,COLOR_SPEC_ID,FYI,QUANTITY,REDUCE_TRIANGLES,SPEC_ID,VALUE,VELO_INDEX
