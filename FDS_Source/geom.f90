...
DO I = 1, N_GEOMETRY
   G=>GEOMETRY(I)
   IF (G%IS_DYNAMIC) THEN
      GEOMETRY_CHANGE_STATE=1
      CYCLE
   ENDIF
...
! to do
! 1.  when using dynamic geometries, CONVERTGEOM should be called whenever these geometries change
...
! need to fix allocation before calling this routine here
! IF (GEOMETRY_STATUS==1) CALL CONVERTGEOM(T)
