...
REAL(EB) :: RADIUS,AREA_SCALING,RVC,M_DOT_PPP_SINGLE,M_DOT_SINGLE,CP,CPBAR,MW_RATIO,H_G,&
...
REAL(EB) :: UN,DD,MFT,TSI,ZZ_GET(1:N_TRACKED_SPECIES),RSUM_F,MPUA_SUM,RHO_F_PREVIOUS,RN1,RN2,TWOMFT,CPBAR2,Q_NEW
INTEGER :: N,ITER
...
REAL(EB) :: DTMP,REACTION_RATE,Y_O2,X_O2,Q_DOT_S_PPP,MW_G,X_G,X_W,D_AIR,H_MASS,RE_L,SHERWOOD,MFLUX,MU_AIR,SC_AIR,U_TANG,&
            ...
            RHO_DOT,DR,R_S_0,R_S_1,SH_FAC_WALL,H_R,H_R_B,T_BOIL_EFF,H_S_B,H_S
