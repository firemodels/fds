...
NAMELIST /COMB/ AUTO_IGNITION_TEMPERATURE,CHECK_REALIZABILITY,DT_SPARK,EXTINCTION_MODEL,FREE_BURN_TEMPERATURE,FIXED_MIX_TIME,&
...
IF (DT_SPARK<0._EB) DT_SPARK = CHARACTERISTIC_CELL_SIZE/LAMINAR_FLAME_SPEED
