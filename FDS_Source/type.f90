...
TYPE PARTICLE_CLASS_TYPE
   ...
   INTEGER :: SAMPLING,SPEC_INDEX=-1,Y_INDEX=-1,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
...
TYPE SPECIES_TYPE
   REAL(EB) :: MW=0._EB,YY0=0._EB,RCON,MAXMASS,MASS_EXTINCTION_COEFFICIENT=8700._EB,D(5000),&
   ...
   LOGICAL :: ABSORBING=.FALSE.,ISFUEL=.FALSE.
   CHARACTER(30):: ID,FORMULA
   INTEGER :: MODE=2,INDEX=-1,Y_INDEX=-1
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   INTEGER, POINTER, DIMENSION(:) :: SPEC_INDEX
...
TYPE MATERIAL_TYPE
   ...
   REAL(EB), DIMENSION(1:MAX_REACTIONS) :: TMP_REF,TMP_IGN,TMP_THR,RATE_REF,THR_SIGN
   ...
   LOGICAL, DIMENSION(1:MAX_REACTIONS) :: PCR = .FALSE.
...
TYPE VENTS_TYPE
   ...
   LOGICAL :: ACTIVATED=.TRUE.,BOUNDARY_FORCING=.FALSE.,GHOST_CELLS_ONLY=.FALSE.
...
TYPE NODE_BC_TYPE
   REAL(EB), DIMENSION(:), POINTER :: YY_V
