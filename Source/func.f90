...
LC=LC+1 ; CALL EQUATE(OS%LOGICALS(LC,1),WC%THIN(1),UNPACK_IT)
LC=LC+1 ; CALL EQUATE(OS%LOGICALS(LC,1),WC%THIN(2),UNPACK_IT)
LC=LC+1 ; CALL EQUATE(OS%LOGICALS(LC,1),WC%THIN(3),UNPACK_IT)
...
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),BC%DX,UNPACK_IT)
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),BC%DY,UNPACK_IT)
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),BC%DZ,UNPACK_IT)
...
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),ONE_D%N_CELLS_MAX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),ONE_D%N_CELLS_INI,UNPACK_IT)
...
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),ONE_D%M_DOT_PART_ACTUAL,UNPACK_IT)
