...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,TMPM,RHOA,RHO_LOWER_GLOBAL,RHO_UPPER_GLOBAL,P_INF,P_STP,GRAV,R0,R1, &
            ...
            RFAC_FORCING=0.5_EB,PARTICLE_CFL_MAX=1.0_EB
...
REAL(EB),ALLOCATABLE, DIMENSION(:) :: HRR,RHRR,CHRR,FHRR,FUEL_DROPLET_MLR,MLR,HRR_SUM,RHRR_SUM,CHRR_SUM,FHRR_SUM,MLR_SUM,HRR_TIME_INTERVAL
