...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               ...
               REAL_REFRACTIVE_INDEX,COMPLEX_REFRACTIVE_INDEX,TOL_INT,DENSITY,FTPR,FREE_AREA_FRACTION
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: R_CDF,CDF,BREAKUP_R_CDF,BREAKUP_CDF,W_CDF,R50,LAMBDA
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: WQABS,WQSCA
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: ORIENTATION
   INTEGER :: SAMPLING,N_QUANTITIES,QUANTITIES_INDEX(10),ARRAY_INDEX=0,RGB(3),RADIATIVE_PROPERTY_INDEX=0, &
              SURF_INDEX=0,DRAG_LAW=1,DEVC_INDEX=0,CTRL_INDEX=0,PROP_INDEX=-1,N_ORIENTATION,Z_INDEX=-1,N_STRATA=7, &
              Y_INDEX=-1,CNF_RAMP_INDEX=-1,BREAKUP_CNF_RAMP_INDEX=-1,N_STORAGE_REALS,N_STORAGE_INTEGERS,N_STORAGE_LOGICALS
   INTEGER,  ALLOCATABLE, DIMENSION(:) :: IL_CDF,IU_CDF
   LOGICAL :: STATIC=.FALSE.,MASSLESS,MONODISPERSE=.FALSE.,TURBULENT_DISPERSION=.FALSE., &
              BREAKUP=.FALSE.,CHECK_DISTRIBUTION=.FALSE.,FUEL=.FALSE.
...
TYPE LAGRANGIAN_PARTICLE_TYPE
   ...
   INTEGER, POINTER :: TAG,ARRAY_INDEX,STORAGE_INDEX,CLASS_INDEX,ORIENTATION_INDEX,WALL_INDEX
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=16,N_WALL_SCALAR_INTEGERS=10,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,LP_CPUA,LP_MPUA,AWM_AEROSOL,RHODW,ZZ_F,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,RAW,RDN,RHO_F,U_TAU,UVW_GHOST,UW0,XW,Y_PLUS,YW,ZW,VEG_HEIGHT,VELOCITY_ERROR
...
TYPE SPECIES_TYPE
   ...
   CHARACTER(30) :: ID,RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D,DATA_ID,RADCAL_ID
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   CHARACTER(30), ALLOCATABLE, DIMENSION(:) :: SPEC_ID
...
TYPE REACTION_TYPE
   ...
   CHARACTER(30), ALLOCATABLE, DIMENSION(:) :: SMIX_ID,SMIX_ID_READ,SPEC_ID,SPEC_ID_READ
   REAL(EB) :: C,H,N,O,EPUMO2,HEAT_OF_COMBUSTION,HOC_COMPLETE,A,A_IN,A_LEAN,E,E_IN,E_LEAN,&
      Y_O2_INFTY,Y_N2_INFTY=0._EB,MW_FUEL,MW_SOOT,X_O2_LL,Y_O2_LL,Y_F_LFL,&
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: NU,NU_READ,NU_SPECIES,N_S,N_S_READ
   INTEGER :: FUEL_SMIX_INDEX=-1,MODE,N_SMIX,N_SPEC
   LOGICAL :: IDEAL,CHECK_ATOM_BALANCE,EDCM,REVERSIBLE=.FALSE.,FAST_CHEMISTRY=.FALSE.,PHI_DEPENDENCE=.FALSE.
...
TYPE MATERIAL_TYPE
   REAL(EB) :: K_S,C_S,RHO_S,EMISSIVITY,DIFFUSIVITY,KAPPA_S,MOISTURE_FRACTION,TMP_BOIL,INIT_VAPOR_FLUX,POROSITY
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT=-1._EB,TMP_BACK=-1._EB,VEL,VEL_GRAD,PLE,Z0,CONVECTIVE_HEAT_FLUX,NET_HEAT_FLUX, &
               ...
               TMP_IGN,H_V,LAYER_DIVIDE,ROUGHNESS,RADIUS=-1._EB,LENGTH=-1._EB,WIDTH=-1._EB, &
   ...
   CHARACTER(30), ALLOCATABLE, DIMENSION(:) :: MATL_NAME
   ...
   LOGICAL :: BURN_AWAY,ADIABATIC,THERMALLY_THICK,INTERNAL_RADIATION,USER_DEFINED=.TRUE., &
              ...
              SPECIFIED_NORMAL_GRADIENT=.FALSE.
...
TYPE(VERTEX_TYPE), ALLOCATABLE, DIMENSION(:) :: VERTEX
...
TYPE(VOLUME_TYPE), ALLOCATABLE, DIMENSION(:) :: VOLUME
...
TYPE INITIALIZATION_TYPE
   REAL(EB) :: TEMPERATURE,DENSITY,MASS_FRACTION(MAX_SPECIES)=0._EB,X1,X2,Y1,Y2,Z1,Z2,MASS_PER_VOLUME,MASS_PER_TIME,DT_INSERT, &
               X0,Y0,Z0,U0,V0,W0,VOLUME,HRRPUV=0._EB,DX=0._EB,DY=0._EB,DZ=0._EB,HEIGHT,RADIUS
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: PARTICLE_INSERT_CLOCK
   INTEGER  :: PART_INDEX=0,N_PARTICLES,LU_PARTICLE,PROF_INDEX=0,DEVC_INDEX=0,CTRL_INDEX=0,TABL_INDEX=0, &
               N_PARTICLES_PER_CELL=0
   LOGICAL :: ADJUST_DENSITY=.FALSE.,ADJUST_TEMPERATURE=.FALSE.,SINGLE_INSERTION=.TRUE.,ALREADY_INSERTED=.FALSE., &
              CELL_CENTERED=.FALSE.
   CHARACTER(30) :: SHAPE,DEVC_ID,CTRL_ID,ID
