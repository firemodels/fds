...
TYPE SPECIES_TYPE
   ...
   CHARACTER(LABEL_LENGTH) :: ID,RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D,RADCAL_ID,RAMP_G_F
...
TYPE GEOMETRY_TYPE
   ...
   LOGICAL :: COMPONENT_ONLY, HAS_SURF=.FALSE., HAS_MATL=.FALSE.,IS_DYNAMIC=.TRUE.
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: VERTS_BASE, VERTS, TVERTS, DAZIM, DELEV, ZVALS
