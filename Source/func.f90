...
IF (PRESENT(LP_INDEX)) THEN
   ...
   B1_INDEX = M%LAGRANGIAN_PARTICLE(LP_INDEX)%B1_INDEX
   B2_INDEX = M%LAGRANGIAN_PARTICLE(LP_INDEX)%B2_INDEX
   ...
   M%LAGRANGIAN_PARTICLE(LP_INDEX)%B1_INDEX = B1_INDEX
   M%LAGRANGIAN_PARTICLE(LP_INDEX)%B2_INDEX = B2_INDEX
...
ELSEIF (PRESENT(WALL_INDEX)) THEN
   ...
   M%WALL(WALL_INDEX)%B1_INDEX   = B1_INDEX
   M%WALL(WALL_INDEX)%B2_INDEX   = B2_INDEX
...
ELSEIF (PRESENT(THIN_WALL_INDEX)) THEN
   ...
   B1_INDEX = M%THIN_WALL(THIN_WALL_INDEX)%B1_INDEX
   IF (SF%INCLUDE_BOUNDARY_COORD_TYPE) CALL ALLOCATE_BOUNDARY_COORD_ARRAYS
   IF (SF%INCLUDE_BOUNDARY_PROP1_TYPE) CALL ALLOCATE_BOUNDARY_PROP1_ARRAYS
   IF (SF%INCLUDE_BOUNDARY_ONE_D_TYPE) CALL ALLOCATE_BOUNDARY_ONE_D_ARRAYS
   IF (SF%INCLUDE_BOUNDARY_THR_D_TYPE) CALL ALLOCATE_BOUNDARY_THR_D_ARRAYS
   ...
   M%THIN_WALL(THIN_WALL_INDEX)%B1_INDEX   = B1_INDEX
...
ELSEIF (PRESENT(CFACE_INDEX)) THEN
   ...
   B1_INDEX = M%CFACE(CFACE_INDEX)%B1_INDEX
   B2_INDEX = M%CFACE(CFACE_INDEX)%B2_INDEX
   ...
   M%CFACE(CFACE_INDEX)%B1_INDEX = B1_INDEX
   M%CFACE(CFACE_INDEX)%B2_INDEX = B2_INDEX
