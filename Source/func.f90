...
SF%ONE_D_REALS_ARRAY_SIZE( 7) = N_TRACKED_SPECIES            ! ZZ_G
SF%ONE_D_REALS_ARRAY_SIZE( 8) = N_TRACKED_SPECIES            ! ZZ_F
SF%ONE_D_REALS_ARRAY_SIZE( 9) = N_TRACKED_SPECIES            ! RHO_D_F
SF%ONE_D_REALS_ARRAY_SIZE(10) = N_TRACKED_SPECIES            ! RHO_D_DZDN_F
SF%ONE_D_REALS_ARRAY_SIZE(11) = SF%N_CELLS_MAX               ! RHO_C_S
SF%ONE_D_REALS_ARRAY_SIZE(12) = SF%N_CELLS_MAX+2             ! K_S
SF%ONE_D_REALS_ARRAY_SIZE(13) = N_SURFACE_DENSITY_SPECIES    ! AWM_AEROSOL
SF%ONE_D_REALS_ARRAY_SIZE(14) = SF%N_LAYERS                  ! DDSUM
SF%ONE_D_REALS_ARRAY_SIZE(15) = SF%N_LAYERS                  ! SMALLEST_CELL_SIZE
SF%ONE_D_REALS_ARRAY_SIZE(16) = SF%N_LPC                     ! PART_MASS
SF%ONE_D_REALS_ARRAY_SIZE(17) = SF%N_LPC                     ! PART_ENTHALPY
SF%ONE_D_REALS_ARRAY_SIZE(18) = (SF%N_CELLS_MAX+2)*SF%N_MATL ! RHO
SF%ONE_D_REALS_ARRAY_SIZE(19) = (SF%N_CELLS_MAX+2)*SF%N_MATL ! RHO_DOT
SF%ONE_D_REALS_ARRAY_SIZE(20) = (SF%N_CELLS_MAX+2)*SF%N_SPEC ! RHO (gas)
...
IF (.NOT.ALREADY_ALLOCATED) THEN
   ...
   ALLOCATE(ONE_D%ZZ_G(SF%ONE_D_REALS_ARRAY_SIZE(7)))
   IF (ALLOCATED(ONE_D%ZZ_F)) DEALLOCATE(ONE_D%ZZ_F)
   ALLOCATE(ONE_D%ZZ_F(SF%ONE_D_REALS_ARRAY_SIZE(8)))
   IF (ALLOCATED(ONE_D%RHO_D_F)) DEALLOCATE(ONE_D%RHO_D_F)
   ALLOCATE(ONE_D%RHO_D_F(SF%ONE_D_REALS_ARRAY_SIZE(9)))
   IF (ALLOCATED(ONE_D%RHO_D_DZDN_F)) DEALLOCATE(ONE_D%RHO_D_DZDN_F)
   ALLOCATE(ONE_D%RHO_D_DZDN_F(SF%ONE_D_REALS_ARRAY_SIZE(10)))
   IF (ALLOCATED(ONE_D%RHO_C_S)) DEALLOCATE(ONE_D%RHO_C_S)
   ALLOCATE(ONE_D%RHO_C_S(SF%ONE_D_REALS_ARRAY_SIZE(11)))
   IF (ALLOCATED(ONE_D%K_S)) DEALLOCATE(ONE_D%K_S)
   ALLOCATE(ONE_D%K_S(0:SF%ONE_D_REALS_ARRAY_SIZE(12)-1))
   IF (ALLOCATED(ONE_D%AWM_AEROSOL)) DEALLOCATE(ONE_D%AWM_AEROSOL)
   ALLOCATE(ONE_D%AWM_AEROSOL(SF%ONE_D_REALS_ARRAY_SIZE(13)))
   IF (ALLOCATED(ONE_D%DDSUM)) DEALLOCATE(ONE_D%DDSUM)
   ALLOCATE(ONE_D%DDSUM(SF%ONE_D_REALS_ARRAY_SIZE(14)))
   IF (ALLOCATED(ONE_D%SMALLEST_CELL_SIZE)) DEALLOCATE(ONE_D%SMALLEST_CELL_SIZE)
   ALLOCATE(ONE_D%SMALLEST_CELL_SIZE(SF%ONE_D_REALS_ARRAY_SIZE(15)))
   IF (ALLOCATED(ONE_D%PART_MASS)) DEALLOCATE(ONE_D%PART_MASS)
   ALLOCATE(ONE_D%PART_MASS(SF%ONE_D_REALS_ARRAY_SIZE(16)))
   IF (ALLOCATED(ONE_D%PART_ENTHALPY)) DEALLOCATE(ONE_D%PART_ENTHALPY)
   ALLOCATE(ONE_D%PART_ENTHALPY(SF%ONE_D_REALS_ARRAY_SIZE(17)))
...
ONE_D%ZZ_G = SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%ZZ0
ONE_D%ZZ_F = SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%ZZ0
ONE_D%RHO_D_F = 0._EB
