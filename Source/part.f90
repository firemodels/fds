...
IF (IP<NLP-IKILL) THEN
   IF (LP%BC_INDEX>0) M%BOUNDARY_COORD_OCCUPANCY(LP%BC_INDEX) = 0
   IF (LP%OD_INDEX>0) M%BOUNDARY_ONE_D_OCCUPANCY(LP%OD_INDEX) = 0
   IF (LP%BP_INDEX>0) M%BOUNDARY_PROPERTY_OCCUPANCY(LP%BP_INDEX) = 0
