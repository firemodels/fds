...
\be X_{\rm l} = \exp \left[ \frac{h_v \, W_{\rm l}}{\cal R}
...
\be
   \frac{\d Y_{\rm l}}{\d T_{\rm l}} = \frac{\d Y_{\rm l}}{\d X_{\rm l}} \, \frac{\d X_{\rm l}}{\d T_{\rm l}}  = \frac{W_{\rm a}/W_{\rm l}}{ (X_{\rm l} (1-W_{\rm a}/W_{\rm l}) + W_{\rm a}/W_{\rm l})^2 } \;
     \frac{h_v W_{\rm l}}{{\cal R} \, T_{\rm l}^2} \, \exp \left[ \frac{h_v \, W_{\rm l}}{\cal R} \left( \frac{1}{T_{\rm b}}-\frac{1}{T_{\rm l}} \right) \right]
\ee
