   ...
   CASE(INFINITELY_FAST)
      ...
      REACTION_LOOP_1: DO I=1,N_REACTIONS
         ...
         IF (RN%AIR_SMIX_INDEX > 0) THEN
            DZ_F = ZZ_0(RN%FUEL_SMIX_INDEX)*ZZ_0(RN%AIR_SMIX_INDEX) ! 2nd-order reaction
         ELSE
            DZ_F = ZZ_0(RN%FUEL_SMIX_INDEX) ! 1st-order
         ENDIF
      ...
      DT_TMP = HUGE_EB
      DO NS = 1,N_TRACKED_SPECIES
         IF (DZZ(NS) < -TWO_EPSILON_EB) DT_TMP(NS) = -ZZ_0(NS)/DZZ(NS)
      ENDDO
      DZZ = DZZ*MINVAL(DT_TMP)
