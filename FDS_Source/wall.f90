...
REAL(EB) :: RADIUS,AREA_SCALING,RVC,M_DOT_PPP_SINGLE,CP,CPBAR,MW_RATIO,H_G,DELTA_H_G,ZZ_GET(1:N_TRACKED_SPECIES),CPBAR2
REAL(EB), INTENT(IN) :: T,DT
INTEGER, INTENT(IN) :: NM
...
PARTICLE_LOOP: DO IP=1,NLP
   ...
   DO NS=1,N_TRACKED_SPECIES
      ...
      D_LAGRANGIAN(IIG,JJG,KKG) = D_LAGRANGIAN(IIG,JJG,KKG) + M_DOT_PPP_SINGLE*(MW_RATIO + DELTA_H_G/H_G)/RHOP(IIG,JJG,KKG)
