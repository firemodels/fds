...
REAL(EB), INTENT(INOUT) :: TMP_MIXED,Q_REAC_OUT(1:N_REACTIONS)
...
REAL(EB) :: ZZ_0(1:N_TRACKED_SPECIES),ZZ_NEW(1:N_TRACKED_SPECIES),DZZ(1:N_TRACKED_SPECIES),UNMIXED_MASS_0(1:N_TRACKED_SPECIES),&
            BOUNDEDNESS_CORRECTION,MIXED_MASS(1:N_TRACKED_SPECIES),MIXED_MASS_0(1:N_TRACKED_SPECIES),TOTAL_MIXED_MASS,&
            TOTAL_MIXED_MASS_0,Q_REAC_TEMP(1:N_REACTIONS)
INTEGER :: SR
...
REAL(EB), INTENT(OUT) :: ZZ_OUT(1:N_TRACKED_SPECIES),ZETA_OUT
REAL(EB), INTENT(INOUT) :: TMP_MIXED,Q_REAC_TEMP(1:N_REACTIONS)
...
DO N=1,N_INC
   ...
   Q_REAC_TEMP = Q_REAC_TEMP + 0.5_EB*(Q_REAC_1+Q_REAC_2) * DT_LOC
   ZZ_0 = ZZ_OUT
   ZETA_OUT = ZETA_1
   ZETA_0 = ZETA_OUT
ENDDO
