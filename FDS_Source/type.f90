...
TYPE PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: DENSITY,TMP_V,TMP_MELT,FTPR,HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
   ...
   INTEGER :: SAMPLING,SPEC_INDEX,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
              SURF_INDEX=-1,DRAG_LAW=1,DEVC_INDEX=0,CTRL_INDEX=0,PROP_INDEX=-1
...
TYPE DROPLET_TYPE
   REAL(EB) :: X,Y,Z,TMP,U,V,W,R,PWT,A_X,A_Y,A_Z,T,RE=0._EB, &
               ...
               VEG_IGN_TOFF,VEG_IGN_TRAMPON,VEG_IGN_TRAMPOFF,VEG_CHAR_MASS,VEG_SV,VEG_MLR
   LOGICAL  :: IGNITOR
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT,TMP_INNER,VEL,PLE,Z0,CONVECTIVE_HEAT_FLUX,NET_HEAT_FLUX, &
               ...
               DT_INSERT,H_FIXED=-1._EB,EMISSIVITY_BACK,CONV_LENGTH
   ...
   REAL(EB), DIMENSION(-5:MAX_SPECIES) :: TAU
...
!                                                               Boundary vegetation
   ...
   INTEGER  :: NVEG_L
   REAL(EB) :: VEG_CHARFRAC,VEG_DRAG_INI,VEG_ELEMENT_DENSITY,VEG_HEIGHT,VEG_LOAD, &
               VEG_MOISTURE,VEG_SVRATIO,VEG_PACKING,VEG_KAPPA
...
TYPE INITIALIZATION_TYPE
   ...
   INTEGER  :: PART_INDEX=0,NUMBER_INITIAL_DROPLETS,WALL_INDEX_START=-1
