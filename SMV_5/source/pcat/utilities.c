...
void version(void){
    char pcat_version[100];
    int svn_num;

    getPCATversion(pcat_version);  // get Smokeview version (ie 5.x.z)
...
void getPCATversion(char *PCATversion){
  strcpy(PCATversion,PCATVERSION);
}
