...
REAL :: ACTIVATION_TEMPERATURE,ALPHA,AREA,A_T,A_V,CHI_R,CONDUIT_DIAMETER,CONDUIT_THICKNESS,C_S,D,DELTA,DT,H, &
        ...
        RADIATIVE_FRACTION,RHO_S,RTI,T,t_activation,T_END,TMP_A,TMP_G,T_P,T_CLOCK,U_JET,V,V_DOT,W,W_V
...
NAMELIST /SPKACT/ Q,T2_RAMP,RTI,ACTIVATION_TEMPERATURE,H,R,TMP_A,RADIATIVE_FRACTION,OUTPUT_FILE
...
DO WHILE (ITER)
   Q_C = ALPHA * T**2 * (1 - RADIATIVE_FRACTION)
