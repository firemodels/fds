...
The FM/SNL tests consisted of propylene gas burners, heptane pools, methanol pools, PMMA solids, as well as qualified and unqualified cables, burned in a large room which, for the first 18 tests, was free of obstructions. Plume Temperatures shown here are recorded at approximately 6 m from the floor, or .98 times the total ceiling height.
...
\includegraphics[height=2.2in]{FIGURES/FM_SNL/FM_SNL_18_Plume_Temperature} \\
\includegraphics[height=2.2in]{FIGURES/FM_SNL/FM_SNL_19_Plume_Temperature} \\
\end{tabular}
