...
!$OMP SHARED(N_EXTERNAL_WALL_CELLS,IJKW,PRESSURE_BC_INDEX,BXS,BXF,BYS,BYF,BZS,BZF,HX,HY,HZ,FVX,FVY,FVZ,DUWDT, &
!$OMP        IBP1,JBP1,KBP1, &
!$OMP        BOUNDARY_TYPE,PREDICTOR,CORRECTOR,RFODT,UWP,U,V,W,US,VS,WS,IBAR,JBAR,KBAR,DX,DY,DZ, &
!$OMP        DUUDT,DVVDT,DWWDT,HP, &
!$OMP        OMESH,MESHES,WALL_WORK1, &
!$OMP        VENT_INDEX,VENTS,TW,T_BEGIN,T,DUMMY,UU,VV,WW,RHO_F,KRES,H0, &
