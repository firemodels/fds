...
PROF_LOOP: DO N=1,N_PROF
   ...
   DO I = 1, NWP
      IF (PF%WALL_INDEX>0) THEN
         PF_TEMP(I) = SOLID_PHASE_OUTPUT(ABS(PF%QUANTITY_INDEX),1,1,LP%CLASS_INDEX,&
   ...
   IF (PF%QUANTITY == 'INSIDE WALL TEMPERATURE') THEN
      IF (PF%WALL_INDEX>0) THEN
         PF_TEMP(0) = SOLID_PHASE_OUTPUT(ABS(PF%QUANTITY_INDEX),1,1,LP%CLASS_INDEX,&
                                          OPT_WALL_INDEX=PF%WALL_INDEX,OPT_NODE_INDEX=0,OPT_PROF_INDEX=N)
         PF_TEMP(NWP+1) = SOLID_PHASE_OUTPUT(ABS(PF%QUANTITY_INDEX),1,1,LP%CLASS_INDEX,&
