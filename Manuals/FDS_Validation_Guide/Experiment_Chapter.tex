...
The experimental design provided data on the performance of alarms in various installation arrangements.
...
Mark Sippola, a doctoral student at the University of California, Berkeley,
measured deposition rates for various sizes of monodisperse fluorescent particles and
various air velocities in a duct \cite{Sippola:2002,Sippola:2010}. For the experiments
considered here, the straight duct was square with dimensions of 15~cm by 15~cm. The
particle sizes were 1~$\mu$m, 3~$\mu$m, 5~$\mu$m, 9~$\mu$m, and 16~$\mu$m. The air velocities
in the duct were 2.2~m/s, 5.3~m/s, and 9.0~m/s. A total of twelve panels (20~cm x 10~cm)
were cut from a duct section to measure the amount of particles deposited; four panels
each from the duct ceiling, wall, and floor surfaces. Fluorescent techniques were used
to measure the deposition velocities of the particles to duct surfaces (ceiling, wall,
and floor) at two straight duct sections where the turbulent flow profile was fully developed.
