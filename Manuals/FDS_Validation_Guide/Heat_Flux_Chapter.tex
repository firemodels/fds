...
Figure~\ref{FM_Burner_Vertical_Heat_Flux} displays mean and rms vertical profiles of the radiation emission, in units of kW/m, from 15~kW, 15.2~cm diameter, ethylene flames at oxygen concentrations of 20.9~\%, 16.8~\%, and 15.2~\% oxygen.
...
\begin{figure}[h!]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Summary of SETCOM results.}
