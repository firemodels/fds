...
The following figures display the temperature of  the ceiling jet at the location of sprinklers for each of the 18 scenarios matched with the appropriate experimental data. Each test was a combination of smooth or obstructed, slow, medium or fast, and and Open, wall, or corner configuration. A diagram of the test structure is displayed in Figure~\ref{Vettori_Drawing}.

The experiments performed included three replications of  each of the smooth ceiling configurations and two replications of each of the obstructed ceiling configurations.
...
\begin{sidewaysfigure}[p]
\begin{center}
\includegraphics[height=6.5in]{FIGURES/Vettori_Flat_Ceiling/Vettori_Activation_Time.pdf}
\end{center}
