...
READ_PROP_LOOP: DO N=0,N_PROP
   ...
   IF (PART_ID/='null' .AND. SPRAY_PATTERN_TABLE == 'null' ) THEN
           ...
           IF(SPRAY_PATTERN_MU<0._EB) THEN
              ...
              ENDIF
           ENDIF
           CALL SPRAY_ANGLE_DISTRIBUTION(PY%SPRAY_ANGLE_CDF_THETA,PY%SPRAY_ANGLE_CDF,SPRAY_PATTERN_BETA, &
                                         SPRAY_PATTERN_MU,MAXVAL(PY%SPRAY_ANGLE),MINVAL(PY%SPRAY_ANGLE),SPRAY_PATTERN_SHAPE,NDC)
   ENDIF
