...
These values have been input directly into FDS, and the predicted heat release rates
are compared with measured values from the Cone
...
Char 1 Conductivity         & W/m/K         & 0.36                              & Fit to cone data          &  \cite{Oztekin:CF2012}                  \\ \hline
...
Char 2 Conductivity         & W/m/K         & 0.36                              & Fit to cone data          &  \cite{Oztekin:CF2012}                  \\ \hline
...
Reac 2 Pre-Exp.~Factor      & s$^{-1}$      & 1000                              & TGA                       &  \cite{Oztekin:CF2012}                  \\ \hline
...
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_50} \\ \includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_70} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_90} \end{tabular*}
