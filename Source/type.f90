...
TYPE SURFACE_TYPE
   ...
   REAL(EB), DIMENSION(MAX_LAYERS) :: LAYER_DENSITY,MOISTURE_CONTENT,SURFACE_VOLUME_RATIO,PACKING_RATIO,KAPPA_S=-1._EB,RENODE_DELTA_T
   REAL(EB), DIMENSION(MAX_LAYERS) :: FALLOFF_TMP,FALLOFF_DENSITY !< Temperature and density criteria for layer fall-off (delamination)
