...
\includegraphics[width=4.0in]{FIGURES/Scatterplots/Ceiling_Jet_Temperature_Unconfined}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=4.0in]{FIGURES/Scatterplots/Smoke_Detector_Activation_Time_Alpert}
\end{tabular}
\end{center}
