...
!! ONE_D%AREA = ONE_D%AREA*LP%PWT
   ...
   DO NS=0,N_TRACKED_SPECIES
      ...
      IF (ENTHALPY_TRANSPORT) THEN
         ...
         D_LAGRANGIAN(IIG,JJG,KKG) =  D_LAGRANGIAN(IIG,JJG,KKG) + M_DOT_PPP*H_S_B
      ELSE
...
ENDIF
THICKNESS=SUM(LAYER_THICKNESS(1:SF%N_LAYERS))
IF (PREDICTOR) THEN
   UU => U
   VV => V
   WW => W
   ...
   POINT_LOOP1: DO I=1,NWP
      ...
      MATERIAL_LOOP1b: DO N=1,SF%N_MATL
         ...
         REACTION_LOOP: DO J=1,ML%N_REACTIONS
            ...
            MFLUX_S = MF_FRAC(I)*REACTION_RATE/RDX_S(I)/THICKNESS**I_GRAD
