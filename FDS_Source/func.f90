...
REAL(EB) FUNCTION LES_FILTER_WIDTH_3D_NMAX(DX,DY,DZ)

REAL(EB), INTENT(IN) :: DX,DY,DZ

LES_FILTER_WIDTH_3D_NMAX = (DX*DY*DZ)**ONTH

END FUNCTION LES_FILTER_WIDTH_3D_NMAX
...
REAL(EB) FUNCTION LES_FILTER_WIDTH_2D_NMAX(DX,DY,DZ)

USE GLOBAL_CONSTANTS, ONLY: TWO_D,MAX_FILTER_WIDTH
REAL(EB), INTENT(IN) :: DX,DY,DZ

LES_FILTER_WIDTH_2D_NMAX = SQRT(DX*DZ)

END FUNCTION LES_FILTER_WIDTH_2D_NMAX
