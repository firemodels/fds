...
STDCALL FORTgetxyzsize(char *xyzfilename,int *ibp1,int *jbp1,int *kbp1,int *endian,int *error, int len);
STDCALL FORTgetzonesize(char *zonefilename, int *nzonet, int *nrooms, int *nfires, int *endian, int *error, int len);
...
STDCALL FORTgetpatchdata(int *npatch,int *pi1,int *pi2,int *pj1,int *pj2,int *pk1,int *pk2,
...
STDCALL FORTgetdata2b(char *partfilename, 
                      ...
                      int *error, int lenfile);
STDCALL FORTgetdata3(int *nframes,int *npoints,int *error);

STDCALL FORTgetsizesa(char *partfilename, int *npartpoint,int *npartframes,int lenfile);
STDCALL FORTgetsizes(char *partfilename, int *ibar, int *jbar, int *kbar, 
                     int *nb, int *nv, int *nspr,int *mxframepoints, int *endian, int *showstaticsmoke, int *error, int filelen);
