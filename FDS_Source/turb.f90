...
BETA11 = RHOP(0:IBP1,0:JBP1,0:KBP1)*SS*S11
BETA22 = RHOP(0:IBP1,0:JBP1,0:KBP1)*SS*S22
BETA33 = RHOP(0:IBP1,0:JBP1,0:KBP1)*SS*S33
BETA12 = RHOP(0:IBP1,0:JBP1,0:KBP1)*SS*S12
BETA13 = RHOP(0:IBP1,0:JBP1,0:KBP1)*SS*S13
BETA23 = RHOP(0:IBP1,0:JBP1,0:KBP1)*SS*S23
...
RHOPHAT => WORK7
CALL TEST_FILTER(RHOPHAT,RHOP(ARRAY_LO(1):ARRAY_HI(1),ARRAY_LO(2):ARRAY_HI(2),ARRAY_LO(3):ARRAY_HI(3)),N_LO,N_HI,ARRAY_LO,ARRAY_HI)
