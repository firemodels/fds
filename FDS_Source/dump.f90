...
REAL(EB) :: FLOW,HMFAC,F1,F2,H_TC,SRAD,TMP_TC,MU_AIR,RE_D,K_AIR,NUSSELT,NU_FAC,PR,AREA,VEL, &
            ...
            DHOR,X_EQUIL,MW_RATIO,Y_EQUIL,TMP_BOIL,EXPON,Y_SPECIES,RCON,MEC,Y_SPECIES2
...
SELECT CASE(IND)
   ...
   CASE(94)  ! VOLUME FRACTION
      IF (SPEC_INDEX<0) RCON = RCON_MF(-SPEC_INDEX)
      IF (SPEC_INDEX>0) RCON = SPECIES(SPEC_INDEX)%RCON
      GAS_PHASE_OUTPUT = RCON*Y_SPECIES/RSUM(II,JJ,KK)
   CASE(95)  ! VISIBILITY
