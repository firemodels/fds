...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            DRAG_COEFFICIENT,MINIMUM_BURNOUT_TIME,DELTA_TMP_MAX,BURN_DURATION,CONE_HEAT_FLUX
...
REAL(EB) :: VEG_LSET_IGNITE_TIME,VEG_LSET_QCON,VEG_LSET_ROS_HEAD,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK, &
            VEG_LSET_WIND_EXP,VEG_LSET_BETA,VEG_LSET_HT,VEG_LSET_SIGMA,VEG_LSET_ROS00, &
...
NAMELIST /SURF/ ADIABATIC,BACKING,BLOWING,BURN_AWAY,BURN_DURATION,CELL_SIZE_FACTOR,&
                ...
                VEG_LSET_ROS00,VEG_LSET_ROS_BACK,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_HEAD,VEG_LSET_SIGMA,&
                VEG_LSET_TAN2,VEG_LSET_WIND_EXP,VEG_LSET_SURF_LOAD,VEG_LSET_FIREBASE_TIME,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   IF (VEG_LSET_IGNITE_TIME < 1.E6_EB .OR. VEG_LSET_FUEL_INDEX>0 .OR. &
       VEG_LSET_ROS00>0._EB .OR. VEG_LSET_ROS_HEAD>0._EB) VEG_LSET_SPREAD = .TRUE.
   ...
   IF (VEG_LSET_ROS00     >0 .AND. LEVEL_SET_COUPLED_FIRE) HRRPUA = 1._EB  
   IF (VEG_LSET_ROS_HEAD  >0 .AND. LEVEL_SET_COUPLED_FIRE) HRRPUA = 1._EB 

   SF%VEG_LSET_SPREAD       = VEG_LSET_SPREAD
   SF%VEG_LSET_ROS00        = VEG_LSET_ROS00        ! no-wind, no-slope RoS (m/s), Rothermel model
...
!rm IF (VEG_LSET_FIREBASE_TIME > 0._EB) SF%BURN_DURATION = VEG_LSET_FIREBASE_TIME 
...
VEG_LSET_FIREBASE_TIME  = 75600._EB/VEG_LSET_SIGMA !s
