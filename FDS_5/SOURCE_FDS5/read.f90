...
PLOOP: DO N=1,5
   CALL GET_QUANTITY_INDEX(PLOT3D_QUANTITY_INDEX(N),PLOT3D_SPEC_INDEX(N),I_DUM,'PLOT3D',PLOT3D_QUANTITY(N),PLOT3D_SPEC_ID(N),'null')
ENDDO PLOOP
...
IF (SMOKE3D) THEN
   CALL GET_QUANTITY_INDEX(SMOKE3D_QUANTITY_INDEX,SMOKE3D_SPEC_INDEX,I_DUM,'SMOKE3D',SMOKE3D_QUANTITY,SMOKE3D_SPEC_ID,'null')
   SMOKE3D_SPEC_INDEX = 0
   IF (SMOKE3D_QUANTITY_INDEX>50 .AND. SMOKE3D_QUANTITY_INDEX<=60) SMOKE3D_SPEC_INDEX = SMOKE3D_QUANTITY_INDEX - 50
ENDIF
...
DO N=1,N_PART
   ...
   IF (ANY(PC%QUANTITIES/='null')) THEN
      QUANTITIES_LOOP: DO NN=1,10
         ...
         CALL GET_QUANTITY_INDEX(PC%QUANTITIES_INDEX(PC%N_QUANTITIES),I_DUMMY,I_DUMMY,'PART',PC%QUANTITIES(NN),'null','null')
...
PROC_DEVC_LOOP: DO N=1,N_DEVC
   ...
   IF (DV%QUANTITY /= 'null') THEN
      CALL GET_QUANTITY_INDEX(QUANTITY_INDEX,DV%SPEC_INDEX,DV%PART_INDEX,'DEVC',DV%QUANTITY,DV%SPEC_ID,DV%PART_ID)
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      VECTORLOOP: DO ITER=1,NITER
         ...
         CALL GET_QUANTITY_INDEX(SL%INDEX,SL%SPEC_INDEX,SL%PART_INDEX,'SLCF',QUANTITY,SPEC_ID,PART_ID)
      ENDDO VECTORLOOP
...
READ_BNDF_LOOP: DO N=1,N_BNDF
   ...
   CALL GET_QUANTITY_INDEX(BF%INDEX,BF%SPEC_INDEX,BF%PART_INDEX,'BNDF',QUANTITY,SPEC_ID,PART_ID)
...
SUBROUTINE GET_QUANTITY_INDEX(OUTPUT_INDEX,SPEC_INDEX,PART_INDEX,OUTTYPE,QUANTITY,SPEC_ID,PART_ID)
