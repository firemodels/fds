...
REAL(EB) :: H_TC,TMP_TC,RE_D,NUSSELT,VEL,K_G,MU_G,DROPLET_COOLING,&
            ...
            EXPON,Y_SPECIES,MEC,Y_SPECIES2,Y_H2O,R_Y_H2O,R_DN,SGN,H_S,D_Z_N(0:I_MAX_TEMP),&
...
REAL(EB), DIMENSION(:), POINTER :: ZZ_GET, Y_ALL
REAL(FB) :: RN
...
ZZ_GET => SCRATCH_ZZ_GET(1:N_TRACKED_SPECIES,MY_RANK+THREAD_ID)
Y_ALL => SCRATCH_Y_ALL(:,MY_RANK+THREAD_ID)
