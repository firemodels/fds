...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_01_temp_min_layer}\\
FDS run with minimum HRR\\

\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_01_temp_avg_layer}\\
FDS run with average HRR\\

\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_01_temp_max_layer}\\
FDS run with maximum HRR\\
\end{tabular}
\end{center}
\caption {Experimental and FDS Temperature comparisons for Test 1.
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_02_temp_avg_layer}&
\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_03_temp_avg_layer}\\
Test 2&Test 3\\

\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_04_temp_avg_layer}&
\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_05_temp_avg_layer}\\
Test 4&Test 5\\

\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_06_temp_avg_layer}&
\includegraphics[width=3.0in]{datafigures/MFRI_Training_Tower_07_temp_avg_layer}\\
Test 6&Test 7\\
\end{tabular}
\end{center}
