...
REAL(EB) :: FLOW,HMFAC,H_TC,TMP_TC,RE_D,NUSSELT,AREA,VEL,K_G,MU_G,&
            ...
            UVW,UODX,VODY,WODZ,MW,XHAT,ZHAT,A_D,Q_D,Q_D_1,Y_EQ,T_EQ,M_EQ,M_G,M_D,M_L,H_L,H_V,P_RATIO,TMP_D,WGT
...
!       GAS_PHASE_OUTPUT_RES = MEASURE_SCALAR_RESOLUTION(II,JJ,KK,IND2,Y_INDEX,Z_INDEX,PART_INDEX,VELO_INDEX,NM)
   ...
   CASE(186:187) ! EQUIBLIBRIUM
      ...
      DO I=1,NLP
         ...
         Q_D = Q_D + MIN(Q_D_1,H_V*M_L)
      ENDDO

      IF (M_L > 0._EB) CALL GET_EQUILIBRIUM(Y_EQ,T_EQ,M_EQ,H_G,H_L,ZZ_GET,M_G,M_L,Y_INDEX,Z_INDEX,Q_D,P_RATIO)
