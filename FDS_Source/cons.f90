...
REAL(EB) :: MW_AIR,MW_OTHER,MW_SOOT,HRRPUA_SHEET=0._EB,HRRPUA_SHEET_EXPONENT=1._EB,RHO_SOOT,VISIBILITY_FACTOR, SOOT_H_FRACTION ,&
            MASS_EXTINCTION_COEFFICIENT,EC_LL,C_EDC=0.10_EB,HRRPUV_AVERAGE=2500._EB
