...
\end{tabular}
\end{center}
\caption[Summary of sprinkler activation time predictions, UL/NFPRF test series.]
{Above: Comparison of predicted and measured sprinkler activation times for the UL/NFPRF Series. Below: Comparison of activation
