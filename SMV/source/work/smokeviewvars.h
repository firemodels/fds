...
SVEXTERN vdevicedata SVDECL(*vdeviceinfo,NULL),SVDECL(**vdeviceptrinfo,NULL);
...
SVEXTERN mesh *getmesh_in_smesh(mesh *mesh_guess, supermesh *smesh, float *xyz);
...
SVEXTERN float SVDECL(smoke_albedo,0.0);
