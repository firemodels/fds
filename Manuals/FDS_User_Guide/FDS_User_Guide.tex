...
\begin{equation*}
   \hbox{\ct 'NORMALIZED HEAT ABSORPTION RATE'} =  \dot{q}''_c (t) \Big/ \sum_\alpha  m''_\alpha (0) \quad \quad \hbox{(W/g)}
\end{equation*}
...
\hline \hline
\endhead
{\ct ABSORPTION COEFFICIENT}                    & Section~\ref{info:RADI_Absorption}            & 1/m            & D,I,P,S      \\ \hline
...
{\ct NORMALIZED HEAT ABSORPTION RATE}           & Section \ref{info:material_components}            & W/g            & B,D          \\ \hline
