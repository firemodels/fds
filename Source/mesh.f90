...
TYPE MESH_TYPE
   ...
   INTEGER :: N_EDGES=0
   INTEGER, ALLOCATABLE, DIMENSION(:,:) :: IJKE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: CELL_REALS                !< 1-D array to hold CELL variables
...
INTEGER, POINTER, DIMENSION(:,:) :: IJKE
...
REAL(EB), POINTER, DIMENSION(:) :: CELL_REALS
