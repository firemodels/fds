...
if(~exist([data_dir,'radiation_gas_panel_10cm_devc.csv'])        || ...
   ...
   ~exist([data_dir,'radiation_gas_panel_46cm_devc.csv'])        || ...
   ...
   ~exist([data_dir,'radiation_gas_panel_46cm_offset_devc.csv']) || ...
...
M46 = csvread([data_dir,'radiation_gas_panel_46cm_devc.csv'],2);
...
M46Offset = csvread([data_dir,'radiation_gas_panel_46cm_offset_devc.csv'],2);
...
xlabel('Perpendicular distance from the radiant panel (m)','FontSize',Title_Font_Size,'Interpreter',Font_Interpreter,'FontName',Font_Name); hold on
