@echo off
Title Bundle FDS and Smokeview for 32 bit Linux
...
set bundledir=FDS_%fds_version%-SMV_%smv_version%_linux32
plink %svn_logon% %linux_svn_root%/Utilities/Scripts/BUNDLE_linux32.csh %linux_svn_root% %bundledir% %linux_hostname% %fds_edition% %fds_version% %smv_version% %fdssmv_major_version%

set manifest=%svn_root%\Utilities\uploads\manifest_linux_32.html
