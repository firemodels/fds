...
TYPE SPECIES_TYPE
   REAL(EB) :: MW=0._EB,YY0=0._EB,RCON,MAXMASS,MASS_EXTINCTION_COEFFICIENT=0._EB,&
               ...
               SPECIFIC_HEAT_LIQUID=-1,DENSITY_LIQUID,VAPORIZATION_TEMPERATURE,HEAT_OF_VAPORIZATION,MELTING_TEMPERATURE,&
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   REAL(EB) :: MW , RCON, ZZ0=0._EB, MASS_EXTINCTION_COEFFICIENT=0._EB,ADJUST_NU=1._EB,ATOMS(118)=0._EB
...
TYPE REACTION_TYPE
   ...
   REAL(EB) :: C,H,N,O,EPUMO2,HEAT_OF_COMBUSTION,HOC_COMPLETE,A,A_IN,E,E_IN,N_F=0._EB,N_O=0._EB, &
      Y_O2_INFTY,Y_N2_INLET=0._EB,Y_N2_INFTY=0._EB,MW_FUEL,MW_SOOT, &
      CO_YIELD,SOOT_YIELD,H2_YIELD, SOOT_H_FRACTION,RHO_EXPONENT, &
