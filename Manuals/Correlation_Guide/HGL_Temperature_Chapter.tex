...
\begin{table}[!ht]
\caption[Verification input parameters, HGL temperature, natural ventilation]
{Verification input parameters, HGL temperature, natural ventilation.}
\begin{center}
\begin{tabular}{|l|c|}
\hline
                        &              \\
...
\noindent Expected result: At 60~s, the HGL temperature $T\sb{g}$ is 111.45~$^\circ$C; at 120~s, $T\sb{g}$ is 121.05~$^\circ$C; at 180~s, $T\sb{g}$ is 127.21~$^\circ$C.
...
\begin{table}[!ht]
\caption[Verification input parameters, HGL temperature, forced ventilation]
{Verification input parameters, HGL temperature, forced ventilation.}
\begin{center}
\begin{tabular}{|l|c|}
\hline
                            &              \\
...
\begin{table}[!ht]
\caption[Verification input parameters, HGL temperature, no ventilation]
{Verification input parameters, HGL temperature, no ventilation.}
\begin{center}
\begin{tabular}{|l|c|}
\hline
                            &              \\
