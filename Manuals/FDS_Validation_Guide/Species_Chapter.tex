...
particle sizes (1~$\mu$m, 3~$\mu$m, 5~$\mu$m, 9~$\mu$m, and 16~$\mu$m) and 3 different air velocities (2.2~m/s, 5.3~m/s, and 9.0~m/s). For the simulations, the aerosol species is tracked
...
\noindent The particle deposition velocity, $V_d$, is determined from
\be
   V_d = \frac{J_1 + J_2 + J_3 + J_4}{4 \; C_{avg}}
\ee
$J_1$ through $J_4$ are the deposition fluxes (kg/m$^2$/s) for duct panels 1 through 4 given by
\be
...
\end{tabular}
\end{center}
\caption[Summary of Sippola aerosol deposition velocities]
{Summary of Sippola aerosol deposition velocities.}
\end{figure}
