...
INTEGER :: JJ,MI,JJJ,NR,NRE,N_MATLS_X_IN,N_MATLS_X_IN_2
TYPE (MATERIAL_TYPE), POINTER :: ML

N_MATLS_X_IN = N_MATLS_X
...
! I reaction check added new materials check for succesive reactions.
IF (N_MATLS_X_IN < N_MATLS_X) THEN
   FIND_REACTIONS: DO
      N_MATLS_X_IN_2 = N_MATLS_X
      DO JJ=N_MATLS_X_IN+1,N_MATLS_X
         ML => MATERIAL(MATL_INDEX_X(JJ))
         REACTION_LOOP_2: DO NR=1,ML%N_REACTIONS
            RESIDUE_LOOP_2: DO NRE=1,ML%N_RESIDUE(NR)
               DO JJJ=1,N_MATLS_X
                  IF (ML%RESIDUE_MATL_INDEX(NRE,NR)==MATL_INDEX_X(JJJ)) CYCLE RESIDUE_LOOP_2
               ENDDO
               N_MATLS_X = N_MATLS_X + 1
               MATL_INDEX_X(N_MATLS_X) = ML%RESIDUE_MATL_INDEX(NRE,NR)
            ENDDO RESIDUE_LOOP_2
         ENDDO REACTION_LOOP_2
      ENDDO
      IF (N_MATLS_X_IN_2==N_MATLS_X) EXIT FIND_REACTIONS
      N_MATLS_X_IN = N_MATLS_X_IN_2
      N_MATLS_X_IN_2 = N_MATLS_X
   ENDDO FIND_REACTIONS
ENDIF
