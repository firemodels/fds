...
\centering
\begin{tabular}{|p{5.5cm}|p{1.0cm}|p{1.0cm}|p{0.8cm}|p{1.4cm}|p{1.0cm}|p{1.0cm}|c|}
\hline
            & \centering$k$& \centering$\rho$& \centering$\varepsilon$& \centering$c_{p}$& \centering$T_{\mathrm{ign}}$&\centering$\Delta H_{c}$& $Y_{s}$  \\
Material    & $\mathrm{\left(\frac{W}{m\cdot K}\right)}$ & $\mathrm{\left(\frac{kg}{m^{3}}\right)}$ & $\mathrm{( - )}$ & $\mathrm{\left(\frac{kJ}{(kg\cdot ^{\circ}C)}\right)}$ &  ($\mathrm{^{\circ}C}$)   & $\left(\mathrm{\frac{kJ}{kg}}\right)$ & $\mathrm{\left(-\right)}$ \\ \hline
\hline
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.10in]{SCRIPT_FIGURES/Scaling_Pyrolysis/RISE_POlyolefin_XLPE-45mm_cone_45p0.pdf} &
...
\includegraphics[height=2.10in]{SCRIPT_FIGURES/Scaling_Pyrolysis/RISE_PVC_XLPE-17mm_cone_17p7.pdf} \\
...
\includegraphics[height=2.10in]{SCRIPT_FIGURES/Scaling_Pyrolysis/RISE_Polyolefin_PA-02mm_cone_2p5.pdf} &
...
\includegraphics[height=2.10in]{SCRIPT_FIGURES/Scaling_Pyrolysis/RISE_RPPVC_XLPE-22mm_cone_22p5.pdf} \\
...
\includegraphics[height=2.10in]{SCRIPT_FIGURES/Scaling_Pyrolysis/RISE_synthetic_rubber_glue_plywood-14mm_cone_14p8.pdf} &
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, Mixtures materials]
{Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
\label{RISE_Materials_HRR_Mixtures6}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.10in]{SCRIPT_FIGURES/Scaling_Pyrolysis/RISE_PVDF-01mm_cone_1p9.pdf} &
