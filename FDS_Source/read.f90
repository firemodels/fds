...
NAMELIST /DUMP/ RENDER_FILE,SMOKE3D,SMOKE3D_QUANTITY,FLUSH_FILE_BUFFERS,MASS_FILE, &
                ...
                PLOT3D_PART_ID,PLOT3D_VELO_INDEX,VELOCITY_ERROR_FILE,DT_SL3D,SIG_FIGS,SIG_FIGS_EXP
...
NAMELIST /SLCF/ XB,QUANTITY,FYI,PBX,PBY,PBZ,VECTOR,MESH_NUMBER,MAXIMUM_VALUE,MINIMUM_VALUE,SPEC_ID, &
