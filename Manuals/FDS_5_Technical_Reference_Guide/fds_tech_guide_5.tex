...
\Huge \flushright{Fire Dynamics Simulator (Version 5) \\ Technical Reference Guide \\ (Draft: August 23, 2007)}
...
Natl.~Inst.~Stand.~Technol.~Spec.~Publ.~1018-5, 100 pages (September 2007) \\
CODEN: NSPUE2 }
...
The present version of FDS is 5, officially released in September, 2007. Changes in
...
\be  Z_f   = \left( 1+\frac{W_\OTWO}{W_\F} \left(1+\frac{Y_{{\tiny \hbox{N}_2}}^\infty}{Y_\OTWO^\infty} \right) \, \Big( (1-c)\, \nu_{O_2,2}+c \, \nu_{O_2,3} \Big) \right)^{-1}   \quad ; \quad  c = \frac {Z_3}{Z_2+Z_3}  \ee
...
that can be used to dictate that the reaction must not occur below a
