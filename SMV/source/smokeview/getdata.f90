...
XMIN = MIN(V0(0),V1(0),V2(0),V3(0))-1.1_EB
XMAX = MAX(V0(0),V1(0),V2(0),V3(0))+1.21_EB

YMIN = MIN(V0(1),V1(1),V2(1),V3(1))-1.1_EB
YMAX = MAX(V0(1),V1(1),V2(1),V3(1))+1.21_EB

ZMIN = MIN(V0(2),V1(2),V2(2),V3(2))-1.1_EB
ZMAX = MAX(V0(2),V1(2),V2(2),V3(2))+1.21_EB
...
DO J = 0, NBOXJ-1
DO K = 0, NBOXK-1
BOXBOUNDS(0)=XMIN +   REAL(I,EB)*(XMAX-XMIN)/REAL(NBOXI,EB)
BOXBOUNDS(1)=XMIN + REAL(I+1,EB)*(XMAX-XMIN)/REAL(NBOXI,EB)
BOXBOUNDS(2)=YMIN +   REAL(J,EB)*(YMAX-YMIN)/REAL(NBOXJ,EB)
BOXBOUNDS(3)=YMIN + REAL(J+1,EB)*(YMAX-YMIN)/REAL(NBOXJ,EB)
BOXBOUNDS(4)=ZMIN +   REAL(K,EB)*(ZMAX-ZMIN)/REAL(NBOXK,EB)
BOXBOUNDS(5)=ZMIN + REAL(K+1,EB)*(ZMAX-ZMIN)/REAL(NBOXK,EB)
...
IF(ABS(VOL_TETRA-VOL).GT.1.0E-5_EB*ABS(VOL_TETRA)+1.0E-5_EB)THEN
   ...
   DO K = 0, NBOXK-1
   DO J = 0, NBOXJ-1 
   WRITE(6,*)"VV",(VOL2(I,J,K),I=0,NBOXI-1)
   END DO
   END DO
...
BOX_BOUNDS_IJK_EB(5) = BOX_BOUNDS_EB(4) + REAL(K+1,EB)*(BOX_BOUNDS_EB(5) - BOX_BOUNDS_EB(4))
