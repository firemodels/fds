...
IF (ALLOCATED(B1%M_DOT_G_PP_ACTUAL)) B1%M_DOT_G_PP_ACTUAL = M_DOT_G_PP_ACTUAL_NET
...
IF (PRESENT(PARTICLE_INDEX_IN)) THEN
   ...
   IF (SFX%BLOWING) ONE_DX => BOUNDARY_ONE_D(LPX%OD_INDEX)
   DN = SFX%CONV_LENGTH
   R_DROP = LPX%RADIUS
...
ELSEIF (PRESENT(WALL_INDEX_IN)) THEN
   ...
   IF (SFX%BLOWING) ONE_DX => BOUNDARY_ONE_D(WCX%OD_INDEX)
   DN = 1._EB/P1X%RDN
   TMP_G  = TMP(BCX%IIG,BCX%JJG,BCX%KKG)
   RHO_G  = RHO(BCX%IIG,BCX%JJG,BCX%KKG)
   ZZ_G(1:N_TRACKED_SPECIES) = ZZ(BCX%IIG,BCX%JJG,BCX%KKG,1:N_TRACKED_SPECIES)
ELSEIF (PRESENT(CFACE_INDEX_IN)) THEN
   ...
   IF (SFX%BLOWING) ONE_DX => BOUNDARY_ONE_D(CFAX%OD_INDEX)
   DN = 1._EB/P1X%RDN
   TMP_G  = CFA%TMP_G
   RHO_G  = CFA%RHO_G
   ZZ_G   = CFA%ZZ_G
