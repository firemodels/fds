...
TYPE MESH_TYPE
   ...
   INTEGER, ALLOCATABLE, DIMENSION(:,:,:) :: THIN_WALL_INDEX        !< THIN_WALL index
   INTEGER, ALLOCATABLE, DIMENSION(:,:,:) :: THIN_SURF_INDEX        !< THIN_WALL SURF index
   INTEGER, ALLOCATABLE, DIMENSION(:,:,:) :: THIN_OBST_INDEX        !< THIN_WALL OBST index
   INTEGER, ALLOCATABLE, DIMENSION(:,:) :: SURF_INDEX               !< SURF index of 6 faces of cell with CELL_INDEX(I,J,K)
   ...
   TYPE(IBM_RCFACE_LST_TYPE), ALLOCATABLE, DIMENSION(:) :: RC_FACE
   ...
   INTEGER :: N_BOUNDARY_COORD_DIM=0,N_BOUNDARY_ONE_D_DIM=0,N_BOUNDARY_THR_D_DIM=0,N_BOUNDARY_PROPS_DIM=0,N_BOUNDARY_RADIA_DIM=0
   INTEGER :: NEXT_AVAILABLE_BOUNDARY_COORD_SLOT,NEXT_AVAILABLE_BOUNDARY_ONE_D_SLOT,NEXT_AVAILABLE_BOUNDARY_THR_D_SLOT, &
              NEXT_AVAILABLE_BOUNDARY_PROPS_SLOT,&
   ...
   INTEGER, ALLOCATABLE, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_THR_D_OCCUPANCY, &
                                         BOUNDARY_PROPS_OCCUPANCY,BOUNDARY_RADIA_OCCUPANCY
...
TYPE(IBM_CUTEDGE_TYPE),   POINTER, DIMENSION(:) :: CUT_EDGE
...
TYPE(IBM_REGFACEZ_TYPE),  POINTER, DIMENSION(:) :: IBM_REGFACE_IAXIS_Z, &
                                                   IBM_REGFACE_JAXIS_Z, &
                                                   IBM_REGFACE_KAXIS_Z
TYPE(IBM_RCFACE_LST_TYPE), POINTER, DIMENSION(:):: RC_FACE
...
INTEGER, POINTER, DIMENSION(:,:) :: WALL_INDEX,SURF_INDEX
INTEGER, POINTER, DIMENSION(:,:,:) :: THIN_WALL_INDEX,THIN_SURF_INDEX,THIN_OBST_INDEX
...
INTEGER, POINTER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_THR_D_DIM,N_BOUNDARY_PROPS_DIM,N_BOUNDARY_RADIA_DIM
...
THIN_WALL_INDEX=>M%THIN_WALL_INDEX
THIN_SURF_INDEX=>M%THIN_SURF_INDEX
THIN_OBST_INDEX=>M%THIN_OBST_INDEX
SURF_INDEX=>M%SURF_INDEX
SOLID=>M%SOLID
EXTERIOR=>M%EXTERIOR
