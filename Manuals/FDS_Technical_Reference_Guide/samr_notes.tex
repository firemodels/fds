...
% grid
\draw[step=3.0cm,thick] (0, 0) grid (12, 12);
\draw[step=1.5cm,thick] (3, 3) grid (9, 9);
\draw[line width=1.5pt,-,blue] (3, 3) rectangle (9, 9);
\draw[line width=2.0pt,-,red] (3,3) -- (3,4.5);
\draw[line width=1.0pt,->] (3,3.75) -- (3.5,3.75);

%\draw[line width=1.0pt,dashed,-] (3.75,3) -- (3.75,4.5);
...
\draw[line width=1.5pt,-,blue] (0,-1) -- (3,-1) node[anchor=west] {wall cells};
\draw[line width=2.0pt,-,red] (0,-2) -- (3,-2) node[anchor=west] {highlighted wall cell};
\draw[line width=1.0pt,->] (0,-3) -- (3,-3) node[anchor=west] {\texttt{IOR}};
