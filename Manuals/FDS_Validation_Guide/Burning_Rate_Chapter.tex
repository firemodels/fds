...
Six tests of the British Steel - Fire Research Station tests were modelled. The experiments are described in Section~\label{BST_FRS_wood_cribs_description}. The results consist of temperatures over criblines 2 (back), 6 (middle) and 10 (front) of the room. Each measurement is an average of three thermocouples at the same distance.

Figures~\ref{BST_FRS_wood_cribs_Tests_1to2} to \ref{BST_FRS_wood_cribs_Tests_5to6} display comparisons of the measured and predicted temperatures. 
...
\end{tabular*}
\caption[BST/FRS Wood Cribs temperatures, Tests 1 and 2]{BST/FRS Wood Cribs temperatures, Tests 1 and 2.}
...
\end{tabular*}
\caption[BST/FRS Wood Cribs temperatures, Tests 3 and 4]{BST/FRS Wood Cribs temperatures, Tests 3 and 4.}
...
\end{tabular*}
\caption[BST/FRS Wood Cribs temperatures, Tests 5 and 6]{BST/FRS Wood Cribs temperatures, Tests 5 and 6.}
