...
CHARACTER(80) :: TCFORM
LOGICAL :: EX,DRY
CHARACTER(255), PARAMETER :: dumpid='$Id: dump.f90 10140 2012-02-26 17:45:06Z mcgratta $'
CHARACTER(255), PARAMETER :: dumprev='$Revision: 10140 $'
CHARACTER(255), PARAMETER :: dumpdate='$Date: 2012-02-26 12:45:06 -0500 (Sun, 26 Feb 2012) $'
...
REAL(EB), INTENT(IN) :: T
INTEGER :: NOM,N,N_TOTAL_WALL_CELLS
!INTEGER :: SURF_INDEX,IW
INTEGER, INTENT(IN) :: NM
