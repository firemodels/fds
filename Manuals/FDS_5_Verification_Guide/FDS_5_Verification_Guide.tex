...
The qualitative form of the solution (\ref{eqn_1dsoln}) is illustrated by Figure \ref{fig_soln1d}, where we show the solution at specific points in time corresponding to the initial condition, the peak of the first compression cycle, and the trough of the first compression cycle.  The initial condition for the density is specified as $\rho(x,0) = 1$ and the amplitude and frequency are set to unity, $B=1$ and $\omega=1$.


\subsection{Pulsating 2D solution}
\label{soln_2d}

The velocity $\mathbf{u}=[u,v]^T$ and the velocity divergence are given by
\begin{eqnarray}
\label{eqn_u2d}
...
\begin{figure}[t]
   \begin{tabular}{rl}
      \includegraphics[width=3.2in]{FIGURES/compression_wave_time_series.pdf} &
      \includegraphics[width=3.2in]{FIGURES/compression_wave_convergence.pdf}
   \end{tabular}
...
\includegraphics[width=3.2in]{FIGURES/energy_budget_adiabatic_walls} &
\includegraphics[width=3.2in]{FIGURES/energy_budget_cold_walls}
\end{tabular*}
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{FIGURES/isentropic_density} &
\includegraphics[width=3.2in]{FIGURES/isentropic_pressure} \\
\includegraphics[width=3.2in]{FIGURES/isentropic_temperature} &
\includegraphics[width=3.2in]{FIGURES/isentropic_enthalpy}
\end{tabular*}
...
density, pressure and temperature ought to rise to rise to the same values regardless of the time of injection.
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{FIGURES/isentropic2_density} &
\includegraphics[width=3.2in]{FIGURES/isentropic2_pressure} \\
\includegraphics[width=3.2in]{FIGURES/isentropic2_temperature} &
\includegraphics[width=3.2in]{FIGURES/isentropic2_enthalpy}
\end{tabular*}
...
\begin{center}
\includegraphics[width=4.0in]{FIGURES/plate_view_factor.pdf}
\end{center}
...
\begin{figure}[h]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{FIGURES/droplet_absorption_cart} &
\includegraphics[width=3.2in]{FIGURES/droplet_absorption_cyl}
\end{tabular*}
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_char_cart_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_char_cart_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_char_cyl_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_char_cyl_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_char_spher_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_char_spher_gas}
\end{tabular*}
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_nonchar_cart_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_nonchar_cart_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_nonchar_cyl_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_nonchar_cyl_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_nonchar_spher_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_vent_nonchar_spher_gas}
\end{tabular*}
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_char_cart_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_char_cart_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_char_cyl_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_char_cyl_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_char_spher_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_char_spher_gas}
\end{tabular*}
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_nonchar_cart_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_nonchar_cart_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_nonchar_cyl_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_nonchar_cyl_gas} \\
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_nonchar_spher_fuel} &
\includegraphics[width=3.2in]{FIGURES/surf_mass_part_nonchar_spher_gas}
\end{tabular*}
...
\section{Interphase momentum transfer (\texorpdfstring{{\bf particle\_drag}}{particle\_drag})}
\label{particle_drag}
The particle drag test cases consider a $1\times1\times1$ $m^{3}$
...
of the channel, one particle in a computational cell, so that they form a surface
perpendicular to the flow direction. Graviational acceleration and viscosity
are set to zero. Due to the symmetry of the problem the flow is one
...
\be u=\frac{u_{0}}{Bu_{0}t+1},\ee
\noindent where
\be B=\frac{1}{2}\frac{\sum_{i=1}^{N}\rho_{g}C_{D}\pi r_{d}^{2}}{MV}.\ee
In the above $M=\rho_{g}V$ is the mass of the gas within the channel,
 $\rho_{g}$ is gas density, $r_{d}$ is the droplet radius, $C_{D}$
is the droplet drag coeffcient, $N$ is the number of droplets in the
channel and $u$ is the gas velocity in the channel (in the x-direction).
The common parameters used in all the simulations are
\[
    C_D=10, \quad r_d=0.005.
\]
The initial veolcity $u_0$ is varies as presented in Table \ref{particle_drag_parameters}.
Graphical comparison of computed results to the analytical results is shown in Figure \ref{particle_drag_plots}. 
\begin{table}[ht]
\begin{center}
...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=3.2in]{FIGURES/particle_drag_A} &
\includegraphics[width=3.2in]{FIGURES/particle_drag_D} \\
\includegraphics[width=3.2in]{FIGURES/particle_drag_B} &
\includegraphics[width=3.2in]{FIGURES/particle_drag_E} \\
\includegraphics[width=3.2in]{FIGURES/particle_drag_C} &
\includegraphics[width=3.2in]{FIGURES/particle_drag_F}
\end{tabular*}
