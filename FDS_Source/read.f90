...
INTEGER  :: N_SPEC_READ,N,NN
LOGICAL  :: ABSORBING,SMIX_COMPONENT_ONLY,BACKGROUND,PREDEFINED(MAX_SPECIES)
CHARACTER(30) :: FORMULA,PREDEFINED_SPEC_ID(MAX_SPECIES)
...
SPEC_READ_LOOP: DO N=1,N_SPECIES
   ...
   CALL GAS_PROPS(SS%ID,SS%SIG,SS%EPSK,SS%MW,SS%ABSORBING,SS%FORMULA,SS%LISTED)  
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   RN%ID                        = ID
   RN%MW_FUEL                   = C*MW_C + H*MW_H + O*MW_O + N*MW_N
   RN%MW_SOOT                   = MW_C * (1._EB-SOOT_H_FRACTION) + MW_H*SOOT_H_FRACTION
   RN%N                         = N
   RN%O                         = O
   ...
   IF (SIMPLE_CHEMISTRY) THEN
      ...
      ELSE
         IF (IDEAL) THEN
            ...
            RN%HEAT_OF_COMBUSTION = RN%HEAT_OF_COMBUSTION - RN%NU_SOOT*CO2_HEAT_OF_FORMATION*(1._EB-RN%SOOT_H_FRACTION)
            RN%HEAT_OF_COMBUSTION = RN%HEAT_OF_COMBUSTION - RN%NU_H2*H2O_HEAT_OF_FORMATION
            RN%HEAT_OF_COMBUSTION = RN%HEAT_OF_COMBUSTION - RN%NU_SOOT*H2O_HEAT_OF_FORMATION*RN%SOOT_H_FRACTION*0.5_EB
