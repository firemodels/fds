...
INTEGER :: N,I,J,K,II,JJ,KK,NN,IPTS,JPTS,KPTS,N_EDGES_DIM,IW,IC,IBC,IOR,IOPZ,IERR,IB,JB,KB,IPC,IPZ,ITMP,NPF
...
IF (FLUX_LIMITER>=0 .AND. .NOT.NEW_FLUX_LIMITER .AND. .NOT.EVACUATION_ONLY(NM)) THEN
