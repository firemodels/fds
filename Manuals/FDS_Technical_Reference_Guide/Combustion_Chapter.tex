...
\begin{multline}
\label{eq:extinction}
m_{\rm F,st} \, \left( h_{\rm F}(T)+\Delta h_{\rm c,F} \right) + m_{\rm A,st} \, h_{\rm A}(T) + m_{\rm P,st} \, h_{\rm P}(T)  < \\
m_{\rm F,st} \, h_{\rm F}(T_{\rm LFT}) + m_{\rm A,st} \, h_{\rm A}(T_{\rm LFT}) + m_{\rm P,st} \, h_{\rm P}(T_{\rm LFT}) 
\end{multline}
