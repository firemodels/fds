...
SELECT CASE (SPEC_ID)
   ...
   CASE('METHANE')
      IF (TE<100._EB) THEN
         CP = 2078.875_EB - TE * 0.00001618_EB
      ELSE
   ...
   CASE('CARBON MONOXIDE')
      IF (TE<100._EB) THEN
         CP = 1033.429_EB + TE * 0.0025424_EB
      ELSE
