...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   INTEGER :: SAMPLING,N_QUANTITIES,QUANTITIES_INDEX(10),QUANTITIES_Y_INDEX(10)=-1,QUANTITIES_Z_INDEX(10)=-1,ARRAY_INDEX=0,&
              ...
              ORIENTATION_INDEX=0,N_ORIENTATION,Z_INDEX=-1,N_STRATA=7,NEAREST_RAD_ANGLE_INDEX=0, &
...
TYPE OMESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: &
         REAL_SEND_PKG1,REAL_SEND_PKG3,REAL_SEND_PKG4,REAL_SEND_PKG5,REAL_SEND_PKG6,REAL_SEND_PKG7,&
         REAL_RECV_PKG1,REAL_RECV_PKG3,REAL_RECV_PKG4,REAL_RECV_PKG5,REAL_RECV_PKG6,REAL_RECV_PKG7
