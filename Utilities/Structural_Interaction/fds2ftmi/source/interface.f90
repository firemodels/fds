...
REAL C_SIZE,TINT,TBEG,TEND,VEC_MULT,HC,EM,IOR
CHARACTER(256) CHID,INPUT
CHARACTER(8) INTFILE2,INTFILE3,FILE_END,ARG
CHARACTER(16), ALLOCATABLE, DIMENSION (:) :: DEVICE
...
READ_NODES: DO I=1,NNODE
   IF (CODE==5) THEN
      READ (1,*) DEVICE(I),NOS(I,2),NOS(I,3),NOS(I,4),IOR
      IF (IOR==1) THEN
         N(I,2)=1
         N(I,3)=0
         N(I,4)=0
...
PRINT *, 'LOOP_FDS2AST'
CALL FDS2AST (CHID,NOMASTER,C_SIZE,TBEG,TEND,TINT,NUMEL,VARIABLE,N,N_AVERAGE,T_AVERAGE,CODE,DEVICE)
!*******************
!!WORKING!!
...
ENDIF
!*******************************
CASE (5) ! JUST EXPORT RESULTS FROM NODES.DAT
!****** LOOP AT FDS2AST TO EXTRACT RESULTS FROM BNDF FILES *****
PRINT *, 'LOOP_FDS2AST'
CALL FDS2AST (CHID,NOS,C_SIZE,TBEG,TEND,TINT,NNODE,VARIABLE,N,N_AVERAGE,T_AVERAGE,CODE,DEVICE)
!****************************
