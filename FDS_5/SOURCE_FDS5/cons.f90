...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, &
         ...
         FLUSH_FILE_BUFFERS,PRESSURE_CORRECTION=.FALSE.,RECOMPUTE_A=.TRUE.,RESTRICT_MESH_ASSIGNMENT=.TRUE., &
         ...
         FREEZE_VELOCITY=.FALSE.,ADJUST_HOR=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,TMPM,RHOA,RHO_LOWER,RHO_UPPER,P_INF,P_STP,GRAV,R0,R1, &
...
REAL(EB) :: MW_AIR,MW_SOOT,HRRPUA_SHEET=200._EB,RHO_SOOT,VISIBILITY_FACTOR, &
            MASS_EXTINCTION_COEFFICIENT,EC_LL,C_EDC=0.2_EB,HRRPUV_AVERAGE=3000._EB,HRRPUV_AVERAGE_TIME=1._EB
...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: Z2Y_C,Z2MW_C,Z2CP_C,Z2D_C,Z2K_C,Z2MU_C,MW_AVG_Z,Y_MF_SUM_Z, Z2KAPPA_M4
...
INTEGER :: PLOT3D_QUANTITY_INDEX(5),PLOT3D_SPEC_INDEX(5),SMOKE3D_QUANTITY_INDEX,SMOKE3D_SPEC_INDEX
CHARACTER(30) :: PLOT3D_QUANTITY(5),PLOT3D_SPEC_ID(5),PLOT3D_SMOKEVIEW_BAR_LABEL(5), &
...
REAL(EB), PARAMETER :: BTOL=1.E-10_EB
