...
If you want the obstruction that is present when the {\ct HOLE} is in a {\ct .FALSE.} state to have a different color than the original obstruction, set the {\ct COLOR} or integer triplet {\ct RGB} on the {\ct HOLE} line (see Section~\ref{info:colors}). If you want the obstruction to be invisible, set {\ct COLOR='INVISIBLE'}.
