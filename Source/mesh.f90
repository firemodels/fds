...
TYPE MESH_TYPE
   ...
   INTEGER :: N_SLCF_O=0, N_SLCF_VTK=0
...
INTEGER, POINTER, DIMENSION(:) :: ALL_SLICE_TOPOLOGIES
LOGICAL, POINTER, DIMENSION(:) :: EMPTY_UNIQUE_SLICE, UNIQUE_SLICE_IS_SL3D, UNIQUE_SLICE_IN_DOMAIN
...
UNIQUE_SLICE_IS_SL3D => M%UNIQUE_SLICE_IS_SL3D
ALL_SLICE_NAMES => M%ALL_SLICE_NAMES
ALL_SLICE_TOPOLOGIES => M%ALL_SLICE_TOPOLOGIES
ALL_SLICE_QUANTITIES => M%ALL_SLICE_QUANTITIES
UNIQUE_SLICE_IN_DOMAIN => M%UNIQUE_SLICE_IN_DOMAIN
