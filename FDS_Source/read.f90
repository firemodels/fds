...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,PRESSURE_RELAX_FACTOR,RELAXATION_FACTOR,FYI, &
                ...
                FDS6,ALMS,ALMS_RELAXATION_FACTOR,ALMS_MAX_IT,SECONDARY_BREAKUP,COMBUSTION2
...
T_LOOP_1: DO J=1,5000
   ...
   SPECIES_LOOP_2: DO N=1,N_SPECIES
      ...
      IF (J>1) THEN
         ...
         Y2CPBAR(J,N) = (Y2CP(J-1,N)*REAL(J-1,EB)+Y2CP(J,N))/REAL(J,EB)   
      ELSE
...
NAMELIST /PART/ NUMBER_INITIAL_DROPLETS,FYI,DROPLETS_PER_SECOND,MASS_PER_VOLUME, &
                ...
                VEG_MOIST_MPV_MIN,VEG_REMOVE_CHARRED,VEG_STEM,SMOKEVIEW_ID,LENGTH,ELEVATION,AZIMUTH,H_V_REFERENCE_TEMPERATURE
