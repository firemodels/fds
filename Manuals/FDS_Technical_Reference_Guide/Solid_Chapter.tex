...
\ee
Here $h_{\rm m}=Sh\mu_{\rm g}/Sc\Delta~x$ is the mass transfer coefficient and $\rho_{f,g}$ and $X_{\rm g}$ are the density of the fuel vapor and the volume fraction of fuel vapor in the grid cell adjacent to the pool surface. The Schmidt number of air $Sc$ is $0.6$ and the Sherwood numer is given by
\be
