...
INTEGER :: N,I1,I2,J1,J2,K1,K2,I_LOWER,I_UPPER,J_LOWER,J_UPPER,K_LOWER,K_UPPER,N_LOWER,N_UPPER,&
           I_LOWER_SKIP,I_UPPER_SKIP,J_LOWER_SKIP,J_UPPER_SKIP,K_LOWER_SKIP,K_UPPER_SKIP
...
READ_MULT_LOOP: DO N=0,N_MULT
   ...
   ALLOCATE(MR%SKIP(I_LOWER:I_UPPER,J_LOWER:J_UPPER,K_LOWER:K_LOWER),STAT=IZERO)
   CALL ChkMemErr('READ_MULT','SKIP',IZERO)
   MR%SKIP = .FALSE.
   IF (I_LOWER_SKIP>=I_LOWER .OR. J_LOWER_SKIP>=J_LOWER .OR. K_LOWER_SKIP>=K_LOWER .OR. &
       I_UPPER_SKIP<=I_UPPER .OR. J_UPPER_SKIP<=J_UPPER .OR. K_UPPER_SKIP<=K_UPPER) THEN
      I1 = MAX(I_LOWER,I_LOWER_SKIP)
      I2 = MIN(I_UPPER,I_UPPER_SKIP)
      J1 = MAX(J_LOWER,J_LOWER_SKIP)
      J2 = MIN(J_UPPER,J_UPPER_SKIP)
      K1 = MAX(K_LOWER,K_LOWER_SKIP)
      K2 = MIN(K_UPPER,K_UPPER_SKIP)
