...
IF (N_TRACKED_SPECIES==1 .AND. .NOT. SF%SPECIES_BC_INDEX==SPECIFIED_MASS_FLUX) RETURN
IF (N_TRACKED_SPECIES==1 .AND. SF%SPECIES_BC_INDEX==SPECIFIED_MASS_FLUX .AND. ABS(SF%MASS_FLUX(1))<=TWO_EPSILON_EB) RETURN
...
WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   SPECIES_IF_1: IF (N_TRACKED_SPECIES==1) THEN
