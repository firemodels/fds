...
\section{NIST Helium Release in a Reduced Scale Garage Geometry Experiments}

The NIST Helium Release in a Reduced Scale Garage Geometry Experiments were a set of 18 experiments in which helium was released over a lengthy time period inside of a 1.5 m x 1.5 m x 0.75 m plexiglass box~\cite{NIST_He} with one or two small leakage holes.  The tests were intended to represent the release of hydrogen from passenger vehicle fuel cell inside of a residential garage.  Tests varied the release rate and length, the location of the release, and the size and location of the leakage.  Measurements were made of the helium concentration in a rake at seven locations over the height of the compartment during the release and for a period of up to 11 hours post-release.

Test variables included all permutations of the leak rate and time (14.8 L/min over 3600 s or 3.71 L/min over 14400 s), leak location (on the floor at the center of the compartment, on the floor at the center of the rear wall, and 2.5 cm below the ceiling at the center of the compartment), and the leak area (2.4 cm x 2.4 cm at the center of the front wall, 3.05 cm x 3.05 cm at the center of the front wall, and a pair of 2.15 cm x 2.15 cm centered on the front wall 2.5 cm from the floor and ceiling).  
...
a rectangular steel tube filled with an insulation material. A diagram of the room used in Test 1 is displayed in Figure~\ref{Hollowbar_Drawing}.  The beam in Tests 2 and 3 was an I-beam. A diagram of the room used in Tests 2 and 3 is displayed in Figure~\ref{Room_Drawing}.

\begin{sidewaysfigure}[ht]
\begin{center}
\includegraphics[width=8.8in]{FIGURES/SP_AST/Full_Room_hollowbar}
\end{center}
\caption{Geometry of the SP/AST compartment for Test 1}
\label{Hollowbar_Drawing}
\end{sidewaysfigure} 

\begin{sidewaysfigure}[h]
\begin{center}
\includegraphics[width=8.8in]{FIGURES/SP_AST/Fullroom_Drawing}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=7in]{FIGURES/Steckler_Compartment/Room_Drawing.pdf}
\end{center}
...
\begin{sidewaysfigure}[p]
\begin{center}
\includegraphics[height=6.5in]{FIGURES/WTC/WTC}
\end{center}
