...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{SCRIPT_FIGURES/ScatterPlots/FDS_Plume_Temperature} \\[-0.2in]
\includegraphics[width=4.0in]{SCRIPT_FIGURES/ScatterPlots/FDS_Fire_Plume_Temperature}
\end{tabular}
\end{center}
