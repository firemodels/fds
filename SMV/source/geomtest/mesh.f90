...
CHARACTER(255), PARAMETER :: meshid='$Id: mesh.f90 10043 2012-02-10 18:46:10Z drjfloyd $'
CHARACTER(255), PARAMETER :: meshrev='$Revision: 10043 $'
CHARACTER(255), PARAMETER :: meshdate='$Date: 2012-02-10 13:46:10 -0500 (Fri, 10 Feb 2012) $'
...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:,:) :: ZZ,ZZS,DEL_RHO_D_DEL_Z
   ...
   REAL(EB) :: BC_CLOCK
   REAL(EB), POINTER, DIMENSION(:,:) :: EDGE_INTERPOLATION_FACTOR,AWM_AEROSOL
