...
\label{HGL Temperature, Flashover}
\label{HGL Depth}
...
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_HGL_Temperature_Flashover}
\end{tabular}
\end{center}
\caption[Summary of HGL temperature for unventilated and flashed over compartments]
{Summary of HGL temperature predictions for unventilated and flashover compartments.}
\label{HGL_Summary_2}
\end{figure}
