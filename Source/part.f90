...
TYPE (BOUNDARY_ONE_D_TYPE_TYPE), POINTER :: ONE_DX
TYPE (WALL_TYPE), POINTER :: WC
TYPE (CFACE_TYPE), POINTER :: CFA
...
TYPE(BOUNDARY_ONE_D_TYPE_TYPE), POINTER :: ONE_D,LP_ONE_D
TYPE(BOUNDARY_PROPS_TYPE), POINTER :: BP
TYPE(BOUNDARY_COORD_TYPE), POINTER :: BC
TYPE (SURFACE_TYPE), POINTER :: SF
...
IF (IP<NLP-IKILL) THEN
   ...
   IF (LP%BR_INDEX>0) M%BOUNDARY_RADIA_OCCUPANCY(LP%BR_INDEX) = 0
