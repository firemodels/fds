...
\be
\dot q''\sb{r} = \cos\theta \left( \frac{\chi\sb{r} \dot Q}{4 \pi R^2} \right) \quad \si{kW/m^2}
...
\multicolumn{2}{|c|}{}                                          \\ \hline
                 &                                              \\
\rb{Radius (m)}  &  \rb{Heat Flux (kW/m$^2$)}                   \\ \hline \hline
0.50             &  6.01                                        \\ \hline
0.75             &  3.65                                        \\ \hline
1.00             &  2.33                                        \\ \hline
\end{tabular}
...
\be
\dot q''\sb{r} = E F_{12} \quad \si{kW/m^2}
