...
levels = [21 38 60 93 149 204 260 316 371 427 482 538 593 649 704 760 816];
...
for k=1:17 % Experiment

   clear M E mod_data_indices exp_data_indices X_mod Y_mod Z_mod X_exp Y_exp Z_exp
   ...
   for i=1:19
      ...
      contour(X_mod,Y_mod,Z_mod,levels,'k-') ; hold on
      contour(X_exp,Y_exp,Z_exp,levels,'r-') ; hold on

      a = get(gca,'XTickLabel');  
      set(gca,'XTickLabel',a,'fontsize',4)
      set(gca,'TickLength',[0 0])
      xticks(pos)
      xticklabels({'214','213','211','209','208','207','307','306','305','','304','303','302','301','202'})
      ylabel('Height (m)','FontSize',4,'Interpreter',Font_Interpreter)
