...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_01_all_hfg} \\
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_02_all_hfg} \\
\end{tabular*}
\label{JH_FRA_HF_1}
\caption[JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor 1:4 scale inert lining configurations]{JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor 1:4 scale inert lining configurations.}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_03_all_hfg} \\
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_03A_all_hfg} \\
%\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_04_all_hfg} \\
\end{tabular*}
\label{JH_FRA_HF_2}
\caption[JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor Tests 3-4]{JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor Tests 3-4}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_11_all_hfg} \\
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_12_all_hfg} \\
\end{tabular*}
\label{JH_FRA_HF_3}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_13_all_hfg} \\
%\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_14_all_hfg} \\
\end{tabular*}
\label{JH_FRA_HF_4}
\caption[JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor Tests 8-9]{JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor Tests 8-9}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_21_all_hfg} \\
\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_22_all_hfg} \\
\end{tabular*}
\label{JH_FRA_HF_5}
...
%\begin{figure}[p]
%\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
%\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_23_all_hfg} \\
%\includegraphics[width=0.99\textwidth]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_24_all_hfg} \\
%\end{tabular*}
%\label{JH_FRA_HF_6}
%\caption[JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor Tests 12-13]{JH/FRA room corner experiments, heat flux to the ceiling, wall, and floor Tests 12-13}
%\end{figure}
