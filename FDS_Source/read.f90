...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                FREEZE_VELOCITY,FYI,GAMMA,GROUND_LEVEL,GVEC,GRAV_VISC,HRRPUVCUT_MAX,HRRPUV_MAX_SMV,IDEAL_GAS, &
                IMMERSED_BOUNDARY_METHOD,INCLUDE_NUMERICAL_DIFFUSION,LAPSE_RATE,CUTCELL_TEST,&
