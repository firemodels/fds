...
# $QFDS $DEBUG -p 38 -n 6 $QUEUE -d $INDIR methane_XO2_ramp_2step_dx_1p25cm.fds
# $QFDS $DEBUG -p 184 -n 6 $QUEUE -d $INDIR methane_XO2_ramp_2step_dx_p625cm.fds
# $QFDS $DEBUG -p 184 -n 6 $QUEUE -d $INDIR methane_XO2_ramp_2step_dx_p3125cm.fds

# $QFDS $DEBUG -p 38 -n 6 $QUEUE -d $INDIR propane_XO2_ramp_2step_dx_1p25cm.fds
# $QFDS $DEBUG -p 184 -n 6 $QUEUE -d $INDIR propane_XO2_ramp_2step_dx_p625cm.fds
# $QFDS $DEBUG -p 184 -n 6 $QUEUE -d $INDIR propane_XO2_ramp_2step_dx_p3125cm.fds
