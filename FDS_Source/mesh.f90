...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:) :: SAVE1,SAVE2,SAVE3,WORK
   ...
   REAL(EB), POINTER, DIMENSION(:) :: TURB_WORK20,TURB_WORK21,TURB_WORK22
...
RHOS=>M%RHOS
TMP=>M%TMP
FRHO=>M%FRHO      !! no longer need with FLUX_LIMITER
FRHOYY=>M%FRHOYY  !! no longer need with FLUX_LIMITER
MU=>M%MU
Q=>M%Q
Q_AVG=>M%Q_AVG
QR=>M%QR
...
IF (DYNSMAG) THEN
   ...
   TURB_WORK21=>M%TURB_WORK21
   TURB_WORK22=>M%TURB_WORK22
ENDIF
