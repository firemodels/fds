...
\begin{table}[!ht]
\caption[Input parameters for Fleury Heat Flux cases, point source and solid flame radiation heat flux]
{Summary of input parameters used for Fleury Heat Flux cases, point source and solid flame radiation heat flux.}
...
\begin{table}[!ht]
\caption[Input parameters for NIST/NRC cases, point source and solid flame radiation heat flux]
{Summary of input parameters used for NIST/NRC cases, point source and solid flame radiation heat flux.}
...
\begin{table}[!ht]
\caption[Input parameters for NIST Smoke Alarms cases, smoke detector activation time (Temperature Rise)]
{Summary of input parameters used for NIST Smoke Alarms cases, smoke detector activation time (Temperature Rise).}
...
\begin{table}[!ht]
\caption[Input parameters for WTC cases, point source and solid flame radiation heat flux]
{Summary of input parameters used for WTC cases, point source and solid flame radiation heat flux.}
