...
\begin{notebox}
\noindent
Avoid using a Smokeview .smv file keyword for the {\ct ID}. See the 
``User's Guide for Smokeview Version~5''~\cite{Smokeview_Users_Guide_5}
for a listing of these keywords.
\end{notebox}
