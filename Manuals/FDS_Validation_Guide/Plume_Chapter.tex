...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms temperature, 18~cm to 40~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms temperature, 50~cm to 60~cm above the burner]
