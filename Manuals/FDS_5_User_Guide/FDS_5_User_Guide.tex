...
\ee
Note that $U$ is used in Eq.~(\ref{TC}) to get the effective radiative flux to a small thermocouple bead so that its temperature, as opposed to the gas temperature,
can be calculated. If you divide $U$ by $4\pi$, you get the the average intensity at a particular point in space:
\be
