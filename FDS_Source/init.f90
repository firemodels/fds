...
IF (PRESSURE_CORRECTION .AND. .NOT.EVACUATION_ONLY(NM)) THEN
...
IF (N_EVAP_INDICIES>0 .AND. .NOT.EVACUATION_ONLY(NM)) THEN
...
IF (PRESSURE_CORRECTION .AND. .NOT.EVACUATION_ONLY(NM)) M%HP = 0._EB
M%DDDT  = 0._EB
M%D     = 0._EB
M%DS    = 0._EB
M%Q     = 0._EB
...
IF (DNS .AND. ISOTHERMAL .AND. .NOT.EVACUATION_ONLY(NM)) THEN
...
PARTICLE_LOOP: DO N=1,N_PART
   IF (EVACUATION_ONLY(NM)) CYCLE PARTICLE_LOOP
   PC =>PARTICLE_CLASS(N)
