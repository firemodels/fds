...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, &
         ...
         MATLAB_DLMREAD=.FALSE.,PERIODIC_BC=.FALSE.,TURB_INIT=.FALSE.
...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: Z2Y_C,Z2MW_C,Z2CP_C,Z2D_C,Z2K_C,Z2MU_C,MW_AVG_Z,Y_MF_SUM_Z, Z2KAPPA_M4,Z_VECTOR
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,NCGC,PERIODIC_TEST=0
