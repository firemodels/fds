...
&HVAC TYPE='FILTER', ID='filter 1', LOADING=0., SPEC_ID='SOOT',
      EFFICIENCY=0.99, MULTIPLIER=1,CLEAN_LOSS=2., LOSS=100./
\end{verbatim}\normalsize
...
\noindent
Note that a filter input refers to a class of aircoils and that multiple ducts can reference the same filter definition.
