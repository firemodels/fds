...
TYPE MESH_TYPE
   ...
   INTEGER :: IBM_NBNDCUTFACE_MESH=0, IBM_NGCCUTFACE_MESH=0, IBM_NGCCUTCELL_MESH=0
   ...
   INTEGER :: IBM_NREGFACE_Z(MAX_DIM), IBM_NREGFACE_H(MAX_DIM)
   ...
   INTEGER :: N_GEOM_CFACES=0
   TYPE(GEOM_CFACE_TYPE), ALLOCATABLE, DIMENSION(:) :: CFACE
...
!rm <-
   ...
   ! Solid phase 1D-3D heat transfer coupling

   REAL(EB), ALLOCATABLE, DIMENSION(:) :: ONE_D_WORK1,ONE_D_WORK2,ONE_D_WORK3,ONE_D_WORK4,&
                                          ONE_D_WORK5,ONE_D_WORK6,ONE_D_WORK7,ONE_D_WORK8
...
REAL(EB), POINTER, DIMENSION(:) :: ONE_D_WORK1,ONE_D_WORK2,ONE_D_WORK3,ONE_D_WORK4,&
                                   ONE_D_WORK5,ONE_D_WORK6,ONE_D_WORK7,ONE_D_WORK8
...
ONE_D_WORK1=>M%ONE_D_WORK1
ONE_D_WORK2=>M%ONE_D_WORK2
ONE_D_WORK3=>M%ONE_D_WORK3
ONE_D_WORK4=>M%ONE_D_WORK4
ONE_D_WORK5=>M%ONE_D_WORK5
ONE_D_WORK6=>M%ONE_D_WORK6
ONE_D_WORK7=>M%ONE_D_WORK7
ONE_D_WORK8=>M%ONE_D_WORK8
!rm ->
