...
Figure~\ref{Water_Methanol_Plume_Temp_CL} displays the centerline profile of measured and predicted mean temperatures above a 30~cm diameter methanol pool fire. These measurements were conducted by Hamins and Lock~\cite{Hamins:TN1928} at NIST, along with an additional radial profile of mean temperature at a height of 60~cm. All of the other measurements on the following pages were conducted by Weckman at the University of Waterloo~\cite{Weckman:CF1996}.

Figures~\ref{Water_Methanol_Plume_Temp_1} through \ref{Water_Methanol_Plume_Temp_3} display radial profiles of measured and predicted mean (left hand plots) and root mean square (right hand plots) temperatures. The root mean square of the temperature is given by
\be
...
\caption[Waterloo Methanol, centerline profile of mean temperature, 2~cm to 60~cm above the burner]
...
\multicolumn{2}{c}{\includegraphics[height=2.15in]{SCRIPT_FIGURES/Waterloo_Methanol/Waterloo_Methanol_Temperature_60_cm}}
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms temperature, 18~cm to 30~cm above the burner]
{Waterloo Methanol, radial profiles of mean (left) and rms (right) temperature, 18~cm to 30~cm above the burner. The measurement at 60~cm was performed by Hamins and Lock~\cite{Hamins:TN1928}.}
