...
INTEGER :: N,I,J,K,II,JJ,KK,NN,IPTS,JPTS,KPTS,N_EDGES_DIM,N_TOTAL_WALL_CELLS,IW,IWE,IWG,IC,IBC,IOR,IOPZ, &
           IERR,IB,JB,KB,IPC,IPZ,CELL_COUNT
...
IF (IMMERSED_BOUNDARY_METHOD>=0) THEN
   ...
   M%W_MASK=1
   M%P_MASK=1
   ALLOCATE(M%CELL_INDEX_IBM(0:M%IBP1,0:M%JBP1,0:M%KBP1),STAT=IZERO)
   CALL ChkMemErr('INIT_IBM','CELL_INDEX_IBM',IZERO)
   M%CELL_INDEX_IBM=0
   CELL_COUNT=0
   DO K=1,M%KBAR
      DO J=1,M%JBAR
         DO I=1,M%IBAR
            ...
            M%CELL_INDEX_IBM(I,J,K)=CELL_COUNT
         ENDDO
      ENDDO
   ENDDO
ENDIF
