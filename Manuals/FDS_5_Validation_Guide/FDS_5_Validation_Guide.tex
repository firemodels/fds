...
\item Bryan Klein of NIST assisted in the development of techniques to automatically generate the plots that
...
\item Thanks to VTT, Finland, for their contribution of experimental data,
...
\item Thanks to Jerry Back, Craig Beyler and Phil DiNenno of Hughes Associates and Pat Tatem of
...
\item Thanks to Ken Steckler for providing details about the ``Steckler Compartment Experiments'' of 1979.
...
\item Thanks to Jeremy Thornock at the University of Utah for providing data on the Sandia helium plume.
\end{itemize}
