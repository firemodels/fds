...
SCARC_BICG_16MESH  = csvread([data_dir,'scarc2d_bicg_16mesh_devc.csv'],2,0);
...
time_scarc_bicg_16mesh  = SCARC_BICG_16MESH(:,1); pres_scarc_bicg_16mesh = SCARC_BICG_16MESH(:,5);
...
H(4)=plot(time_scarc_bicg_16mesh(1:10:end),pres_scarc_bicg_16mesh(1:10:end) ,'g^','LineWidth',Line_Width); hold on
...
axis([0 1 -2 2])
legend_handle=legend(H,'FFT 1 mesh','FFT 64 meshes','ScaRC-CG 64 meshes','ScaRC-BICG 16 meshes','ScaRC-GMG 64 meshes','Location','EastOutside');
legend boxoff
...
SVN_Filename = [data_dir,'scarc2d_cg_64mesh_svn.txt'];
