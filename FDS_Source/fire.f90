...
REAL(EB), INTENT(IN) :: T,DT
REAL(EB) :: ZZ_GET(1:N_TRACKED_SPECIES),DZZ(1:N_TRACKED_SPECIES),CP,H_S_N,ZETA_TMP,AIT_TMP,&
            REAC_SOURCE_TERM_TMP(N_TRACKED_SPECIES),Q_REAC_TMP(N_REACTIONS)
LOGICAL :: Q_EXISTS
REAL(EB), POINTER, DIMENSION(:,:,:) :: ZETA_P=>NULL(),AIT_P=>NULL()
...
ZETA_P => WORK1
ZETA_P = 0._EB
IF (TRANSPORT_UNMIXED_FRACTION) ZETA_P = ZZ(:,:,:,ZETA_INDEX)
   ...
   DO J=1,JBAR
      ILOOP: DO I=1,IBAR
         ...
         CALL COMBUSTION_MODEL( T,DT,ZZ_GET,Q(I,J,K),MIX_TIME(I,J,K),CHI_R(I,J,K),&
                                ...
                                TMP(I,J,K),RHO(I,J,K),MU(I,J,K),KRES(I,J,K),&
...
IF (TRANSPORT_UNMIXED_FRACTION) ZZ(:,:,:,ZETA_INDEX) = ZETA_P
...
SUBROUTINE COMBUSTION_MODEL(T,DT,ZZ_GET,Q_OUT,MIX_TIME_OUT,CHI_R_OUT,CHEM_SUBIT_OUT,REAC_SOURCE_TERM_OUT,Q_REAC_OUT,&
                            TMP_IN,RHO_IN,MU_IN,KRES_IN,ZETA_INOUT,AIT_IN,PBAR_IN,DELTA,CELL_VOLUME)
USE COMP_FUNCTIONS, ONLY: SHUTDOWN
USE MATH_FUNCTIONS, ONLY: EVALUATE_RAMP
USE PHYSICAL_FUNCTIONS, ONLY: GET_AVERAGE_SPECIFIC_HEAT,GET_SPECIFIC_GAS_CONSTANT,GET_ENTHALPY
REAL(EB), INTENT(IN) :: T,DT,TMP_IN,RHO_IN,MU_IN,KRES_IN,PBAR_IN,AIT_IN,DELTA,CELL_VOLUME
...
REAL(EB), INTENT(INOUT) :: ZZ_GET(1:N_TRACKED_SPECIES),ZETA_INOUT
REAL(EB) :: ERR_EST,ERR_TOL,A1(1:N_TRACKED_SPECIES),A2(1:N_TRACKED_SPECIES),A4(1:N_TRACKED_SPECIES),ZETA,ZETA_0,&
            ...
            PBAR_0,VEL_RMS,TAU_RES,ZZ_0(1:N_TRACKED_SPECIES),&
...
TAU_RES = MU_IN/(RHO_IN*SC)/MAX(2._EB*KRES_IN,TWO_EPSILON_EB)
