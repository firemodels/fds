...
REAL(EB), INTENT(IN) :: T
REAL(EB) :: DT_BC,TSI,UBAR,VBAR,WBAR,RAMP_FACTOR,RSUM_G,MU_G,SF_HTC
INTEGER  :: SURF_INDEX,IW,IP,ICF,ITW
INTEGER, INTENT(IN) :: NM
REAL(EB), POINTER, DIMENSION(:,:) :: PBAR_P
REAL(EB), POINTER, DIMENSION(:,:,:) :: UU,VV,WW,RHOP,OM_RHOP,HP
...
INTEGER :: IW,IC,ICG,ICF,IP,OBST_INDEX
REAL(EB), POINTER, DIMENSION(:,:) :: PBAR_P
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: ZZP
...
PARTICLE_LOOP: DO IP=1,NLP
   ...
   ! Add the particle off-gas to the gas phase mesh

   CALL DEPOSIT_PARTICLE_MASS
...
REAL(EB) :: RVC,M_DOT_PPP_SINGLE,ZZ_GET(1:N_TRACKED_SPECIES),DENOM,M_GAS,LENGTH,WIDTH,H_S_B
INTEGER :: N,NS,IDX1,IDX2,NQ,ITER,IIO,JJO,KKO,OTHER_MESH_OBST_INDEX,LL,SPECIES_BC_INDEX
...
REAL(EB) :: RADIUS,AREA_SCALING,RVC,M_DOT_PPP_SINGLE,M_DOT_SINGLE,CP,MW_RATIO,H_G,&
            ZZ_GET(1:N_TRACKED_SPECIES),M_GAS,LENGTH,WIDTH,H_S_B
INTEGER :: NS
TYPE(BOUNDARY_ONE_D_TYPE), POINTER :: ONE_D
...
INTEGER  :: IW,SURF_INDEX,COUNTER,DU,ICF
REAL(EB), POINTER, DIMENSION(:,:) :: PBAR_P
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: ZZP
TYPE(CFACE_TYPE), POINTER :: CFA
TYPE(WALL_TYPE), POINTER :: WC
...
INTEGER :: NWP,I,NL,N,OBST_INDEX,N_LAYER_CELLS_NEW(MAX_LAYERS),N_CELLS,ITMP,ITER,BACK_MESH,BACK_INDEX,BACK_WALL_INDEX
