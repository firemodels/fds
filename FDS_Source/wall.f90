...
USE PHYSICAL_FUNCTIONS, ONLY: GET_AVERAGE_SPECIFIC_HEAT,GET_SPECIFIC_HEAT
USE OUTPUT_DATA, ONLY: M_DOT
USE MATH_FUNCTIONS, ONLY : EVALUATE_RAMP
REAL(EB) :: RADIUS,AREA_SCALING,RVC,RHO_NEW,M_DOT_PPP,CP,CPBAR,MW_RATIO,H_G,DELTA_H_G,ZZ_GET(0:N_TRACKED_SPECIES),CPBAR2,X1,X2
REAL(EB), INTENT(IN) :: T
INTEGER, INTENT(IN) :: NM
