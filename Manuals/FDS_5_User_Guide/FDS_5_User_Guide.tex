...
\item[{\ct STATE\_FILE}] If {\ct .TRUE.}, produce an output file listing the species mass fractions associated with the mixture fraction, assuming complete combustion. It is {\ct .FALSE.} by default,
...
{\ct '[SPECIES]\_FLUX\_X'} is an appropriate output quantity if you want to know the mass flux of that species through an
...
{\ct BACK\_WALL\_TEMPERATURE}                   & $T_w$                                         & $^\circ$C      & B,D          \\ \hline
...
{\ct RADIANT\_INTENSITY}                        & See Section~\ref{info:heat_flux}              & kW/m$^2$       & D,I,P,S      \\ \hline
{\ct RADIATIVE\_FLUX}                           & See Section~\ref{info:heat_flux}              & kW/m$^2$       & B,D          \\ \hline
{\ct RADIATIVE\_FLUX\_GAS}                      & See Section~\ref{info:heat_flux}              & kW/m$^2$       & D            \\ \hline
...
{\ct WALL\_THICKNESS}                           & $\Delta x_w$                                  & m              & B,D          \\ \hline
