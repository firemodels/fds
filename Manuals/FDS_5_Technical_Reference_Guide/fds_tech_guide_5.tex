...
\be  \hbox{Fuel} +  \nu_\OTWO \, \mathrm{O_2}  \rightarrow  \nu_\COTWO \, \mathrm{CO_2} + \nu_\HTWOO \, \mathrm{H_2O} + \nu_\CO \, \mathrm{CO} +
     \nu_\So \, \mathrm{S}  \label{stoich} \ee
...
\be
   \nu_\So = \frac{W_\F}{W_\So} \; y_s  \label{soot_yield}
\ee
where:
\be
...
\be
   Z = Y_\F + \frac{W_\F}{x W_\COTWO} \, Y_\COTWO + \frac{W_\F}{x W_\CO} \, Y_\CO  + \frac{W_\F}{x W_\So} \, Y_\So
\label{Zdef} \ee
...
\end{eqnarray}
such that $Z=Z_1+Z_2$. Transport equations are required for both $Z_1$ and $Z_2$.  Note that since we are using our extra
...
\begin{eqnarray}  Z_1 &=& Y_\F    \\*[.1in]
                  Z_2 &=& \frac{W_\F}{(\hbox{x}-(1-X_\Hy) \nu_\So) \, W_\CO }    \;  Y_\CO \\*[.1in]
                  Z_3 &=& \frac{W_\F}{(\hbox{x}-(1-X_\Hy) \nu_\So) \, W_\COTWO } \;  Y_\COTWO  \end{eqnarray}
