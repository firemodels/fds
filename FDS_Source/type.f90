...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:) :: R_CDF,CDF,BREAKUP_R_CDF,BREAKUP_CDF,W_CDF,R50,LAMBDA
...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=13,N_PARTICLE_SCALAR_INTEGERS=7,N_PARTICLE_SCALAR_LOGICALS=3
