...
MESH_LOOP: DO NM=1,NMESHES
   ...
   READ_OBST_LOOP: DO NN=1,N_OBST_O
      ...
      IF (EVACUATION_ONLY(NM) .AND. SURF_ID=='null') SURF_ID=EVAC_SURF_DEFAULT
      ...
      DO NNNN=1,3
         IF (EVACUATION_ONLY(NM) .AND. SURF_IDS(NNNN)=='null') SURF_IDS(NNNN)=EVAC_SURF_DEFAULT
      ...
      DO NNNN=1,6
         IF (EVACUATION_ONLY(NM) .AND. SURF_ID6(NNNN)=='null') SURF_ID6(NNNN)=EVAC_SURF_DEFAULT
...
USE DEVICE_VARIABLES, ONLY : DEVICE_TYPE, DEVICE, N_DEVC, N_PROP, PROPERTY, PROPERTY_TYPE
USE CONTROL_VARIABLES
! Process the DEViCes
 
INTEGER  :: N,NN,NNN,NM,QUANTITY_INDEX,MAXCELLS,I,J,K
REAL(EB) :: XX,YY,ZZ,XX1,YY1,ZZ1,DISTANCE,SCANDISTANCE,DX,DY,DZ,SUBTOTAL_FLOWRATE,TOTAL_FLOWRATE
TYPE (DEVICE_TYPE),  POINTER :: DV
TYPE (PROPERTY_TYPE),POINTER :: PY
TYPE (TABLES_TYPE),  POINTER :: TA
...
PROC_DEVC_LOOP: DO N=1,N_DEVC
   ...
   IF (DV%PROP_ID /='null' .AND. PROPERTY(DV%PROP_INDEX)%SPRAY_PATTERN_INDEX>0) THEN
