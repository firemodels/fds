...
Predicted and measured heat fluxes from six compartment fires are shown on the following pages. The FDS grid resolution is chosen such that $D^*/\dx$ is 10 to 15 during the post-flashover phase.

\begin{figure}[ht]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_01_all_hfg} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_02_all_hfg}
\end{tabular*}
\label{JH_FRA_HF_1}
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_03_all_hfg} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_03A_all_hfg} 
\end{tabular*}
\label{JH_FRA_HF_2}
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_11_all_hfg} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_12_all_hfg}
\end{tabular*}
\label{JH_FRA_HF_3}
...
\begin{figure}[ht]
\centering
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_13_all_hfg}
\label{JH_FRA_HF_4}
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_21_all_hfg} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_22_all_hfg} 
\end{tabular*}
\label{JH_FRA_HF_5}
...
\begin{figure}[ht]
\centering
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JH_FRA/JH_FRA_compartment_23_all_hfg} 
\label{JH_FRA_HF_6}
...
\subsection{JIS Facade}

Figure~\ref{JIS_Facade_HF_Positions} indicates the location of the heat flux gauges on the outer wall of the JIS~A~1310 test configuation, described in Sec.~\ref{JIS_Facade_Description}. Figure~\ref{JIS_Facade_Heat_Flux} displays measured and predicted heat flux to the surface above a window.
...
\begin{figure}[p]
\centering
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_HF_600_kW} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_HF_750_kW} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_HF_900_kW}
...
{Smokeview rendering of one of the NRCC Facade experiments. The door is 0.94~m by 2.70~m tall (referred to as ``Window 2'' in the comparison plots). The fire is 10.3~MW.}
...
\hline
Test     & $D$     & $D^*$      & $\dot{Q}$   & $\dot{Q}^*$   & Observed  Flame \\
...
9        & 0.70    & 0.74       &  523        & 0.85    & 2.9 (based on 500~\unit{\degreeCelsius})       \\ \hline
\end{tabular}
...
Figure~\ref{TUS_Facade_HF_Positions} indicates the location of the heat flux gauges on the outer wall of the TUS Facade experiments, described in Sec.~\ref{TUS_Facade_Description}. Figures~\ref{TUS_Facade_Heat_Flux_1} through \ref{TUS_Facade_Heat_Flux_I} display measured and predicted heat flux to the surface above a window out of which emanates a fire plume. The measurements have been made along three vertical lines, a, b, and c, where b is along the centerline, and a and c are along the outer edges of the window.
...
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_1_HF_Line_a} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_2_HF_Line_a} &  
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_3_HF_Line_a} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_1_HF_Line_b} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_2_HF_Line_b} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_3_HF_Line_b} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_1_HF_Line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_2_HF_Line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_3_HF_Line_c}
\end{tabular*}
\caption[TUS Facade, heat flux, Case 1]{TUS Facade, heat flux, Case 1.}
\label{TUS_Facade_Heat_Flux_1}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{lll}
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_1_HF_Line_a} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_2_HF_Line_a} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_3_HF_Line_a} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_1_HF_Line_b} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_2_HF_Line_b} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_3_HF_Line_b} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_1_HF_Line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_2_HF_Line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_3_HF_Line_c} 
\end{tabular*}
\caption[TUS Facade, heat flux, Case 2]{TUS Facade, heat flux, Case 2.}
\label{TUS_Facade_Heat_Flux_2}
\end{figure}
...
\end{tabular*}
\caption[TUS Facade, heat flux, Case I]{TUS Facade, heat flux, Case I.}
\label{TUS_Facade_Heat_Flux_I}
\end{figure}
...
\caption[Summary of compartment surface heat flux predictions]{Summary of surface heat flux predictions.}
...
\caption[Summary of target heat flux predictions]{Summary of target heat flux predictions.}
\end{figure}
...
Figure~\ref{FM_Burner_Vertical_Heat_Flux} displays mean and rms vertical profiles of the radiation emission, in units of kW/m, from a 15~kW, 13.7~cm (inner) diameter ethylene burner at ambient oxygen concentrations of 21~\%, 17~\%, and 15~\%. Figure~\ref{FM_Burner_Radiant_Fraction} displays the predicted total radiant fraction for the four ambient oxygen levels.
