...
In this example, the initial gas-phase soot concentration is specified, and the only active deposition mechanism (i.e., soot removal term) is gravitational deposition. The transient gas-phase soot concentration can then be represented as
