...
SELECT CASE (SPEC_ID_USE)
   ...
   CASE('ACETYLENE')
      ...
      G_F = 8.E-8_EB*TE**2._EB - 0.0554*TE + 225.1_EB !kJ/mol
      FUEL = .TRUE.
   CASE('ACROLEIN')
      IF (TE<50._EB) THEN
   ...
   CASE('CARBON DIOXIDE')
      ...
      ENDIF
      G_F = 7.E-7_EB*TE**2._EB - 0.0028*TE - 393.62_EB !kJ/mol
   ...
   CASE('CARBON MONOXIDE')
      ...
      ENDIF
      G_F = 2.E-6_EB*TE**2._EB - 0.0903_EB*TE - 111.44_EB !kJ/mol
   ...
   CASE('FORMALDEHYDE')
      ...
      G_F = -6.E-17_EB*TE**5 + 1.E-12_EB*TE**4 - 7.E-9_EB*TE**3 + 2.E-5*TE**2 - 0.0107_EB*TE - 114.18_EB !kJ/mol 
   CASE('HYDROGEN')
      IF (TE<100._EB) THEN
   ...
   CASE('HYDROGEN ATOM') !NIST webbook
      ...
      G_F = -7.E-7*TE**2 - 0.0559_EB*TE + 220.63_EB !kJ/mol JANAF
   CASE('HYDROGEN BROMIDE')
      ...
      ENDIF
      IF (TE<300._EB) THEN
         G_F = -0.0835*TE-29.006 !kJ/mol
      ELSE
         G_F = 0.0000002_EB*TE**2-0.0073_EB*TE-53.561_EB
      ENDIF
   ...
   CASE('HYDROPEROXY RADICAL') ! HO2 (NIST webbook)
      ...
      G_F = 2.E-7_EB*TE**2 + 0.0472_EB*TE + 0.378_EB !kJ/mol (JANAF)
   ...
   CASE('WATER VAPOR')
      ...
      ENDIF
      G_F = 7.E-7_EB*TE**2._EB + 0.0538*TE - 245.25_EB !kJ/mol 
