...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION,CONVECTION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,MIXTURE_FRACTION=.FALSE., &
           ...
           MEAN_FORCING=.FALSE.,MEAN_FORCING_U=.FALSE.,MEAN_FORCING_V=.FALSE.,MEAN_FORCING_W=.FALSE.
...
REAL(EB) :: DT_SLCF,DT_BNDF,DT_DEVC,DT_DEVC_LINE,DT_PL3D,DT_PART,DT_RESTART,DT_ISOF,DT_HRR,DT_MASS,DT_PROF,DT_CTRL,DT_SPEC,DT_FLUSH
...
REAL(EB) :: DX_LS,DY_LS,PHI_MIN_LS,PHI_MAX_LS,ROS_0,ROS_HEADS,ROS_BACKS,ROS_BACKU
...
REAL(EB) :: RFAC_FORCING=0.5_EB,UMEAN=0._EB,VMEAN=0._EB,WMEAN=0._EB,FSUMU=0._EB,FSUMV=0._EB,FSUMW=0._EB
