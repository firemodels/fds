...
IF (CORRECTOR .AND. DO_Y_EQ) CALL NEW_PARTICLE_MASS_ENERGY_TRANSFER(T,NM)
...
SUBROUTINE NEW_PARTICLE_MASS_ENERGY_TRANSFER(T,NM)
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: DROP_DEN=>NULL(),DROP_RAD=>NULL(),DROP_TMP=>NULL(),MVAP_TOT=>NULL(),DROP_AREA=>NULL(),&
                                       DROP_DEN_ALL=>NULL(),M_L_TOT=>NULL(),T_EQ=>NULL(),M_EQ=>NULL(),H_L_TOT=>NULL(),&
                                       Q_R_TOT=>NULL()
