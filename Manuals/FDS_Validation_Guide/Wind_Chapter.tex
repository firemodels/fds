...
The atmospheric boundary layer is modeled using Monin-Obukhov similarity theory. The wind speed, $u$, and potential temperature\footnote{The potential temperature is given by $\theta=T(p_0/p)^{R/c_p}$, where $p_0$ is typically the ground level pressure and $R/c_p=0.286$  for air.}, $\theta$, vary with height, $z$, according to:
\begin{eqnarray}
...
The default rough wall model used in FDS, in the ``fully rough'' limit, is given by log law model:
\be 
...
$z_0$ (m)   & 0.0002 & 0.0002 & 0.0002 & 0.0002 & 0.0002 & 0.0002 & 0.0002      & 0.008  & 0.008  & 0.008      & 0.0003  & 0.0003 & 0.0003  \\ \hline
\end{tabular}
\end{center}
