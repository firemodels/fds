...
MAIN_LOOP: DO  
   ...
   DO NM=1,NMESHES
   IF (PROCESS(NM)/=MYID) CYCLE
      IF (DEBUG) WRITE(LU_ERR,'(A,I8,A,I3,A,L)') 'Cycle ',ICYC,', Mesh ',NM, ' status=',ACTIVE_MESH(NM)
...
CALL MPI_REDUCE(STOP_STATUS,PROCESS_STOP_STATUS,1,MPI_INTEGER,MPI_MAX,0,MPI_COMM_WORLD,IERR)
