...
\begin{tabular}{cp{1.0in}}
 \includegraphics[height=\figheightE]{SCRIPT_FIGURES/plume5c_fed_slice_00}\\
 \includegraphics[height=\figheightE]{SCRIPT_FIGURES/plume5c_fed_slice_10}\\
 \includegraphics[height=\figheightE]{SCRIPT_FIGURES/plume5c_fed_slice_30}\\
&\raisebox{0.5in}[0pt]{\includegraphics[height=7.5in]{../SMV_User_Guide/figures/colorbar_fed}}
 \end{tabular}
\end{center}
...
\begin{tabular}{rccl}
 ...
 \end{tabular}
\end{center}
 \caption[FED slice file test.] {FED slice file test. A fractional effective dose
 is computed for constant CO2, CO and O2 data.  The FED value displayed should
 equal xxx.}
\label{figvslicetest}%
\end{figure}
