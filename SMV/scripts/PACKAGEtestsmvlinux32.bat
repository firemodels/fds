...
echo copying ..\for_bundle\uploads\smv_test_%smv_revision%_linux32.tar.gz to %gupload%
copy ..\for_bundle\uploads\smv_test_%smv_revision%_linux32.tar.gz "%gupload%"
