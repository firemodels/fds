...
\begin{tabular}{cccp{1.0in}}
 ...
 node centered data&data chopped below 140\degC&cell centered data\\
 &&&\raisebox{0.5in}[0pt]{\includegraphics[height=7.5in]{figures/colorbar_20_620}}\\
 \end{tabular}
\end{center}
...
\begin{tabular}{cc}
 ...
 \includegraphics[width=2.7in]{SCRIPT_FIGURES/cell_test_z3p5}&
 \includegraphics[width=2.7in]{SCRIPT_FIGURES/cell_test_3D}\\

 a) plan view (XY), $1\le i \le 3, 1\le j \le 4, k=4$&
 b) 3D view\\
 \includegraphics[width=2.7in]{SCRIPT_FIGURES/cell_test_y2p5}&
 \includegraphics[width=3.6in]{SCRIPT_FIGURES/cell_test_x1p5}\\
  c) elevation view (XZ), $1\le  i \le 3, j=3, 1\le k\le 5$&
  d) side view (YZ), $i=2,1\le j\le 4,1\le k \le 5$
\end{tabular}
\end{center}
 \caption[Cell centered slice file test.]{Test that Smokeview is inputting cell centered slice file
 data properly.
 Cell values are initialized in FDS to $100*i + 10*j + k$. Cell values displayed by Smokeview should match listed $(i,j,k)$ indices. }
\label{figslicetest}%
\end{figure}
