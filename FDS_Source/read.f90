...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,FYI, &
                ...
                WIND_ONLY,TERRAIN_CASE,DYNSMAG, &
                PROJECTION,FORCE_VECTOR,DEBUG_OPENMP, &
                CLIP_MASS_FRACTION,CHECK_VN,CHECK_GR, &
                IMMERSED_BOUNDARY_METHOD,LIMITING_DT_RATIO, &
...
NAMELIST /DUMP/ RENDER_FILE,SMOKE3D,SMOKE3D_QUANTITY,FLUSH_FILE_BUFFERS,MASS_FILE, &
                ...
                PLOT3D_PART_ID,PLOT3D_VELO_INDEX,VELOCITY_ERROR_FILE,DT_SL3D,SIG_FIGS,SIG_FIGS_EXP,EB_PART_FILE
...
NAMELIST /REAC/ E,A,HEAT_OF_COMBUSTION,FYI,FUEL,EPUMO2,ID, N_S, &
                ...
                N_T,CHECK_ATOM_BALANCE,REAC_ATOM_ERROR,REAC_MASS_ERROR
...
NAMELIST /SURF/ TMP_FRONT,TMP_INNER,THICKNESS,MASS_FRACTION,VEL,VEL_T,NPPC, &
                ...
                MASS_FLUX_TOTAL,GEOMETRY,STRETCH_FACTOR,MATL_MASS_FRACTION,EMISSIVITY,COLOR,MAX_PRESSURE,&
                IGNITION_TEMPERATURE,HEAT_OF_VAPORIZATION,REGRID_FACTOR,NET_HEAT_FLUX,LAYER_DIVIDE,SURFACE_DENSITY, &
