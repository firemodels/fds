...
\label{Vettori:Results}

The behavior of ceiling jets is a critical component in the design of automatic fire suppression systems, such as sprinklers. The Vettori cases examined the effects of fire location, fire growth rate, and ceiling obstructions on the temperature of ceiling jets and activation time of sprinklers. The results that follow provide useful data as to the predictive capacity of FDS with regards to ceiling jet behavior.
...
This series of experiments involved a room with varying fire growth rates, burner configurations, level of ceiling slope, and obstruction. The effects of these variables of sprinkler activation time, as well as ceiling jet temperatures, is valuable in assessing FDS as a prediction tool.

The following plots show various thermocouple temperatures within the ceiling jet. Following is a scatter plot examining sprinkler activation times.
