...
CALL MPI_BCAST(REAL_BUFFER_EXTERNAL,N_RAMP,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
CALL MPI_BCAST(LOGICAL_BUFFER_EXTERNAL,N_CTRL,MPI_LOGICAL,0,MPI_COMM_WORLD,IERR)
