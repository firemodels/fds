...
MESH_LOOP: DO NM=1,NMESHES
   ...
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      MESHES(1)%ALL_SLICE_NAMES(NN) = TRIM(SL%SMOKEVIEW_LABEL(1:30))
   ENDDO SLCF_LOOP
   ...
   DO NN = 1,N_SLCF
      ...
      ENDIF
      DO I = 1,N_UNIQUE_SLCF
         !(*,*) NN, I, SL%SLCF_NAME, UNIQUE_SLICE_NAMES(I)
   ...
   DO I = 1,N_UNIQUE_SLCF
      WRITE(*,*) "MESH", NM, "SLCF_NAME ", TRIM(M%UNIQUE_SLICE_NAMES(I)), " EMPTY ", M%EMPTY_UNIQUE_SLICE(I)
   ENDDO
ENDDO MESH_LOOP

WRITE(*,*) "AFTER PROCESSING ALL MESHES"
DO NM=1,NMESHES
   DO I = 1,N_UNIQUE_SLCF
      WRITE(*,*) "MESH", NM, "SLCF_NAME ", TRIM(MESHES(NM)%UNIQUE_SLICE_NAMES(I)),&
                 " EMPTY ", MESHES(NM)%EMPTY_UNIQUE_SLICE(I)
   ENDDO
ENDDO
