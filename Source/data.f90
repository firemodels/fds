...
INTEGER :: N_BNDF,N_ISOF,N_PROF,N_SLCF_MAX=0,N_SMOKE3D=0,N_RADF_MAX=0
...
OUTPUT_QUANTITY(187)%NAME = 'TOTAL NUMBER OF PARTICLES'
OUTPUT_QUANTITY(187)%UNITS = '#'
OUTPUT_QUANTITY(187)%SHORT_NAME = 'NLP_tot'
OUTPUT_QUANTITY(187)%ISOF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(187)%SLCF_APPROPRIATE = .FALSE.
...
OUTPUT_QUANTITY(-50)%NAME = 'FLUX TIME PRODUCT'
OUTPUT_QUANTITY(-50)%UNITS= 'kJ/m2'
OUTPUT_QUANTITY(-50)%SHORT_NAME = 'ftp'
...
OUTPUT_QUANTITY(-83)%NAME = 'INSIDE AVERAGE TEMPERATURE'
OUTPUT_QUANTITY(-83)%UNITS = 'C'
OUTPUT_QUANTITY(-83)%SHORT_NAME = 'T_avg'
OUTPUT_QUANTITY(-83)%BNDF_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(-83)%PROF_APPROPRIATE = .FALSE.
