...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Wall_Temperature} \\
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Ceiling_Temperature}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Floor_Temperature}
\end{tabular}
\end{center}
