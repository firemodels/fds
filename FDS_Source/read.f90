...
NAMELIST /REAC/ E,BOF,HEAT_OF_COMBUSTION,FYI,FUEL,OXIDIZER,EPUMO2,ID, N_S,&
                ...
                EDDY_DISSIPATION,C_EDC,HRRPUA_SHEET,HRRPUA_SHEET_EXPONENT,HRRPUV_AVERAGE,AIT,FIXED_RESIDENCE_TIME
   ...
   K_MULT_LOOP: DO KK=MR%K_LOWER,MR%K_UPPER
      J_MULT_LOOP: DO JJ=MR%J_LOWER,MR%J_UPPER
         I_MULT_LOOP: DO II=MR%I_LOWER,MR%I_UPPER
            ...
            IN%SHAPE         = SHAPE
            IN%DROPLET_FILENAME = TRIM(DROPLET_FILENAME)
            IF (IN%DROPLET_FILENAME/='null') IN%DROPLET_INIT_FILE=.TRUE.
