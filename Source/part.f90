...
UBAR = AFILL2(U,IIG_OLD-1,JJY,KKZ,X_WGT2,Y_WGT,Z_WGT)
VBAR = AFILL2(V,IIX,JJG_OLD-1,KKZ,X_WGT,Y_WGT2,Z_WGT)
WBAR = AFILL2(W,IIX,JJY,KKG_OLD-1,X_WGT,Y_WGT,Z_WGT2)
...
FVX_D(IIG_OLD-1,JJY+1,KKZ  ) = FVX_D(IIG_OLD-1,JJY+1,KKZ  ) - ACCEL_X*(1-X_WGT2)*(   Y_WGT)*(1.-Z_WGT)
FVX_D(IIG_OLD  ,JJY+1,KKZ  ) = FVX_D(IIG_OLD  ,JJY+1,KKZ  ) - ACCEL_X*(  X_WGT2)*(   Y_WGT)*(1.-Z_WGT)
FVX_D(IIG_OLD-1,JJY  ,KKZ+1) = FVX_D(IIG_OLD-1,JJY  ,KKZ+1) - ACCEL_X*(1-X_WGT2)*(1.-Y_WGT)*(   Z_WGT)
FVX_D(IIG_OLD  ,JJY  ,KKZ+1) = FVX_D(IIG_OLD  ,JJY  ,KKZ+1) - ACCEL_X*(  X_WGT2)*(1.-Y_WGT)*(   Z_WGT)
FVX_D(IIG_OLD-1,JJY+1,KKZ+1) = FVX_D(IIG_OLD-1,JJY+1,KKZ+1) - ACCEL_X*(1-X_WGT2)*(   Y_WGT)*(   Z_WGT)
FVX_D(IIG_OLD  ,JJY+1,KKZ+1) = FVX_D(IIG_OLD  ,JJY+1,KKZ+1) - ACCEL_X*(  X_WGT2)*(   Y_WGT)*(   Z_WGT)

FVY_D(IIX  ,JJG_OLD-1,KKZ  ) = FVY_D(IIX  ,JJG_OLD-1,KKZ  ) - ACCEL_Y*(1.-X_WGT)*(1-Y_WGT2)*(1.-Z_WGT)
FVY_D(IIX+1,JJG_OLD-1,KKZ  ) = FVY_D(IIX+1,JJG_OLD-1,KKZ  ) - ACCEL_Y*(   X_WGT)*(1-Y_WGT2)*(1.-Z_WGT)
FVY_D(IIX  ,JJG_OLD  ,KKZ  ) = FVY_D(IIX  ,JJG_OLD  ,KKZ  ) - ACCEL_Y*(1.-X_WGT)*(  Y_WGT2)*(1.-Z_WGT)
FVY_D(IIX+1,JJG_OLD  ,KKZ  ) = FVY_D(IIX+1,JJG_OLD  ,KKZ  ) - ACCEL_Y*(   X_WGT)*(  Y_WGT2)*(1.-Z_WGT)
FVY_D(IIX  ,JJG_OLD-1,KKZ+1) = FVY_D(IIX  ,JJG_OLD-1,KKZ+1) - ACCEL_Y*(1.-X_WGT)*(1-Y_WGT2)*(   Z_WGT)
FVY_D(IIX+1,JJG_OLD-1,KKZ+1) = FVY_D(IIX+1,JJG_OLD-1,KKZ+1) - ACCEL_Y*(   X_WGT)*(1-Y_WGT2)*(   Z_WGT)
FVY_D(IIX  ,JJG_OLD  ,KKZ+1) = FVY_D(IIX  ,JJG_OLD  ,KKZ+1) - ACCEL_Y*(1.-X_WGT)*(  Y_WGT2)*(   Z_WGT)
FVY_D(IIX+1,JJG_OLD  ,KKZ+1) = FVY_D(IIX+1,JJG_OLD  ,KKZ+1) - ACCEL_Y*(   X_WGT)*(  Y_WGT2)*(   Z_WGT)

FVZ_D(IIX  ,JJY  ,KKG_OLD-1) = FVZ_D(IIX  ,JJY  ,KKG_OLD-1) - ACCEL_Z*(1.-X_WGT)*(1.-Y_WGT)*(1-Z_WGT2)
FVZ_D(IIX+1,JJY  ,KKG_OLD-1) = FVZ_D(IIX+1,JJY  ,KKG_OLD-1) - ACCEL_Z*(   X_WGT)*(1.-Y_WGT)*(1-Z_WGT2)
FVZ_D(IIX  ,JJY+1,KKG_OLD-1) = FVZ_D(IIX  ,JJY+1,KKG_OLD-1) - ACCEL_Z*(1.-X_WGT)*(   Y_WGT)*(1-Z_WGT2)
FVZ_D(IIX+1,JJY+1,KKG_OLD-1) = FVZ_D(IIX+1,JJY+1,KKG_OLD-1) - ACCEL_Z*(   X_WGT)*(   Y_WGT)*(1-Z_WGT2)
FVZ_D(IIX  ,JJY  ,KKG_OLD  ) = FVZ_D(IIX  ,JJY  ,KKG_OLD  ) - ACCEL_Z*(1.-X_WGT)*(1.-Y_WGT)*(  Z_WGT2)
FVZ_D(IIX+1,JJY  ,KKG_OLD  ) = FVZ_D(IIX+1,JJY  ,KKG_OLD  ) - ACCEL_Z*(   X_WGT)*(1.-Y_WGT)*(  Z_WGT2)
FVZ_D(IIX  ,JJY+1,KKG_OLD  ) = FVZ_D(IIX  ,JJY+1,KKG_OLD  ) - ACCEL_Z*(1.-X_WGT)*(   Y_WGT)*(  Z_WGT2)
FVZ_D(IIX+1,JJY+1,KKG_OLD  ) = FVZ_D(IIX+1,JJY+1,KKG_OLD  ) - ACCEL_Z*(   X_WGT)*(   Y_WGT)*(  Z_WGT2)
