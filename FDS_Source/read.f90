...
CHARACTER(60) :: TEXTURE_MAP,BOUNDARY_CONDITION_FILENAME,BOUNDARY_COORDINATE_FILENAME,HEAT_TRANSFER_MODEL
CHARACTER(25) :: COLOR
...
NAMELIST /SURF/ ADIABATIC,BACKING,BOUNDARY_CONDITION_FILENAME,BOUNDARY_COORDINATE_FILENAME,BURN_AWAY,CELL_SIZE_FACTOR,COLOR, &
                ...
                FIRELINE_MLR_MAX,FREE_SLIP,FYI,GEOMETRY,HEAT_OF_VAPORIZATION,HEAT_TRANSFER_MODEL,HRRPUA,H_FIXED,&
                ID,IGNITION_TEMPERATURE,LAYER_DIVIDE,&
...
!  SF%VEG_DEHYDRATION_RATE_MAX = SRF_VEG_DEHYDRATION_RATE_MAX
   ...
   SF%COOR_FILENAME        = BOUNDARY_COORDINATE_FILENAME   
...
BOUNDARY_COORDINATE_FILENAME = 'null'
BURN_AWAY               = .FALSE.
