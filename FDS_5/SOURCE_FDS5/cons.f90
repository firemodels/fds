...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, &
         ...
         FREEZE_VELOCITY=.FALSE.,CHECK_BOUNDEDNESS=.FALSE.,ADJUST_HOR=.TRUE.
...
REAL(EB) :: MW_AIR,MW_SOOT,HRRPUA_SHEET=200._EB,DIMENSION_SHEET=2._EB,RHO_SOOT,VISIBILITY_FACTOR,MASS_EXTINCTION_COEFFICIENT,EC_LL, &
            MIX_TIME_FACTOR=1._EB
