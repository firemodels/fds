...
\be  \rho_{\rm w} = \frac{\overline{p}_m}{ \calR \, T_{\rm w} \, \sum_\alpha (Z_{\rm \alpha,w}/W_\alpha) }  \ee
...
\be T_{ijk} = \frac{\bp_m}{\rho_{ijk} \calR\, \sum_{\alpha=0}^{N_s} (Z_{\alpha,ijk}/W_\alpha)}\ee
...
\be
  \bp_{\rm eq} = \sum_m \left( \bp_m \int_{\Omega_m} {\cal P} \, \d V  \right)  \Big/  \sum_m \int_{\Omega_m} {\cal P} \, \d V \approx \frac{ \sum_m V_m }{ \sum_m (V_m/\bp_m) }
\ee
Note that
\be
...
\be
   \dod{\bp_{\rm eq}}{t} = \left( \sum_m \int_{\Omega_m} {\cal D} \, \d V - \sum_m \int_{\partial \Omega_m} \bu \cdot \d \bS \right) \Big/ \sum_m \int_{\Omega_m} {\cal P} \, \d V
\ee
