...
SF%N_ONE_D_STORAGE_REALS    = N_ONE_D_SCALAR_REALS    + SUM(SF%ONE_D_REALS_ARRAY_SIZE(1:10))
...
SF%WALL_REALS_ARRAY_SIZE(6) = SF%NVEG_L                     ! VEG_FUELMASS_L
SF%WALL_REALS_ARRAY_SIZE(7) = SF%NVEG_L                     ! VEG_MOISTMASS_L
SF%WALL_REALS_ARRAY_SIZE(8) = SF%NVEG_L+1                   ! VEG_TMP_L

SF%N_WALL_STORAGE_REALS    = N_WALL_SCALAR_REALS    + SUM(SF%WALL_REALS_ARRAY_SIZE(1:8))    + SF%N_ONE_D_STORAGE_REALS
...
WC%JD11_INDEX         => OS%INTEGERS(13,STORAGE_INDEX) ; IF (NEW) WC%JD11_INDEX = 0
WC%JD12_INDEX         => OS%INTEGERS(14,STORAGE_INDEX) ; IF (NEW) WC%JD12_INDEX = 0
WC%JD21_INDEX         => OS%INTEGERS(15,STORAGE_INDEX) ; IF (NEW) WC%JD21_INDEX = 0
WC%JD22_INDEX         => OS%INTEGERS(16,STORAGE_INDEX) ; IF (NEW) WC%JD22_INDEX = 0
...
WC%RDN                => OS%REALS( 5,STORAGE_INDEX) ; IF (NEW) WC%RDN = 1._EB
WC%U_TAU              => OS%REALS( 6,STORAGE_INDEX) ; IF (NEW) WC%U_TAU = 0._EB
WC%UVW_GHOST          => OS%REALS( 7,STORAGE_INDEX) ; IF (NEW) WC%UVW_GHOST = 0._EB
WC%UW0                => OS%REALS( 8,STORAGE_INDEX) ; IF (NEW) WC%UW0 = 0._EB
WC%XW                 => OS%REALS( 9,STORAGE_INDEX)
WC%Y_PLUS             => OS%REALS(10,STORAGE_INDEX) ; IF (NEW) WC%Y_PLUS = 1._EB
WC%YW                 => OS%REALS(11,STORAGE_INDEX)
WC%ZW                 => OS%REALS(12,STORAGE_INDEX)
WC%VEG_HEIGHT         => OS%REALS(13,STORAGE_INDEX)
WC%VEL_ERR_NEW        => OS%REALS(14,STORAGE_INDEX) ; IF (NEW) WC%VEL_ERR_NEW = 0._EB
WC%V_DEP              => OS%REALS(15,STORAGE_INDEX) ; IF (NEW) WC%V_DEP = 0._EB
WC%Q_LEAK             => OS%REALS(16,STORAGE_INDEX) ; IF (NEW) WC%Q_LEAK = 0._EB
...
I1 = I2+1 ; I2 = I1 + SF%WALL_REALS_ARRAY_SIZE(6) - 1  ; WC%VEG_FUELMASS_L(1:I2-I1+1)  => OS%REALS(I1:I2,STORAGE_INDEX)
I1 = I2+1 ; I2 = I1 + SF%WALL_REALS_ARRAY_SIZE(7) - 1  ; WC%VEG_MOISTMASS_L(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
I1 = I2+1 ; I2 = I1 + SF%WALL_REALS_ARRAY_SIZE(8) - 1  ; WC%VEG_TMP_L(0:I2-I1)         => OS%REALS(I1:I2,STORAGE_INDEX)

CALL ONE_D_POINTERS(WALL_INDEX_LOCAL,NEW,N_WALL_SCALAR_REALS+SUM(SF%WALL_REALS_ARRAY_SIZE(1:8)), &
...
INTEGER :: I,J
REAL(EB), POINTER, DIMENSION(:) :: DUMMY
TYPE (CFACE_TYPE), POINTER :: CF

CF => MESHES(NM)%CFACE(CFACE_INDEX_LOCAL)

! Assign and initialize integers

CF%CFACE_INDEX        => OS%INTEGERS(1,STORAGE_INDEX) ; IF (NEW) CF%CFACE_INDEX   = CFACE_INDEX
CF%SURF_INDEX         => OS%INTEGERS(2,STORAGE_INDEX) ; IF (NEW) CF%SURF_INDEX    = SURF_INDEX
CF%BOUNDARY_TYPE      => OS%INTEGERS(3,STORAGE_INDEX) ; IF (NEW) CF%BOUNDARY_TYPE = NULL_BOUNDARY
CF%CUT_FACE_IND1      => OS%INTEGERS(4,STORAGE_INDEX) ; IF (NEW) CF%CUT_FACE_IND1 = -11
CF%CUT_FACE_IND2      => OS%INTEGERS(5,STORAGE_INDEX) ; IF (NEW) CF%CUT_FACE_IND2 = -11

! Assign and initialize reals

CF%AREA               => OS%REALS(1,STORAGE_INDEX)
CF%X                  => OS%REALS(2,STORAGE_INDEX)
CF%Y                  => OS%REALS(3,STORAGE_INDEX)
CF%Z                  => OS%REALS(4,STORAGE_INDEX)
