...
\chapter{Gaurd Cell Interpolation for Consistent Gradients}
\label{ch:flux_matching_uglmat}

This section describes the details of properly matching the pressure gradient $\nabla H$ at a coarse-fine mesh interface for use with the UGLMAT (unstructured global matrix) pressure solver.

\section{Grid Refinement Interface Treatment}
