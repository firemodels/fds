...
DO N=1,N_TRACKED_SPECIES
   ...
   ITMP = NINT(TMPA)
   WRITE(LU_OUTPUT,'(A)') ' '
   WRITE(LU_OUTPUT,'(A,ES9.2)')  '   Viscosity (kg/m/s)    Ambient (TMPA): ', MU_RSQMW_Z(ITMP,N)/RSQ_MW_Z(N)
   ...
   WRITE(LU_OUTPUT,'(A,ES9.2)')  '   Therm. Cond. (W/m/K)  Ambient (TMPA): ', K_RSQMW_Z(ITMP,N)/RSQ_MW_Z(N)
   ...
   WRITE(LU_OUTPUT,'(A,ES9.2)')  '        Enthalpy (J/kg)  Ambient (TMPA): ', CPBAR_Z(ITMP,N)*TMPA
   ...
   WRITE(LU_OUTPUT,'(A,ES9.2)')  '   Spec. Heat (J/kg/K)   Ambient (TMPA): ', CP_Z(ITMP,N)
   ...
   WRITE(LU_OUTPUT,'(A,ES9.2)')  '   Diff. Coeff. (m^2/s)  Ambient (TMPA): ', D_Z(ITMP,N)
