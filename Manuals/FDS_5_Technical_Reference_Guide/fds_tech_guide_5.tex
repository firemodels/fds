...
\Huge \flushright{Fire Dynamics Simulator (Version 5) \\ Technical Reference Guide \\ (Draft: August 28, 2007)}
...
\be  \mathrm{C_xH_yO_zN_aM} +  \nu_\OTWO \, \mathrm{O_2}  \rightarrow  \nu_\COTWO \, \mathrm{CO_2} + \nu_\HTWOO \, \mathrm{H_2O} + \nu_\CO \, \mathrm{CO} +
     \nu_\So \, \mathrm{S}  + \nu_\NTWO \, \mathrm{N_2} + \mathrm{M}  \label{stoich} \ee
Note that the nitrogen in the fuel molecule is assumed to form $\mathrm{N_2}$ only. All other atoms in the fuel molecule are combined into
species $\mathrm{M}$. Soot is assumed to be a mixture of carbon and hydrogen with the hydrogen atomic
...
\hfill \parbox{3.5in}{\begin{eqnarray}
                  ...
                  Y_\M     &=& \frac{W_\M}{W_\F} \; Y_\F^I \; Z_2
\end{eqnarray} }
...
\begin{eqnarray}
\mathrm{C_xH_yO_zN_aM} +  \nu_\OTWO' \mathrm{O_2}  &\rightarrow&  \nu_\HTWOO \mathrm{H_2O} + (\nu_\CO'+ \nu_\CO) \, \mathrm{CO} +
     \nu_\So \, \mathrm{S}  + \nu_\NTWO \, \mathrm{N_2} + \mathrm{M}  \\*[.1in]
...
\hfill \parbox{3.5in}{\begin{eqnarray}
                  ...
                  Y_\M     &=& \frac{W_\M}{W_\F} \; Y_\F^I \; (Z_2 + Z_3)
\end{eqnarray} }
The stoichiometric coefficients are defined:
