...
TYPE PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: DENSITY,TMP_V=-1._EB,TMP_MELT=-1._EB,FTPR,HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               ...
               REAL_REFRACTIVE_INDEX,COMPLEX_REFRACTIVE_INDEX,TOL_INT
...
TYPE REACTION_TYPE
   ...
   LOGICAL :: IDEAL,CHECK_ATOM_BALANCE,REVERSIBLE
...
TYPE FACET_TYPE
   INTEGER :: VERTEX(3)=0,IBC=0
   CHARACTER(30) :: SURF_ID='null'
   REAL(EB) :: NVEC(3)=0._EB,TMP_F=300._EB,TMP_G=300._EB,AREA=0._EB
   TYPE(LINKED_LIST_TYPE), POINTER :: P_CELL_LIST,U_CELL_LIST,V_CELL_LIST,W_CELL_LIST
