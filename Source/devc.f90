...
TYPE SUBDEVICE_TYPE
   REAL(EB) :: VALUE_1=0._EB,VALUE_2=0._EB,X1,X2,Y1,Y2,Z1,Z2
...
TYPE DEVICE_TYPE
   ...
   REAL(EB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INITIAL_VALUE=-1.E10_EB,INSTANT_VALUE,VALUE=0._EB,SMOOTHED_VALUE=-1.E10_EB, &
               DEPTH,TMP_L,Y_C,OBSCURATION,DELAY,ROTATION,SMOOTHING_FACTOR=0._EB,VALUE_1,VALUE_2,&
               TIME_MIN_VALUE=1.E10_EB,TIME_MAX_VALUE=-1.E10_EB,&
               ...
               OVEC(3),CELL_L=-1._EB,RMS_VALUE=0._EB,RMS_VALUE2=0._EB,COV_VALUE=0._EB,TIME_INTEGRAL=0._EB,TIME_INTEGRAL2=0._EB
   ...
   INTEGER  :: N_SUBDEVICES=0,OUTPUT_INDEX,OUTPUT2_INDEX,IOR,IOR_ASSUMED=0,WALL_INDEX=-1,ORDINAL,I,J,K,MESH,&
               I_DEPTH,N_PATH,N_T_E,PROP_INDEX,ORIENTATION_INDEX=0,&
