...
\begin{table}[!ht]
\caption[Validation input parameters for iBMB cases, HGL temperature]
{Summary of validation input parameters used for iBMB cases, HGL temperature.}
...
\hline
           &                    &                 &            &            &            &                 &                    &                  \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$L$}  &  \rb{$W$}  &  \rb{$H$}  &  \rb{$\dot m$}  &  \rb{$T_\infty$}   &  \rb{$t_{end}$}  \\
...
\hline
           &                    &                 &                 &              &              &                    &                  \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$\dot m$}  &  \rb{$H_v$}  &  \rb{$W_v$}  &  \rb{$T_\infty$}   &  \rb{$t_{end}$}  \\
...
\hline
                       &              \\
\rb{Input Parameter}   &  \rb{Value}  \\ \hline \hline
$\rho_{s}$ (kg/m$^3$)  &  7833        \\ \hline
$c_{s}$ (kJ/kg/K)      &  0.465       \\ \hline
$\epsilon$ (-)         &  0.7         \\ \hline
...
\hline
           &                    &                 &              &              &                    \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$H_v$}  &  \rb{$W_v$}  &  \rb{$T_infty$}    \\
