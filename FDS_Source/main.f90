...
ALLOCATE(REAL_BUFFER_7(N_DUCTNODES,N_GAS_SPECIES,NMESHES))
ALLOCATE(REAL_BUFFER_8(0:N_ZONE,0:N_ZONE,NMESHES))
ALLOCATE(REAL_BUFFER_9(0:N_ZONE,0:N_ZONE,N_GAS_SPECIES,NMESHES))
ALLOCATE(REAL_BUFFER_10(N_DUCTS,NMESHES))
ALLOCATE(INTEGER_BUFFER_1(NMESHES))
ALLOCATE(INTEGER_BUFFER_2(NMESHES,NMESHES))
...
IF (USE_MPI) THEN
   INTEGER_BUFFER_2 = I_MIN
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       I_MIN,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
   INTEGER_BUFFER_2 = I_MAX
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       I_MAX,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
   INTEGER_BUFFER_2 = J_MIN
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       J_MIN,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
   INTEGER_BUFFER_2 = J_MAX
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       J_MAX,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
   INTEGER_BUFFER_2 = K_MIN
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       K_MIN,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
   INTEGER_BUFFER_2 = K_MAX
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       K_MAX,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
   INTEGER_BUFFER_2 = NIC
   CALL MPI_ALLGATHERV(INTEGER_BUFFER_2(1,DISPLS(MYID)+1),COUNTS2D(MYID),MPI_INTEGER, &
                       NIC,COUNTS2D,DISPLS2D,MPI_INTEGER,MPI_COMM_WORLD,IERR)
ENDIF
...
USE HVAC_ROUTINES, ONLY: NODE_CP,NODE_P,NODE_TMP,NODE_RHO,NODE_RSUM,NODE_YY,LEAK_CP,LEAK_TMP,LEAK_RHO,LEAK_RSUM,LEAK_YY
...
REAL_BUFFER_7 = NODE_YY
CALL MPI_GATHERV(REAL_BUFFER_7(1,1,DISPLS(MYID)+1),COUNTS_HVAC(MYID)*N_GAS_SPECIES,MPI_DOUBLE_PRECISION, &
                 NODE_YY,COUNTS_HVAC*N_GAS_SPECIES,DISPLS_HVAC*N_GAS_SPECIES,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
...
IF (LEAK_DUCTS > 0) THEN
   ...
   REAL_BUFFER_9 = LEAK_YY 
   CALL MPI_GATHERV(REAL_BUFFER_9(0,0,1,DISPLS(MYID)+1),COUNTS_LEAK(MYID)*N_GAS_SPECIES,MPI_DOUBLE_PRECISION, &
                    LEAK_YY,COUNTS_LEAK*N_GAS_SPECIES,DISPLS_LEAK*N_GAS_SPECIES,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
ENDIF
...
REAL_BUFFER_6 = NODE_TMP
CALL MPI_SCATTER(REAL_BUFFER_6(1,1),SIZE(NODE_TMP),MPI_DOUBLE_PRECISION, &
                 NODE_TMP,SIZE(NODE_TMP),MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
REAL_BUFFER_6 = NODE_RHO
CALL MPI_SCATTER(REAL_BUFFER_6(1,1),SIZE(NODE_RHO),MPI_DOUBLE_PRECISION, &
                 NODE_RHO,SIZE(NODE_RHO),MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
REAL_BUFFER_10 = DUCT_U
CALL MPI_SCATTER(REAL_BUFFER_10(1,1),SIZE(DUCT_U),MPI_DOUBLE_PRECISION, &
                 DUCT_U,SIZE(DUCT_U),MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
REAL_BUFFER_7 = NODE_YY
CALL MPI_SCATTER(REAL_BUFFER_7(1,1,1),SIZE(NODE_YY),MPI_DOUBLE_PRECISION, &
                 NODE_YY,SIZE(NODE_YY),MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
