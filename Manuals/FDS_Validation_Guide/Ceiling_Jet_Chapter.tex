...
FDS is a computational fluid dynamics (CFD) model and has no specific ceiling jet algorithm. Rather, temperatures throughout the fire compartment are computed directly from the governing conservation equations. Nevertheless, temperature measurements near the ceiling can be used to evaluate the model's ability to predict the activation times of sprinklers, smoke alarms, and other fire protection devices.

This chapter first presents comparisons of model predictions and temperature measurements near to the ceiling. Next, predicted sprinkler activation times and the total number of activations are compared with measurements. Finally, predicted smoke alarm activation times are compared with measurements. 
...
The primary purpose of the NIST Dunes 2000 experiments was to measure smoke alarm activation times in a single-story manufactured home. Thermocouple trees were located at each of the five smoke alarm measurement stations. The highest thermocouple can be compared to ceiling jet temperature predictions. The plots on the following page show the measured and predicted ceiling jet temperatures for the five measuring stations.
...
\section{Smoke Alarm Activation Times}
