...
REAL(EB) :: TNOW,MTOT,ETOT,VTOT,YYTOT(1:N_GAS_SPECIES),TGUESS,VFLOW,YY_N(1:N_GAS_SPECIES)
...
REAL(EB) :: AREA_SUM,AREA,CPBAR,H_G,TMP_SUM,TMP_NEW,YY_N(1:N_GAS_SPECIES)
TYPE(DUCTNODE_TYPE), POINTER :: DN=>NULL()
