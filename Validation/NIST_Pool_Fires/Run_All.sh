...
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Acetone_Prescribed_0p5cm.fds
...
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Methane_Prescribed_2cm.fds
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Methane_Prescribed_1cm.fds
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Methane_Prescribed_0p5cm.fds
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Propane_20kW_Prescribed_2cm.fds
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Propane_20kW_Prescribed_1cm.fds
$QFDS $DEBUG -p 24  $QUEUE -d $INDIR NIST_Propane_20kW_Prescribed_0p5cm.fds
