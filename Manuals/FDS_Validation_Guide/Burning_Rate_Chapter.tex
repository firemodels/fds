...
Six tests of the British Steel - Fire Research Station tests were modelled. The experiments are described in Section~\ref{BST_FRS_wood_cribs_description}. The results consist of temperatures over criblines 2 (back), 6 (middle) and 10 (front) of the room. Each measurement is an average of three thermocouples at the same distance.
