...
INTEGER :: I,IBC,IIG,JJG,KKG,IOR,IWB,IW,II,JJ,KK,N,IIO,JJO,KKO,N_INT_CELLS,NOM,ITMP
TYPE (SURFACE_TYPE), POINTER :: SF=>NULL()
TYPE (VENTS_TYPE), POINTER :: VT=>NULL()
TYPE (OMESH_TYPE), POINTER :: OM=>NULL()
TYPE (MESH_TYPE), POINTER :: MM=>NULL()
...
WALL_CELL_LOOP: DO IW=1,NWC+NVWC
   ...
   IF (N_SPECIES==0 .AND. .NOT. SF%SPECIES_BC_INDEX==SPECIFIED_MASS_FLUX .AND. .NOT. SF%SPECIES_BC_INDEX==HVAC_BOUNDARY) &
       CYCLE WALL_CELL_LOOP
...
INTEGER, PARAMETER :: IHEDDY=1,IHLOGLAW=2
