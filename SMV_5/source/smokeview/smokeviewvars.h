...
SVEXTERN sv_object **device_defs;
SVEXTERN sv_object *heat_detector_device_backup;
SVEXTERN sv_object *target_device_backup;
SVEXTERN sv_object *sprinkler_upright_device_backup;
SVEXTERN sv_object *smoke_detector_device_backup;
SVEXTERN sv_object *thcp_device_backup;
...
SVEXTERN GLuint texture_colorbar_id, texture_slice_colorbar_id, texture_plot3d_colorbar_id, texture_iso_colorbar_id;
