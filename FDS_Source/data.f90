...
TYPE OUTPUT_QUANTITY_TYPE
   ...
   LOGICAL :: SLCF_APPROPRIATE=.TRUE., BNDF_APPROPRIATE=.FALSE., ISOF_APPROPRIATE=.TRUE., PART_APPROPRIATE=.FALSE., &
              SMIX_COMPONENT_ONLY=.FALSE.,INTEGRATED=.FALSE.,SOLID_PHASE=.FALSE.,GAS_PHASE=.TRUE.,INTEGRATED_DROPLETS=.FALSE., &
...
!OUTPUT_QUANTITY(13)%SMIX_COMPONENT_ONLY = .TRUE.
...
SS0=>SPECIES(SPECIES_MIXTURE(0)%Y_INDEX(I(1)))
