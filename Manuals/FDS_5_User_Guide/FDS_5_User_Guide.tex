...
Solve for $z_{int}$:
\be z_{int} = \frac{ T_l(I_1 \, I_2 - H^2)}{I_1+I_2 \, T_l^2 - 2\, T_l
\, H} 
\ee 
...
T_{\hbox{\tiny AST}}^4 - T_w^4 \right) + h (T_{\hbox{\tiny AST}} - T_w
)  \ee 
...
%{\ct CHECK\_VOLUME\_FLOW}       & Logical      & See Section~\ref{info:MPI}        &           & {\ct .FALSE.}                      \\ \hline
...
%{\ct PRESSURE\_CORRECTION}      & Logical       & See Section~\ref{info:MPI}                    &               & {\ct .FALSE.}     \\ \hline
