...
SUBROUTINE GETVERTS2(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,FACES,FACE_ID,WHICH_POLY,NFACES2,NPOLYS,VOLUME,BOX_STATE)
...
CALL GET_VERTS(BOX_BOUNDS_EB,V0_EB,V1_EB,V2_EB,V3_EB,VERTS_EB,NVERTS,FACES,FACE_ID,WHICH_POLY,NFACES2,NPOLYS,BOX_STATE,VERT_STATE)
DO I = 0, NFACES2-1
...
WRITE(LU_OUTPUT,'(a,3(1x,E15.8))')"box check: ",VOL,VOL_TOTAL,(VOL-VOL_TOTAL)/VOL_TOTAL
