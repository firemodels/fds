...
\begin{eqnarray*}  x_i = x_0 + i \, \dx  &;& \hbox{\small I\_LOWER} \le i \le \hbox{\small I\_UPPER} \\
                   y_j = y_0 + j \, \dy  &;& \hbox{\small J\_LOWER} \le j \le \hbox{\small J\_UPPER} 
\end{eqnarray*}
Note that the same rules apply for the $z$ direction as well.
...
This value can be overriden by setting {\ct SURFACE\_DENSITY} on the {\ct SURF} line. For surfaces with prescribed HRR
