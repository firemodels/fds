...
$QFDS $DEBUG $QUEUE -p 16  -n 12 -d $INDIR weak_scaling_glmat_016.fds
$QFDS $DEBUG $QUEUE -p 8   -n 12 -d $INDIR weak_scaling_glmat_008.fds
$QFDS $DEBUG $QUEUE -p 4   -n 12 -d $INDIR weak_scaling_glmat_004.fds
...
$QFDS $DEBUG $QUEUE -p 32  -n 12 -d $INDIR strong_scaling_glmat_032.fds
$QFDS $DEBUG $QUEUE -p 8   -n 12 -d $INDIR strong_scaling_glmat_008.fds
$QFDS $DEBUG $QUEUE -p 1   -n 12 -d $INDIR strong_scaling_glmat_001.fds
