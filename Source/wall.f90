...
REAL(EB) :: TMP_1,TMP_NWP,TNOW,RHO_C_S_BAR,RHO_C_S_DELTA_TMP_BAR
...
WALL_LOOP: DO IW=1,M%N_EXTERNAL_WALL_CELLS+M%N_INTERNAL_WALL_CELLS
   ...
   NODE_LOOP: DO I=1,NWP  ! Nodes of the chosen wall cell.
      ...
      WEIGHT_LOOP: DO II=1,THR_D%NODE(I)%ALTERNATE_WALL_COUNT
         ...
         RHO_C_S_BAR = RHO_C_S_BAR + THR_D%NODE(I)%ALTERNATE_WALL_WEIGHT(II)*ONE_D2%RHO_C_S(I_NODE)
         RHO_C_S_DELTA_TMP_BAR = RHO_C_S_DELTA_TMP_BAR + &
                                 THR_D%NODE(I)%ALTERNATE_WALL_WEIGHT(II)*ONE_D2%RHO_C_S(I_NODE)*ONE_D2%DELTA_TMP(I_NODE)
      ENDDO WEIGHT_LOOP
      ONE_D%TMP(I) = (RHO_C_S_BAR*ONE_D%TMP(I) + RHO_C_S_DELTA_TMP_BAR)/RHO_C_S_BAR
      !$OMP CRITICAL
