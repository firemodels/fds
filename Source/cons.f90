...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           DUCT_HT_INSERTED,PROCESS_ALL_MESHES=.FALSE.,H_MASS_CORRECTION=.FALSE.,H_MASS_B_NUMBER=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            H_V_H2O(0:5000),CHI_R_MIN=0._EB,CHI_R_MAX=1._EB,DRAG_CFL_MAX,EVAP_FILM_FAC=0._EB
...
INTEGER :: ICYC,ICYC_RESTART=0,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,TURB_MODEL=0,SLIP_CONDITION=2,FISHPAK_BC(3)=-1,&
           STOP_AT_ITER=0,HT3D_TEST=0,STOPFDS=-1
...
REAL(EB) :: WALL_CLOCK_START, WALL_CLOCK_END, WALL_CLOCK_START_ITERATIONS=0._EB
