...
REAL(EB) :: RADIUS,AREA_SCALING,RVC,RHO_NEW,M_DOT_PPP,CP,CPBAR,MW_RATIO,H_G,DELTA_H_G,ZZ_GET(0:N_TRACKED_SPECIES), &
            CPBAR2,MOMENTUM_SINK_FACTOR,XI,YJ,ZK,UBAR,VBAR,WBAR
REAL(EB), INTENT(IN) :: T
INTEGER, INTENT(IN) :: NM
...
PARTICLE_LOOP: DO IP=1,NLP
   ...
   IF (EVAPORATION_DRAG) THEN
      ...
      LP%ACCEL_X = (LP%U - UBAR) * MOMENTUM_SINK_FACTOR
      LP%ACCEL_Y = (LP%V - VBAR) * MOMENTUM_SINK_FACTOR
      LP%ACCEL_Z = (LP%W - WBAR) * MOMENTUM_SINK_FACTOR
   ENDIF
