...
IF (TRI_MODEL .AND. Q_OUT>TWO_EPSILON_EB) THEN
   ...
   KAPPA_0     = 1._EB ! GET_KAPPA(ZZ_0,TMP_IN,1)
   KAPPA_FLAME = 1._EB ! GET_KAPPA(ZZ_FLAME,TMP_FLAME,1)
...
INTEGER:: I,J,K, NS, NS2, Y_INDEX, Z_COND_INDEX
...
SPEC_LOOP: DO NS = 1, N_TRACKED_SPECIES
   ...
   DO K = 1, KBAR
      DO J = 1, JBAR
         ILOOP: DO I = 1, IBAR
            ...
            EVAP_LOOP: DO
               ...
               IF (ABS(TMP_N - TMP_NN)<1.E-4_EB) EXIT EVAP_LOOP
      ...
      ENDDO
   ENDDO
   IF (ALLOCATED(Y_BIN)) DEALLOCATE(Y_BIN)
   IF (ALLOCATED(A_BIN)) DEALLOCATE(A_BIN)
ENDDO SPEC_LOOP
