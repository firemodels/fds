  ...
  */
      ...
      match(buffer,"SLCT") == 1)
    {
      ...
      if(getfileinfo(full_file,NULL,&filesize)==0){
        ...
        FORTgetsliceparms(full_file,&endian,&is1,&is2,&js1,&js2,&ks1,&ks2,&ni,&nj,&nk,&slicei->volslice, &error FDSLABELLEN,lenfile);
        slicei->is1=is1;
        slicei->is2=is2;
        slicei->js1=js1;
        slicei->js2=js2;
  ...
  */
    if(match(buffer,"BNDF") == 1||
      ...
      if(getfileinfo(full_file,NULL,&filesize)==0){
        ...
        FORTgetboundaryheader1(full_file,&boundaryunitnumber,&endian, &npatches,  &error FDSLABELLEN, lenfile);
        if(npatches>0){
