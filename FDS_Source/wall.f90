...
DO I=1,N_TGA
   ...
   IF (MOD(I,NINT(1._EB/(TGA_HEATING_RATE*DT_TGA)))==0) THEN
      ...
      ELSE
         HRR = 0._EB
      ENDIF
      WRITE(LU_TGA,TCFORM) T_TGA,ONE_D%TMP_F-TMPM, SURF_DEN/SURF_DEN_0, &
                           SUM(ONE_D%MASSFLUX_ACTUAL(0:N_TRACKED_SPECIES))/SURF_DEN_0, &
                           HRR, ONE_D%QCONF*0.001_EB/SURF_DEN_0
   ENDIF
ENDDO
...
REAL(EB) :: RADIUS,AREA_SCALING,RVC,RHO_NEW,M_DOT_PPP,CP,CPBAR,MW_RATIO,H_G,DELTA_H_G,ZZ_GET(0:N_TRACKED_SPECIES),CPBAR2
REAL(EB), INTENT(IN) :: T
INTEGER, INTENT(IN) :: NM
...
REAL(EB) :: ZZ_G,UN,DD,MFT,TSI,ZZ_GET(0:N_TRACKED_SPECIES),RSUM_F,MPUA_SUM,T_IGN,AREA_ADJUST,RHO_0,RN1,RN2,TWOMFT
INTEGER :: N,ITER
INTEGER, INTENT(IN), OPTIONAL :: WALL_INDEX,PARTICLE_INDEX
