...
INTEGER :: N,I,J,K,NN,IL,III,JJJ,KKK,Y_INDEX,Z_INDEX,PART_INDEX,ITMP,IP,JP,KP,FLOW_INDEX
CHARACTER(100) :: MESSAGE
...
REAL(EB) :: CONCORR,U2,V2,W2,HQ2,FLUX,DFLUXDT,SOLID_PHASE_OUTPUT_OLD,VOLSUM,C_S_ADJUST_UNITS, TFMEAN
   ...
   IF (INDX == 5) THEN ! If wall temperature of particles
      ...
      IF (LPC%N_ORIENTATION > 1) THEN ! if particles are splitted
         DO I = OPT_LP_INDEX,OPT_LP_INDEX+LPC%N_ORIENTATION-1
               TFMEAN = TFMEAN + LAGRANGIAN_PARTICLE(I)%ONE_D%TMP_F - TMPM
         ENDDO
         TFMEAN = TFMEAN / LPC%N_ORIENTATION
      ENDIF
   ENDIF
ENDIF
