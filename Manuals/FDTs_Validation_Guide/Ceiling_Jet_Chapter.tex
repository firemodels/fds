...
For steady-state fire, the ceiling jet temperature of a fire plume are given by the following expressions developed by Alpert (1972)
...
In Eqs.~\ref{eq:Alpert_Tjet_less} and \ref{eq:Alpert_Tjet_greater}, $T_{jet}$ is the ceiling jet temperature~($^\circ$C), $\dot Q$ is the total HRR~(kW), $H$ is the height of the ceiling above the fuel~(m), and $r$~is the radial distance to the detector~(m).
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=4.0in]{FIGURES/Scatterplots/Ceiling_Jet_Temperature_Compartment}
\end{tabular}
\end{center}
\caption[Summary of ceiling jet temperature predictions for compartment cases.]
{Summary of ceiling jet temperature predictions for compartment cases.}
\label{Ceiling_Jet_Temperature_Compartment_Summary}
\end{figure}

\begin{figure}[ht]
\begin{center}
\begin{tabular}{l}
\includegraphics[width=4.0in]{FIGURES/Scatterplots/Ceiling_Jet_Temperature_Unconstrained}
\end{tabular}
\end{center}
\caption[Summary of ceiling jet temperature predictions for unconstrained cases.]
{Summary of ceiling jet temperature predictions for unconstrained cases.}
\label{Ceiling_Jet_Temperature_Unconstrained_Summary}
\end{figure}
