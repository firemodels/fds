...
REAL(EB), INTENT(IN) :: T
REAL(EB) :: VALUE,VALUE2,STAT_VALUE,SUM_VALUE,VOL,WGT,T_TMP,DVAL,DVAL2,DEV2
   ...
   IF (DV%LINE>0) THEN
      ...
      SELECT CASE(TRIM(DV%STATISTICS))
         ...
         CASE('COV') ! covariance
            ...
            DV%COV_VALUE = (1._EB-WGT)*DV%COV_VALUE + WGT*DVAL*DVAL2
         ...
         CASE('CORRCOEF') ! correlation coefficient
            ...
            DVAL2 = VALUE2-DV%AVERAGE_VALUE2
            DV%COV_VALUE = (1._EB-WGT)*DV%COV_VALUE + WGT*DVAL*DVAL2
            DV%RMS_VALUE      = (1._EB-WGT)*DV%RMS_VALUE  + WGT*(VALUE -DV%AVERAGE_VALUE )**2
            DV%RMS_VALUE2     = (1._EB-WGT)*DV%RMS_VALUE2 + WGT*(VALUE2-DV%AVERAGE_VALUE2)**2
