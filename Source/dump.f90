      ...
      DO NN=1,LPC%N_QUANTITIES
         SELECT CASE(LPC%QUANTITIES_INDEX(NN))
            ...
            CASE(447)  ! PARTICLE ACCEL X
               QP(NPP,NN) = LP%ACCEL_X
            CASE(448)  ! PARTICLE ACCEL Y
               QP(NPP,NN) = LP%ACCEL_Y
            CASE(449)  ! PARTICLE ACCEL Z
               QP(NPP,NN) = LP%ACCEL_Z
            CASE(450)  ! PARTICLE DRAG FORCE X
               QP(NPP,NN) = LP%MASS * LP%PWT * LP%ACCEL_X
            CASE(451)  ! PARTICLE DRAG FORCE Y
               QP(NPP,NN) = LP%MASS * LP%PWT * LP%ACCEL_Y
            CASE(452)  ! PARTICLE DRAG FORCE Z
               QP(NPP,NN) = LP%MASS * LP%PWT * LP%ACCEL_Z
