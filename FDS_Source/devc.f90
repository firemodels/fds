...
TYPE DEVICE_TYPE
   REAL(FB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INITIAL_VALUE=-1.E10,INSTANT_VALUE,AVERAGE_VALUE=0.,AVERAGE_VALUE2=0.,&
               RMS_VALUE=0.,RMS_VALUE2=0.,COV_VALUE=0.,VALUE, &
               DEPTH,TMP_L,Y_C,OBSCURATION,DELAY,ROTATION,SMOOTHED_VALUE=-1.E10,SMOOTHING_FACTOR=0.,&
               SETPOINT, T_CHANGE=1.E6,BYPASS_FLOWRATE,DT,TOTAL_FLOWRATE,FLOWRATE,TI_T,TI_VALUE, &
               CONVERSION_FACTOR=1., COORD_FACTOR=1., &
               TIME_INTERVAL,TIME_MIN_VALUE=999.,TIME_MAX_VALUE=-999.,QUANTITY_RANGE(2),STATISTICS_START=-1.E20
   ...
   CHARACTER(LABEL_LENGTH) :: ID,PROP_ID,QUANTITY,QUANTITY2,CTRL_ID,DEVC_ID,STATISTICS='null',&
                    ...
                    INIT_ID='null',NO_UPDATE_DEVC_ID='null',NO_UPDATE_CTRL_ID='null',REAC_ID
