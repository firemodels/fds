...
SUBROUTINE SCARC_STOP_CHECK
INTEGER :: STOP_STATUS, IERR=0
...
IF (MYID==0) THEN
   WRITE(MESSAGE,'(A)') 'FDS was stopped due to an error in ScaRC'
   CALL SHUTDOWN(MESSAGE)
ENDIF

STOP

END SUBROUTINE SCARC_STOP_CHECK
