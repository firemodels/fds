...
\be \hat{\delta} \approx \exp \left( \overline{M}-\overline{E}+\frac{\widetilde{\sigma}_M^2}{2 \delta^2} \right) \ee
...
\be \theta \sim N \left( \frac{M}{\hat{\delta}} \; , \; \left( \frac{M \, \widetilde{\sigma}_M}{\hat{\delta}} \right)^2 \right) \label{truth} \ee
