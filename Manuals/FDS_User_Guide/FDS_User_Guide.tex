...
If you want to attach a shortened name to the gas species for use in Smokeview, use the character string {\ct FORMULA}. For example, {\ct FORMULA='CH4'} could be used
to indicate {\ct 'METHANE'} in the Smokeview label. {\ct FORMULA} has no other use but for presentation of the output.
...
%Undocumented: AGL_SLICE,FIRE_LINE,EVACUATION,LEVEL_SET_FIRE_LINE,QUANTITY2,RLE,TWO_BYTE
