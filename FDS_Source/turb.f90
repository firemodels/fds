...
USE MESH_POINTERS
USE MESH_VARIABLES
USE GLOBAL_CONSTANTS, ONLY: P_INF,TMPA,N_TRACKED_SPECIES,TEST_FULL_TRANSPORT,DENSITY_TRANSPORT
...
IF (DENSITY_TRANSPORT) THEN
   RHO_0_MMS = P_INF*SPECIES_MIXTURE(0)%MW/(GAS_CONSTANT*TMPA)
...
DO K=0,KBP1
   DO J=0,JBP1
      DO I=0,IBP1
         ...
         IF (TEST_FULL_TRANSPORT .AND. .NOT.DENSITY_TRANSPORT) THEN
