...
MESH_LOOP: DO NM=1,NMESHES
   ...
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      IF (TRIM(QUANTITY) == 'UNMIXED FRACTION' .AND. .NOT.TRANSPORT_UNMIXED_FRACTION) THEN
         WRITE(MESSAGE,'(A)') 'ERROR: TRANSPORT_UNMIXED_FRACTION must be TRUE on MISC line to output UNMIXED FRACTION'
         CALL SHUTDOWN(MESSAGE) ; RETURN
      ENDIF
