   ...
   RECEIVING_MESH_LOOP: DO NOM=1,NMESHES
      ...
      IF (CODE==1 .AND. M3%NIC_S>0) THEN
         IF (RNODE/=SNODE) THEN
            ...
            PACK_REAL_SEND_PKG1: DO LL=1,M3%NIC_S
               ...
               DO NN=1,N_TRACKED_SPECIES+N_PASSIVE_SCALARS
         ...
         ELSE
            ...
            M2%ZZS(IMIN:IMAX,JMIN:JMAX,KMIN:KMAX,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS)= &
                                  M%ZZS(IMIN:IMAX,JMIN:JMAX,KMIN:KMAX,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS)
         ENDIF
      ENDIF
      ...
      IF (CODE==4 .AND. M3%NIC_S>0) THEN
         ...
         ELSE
            ...
            M2%ZZ(IMIN:IMAX,JMIN:JMAX,KMIN:KMAX,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS)= &
                                  M%ZZ(IMIN:IMAX,JMIN:JMAX,KMIN:KMAX,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS)
         ENDIF
      ENDIF
