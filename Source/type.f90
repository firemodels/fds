...
TYPE OMESH_TYPE
   ...
   INTEGER, ALLOCATABLE, DIMENSION(:) :: WALL_CELL_INDICES_RECV,WALL_CELL_INDICES_SEND,&
                                         ...
                                         WALL_REAL_NUMBERS_RECV,WALL_REAL_NUMBERS_SEND,&
                                         WALL_INTE_NUMBERS_RECV,WALL_INTE_NUMBERS_SEND,&
                                         WALL_LOGI_NUMBERS_RECV,WALL_LOGI_NUMBERS_SEND
   INTEGER, ALLOCATABLE, DIMENSION(:) :: THIN_WALL_CELL_INDICES_RECV,THIN_WALL_CELL_INDICES_SEND,&
                                         ...
                                         THIN_WALL_REAL_NUMBERS_RECV,THIN_WALL_REAL_NUMBERS_SEND,&
                                         THIN_WALL_INTE_NUMBERS_RECV,THIN_WALL_INTE_NUMBERS_SEND,&
                                         THIN_WALL_LOGI_NUMBERS_RECV,THIN_WALL_LOGI_NUMBERS_SEND
   INTEGER :: N_PART_ORPHANS=0,N_PART_ADOPT=0
   INTEGER :: N_WALL_CELLS_SEND,N_WALL_CELLS_RECV,N_WALL_CELLS_RECV_START=1
   INTEGER :: N_THIN_WALL_CELLS_SEND,N_THIN_WALL_CELLS_RECV,N_THIN_WALL_CELLS_RECV_START=1
   ...
   TYPE (STORAGE_TYPE) :: ORPHAN_PARTICLE_STORAGE,ADOPT_PARTICLE_STORAGE
   TYPE (STORAGE_TYPE) :: WALL_STORAGE_SEND,WALL_STORAGE_RECV
   TYPE (STORAGE_TYPE) :: THIN_WALL_STORAGE_SEND,THIN_WALL_STORAGE_RECV
