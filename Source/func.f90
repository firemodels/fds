...
WC%U_TAU              => OS%REALS( 3,STORAGE_INDEX) ; IF (NEW) WC%U_TAU = 0._EB
WC%UVW_GHOST          => OS%REALS( 4,STORAGE_INDEX) ; IF (NEW) WC%UVW_GHOST = 0._EB
WC%UW0                => OS%REALS( 5,STORAGE_INDEX) ; IF (NEW) WC%UW0 = 0._EB
WC%X                  => OS%REALS( 6,STORAGE_INDEX)
WC%Y                  => OS%REALS( 7,STORAGE_INDEX)
WC%Z                  => OS%REALS( 8,STORAGE_INDEX)
WC%Y_PLUS             => OS%REALS( 9,STORAGE_INDEX) ; IF (NEW) WC%Y_PLUS = 1._EB
WC%VEG_HEIGHT         => OS%REALS(10,STORAGE_INDEX)
WC%VEL_ERR_NEW        => OS%REALS(11,STORAGE_INDEX) ; IF (NEW) WC%VEL_ERR_NEW = 0._EB
WC%V_DEP              => OS%REALS(12,STORAGE_INDEX) ; IF (NEW) WC%V_DEP = 0._EB
WC%Q_LEAK             => OS%REALS(13,STORAGE_INDEX) ; IF (NEW) WC%Q_LEAK = 0._EB
WC%Z_STAR             => OS%REALS(14,STORAGE_INDEX) ; IF (NEW) WC%Z_STAR = 1._EB
