...
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_0p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_0p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_0p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_0p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_0p5D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p0D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p0D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p0D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p0D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p0D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p5D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_2p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_2p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_2p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_2p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_1p5D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_3p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_3p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_3p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_3p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/LII_Soot_PDF_3p5D_r=8cm} \\
\end{tabular*}
...
A description of the experiments is included in Section~\ref{Ranz_Marshall_Description}. Figure~\ref{RM_Fig_8} shows the results of predicting the drop diameter of a single droplet evaporating in dry air.

\begin{figure}[!ht]
	\begin{center}
		\begin{tabular}{c}
			\includegraphics[height=4.0in]{SCRIPT_FIGURES/Ranz_Marshall/Ranz_Marshall_Time_Dep} \\
			\vspace{0.25in} \\
		\end{tabular}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\begin{tabular}{c}
			\includegraphics[height=4.0in]{SCRIPT_FIGURES/ScatterPlots/FDS_Evaporation_Rate} \\
			\vspace{0.25in} \\
		\end{tabular}
	\end{center}
