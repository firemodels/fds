...
Black PMMA was chosen as the first material to be studied by the MaCFP Condenced Phase Subgroup. Its properties are listed in Table~\ref{NIST_PMMA_Properties}. It is assumed that the solid decomposes via a single reaction whose pre-exponential factor and activation energy are derived directly from the TGA measurement. The thermal properties are taken from Ref.~\cite{Fiola:FSJ2021}.

\begin{table}[!h]
\caption[NIST PMMA properties]{Input parameters for PMMA.}
\begin{center}
\begin{tabular}{|l|c|c|c|c|}
\hline
Property                    & Units         & Value                                                                                                                                          & Unc.      &  Reference                 \\ \hline \hline
Density                     & kg/m$^3$      & 1210                                                                                                                                           & 30        &  \cite{Fiola:FSJ2021}      \\ \hline
Conductivity                & W/m/K         & $\begin{array}{ll} 0.16  & T<395 \; \hbox{K} \\  0.34 - 4.2 \times 10^{-4} \, T  & T>395 \; \hbox{K} \end{array}$                              &           &  \cite{Fiola:FSJ2021}      \\ \hline
Specific Heat               & kJ/kg/K       & $\begin{array}{ll} -1.39+ 8.33 \times 10^{-3} \, T & T<395 \; \hbox{K} \\ 0.851 + 3.07 \times 10^{-3} \, T & T>395 \; \hbox{K} \end{array}$    &           &  \cite{Fiola:FSJ2021}      \\ \hline
Emissivity                  &               & 0.96                                                                                                                                           &           &  \cite{Fiola:FSJ2021}      \\ \hline
Absorption Coef.            & m$^{-1}$      & 2870                                                                                                                                           & 280       &  \cite{Fiola:FSJ2021}      \\ \hline
Pre-Exp.~Factor             & s$^{-1}$      & $2.85 \times 10^{13}$                                                                                                                          &           &                            \\ \hline
Activation Energy           & J/mol         & $1.91 \times 10^{5}$                                                                                                                           &           &                            \\ \hline
Heat of Reaction            & kJ/kg         & 817                                                                                                                                            &           &  \cite{Fiola:FSJ2021}      \\ \hline
\end{tabular}
\end{center}
\label{NIST_PMMA_Properties}
\end{table}

Figure~\ref{NIST_PMMA} displays the results of measurements and simulations of pyrolyzing black PMMA in the TGA (10~K/min) and Gasification Apparatus (50~kW/m$^2$).

\begin{figure}[!h]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/NIST_Polymers/TGA_10K} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/NIST_Polymers/PMMA_MLR} 
\end{tabular*}
\caption[NIST Polymers, TGA and Gasification Apparatus]
{(Left) Mass of a 5~mg sample of black PMMA undergoing pyrolysis in nitrogen. (Right) Mass loss rate of a 6~mm thick sample of PMMA exposed to 50~kW/m$^2$.}
\label{NIST_PMMA}
\end{figure}
...
A description of this experiment is given in Section~\ref{UMD_SBI_Description}.
