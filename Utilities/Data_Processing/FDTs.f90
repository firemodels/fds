...
NAMELIST /ALPERT/ Q,T_END,R_LIST,H_LIST,LABEL,TMP_A,OUTPUT_FILE
...
DO I=1,30
   ...
   IF (R/H<=0.18) THEN
      T_JET(I) = (16.9 * Q**(2./3.) / H**(5./3.)) + (TMP_A+273)
   ELSEIF (R/H>0.18) THEN
      T_JET(I) = (5.38 * (Q/R)**(2./3.) / H) + (TMP_A+273)
   ENDIF
ENDDO
...
WRITE(11,FMT) 0, (T_JET(K)-273,K=1,N_PTS)
WRITE(11,FMT) T_END, (T_JET(K)-273,K=1,N_PTS)
