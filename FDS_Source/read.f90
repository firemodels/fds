...
USE PHYSICAL_FUNCTIONS, ONLY: LES_FILTER_WIDTH,LES_FILTER_WIDTH_2D_MAX,LES_FILTER_WIDTH_2D_MEAN,LES_FILTER_WIDTH_3D_MAX,&
...
CHARACTER(30) :: RAMP_GX,RAMP_GY,RAMP_GZ,TURBULENCE_MODEL,FILTER_WIDTH_FUNCTION
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                FILTER_WIDTH_FUNCTION,FLUX_LIMITER,FORCE_VECTOR,&
...
IF (TWO_D) THEN
   SELECT CASE (TRIM(FILTER_WIDTH_FUNCTION))
      CASE ('MIN','min')
         LES_FILTER_WIDTH=>LES_FILTER_WIDTH_2D_MIN
      CASE ('MAX','max','null')
         LES_FILTER_WIDTH=>LES_FILTER_WIDTH_2D_MAX
      CASE ('MEAN','mean')
         LES_FILTER_WIDTH=>LES_FILTER_WIDTH_2D_MEAN
   END SELECT
ELSE
   SELECT CASE (TRIM(FILTER_WIDTH_FUNCTION))
      CASE ('MIN','min')
         LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_MIN
      CASE ('MAX','max','null')
         LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_MAX
      CASE ('MEAN','mean')
         LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_MEAN
   END SELECT
ENDIF
...
NAMELIST /SURF/ ADIABATIC,BACKING,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,&
                ...
                REGRID_FACTOR,RGB,ROUGHNESS,SPEC_ID,SPREAD_RATE,STRETCH_FACTOR,SURFACE_DENSITY,&
