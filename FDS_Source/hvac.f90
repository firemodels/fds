...
REAL(EB) :: ZZ_GET(0:N_TRACKED_SPECIES),TNOW
TYPE(DUCTNODE_TYPE), POINTER :: DN=>NULL()
TYPE(DUCT_TYPE), POINTER :: DU=>NULL()
...
REAL(EB) :: ZZ_GET(0:N_TRACKED_SPECIES),AREA,TNOW,P_AVE,CPBAR
...
REAL(EB) :: AREA,RHO_SUM,CPBAR,H_G,TMP_SUM,TMP_NEW,ZZ_GET(0:N_TRACKED_SPECIES),CPBAR2,DCPDT
TYPE(DUCTNODE_TYPE), POINTER :: DN=>NULL(),DN2=>NULL()
