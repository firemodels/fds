...
for i=1:n_chid
    ...
    if i==1
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_14_kW_45_line.csv',',',2);
    end 
    if i==2
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_22_kW_45_line.csv',',',2);
    end
    if i==3
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_33_kW_45_line.csv',',',2);
    end
    if i==4
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_45_kW_45_line.csv',',',2);
    end
    if i==5
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_57_kW_45_line.csv',',',2);
    end
