...
specified for the aspiration detector.  1 kg/s of combustion products with {\ct SOOT_YIELD=0.001} is input into 
the bottom of the compartment and 1 kg/s of total mass is removed from the top of the compartment.
The aspiration detector shows an increasing \% obscuration over time, see figure blah blah blah.  There is a delay in slightly over 50 s in
...
an additional one third of the soot being transported to the detector.  The soot density at the sampling point is
 $3.493x10^{-4}$~kg/m$^3$.  Using this value the plateaus are computed as 63.7 \%, 86.8 \%, and 95.2 \% as seen
in the figure.
