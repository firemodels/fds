...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           NEW_ABSORPTION=.FALSE.,RESEARCH_MODE=.FALSE.,STABILITY_CORRECTION=.FALSE.
...
LOGICAL :: SIMPLE_CHEM = .TRUE.,EDC = .TRUE.,TEMPERATURE_DEPENDENT_REACTION=.FALSE.
REAL(EB) :: RSUM0
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,IUVW=1,TURB_MODEL=0,SLIP_CONDITION=6
