...
\be
I^o_{b,\om}(T) = \dfrac{2 \, h \, c^2 \, \om^3}{\exp\left(\dfrac{h \, c \, \om}{k_B \, T}\right)-1}
\ee
...
\be I_{b,f}(\bx) = C \, \frac{\sigma \, T(\bx)^4}{\pi}   \quad ; \quad
    C = \frac{\sum_{\dq'''_{ijk}>0} \left( \chi_r \, \dq'''_{ijk} + \kappa_{ijk} \, U_{ijk} \right) \, dV}{\sum_{\dq'''_{ijk}>0} \left( 4 \, \kappa_{ijk} \, \sigma \, T^4_{ijk} \right) \, dV} \label{corrected_emission_source_term}
\ee
