...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=8.5in]{FIGURES/Harrison_Spill_Plumes/Harrison_Spill_Plumes_Assembly_Drawing}
\end{center}
...
\begin{center}
\includegraphics[width=7.5in]{FIGURES/SP_AST/Full_Room_hollowbar}
\end{center}
...
\begin{sidewaysfigure}[h]
\begin{center}
\includegraphics[width=7.5in]{FIGURES/SP_AST/Fullroom_Drawing}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=8.5in]{FIGURES/Steckler_Compartment/Room_Drawing.pdf}
\end{center}
