...
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                REAC_MASS_ERROR,REVERSE,SOOT_H_FRACTION,SOOT_YIELD,SPEC_ID_N_S,SPEC_ID_NU,TABLE_FS,TAU_CHEM,TAU_FLAME,&
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   IF (RN%TABLE_FS/='null') CALL GET_TABLE_INDEX(RN%TABLE_FS,TABLE_2D_TYPE,RN%TABLE_FS_INDEX) 
