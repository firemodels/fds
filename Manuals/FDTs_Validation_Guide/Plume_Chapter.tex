...
For a fire plume, the correlation by Heskestad (1995) predicts that the increase in centerline temperature, $\Delta T_0$, is given by
\be
...
For a fire plume, the correlation by McCaffrey (1979) predicts that the increase in centerline temperature, $\Delta T_0$, is given by
\be
