...
CALL EX2G3D(UP,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(VP,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL EX2G3D(WP,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(SHAT11,S11,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT22,S22,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT33,S33,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT12,S12,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT13,S13,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(SHAT23,S23,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(BETAHAT11,BETA11,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT22,BETA22,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT33,BETA33,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT12,BETA12,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT13,BETA13,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(BETAHAT23,BETA23,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)

! test filter the density

RHOPHAT => WORK7
CALL TEST_FILTER(RHOPHAT,RHOP,ARRAY_LO,ARRAY_HI,RHOMIN,RHOMAX)
...
CALL TEST_FILTER(MLHAT,ML,ARRAY_LO,ARRAY_HI,0._EB,1.E10_EB)
CALL TEST_FILTER(MMHAT,MM,ARRAY_LO,ARRAY_HI,0._EB,1.E10_EB)
...
CALL TEST_FILTER(RUU_HAT,RUU,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL TEST_FILTER(RVV_HAT,RVV,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL TEST_FILTER(RWW_HAT,RWW,ARRAY_LO,ARRAY_HI,0.E10_EB,1.E10_EB)
CALL TEST_FILTER(RUV_HAT,RUV,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RUW_HAT,RUW,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RVW_HAT,RVW,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
CALL TEST_FILTER(RU_HAT,RU,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RV_HAT,RV,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(RW_HAT,RW,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
...
SUBROUTINE TEST_FILTER(PHIBAR,PHI,ARRAY_LO,ARRAY_HI,PHI_MIN,PHI_MAX)
IMPLICIT NONE
...
DO K = ARRAY_LO(3),ARRAY_HI(3)
   DO J = ARRAY_LO(2),ARRAY_HI(2)
      PHI1(ARRAY_LO(1):ARRAY_HI(1)) = PHI(ARRAY_LO(1):ARRAY_HI(1),J,K)
...
CALL TEST_FILTER(UP_HAT,UP,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(VP_HAT,VP,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
CALL TEST_FILTER(WP_HAT,WP,ARRAY_LO,ARRAY_HI,-1.E10_EB,1.E10_EB)
