...
The results of a two corridor simulation performed at ATF Fire Research Laboratory in Ammendale, Maryland.
The tests were conducted in a two-story structure with two 17.0 m long hallways on each floor. A stairway consisting of two staircases and an intermediary landing connected the two floors. 
...
\includegraphics[height=2.2in]{FIGURES/ATF_Corridors/ATF_Corridors_Velocity_H_240_kW} &
