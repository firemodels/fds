...
REAL(EB) :: Y_O2_INFTY,Y_F_INLET, &
            ...
            FUEL_HEAT_OF_FORMATION,MAXIMUM_VISIBILITY,AIT
NAMELIST /REAC/ E,BOF,HEAT_OF_COMBUSTION,FYI,FUEL,OXIDIZER,EPUMO2,ID, N_S,&
                ...
                EDDY_DISSIPATION,C_EDC,HRRPUA_SHEET,HRRPUV_AVERAGE,HRRPUV_AVERAGE_TIME,AIT
...
DO N=1,N_SPECIES
   ...
   IF (SPECIES(N)%ID=='MIXTURE_FRACTION') &
      SPECIES%MW = 1._EB/(REACTION(1)%Y_F_INLET/REACTION(1)%MW_FUEL+REACTION(1)%Y_N2_INLET/MW_N2)   
...
REAL(EB) :: SPECIFIC_HEAT,VAPORIZATION_TEMPERATURE,MELTING_TEMPERATURE,MASS_PER_VOLUME,MASS_PER_TIME,DIAMETER, &
            ...
            ELEVATION,AZIMUTH,SURFACE_TENSION,BREAKUP_CHILD_DIAMETER,BREAKUP_CHILD_GAMMA_D,BREAKUP_CHILD_SIGMA_D
...
CHARACTER(30) :: PART_ID,SPEC_ID,DEVC_ID,CTRL_ID,QUANTITIES(1:10),SURF_ID,DRAG_LAW
...
TYPE(PARTICLE_CLASS_TYPE), POINTER :: PC
TYPE(PROPERTY_TYPE), POINTER :: PY
NAMELIST /PART/ NUMBER_INITIAL_DROPLETS,FYI,DROPLETS_PER_SECOND,MASS_PER_VOLUME,MASS_PER_TIME, &
                ...
                AGE,DEVC_ID,CTRL_ID,SPEC_ID,SURF_ID,INITIAL_TEMPERATURE,XB,RGB,QUANTITIES,DT_INSERT,COLOR, &
                ...
                VEG_MOIST_MPV_MIN,VEG_REMOVE_CHARRED,VEG_STEM,SMOKEVIEW_ID, &
                ELEVATION,AZIMUTH,H_V_REFERENCE_TEMPERATURE,DRAG_LAW,USER_DRAG_COEFFICIENT, &
                SURFACE_TENSION,BREAKUP,BREAKUP_CHILD_DIAMETER,BREAKUP_CHILD_GAMMA_D,BREAKUP_CHILD_SIGMA_D
...
READ_PART_LOOP: DO N=1,N_PART
   ...
   IF (NUMBER_INITIAL_DROPLETS>0 .AND. DT_INSERT<0._EB) DT_INSERT = 1.E5_EB
   ...
   PC%Z2 = XB(6)
   PC%GAMMA_VAP = GAMMA
   PC%NUMBER_INITIAL_DROPLETS = NUMBER_INITIAL_DROPLETS
   ...
   PC%MASS_PER_TIME      = MASS_PER_TIME
...
ALLOCATE(TREE_OUTPUT_DATA(N_TREES_OUT,2),STAT=IZERO)
...
N_TREES_0 = N_TREES
N = 0
N_TREES_OUT = 0 ; OUTPUT_TREE = .FALSE.
!
...
REAL(EB) :: ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E, &
            ...
            OFFSET,OPERATING_PRESSURE,RTI,PDPA_START,PDPA_END,PDPA_RADIUS,SMOKEVIEW_PARAMETERS(12)
INTEGER :: I,N,PDPA_M,PDPA_N,STATE_INDEX
LOGICAL :: PDPA_INTEGRATE,PDPA_NORMALIZE
EQUIVALENCE(LENGTH,ALPHA_C)
CHARACTER(30) :: SMOKEVIEW_ID='null',QUANTITY='null',PART_ID='null',FLOW_RAMP='null',SPRAY_PATTERN_TABLE='null',SPEC_ID='null',&
                 PRESSURE_RAMP='null'
...
NAMELIST /PROP/ ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E, &
                ...
                CONDUIT_DIAMETER,CONDUIT_THICKNESS,CABLE_MASS_PER_LENGTH,CABLE_DIAMETER, &
                CABLE_JACKET_THICKNESS,CABLE_FAILURE_TEMPERATURE, &
                C_FACTOR,CHARACTERISTIC_VELOCITY,ORIFICE_DIAMETER,STATE_INDEX, &
                ...
                PDPA_START,PDPA_END,PDPA_RADIUS,PDPA_M,PDPA_N,PDPA_INTEGRATE,PDPA_NORMALIZE,TEXTURE_MAP,SMOKEVIEW_PARAMETERS
...
READ_PROP_LOOP: DO N=0,N_PROP
   ...
   DO I=1,12
      IF (PY%SMOKEVIEW_PARAMETERS(I)/=-1._EB) PY%N_SMOKEVIEW_PARAMETERS = PY%N_SMOKEVIEW_PARAMETERS + 1
   ENDDO
   PY%SPEC_ID              = SPEC_ID
   PY%STATE_INDEX          = STATE_INDEX
...
NAMELIST /SURF/ TMP_FRONT,TMP_INNER,THICKNESS,MASS_FRACTION,VEL,VEL_T,NPPC, &
                ...
                IGNITION_TEMPERATURE,HEAT_OF_VAPORIZATION,REGRID_FACTOR,NET_HEAT_FLUX,LAYER_DIVIDE,SURFACE_DENSITY, &
                ROUGHNESS,FREE_SLIP,NO_SLIP,EXTERNAL_FLUX,EXTERNAL_FLUX_RAMP,RADIUS,LENGTH,WIDTH
...
REAL(EB) :: TEMPERATURE,DENSITY,MASS_FRACTION(MAX_SPECIES),RR_SUM,YY_GET(1:N_SPECIES),MASS_PER_VOLUME,MASS_PER_TIME
INTEGER  :: N,NN,NS,NUMBER_INITIAL_DROPLETS
CHARACTER(30) :: PART_ID
TYPE(INITIALIZATION_TYPE), POINTER :: IN
NAMELIST /INIT/ XB,TEMPERATURE,DENSITY,MASS_FRACTION,MASS_PER_TIME,MASS_PER_VOLUME,NUMBER_INITIAL_DROPLETS,PART_ID
