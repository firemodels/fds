...
$QFDS -p 4 -d Scalar_Analytical_Solution irrot_charm_cos_wave_128.fds
$QFDS -d Scalar_Analytical_Solution irrot_charm_cos_wave_16.fds
$QFDS -d Scalar_Analytical_Solution irrot_charm_cos_wave_32.fds
$QFDS -d Scalar_Analytical_Solution irrot_charm_cos_wave_64.fds
$QFDS -p 4 -d Scalar_Analytical_Solution irrot_charm_square_wave_128.fds
$QFDS -d Scalar_Analytical_Solution irrot_charm_square_wave_16.fds
$QFDS -d Scalar_Analytical_Solution irrot_charm_square_wave_32.fds
$QFDS -d Scalar_Analytical_Solution irrot_charm_square_wave_64.fds
$QFDS -p 4 -d Scalar_Analytical_Solution irrot_godunov_square_wave_128.fds
$QFDS -d Scalar_Analytical_Solution irrot_godunov_square_wave_16.fds
$QFDS -d Scalar_Analytical_Solution irrot_godunov_square_wave_32.fds
$QFDS -d Scalar_Analytical_Solution irrot_godunov_square_wave_64.fds
$QFDS -p 4 -d Scalar_Analytical_Solution irrot_mp5_cos_wave_128.fds
...
$QFDS -p 4 -d Scalar_Analytical_Solution irrot_superbee_square_wave_128.fds
$QFDS -d Scalar_Analytical_Solution irrot_superbee_square_wave_128_1mesh.fds
$QFDS -d Scalar_Analytical_Solution irrot_superbee_square_wave_16.fds
$QFDS -d Scalar_Analytical_Solution irrot_superbee_square_wave_32.fds
$QFDS -d Scalar_Analytical_Solution irrot_superbee_square_wave_64.fds
