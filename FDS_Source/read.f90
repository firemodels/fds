...
USE PHYSICAL_FUNCTIONS, ONLY: LES_FILTER_WIDTH,LES_FILTER_WIDTH_2D_MAX,LES_FILTER_WIDTH_2D_NMAX,LES_FILTER_WIDTH_3D_MAX,&
                              LES_FILTER_WIDTH_3D_NMAX
...
IF (TWO_D) THEN
   ...
   ELSE
      LES_FILTER_WIDTH=>LES_FILTER_WIDTH_2D_NMAX
   ENDIF
ELSE
   IF (MAX_FILTER_WIDTH) THEN
      LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_MAX
   ELSE
      LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_NMAX
   ENDIF
ENDIF
