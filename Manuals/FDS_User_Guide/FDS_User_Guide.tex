...
sucks air, regardless of the surrounding pressure field. In the HVAC model, this approach to modeling a fan occurs when the fan is specified with a {\ct VOLUME_FLOW}.  In reality, fans operate based on
...
%Undocumented: H_LOGLAW, H_CHILTON_COLBURN, LIMITING_DT_RATIO, HRRPUVCUT_MAX, RUN_AVG_FAC, THERMOPHORETIC_DEPOSITION, TURBULENT_DEPOSITION,
...
%Undocumented: AGL_SLICE,FIRE_LINE,EVACUATION,LEVEL_SET_FIRE_LINE,QUANTITY2
