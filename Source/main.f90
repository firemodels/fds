...
OTHER_MESH_LOOP: DO NOM=1,NMESHES
   ...
   IF (LEVEL_SET_MODE>0) THEN
      ...
      ALLOCATE(OM%TOA(IMIN:IMAX,JMIN:JMAX))     ; OM%TOA      =  1.E10_EB
   ...
   ELSEIF (LEVEL_SET_MODE==0 .AND. TERRAIN_CASE) THEN
      ALLOCATE(OM%Z_LS(IMIN:IMAX,JMIN:JMAX))    ; OM%Z_LS     =  0._EB
      IF (FIRE_ARRIVAL_SLICE) ALLOCATE(OM%TOA(IMIN:IMAX,JMIN:JMAX)) ; OM%TOA = 1.E10_EB
   ENDIF
