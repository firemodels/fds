% This document is not using proper pdflatex syntax.
% Many errors when building like:
% Package hyperref Warning: Token not allowed in a PDFDocEncoded string,
% *(hyperref)                removing `\f@encoding' on input line 1561.
% See user guide for how this is resolved.
...
\Huge \flushright{Fire Dynamics Simulator (Version 5) \\ Verification \& Validation Guide \\ \LARGE Volume 1: Verification \\ (Draft, June 21, 2007)}
...
grid size for future work. A propane burner 1.0~m by 1.0~m was modeled
