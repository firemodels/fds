...
(\rho_{\rm s} \, c_{\rm s})_i \frac{T_{{\rm s},x,i}^{n+1}-T_{{\rm s},x,i}^{n}}{3 \, \delta t}
& = \frac{1}{2 \, \delta x_i} \left( k_{{\rm s},i+\frac{1}{2}} \frac{T_{{\rm s},x,i+1}^{n}  -T_{{\rm s},x,i}^{n}}  {\delta x_{i+\frac{1}{2}}} - k_{{\rm s},i-\frac{1}{2}} \frac{T_{{\rm s},x,i}^{n}  -T_{{\rm s},x,i-1}^{n}}  {\delta x_{i-\frac{1}{2}}} \right) \notag \\[0.1in]
& + \frac{1}{2 \, \delta x_i} \left( k_{{\rm s},i+\frac{1}{2}} \frac{T_{{\rm s},x,i+1}^{n+1}-T_{{\rm s},x,i}^{n+1}}{\delta x_{i+\frac{1}{2}}} - k_{{\rm s},i-\frac{1}{2}} \frac{T_{{\rm s},x,i}^{n+1}-T_{{\rm s},x,i-1}^{n+1}}{\delta x_{i-\frac{1}{2}}} \right) + \frac{\dot{q}'''_{{\rm s},i}}{3}  \\[0.2in]
