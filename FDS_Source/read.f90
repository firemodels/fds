...
REAL(EB) :: MU_USER(0:MAX_SPECIES)=-1._EB,K_USER(0:MAX_SPECIES)=-1._EB,D_USER(0:MAX_SPECIES)=-1._EB, &
            EPSK(0:MAX_SPECIES),SIG(0:MAX_SPECIES),MW_MIN,MW_MAX
...
REAL(EB) :: SPECIFIC_HEAT,VAPORIZATION_TEMPERATURE,MELTING_TEMPERATURE,MASS_PER_VOLUME,DIAMETER, &
...
REAL(EB) :: TEMPERATURE,DENSITY,MASS_FRACTION(MAX_SPECIES),RR_SUM,YY_GET(1:N_SPECIES),MASS_PER_VOLUME
INTEGER  :: N,NN,NS,NUMBER_INITIAL_DROPLETS
CHARACTER(30) :: PART_ID
TYPE(INITIALIZATION_TYPE), POINTER :: IN
NAMELIST /INIT/ XB,TEMPERATURE,DENSITY,MASS_FRACTION,MASS_PER_VOLUME,NUMBER_INITIAL_DROPLETS,PART_ID
