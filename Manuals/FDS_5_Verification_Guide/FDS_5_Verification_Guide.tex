...
The reference results were computed using HEATING (version~7.3), a multi-dimensional, finite-difference, general purpose heat transfer
model~\cite{Childs}. In cartesian and cylindrical cases, the results have also  been verified using a commercial finite-element solver, ABAQUS.
