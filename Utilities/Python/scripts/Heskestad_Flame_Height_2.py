...
fdsplotlib.plot_to_fig(x_data=Qstar, y_data=Becker_and_Liang, marker_style='g-', figure_handle=fig, data_label='Becker \& Liang')
fdsplotlib.plot_to_fig(x_data=Qstar[1:16], y_data=Cox_and_Chitty[1:16], marker_style='c-', figure_handle=fig, data_label='Cox \& Chitty')
fdsplotlib.plot_to_fig(x_data=Qstar, y_data=Heskestad, marker_style='r-', figure_handle=fig, data_label='Heskestad')
fdsplotlib.plot_to_fig(x_data=Qstar[2:16], y_data=Hasemi_and_Tokunaga[2:16], marker_style='m-', figure_handle=fig, data_label='Hasemi \& Tokunaga')
