...
IF (MYID>0) THEN
   CALL MPI_GATHERV(REAL_BUFFER_20(1,DISPLS(MYID)+1),COUNTS_20(MYID),MPI_DOUBLE_PRECISION,REAL_BUFFER_20,COUNTS_20,DISPLS_20,&
...
IF (T>=MASS_CLOCK .AND. N_MPI_PROCESSES>1) THEN
   ...
   CALL MPI_GATHERV(REAL_BUFFER_MASS(0,DISP),COUNTS_MASS(MYID),MPI_DOUBLE_PRECISION, &
...
IF (MYID>0) THEN
   CALL MPI_GATHERV(REAL_BUFFER_QM(1,DISPLS(MYID)+1),COUNTS_QM(MYID),MPI_DOUBLE_PRECISION, &
...
IF (MYID>0) THEN
   CALL MPI_GATHERV(REAL_BUFFER_HVAC(1,DISPLS(MYID)+1),COUNTS_HVAC(MYID),MPI_DOUBLE_PRECISION, &
