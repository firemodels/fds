...
The smoke drawing verification problem can be broken down into two steps.
...
{A test verifying that Smokeview can correctly transform the smokesensor physical location to screen coordinates 
and obtain the correct color found there.
A small white (255,255,255) smoke\_sensor appears in front of a grey (128,128,128) obstacle.
The value displayed should be 255,  the value recorded by Smokeview.
}
