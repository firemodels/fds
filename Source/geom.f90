...
CFTRI_LOOP : DO ITRI=1,N_TRI
   ...
   V12(IAXIS:KAXIS) = (/ CUT_FACE(IND1)%XYZVERT(IAXIS,INOD_2)-BOUNDARY_COORD(CFA%BC_INDEX)%X, &
                         CUT_FACE(IND1)%XYZVERT(JAXIS,INOD_2)-BOUNDARY_COORD(CFA%BC_INDEX)%Y, &
                         CUT_FACE(IND1)%XYZVERT(KAXIS,INOD_2)-BOUNDARY_COORD(CFA%BC_INDEX)%Z /)
   V13(IAXIS:KAXIS) = (/ CUT_FACE(IND1)%XYZVERT(IAXIS,INOD_3)-BOUNDARY_COORD(CFA%BC_INDEX)%X, &
                         CUT_FACE(IND1)%XYZVERT(JAXIS,INOD_3)-BOUNDARY_COORD(CFA%BC_INDEX)%Y, &
                         CUT_FACE(IND1)%XYZVERT(KAXIS,INOD_3)-BOUNDARY_COORD(CFA%BC_INDEX)%Z /)
...
CFA_X = E1*BC%X + E2*CUT_FACE(IND1)%XYZVERT(IAXIS,INOD_2) + E3*CUT_FACE(IND1)%XYZVERT(IAXIS,INOD_3)
CFA_Y = E1*BC%Y + E2*CUT_FACE(IND1)%XYZVERT(JAXIS,INOD_2) + E3*CUT_FACE(IND1)%XYZVERT(JAXIS,INOD_3)
CFA_Z = E1*BC%Z + E2*CUT_FACE(IND1)%XYZVERT(KAXIS,INOD_2) + E3*CUT_FACE(IND1)%XYZVERT(KAXIS,INOD_3)
