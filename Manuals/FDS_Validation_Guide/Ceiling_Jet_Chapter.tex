...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.8in]{FIGURES/ScatterPlots/Flat_Ceiling_Jet_Temperature} \\
\includegraphics[width=3.8in]{FIGURES/ScatterPlots/Sloped_Ceiling_Jet_Temperature}
\end{tabular}
\end{center}
