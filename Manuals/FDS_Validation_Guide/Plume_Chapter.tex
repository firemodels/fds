...
The figures on the following pages display comparisons of measured and predicted temperatures above a 30~cm diameter methanol pool fire. Each plot displays radial profiles of temperature at heights ranging from 2~cm to 30~cm. Time resolved temperature data was measured using 50~$\mu$m diameter, bare-wire thermocouples (Pt~vs~Pt-10\%~Rh) with known bead diameters in the range of 75~$\mu$m to 100~$\mu$m.
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of temperature, 2~cm to 12~cm above the burner]
{Waterloo Methanol, radial profiles of temperature, 2~cm to 14~cm above the burner.}
...
\multicolumn{2}{c}{\includegraphics[height=2.15in]{SCRIPT_FIGURES/Waterloo_Methanol/Waterloo_Methanol_Temperature_30_cm}} 
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of temperature, 14~cm to 30~cm above the burner]
{Waterloo Methanol, radial profiles of temperature, 14~cm to 30~cm above the burner.}
