...
\begin{figure}
   \begin{center}
      \includegraphics[width=3.2in]{SCRIPT_FIGURES/poiseuille_convergence.pdf}
...
\begin{figure}
   \begin{center}
      \includegraphics[width=4.5in]{FIGURES/channel_flow_setup.pdf}
...
\begin{figure}
   \begin{center}
      \includegraphics[width=5.5in]{SCRIPT_FIGURES/fds_moody_chart.pdf}
...
\begin{figure}[h]
   \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
      \includegraphics[width=3.2in]{SCRIPT_FIGURES/blasius_profile.pdf} &
      \includegraphics[width=3.2in]{SCRIPT_FIGURES/blasius_convergence.pdf}
   \end{tabular*}
...
\end{align}
At stoichiometric conditions, the species mass fractions are the same whether approaching from fuel lean or fuel rich: $Y_{fuel} = 0$, $Y_{ox}=0$, and $Y_{prod}=1$. Fig.~\ref{fig:burke_schumann_spec} shows the comparison between the final lumped species concentrations (fuel, oxidizer, and products) as a function of mixture fraction from fuel lean to fuel rich combustion. 
...
The state relationship for temperature is dependent upon the mixture fraction and the appropriate definition of $Y_{fuel}$ based on the mixture fraction:
\begin{equation}\label{eq:mix_relate_temp}
T = (f-Y_{fuel})\frac{\Delta h_{c}}{c_{p}} + f(T_{fuel,i}-T_{ox,i}) + T_{ox,i}
\end{equation}
The predicted temperature profile does not currently agree with the expected value and there is on going work to determine the source of the differences (Fig.~\ref{fig:burke_schumann_temp}).
\begin{figure}[h!]
\begin{center}
...
\begin{figure}[ht]
   \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
      \scalebox{1.0}{ \includegraphics[width=3.2in]{SCRIPT_FIGURES/HVAC_mass_conservation.png} } &
...
\begin{figure}[ht]
   \begin{center}
      \includegraphics[width=3.5in]{SCRIPT_FIGURES/leak_test.pdf}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=4.in]{FIGURES/ashrae_7.pdf} 
\end{center}
...
\input{SCRIPT_FIGURES/verification_statistics.tex}
