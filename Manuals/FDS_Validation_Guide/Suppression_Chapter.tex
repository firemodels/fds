...
Figures \ref{NIST_NRC_HRR_1} through \ref{NIST_NRC_HRR_3} compare predicted versus measured heat release rates. Each plot contains two sets of curves. The black curves represent the nominal HRR based solely on the metered natural gas flow. The gas flow was ramped up in increments of 25~kW, 50~kW, or 100~kW until the HRR determined via oxygen consumption calorimetry (red curves) diverged, at which point the maximum achievable HRR within the enclosure had been reached.
...
\end{tabular*}
\caption[NIST/NRC OLIVE-Fire maximum HRR, Tests 3, 4, 8, 9, 12, 13]
{NIST/NRC OLIVE-Fire maximum HRR, Tests 3, 4, 8, 9, 12, 13.}
...
\end{tabular*}
\caption[NIST/NRC OLIVE-Fire maximum HRR, Tests 15, 16, 17, 19, 22, 23]
{NIST/NRC OLIVE-Fire maximum HRR, Tests 15, 16, 17, 19, 22, 23.}
...
\end{tabular*}
\caption[NIST/NRC OLIVE-Fire maximum HRR, Tests 24, 26, 27, 29, 30, 31]
{NIST/NRC OLIVE-Fire maximum HRR, Tests 24, 26, 27, 29, 30, 31.}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=4in]{SCRIPT_FIGURES/Theobald_Hose_Stream/Theobald_Hose_Stream_Max_Range}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=4in]{SCRIPT_FIGURES/Theobald_Hose_Stream/Theobald_Hose_Stream_Max_Height}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=4in]{SCRIPT_FIGURES/Theobald_Hose_Stream/Theobald_Hose_Stream_Max_Height_Distance}
