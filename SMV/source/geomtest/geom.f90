...
DO I = 1, N
   VEC(1:3) = MATMUL(M,XIN(3*I-2:3*I))
   XOUT(3*I-2:3*I) = VEC(1:3)
END DO
...
SUBROUTINE PROCESS_GEOM
   ...
   DO I = 1, N_GEOM
      ...
      CALL ROTATE_VEC(M,G%N_VERTS,G%VERTS,G%VERTS)
...
SUBROUTINE MERGE_GEOMS(VERTS,N_VERTS,FACES,SURF_IDS,N_FACES)
   ...
   DO I = 0, N_GEOM-1
      ...
      I1SURF = I2SURF + 1
      I2SURF = I1SURF + G%N_FACES - 1
      IF(G%N_FACES>0)THEN
         FACES(I1FACE:I2FACE) = G%FACES(1:3*G%N_FACES)+OFFSETS(I)
         SURF_IDS(I1SURF:I2SURF) = G%SURF_INDEX
      ENDIF
   END DO
