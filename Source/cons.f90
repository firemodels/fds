...
INTEGER, PARAMETER :: CLOCK_STOP=11                    !< Flag for STATUS_STOP
...
LOGICAL :: SHARED_FILE_SYSTEM=.FALSE.       !< Assume that FDS is NOT being run on computers with a shared file system (FireX)
...
REAL(EB), ALLOCATABLE, TARGET, DIMENSION(:) :: H_BAR             !< Pressure solution of 1-D tunnel pressure solver
REAL(EB), ALLOCATABLE, TARGET, DIMENSION(:) :: H_BAR_S           !< Pressure solution of 1-D tunnel pressure solver, predictor step
...
CHARACTER(200), ALLOCATABLE, DIMENSION(:)  :: FN_SMOKE3D_VTK,FN_BNDF_VTK
CHARACTER(200), ALLOCATABLE, DIMENSION(:,:):: FN_PART_VTK,FN_SL3D_VTK
CHARACTER(200)                             :: FN_PARAVIEW
