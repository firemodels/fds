...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_Test_1_Heat_Flux} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_Test_2_Heat_Flux} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_Test_3_Heat_Flux} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_Test_4_Heat_Flux}
\\
\end{tabular*}
\label{Hu_Heat_Flux}
\end{figure}
