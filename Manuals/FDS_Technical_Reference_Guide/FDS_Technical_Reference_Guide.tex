...
If any convergence check fails, the solution is re-iterated wiht new extrapolated pressures.  Density and enthalpy values are taken as the upwind values in each iteration.
