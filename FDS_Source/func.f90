...
! SPRAY_ANGLE(1:2,1) and SPRAY_ANGLE(1:2,2) respectively

DO I=0,NPT
  THETA_MIN=SPRAY_ANGLE(1,1)*SPRAY_ANGLE(1,2)
  IF(THETA_MIN>0._EB) THEN
     THETA_MIN=THETA_MIN/SQRT((SPRAY_ANGLE(1,1)*COS(LON(I)))**2+(SPRAY_ANGLE(1,2)*SIN(LON(I)))**2)
  ENDIF
  THETA_MAX=SPRAY_ANGLE(2,1)*SPRAY_ANGLE(2,2)
  THETA_MAX=THETA_MAX/SQRT((SPRAY_ANGLE(2,1)*COS(LON(I)))**2+(SPRAY_ANGLE(2,2)*SIN(LON(I)))**2)
