...
\end{tabular*}
\caption[HRRPUA of FAA Polymers using scaling model (1/3)]
{FAA Polymers (1/3) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FAA Polymers using scaling model (2/3)]
{FAA Polymers (2/3) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FAA Polymers using scaling model (3/3)]
{FAA Polymers (3/3) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, other materials (1/4)]
{FSRI, other materials (1/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, others materials (2/4)]
{FSRI, other materials (2/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, others materials (3/4)]
{FSRI, other materials (3/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, others materials (4/4)]
{FSRI, other materials (4/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, polymer materials (1/4)]
{FSRI, polymer materials (1/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, polymer materials (2/4)]
{FSRI, polymer materials (2/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, polymer materials (3/4)]
{FSRI, polymer materials (3/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, polymer materials (4/4)]
{FSRI, polymer materials (4/4) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, wood-based materials (1/3)]
{FSRI, wood-based materials (1/3) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, wood-based materials (2/3)]
{FSRI, wood-based materials (2/3) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of FSRI Materials using scaling model, wood-Based materials (3/3)]
{FSRI, wood-based materials (3/3) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of JH Materials using scaling model (1/2)]
{JH materials (1/2) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of JH Materials using scaling model (2/2)]
{JH materials (1/2) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, mixtures materials (1/5)]
{RISE, mixture materials (1/5) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, mixtures materials (2/5)]
{RISE, mixture materials (2/5) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, mixtures materials (3/5)]
{RISE, mixture materials (3/5) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, mixtures materials (4/5)]
{RISE, mixture materials (4/5) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, mixtures materials (5/5)]
{RISE, mixture materials (5/5) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, polymer materials (1/2)]
{RISE, polymer materials (1/2) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
...
\end{tabular*}
\caption[HRRPUA of RISE Materials using scaling model, polymer materials (2/2)]
{RISE, polymer materials (2/2) - Comparison of predicted and measured heat release rate per unit area using scaling-based approach for cone calorimeter experiments.}
