...
an {\ct IGNITION\_TEMPERATURE} delays burning until your specified temperature is reached. Finally, the addition of {\ct HEAT\_OF\_VAPORIZATION} to the
{\ct SURF} line tells FDS to account for the energy used to vaporize the fuel.
