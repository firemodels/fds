...
\begin{figure}[!ht]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption[Predicted and measured aerosol deposited mass, NIST Soot Deposition Gauge tests]
	{Predicted and measured aerosol deposited mass, NIST Soot Deposition Gauge tests.}
