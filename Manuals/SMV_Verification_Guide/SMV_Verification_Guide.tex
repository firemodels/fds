...
\begin{center}
\begin{tabular}{cc}
 \includegraphics[width=4.0in]{SCRIPT_FIGURES/cell_test_x1p5}&
 \includegraphics[width=4.0in]{SCRIPT_FIGURES/cell_test_y2p5}\\
 \includegraphics[width=4.0in]{SCRIPT_FIGURES/cell_test_z3p5}
\end{tabular}
\end{center}
 \caption[Cell centered slice file test.]{Test that Smokeview is inputting slice file 
 data properly.
 Cell values are initialized in FDS to $100*i + 10*j + k$. }
\label{figslicetest}%
\end{figure}
