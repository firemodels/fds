...
&RAMP ID='fan curve',T=-1000,F= 17.32/
&RAMP ID='fan curve',T= -800,F= 16.12/
&RAMP ID='fan curve',T= -600,F= 14.83/
&RAMP ID='fan curve',T= -400,F= 13.42/
&RAMP ID='fan curve',T= -200,F= 11.83/
&RAMP ID='fan curve',T=    0,F= 10.00/
&RAMP ID='fan curve',T=  200,F=  7.75/
&RAMP ID='fan curve',T=  400,F=  4.47/
&RAMP ID='fan curve',T=  600,F= -4.47/
&RAMP ID='fan curve',T=  800,F= -7.75/
&RAMP ID='fan curve',T= 1000,F=-10.00/
\end{verbatim}\normalsize

Figure~\ref{fig:Fan_Curve} displays a typical fan curves.  Additional examples can be found in the {\ct ashrae7} and {\ct fan\_test} example cases which are documented in the Verification Guide.
...
&HVAC TYPE_ID='FILTER',ID='FILTER',CLEAN_LOSS=1.,SPEC_ID='PARTICULATE',EFFICIENCY=1.,LOSS=7732.446,LOADING_MULTIPLIER=1./
\end{verbatim}\normalsize
