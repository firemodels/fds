...
ALLOCATE(MESHES(NM)%BOUNDARY_COORD(N_BOUNDARY_COORD_DIM))       ; N_BOUNDARY_COORD = 0
ALLOCATE(MESHES(NM)%BOUNDARY_ONE_D(N_BOUNDARY_ONE_D_DIM))       ; N_BOUNDARY_ONE_D = 0
ALLOCATE(MESHES(NM)%BOUNDARY_PROPERTY(N_BOUNDARY_PROPERTY_DIM)) ; N_BOUNDARY_PROPERTY = 0
