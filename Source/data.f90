...
! For a given FUEL, send back the Critical Flame Temperature in degrees C (Beyler, SFPE Handbook)
...
SELECT CASE(FUEL)
 ...
 ! CASE('BUTANE')      ; CRITICAL_FLAME_TEMPERATURE = ????._EB
   CASE('DODECANE')    ; CRITICAL_FLAME_TEMPERATURE = 1507._EB ! Assumed
   ...
   CASE('N-HEPTANE')   ; CRITICAL_FLAME_TEMPERATURE = 1507._EB ! Assumed
 ...
 ! CASE('TOLUENE')     ; CRITICAL_FLAME_TEMPERATURE = ????._EB
