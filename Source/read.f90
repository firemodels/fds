...
NAMELIST /MISC/ AGGLOMERATION,AEROSOL_AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,&
                ...
                THERMOPHORETIC_DEPOSITION,THERMOPHORETIC_SETTLING,THICKEN_OBSTRUCTIONS,TRANSPORT_UNMIXED_FRACTION,&
                TRANSPORT_ZETA_SCHEME,TMPA,TURBULENCE_MODEL,TURBULENT_DEPOSITION,TURB_INIT_CLOCK,UVW_FILE,&
                VEG_LEVEL_SET_COUPLED,VEG_LEVEL_SET_UNCOUPLED,VERBOSE,VISIBILITY_FACTOR,VN_MAX,VN_MIN,Y_CO2_INFTY,Y_O2_INFTY,&
                WD_PROPS,WIND_ONLY,VEG_LEVEL_SET_SURFACE_HEAT_FLUX,VEG_LEVEL_SET_THERMAL_ELEMENTS, &
...
!print '(A,1x,1I3,3ES12.4)','read_surf: NL,LAYER_DENSITY,LAYER_MATL_FRAC,RHOS_S', &
!                NL,SF%LAYER_DENSITY(NL),SF%LAYER_MATL_FRAC(NL,NN),MATERIAL(NNN)%RHO_S
...
!print '(A,1x,3I3,2ES12.4)','read.f90: ii,n_layer,n_matl,layer_matl_frac,layer_density', &
!                                      ii,nn,n,sf%layer_matl_frac(il,nn),sf%layer_density(il)
         ENDDO
      ENDDO
   ENDDO
