...
LOGICAL  :: LUMPED_COMPONENT_ONLY,AEROSOL,BACKGROUND,&
            DEFINED_BACKGROUND,REAC_FUEL_READ=.FALSE.,PRIMITIVE,PASSIVE_SCALAR=.FALSE.
...
NAMELIST /SPEC/ AEROSOL,BACKGROUND,CONDUCTIVITY,CONDUCTIVITY_SOLID, &
                ...
                MIN_DIAMETER,MW,N_BINS,PASSIVE_SCALAR,PR_GAS,PRIMITIVE,RADCAL_ID,&
...
ELSE
   ...
   SM%PASSIVE_SCALAR              = PASSIVE_SCALAR
   SM%PR_USER                     = PR_GAS
   SM%RAMP_CP                     = RAMP_CP
   SM%RAMP_D                      = RAMP_D
