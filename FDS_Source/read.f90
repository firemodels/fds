...
NAMELIST /PART/ AGE,BREAKUP,BREAKUP_CHILD_DIAMETER,BREAKUP_CHILD_GAMMA_D,BREAKUP_CHILD_SIGMA_D,COLOR,COMPLEX_REFRACTIVE_INDEX,&
                ...
                VEG_STEM,VEG_SV,VERTICAL_VELOCITY,CNF_RAMP_ID,CHILD_CNF_RAMP_ID,DISTRIBUTION,CHILD_DISTRIBUTION
...
INTEGER ::I,N,NN,PDPA_M,PDPA_N,DROPLETS_PER_SECOND,VELOCITY_COMPONENT=0,PDPA_HISTOGRAM_NBINS=-1
...
NAMELIST /PROP/ ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BEAD_DENSITY,BEAD_DIAMETER,BEAD_EMISSIVITY,&
                ...
                SPRAY_PATTERN_BETA,SPRAY_PATTERN_MU,SPRAY_PATTERN_SHAPE,SPRAY_PATTERN_TABLE,VELOCITY_COMPONENT,PDPA_HISTOGRAM, &
                PDPA_HISTOGRAM_NBINS,PDPA_HISTOGRAM_LIMITS
...
!Timo:                  DEVC_OR_CTRL: IF ((DEVC_ID/='null' .OR. CTRL_ID/='null') .AND. .NOT.EVACUATION_ONLY(NM)) THEN
...
READ_DEVC_LOOP: DO NN=1,N_DEVC_READ
   ...
   POINTS_LOOP: DO I_POINT=1,POINTS
      ...
      EVACUATION_MESH_LOOP: DO NM=1,NMESHES
         !Timo: IF (.NOT.BAD .OR. .NOT.EVACUATION_ONLY(NM)) CYCLE EVACUATION_MESH_LOOP
