...
CHARACTER(LABEL_LENGTH) :: PART_ID,RAMP_MF(MAX_SPECIES),RAMP_Q,RAMP_V,RAMP_T,MATL_ID(MAX_LAYERS,MAX_MATERIALS),&
                 ...
                 SPEC_ID(MAX_SPECIES),RAMP_T_B,RAMP_V_X,RAMP_V_Y,RAMP_V_Z,RAMP_TMP_GAS_FRONT,NEAR_WALL_TURBULENCE_MODEL,&
                 SURF_DEFAULT
...
NAMELIST /SURF/ ADIABATIC,AREA_MULTIPLIER,BACKING,BURN_AWAY,BURN_DURATION,&
                ...
                RAMP_PART,RAMP_Q,RAMP_T,RAMP_T_B,RAMP_TMP_GAS_FRONT,RAMP_V,RAMP_V_X,RAMP_V_Y,RAMP_V_Z,&
                REFERENCE_HEAT_FLUX,REFERENCE_HEAT_FLUX_TIME_INTERVAL,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   ALLOCATE(SF%RAMP_INDEX(-9:N_TRACKED_SPECIES),STAT=IZERO)
