   ...
   FIND_BACK_WALL_CELL: DO  ! Look for the back wall cell; that is, the wall cell on the other side of the obstruction
      ...
      IF (SF%HT1D .OR. SF%HT_DIM>1) THEN 
         ...
         IF (OBST_INDEX/=OBST_INDEX_PREVIOUS .AND. OBST_INDEX_PREVIOUS>0 .AND. OBST_INDEX>0) THEN
            ...
            IF (ANY(OB%MATL_MASS_FRACTION(:)/=OB_PREV%MATL_MASS_FRACTION(:),DIM=1)) THEN
         ...
         IF (OBST_INDEX>0) MATL_MASS_FRACTION(ONE_D%N_LAYERS,:) = OB%MATL_MASS_FRACTION(:)
...
DO NL=1,ONE_D%N_LAYERS
   ...
   CALL GET_N_LAYER_CELLS(SF%MIN_DIFFUSIVITY(1),SF%SWELL_RATIO*ONE_D%LAYER_THICKNESS(NL),SF%STRETCH_FACTOR(1), &
                          SF%CELL_SIZE_FACTOR,SF%CELL_SIZE,SF%N_LAYER_CELLS_MAX(1),N_CELLS_MAX,&
   ...
   CALL GET_N_LAYER_CELLS(SF%MIN_DIFFUSIVITY(1),ONE_D%LAYER_THICKNESS(NL),SF%STRETCH_FACTOR(1), &
                          SF%CELL_SIZE_FACTOR,SF%CELL_SIZE,SF%N_LAYER_CELLS_MAX(1),ONE_D%N_LAYER_CELLS(NL),&
                          ONE_D%SMALLEST_CELL_SIZE(NL),ONE_D%DDSUM(NL))
