...
INTEGER, PARAMETER :: SPHERE_DRAG=1,CYLINDER_DRAG=2,USER_DRAG=3,NO_DRAG=4,SCREEN_DRAG=5     ! Options for drag computation
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           ENTHALPY_TRANSPORT=.FALSE.,UVW_RESTART=.FALSE.,CUTCELL_DATA_FILE=.FALSE.,SECOND_ORDER_PARTICLE_TRANSPORT=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            LIMITING_DT_RATIO=1.E-4_EB,HRRPUVCUT_MAX=200._EB, &
