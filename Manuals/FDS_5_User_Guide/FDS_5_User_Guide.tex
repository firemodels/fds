...
adjustable. When in doubt about the values of these parameters, just specify the {\ct REFERENCE\_TEMPERATURE}.
...
so simple. First, they consist of more than one material component, each of which can react over a particular temperature interval, and some of which leave behind a solid residue.
...
\begin{align*}
   ...
   \frac{dY_3}{dt} &= -\nu_{r,2,1} \frac{dY_2}{dt}                    & Y_3(0) &=0.0 \\
   \frac{dT}{dt}   &= \frac{5}{60} \; \frac{\mathrm{K}}{\mathrm{s}} & T(0) &= 20+273 \; \mathrm{K} \\
\end{align*}
\begin{align*}
...
and 90~\% combustible material that pyrolyzes at 300~$^\circ$C, leaving a 20~\% (by mass) residue behind. Note that the numbered subscripts refer
