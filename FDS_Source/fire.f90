...
LOGICAL FUNCTION EXTINCT_1(ZZ_IN,TMP_MIXED,AIT_LOC)
USE PHYSICAL_FUNCTIONS,ONLY:GET_AVERAGE_SPECIFIC_HEAT
REAL(EB),INTENT(IN)::ZZ_IN(1:N_TRACKED_SPECIES),TMP_MIXED,AIT_LOC
...
REACTION_LOOP: DO NR=1,N_REACTIONS
   ...
   AIT_IF: IF (TMP_MIXED < MIN(AIT_LOC,RN%AUTO_IGNITION_TEMPERATURE)) THEN
      EXTINCT_1 = .TRUE.
   ELSE AIT_IF
...
LOGICAL FUNCTION EXTINCT_2(ZZ_MIXED_IN,TMP_MIXED,AIT_LOC)
...
FUNCTION EXTINCT_3(ZZ_MIXED_IN,TMP_MIXED,AIT_LOC)
USE PHYSICAL_FUNCTIONS,ONLY:GET_SENSIBLE_ENTHALPY
