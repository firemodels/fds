...
Figure~\ref{Phoenix_Heat_Flux} compares predicted and measured heat fluxes to radiometers at various distances from the LNG pool fires. The general layout of the facility is shown in Fig.~\ref{Phoenix_Layout}. The radiometers were positioned at various heights off the ground and at various inclination angles along the axes shown in the figure.
...
\end{tabular*}
\caption[Phoenix LNG Fires, radial profiles of heat flux]{Phoenix LNG Fires, radial profiles of heat flux.}
