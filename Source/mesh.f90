...
TYPE MESH_TYPE
   ...
   TYPE(BOUNDARY_PROPS_TYPE), ALLOCATABLE, DIMENSION(:) :: BOUNDARY_PROPS
   TYPE(BOUNDARY_RADIA_TYPE), ALLOCATABLE, DIMENSION(:) :: BOUNDARY_RADIA
   INTEGER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_PROPS_DIM,N_BOUNDARY_RADIA_DIM
   INTEGER :: NEXT_AVAILABLE_BOUNDARY_COORD_SLOT,NEXT_AVAILABLE_BOUNDARY_ONE_D_SLOT,NEXT_AVAILABLE_BOUNDARY_PROPS_SLOT,&
              NEXT_AVAILABLE_BOUNDARY_RADIA_SLOT
   INTEGER, ALLOCATABLE, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_PROPS_OCCUPANCY,&
   ...
   INTEGER :: BNDF_COUNTER=0,ISOF_COUNTER=0,PART_COUNTER=0,PL3D_COUNTER=0,&
              PROF_COUNTER=0,RADF_COUNTER=0,SLCF_COUNTER=0,SL3D_COUNTER=0,SM3D_COUNTER=0,UVW_COUNTER=0
   INTEGER :: N_SLCF=0
...
TYPE(BOUNDARY_PROPS_TYPE), POINTER, DIMENSION(:) :: BOUNDARY_PROPS
TYPE(BOUNDARY_RADIA_TYPE), POINTER, DIMENSION(:) :: BOUNDARY_RADIA
INTEGER, POINTER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_PROPS_DIM,N_BOUNDARY_RADIA_DIM
INTEGER, POINTER :: NEXT_AVAILABLE_BOUNDARY_COORD_SLOT,NEXT_AVAILABLE_BOUNDARY_ONE_D_SLOT,NEXT_AVAILABLE_BOUNDARY_PROPS_SLOT,&
                    NEXT_AVAILABLE_BOUNDARY_RADIA_SLOT
INTEGER, POINTER, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_PROPS_OCCUPANCY,&
                                  BOUNDARY_RADIA_OCCUPANCY
...
INTEGER, POINTER :: BNDF_COUNTER,ISOF_COUNTER,PART_COUNTER,PL3D_COUNTER,PROF_COUNTER,RADF_COUNTER,SLCF_COUNTER,SL3D_COUNTER,&
                    SM3D_COUNTER,UVW_COUNTER
...
NEXT_AVAILABLE_BOUNDARY_PROPS_SLOT=>M%NEXT_AVAILABLE_BOUNDARY_PROPS_SLOT
...
BOUNDARY_PROPS_OCCUPANCY=>M%BOUNDARY_PROPS_OCCUPANCY
...
N_SLCF=>M%N_SLCF
BNDF_COUNTER=>M%BNDF_COUNTER
ISOF_COUNTER=>M%ISOF_COUNTER
PART_COUNTER=>M%PART_COUNTER
PL3D_COUNTER=>M%PL3D_COUNTER
PROF_COUNTER=>M%PROF_COUNTER
RADF_COUNTER=>M%RADF_COUNTER
SLCF_COUNTER=>M%SLCF_COUNTER
SL3D_COUNTER=>M%SL3D_COUNTER
SM3D_COUNTER=>M%SM3D_COUNTER
UVW_COUNTER =>M%UVW_COUNTER
SLICE=>M%SLICE
N_RADF=>M%N_RADF
RAD_FILE=>M%RAD_FILE
INC=>M%INC
