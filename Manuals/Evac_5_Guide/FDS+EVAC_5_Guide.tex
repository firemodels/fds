...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/b_ave90s11rnd_d123_initpos}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=80mm]{FIGURES/KaytavaTulokset}}
...
%
\begin{figure}[!tb]
  \centerline{\includegraphics[clip=true,width=120mm]{FIGURES/kaytava_u1s0p5_65s}}
  \centerline{\includegraphics[clip=true,width=120mm]{FIGURES/kaytava_simulex120s}}
