...
USE GLOBAL_CONSTANTS, ONLY: N_TRACKED_SPECIES,N_LP_ARRAY_INDICES,N_SURFACE_DENSITY_SPECIES,N_PASSIVE_SCALARS
INTEGER, INTENT(IN) :: SURF_INDEX
TYPE (SURFACE_TYPE), POINTER :: SF
...
SF%WALL_REALS_ARRAY_SIZE(5) = N_TRACKED_SPECIES+N_PASSIVE_SCALARS         ! RHODW
SF%WALL_REALS_ARRAY_SIZE(6) = N_TRACKED_SPECIES+N_PASSIVE_SCALARS         ! ZZ_F 
...
H_S_OUT = DOT_PRODUCT(CP_AVG_Z(ITMP,1:N_TRACKED_SPECIES),Z_IN)*TMPG
