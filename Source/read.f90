...
NAMELIST /DUMP/ CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,&
                DEVC_COLUMN_LIMIT,DT_BNDE,DT_BNDF,DT_CPU,DT_CTRL,DT_DEVC,DT_FLUSH,&
                ...
                SMOKE3D_QUANTITY,SMOKE3D_SPEC_ID,STATUS_FILES,SUPPRESS_DIAGNOSTICS,T_RADF_BEGIN,T_RADF_END,&
...
READ_DEVC_LOOP: DO NN=1,N_DEVC_READ
   ...
   SELECT CASE(STATISTICS)
      ...
      CASE('null')
         IF (TIME_AVERAGED)   TEMPORAL_STATISTIC = 'TIME AVERAGE'
   ...
   IF (POINTS>1 .AND. .NOT.TIME_HISTORY) THEN
      ...
      IF (STATISTICS_END  > 1.E6_EB) STATISTICS_END   = T_END
      IF (TEMPORAL_STATISTIC=='TIME AVERAGE') TEMPORAL_STATISTIC='RUNNING AVERAGE'
   ENDIF
