...
As mentioned above, we do not actually solve Eq.~(\ref{energy}). Instead, we factor out the divergence as follows:
\be
...
\be \dt \; \max\left( \frac{|u|}{\dx}, \frac{|v|}{\dy}, \frac{|w|}{\dz} \right) < 1 \quad ; \quad
