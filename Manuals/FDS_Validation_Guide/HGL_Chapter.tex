...
The plots on the following pages compare predicted and measured upper and lower layer temperatures from the LLNL Enclosure test series. The temperatures were reported as averages of 5 thermocouples aligned in a vertical rake. The experiments explore hot gas layer development with largely varying levels of ventilation.

 Note: In the figures that follow the black symbols depict an average temperature recorded by the five upper-most thermocouples on the western thermocouple rake. These five thermocouples are located above the plenum that is present in tests 17 - 60. The red symbols depict the five middle thermocouples on the western thermocouple rake. These five thermocouples are located immediately beneath the plenum.
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=5.0in]{FIGURES/ScatterPlots/HGL_Temperature_LLNL}
\end{tabular}
