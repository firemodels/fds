...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   INTEGER :: SAMPLING,N_QUANTITIES,QUANTITIES_INDEX(10),QUANTITIES_Y_INDEX(10)=-1,QUANTITIES_Z_INDEX(10)=-1,ARRAY_INDEX=0,&
              RGB(3),RADIATIVE_PROPERTY_INDEX=0, &
...
TYPE SPECIES_TYPE
   ...
   LOGICAL :: ABSORBING=.FALSE.,ISFUEL=.FALSE.,LISTED=.FALSE.
   CHARACTER(30) :: ID,RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D,RADCAL_ID
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   INTEGER :: AWM_INDEX = -1,SINGLE_SPEC_INDEX=-1
...
TYPE REACTION_TYPE
   ...
   CHARACTER(30), ALLOCATABLE, DIMENSION(:) :: SPEC_ID_NU,SPEC_ID_NU_READ,SPEC_ID_N_S,SPEC_ID_N_S_READ
   ...
   LOGICAL :: IDEAL,CHECK_ATOM_BALANCE,REVERSIBLE=.FALSE.,FAST_CHEMISTRY=.FALSE.
