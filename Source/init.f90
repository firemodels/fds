...
TYPE (VENTS_TYPE), POINTER :: VT
TYPE (OBSTRUCTION_TYPE), POINTER :: OB
TYPE (SURFACE_TYPE), POINTER :: SF,SFO
LOGICAL :: SOLID_CELL
INTEGER :: WSC,WSCS
TYPE WALL_SAVE_TYPE
   INTEGER :: COUNTER=0
...
DO IW=1,M%N_EXTERNAL_WALL_CELLS+M%N_INTERNAL_WALL_CELLS
   ...
   ENDIF
   SFO => SURFACE(WC%SURF_INDEX_ORIG)
   IF (WC%SURF_INDEX/=WC%SURF_INDEX_ORIG .AND. SFO%N_WALL_STORAGE_INTEGERS<1) THEN
      CALL PACK_WALL(NM,IW,WC%SURF_INDEX_ORIG,1,.FALSE.,N_INTEGERS=N_INT,N_REALS=N_RLS,N_LOGICALS=N_LOG)
      SFO%N_WALL_STORAGE_INTEGERS = MAX(SFO%N_WALL_STORAGE_INTEGERS,N_INT)
      SFO%N_WALL_STORAGE_REALS    = MAX(SFO%N_WALL_STORAGE_REALS   ,N_RLS)
      SFO%N_WALL_STORAGE_LOGICALS = MAX(SFO%N_WALL_STORAGE_LOGICALS,N_LOG)
   ENDIF
ENDDO
