...
\end{tabular*}
\caption{FM/FPRF Datacentert Tests, smoke concentration, low and high exhaust rate, propylene and cable tests}
...
\end{tabular*}
\caption[CH$_4$ and O$_2$ volume fractions at 11~mm, 9~mm, and 7~mm above burner, Smyth slot burner]
...
\end{tabular*}
\caption[CO$_2$ and CO volume fractions at 11~mm, 9~mm, and 7~mm above burner, Smyth slot burner]
...
\end{tabular*}
\caption[H$_2$O and H$_2$ volume fractions at 11~mm, 9~mm, and 7~mm above burner, Smyth slot burner]
...
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Waterloo_Methanol/Waterloo_Methanol_CH3OH_CL} \\
...
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Waterloo_Methanol/Waterloo_Methanol_H2_CL}
\end{tabular*}
