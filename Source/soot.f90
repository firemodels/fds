...
USE GLOBAL_CONSTANTS, ONLY: GVEC, D_Z
USE PHYSICAL_FUNCTIONS, ONLY: GET_VISCOSITY
INTEGER, INTENT(IN) :: IP,NM
REAL(EB), INTENT(IN) :: DT,DT_P
INTEGER :: IIG,JJG,KKG,NS
REAL(EB) :: VEL,VREL, R_D, FRAC, EFF, EFF_IN, EFF_IM, PE, EFF_DIFF, STK, MU_G, ZZ_GET(1:N_TRACKED_SPECIES)
...
FRAC = MIN(1._EB,VEL*DT_P*MIN(VOL**TWTH,LP%PWT*4._EB*PI*R_D**2)/VOL)
