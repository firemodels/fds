...
[X Tet] = importabaqus('Lattimer_20_kW_0_degree.inp');

% write FDS input file

fid = fopen('Lattimer_20_kW_0_degree.fds','wt');

head = ['&HEAD CHID=''Lattimer_20_kW_0_degree'', TITLE=''Surface temperature on slopped wall, 20 kW propane fire'' /'];
fprintf(fid,'%s\n',head);
