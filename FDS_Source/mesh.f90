...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: &
            ...
            MU,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION,D_GEOMETRY, &
            CSD2,CHEM_SUBIT,MIX_TIME,STRAIN_RATE,TMP_FLAME
 
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: ZZ,ZZS,DEL_RHO_D_DEL_Z,FX,FY,FZ
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: TURB_WORK11,TURB_WORK12
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
          U,V,W,US,VS,WS,DDDT,D,DS,H,HS,KRES,FVX,FVY,FVZ,RHO,RHOS, &
          MU,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION,D_GEOMETRY, &
          CSD2,MTR,MSR,WEM,MIX_TIME,CHEM_SUBIT,STRAIN_RATE,TMP_FLAME
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: ZZ,ZZS,DEL_RHO_D_DEL_Z,FX,FY,FZ
