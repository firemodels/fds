...
TYPE MESH_TYPE
   ...
   TYPE(ONE_D_M_AND_E_XFER_TYPE), ALLOCATABLE, DIMENSION(:) :: BOUNDARY_ONE_D
   TYPE(BOUNDARY_COORD_TYPE), ALLOCATABLE, DIMENSION(:) :: BOUNDARY_COORD
   TYPE(BOUNDARY_PROPERTY_TYPE), ALLOCATABLE, DIMENSION(:) :: BOUNDARY_PROPERTY
   TYPE(BOUNDARY_RADIA_TYPE), ALLOCATABLE, DIMENSION(:) :: BOUNDARY_RADIA
   INTEGER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_PROPERTY_DIM,N_BOUNDARY_RADIA_DIM
   INTEGER, ALLOCATABLE, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_PROPERTY_OCCUPANCY,&
...
TYPE(ONE_D_M_AND_E_XFER_TYPE), POINTER, DIMENSION(:) :: BOUNDARY_ONE_D
TYPE(BOUNDARY_COORD_TYPE), POINTER, DIMENSION(:) :: BOUNDARY_COORD
TYPE(BOUNDARY_PROPERTY_TYPE), POINTER, DIMENSION(:) :: BOUNDARY_PROPERTY
TYPE(BOUNDARY_RADIA_TYPE), POINTER, DIMENSION(:) :: BOUNDARY_RADIA
INTEGER, POINTER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_PROPERTY_DIM,N_BOUNDARY_RADIA_DIM
INTEGER, POINTER, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_PROPERTY_OCCUPANCY,&
                                  BOUNDARY_RADIA_OCCUPANCY
...
BOUNDARY_PROPERTY_OCCUPANCY=>M%BOUNDARY_PROPERTY_OCCUPANCY
