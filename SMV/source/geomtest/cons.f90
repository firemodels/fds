...
INTEGER, PARAMETER :: SPHERE_DRAG=1,CYLINDER_DRAG=2,USER_DRAG=3,NO_DRAG=4                   ! Options for drag computation
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,IUVW=0,TURB_MODEL=0
...
REAL(EB) :: DT_VEG,VEG_CLOCK,BNDE_CLOCK,GEOM_CLOCK
REAL(EB) :: UVW_CLOCK_CBC(0:3)=(/0._EB,0.28_EB,0.67_EB,1.E10_EB/)
...
REAL(EB) :: RUN_AVG_FAC,CDF_CUTOFF=0.01_EB
LOGICAL :: EB_PART_FILE=.FALSE.

INTEGER :: OM_LP_ILW_A=1,OM_LP_ILW_B=1,OM_LP_NODES=1,OM_LP_MATL=1,OM_LP_LAYERS=1
