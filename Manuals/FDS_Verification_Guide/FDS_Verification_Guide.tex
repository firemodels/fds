...
In these examples, a 1~cm thick steel plate and pipe are coated on each side with 2~cm thick insulation material. The steel and insulation material have constant thermal properties, and the heat transfer coefficient is 10~W/m$^2$/K. The outer surface of the composite is exposed to air at 480~$^\circ$C while the inner surface is exposed to air at 20~$^\circ$C. The assemblies are heated for 10~h and the steady-state temperature profiles are shown in Fig.~\ref{insulated_steel_plate}. Neglecting thermal radiation, the heat flux through the plate is given by~\cite{Incropera:1}:
\be
