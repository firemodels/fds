...
INTEGER, PARAMETER :: SPHERE_DRAG=1,CYLINDER_DRAG=2,USER_DRAG=3                             ! Program Stop Status
...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION,CONVECTION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,MIXTURE_FRACTION=.FALSE., &
           ...
           MEAN_FORCING=.FALSE.,H_EDDY=.FALSE.,H_LOGLAW=.FALSE.,H_CHILTON_COLBURN=.FALSE.,BAROCLINIC=.TRUE.,NOBIAS=.FALSE., &
           VAN_DRIEST=.FALSE.,EMBEDDED_MESH=.FALSE.,EDDY_BREAK_UP=.FALSE.,EDC_ODE=.FALSE.,&
           THERMOPHORETIC_DEPOSITION=.TRUE.,TURBULENT_DEPOSITION=.TRUE.,VELOCITY_ERROR_FILE=.FALSE.,OLD_PRESSURE_SCHEME=.FALSE., &
           CP_FTMP=.FALSE.,EMPIRICAL_EXTINCTION=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,TMPM,RHOA,P_INF,P_STP,GRAV,R0,R1, &
            ...
            LAPSE_RATE,HCH,HCV,TEX_ORI(3),SIGMA,KAPPA0,C_FORCED,ASSUMED_GAS_TEMPERATURE, &
            CHARACTERISTIC_VELOCITY,CFL_MAX,CFL_MIN,VN_MAX,VN_MIN,PR,SC,C_P_W,H_V_W,SMOKE_ALBEDO,GROUND_LEVEL=0._EB, &
            RFAC_FORCING=0.5_EB,PARTICLE_CFL_MAX=1.0_EB,LIMITING_DT_RATIO=1.E-4_EB,HRRPUVCUT_MAX=200._EB, &
...
REAL(EB) :: MW_AIR,MW_OTHER,MW_SOOT,HRRPUA_SHEET,HRRPUA_SHEET_EXPONENT=1._EB,RHO_SOOT,VISIBILITY_FACTOR, SOOT_H_FRACTION ,&
            MASS_EXTINCTION_COEFFICIENT,EC_LL,C_EDC=0.10_EB,C_EBU=1._EB,HRRPUV_AVERAGE
...
REAL(EB) :: VELOCITY_TOLERANCE=1.E6_EB
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,DSMAG_FREQ=1,DSMAG_INC=1,FISHPAK_BC(3)=-1
...
INTEGER                              :: LU_MASS,LU_HRR,LU_NOTREADY,LU_VELOCITY_ERROR
...
REAL(EB) :: DX_LS,DY_LS,PHI_MIN_LS,PHI_MAX_LS,ROS_0
LOGICAL  :: RK2_PREDICTOR_LS,VEG_LEVEL_SET
REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: FLUX0_LS,FLUX1_LS,PHI_LS,PHI0_LS,PHI1_LS, &
                                         ROS_HEAD,ROS_HEAD_U0_INFW,ROS_HEAD_U_INFW,ROS_FLANK, &
                                         SR_X_LS,SR_Y_LS,U_LS,V_LS
