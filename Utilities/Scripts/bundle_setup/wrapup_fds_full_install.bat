...
"%CD%\shortcut.exe" /F:"%FDS5START%\Guides and Release Notes\FDS 5 Verification Guide.lnk" /T:"%CD%\Documentation\Guides_and_Release_Notes\FDS_5_Verification_Guide.pdf" /A:C >NUL
"%CD%\shortcut.exe" /F:"%FDS5START%\Guides and Release Notes\FDS 5 Validation Guide.lnk"   /T:"%CD%\Documentation\Guides_and_Release_Notes\FDS_5_Validation_Guide.pdf" /A:C >NUL
...
"%CD%\shortcut.exe" /F:"%FDS5START%\Guides and Release Notes\SMV 5 Verification Guide.lnk" /T:"%CD%\Documentation\Guides_and_Release_Notes\SMV_5_Verification_Guide.pdf" /A:C >NUL
