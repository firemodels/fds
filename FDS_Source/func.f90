...
REAL(EB) FUNCTION LES_FILTER_WIDTH_3D_GMEAN(DX,DY,DZ)

REAL(EB), INTENT(IN) :: DX,DY,DZ

LES_FILTER_WIDTH_3D_GMEAN = (DX*DY*DZ)**ONTH

END FUNCTION LES_FILTER_WIDTH_3D_GMEAN
...
REAL(EB) FUNCTION LES_FILTER_WIDTH_2D_GMEAN(DX,DY,DZ)

REAL(EB), INTENT(IN) :: DX,DY,DZ
REAL(EB) :: DUMMY

DUMMY = DY
LES_FILTER_WIDTH_2D_GMEAN = SQRT(DX*DZ)

END FUNCTION LES_FILTER_WIDTH_2D_GMEAN
