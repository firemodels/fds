...
# $QFDS $DEBUG -p 36 -n 12 -q aspen -d $INDIR McCaffrey_14_kW_21.fds
# $QFDS $DEBUG -p 36 -n 12 -q aspen -d $INDIR McCaffrey_22_kW_21.fds
# $QFDS $DEBUG -p 36 -n 12 -q aspen -d $INDIR McCaffrey_33_kW_21.fds
# $QFDS $DEBUG -p 36 -n 12 -q aspen -d $INDIR McCaffrey_45_kW_21.fds
# $QFDS $DEBUG -p 36 -n 12 -q aspen -d $INDIR McCaffrey_57_kW_21.fds

# $QFDS $DEBUG -p 175 -n 12 -q aspen -d $INDIR McCaffrey_14_kW_45.fds
# $QFDS $DEBUG -p 175 -n 12 -q aspen -d $INDIR McCaffrey_22_kW_45.fds
# $QFDS $DEBUG -p 175 -n 12 -q aspen -d $INDIR McCaffrey_33_kW_45.fds
# $QFDS $DEBUG -p 175 -n 12 -q aspen -d $INDIR McCaffrey_45_kW_45.fds
# $QFDS $DEBUG -p 175 -n 12 -q aspen -d $INDIR McCaffrey_57_kW_45.fds
