...
Natl.~Inst.~Stand.~Technol.~Spec.~Publ.~1017-2, 80 pages (August 2009) \\
CODEN: NSPUE2 }
...
%Assuming that $C_\mathrm{CO}$, $C_\mathrm{CO_2}$ and $C_\mathrm{O_2}$ are constant, equations \ref{eq:fedCO}
