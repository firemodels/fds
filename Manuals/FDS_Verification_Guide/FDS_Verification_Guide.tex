...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                                                 %
% The mathematical style of this document is to follow                                            %
%                                                                                                 %
...
\newcommand{\rmcdot}{$\,\cdot\,$} % usage: W/(m$^2$\rmcdot K), note no space after first unit and but space after
...
\newcommand{\dQ}{\dot{Q}}
\newcommand{\dq}{\dot{q}}
\renewcommand{\dm}{\dot{m}}
\newcommand{\ha}{\frac{1}{2}}
\newcommand{\ft}{\frac{4}{3}}
\newcommand{\ot}{\frac{1}{3}}
\newcommand{\fofi}{\frac{4}{5}}
\renewcommand{\of}{\frac{1}{4}}
