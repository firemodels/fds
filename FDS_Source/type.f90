...
TYPE SPECIES_TYPE
   ...
   CHARACTER(LABEL_LENGTH) :: ID,RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D,RADCAL_ID
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   CHARACTER(LABEL_LENGTH) :: ID='null',RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D
...
TYPE SURFACE_TYPE
   ...
   CHARACTER(LABEL_LENGTH), DIMENSION(0:MAX_SPECIES) :: RAMP_MF
...
TYPE GEOMETRY_TYPE
   CHARACTER(LABEL_LENGTH) :: ID='geom',SMVOBJECT='sensor',TFILE='null'
   CHARACTER(LABEL_LENGTH) :: SHAPE='SPHERE',SURF_ID='null'
