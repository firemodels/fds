...
INTEGER :: NR,NS,NS2,NFR,PRIORITY,PROD_COUNTER=0, SIMPLE_COUNTER, NEW_REAC=0,N_SIMPLE_CHEMISTRY_REACTIONS,IZ
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   RN%AUTO_IGNITION_TEMPERATURE = AUTO_IGNITION_TEMPERATURE + TMPM ! AIT converted from C to K
...
LOGICAL :: ADIABATIC,BURN_AWAY,FREE_SLIP,NO_SLIP,CONVERT_VOLUME_TO_MASS,HORIZONTAL
...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            TMP_FRONT,TMP_FRONT_INITIAL,TMP_INNER(MAX_LAYERS),THICKNESS(MAX_LAYERS),VEL,VEL_BULK,INTERNAL_HEAT_SOURCE(MAX_LAYERS),&
...
NAMELIST /SURF/ ADIABATIC,AREA_MULTIPLIER,BACKING,BURN_AWAY,BURN_DURATION,&
                ...
                TMP_BACK,TMP_FRONT,TMP_FRONT_INITIAL,TMP_INNER,TRANSPARENCY,&
