...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: &
            ...
            C_DYNSMAG,MTR,MSR,MU_DNS,WEM
 
   REAL(EB), POINTER, DIMENSION(:,:,:,:) :: YY,YYS,DEL_RHO_D_DEL_Y
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: RHODW,YY_F,EDGE_INTERPOLATION_FACTOR,FW
   REAL(EB), POINTER, DIMENSION(:)   :: XW,YW,ZW,TW,AW,RAW,UW0,DUWDT,RDN, &
            QRADIN,QRADOUT,EW,KW,QCONF,AREA_ADJUST,RHO_F, &
            TMP_F,TMP_B,HEAT_TRANS_COEF,D_CORR,DS_CORR,UVW_SAVE,AWMSOOT,U_TAU,DH,DHS
...
USE PRECISION_PARAMETERS
USE MESH_VARIABLES
USE GLOBAL_CONSTANTS, ONLY: PERIODIC_TEST,DYNSMAG,FLUX_LIMITER,CHECK_KINETIC_ENERGY,IMMERSED_BOUNDARY_METHOD,NEW_FLUX_LIMITER
IMPLICIT NONE
