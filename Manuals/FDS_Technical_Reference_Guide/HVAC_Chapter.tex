...
\be \tilde{P}^n_i  = P^{n-1}_i+\left(\frac{dP^{n-1}_i}{dt} + \frac{{\sum_j u^{n-1}_j A^{n-1}_j} - {\sum_j u^n_j A^n_j}}{\int_{\Omega_m} {\cal P} \, dV}\right)\Delta t^n = \tilde{P^*}^n_i - \frac{\sum_j u^n_j A^n_j}{\int_{\Omega_m} {\cal P} \, dV})\Delta t^n
