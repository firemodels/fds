...
\be F_n(D) = \int_0^D \frac{F'_v(D')}{D'^3} \, \d D'  \left/ \int_0^\infty \, \frac{F'_v(D')}{D'^3}
     \, \d D' \right. \quad ; \quad F_v' \equiv \frac{\d F_v}{\d D}   \ee
...
\be \dm \; \dt = C \, \sum_{i=1}^N \;  \frac{4}{3} \pi \rho_{\rm p}
...
\be X_{\rm l} = \frac{p_{\rm 1 \; atm}}{\bp_m} \exp \left[ \frac{h_v \, W_{\rm l}}{\cal R}
...
\be
   ...
   A \, h_m \, \rho \left( \frac{Y_{\rm l}^{n+1}+Y_{\rm l}^n}{2} - Y_{\rm g} \right) h_v  \right]
\ee
...
\be
   \frac{\d Y_{\rm l}}{\d T_{\rm l}} = \frac{\d Y_{\rm l}}{\d X_{\rm l}} \, \frac{\d X_{\rm l}}{\d T_{\rm l}}  = \frac{W_{\rm a}/W_{\rm l}}{ (X_{\rm l} (1-W_{\rm a}/W_{\rm l}) + W_{\rm a}/W_{\rm l})^2 } \;
     \frac{p_{\rm 1 \; atm}}{\bp_m} \frac{h_v W_{\rm l}}{{\cal R} \, T_{\rm l}^2} \, \exp \left[ \frac{h_v \, W_{\rm l}}{\cal R} \left( \frac{1}{T_{\rm b}}-\frac{1}{T_{\rm l}} \right) \right]
\ee
