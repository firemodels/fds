...
LOGICAL :: LES,DNS,RADIATION,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           IDEAL_GAS=.FALSE., CP_FTMP=.FALSE.,NEW_EVAP=.FALSE., &
           ...
           INCLUDE_NUMERICAL_DIFFUSION=.FALSE.,GRAV_VISC=.FALSE.,HISTOGRAM_FILE=.FALSE.,TENSOR_DIFFUSIVITY=.FALSE.
...
REAL(EB) :: RSUM0
REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: Z2Y,CP_Z,CPBAR_Z,K_Z,MU_Z,D_Z,H_S_Z
