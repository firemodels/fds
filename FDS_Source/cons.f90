...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           GRAVITATIONAL_DEPOSITION_CEILING=.FALSE., &
           ...
           COMPUTE_VISCOSITY_TWICE=.TRUE.,PARTICLE_CFL=.TRUE.

INTEGER :: ISOTROPIC_PARTICLE_FORCE=0
...
LOGICAL :: SIMPLE_CHEM = .TRUE.,TEMPERATURE_DEPENDENT_REACTION=.FALSE.
REAL(EB) :: RSUM0
