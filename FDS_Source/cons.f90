...
LOGICAL :: LES,DNS,RADIATION,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           DYNSMAG=.FALSE.,SPATIAL_GRAVITY_VARIATION=.FALSE., &
           CHECK_KINETIC_ENERGY=.FALSE.,PROJECTION=.FALSE.,CLIP_MASS_FRACTION=.FALSE.,CHECK_VN=.FALSE., &
           ...
           INIT_HRRPUV = .FALSE.,NEW_COMBUSTION=.TRUE.,WFDS_FE=.FALSE.,WFDS_BNDRYFUEL=.FALSE., &
           ENTHALPY_TRANSPORT=.FALSE.,INCLUDE_NUMERICAL_DIFFUSION=.FALSE.      
...
INTEGER :: N_SPECIES=0,N_REACTIONS,I_PRODUCTS=-1,I_WATER=-1,I_CO2=-1,N_KAPPA_ARRAY,N_TRACKED_SPECIES=0
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,IUVW=1
...
REAL(EB) :: UVW_CLOCK_CBC(4)=(/0._EB,0.28_EB,0.67_EB,1.E10_EB/)
