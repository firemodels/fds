...
Geometries that change with time may be created using the keywords, AZIM\_RATE, ELEV\_RATE, XYZ\_RATE and SCALE\_RATE which alter AZIM, ELEV, XYZ and SCALE respectively. For example,
\begin{verbatim}
&GEOM VERTS=...,FACES=....,AZIM=0.0,AZIM_RATE=1.0 /
\end{verbatim}
...
{\ct AZIM\_RATE}    & Real                   & Section~\ref{info:GEOM}            &  deg/s    &    0.0                   \\ \hline
{\ct COMPONENT\_ONLY} & LOGICAL             & Section~\ref{info:GEOM}            &           &  {\ct .FALSE.}           \\ \hline
{\ct ELEV}         & Real                   & Section~\ref{info:GEOM}            &  deg      &    0.0                   \\ \hline
{\ct ELEV\_RATE}    & Real                   & Section~\ref{info:GEOM}            &  deg/s    &    0.0                   \\ \hline
...
{\ct SCALE\_RATE}   & Real Triplet           & Section~\ref{info:GEOM}            &  1/s      &   1.0                    \\ \hline
...
{\ct XYZ\_RATE}     & Real Triplet           & Section~\ref{info:GEOM}            &   m/s     &   0.0                    \\ \hline
