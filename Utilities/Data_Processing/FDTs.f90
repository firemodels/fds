...
REAL :: ACTIVATION_TEMPERATURE,A_C,ALPHA,AREA,A_T,A_V,CHI_R,CONDUIT_DIAMETER,CONDUIT_THICKNESS,CUTOFF_TIME,C_PLUME,C_JET, &
...
! Process ALPERT (NUREG Sprinkler Activation) lines
