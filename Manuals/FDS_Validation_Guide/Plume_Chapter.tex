...
Figures~\ref{Water_Methanol_Plume_Temp_1} through \ref{Water_Methanol_Plume_Temp_3} display radial profiles of measured and predicted mean (left hand plots) and root mean square (right hand plots) temperatures above a 30~cm diameter methanol pool fire. The root mean square of the temperature is given by
\be
...
{Waterloo Methanol, radial profiles of mean (left) and rms (right) temperature, 18~cm to 30~cm above the burner.}
