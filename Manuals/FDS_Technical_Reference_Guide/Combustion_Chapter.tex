...
\begin{align}
\label{eq:dzf}  \Delta Z_{\rm F} &= \min(Z_{\rm F},Z_{\rm A}/s) \\
\label{eq:dza}  \Delta Z_{\rm A} &= s \,\Delta Z_{\rm F} \\
\label{eq:dzp}  \Delta Z_{\rm P} &= \min(\Delta Z_{\rm F}/Z_{\rm F},\Delta Z_{\rm A}/Z_{\rm A}) \, Z_{\rm P}
\end{align}
The extinction criterion is then given by
\begin{multline}
\label{eq:extinction}
\Delta Z_{\rm F} \, \left( h_{\rm F}(T)+\Delta h_{\rm c,F} \right) + \Delta Z_{\rm A} \, h_{\rm A}(T) + \Delta Z_{\rm P} \, h_{\rm P}(T)  < \\
\Delta Z_{\rm F} \, h_{\rm F}(T_{\rm LFT}) + \Delta Z_{\rm A} \, h_{\rm A}(T_{\rm LFT}) + \Delta Z_{\rm P} \, h_{\rm P}(T_{\rm LFT}) 
\end{multline}
