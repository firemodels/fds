...
\subsection{TUS Facade (JIS A 1310 Configuration)}
...
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_600_kW_Middle_Surface_Temp} &
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_750_kW_Middle_Surface_Temp} &
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_900_kW_Middle_Surface_Temp} \\
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_600_kW_Middle-Right_Surface_Temp} &
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_750_kW_Middle-Right_Surface_Temp} &
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_900_kW_Middle-Right_Surface_Temp} \\
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_600_kW_Right_Surface_Temp} &
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_750_kW_Right_Surface_Temp} &
\includegraphics[width=2.1in]{SCRIPT_FIGURES/TUS_Facade/JIS_facade_900_kW_Right_Surface_Temp} 
\end{tabular*}
\caption[TUS Facade surface temperatures, JIS A 1310 facade test]{TUS Facade surface temperatures, JIS A 1310 facade test. The top row displays vertical surface temperature profiles along the centerline of the compartment window. The middle row displays the temperatures 23~cm off-center. The bottom row displays the profiles 41~cm off-center.}
