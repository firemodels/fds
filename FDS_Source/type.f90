...
TYPE REACTION_TYPE
   CHARACTER(LABEL_LENGTH) :: FUEL,OXIDIZER,PRODUCTS,ID,RAMP_FS,TABLE_FS
...
TYPE MATERIAL_TYPE
   ...
   REAL(EB), DIMENSION(MAX_REACTIONS) :: TMP_IGN,TMP_THR,THR_SIGN
   REAL(EB), DIMENSION(MAX_MATERIALS,MAX_REACTIONS) :: NU_RESIDUE
   REAL(EB), DIMENSION(MAX_REACTIONS,MAX_HEATING_RATES) :: TMP_REF,RATE_REF,HEATING_RATE
   REAL(EB), DIMENSION(MAX_REACTIONS) :: A,E,H_R,N_S,N_T,N_O2,GAS_DIFFUSION_DEPTH
   REAL(EB), DIMENSION(MAX_REACTIONS) :: PYROLYSIS_RANGE,HEAT_OF_COMBUSTION,TOL_INT
...
TYPE SLICE_TYPE
   INTEGER :: I1,I2,J1,J2,K1,K2,INDEX,INDEX2=0,Z_INDEX=-999,Y_INDEX=-999,PART_INDEX=0,VELO_INDEX=0,PROP_INDEX=0,REAC_INDEX=0
   REAL(FB), DIMENSION(2) :: MINMAX
   REAL(EB):: SLICE_AGL
   LOGICAL :: TERRAIN_SLICE=.FALSE.,CELL_CENTERED=.FALSE., FIRE_LINE=.FALSE.,LEVEL_SET_FIRE_LINE=.FALSE.,GEOMETRY=.FALSE.
