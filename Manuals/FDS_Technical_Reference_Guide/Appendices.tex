...
The source term $I_{\rm b,\la}(\bx)$ is the {\em Planck function} that represents the
intensity of blackbody radiation at temperature, $T=T(\bx)$, and wavelength, $\la$
\be
I_{\rm b,\la}(T) = \dfrac{2 \, h \, c^2 }{\la^5 \left[\exp\left(\dfrac{h \, c }{\la \, k_{\rm B} \, T}\right)-1\right]}
\ee
