...
! Commented for NOW ELSE IF (RADCAL_FUEL=='PROPANE') THEN
...
! PCH4 : (REAL) PARTIAL PRESSURE OF METHANE
...
REAL(EB), PARAMETER :: Q2      = 1.4388_EB ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
REAL(EB), PARAMETER :: WM_C3H8 = 44._EB
...
! FIRST BAND: 7 MICRON BAND (1250 CM^-1 TO 1600 CM^-1)   
   DINV_C3H8 = 1._EB/5.1_EB ! METHANE DATA--NEED PROPANE DATA 
...
! SECOND BAND: 3.3 MICRON BAND (2600 CM^-1 TO 3350 CM^-1)
   DINV_C3H8 = 1._EB/9.4_EB ! METHANE DATA--NEED PROPANE DATA
...
!--TO DO: NEED HEPTANE DATA - CHECK IF NEEDED
...
! FIRST BAND: 7 MICRON BAND (1250 CM^-1 TO 1600 CM^-1)   
   DINV_C7H16 = 1._EB/5.1_EB ! METHANE DATA
!--TO DO: NEED HEPTANE DATA
   SDWEAK = GET_SPECTRAL_ABSORPTION(OMEGA,TEMP,SD_C7H16_TEMP,OM_BND_C7H16(1,:),SD7_C7H16)

!! LINE SHAPE PARAMETER BROSMER & TIEN, JQSRT V. 33, 525 EQ. 11 (SPECIFIC TO METHANE)
!  GDINV  = .0243_EB*PRESSURE_EFFECTIVE*(TOAZ)**.8_EB
! !--TO DO: NEED GDINV HEPTANE
...
! SECOND BAND: 3.3 MICRON BAND (2600 CM^-1 TO 3350 CM^-1)
   DINV_C7H16 = 1._EB/9.4_EB ! METHANE DATA
!--TO DO: NEED HEPTANE DATA
...
! NOTE GREG SUBROUTINE SAYS :  300, 393, 450, 490, 594, 801 --TO DO: CHECK WITH HIM
