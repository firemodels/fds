...
ALLOCATE(D_TMP_Z(N_TRACKED_SPECIES))
D_TMP_Z = -1.E30_EB
ALLOCATE(MU_TMP_Z(N_TRACKED_SPECIES))
MU_TMP_Z = -1.E30_EB
ALLOCATE(CP_TMP_Z(N_TRACKED_SPECIES))
CP_TMP_Z = -1.E30_EB
ALLOCATE(H_TMP_Z(N_TRACKED_SPECIES))
H_TMP_Z = -1.E30_EB
ALLOCATE(K_TMP_Z(N_TRACKED_SPECIES))
K_TMP_Z = -1.E30_EB
