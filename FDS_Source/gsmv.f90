...
CALL GET_VERTS(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,FACES,NORMAL_INDEX,NFACES,NPOLYS,BOX_STATE,VERT_STATE)
...
SUBROUTINE GET_VERTS(BOX_BOUNDS,VV0,VV1,VV2,VV3,VERTS,NVERTS,FACES,NORMAL_INDEX,NFACES,NPOLYS,BOX_STATE,VERT_STATE)
