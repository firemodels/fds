...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   LOGICAL :: STATIC=.FALSE.,MASSLESS_TRACER=.FALSE.,MASSLESS_TARGET=.FALSE.,LIQUID_DROPLET=.FALSE.,SOLID_PARTICLE=.FALSE., &
              ...
              PERIODIC_X=.FALSE.,PERIODIC_Y=.FALSE.,PERIODIC_Z=.FALSE.,SECOND_ORDER_PARTICLE_TRANSPORT=.FALSE.
...
TYPE DUCT_TYPE
   ...
   REAL(EB) :: AREA,AREA_INITIAL,COIL_Q=0._EB,CP_D,DIAMETER,DP_FAN(2)=0._EB,DX=-1._EB,LENGTH,LOSS(2)=0._EB,MASS_FLOW_INITIAL=1.E6_EB,&
               RHO_D,ROUGHNESS,RSUM_D=0._EB,TAU=-1._EB,TMP_D,TOTAL_LOSS=0._EB,VEL(4)=0._EB,VOLUME_FLOW=1.E6_EB,&
               VOLUME_FLOW_INITIAL=1.E6_EB
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: CP_C,RHO_C,TMP_C,ZZ
