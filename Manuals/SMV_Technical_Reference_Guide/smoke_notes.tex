...
This section discusses splitting the RTE so that it may be solved separately on multiple meshes (or multiple slice planes).  The final solution is then obtained by  combining appropriately the solutions obtained on each part.
