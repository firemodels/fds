...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{SCRIPT_FIGURES/ScatterPlots/Plume_Temperature} \\[-0.2in]
\includegraphics[width=4.0in]{SCRIPT_FIGURES/ScatterPlots/Fire_Plume_Temperature}
\end{tabular}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[height=4in]{SCRIPT_FIGURES/ScatterPlots/Entrainment}
