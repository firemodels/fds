...
INTEGER, PARAMETER :: IBM_MAXVERTS_FACE  =192 ! Size definition parameter. Max number of vertices per Cartesian Face.
INTEGER, PARAMETER :: IBM_MAXCEELEM_FACE = IBM_MAXVERTS_FACE ! Size definition parameter. Max segments per face.
INTEGER, PARAMETER :: IBM_MAXCFELEM_FACE =192 ! Size definition parameter. Max number of cut faces per Cartesian Face.
