...
unknown factors in unfamiliar routes might increase the risk of safe egress, evacuees usually prefer to use familiar exit routes rather than unfamiliar routes.  For this reason, it has been found that emergency exits are used rarely in many evacuation events, and they are actually unfamiliar but better choices.   
