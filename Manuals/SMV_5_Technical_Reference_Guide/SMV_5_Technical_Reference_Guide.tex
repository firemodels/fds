...
Smokeview is comprised of approximately 85,000 lines of code.  Most of it is written in C.
A small but important part is written in Fortran 90.  This part is used to read data
...
of fire modeling simulations such as FDS.  This report documented many of the technical algorithms used to visualize fire modeling data.
Future work with Smokeview then involves adding or improving visualization algorithms that allow one to provide more and better insight.  This work will involve improving the realism and accuracy of the smoke and fire visualization by using more physics to implement the visualization algorithms
such as using the gas temperature within the fire as an indicator of color.
