...
INTEGER :: NP,NXP,IZERO,LU,CUTCELL_COUNT,GEOM_TYPE,OWNER_INDEX,VERSION,NV,NF,NVO,DUMMY_INTEGER
TYPE (MESH_TYPE), POINTER :: M
...
G => GEOMETRY(N)
   IF (TRIM(GEOMETRY(N)%GEOC_FILENAME)=='null' .OR. T==0.0) CYCLE
   ...
   GEOC_CHECK_LOOP: DO I=1,30
      ...
      READ(LU_GEOC) OWNER_INDEX     ! 1 - written by Abq, 0 - already read by FDS
      WRITE(6,*) OWNER_INDEX
   ...
   IF (OWNER_INDEX==1) THEN
      ...
      OWNER_INDEX=0.0
      WRITE(LU_GEOC) OWNER_INDEX     ! 1 - written by Abq, 0 - already read by FDS
      CLOSE(LU_GEOC)
      CALL WRITE_GEOM(T)
   ENDIF 
