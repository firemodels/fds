...
SELECT CASE(TASK_NUMBER)
   ...
   CASE(1)
      ...
      ALLOCATE(REAL_BUFFER_5(0:N_SPECIES+N_TRACKED_SPECIES,NMESHES))
...
DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
   ...
   REAL_BUFFER_13(18,NM)= MESHES(NM)%MIX_TIME( MESHES(NM)%ICFL  ,MESHES(NM)%JCFL  ,MESHES(NM)%KCFL  )
ENDDO
