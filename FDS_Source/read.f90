...
REAL(EB) :: MASS_FRACTION_0,MW,SIGMALJ,EPSILONKLJ,VISCOSITY,CONDUCTIVITY,DIFFUSIVITY,MASS_EXTINCTION_COEFFICIENT, &
            SPECIFIC_HEAT,SPECIFIC_ENTHALPY,REFERENCE_TEMPERATURE,XVAP,FLD_IRR,FIC_IRR
...
NAMELIST /SPEC/ MASS_FRACTION_0,MW,FYI,ID,SIGMALJ,EPSILONKLJ,CONDUCTIVITY,VISCOSITY,DIFFUSIVITY,ABSORBING,BACKGROUND, &
                MASS_EXTINCTION_COEFFICIENT,FORMULA,SPECIFIC_HEAT,SPECIFIC_ENTHALPY,REFERENCE_TEMPERATURE,SMIX_COMPONENT_ONLY, &
                HUMIDITY,FLD_IRR,FIC_IRR
...
SPEC_READ_LOOP: DO N=1,N_SPEC_READ
   ...
   SS%EPSK                        = EPSILONKLJ
   SS%FIC_CONCENTRATION           = FIC_IRR
   SS%FLD_LETHAL_DOSE             = FLD_IRR
   SS%ID                          = ID
...
NAMELIST /SMIX/ BACKGROUND,ID,SPEC_ID,MASS_FRACTION,MASS_FRACTION_0,VOLUME_FRACTION
