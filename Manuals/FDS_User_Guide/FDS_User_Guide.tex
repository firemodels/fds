...
\item The mass of the object is based on the densities of all material components ({\ct MATL}), but it is only consumed by mass fluxes of
...
check that the released mass and the integrated burning rate are
...
Modeling the burning of real materials can be very complicated. Undoubtedly, the {\ct SURF} and {\ct MATL} lines in the
