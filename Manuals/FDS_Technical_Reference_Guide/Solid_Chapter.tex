...
\be
\dot{m}_\alpha'' = h_{\rm m,\alpha} \, \rho_{\rm film} \, \ln \left( 1+B \right) \left( Y_{\alpha,{\rm film}}+\frac{Y_{\alpha,{\rm film}}-Y_{\alpha,{\rm gas}}}{B} \right) \quad ; \quad B=\frac{\sum_\alpha (Y_{\alpha,{\rm film}}-Y_{\alpha,{\rm gas}})}{1-\sum_\alpha Y_{\alpha,{\rm film}}}
\ee
$h_{\rm m,\alpha}$ is the mass transfer coefficient, $\rho_{\rm film}$ is the density within the thin surface layer, $B$ is the Spalding mass transfer number, $Y_{\alpha,{\rm film}}$ is the mass fraction of component $\alpha$ in the thin surface layer, and $Y_{\alpha,{\rm gas}}$ is the mass fraction of component $\alpha$ beyond the thin surface layer. The composition of the thin surface layer is obtained from the Clausius-Clapeyron relation for the volume fraction of component $\alpha$ in the thin surface layer\footnote{According to Raoult's law, the partial pressure of a component above a mixture of liquids is proportional to its mole fraction in solution and its saturated vapor pressure.}:
\be 
   X_{\alpha,{\rm film}} = X_{\alpha,{\rm liq}} \, \exp \left[ -\frac{ h_{\rm v,\alpha} W_{\alpha}}\R \left(\frac{1}{T_{\rm s}}-\frac{1}{T_{\rm b,\alpha}} \right) \right]  \quad ; \quad
   Y_{\alpha,{\rm film}} = \frac{X_{\rm \alpha,film} W_{\alpha} }{\sum_{\alpha'} X_{\rm \alpha',film} W_{\alpha'} } 
   \label{CC_liquid}
\ee
Here $X_{\alpha,{\rm liq}}$ is the volume fraction of component $\alpha$ in the liquid, $h_{\rm v,\alpha}$ is its heat of vaporization, $W_{\rm \alpha}$ is its molecular weight, $T_{\rm b,\alpha}$ is its boiling temperature, and $T_{\rm s}$ is the surface temperature.  The mass transfer coefficient is given by
\be
h_{\rm m,\alpha}= \frac{\SH \, D_{\alpha}}{L} \quad ; \quad \SH=0.037~\SC^{\frac{1}{3}} \RE^{\frac{4}{5}} \quad ; \quad {\rm Sc}=0.6 \quad ; \quad \RE= \frac{\rho~||\bu||~L}{\mu}
\ee
Sh is the Sherwood number, $D_\alpha$ is the gas phase diffusivity of species $\alpha$. The Reynolds number is calculated based on conditions in the gas phase grid cell adjacent to the surface. The length scale, $L$, is 1~m for a liquid pool unless specified otherwise.
