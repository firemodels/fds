   ...
   INTEGRATOR_SELECT: SELECT CASE (COMBUSTION_ODE_SOLVER)
      ...
      CASE (EXPLICIT_EULER) ! Simple chemistry
         ...
         CALL FIRE_FORWARD_EULER(ZZ_MIXED_NEW,ZZ_MIXED,ZZ_UNMIXED,ZETA,ZETA_0,DT_SUB,TMP_MIXED,TMP_UNMIXED,RHO_HAT,&
                                 CELL_MASS,TAU_MIX,PBAR_0,DELTA,VEL_RMS,EXTINCT,Q_REAC_SUB)
      ...
      CASE (RK2_RICHARDSON) ! Finite-rate (or mixed finite-rate/fast) chemistry
         ...
         RICH_EX_LOOP: DO RICH_ITER = 1,RICH_ITER_MAX
            ...
            CALL FIRE_RK2(A1,ZZ_MIXED,ZZ_UNMIXED,ZETA,ZETA_0,DT_SUB,1,TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,PBAR_0, &
                          DELTA,VEL_RMS,EXTINCT,Q_REAC_1)
            CALL FIRE_RK2(A2,ZZ_MIXED,ZZ_UNMIXED,ZETA,ZETA_0,DT_SUB,2,TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,PBAR_0, &
                          DELTA,VEL_RMS,EXTINCT,Q_REAC_2)
            CALL FIRE_RK2(A4,ZZ_MIXED,ZZ_UNMIXED,ZETA,ZETA_0,DT_SUB,4,TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,PBAR_0, &
...
SUBROUTINE FIRE_FORWARD_EULER(ZZ_OUT,ZZ_IN,ZZ_UNMIXED,ZETA_OUT,ZETA_IN,DT_LOC,TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,&
                              PBAR_0,DELTA,VEL_RMS,EXTINCT,Q_REAC_LOC)
USE COMP_FUNCTIONS, ONLY:SHUTDOWN
...
REAL(EB), INTENT(INOUT) :: TMP_MIXED,Q_REAC_LOC(1:N_REACTIONS)
...
REAL(EB) :: ZZ_0(1:N_TRACKED_SPECIES),ZZ_NEW(1:N_TRACKED_SPECIES),DZZ(1:N_TRACKED_SPECIES),UNMIXED_MASS_0(1:N_TRACKED_SPECIES),&
            ...
            TOTAL_MIXED_MASS_0,Q_REAC_OUT(1:N_REACTIONS)
INTEGER :: SR
...
IF (ANY(REACTION(:)%FAST_CHEMISTRY)) THEN
   DO SR = 0,N_SERIES_REACTIONS
      CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,INFINITELY_FAST,PBAR_0,DELTA,VEL_RMS,EXTINCT,Q_REAC_OUT)
      ...
      ZZ_0 = ZZ_NEW
      Q_REAC_LOC = Q_REAC_LOC + Q_REAC_OUT*BOUNDEDNESS_CORRECTION*TOTAL_MIXED_MASS
   ENDDO
ENDIF

IF (.NOT.ALL(REACTION(:)%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,FINITE_RATE,PBAR_0,DELTA,VEL_RMS,EXTINCT,Q_REAC_OUT)
   ZZ_NEW = ZZ_0 + DZZ
...
SUBROUTINE REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_0,TMP_0,KINETICS,PBAR_0,DELTA,VEL_RMS,EXTINCT,Q_REAC_OUT)
...
KINETICS_SELECT: SELECT CASE(KINETICS)
   ...
   CASE(INFINITELY_FAST)
      REACTION_LOOP_1: DO I=1,N_REACTIONS
         ...
         Q_REAC_OUT(I) = RN%HEAT_OF_COMBUSTION*DZ_F
