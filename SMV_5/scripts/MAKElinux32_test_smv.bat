...
plink %svn_logon% %scriptdir%/make_smv_linux32test.csh %smv_revision%

echo downloading compilation results for 32 bit test Linux Smokeview
pscp %svn_logon%:%bindir%/make_intel_linux_test_32.out %svn_root%\SMV_5\for_bundle\to_google\make_intel_linux_test_32.out
