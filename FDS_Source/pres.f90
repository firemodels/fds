...
!$    SHARED(N_EXTERNAL_WALL_CELLS,IJKW,PRESSURE_BC_INDEX,BXS,BXF,BYS,BYF,BZS,BZF,HX,HY,HZ,FVX,FVY,FVZ,DUWDT, &
!$           IBP1,JBP1,KBP1, &
!$           BOUNDARY_TYPE,PREDICTOR,CORRECTOR,RFODT,UWP,U,V,W,US,VS,WS,IBAR,JBAR,KBAR,DX,DY,DZ, &
!$           DUUDT,DVVDT,DWWDT,HP, &
!$           OMESH,MESHES,WALL_WORK1, &
!$           VENT_INDEX,VENTS,TW,T_BEGIN,T,DUMMY,UU,VV,WW,RHO_F,KRES,H0, &
!$           IPS,CYLINDRICAL,R,RDX,RDY,RDZ,RRN,DDDT,PRHS,BXST,BXFT,BYST,BYFT,BZST,BZFT)

!$OMP DO SCHEDULE(STATIC) &
!$    PRIVATE(IW,I,J,K,IOR,DUUDT,DVVDT,DWWDT,NOM,H_OTHER,KKO,JJO,IIO, &
!$            N_INT_CELLS,DX_OTHER,DY_OTHER,DZ_OTHER,VT,TSI,TIME_RAMP_FACTOR,P_EXTERNAL) 
...
!$OMP PARALLEL DEFAULT(NONE) &
!$    SHARED(IPS,KBAR,JBAR,IBAR,HP,PRHS, &
!$           LBC,MBC,NBC,DXI,DETA,DZETA,BXS,BXF,BYS,BYF,BZS,BZF,IBP1,JBP1,KBP1,EVACUATION_ONLY,NM)
