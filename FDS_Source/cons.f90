...
INTEGER, PARAMETER :: NULL_VELOCITY_BC=0,SPECIFIED_VELOCITY=1,WALL_MODEL=2,FREE_SLIP_BC=3, &
                      NO_SLIP_BC=4,INTERPOLATED_VELOCITY_BC=6                               ! Velocity BC
...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,MIXTURE_FRACTION=.FALSE., &
           BAROCLINIC,PREDICTOR,CORRECTOR,APPEND,DROPLET_FILE=.FALSE.,RESTART,SUPPRESSION=.TRUE.,SUPPRESSION_SEARCH=.TRUE., &
           CO_PRODUCTION=.FALSE.,SOOT_DEPOSITION=.FALSE.,ACCUMULATE_WATER,RECOUNT_DRIP,WRITE_XYZ=.FALSE., &
           ...
           ALLOW_ZONE_BREAKS=.TRUE.,CHECK_KINETIC_ENERGY=.FALSE.,PROJECTION=.FALSE., &
           FDS6=.FALSE.,ALMS=.FALSE.,VIRTUAL_PARTICLES=.FALSE.,SECONDARY_BREAKUP=.FALSE.,COMBUSTION2=.FALSE.
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,NCGC,PERIODIC_TEST=0,DSMAG_FREQ=1,FISHPAK_BC(3)=-1,ALMS_MAX_IT=3
...
INTEGER :: NSTRATA,N_ACTUATED_SPRINKLERS=0
INTEGER, PARAMETER :: NDC=1000
LOGICAL :: POROUS_FLOOR=.TRUE.,ALLOW_UNDERSIDE_DROPLETS=.FALSE.

! Particles and Droplets
 
INTEGER :: MAXIMUM_DROPLETS,N_PART,PARTICLE_TAG,N_EVAC,N_EVAP_INDICIES=0,WATER_PART_INDEX=0
REAL(EB) :: FLUXMAX
