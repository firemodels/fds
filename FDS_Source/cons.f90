...
LOGICAL :: LES,DNS,RADIATION,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           MEAN_FORCING(3)=.FALSE.,USE_MAX_FILTER_WIDTH=.FALSE.,CHECK_GR=.FALSE.,CHECK_HT=.FALSE., &
           WFDS=.FALSE.,PATCH_VELOCITY=.FALSE.,OVERWRITE=.TRUE., &
           INIT_HRRPUV = .FALSE.,NEW_COMBUSTION=.TRUE.,WFDS_FE=.FALSE.,WFDS_BNDRYFUEL=.FALSE., &
           ENTHALPY_TRANSPORT=.FALSE.,DISSIPATION_SOURCE=.FALSE.
...
REAL(EB) :: MW_AIR=28.849_EB,MW_N2,MW_O2,MW_CO2,MW_H2O,MW_CO,MW_H2,&
