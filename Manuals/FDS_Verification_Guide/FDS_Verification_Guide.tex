...
In the test case the thickness of the layer is 50 cm, and the temperature boundary condition is implemented as
convection to $T_0$ ambient with very high convection coefficient. For material properties, we choose $\rho_s = \rho_l =$ 1000 kg/m$^3$, 
