...
NAMELIST /MISC/ AEROSOL_AL2O3,AEROSOL_SCRUBBING,AGGLOMERATION,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,&
                ...
                BAROCLINIC,BNDF_DEFAULT,CC_IBM,CC_SLIPIBM_VELO,CCVOL_LINK,CC_ZEROIBM_VELO,C_DEARDORFF,&
                ...
                HUMIDITY,HVAC_LOCAL_PRESSURE,HVAC_MASS_TRANSPORT,HVAC_PRES_RELAX,&
                IBLANK_SMV,MAXIMUM_GEOMETRY_FACES,MAXIMUM_GEOMETRY_ZVALS,MAXIMUM_VISIBILITY,MAX_LEAK_PATHS,MPI_TIMEOUT,&
                NEAR_WALL_TURBULENCE_MODEL,NEW_VEG_LEVEL_SET,&
                ...
                POROUS_FLOOR,PR,PROCESS_CUTCELLS,PROCESS_ALL_MESHES,PROFILING,&
                ...
                TAU_DEFAULT,TENSOR_DIFFUSIVITY,TERRAIN_CASE,TERRAIN_IMAGE,TEST_FILTER_QUADRATURE,TEXTURE_ORIGIN,&
                ...
                WIND_ONLY,&
                DNS,RADIATION,RESEARCH_MODE,STRATIFICATION,SUPPRESSION,SURF_DEFAULT ! Backward compatibility
...
NAMELIST /PROP/ ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E,&
                ...
                PARTICLES_PER_SECOND,PARTICLE_VELOCITY,PART_ID,&
                PDPA_END,PDPA_HISTOGRAM,PDPA_HISTOGRAM_CUMULATIVE,PDPA_HISTOGRAM_LIMITS,&
