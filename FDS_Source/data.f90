...
SELECT CASE (SPEC_ID_USE)
   ...
   CASE('AMMONIA') ! NASA/TP—2002-211556
      TE = MIN(6000._EB,MAX(TE,200._EB))
      IF (TE<1000._EB) THEN
         CP = -76812.2615_EB*TE**(-2)+1270.951578_EB/TE+-3.89322913_EB+0.02145988418_EB*TE+-0.00002183766703_EB*TE**2+0.00000001317385706_EB*TE**3+-3.33232206E-12_EB*TE**4
      ELSE
         CP = 2452389.535_EB*TE**(-2)+-8040.89424_EB/TE+12.71346201_EB+-0.000398018658_EB*TE+0.0000000355250275_EB*TE**2+2.53092357E-12_EB*TE**3+-3.32270053E-16_EB*TE**4
      ENDIF
