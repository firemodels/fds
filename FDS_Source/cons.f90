...
LOGICAL :: LES,DNS,RADIATION,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           INCLUDE_NUMERICAL_DIFFUSION=.FALSE.,GRAV_VISC=.FALSE.,HISTOGRAM_FILE=.FALSE.
...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: PART_CLOCK,CORE_CLOCK,SLCF_CLOCK,SL3D_CLOCK, &
                                       PL3D_CLOCK,BNDE_CLOCK,BNDF_CLOCK,ISOF_CLOCK,PROF_CLOCK
...
INTEGER, ALLOCATABLE, DIMENSION(:,:) :: LU_SLCF,LU_BNDE,LU_BNDF,LU_ISOF,LU_SMOKE3D,LU_BNDF_SLCF
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_BNDE,FN_BNDF,FN_ISOF,FN_SMOKE3D,FN_BNDF_SLCF
