...
! VARIABLE PASSED IN
REAL(EB), DIMENSION(:,:), INTENT(IN) :: TRANSITION_MATRIX ! SQUARE MATRIX
...
REAL(EB), DIMENSION(:,:), ALLOCATABLE :: TRANSITION_MATRIX
...
! Added by Hadi Bordbar Correlations of Change and Charalampopoulos
