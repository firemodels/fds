...
USE MANUFACTURED_SOLUTIONS, ONLY: UF_MMS,WF_MMS,VD2D_MMS_U_SRC,VD2D_MMS_V_SRC,VD2D_MMS_RHO_SRC,VD2D_MMS_U_SRC_2,VD2D_MMS_V_SRC_2
INTEGER, INTENT(IN) :: NM
REAL(EB), INTENT(IN) :: T
INTEGER :: I,J,K
...
DO K=1,KBAR
   DO J=1,JBAR
      DO I=0,IBAR
         ...
         FVX(I,J,K) = FVX(I,J,K) - RRHO*( VD2D_MMS_U_SRC_2(X(I),ZC(K),T) - UU(I,J,K)*VD2D_MMS_RHO_SRC(X(I),ZC(K),T) )
      ENDDO 
   ENDDO   
ENDDO
...
DO K=0,KBAR
   DO J=1,JBAR
      DO I=1,IBAR
         ...
         FVZ(I,J,K) = FVZ(I,J,K) - RRHO*( VD2D_MMS_V_SRC_2(XC(I),Z(K),T) - WW(I,J,K)*VD2D_MMS_RHO_SRC(XC(I),Z(K),T) )
      ENDDO 
   ENDDO   
ENDDO
...
!$OMP         RHO_WALL,MU_WALL,OM,VEL_OTHER,WGT,OMW,ICDO,MU_DUIDXJ,DUIDXJ,MU_DUIDXJ_USE,DUIDXJ_USE, &
...
IF (IMMERSED_BOUNDARY_METHOD==2 .AND. N_GEOM>0) THEN
   PP => WORK1
   UBAR => WORK2
   VBAR => WORK3
   WBAR => WORK4
