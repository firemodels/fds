...
LOGICAL :: A_TMP,L_TMP,CHECK_ATOM_BALANCE,REVERSIBLE
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,BETA_EDC,C,CHECK_ATOM_BALANCE,CO_PRODUCTION,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                HUMIDITY,ID,IDEAL,N,NU,N_S,N_T,O,ODE_SOLVER,REAC_ATOM_ERROR,REAC_MASS_ERROR,REVERSIBLE,SMIX_ID,SOOT_DEPOSITION,&
                SOOT_H_FRACTION,SOOT_YIELD,SPEC_ID,SUPPRESSION,TAU_CHEM,TAU_FLAME,THRESHOLD_TEMPERATURE,Y_CO2_INFTY,Y_O2_INFTY,&
                Y_P_MIN_EDC,TOL_INT
