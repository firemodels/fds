...
\Huge \flushright{Fire Dynamics Simulator (Version 5) \\ Technical Reference Guide \\ (Draft: July 31, 2007)}
...
m_l \; c_l \; \frac{dT_l}{dt} & = &   A_l \, h   \, (T_g-T_l) + \dq_r + \frac{dm_l}{dt} \; h_v  \end{eqnarray}
...
$\rho$ is the gas density, $c_l$ is the liquid specific heat, $h$ is the heat transfer coefficient, $\dq_r$ is the rate of radiative heating of the droplet, and $h_v$ is the latent heat of vaporization of the
