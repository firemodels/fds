...
TYPE (BOUNDARY_ONE_D_TYPE_TYPE), ALLOCATABLE, DIMENSION(:) :: OD_DUMMY
...
USE GLOBAL_CONSTANTS, ONLY: THERMALLY_THICK,TMPM,SIGMA,TMPA4,RSUM0,TMPA,RHOA,N_TRACKED_SPECIES
...
ALLOCATE(ONE_D%ZZ_G(SF%ONE_D_REALS_ARRAY_SIZE(8))) ; ONE_D%ZZ_G = SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%ZZ0
IF (ALLOCATED(ONE_D%ZZ_F)) DEALLOCATE(ONE_D%ZZ_F)
ALLOCATE(ONE_D%ZZ_F(SF%ONE_D_REALS_ARRAY_SIZE(9))) ; ONE_D%ZZ_F = SPECIES_MIXTURE(1:N_TRACKED_SPECIES)%ZZ0
...
TYPE(MESH_TYPE), POINTER :: M=>NULL()
TYPE(BOUNDARY_ONE_D_TYPE_TYPE), POINTER :: ONE_D=>NULL()
TYPE(SURFACE_TYPE), POINTER :: SF=>NULL()
TYPE (MATERIAL_TYPE),POINTER :: ML=>NULL()
