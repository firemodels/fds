   ...
   DO K=0,KBAR
      DO J=0,JBAR
         DO I=0,IBAR
            ...
            KN = MU_G*KN_FAC/SQRT(PRES_G*RHO_G)
            CN = CUNNINGHAM(KN)
...
REAL(EB) :: U_THERM,U_TURB,TGAS,TWALL,MUGAS,Y_AEROSOL,RHOG,ZZ_GET(1:N_TRACKED_SPECIES),YDEP,K_AIR,TMP_FILM,KN,ALPHA,DTMPDX,&
            TAU_PLUS,TAU_PLUS_C,VEL_W,U2,V2,W2,U_GRAV,D_SOLID,MW_RATIO
...
SMIX_LOOP: DO N=1,N_TRACKED_SPECIES
   ...
   WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
      ...
      ENDIF
      IF (THERMOPHORETIC_DEPOSITION) U_THERM = CS2*(ALPHA+CT*KN)*CUNNINGHAM(KN)/((1._EB+CM3*KN)*(1+2*ALPHA+CT2*KN)) * &
