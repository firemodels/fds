...
SUBROUTINE GET_GEOMVALS(NM,CC_FACE_CENTERED,CC_CELL_CENTERED,SLICETYPE, &
                        I1, I2, J1, J2, K1, K2,NFACES, NFACES_CUTCELLS, VALS,IND,Y_INDEX,Z_INDEX,PART_INDEX)
USE COMPLEX_GEOMETRY
USE PHYSICAL_FUNCTIONS, ONLY: GET_MASS_FRACTION

! copy data from QQ array into VALS(1:NFACES)

INTEGER, INTENT(IN) :: NM, I1, I2, J1, J2, K1, K2, IND,Y_INDEX,Z_INDEX,PART_INDEX
...
SUBROUTINE DUMP_SLICE_GEOM_DATA(NM,FUNIT_DATA,FUNIT_BOUNDS,CC_FACE_CENTERED,CC_CELL_CENTERED,SLICETYPE, &
                                HEADER,STIME,I1,I2,J1,J2,K1,K2,IND,Y_INDEX,Z_INDEX,PART_INDEX,DEBUG)
CHARACTER(*), INTENT(IN) :: SLICETYPE
INTEGER, INTENT(IN) :: NM, FUNIT_DATA, FUNIT_BOUNDS, HEADER, I1, I2, J1, J2, K1, K2, IND, &
                       Y_INDEX, Z_INDEX, PART_INDEX, DEBUG
      ...
      ELSE
         ...
         ! geometry and data file at first time step
            ...
            CALL DUMP_SLICE_GEOM_DATA(NM,LU_SLCF(IQ,NM),LU_SLCF(IQ+N_SLCF_MAX,NM),SL%FACE_CENTERED,SL%CELL_CENTERED,SL%SLICETYPE, &
                                      1,STIME,I1,I2,J1,J2,K1,K2,IND,Y_INDEX,Z_INDEX,PART_INDEX,0)
         ELSE
         ! data file at subsequent time steps
            ...
            CALL DUMP_SLICE_GEOM_DATA(NM,LU_SLCF(IQ,NM),LU_SLCF(IQ+N_SLCF_MAX,NM),SL%FACE_CENTERED,SL%CELL_CENTERED,SL%SLICETYPE, &
                                      0,STIME,I1,I2,J1,J2,K1,K2,IND,Y_INDEX,Z_INDEX,PART_INDEX,0)
         ENDIF
         CLOSE(LU_SLCF(IQ,NM))
   ...
   FILE_LOOP2 : DO NF=1,N_BNDF
      ...
      IF (ABS(STIME-T_BEGIN)<TWO_EPSILON_EB) THEN
         ...
         CALL DUMP_SLICE_GEOM_DATA(NM,LU_BNDG(NF,NM),LU_BNDG(NF+N_BNDF,NM), &
                                   ...
                                   IND,BF%Y_INDEX,BF%Z_INDEX,BF%PART_INDEX,BF%DEBUG)
      ELSE
         ! data file at subsequent time steps
