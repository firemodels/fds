...
USE GLOBAL_CONSTANTS, ONLY: PREDICTOR,GVEC,SOLID_BOUNDARY,NULL_BOUNDARY,OPEN_BOUNDARY,INTERPOLATED_BOUNDARY,&
...
SMIX_LOOP: DO N=1,N_TRACKED_SPECIES
   ...
   WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
      ...
      IF (WC%BOUNDARY_TYPE/=SOLID_BOUNDARY .OR. ONE_D%NODE_INDEX /= 0) CYCLE WALL_CELL_LOOP
...
DTMPDX = ONE_D%HEAT_TRANS_COEF*(TMP_G-ONE_D%TMP_F)/K_G
...
WALL_CELL_LOOP: DO IW = 1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   M_SOOT = ONE_D%AWM_AEROSOL(SS%AWM_INDEX)*ONE_D%AREA
   IIG = BC%IIG
   JJG = BC%JJG
   KKG = BC%KKG
   ...
   DO NS=1,N_TRACKED_SPECIES
      ...
      ELSE
         ...
         DELTA_H_G = CPBAR2*ONE_D%TMP_F-CPBAR*TMP_G
