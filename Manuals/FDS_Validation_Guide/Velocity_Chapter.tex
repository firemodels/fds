...
The figures on the following pages display radial profiles of measured and predicted mean and rms vertical and horizontal velocities above a 30~cm diameter methanol pool fire. Each plot displays radial profiles at heights ranging from 2~cm to 30~cm. Time resolved velocity measurements were performed using a two component laser doppler anemometer.
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms vertical velocity, 2~cm to 8~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms vertical velocity, 10~cm to 16~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms vertical velocity, 18~cm to 30~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms horizontal velocity, 2~cm to 8~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms horizontal velocity, 10~cm to 16~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms horizontal velocity, 18~cm to 30~cm above the burner]
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of $u'w'$, 2~cm to 12~cm above the burner]
{Waterloo Methanol, radial profiles of $u'w'$, 2~cm to 12~cm above the burner.}
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of $u'w'$, 14~cm to 30~cm above the burner]
{Waterloo Methanol, radial profiles of $u'w'$, 14~cm to 30~cm above the burner.}
