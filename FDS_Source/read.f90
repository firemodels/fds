...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,PRESSURE_RELAX_FACTOR,RELAXATION_FACTOR,FYI, &
                ...
                MEAN_FORCING,RFAC_FORCING,H_EDDY,H_LOGLAW,H_CHILTON_COLBURN,LIMITING_DT_RATIO, &
                NOBIAS,VAN_DRIEST,HRRPUVCUT_MAX,EMBEDDED_MESH,RUN_AVG_FAC,THERMOPHORETIC_DEPOSITION,TURBULENT_DEPOSITION, &
                VEG_LEVEL_SET,CP_FTMP,HRRPUV_MAX_SMV,EXTINCTION2
...
NAMELIST /REAC/ E,BOF,HEAT_OF_COMBUSTION,FYI,FUEL,OXIDIZER,EPUMO2,ID, N_S,&
                ...
                EDDY_DISSIPATION,C_EDC,EDC_ODE,HRRPUA_SHEET,HRRPUA_SHEET_EXPONENT,HRRPUV_AVERAGE,AIT, &
                EDDY_BREAK_UP,C_EBU
...
IF (EDDY_BREAK_UP) THEN
   EDDY_DISSIPATION=.FALSE.
...
CHARACTER(30) :: PART_ID,RAMP_MF(0:MAX_SPECIES),RAMP_Q,RAMP_V,RAMP_T,MATL_ID(MAX_LAYERS,MAX_MATERIALS),&
                 PROFILE,BACKING,GEOMETRY,NAME_LIST(MAX_MATERIALS),EXTERNAL_FLUX_RAMP,RAMP_PART
...
REAL(EB) :: VEGETATION_CDRAG,VEGETATION_CHAR_FRACTION,VEGETATION_ELEMENT_DENSITY,VEGETATION_HEIGHT,VEGETATION_LOAD, &
            VEGETATION_LSET_IGNITE_TIME,VEGETATION_MOISTURE,VEGETATION_SVRATIO 
LOGICAL :: VEGETATION,VEGETATION_NO_BURN
NAMELIST /SURF/ TMP_FRONT,TMP_INNER,THICKNESS,MASS_FRACTION,VEL,VEL_T,NPPC, &
                ...
                RAMP_PART,TAU_PART,EMISSIVITY_BACK, &
                VEGETATION,VEGETATION_CDRAG,VEGETATION_CHAR_FRACTION,VEGETATION_ELEMENT_DENSITY,VEGETATION_HEIGHT, &
                VEGETATION_LSET_IGNITE_TIME,VEGETATION_LOAD,VEGETATION_MOISTURE,VEGETATION_NO_BURN,VEGETATION_SVRATIO, &
                VEGETATION_LAYERS,CONVECTION_LENGTH_SCALE
...
VEGETATION_ELEMENT_DENSITY = 512._EB
VEGETATION_HEIGHT          = 0.50_EB
VEGETATION_LOAD            = 0.30_EB
VEGETATION_LAYERS          = 0
VEGETATION_MOISTURE        = 0.06_EB
VEGETATION_SVRATIO         = 12000_EB
...
NAMELIST /PRES/ VELOCITY_TOLERANCE,MAX_PRESSURE_ITERATIONS,PRESSIT_RELAX_FACTOR, &
