...
! static geometry
  ...
  IF (N_FACE_S>0)  WRITE(LU_GEOM) (FACE1_S(I),FACE2_S(I),FACE3_S(I),SURF_S(I),I=1,N_FACE_S)
  IF (N_FACE_D>0)  WRITE(LU_GEOM) (FACE1_D(I),FACE2_D(I),FACE3_D(I),SURF_D(I),I=1,N_FACE_D)
...
! dynamic geometry
  ...
  IF(GEOM_TYPE.EQ.0)THEN
    ...
    IF (N_FACE_D>0) WRITE(LU_GEOM) (FACE1_D(I),FACE2_D(I),FACE3_D(I),SURF_D(I),I=1,NFACE_D)
