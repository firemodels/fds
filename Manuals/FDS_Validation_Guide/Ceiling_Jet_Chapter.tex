...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/NRCC_Smoke_Tower/BK-R_Fire_Room_Ceiling_Jet} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/NRCC_Smoke_Tower/CMP-R_Fire_Room_Ceiling_Jet} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/NRCC_Smoke_Tower/CLC-I-R_Fire_Room_Ceiling_Jet} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/NRCC_Smoke_Tower/CLC-II-R_Fire_Room_Ceiling_Jet} 
\end{tabular*}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/UL_NFPRF/UL_NFPRF_P-1_Actuations} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/UL_NFPRF/UL_NFPRF_P-2_Actuations} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/UL_NFPRF/UL_NFPRF_P-3_Actuations} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/UL_NFPRF/UL_NFPRF_P-4_Actuations} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/UL_NFPRF/UL_NFPRF_P-5_Actuations} &
\end{tabular*}
\label{UL_NFPRF_3_1}
\end{figure}
