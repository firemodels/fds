...
INTEGER, POINTER, DIMENSION(:) :: GAS_CELL_RAD_DEVC
...
TYPE PROPERTY_TYPE
   REAL(EB) :: BEAD_DIAMETER,BEAD_EMISSIVITY,RTI,ACTIVATION_TEMPERATURE,ACTIVATION_OBSCURATION, &
               ...
               CABLE_DIAMETER,CABLE_FAILURE_TEMPERATURE,CABLE_MASS_PER_LENGTH
...
TYPE DEVICE_TYPE
   REAL(EB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INSTANT_VALUE,VALUE,DEPTH,TMP_L,Y_C,OBSCURATION,DELAY,ROTATION,&
               SETPOINT, T_CHANGE=1000000._EB,BYPASS_FLOWRATE,DT,TOTAL_FLOWRATE,FLOWRATE,SUM_1=0._EB,SUM_2=0._EB
