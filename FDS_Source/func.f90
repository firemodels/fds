...
WC%VELOCITY_ERROR     => OS%REALS(16,STORAGE_INDEX) ; IF (NEW) WC%VELOCITY_ERROR = 0._EB

I1 = N_WALL_SCALAR_REALS ; I2 = I1 + SF%WALL_REALS_ARRAY_SIZE(1) - 1  ; WC%A_LP_MPUA(1:)       => OS%REALS(I1:I2,STORAGE_INDEX)
