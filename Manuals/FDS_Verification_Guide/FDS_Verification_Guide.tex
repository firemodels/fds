...
A lead radiation shield with a thickness of 1 mm is placed in between a ceiling set to 500~$^\circ$C and a floor set to 20~$^\circ$C. The box has dimensions of 10 m x 0.1 m x 1 m. The emissivity, $\varepsilon_{3}$, of the lead shield is 0.48 on both sides.  At t = 400 s, the shield will be removed to exihibit how the heat flux acts correctly without the shield. 

Using the following formula, we determined an analytical solution for the steady state heat flux at the floor of the box:
\be
   q_{12}' = \frac{\sigma(T_{1}^{4}-T_{2}^{4})}{\frac{1}{\varepsilon_1}+\frac{1}{\varepsilon_2}+2(\frac{1-\varepsilon_3}{\varepsilon_3})}
\ee
where $\sigma$ is the Stefan-Boltzmann constant, $T_{1}$ and $T_{2}$ are the respective temperatures of the ceiling and floor, and $\varepsilon_1$, $\varepsilon_2$, and $\varepsilon_3$ are the emissivities for the ceiling, floor, and lead shield, respectively. If we remove the possibility of heat conduction and let the emissivity of the ceiling and floor be 1, our analytical solution states that the steady state heat flux should be $q_{12}' =$ 4.76 kW/m$^2$.  As shown in Fig.~\ref{radiation_shield_plot_flux}, the steady state heat flux at the floor of the box given by FDS, which is approximately 4.71 kW/m$^2$, agrees very well with the ideal heat flux.  This gives us a percent difference of approximately 0.96$\%$.  
\noindent
\begin{figure}[h]
\begin{center}
\includegraphics[width=3.2in]{SCRIPT_FIGURES/radiation_shield_flux}
\end{center}
\caption[Radiation Shield Test Case]{Incident Heat Flux at the floor of the box from a ceiling at a temperature of 500~$^\circ$C and a floor at 20~$^\circ$C with a lead radiation shield in between.}
\label{radiation_shield_plot_flux}
\end{figure}

When the shield was removed at t = 400 s, the heat flux jumped to and stayed at a constant 19.8 kW/m$^2$.  This is very close to the analytical solution of the heat flux without the shield, which is 20.6 kW/$^2$.  There is a 4.1$\%$ difference between the two values. 

We can also confirm that FDS determines the correct steady state temperature of the lead shield. From the knowledge of $q_{12}'$ and the fact that the heat flux from the ceiling to the shield is equal to the heat flux from the ceiling to the floor, we can determine the steady state temperature of the shield, $T_3$, using the following formula~\cite{Incropera:1}:
\be
   q_{12}' = q_{13}' = \frac{\sigma(T_{1}^{4}-T_{3}^{4})}{\frac{1}{\varepsilon_1}+\frac{1}{\varepsilon_3}-1}
\ee
We can use algebra to solve for $T_3$, which gives us 380.3~$^\circ$C. From Fig.~\ref{radiation_shield_plot_temp}, we can see that FDS properly determines the steady state temperature of the lead shield after about 350 seconds.  $T_3$ stays at around 378.8~$^\circ$C, which has a percent difference of 0.40$\%$ from the analytical solution.
\noindent
\begin{figure}[h]
\begin{center}
\includegraphics[width=3.2in]{SCRIPT_FIGURES/radiation_shield_temp}
\end{center}
\caption[Radiation Shield Test Case]{Temperature of the lead shield with the ceiling at a temperature of 500~$^\circ$C and a floor at 20~$^\circ$C.}
\label{radiation_shield_plot_temp}
\end{figure}

Clearly, at t = 400 s, the temperature of the shield dropped to zero because the shield was no longer present in the box.  
...
\begin{figure}[ht]
   \begin{center}
     ...
     \caption{\label{leak_test} \small Pressure rise in sealed compartment with leakage.}
   \end{center}
\end{figure}
...
\includegraphics[width=3.2in]{SCRIPT_FIGURES/ashrae_7_dotplot_fixed.pdf} \\
\includegraphics[width=3.2in]{SCRIPT_FIGURES/ashrae_7_dotplot_quadratic.pdf} &
\includegraphics[width=3.2in]{SCRIPT_FIGURES/ashrae_7_dotplot_table.pdf}
\end{tabular*}
