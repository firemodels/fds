...
The U.S.~Federal Aviation Administration (FAA) has sponsored experiments and modeling of smoke transport within aircraft storage compartments~\cite{FAA-AR-03-49,FAA-AR-06-21,FAA-AR-07-27}. In one set of experiments, a small tray of plastic beads produced a 5~kW fire within an empty compartment 6.7~m in length, 3.2~m in width, and 1.4~m in height. The long walls of the compartment were barrel-shaped to conform to the shape of the aircraft fuselage. The fire was placed in different locations, and measurements of gas and ceiling temperature, heat flux, gas concentration, and smoke obscuration were made at a variety of locations, mostly near the ceiling.
