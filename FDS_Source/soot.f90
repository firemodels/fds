...
CHARACTER(255), PARAMETER :: sootid='$Id: soot.f90 20650 2014-10-06 20:03:47Z mcgratta $'
CHARACTER(255), PARAMETER :: sootrev='$Revision: 20650 $'
CHARACTER(255), PARAMETER :: sootdate='$Date: 2014-10-06 16:03:47 -0400 (Mon, 06 Oct 2014) $'
...
REAL(EB) :: ZZ_GET(0:N_TRACKED_SPECIES),TMP_G,MU_G,KN,GRAV_FAC,KN_FAC
...
REAL(EB) :: KN,MFP,N0(N_PARTICLE_BINS),N1(N_PARTICLE_BINS),RHOG,TMPG,MUG,TERMINAL(N_PARTICLE_BINS),&
            FU,MOBILITY(N_PARTICLE_BINS),ZZ_GET(0:N_TRACKED_SPECIES),AM,AMT(N_PARTICLE_BINS),&
