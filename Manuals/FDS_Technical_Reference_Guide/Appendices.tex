...
\begin{equation}
\label{bc_front_3}
  -k_s \frac{T_1^{n+1}-T_0^{n+1}}{\delta x_{\frac{1}{2}}} + \frac{1}{2}hT_{s,\frac{1}{2}}^{n+1} + 4\epsilon\sigma T_{s,\frac{1}{2}}^{n+1^3} T_{s,\frac{1}{2}}^{n+1}
...
\begin{equation}
\label{T0}
  T_{s,0}^{n+1} = \underbrace{\frac{\frac{k_{s,0}}{\delta x_1}-(\frac{1}{4}h_F+2\epsilon_F \sigma T_{s,\frac{1}{2}}^{n^3})}{\frac{k_{s,0}}{\delta x_1}+(\frac{1}{4}h_F+2\epsilon_F \sigma T_{s,\frac{1}{2}}^{n^3})}}_{RFACF2} T_1^{n+1}+
 \underbrace{\frac{h_F(T_g-\frac{1}{2}T_{s,\frac{1}{2}}^n)+\dot{q}_{r,F}^{'''}+4\epsilon_F \sigma T_{s,\frac{1}{2}}^{n^4}}{\frac{k_{s,0}}{\delta x_1}+(\frac{1}{4}h_F+2\epsilon_F \sigma T_{s,\frac{1}{2}}^{n^3})}}_{QDXKF}.
\end{equation}
...
\begin{equation}
\label{TN+1}
  T_{s,N+1}^{n+1} = \underbrace{\frac{\frac{k_{s,N+1}}{\delta x_1}-(\frac{1}{4}h_B+2\epsilon_B \sigma T_{s,\frac{1}{2}}^{n^3})}{\frac{k_{s,0}}{\delta x_1}+(\frac{1}{4}h_B+2\epsilon_B \sigma T_{s,\frac{1}{2}}^{n^3})}}_{RFACB2} T_1^{n+1}+
 \underbrace{\frac{h_B(T_g-\frac{1}{2}T_{s,\frac{1}{2}}^n)+\dot{q}_{r,B}^{'''}+4\epsilon_B \sigma T_{s,\frac{1}{2}}^{n^4}}{\frac{k_{s,0}}{\delta x_1}+(\frac{1}{4}h_B+2\epsilon_B \sigma T_{s,\frac{1}{2}}^{n^3})}}_{QDXKB}.
\end{equation}
...
\label{tridiagonal_2}
\begin{split}
& A(i) = -\frac{k_{i+\frac{1}{2}}\delta t}{2(\rho_s c_s)_i}\frac{1}{R_{i-\frac{1}{2}}^I \delta x_i}\frac{R_{i}^I}{\delta x_{i+\frac{1}{2}}} \\
& B(i) = -\frac{k_{i-\frac{1}{2}}\delta t}{2(\rho_s c_s)_i}\frac{1}{R_{i-\frac{1}{2}}^I \delta x_i}\frac{R_{i-1}^I}{\delta x_{i-\frac{1}{2}}}  \\
...
& C'(1) = \frac{C(1)-B(1)\cdot QDXKF}{D(1)} \\
& \\
