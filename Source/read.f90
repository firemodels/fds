...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            DRAG_COEFFICIENT,MINIMUM_BURNOUT_TIME,DELTA_TMP_MAX,BURN_DURATION,CONE_HEAT_FLUX,HF_SMOOTHING_WINDOW,AREA_MULTIPLIER,&
...
NAMELIST /SURF/ ADIABATIC,AREA_MULTIPLIER,BACKING,BURN_AWAY,BURN_DURATION,&
                CELL_SIZE_FACTOR,COLOR,CONE_HEAT_FLUX,HF_SMOOTHING_WINDOW,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   SF%HF_SMOOTHING_WINDOW  = HF_SMOOTHING_WINDOW
