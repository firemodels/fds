...
USE MATH_FUNCTIONS, ONLY: GET_RAMP_INDEX
REAL(EB) :: CORIOLIS_VECTOR(3)=0._EB,FORCE_VECTOR(3)=0._EB
CHARACTER(LABEL_LENGTH) :: RAMP_FVX_T,RAMP_FVY_T,RAMP_FVZ_T,RAMP_U0_T,RAMP_V0_T,RAMP_W0_T,RAMP_U0_Z,RAMP_V0_Z,RAMP_W0_Z,RAMP_TMP0_Z

NAMELIST /WIND/ CORIOLIS_VECTOR,DT_MEAN_FORCING,FORCE_VECTOR,FYI,GROUND_LEVEL,LAPSE_RATE,MEAN_FORCING,&
                NEW_MOMENTUM_NUDGING,POTENTIAL_TEMPERATURE_CORRECTION,RAMP_FVX_T,RAMP_FVY_T,RAMP_FVZ_T,&
                RAMP_TMP0_Z,RAMP_U0_T,RAMP_V0_T,RAMP_W0_T,RAMP_U0_Z,RAMP_V0_Z,RAMP_W0_Z,SPONGE_LAYER_DISTANCE,&
                STRATIFICATION,U0,V0,W0
