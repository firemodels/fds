...
fprintf(fid, '%s\n', '\hline');
fprintf(fid, '%s\n', ['A      & ',num2str(VEL(1)),' & ',num2str(s(1)),' & ',num2str(f_save(1),2),' & ',num2str(f_fds_save(1,1),2),' & ',num2str(f_fds_save(2,1),2),' & ',num2str(max_error(1),2),' \\']);
fprintf(fid, '%s\n', ['B      & ',num2str(VEL(2)),' & ',num2str(s(2)),' & ',num2str(f_save(2),2),' & ',num2str(f_fds_save(1,2),2),' & ',num2str(f_fds_save(2,2),2),' & ',num2str(max_error(2),2),' \\']);
fprintf(fid, '%s\n', ['C      & ',num2str(VEL(3)),' & ',num2str(s(3)),' & ',num2str(f_save(3),2),' & ',num2str(f_fds_save(1,3),2),' & ',num2str(f_fds_save(2,3),2),' & ',num2str(max_error(3),2),' \\']);
fprintf(fid, '%s\n', ['D      & ',num2str(VEL(4)),' & ',num2str(s(4)),' & ',num2str(f_save(4),2),' & ',num2str(f_fds_save(1,4),2),' & ',num2str(f_fds_save(2,4),2),' & ',num2str(max_error(4),2),' \\']);
fprintf(fid, '%s\n', '\hline');
fprintf(fid, '%s\n', '\end{tabular}');
fclose(fid);
