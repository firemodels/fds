...
MODULE FAST_REAC_VARS
USE PRECISION_PARAMETERS

REAL(EB), PUBLIC, ALLOCATABLE, DIMENSION(:) :: RN_A,RN_E,RN_N_T,RN_RHO_E,RN_C0_EXP,RN_HEAT_OF_COMBUSTION
REAL(EB), PUBLIC, ALLOCATABLE, DIMENSION(:,:) :: RN_NU,RN_N_S,RN_THIRD_EFF,RN_DELTA_G
LOGICAL, PUBLIC, ALLOCATABLE, DIMENSION(:) :: RN_FAST,RN_REVERSE,RN_THIRD
INTEGER, PUBLIC, ALLOCATABLE, DIMENSION(:) :: RN_N_NU,RN_N_SPEC,RN_N_THIRD,RN_FUEL_SMIX_INDEX,RN_AIR_SMIX_INDEX
INTEGER, PUBLIC, ALLOCATABLE, DIMENSION(:,:) :: RN_NU_I,RN_N_S_I

END MODULE FAST_REAC_VARS