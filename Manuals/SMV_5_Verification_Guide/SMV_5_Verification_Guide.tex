...
\begin{center}
\begin{tabular}{ccc}
 \includegraphics[width=2.0in]{scriptfigures/colorbar_low}&
 \includegraphics[width=2.0in]{scriptfigures/colorbar_med}&
  \includegraphics[width=2.0in]{scriptfigures/colorbar_high}\\
 \end{tabular}
\end{center}
