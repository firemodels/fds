...
TYPE OUTPUT_QUANTITY_TYPE
   ...
   LOGICAL :: SLCF_APPROPRIATE=.TRUE.,BNDF_APPROPRIATE=.FALSE.,ISOF_APPROPRIATE=.TRUE.,PART_APPROPRIATE=.FALSE.,&
              ...
              CELL_L_REQUIRED=.FALSE.,PROF_APPROPRIATE=.FALSE.
...
OUTPUT_QUANTITY(1)%PROF_APPROPRIATE=.TRUE.
...
OUTPUT_QUANTITY(5)%PROF_APPROPRIATE=.TRUE.
...
OUTPUT_QUANTITY(434:452)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:452)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:452)%DEVC_APPROPRIATE = .TRUE.
