...
if ~exist([ddir,'fluid_part_mom_x_1.prt5'])
    display(['Error: File ' [ddir,'fluid_part_mom_x_1.prt5'] ' does not exist. Skipping case.'])
    skip_case = 1;
end
if ~exist([ddir,'fluid_part_mom_y_1.prt5'])
    display(['Error: File ' [ddir,'fluid_part_mom_y_1.prt5'] ' does not exist. Skipping case.'])
    skip_case = 1;
end
if ~exist([ddir,'fluid_part_mom_z_1.prt5'])
    display(['Error: File ' [ddir,'fluid_part_mom_z_1.prt5'] ' does not exist. Skipping case.'])
    skip_case = 1;
end
...
[STIME_X, XP_X, YP_X, ZP_X, QP_X] = read_prt5([ddir,'fluid_part_mom_x_1.prt5'],'real*4');
[STIME_Y, XP_Y, YP_Y, ZP_Y, QP_Y] = read_prt5([ddir,'fluid_part_mom_y_1.prt5'],'real*4');
[STIME_Z, XP_Z, YP_Z, ZP_Z, QP_Z] = read_prt5([ddir,'fluid_part_mom_z_1.prt5'],'real*4');
