...
INTEGER, PARAMETER :: N_Q_DOT=8,N_M_DOT=4,N_U_DOT=3
...
REAL(EB),ALLOCATABLE, DIMENSION(:,:) :: MINT,MINT_SUM,Q_DOT,Q_DOT_SUM,M_DOT,M_DOT_SUM,MOMENTUM_SUM
REAL(EB),ALLOCATABLE, DIMENSION(:,:,:) :: U_DOT,U_DOT_SUM
...
OUTPUT_QUANTITY(-100)%BNDE_APPROPRIATE = .FALSE.
