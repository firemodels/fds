...
BOUNDARY_FILES: DO NF=1,N_BNDF
   ...
   ELSE RESTART
      ...
      WRITE(LU_BNDF(NF,NM)) BF%SMOKEVIEW_LABEL
      WRITE(LU_BNDF(NF,NM)) BF%SMOKEVIEW_BAR_LABEL
...
DO NM=1,NMESHES
WRITE(LU_SMV,'(F13.5)') 0.25_EB*HRRPUV_AVERAGE/1000._EB
ENDDO
...
REAL(EB) :: FLOW,HMFAC,F1,F2,H_TC,SRAD,TMP_TC,MU_AIR,RE_D,K_AIR,NUSSELT,NU_FAC,PR,AREA,VEL, &
            ...
            DHOR,X_EQUIL,MW_RATIO,Y_EQUIL,TMP_BOIL,EXPON,Y_SPECIES,RCON,MEC,Y_SPECIES2,Y_H2O
...
IF (SPEC_INDEX<0) THEN
   ...
   Y_H2O = 0._EB
   IF (DV%DRY) CALL GET_MASS_FRACTION(Z_VECTOR,H2O_INDEX,Y_SUM(II,JJ,KK),Y_H2O)
ENDIF
