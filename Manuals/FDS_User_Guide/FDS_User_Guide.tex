...
\includegraphics[height=2.2in]{SCRIPT_FIGURES/leak_test_2}
\end{tabular*}
...
\hline \hline
\endhead
{\ct AUTO\_IGNITION\_TEMPERATURE}         & Real        & Auto ignition temperature (MIxture Fraction)          &   K           &  0
   \\ \hline
...
{\ct Y\_CO2\_INFTY}                       & Real        & Ambient carbon dioxide mass fraction (dry air)               &  kg/kg            & 0.0058 \\ \hline
...
{\ct BACKGROUND}                    & Logical     & Use this species as the background species             & {\ct .FALSE.} \\ \hline
{\ct BACKGROUND\_ONLY}              & Logical     & Species is only used for the background species             &                   & {\ct .FALSE.} \\ \hline
...
{\ct SPEC\_ID}                        & Character       & Species for {\ct MASS\_FLUX} or {\ct MASS\_FRACTION}             &                    &                       \\ \hline
