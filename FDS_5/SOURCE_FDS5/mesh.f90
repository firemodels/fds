...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:)   :: XW,YW,ZW,TW,INTERPOLATION_FACTOR, &
            AW,RAW,UW0,DUWDT,RDN,MASS_LOSS, &
            QRADIN,QRADOUT,EW,KW,QCONF,AREA_ADJUST,RHO_W,TMP_W,RSUM_W,RCP_W, &
            TMP_F,TMP_B,HEAT_TRANS_COEF,D_CORR,DS_CORR,DUDT_AVG,DVDT_AVG,DWDT_AVG
...
TYPE EVAC_MESH_TYPE
   ...
   REAL(EB) :: DXI,DETA,DZETA,RDXI,RDETA,RDZETA,XS,XF,YS,YF,ZS,ZF,RDXINT,RDYINT,RDZINT
   REAL(EB), POINTER, DIMENSION(:) :: DX,DY,DZ,CELLSI,CELLSJ,CELLSK
   INTEGER, POINTER, DIMENSION(:,:,:) :: CELL_INDEX
   ...
   INTEGER :: N_HUMANS,N_HUMANS_DIM
   TYPE(HUMAN_GRID_TYPE), POINTER, DIMENSION(:,:) :: HUMAN_GRID
END TYPE EVAC_MESH_TYPE
 
TYPE (EVAC_MESH_TYPE), SAVE, DIMENSION(:), ALLOCATABLE, TARGET :: EVAC_MESH
...
REAL(EB), POINTER :: DXI,DETA,DZETA,XS,XF,YS,YF,ZS,ZF,RDXINT,RDYINT,RDZINT
REAL(EB), POINTER, DIMENSION(:) :: DX,DY,DZ,CELLSI,CELLSJ,CELLSK
INTEGER, POINTER, DIMENSION(:,:,:) :: CELL_INDEX
LOGICAL, POINTER, DIMENSION(:) :: SOLID
TYPE(HUMAN_TYPE), POINTER, DIMENSION(:) :: HUMAN
...
SUBROUTINE POINT_TO_EVAC_MESH(NM)

! Local names for MESH variables point to Global names

INTEGER, INTENT(IN) ::  NM
TYPE (EVAC_MESH_TYPE), POINTER :: M
...
END SUBROUTINE POINT_TO_EVAC_MESH

END MODULE EVAC_MESH_POINTERS
