...
\be
   ...
   \approx \frac{RT_p^2}{\beta} \frac{e r_p}{Y_0}
\ee
Then $A$ can be evaluated directly from Eq.~(\ref{dYdt}):
\be
   A = \frac{r_p}{Y_p} \, \exp \left( \frac{E}{RT_p} \right) \approx \frac{e r_p}{Y_0} \, \exp \left( \frac{E}{RT_p} \right)
\ee
Note that the formulae for $A$ and $E$ are appropriate for multiple-step reactions, where the number of peaks in the reaction
rate curve corresponds to the number of reactions. For TGA data, the values of $r_p$ can be pulled directly from the reaction
...
the heat release rate curve as a function of the temperature. It is important to check the units of all of these quantities because the
