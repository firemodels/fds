...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: &
            ...
            CSD2,CHEM_SUBIT,MIX_TIME,STRAIN_RATE,D_Z_MAX,ZETA_SOURCE_TERM,AIT,Q_DOT_PPP_S,SGS_TMP_COR
...
!For bounday fuel vegetation model or level set fire front
!  REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: DMPVDT_FM_VEG
   INTEGER, ALLOCATABLE, DIMENSION(:,:,:) :: K_AGL_SLICE
   REAL(EB),ALLOCATABLE, DIMENSION(:,:) :: LS_Z_TERRAIN
   REAL(EB),ALLOCATABLE, DIMENSION(:,:,:) :: VEG_DRAG
   INTEGER :: N_TERRAIN_SLCF=0
   REAL(EB) :: VEG_CLOCK_BC !surf veg
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: LSET_PHI
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: HEAD_WIDTH,ROS_HEAD,ROS_HEAD_CROWN,ROS_FLANK,ROS_BACKU,WIND_EXP,FLANKFIRE_LIFETIME
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: PHI_LS,PHI0_LS,PHI1_LS,PHI_TEMP_LS
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: FLUX_LS,FLUX0_LS,FLUX1_LS,SR_X_LS,SR_Y_LS
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: U_LS,V_LS
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: BURN_TIME_LS,CFB_LS
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: ASPECT,DZTDX,DZTDY,MAG_ZT
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: PHI_WS,PHI_S,PHI_S_X,PHI_S_Y,PHI_W_X,PHI_W_Y,PHI_W,UMF_X,UMF_Y,UMF
   REAL(FB), ALLOCATABLE, DIMENSION(:,:) :: CRUZ_CROWN_PROB_OUT,FLI_OUT,HRRPUA_IN,HRRPUA_OUT,MAG_SR_OUT,PHI_OUT, &
                                            ROS_X_OUT,ROS_Y_OUT,TOA
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: CRUZ_CROWN_PROB,THETA_ELPS
   LOGICAL :: LSET_MESH
   INTEGER :: NX_LS,NY_LS
   CHARACTER(80), ALLOCATABLE, DIMENSION(:) :: FN_SLCF_LS
   INTEGER, ALLOCATABLE, DIMENSION(:)       :: LU_SLCF_LS
   REAL(EB) :: DT_COEF_LS,DT_LS,DYN_SR_MAX_LS,SUM_T_SLCF_LS,SUMTIME_LS,TIME_LS
   REAL(FB) :: LSET_TIME_HRRPUA_BURNER
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   U,V,W,US,VS,WS,DDDT,D,DS,H,HS,H_PRIME,KRES,FVX,FVY,FVZ,FVX_B,FVY_B,FVZ_B,RHO,RHOS, &
   MU,MU_DNS,TMP,Q,KAPPA_GAS,CHI_R,QR,QR_W,UII,RSUM,D_SOURCE,D_GEOMETRY,U_OLD,V_OLD,W_OLD, &
   CSD2,MTR,MSR,WEM,MIX_TIME,CHEM_SUBIT,STRAIN_RATE,D_Z_MAX,ZETA_SOURCE_TERM,AIT,Q_DOT_PPP_S,SGS_TMP_COR
...
REAL(EB), POINTER,DIMENSION(:,:,:) :: VEG_DRAG
REAL(EB), POINTER,DIMENSION(:,:) :: LS_Z_TERRAIN
INTEGER, POINTER :: N_TERRAIN_SLCF
REAL(EB), POINTER :: VEG_CLOCK_BC  !surf veg
REAL(EB), POINTER, DIMENSION(:,:,:) :: LSET_PHI
REAL(EB), POINTER, DIMENSION(:,:) :: HEAD_WIDTH,ROS_HEAD,ROS_HEAD_CROWN,ROS_FLANK,ROS_BACKU,WIND_EXP,FLANKFIRE_LIFETIME
REAL(EB), POINTER, DIMENSION(:,:) :: PHI_LS,PHI0_LS,PHI1_LS,PHI_TEMP_LS
REAL(EB), POINTER, DIMENSION(:,:) :: FLUX_LS,FLUX0_LS,FLUX1_LS,SR_X_LS,SR_Y_LS
REAL(EB), POINTER, DIMENSION(:,:) :: U_LS,V_LS
REAL(EB), POINTER, DIMENSION(:,:) :: BURN_TIME_LS,CFB_LS
REAL(EB), POINTER, DIMENSION(:,:) :: ASPECT,DZTDX,DZTDY,MAG_ZT
REAL(EB), POINTER, DIMENSION(:,:) :: PHI_WS,PHI_S,PHI_S_X,PHI_S_Y,PHI_W_X,PHI_W_Y,PHI_W,UMF_X,UMF_Y,UMF
REAL(FB), POINTER, DIMENSION(:,:) :: CRUZ_CROWN_PROB_OUT,FLI_OUT,HRRPUA_IN,HRRPUA_OUT,MAG_SR_OUT,PHI_OUT,ROS_X_OUT,ROS_Y_OUT,TOA
REAL(EB), POINTER, DIMENSION(:,:) :: CRUZ_CROWN_PROB,THETA_ELPS
LOGICAL, POINTER :: LSET_MESH
INTEGER, POINTER :: NX_LS,NY_LS
CHARACTER(80), POINTER, DIMENSION(:) :: FN_SLCF_LS
INTEGER, POINTER, DIMENSION(:)       :: LU_SLCF_LS
REAL(EB), POINTER :: DT_COEF_LS,DT_LS,DYN_SR_MAX_LS,SUM_T_SLCF_LS,SUMTIME_LS,TIME_LS
REAL(FB), POINTER :: LSET_TIME_HRRPUA_BURNER
...
!For boundary fuel vegetation or level set
...
LSET_PHI      => M%LSET_PHI
HEAD_WIDTH    => M%HEAD_WIDTH
ROS_HEAD      => M%ROS_HEAD
ROS_HEAD_CROWN=> M%ROS_HEAD_CROWN
ROS_FLANK     => M%ROS_FLANK
ROS_BACKU     => M%ROS_BACKU
WIND_EXP      => M%WIND_EXP
FLANKFIRE_LIFETIME => M%FLANKFIRE_LIFETIME
PHI_LS        => M%PHI_LS
PHI0_LS       => M%PHI0_LS
PHI1_LS       => M%PHI1_LS
PHI_TEMP_LS   => M%PHI_TEMP_LS
FLUX_LS       => M%FLUX_LS
FLUX0_LS      => M%FLUX0_LS
FLUX1_LS      => M%FLUX1_LS
SR_X_LS       => M%SR_X_LS
...
CRUZ_CROWN_PROB => M%CRUZ_CROWN_PROB
THETA_ELPS      => M%THETA_ELPS

CRUZ_CROWN_PROB_OUT => M%CRUZ_CROWN_PROB_OUT
FLI_OUT       => M%FLI_OUT
HRRPUA_IN     => M%HRRPUA_IN 
HRRPUA_OUT    => M%HRRPUA_OUT
MAG_SR_OUT    => M%MAG_SR_OUT
PHI_OUT       => M%PHI_OUT
ROS_X_OUT     => M%ROS_X_OUT
ROS_Y_OUT     => M%ROS_Y_OUT
TOA           => M%TOA

LSET_MESH     =>M%LSET_MESH

FN_SLCF_LS    => M%FN_SLCF_LS
LU_SLCF_LS    => M%LU_SLCF_LS

LSET_TIME_HRRPUA_BURNER => M%LSET_TIME_HRRPUA_BURNER

DT_COEF_LS    => M%DT_COEF_LS
DT_LS         => M%DT_LS
DYN_SR_MAX_LS => M%DYN_SR_MAX_LS
SUM_T_SLCF_LS => M%SUM_T_SLCF_LS
SUMTIME_LS    => M%SUMTIME_LS
TIME_LS       => M%TIME_LS
