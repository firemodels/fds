...
TYPE PROPERTY_TYPE
   REAL(EB) :: BEAD_DENSITY,BEAD_DIAMETER,BEAD_EMISSIVITY,BEAD_H_FIXED,BEAD_SPECIFIC_HEAT,RTI, &
               ...
               CONDUIT_DIAMETER,CONDUIT_THICKNESS,DT_INSERT
   INTEGER  :: PDPA_M=0,PDPA_N=0,N_SMOKEVIEW_PARAMETERS=0,N_SMOKEVIEW_IDS=0,N_INSERT
   LOGICAL  :: PDPA_INTEGRATE=.TRUE.,PDPA_NORMALIZE=.TRUE.
   REAL(EB) :: PDPA_START=0._EB,PDPA_END=1.E6,PDPA_RADIUS=0.1_EB
   REAL(EB), POINTER, DIMENSION(:) :: TABLE_ROW, V_FACTOR,PARTICLE_INSERT_CLOCK
   INTEGER  :: PART_INDEX=-1,FLOW_RAMP_INDEX,SPRAY_PATTERN_INDEX,SPEC_INDEX=-1,PRESSURE_RAMP_INDEX,Y_INDEX=-1
...
TYPE DEVICE_TYPE
   REAL(EB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INITIAL_VALUE=-1.E10_EB,INSTANT_VALUE,VALUE,DEPTH,TMP_L,Y_C,OBSCURATION,DELAY,ROTATION,&
   ...
   INTEGER  :: OUTPUT_INDEX,IOR,IW,ORDINAL,I,J,K,MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,I_DEPTH,N_PATH,N_T_E,PROP_INDEX,&
               TRIP_DIRECTION,CTRL_INDEX,N_INPUTS,VIRTUAL_WALL_INDEX=0,SURF_INDEX=-1,SPEC_INDEX=-1,Y_INDEX=-1,PART_INDEX=0,&
               VELO_INDEX=0
   INTEGER  :: DUCT_INDEX=-1,NODE_INDEX=-1,POINT=1,LINE=0,LINE_COORD_CODE=123
   ...
   CHARACTER(30) :: ID,PROP_ID,QUANTITY,CTRL_ID,DEVC_ID,STATISTICS='null',SURF_ID,PART_ID='null',SPEC_ID='null',MATL_ID='null', &
                    SMOKEVIEW_BAR_LABEL,UNITS='null',DUCT_ID='null',NODE_ID='null',X_ID='null',Y_ID='null',Z_ID='null'
   ...
   LOGICAL :: INITIAL_STATE,CURRENT_STATE,LATCH,PRIOR_STATE,GAS_CELL_RAD_FLUX=.FALSE.,DRY=.FALSE.,TIME_AVERAGED=.TRUE., &
              EVACUATION=.FALSE.,CHANGE_ONLY=.FALSE.
