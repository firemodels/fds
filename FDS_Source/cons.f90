...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,MIXTURE_FRACTION=.FALSE., &
           ...
           FLUSH_FILE_BUFFERS,RECOMPUTE_A=.TRUE.,RESTRICT_MESH_ASSIGNMENT=.FALSE., &
           ...
           MEAN_FORCING=.FALSE.,H_EDDY=.FALSE.,BAROCLINIC2=.FALSE.,NOBIAS=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,TMPM,RHOA,RHO_LOWER_GLOBAL,RHO_UPPER_GLOBAL,P_INF,P_STP,GRAV,R0,R1, &
            ...
            RFAC_FORCING=0.5_EB,PARTICLE_CFL_MAX=1.0_EB,LIMITING_DT_RATIO=1.E-4_EB
...
INTEGER, PARAMETER :: TIME_HEAT=-1,TIME_VELO=-2,TIME_TEMP=-3,TIME_EFLUX=-4,TANH_RAMP=-2,TSQR_RAMP=-1
