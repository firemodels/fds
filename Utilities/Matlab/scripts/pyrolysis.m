...
for i_plot=1:2
    ...
    xlabel('Temperature (°C)','Interpreter',Font_Interpreter,'FontSize',Label_Font_Size,'FontName',Font_Name)
    ...
    set(get(AX(2),'Ylabel'),'String','Reaction Rate \times 10^3 (s^{-1})','Interpreter',Font_Interpreter,'FontSize',Label_Font_Size,'FontName',Font_Name)
    set(AX(1),'YLim',[0 1.1])
    set(AX(2),'YLim',[0 2.2])
