...
if is_case_1_run % case 1 if
    ...
    eta_FDS_1 = eta_FDS_1./(MLR_FDS_1*fuel_hoc(i_fuel));
...
if is_case_2_run % case 2 if
    ...
    eta_FDS_2 = eta_FDS_2./(MLR_FDS_2*fuel_hoc(i_fuel));
...
if is_case_3_run % case 3 if
    ...
    eta_FDS_3 = eta_FDS_3./(MLR_FDS_3*fuel_hoc(i_fuel));
...
if is_case_4_run % case 4 if
    ...
    HRR4 = importdata([outdir,fuel_name{i_fuel},'_XO2_ramp_2step_dx_1p25cm_hrr.csv'],',',2);
    DEV4 = importdata([outdir,fuel_name{i_fuel},'_XO2_ramp_2step_dx_1p25cm_devc.csv'],',',2);
    ...
    eta_FDS_4 = HRR4.data(:,find(strcmp(HRR4.colheaders,'HRR')));
    MLR_FDS_4 = HRR4.data(:,find(strcmp(HRR4.colheaders,'MLR_FUEL')));
    eta_FDS_4 = eta_FDS_4./(MLR_FDS_4*fuel_hoc(i_fuel));
...
if is_case_5_run % case 5 if
    ...
    eta_FDS_5 = HRR5.data(:,find(strcmp(HRR5.colheaders,'HRR')));
    MLR_FDS_5 = HRR5.data(:,find(strcmp(HRR5.colheaders,'MLR_FUEL')));
    eta_FDS_5 = eta_FDS_5./(MLR_FDS_5*fuel_hoc(i_fuel));
...
if is_case_run
    if is_case_1_run; H(3)=plot(XO2_FDS_1,CHI_R_FDS_1,'-*'); end
    if is_case_2_run; H(4)=plot(XO2_FDS_2,CHI_R_FDS_2,'-^'); end
    if is_case_3_run; H(5)=plot(XO2_FDS_3,CHI_R_FDS_3,'-sq'); end
    if is_case_4_run; H(6)=plot(XO2_FDS_4,CHI_R_FDS_4,'->'); end
    if is_case_5_run; H(7)=plot(XO2_FDS_5,CHI_R_FDS_5,'-v'); end
...
if is_case_run
    if is_case_1_run; H(2)=plot(XO2_FDS_1,eta_FDS_1,'-*'); end
    if is_case_2_run; H(3)=plot(XO2_FDS_2,eta_FDS_2,'-^'); end
    if is_case_3_run; H(4)=plot(XO2_FDS_3,eta_FDS_3,'-sq'); end
    if is_case_4_run; H(5)=plot(XO2_FDS_4,eta_FDS_4,'->'); end
    if is_case_5_run; H(6)=plot(XO2_FDS_5,eta_FDS_5,'-v'); end
...
if is_case_run
    if is_case_1_run; H(2)=plot(Time_FDS_1,XO2_FDS_1,'-*'); end
    if is_case_2_run; H(3)=plot(Time_FDS_2,XO2_FDS_2,'-^'); end
    if is_case_3_run; H(4)=plot(Time_FDS_3,XO2_FDS_3,'-sq'); end
    if is_case_4_run; H(5)=plot(Time_FDS_4,XO2_FDS_4,'->'); end
    if is_case_5_run; H(6)=plot(Time_FDS_5,XO2_FDS_5,'-v'); end
    axis([0 60 0.1 0.21])
...
if is_case_run
    if is_case_1_run; H(2)=plot(XO2_FDS_1,q_R_FDS_1,'-*'); end
    if is_case_2_run; H(3)=plot(XO2_FDS_2,q_R_FDS_2,'-^'); end
    if is_case_3_run; H(4)=plot(XO2_FDS_3,q_R_FDS_3,'-sq'); end
    if is_case_4_run; H(5)=plot(XO2_FDS_4,q_R_FDS_4,'->'); end
    if is_case_5_run; H(6)=plot(XO2_FDS_5,q_R_FDS_5,'-v'); end
...
set(h,'Color',steel_blue)
if is_case_run
    if is_case_1_run; H(2)=plot(XO2_FDS_1,Lf_FDS_1,'-*'); end
    if is_case_2_run; H(3)=plot(XO2_FDS_2,Lf_FDS_2,'-^'); end
    if is_case_3_run; H(4)=plot(XO2_FDS_3,Lf_FDS_3,'-sq'); end
    if is_case_4_run; H(5)=plot(XO2_FDS_4,Lf_FDS_4,'->'); end
    if is_case_5_run; H(6)=plot(XO2_FDS_5,Lf_FDS_5,'-v'); end
