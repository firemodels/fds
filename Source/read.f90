...
WRITE(*,*) 'N_S:',N_SPECIES,N_PRIMITIVE,N_PREDEFINED,N_COPY_PRIMITIVE,N_SIMPLE_FUEL   
...
WRITE(*,*) 'NTSP:',N_TRACKED_SPECIES,N_LUMPED,N_COPY,N_TOTAL_BINS,N_PREDEFINED_SMIX,N_CONDENSATION
N_TOTAL_SCALARS = N_TRACKED_SPECIES + N_PASSIVE_SCALARS
WRITE(*,*) 'NTSC',N_TOTAL_SCALARS,N_TRACKED_SPECIES,N_PASSIVE_SCALARS
