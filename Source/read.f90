...
CHARACTER(25) :: COLOR
LOGICAL :: TARGET_ONLY,MASSIVE_TRACER,MASSLESS,STATIC,MONODISPERSE,BREAKUP,CHECK_DISTRIBUTION,&
...
NAMELIST /PART/ ADHERE_TO_SOLID,AGE,BREAKUP,BREAKUP_CNF_RAMP_ID,BREAKUP_DISTRIBUTION,BREAKUP_GAMMA_D,BREAKUP_RATIO,&
                ...
                HORIZONTAL_VELOCITY,ID,INITIAL_TEMPERATURE,KILL_DIAMETER,MASSIVE_TRACER,MASSLESS,&
...
READ_PART_LOOP: DO N=1,N_LAGRANGIAN_CLASSES
   ...
   LPC%MASSIVE_TRACER      = MASSIVE_TRACER
