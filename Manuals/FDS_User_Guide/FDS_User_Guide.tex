...
{\ct HT3D} can also be used in multiple meshes to transfer heat across mesh boundaries. An example that demonstrate its usage is provided in ({\ct ht3d\_2mesh}). 
Notice that we can account for volumetric heat sources, below is an example from ({\ct ht3d\_source\_term}) input file:
