...
setenv SMV5 ~/bin/smv5_linux

# specify location of FDS-SMV repository
setenv FDSSMV ~/FDS-SMV
...
set RUNSMV=$FDSSMV/Utilities/Scripts/runsmv.csh

# specify directory containing case directories
...
$RUNSMV MCFRS/MCFRS_Tower MCFRS_Tower_00
# MFRI  cases
