...
SELECT CASE(FUEL)
   CASE('ACETONE')     ; CHI_R = 0.30_EB
   CASE('ACETYLENE')   ; CHI_R = 0.45_EB
   CASE('BENZENE')     ; CHI_R = 0.45_EB
   CASE('BUTANE')      ; CHI_R = 0.35_EB
   CASE('DODECANE')    ; CHI_R = 0.40_EB
   CASE('ETHANE')      ; CHI_R = 0.25_EB
   CASE('ETHANOL')     ; CHI_R = 0.20_EB
   CASE('ETHYLENE')    ; CHI_R = 0.35_EB
   CASE('HYDROGEN')    ; CHI_R = 0.10_EB
   CASE('ISOPROPANOL') ; CHI_R = 0.30_EB
   CASE('METHANE')     ; CHI_R = 0.20_EB
   CASE('METHANOL')    ; CHI_R = 0.20_EB
   ...
   CASE('PROPYLENE')   ; CHI_R = 0.35_EB
   CASE('TOLUENE')     ; CHI_R = 0.45_EB
...
SELECT CASE(FUEL)
   CASE('ACETONE')     ; CRITICAL_FLAME_TEMPERATURE = 1670._EB
   CASE('ACETYLENE')   ; CRITICAL_FLAME_TEMPERATURE = 1312._EB
   CASE('BENZENE')     ; CRITICAL_FLAME_TEMPERATURE = 1683._EB
   CASE('BUTANE')      ; CRITICAL_FLAME_TEMPERATURE = 1594._EB
   CASE('DODECANE')    ; CRITICAL_FLAME_TEMPERATURE = 1577._EB
 ! CASE('ETHANE')      ; CRITICAL_FLAME_TEMPERATURE = ????._EB
   CASE('ETHANOL')     ; CRITICAL_FLAME_TEMPERATURE = 1529._EB
   CASE('ETHYLENE')    ; CRITICAL_FLAME_TEMPERATURE = 1441._EB
   CASE('HYDROGEN')    ; CRITICAL_FLAME_TEMPERATURE =  870._EB
   CASE('ISOPROPANOL') ; CRITICAL_FLAME_TEMPERATURE = 1608._EB
   CASE('METHANE')     ; CRITICAL_FLAME_TEMPERATURE = 1663._EB
   CASE('METHANOL')    ; CRITICAL_FLAME_TEMPERATURE = 1395._EB
 ! CASE('N-DECANE')    ; CRITICAL_FLAME_TEMPERATURE = ????._EB
   CASE('N-HEPTANE')   ; CRITICAL_FLAME_TEMPERATURE = 1617._EB
   CASE('N-HEXANE')    ; CRITICAL_FLAME_TEMPERATURE = 1646._EB
   CASE('N-OCTANE')    ; CRITICAL_FLAME_TEMPERATURE = 1564._EB
   CASE('PROPANE')     ; CRITICAL_FLAME_TEMPERATURE = 1573._EB
 ! CASE('PROPYLENE')   ; CRITICAL_FLAME_TEMPERATURE = ????._EB
   CASE('TOLUENE')     ; CRITICAL_FLAME_TEMPERATURE = 1755._EB
   CASE DEFAULT        ; CRITICAL_FLAME_TEMPERATURE = 1550._EB
END SELECT
