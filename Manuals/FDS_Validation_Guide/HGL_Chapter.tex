...
Details on the experiments and modeling can be found in Section~\ref{LLNL_Enclosure_Description}.
...
\label{Memorial_Tunnel_Temperature_Profiles}

The plots on the following pages show measured and predicted vertical gas temperature profiles at various locations in the 854~m long Memorial Tunnel. A description of the experiments can be found in Section~\ref{Memorial_Tunnel_Description}.

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_0} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_1} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_2} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_3} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_4} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_5}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 606A, 0-5 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~606A at 0, 1, 2, 3, 4, and 5~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_606A_T_0-5}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_8} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_10} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_12} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_14} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_16} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_18}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 606A, 8-18 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~606A at 8, 10, 12, 14, 16, and 18~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_606A_T_8-18}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_20} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_22} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_24} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_26} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_28} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A_T_30}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 606A, 20-30 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~606A at 20, 22, 24, 26, 28, and 30~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_606A_T_20-30}
\end{figure}


\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_0} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_1} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_2} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_3} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_4} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_5}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 612B, 0-5 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~612B at 0, 1, 2, 3, 4, and 5~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_612B_T_0-5}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_8} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_10} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_12} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_14} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_16} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_18}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 612B, 8-18 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~612B at 8, 10, 12, 14, 16, and 18~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_612B_T_8-18}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_20} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_22} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_24} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_26} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_28} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B_T_30}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 612B, 20-30 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~612B at 20, 22, 24, 26, 28, and 30~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_612B_T_20-30}
\end{figure}


\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_0} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_1} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_2} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_3} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_4} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_5}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 615B, 0-5 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~615B at 0, 1, 2, 3, 4, and 5~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_615B_T_0-5}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_8} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_10} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_12} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_14} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_16} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_18}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 615B, 8-18 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~615B at 8, 10, 12, 14, 16, and 18~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_615B_T_8-18}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{c}
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_20} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_22} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_24} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_26} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_28} \\
\includegraphics[height=1.25in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B_T_30}
\end{tabular*}
\caption[Memorial Tunnel experiments, temperature profiles, Test 615B, 20-30 min]{Measured (red) and predicted (black) centerline temperature profiles for Memorial Tunnel Test~615B at 20, 22, 24, 26, 28, and 30~min. The numbers along the horizontal axis indicate the station or ``loop'' at which the measurements were made.}
\label{Memorial_615B_T_20-30}
\end{figure}
