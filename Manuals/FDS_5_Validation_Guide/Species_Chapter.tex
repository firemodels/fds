...
\begin{figure}
\includegraphics[width=6in]{FIGURES/WP_CH4_Temp}
...
\begin{figure}[p]
\includegraphics[width=6in]{FIGURES/Beyler_species}
...
Fig.~\ref{RSE1_species} shows the measured and predicted $CO_2$ and CO concentrations.  The measured values are 
...
\begin{figure}
\includegraphics[width=6in]{FIGURES/RSE1_species}
