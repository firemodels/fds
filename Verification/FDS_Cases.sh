...
$QFDS -T -t 1 -d Timing_Benchmarks openmp_test64a.fds
$QFDS -T -t 2 -d Timing_Benchmarks openmp_test64b.fds
$QFDS -T -t 3 -d Timing_Benchmarks openmp_test64c.fds
$QFDS -T -t 4 -d Timing_Benchmarks openmp_test64d.fds
$QFDS -T -t 5 -d Timing_Benchmarks openmp_test64e.fds
$QFDS -T -t 6 -d Timing_Benchmarks openmp_test64f.fds
$QFDS -T -t 7 -d Timing_Benchmarks openmp_test64g.fds
$QFDS -T -t 8 -d Timing_Benchmarks openmp_test64h.fds

$QFDS -T -t 1 -d Timing_Benchmarks openmp_test128a.fds
$QFDS -T -t 2 -d Timing_Benchmarks openmp_test128b.fds
$QFDS -T -t 3 -d Timing_Benchmarks openmp_test128c.fds
$QFDS -T -t 4 -d Timing_Benchmarks openmp_test128d.fds
$QFDS -T -t 5 -d Timing_Benchmarks openmp_test128e.fds
$QFDS -T -t 6 -d Timing_Benchmarks openmp_test128f.fds
$QFDS -T -t 7 -d Timing_Benchmarks openmp_test128g.fds
$QFDS -T -t 8 -d Timing_Benchmarks openmp_test128h.fds
...
$QFDS -d Evacuation evac_smv_testcase1.fds
