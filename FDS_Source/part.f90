...
!$OMP PRIVATE(TMP_G,RHO_G,MU_AIR,C_DRAG,WE_G,SFAC,CONST,BFAC,AUREL,AVREL,AWREL,DTMIN,UVW,NITER,DTSP,N) &
!$OMP PRIVATE(X_OLD,Y_OLD,Z_OLD,IW,RN,THETA_RN,IIN,JJN,KKN,ICN,IOR_OLD,HIT_SOLID) &
!$OMP PRIVATE(IWP1,IWM1,IWP2,IWM2,IWP3,IWM3,STEP_FRACTION,IML,IOR_FIRST,R_NEW)
