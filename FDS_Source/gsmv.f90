...
REAL(EB) FUNCTION GET_TETRABOX_VOLUME(BOX_BOUNDS,V0,V1,V2,V3,AREAS)
...
CALL GET_VERTS(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,FACES,SIDE_INDEX,WHICH_SIDE,NFACES,NSIDES,BOX_STATE,VERT_STATE)
...
DO I = 1, NFACES
   F=FACES(3*I-2:3*I)
   V1(1:3)=>VERTS(3*F(0)-2:3*F(0))
   V2(1:3)=>VERTS(3*F(1)-2:3*F(1))
   V3(1:3)=>VERTS(3*F(2)-2:3*F(2))
...
SUBROUTINE GET_VERTS(BOX_BOUNDS,VV0,VV1,VV2,VV3,VERTS,NVERTS,FACES,SIDE_INDEX,WHICH_SIDE,NFACES,NSIDES,BOX_STATE,VERT_STATE)
