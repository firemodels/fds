...
NAMELIST /DUMP/ CFL_FILE,CLIP_RESTART_FILES,COLUMN_DUMP_LIMIT,CTRL_COLUMN_LIMIT,&
                ...
                DT_GEOM,DT_HRR,DT_ISOF,DT_MASS,DT_MOM,DT_PART,DT_PL3D,DT_PROF,DT_RESTART,DT_RADF,DT_SL3D,DT_SLCF,EB_PART_FILE,&
                FLUSH_FILE_BUFFERS,GEOM_DIAG,GET_CUTCELLS_VERBOSE,MASS_FILE,MAXIMUM_PARTICLES,MMS_TIMER,&
                MOMENTUM_FILE,NFRAMES,PLOT3D_PART_ID, &
...
IF (DT_MOM  < 0._EB) THEN ; DT_MOM  = DT_DEFAULT       ; ELSE ; DT_MOM  = DT_MOM  /TIME_SHRINK_FACTOR ; ENDIF
...
NAMELIST /SURF/ ADIABATIC,AREA_ADJUST,&
                ...
                N_CELLS_MAX,N_LAYER_CELLS_MAX,NET_HEAT_FLUX,&
