...
REAL(EB), INTENT(IN) :: T
INTEGER, INTENT(IN) :: NM
INTEGER :: I,II,JJ,KK,IIG,JJG,KKG,IW,NS
TYPE (SURFACE_TYPE), POINTER :: SF=>NULL()
...
PARTICLE_LOOP: DO I=1,NLP
   ...
   CALC_LP_MASS:IF (SF%THERMALLY_THICK) THEN
      SELECT CASE (SF%GEOMETRY)
         CASE (SURF_CARTESIAN)               
            LP%MASS = SF%LENGTH*SF%WIDTH*SF%THICKNESS*SURFACE_DENSITY(NM,1,LAGRANGIAN_PARTICLE_INDEX=I)
          CASE (SURF_CYLINDRICAL)
            LP%MASS = SF%LENGTH*PI*SF%THICKNESS**2*SURFACE_DENSITY(NM,1,LAGRANGIAN_PARTICLE_INDEX=I)
         CASE (SURF_SPHERICAL)
            LP%MASS = FOTHPI*SF%THICKNESS**3*SURFACE_DENSITY(NM,1,LAGRANGIAN_PARTICLE_INDEX=I)
      END SELECT
   ENDIF CALC_LP_MASS  
