...
TYPE PARTICLE_CLASS_TYPE
   CHARACTER(30) :: ID,SPEC_ID,QUANTITIES(10),SMOKEVIEW_BAR_LABEL(10),SURF_ID='null'
   CHARACTER(60) :: SMOKEVIEW_LABEL(10),SMOKEVIEW_ID=' '
   REAL(EB) :: DENSITY,TMP_V,TMP_MELT,FTPR,MASS_PER_VOLUME, &
               HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               LIFETIME,LENGTH,AZIMUTH,ELEVATION,DIAMETER,MINIMUM_DIAMETER,MAXIMUM_DIAMETER,GAMMA,KILL_RADIUS, &
   ...
   REAL(EB) :: H_V(5000)=-1._EB,C_P(5000)=-1._EB,C_P_BAR(5000)=-1._EB,H_V_REFERENCE_TEMPERATURE,H_L(5000)
   INTEGER :: N_INITIAL,SAMPLING,N_INSERT,SPEC_INDEX,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
              SURF_INDEX=-1,WALL_INDEX_START=-1
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT,TMP_INNER,VEL,PLE,Z0,CONVECTIVE_HEAT_FLUX, NET_HEAT_FLUX, &
               ...
               TMP_IGN,H_V,REGRID_FACTOR,LAYER_DIVIDE,ROUGHNESS,LENGTH,WIDTH
   ...
   LOGICAL :: BURN_AWAY,ADIABATIC,THERMALLY_THICK,INTERNAL_RADIATION,SHRINK,POROUS=.FALSE.,USER_DEFINED=.TRUE.,FREE_SLIP=.FALSE.
...
TYPE OMESH_TYPE
   REAL(EB), POINTER, DIMENSION(:,:,:) :: MU,RHO,RHOS,U,V,W,US,VS,WS,H,DUDT,DVDT,DWDT
...
TYPE OUTPUT_QUANTITY_TYPE
   ...
   LOGICAL :: SLCF_APPROPRIATE=.TRUE., BNDF_APPROPRIATE=.FALSE., ISOF_APPROPRIATE=.TRUE., PART_APPROPRIATE=.FALSE., &
              ...
              MATL_ID_REQUIRED=.FALSE.,TIME_AVERAGED=.TRUE.
