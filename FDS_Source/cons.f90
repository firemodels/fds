...
LOGICAL :: LES,DNS,RADIATION,CONVECTION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,SIMPLE_CHEMISTRY=.FALSE., &
           ...
           CHECK_KINETIC_ENERGY=.FALSE.,CLIP_MASS_FRACTION=.FALSE.,STORE_MU_DNS=.FALSE.,CHECK_VN=.FALSE., &
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            TMPM=273.15, P_STP=101325.,GRAV=9.80665,R0=8314.472,R1=1.986257E-03_EB,SIGMA=5.67E-8_EB 
