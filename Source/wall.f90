...
LOGICAL :: CALL_HT_1D,SECOND_ORDER_INTERPOLATED_BOUNDARY
...
WALL_CELL_LOOP_0: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   IF (IW<=N_EXTERNAL_WALL_CELLS) CALL ASSIGN_GHOST_VALUE(IW,BC,B1,SECOND_ORDER_INTERPOLATED_BOUNDARY)
...
WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   IF (.NOT.SF%THERMAL_BC_INDEX==THERMALLY_THICK) THEN
      CALL SURFACE_HEAT_TRANSFER(NM,T,SF,BC,B1,WALL_INDEX=IW,SOIB=SECOND_ORDER_INTERPOLATED_BOUNDARY)
...
SUBROUTINE ASSIGN_GHOST_VALUE(WALL_INDEX,BC,B1,SECOND_ORDER_INTERPOLATED_BOUNDARY)

USE PHYSICAL_FUNCTIONS, ONLY : GET_SPECIFIC_GAS_CONSTANT
USE COMPLEX_GEOMETRY, ONLY : CC_CGSC, CC_SOLID
INTEGER, INTENT(IN) :: WALL_INDEX
LOGICAL, INTENT(OUT) :: SECOND_ORDER_INTERPOLATED_BOUNDARY
...
SUBROUTINE SURFACE_HEAT_TRANSFER(NM,T,SF,BC,B1,WALL_INDEX,CFACE_INDEX,PARTICLE_INDEX,SOIB)
...
LOGICAL, INTENT(IN), OPTIONAL :: SOIB !Second Order Interpolated Boundary
REAL(EB) :: ARO,QNET,RAMP_FACTOR,RSUM_F,PBAR_F,TSI,UN, &
            ...
            RHO_G_2,RHO_OTHER_2,RHO_ZZ_G,RHO_ZZ_G_2,RHO_ZZ_OTHER_2,RHO_ZZ_OTHER(1:N_TOTAL_SCALARS)
