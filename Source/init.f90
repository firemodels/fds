...
ALLOCATE(M%U(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','U',IZERO); M%U=0._EB
ALLOCATE(M%V(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','V',IZERO); M%V=0._EB
ALLOCATE(M%W(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','W',IZERO); M%W=0._EB
ALLOCATE(M%US(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','US',IZERO)
ALLOCATE(M%VS(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','VS',IZERO)
ALLOCATE(M%WS(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WS',IZERO)
ALLOCATE(M%WORK_U(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WORK_U',IZERO); M%WORK_U=0._EB
ALLOCATE(M%WORK_V(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WORK_V',IZERO); M%WORK_V=0._EB
ALLOCATE(M%WORK_W(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WORK_W',IZERO); M%WORK_W=0._EB
