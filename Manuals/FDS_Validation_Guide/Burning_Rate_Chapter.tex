...
lists eleven parameters for each polymer studied.  In this model, the polymer first decays to a liquid with identical properties and then decays into a gas. 
\begin{equation}
   Polymer \rightarrow Liquid \rightarrow Gas
\end{equation}
The decomposition into a liquid is represented by a threshold temperature and a heat of reaction equivalent to a heat of melting. These values have been input directly into FDS, and the predicted mass loss rates are compared with measured values from the NIST Gasification Apparatus, a device that pyrolyzes the solid in a nitrogen environment to prevent combustion of fuel gases. The results are shown in Fig.~\ref{FAA_Polymers2}. The exposing
heat flux was 50~kW/m$^2$. A thin sheet of aluminum foil and a 2.5~cm layer of Foamglas insulation was placed under the sample. Its properties are given in Ref.~\cite{Stoliarov:FM2012}.
...
\hline
Property                    & Units         & PP                 & PA66                  & POM              & PET   & Unc. (\%) & Method                &  Ref.                         \\ \hline \hline
Density                     & kg/m$^3$      & 910                   & 1150                   & 1425   & 1380              & 5         & Direct                &  \cite{Stoliarov:FM2012}      \\ \hline
Conductivity                & W/m/K         & 0.24                  & 0.34                  & 0.28       & 0.29          & 15        & TLC                   &  \cite{Stoliarov:FM2012}      \\ \hline
Specific Heat               & kJ/kg/K       & 2.68                 & 2.54                   & 1.88        & 2.01          & 15        & DSC                   &  \cite{Stoliarov:FM2012}     \\ \hline
Emissivity                  &               & 0.96                  & 0.95                  & 0.95             & 0.903  & 20        & IS                    &  \cite{Stoliarov:FM2012}       \\ \hline
Absorption Coef.            & m$^{-1}$      & 966                  & 3920                  & 3550      &2937           & 50        & FTIR                  &  \cite{Stoliarov:FM2012}   \\ \hline
Pre-Exp.~Factor             & s$^{-1}$      & $1.6 \times 10^{23}$  & $5.7 \times 10^{17}$  & $3.7 \times 10^{10}$ & $4.50 \times 10^{18}$ & 50        & TGA                   &  \cite{Stoliarov:FM2012}      \\ \hline
Activation Energy           & kJ/kmol       & $3.52 \times 10^{5}$  & $2.74 \times 10^{5}$  & $1.57 \times 10^{5}$   & $2.81 \times 10^{5}$ & 3         & TGA                   &  \cite{Stoliarov:FM2012}      \\ \hline
Heat of Reaction            & kJ/kg         & 1310                  & 1390                  & 1570      & 1800            & 15        & DSC                   &  \cite{Stoliarov:FM2012}     \\ \hline
Heat of Melting            & kJ/kg         & 80                  & 55                  & 141              & 37    & 15        & DSC                   &  \cite{Stoliarov:FM2012}     \\ \hline
Melting Temperature            & K         & 158                  & 262                  & 165          & 253        & 15        & DSC                   &  \cite{Stoliarov:FM2012}     \\ \hline
...
\begin{figure}[h!]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PP} &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PA66} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_POM}&
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PET} \\
\end{tabular*}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_50_solid_only} &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_50} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_70_solid_only} &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_70} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_90_solid_only} &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PEEK_90}
\end{tabular*}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
 &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBT_35_solid_only} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBT} &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBT_50_solid_only} \\
 &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBT_70_solid_only}
\end{tabular*}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
 &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBTGF_35_solid_only} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBTGF} &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBTGF_50_solid_only} \\
 &
\includegraphics[height=2.2in]{FIGURES/FAA_Polymers/FAA_Polymers_PBTGF_70_solid_only}
\end{tabular*}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/Pool_Fires/acetone_1_m} &
\includegraphics[height=2.2in]{FIGURES/Pool_Fires/benzene_1_m} \\
\includegraphics[height=2.2in]{FIGURES/Pool_Fires/butane_1_m} &
\includegraphics[height=2.2in]{FIGURES/Pool_Fires/ethanol_1_m} \\
\includegraphics[height=2.2in]{FIGURES/Pool_Fires/heptane_1_m} &
\includegraphics[height=2.2in]{FIGURES/Pool_Fires/methanol_1_m} \\
\end{tabular*}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=5.0in]{FIGURES/ScatterPlots/Pool_Fires_Burning_Rates}
\end{tabular}
\end{center}
