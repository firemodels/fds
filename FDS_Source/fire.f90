...
REAL(EB) :: ERR_EST,ERR_TOL,ZZ_TEMP(1:N_TRACKED_SPECIES),DZZ(1:N_TRACKED_SPECIES),&
            ...
            PBAR_0,VEL_RMS,TAU_RES,Q_H_SUM,Q_H_CUM,H1,H2,CHI_R_TEMP,CHI_R_1,CHI_R_2,CHI_R_4,&
...
INTEGRATION_LOOP: DO TIME_ITER = 1,MAX_CHEMISTRY_ITERATIONS
   ...
   INTEGRATOR_SELECT: SELECT CASE (COMBUSTION_ODE_SOLVER)
      ...
      CASE (EXPLICIT_EULER) ! Simple chemistry
         ...
         DO SR=0,N_SERIES_REACTIONS
            CALL FIRE_FORWARD_EULER(ZZ_MIXED_NEW,ZETA,ZZ_MIXED,ZETA_0,DT_SUB,TMP_MIXED,TMP_UNMIXED,RHO_HAT,ZZ_UNMIXED,&
                                    CELL_MASS,TAU_MIX,PBAR_0,DELTA,VEL_RMS,EXTINCT,CHI_R_TEMP,Q_REAC_TEMP)
      ...
      CASE (RK2_RICHARDSON) ! Finite-rate (or mixed finite-rate/fast) chemistry
         ...
         ENDDO RICH_EX_LOOP
         ZETA_0 = ZETA
         CHI_R_TEMP = (4._EB*CHI_R_4-CHI_R_2)*ONTH
   ...
   CHI_R(I,J,K) = CHI_R(I,J,K) + DT_SUB * CHI_R_TEMP
...
SUBROUTINE FIRE_FORWARD_EULER(ZZ_OUT,ZETA_OUT,ZZ_IN,ZETA_IN,DT_LOC,TMP_MIXED,TMP_UNMIXED,RHO_HAT,ZZ_UNMIXED,CELL_MASS,TAU_MIX,&
                              PBAR_0,DELTA,VEL_RMS,EXTINCT,CHI_R_TEMP,Q_REAC_TEMP)
USE COMP_FUNCTIONS, ONLY:SHUTDOWN
...
REAL(EB), INTENT(OUT) :: ZZ_OUT(1:N_TRACKED_SPECIES),ZETA_OUT,CHI_R_TEMP,Q_REAC_TEMP(1:N_REACTIONS)
...
IF (ANY(REACTION(:)%FAST_CHEMISTRY)) THEN
   DO SR = 0,N_SERIES_REACTIONS
      CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,INFINITELY_FAST,PBAR_0,DELTA,VEL_RMS,EXTINCT,CHI_R_TEMP,Q_REAC_TEMP)
...
IF (.NOT.ALL(REACTION(:)%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,FINITE_RATE,PBAR_0,DELTA,VEL_RMS,EXTINCT,CHI_R_TEMP,Q_REAC_TEMP)
   ZZ_NEW = ZZ_0 + DZZ
   ...
   IF (TEMPERATURE_DEPENDENT_REACTION) THEN
      ...
      DO ITER = 1,3
         ...
         TMP_MIXED = ( CPBAR_MIXED_0*TMP_MIXED_0 + (1._EB-CHI_R_TEMP)*Q_TEMP )/CPBAR_MIXED ! CGW Eq. (38)
      ENDDO
   ENDIF
ENDIF
...
REAL(EB) :: DT_LOC,ZZ_0(1:N_TRACKED_SPECIES),ZZ_1(1:N_TRACKED_SPECIES),ZZ_2(1:N_TRACKED_SPECIES),ZETA_0,ZETA_1,ZETA_2,&
            CHI_R_1,CHI_R_2,Q_REAC_1(1:N_REACTIONS),Q_REAC_2(1:N_REACTIONS)
INTEGER :: N
...
SUBROUTINE REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_0,TMP_0,KINETICS,PBAR_0,DELTA,VEL_RMS,EXTINCT,CHI_R_TEMP,Q_REAC_TEMP)
USE PHYSICAL_FUNCTIONS, ONLY : GET_MASS_FRACTION_ALL,GET_SPECIFIC_GAS_CONSTANT,GET_GIBBS_FREE_ENERGY,GET_MOLECULAR_WEIGHT
REAL(EB), INTENT(OUT) :: DZZ(1:N_TRACKED_SPECIES),CHI_R_TEMP
...
REAL(EB) :: DZ_F(1:N_REACTIONS),YY_PRIMITIVE(1:N_SPECIES),DG_RXN,MW,MOLPCM3,DTHETA,CHI_R_N,CHI_R_D
INTEGER :: I,NS
INTEGER, PARAMETER :: INFINITELY_FAST=1,FINITE_RATE=2
TYPE(REACTION_TYPE), POINTER :: RN=>NULL()
...
KINETICS_SELECT: SELECT CASE(KINETICS)
   ...
   CASE(INFINITELY_FAST)
      REACTION_LOOP_1: DO I=1,N_REACTIONS
         ...
         CHI_R_N = CHI_R_N + RN%CHI_R*RN%HEAT_OF_COMBUSTION*DZ_F(I)
         CHI_R_D = CHI_R_D +          RN%HEAT_OF_COMBUSTION*DZ_F(I)
...
IF (ANY(DZ_F>0._EB)) CHI_R_TEMP = CHI_R_N/CHI_R_D
