...
INTEGER :: I,J,K,IIG,JJG,KKG,II,JJ,KK,IW,TURB_MODEL_TMP
...
!$OMP        LES,NM,CSMAG,TWO_D,DX,DY,DZ,USE_MAX_FILTER_WIDTH,RDX,RDY,RDZ,UU,VV,WW,RHOP,CSD2, &
...
UNSTRUCTURED_GEOMETRY_LOOP: DO TRI_INDEX=1,N_FACE
   ...
   FACET(TRI_INDEX)%TMP_F = TMP_SUM/REAL(N_CELLS,EB)
