...
IMPLICIT NONE
CHARACTER(255), PARAMETER :: typeid='$Id: type.f90 17367 2013-11-13 15:04:36Z mrctkg@gmail.com $'
CHARACTER(255), PARAMETER :: typerev='$Revision: 17367 $'
CHARACTER(255), PARAMETER :: typedate='$Date: 2013-11-13 10:04:36 -0500 (Wed, 13 Nov 2013) $'
...
TYPE REACTION_TYPE
   ...
   LOGICAL :: IDEAL,CHECK_ATOM_BALANCE,FAST_CHEMISTRY=.FALSE.,SERIES_REACTION=.FALSE.,REVERSE=.FALSE.
...
TYPE SURFACE_TYPE
   ...
   INTEGER,  DIMENSION(-8:MAX_SPECIES) :: RAMP_INDEX=0
   ...
   CHARACTER(30) :: PART_ID,RAMP_Q,RAMP_V,RAMP_T,RAMP_EF,RAMP_PART,RAMP_V_X,RAMP_V_Y,RAMP_V_Z
