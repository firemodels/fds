...
USE GLOBAL_CONSTANTS, ONLY: LU_INPUT,INPUT_FILE_LINE_NUMBER,STOP_STATUS,SETUP_STOP,HVAC_DEBUG,N_DUCTS,N_DUCTNODES,&
                            N_FILTERS,N_FANS,N_AIRCOILS,N_ZONE,N_SURF,HVAC_SOLVE,DUCT_NE,DUCT_DR,DUCTNODE_NE,DUCTNODE_DR,&
...
USE GLOBAL_CONSTANTS, ONLY: DUCTNODE_NE
...
USE GLOBAL_CONSTANTS, ONLY: DUCTNODE_NE,DUCT_NE
INTEGER, INTENT(IN)::NETWORK_INDEX
...
USE GLOBAL_CONSTANTS, ONLY: DUCT_NE,HVAC_LOCAL_PRESSURE,OLD,GAMMA,N_ZONE,STRATIFICATION,GVEC,PREVIOUS,GUESS
INTEGER, INTENT(IN)::NETWORK_INDEX
...
USE GLOBAL_CONSTANTS, ONLY: DUCT_NE,PREVIOUS,GUESS,DUCTNODE_NE,HVAC_LOCAL_PRESSURE,GAMMA
INTEGER, INTENT(IN) :: NETWORK_INDEX
INTEGER :: NN,ND, ARRAYLOC1,ARRAYLOC2
TYPE(NETWORK_TYPE), POINTER :: NE
...
NODE_COUNTER = 0
DUCT_COUNTER = 0
CONNECTED_ZONES2 = CONNECTED_ZONES
   ...
   DO ND = 1, N_DUCTS
      ...
      IF (NODE_COUNTER(DU%NODE_INDEX(1)) /= NODE_COUNTER(DU%NODE_INDEX(2))) THEN
         ...
         IF (NODE_COUNTER(DU%NODE_INDEX(1)) <=N_ZONE .AND. NODE_COUNTER(DU%NODE_INDEX(2)) <=N_ZONE) THEN
            CONNECTED_ZONES2(NODE_COUNTER(DU%NODE_INDEX(1)),NODE_COUNTER(DU%NODE_INDEX(2)))=1
            CONNECTED_ZONES2(NODE_COUNTER(DU%NODE_INDEX(2)),NODE_COUNTER(DU%NODE_INDEX(1)))=1
         ENDIF
...
COUNTER = 0
DO ND = 1, N_DUCTS
write(0,*) ND,N_DUCTS,UBOUND(NETWORK),DUCT_COUNTER(ND)
...
USE GLOBAL_CONSTANTS, ONLY: N_NETWORKS
