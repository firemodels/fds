...
plt.text( 8.2, 505, 'SVN '+SVN, fontdict=font3)
...
plt.text( 8.2, 765, 'SVN '+SVN, fontdict=font3)
...
plt.text( 50, 765, 'SVN '+SVN, fontdict=font3)
...
plt.text( 50, 2.02, 'SVN '+SVN, fontdict=font3)
...
plt.text( 50, 0.3037, 'SVN '+SVN, fontdict=font3)
