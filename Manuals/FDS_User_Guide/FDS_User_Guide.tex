...
\end{itemize}
In FDS, the layer thickess is updated according to the ratio of the instantaneous material density and the density of the material in its pure form, i.e. 
...
the size of each condenced phase cell is changed according to the ratio $\delta$
\be
\delta = 
   \begin{cases}
