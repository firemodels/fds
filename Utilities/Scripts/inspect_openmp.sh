...
TARGET=$SVNROOT/FDS_Compilation/openmp_intel_linux_64_inspect
...
inspxe-cl -collect ti3 -knob scope=normal \
          ...
          -- $SVNROOT/FDS_Compilation/openmp_intel_linux_64_inspect/fds_openmp_intel_linux_64_inspect bench2.fds
