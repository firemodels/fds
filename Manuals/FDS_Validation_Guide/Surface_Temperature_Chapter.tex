...
Results of the Frankman vegetation experiments are shown in Fig.~\ref{Frankman_Figs}. Each plot represents a particular fuel sample. ``SmEx15'', for example, is the small excelsior at 15~cm from the burner. Details and references can be found in Section~\ref{Frankman_Vegetation_Description}.
...
This section presents predicted liquid pool fire surface temperatures compared with the respective liquid boiling temperatures. Mass loss rate comparisons are shown in Section~\ref{sec:Liquid_Pool_Fires_MLR}.
