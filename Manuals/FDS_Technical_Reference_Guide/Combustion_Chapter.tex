...
If we look at the primitive species in \ref{eq:lumped_expand} and assume that $\mathbf{Z} = [0.3\, \, 0.2\, \, 0.5]^\mathrm{T}$, we can transform from lumped species to primitive species:
