...
CHARACTER(LABEL_LENGTH) :: PART_ID,RAMP_MF(MAX_SPECIES),RAMP_Q,RAMP_V,RAMP_T,MATL_ID(MAX_LAYERS,MAX_MATERIALS),&
                 ...
                 SPEC_ID(MAX_SPECIES),RAMP_T_B,RAMP_T_I,RAMP_V_X,RAMP_V_Y,RAMP_V_Z,NEAR_WALL_TURBULENCE_MODEL,SURF_DEFAULT
...
NAMELIST /SLCF/ AGL_SLICE,CELL_CENTERED,DB,FACE_CENTERED,FYI,DEBUG,ID,MAXIMUM_VALUE,MESH_NUMBER,&
