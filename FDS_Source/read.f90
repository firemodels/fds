...
IF (TRIM(CHID)=='%INPUTFILENAME%') THEN
...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,PRESSURE_RELAX_FACTOR,RELAXATION_FACTOR,FYI, &
                ...
                NEW_PARTICLE_METHOD,WFDS,PATCH_VELOCITY,OVERWRITE,ENSEMBLE_MEAN_CLOSURE,C_EMC
...
CHARACTER(30) :: PART_ID,SHAPE,MULT_ID,ORIGIN='CENTER',PROF_ID='null'
