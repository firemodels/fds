...
stoichiometric coefficient, $\nu_\C$, represents the number of carbon atoms in the fuel that are converted to soot. It is related to the
{\em soot yield}, $y_s$, via the relation:
\be
   \nu_\C = \frac{W_\F}{W_\C} \; y_s  \label{soot_yield}
\ee
...
\be
   Z = Y_\F + \frac{W_\F}{x W_\COTWO} \, Y_\COTWO + \frac{W_\F}{x W_\CO} \, Y_\CO  + \frac{W_\F}{x W_\C} \, Y_\C
\label{Zdef} \ee
...
Here, $\hbox{x}-\nu_\C$ represents the number of carbon atoms in the fuel molecule that are oxidized; that is, the carbon atoms that are not converted to soot.
...
\end{eqnarray}
All of the various stoichiometric coefficients in these formulae are based on the atomic composition of the fuel molecule, {\em except}
$\nu_\CO$ and $\nu_\C$, which are based on user-specified yields as shown in Eqs.~(\ref{CO_yield})~and~(\ref{soot_yield}).
