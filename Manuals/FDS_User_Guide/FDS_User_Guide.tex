...
\ee
where $\tau_w = \mu\,\partial |\mathbf{u}|/\partial n$ is the viscous stress evaluated at the wall ($\tau_w$ is computed by the wall function, $|\mathbf{u}|$ is taken as an estimate of the streamwise velocity component near the wall); the quantity $u_\tau$ is the \emph{friction velocity}.
...
{\ct YPLUS}                                     & Section~\ref{info:yplus}                      &                & B            \\ \hline
\end{longtable}
