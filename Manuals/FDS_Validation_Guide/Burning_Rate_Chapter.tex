...
\begin{tabular}{|l|c|c|c|c|c|c|c|c|} \hline
        & $\rho$               & $c_p$                        & $k$                &  $\Delta h_{\rm v}$         & $\chi_{\rm r}$       & $y_{\rm s}$          & $T_{\rm b}$                    & $\kappa$  \\
Fuel    & \si{\kg/\m^3}        & \si{\kJ/(\kg.\K)}            & \si{\W/(\m.\K)}    & \si{\kJ/\kg}                &                      &  \si{\g/\g}          & $^\circ$C                      & m$^{-1}$  \\
        & \cite{Babrauskas:1}  & \cite{Webbook:HeatCapacity}  & \cite{CRCHandbook} &  \cite{Webbook:FluidThermo} & \cite{SFPE:Tewarson} & \cite{SFPE:Tewarson} & \cite{Webbook:BoilingPoint}    & See text  \\
\hline \hline
Acetone  &  791  &  2.13   & 0.20  &   501   & 0.27 & 0.014 & 56.3 & 100    \\ \hline
Benzene  &  874  &  1.74   & 0.14  &   393   & 0.60 & 0.181 & 80.3 & 123    \\ \hline
Butane   &  573  &  2.28   & 0.12  &   385   & 0.31 & 0.029 & 0    & 100    \\ \hline
Ethanol  &  794  &  2.44   & 0.17  &   837   & 0.25 & 0.008 & 78.5 & 1534.3 \\ \hline
Heptane  &  675  &  2.24   & 0.14  &   317   & 0.33 & 0.037 & 98.5 & 187.5  \\ \hline
Methanol &  796  &  2.48   & 0.20  &   1099  & 0.16 & 0.001 & 64.8 & 1500   \\ \hline
\end{tabular}
\end{center}
\end{table}
