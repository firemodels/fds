...
PRIVATE
CHARACTER(255), PARAMETER :: presid='$Id: pres.f90,v 1.7 2007/02/08 22:04:47 mcgratta Exp $'
PUBLIC PRESSURE_SOLVER,COMPUTE_A_B,UPDATE_PRESSURE,COMPUTE_CORRECTION_PRESSURE,COMPUTE_C
...
!
IF (ABS(POIS_PTB)>1.E-5_EB) WRITE(0,*) ' POIS_PTB=',POIS_PTB, ' MESH=',NM
!
DO K=1,KBAR
   DO J=1,JBAR
      DO I=1,IBAR
