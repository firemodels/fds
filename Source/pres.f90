...
!WRITE(77,*) '================== PRES ====================='
!WRITE(77,*) 'UU:'
!WRITE(77,'(6E18.10)')  (((UU(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'VV:'
!WRITE(77,'(6E18.10)')  (((VV(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'WW:'
!WRITE(77,'(6E18.10)')  (((WW(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'FVX:'
!WRITE(77,'(6E18.10)')  (((FVX(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'FVY:'
!WRITE(77,'(6E18.10)')  (((FVY(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'FVZ:'
!WRITE(77,'(6E18.10)')  (((FVZ(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'HP:'
!WRITE(77,'(6E18.10)')  (((HP(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'RHOP:'
!WRITE(77,'(6E18.10)')  (((RHOP(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'DDDT:'
!WRITE(77,'(6E18.10)')  (((DDDT(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
ENDIF
...
USE GLOBAL_CONSTANTS, ONLY: PREDICTOR,VELOCITY_ERROR_MAX,SOLID_BOUNDARY,INTERPOLATED_BOUNDARY,VELOCITY_ERROR_MAX_LOC,T_USED,&
                            EXTERNAL_BOUNDARY_CORRECTION, MYID
...
!WRITE(77,*) 'U:'
!WRITE(77,'(6E18.10)')  (((U(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'V:'
!WRITE(77,'(6E18.10)')  (((V(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'W:'
!WRITE(77,'(6E18.10)')  (((W(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'FVX:'
!WRITE(77,'(6E18.10)')  (((FVX(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
!WRITE(77,*) 'FVY:'
!WRITE(77,'(6E18.10)')  (((FVY(II,JJ,KK),II=0,5),JJ=1,1),KK=5,0,-1)
...
CHECK_WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   IF (PREDICTOR) THEN
      SELECT CASE(IOR)
         ...
         CASE(-1)
!!!WRITE(77,'(E18.10)') UN_NEW
            UN_NEW = U(II-1,JJ,KK) - DT*(FVX(II-1,JJ,KK) + RDXN(II-1)*(H(II,JJ,KK)-H(II-1,JJ,KK))*DHFCT)
!!!WRITE(77,'(E18.10)') FVX(II-1,JJ,KK) + RDXN(II-1)*(H(II,JJ,KK)-H(II-1,JJ,KK))
!!!WRITE(77,'(E18.10)') DT*(FVX(II-1,JJ,KK) + RDXN(II-1)*(H(II,JJ,KK)-H(II-1,JJ,KK)))
!!!WRITE(77,'(E18.10)') U(II-1,JJ,KK) - DT*(FVX(II-1,JJ,KK) + RDXN(II-1)*(H(II,JJ,KK)-H(II-1,JJ,KK)))
!!!WRITE(77,'(E18.10)') UN_NEW
!!!WRITE(77,'(A,6E18.10, 4i4)') 'H1: IOR=-1:',U(II-1,JJ,KK),FVX(II-1,JJ,KK),H(II,JJ,KK),H(II-1,JJ,KK),RDXN(II-1),UN_NEW,II,JJ,KK,IOR
         CASE( 2)
   ...
   ELSE
      ...
      END SELECT
!!!WRITE(77,'(A,2E18.10, 3I4)') 'H2: DT, UN_NEW =',DT, UN_NEW, II,JJ,KK
