...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           CO_PRODUCTION=.FALSE.,ACCUMULATE_WATER=.FALSE.,WRITE_XYZ=.FALSE., &
           ...
           CONSTANT_SPECIFIC_HEAT=.FALSE., NEW_EVAP=.FALSE.,NEW_EVAP_DROP=.FALSE., &
           ...
           HISTOGRAM_FILE=.FALSE.,TENSOR_DIFFUSIVITY=.FALSE.,&
...
LOGICAL :: SIMPLE_CHEM = .TRUE.,EDC = .FALSE.
REAL(EB) :: RSUM0
...
REAL(EB) :: DT_SLCF,DT_BNDC,DT_BNDE,DT_BNDF,DT_DEVC,DT_DEVC_LINE,DT_PL3D,DT_PART,DT_RESTART,DT_ISOF,DT_HRR,DT_MASS,DT_PROF,DT_CTRL,&
            DT_FLUSH,DT_SL3D,DT_GEOC,DT_GEOM
...
INTEGER                              :: LU_EVACCSV,LU_EVACEFF,LU_EVACFED,LU_EVACOUT,LU_HISTOGRAM,LU_SFBC=-1,LU_SFCO=-1
...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: AAS,BBS,CCS,DDS,DDT,DX_S,RDX_S,RDXN_S,DX_WGT_S, &
                                       K_S,RHOCBAR,C_S,RHO_S,Q_S,KAPPA_S,X_S_NEW,R_S,MF_FRAC,SHRINK_FACTOR,R_S_NEW
