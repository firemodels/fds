...
IF (INIT_HRRPUV) CALL ADD_VOLUMETRIC_HEAT_SOURCE(T)
...
!> \brief Add a fixed volumetric heat source via the parameter HRRPUV on the INIT line
!> \param T Time (s)

SUBROUTINE ADD_VOLUMETRIC_HEAT_SOURCE(T)
