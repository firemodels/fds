...
\flushright{(Draft: August 3, 2007)}
...
Natl.~Inst.~Stand.~Technol.~Spec.~Publ.~1072, 47 pages (September 2007) \\
CODEN: NSPUE2 }
...
guide.
Smokeview uses the 3D graphics library called OpenGL to visualizing fire and smoke data.
This library is
...
Each visualization technique hilights a different aspect of the data.
...
This report is organized as follows.  Chapter \ref{chapter:fundamentals} discusses graphical concepts
fundamental to Smokeview's display of data. These fundamentals or basic building blocks are used by each of the techniques discussed later for visualizing data, in particular, smoke visualization.  Smokeview visualization may be performed using quantitative and realistic techniques.  Realistic display of data refers to the intent of displaying data in a form as it would actually appear.


\chapter{Fundamentals}
\label{chapter:fundamentals}
Smokeview uses the 3D graphics library, OpenGL, to visualize data.
This data takes many forms.  Some data is static and while other data evolves with time.
Some data represents geometric objects while other data represents the solution to the flow equations.
The purpose of visualization in general and Smokeview in particular is to gain understanding
or insight into the underlying phenomena being studied.  In the case of Smokeview, to
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=3.5in]{figures/shapes}
\end{center}
...
\end{figure}
\section{Objects} The fundamental object in OpenGL is a vertex.
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=2.5in]{figures/th_transparent}&
\includegraphics[width=2.5in]{figures/th_solid}\\
transparent&solid\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=2.5in]{figures/th_unlit}&\includegraphics[width=2.5in]{figures/th_lit}\\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=2.5in]{figures/triangle_normal}&\includegraphics[width=2.5in]{figures/triangle_normal2}\\
\includegraphics[width=2.5in]{figures/sphere_facet}&\includegraphics[width=2.5in]{figures/sphere_lit}\\
...
\section{Lighting} OpenGL uses two shading models for drawing
...
\section{Movement} The previous sections discussed how appearance
...
\section{Projection and Viewports}
\begin{figure}[t]
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=2.75in]{figures/figviewport}&
\includegraphics[width=2.75in]{figures/figviewport2}\\
...
\section{Graphics Library Utility Toolkit - GLUT} OpenGL by design draws
...
\section{Rendering Smokeview Images}
...
% .............. new section ..............................
%
\chapter{Quantitative Visualization}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=2.5in]{figures/rainbowcolor}&\includegraphics[height=2.5in]{figures/3dcolorcube}\\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=2.5in]{figures/interpcolorrgb}&
\includegraphics[height=2.5in]{figures/interpcolorindex}\\
a) colors interpolated within color cube&b) colors interpolated within the colorbar\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=2.5in]{figures/plume5a_part}&
\includegraphics[height=2.5in]{figures/plume5b_part}\\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=2.5in]{figures/plume5a_streak}&
 \includegraphics[height=2.5in]{figures/plume5b_streak}\\
a) Open plume&b) Partially obstructed plume\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ll}
 \includegraphics[height=2.5in]{figures/thouse5c_slice}&
 \includegraphics[height=2.5in]{figures/thouse5c_vslice}\\
a) Shaded temperature contours.&b) Colored flow vectors.\\
\end{tabular}
\end{center}
...
\section{Contours}
Smokeview uses contours to identify {\em where}\ rather than {\em how much}\ a specified level occurs.  Smokeview uses several methods for generating contours such as marching squares or marching cubes\cite{marchingcubes}.  These {\em marching}\ algorithms work by reducing the general contouring problem to that of finding the contour in an elementary figure such as a square or a cube.  Marching
squares are used for finding 2D contours in a plane and marching cubes are used for finding isosurfaces in a volume.
The general contouring problem is the solved by splitting the solution domain into a series of figures, solving the contouring problem for each figure and finally assembling the solution acquired from all the parts.  More details are discussed in the next few sections.
...
\subsection{3D Contours - Isosurfaces}
...
\end{center}
\caption{3D isosurface canonical forms.
  }
\label{figisosetup}%
\end{figure}
...
\begin{figure}[\figoptions]
\begin{center}
\includegraphics[width=7.0in]{figures/plume5a_iso_full}\\
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=3.5in]{figures/plume5a_iso_lines}&
\includegraphics[width=3.5in]{figures/plume5a_iso_solid}\\
line view&solid view
\end{tabular}
\end{center}
\caption{Snapshot of an isosurface for temperature at 100 \degC (212 \degF).
  }
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=2.0in]{figures/decimate_before}&
\includegraphics[width=2.0in]{figures/decimate_after}\\
...
\begin{figure}[\figoptions]
\begin{center}
\includegraphics[width=3.5in]{figures/3point_line_smooth}
\end{center}
...
\chapter{Realistic Visualization}
\begin{figure}[t]
\begin{center}
\begin{tabular}{cc}
...
\section{Computing Opacity}
\begin{figure}[t]
\begin{center}
\includegraphics[width=3.5in]{figures/smoke_setup}
\end{center}
...
\begin{figure}[t]
\centerline{\includegraphics[width=3.0in]{figures/forney_figure4}}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=2.5in]{figures/splume_20_27}&\includegraphics[width=2.5in]{figures/splume_17_27}\\
slices 20 to 27&slices 17 to 27\\
\includegraphics[width=2.5in]{figures/splume_14_27}&\includegraphics[width=2.5in]{figures/splume_11_27}\\
...
\section{Smoke plane orientation}
