...
$QFDS $DEBUG -p 16 $QUEUE -d $INDIR Sandia_He_1m_dx6cm.fds
...
$QFDS $DEBUG -p 16 $QUEUE -d $INDIR Sandia_He_1m_dx3cm.fds
...
$QFDS $DEBUG -p 16 $QUEUE -d $INDIR Sandia_He_1m_dx1p5cm.fds
