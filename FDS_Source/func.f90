...
SUBROUTINE OPENMP_PRINT_STATUS
  USE GLOBAL_CONSTANTS, ONLY : LU_ERR, USE_MPI, MYID, N_MPI_PROCESSES
  INTEGER :: THREAD_ID
  ...
  !$OMP CRITICAL
  IF (USE_OPENMP .AND. USE_MPI) WRITE(LU_ERR,91) " OpenMP thread ",THREAD_ID," of ",OPENMP_USED_THREADS-1,&
     " assigned to MPI process ",MYID," of ",N_MPI_PROCESSES-1
  IF (.NOT.USE_OPENMP .AND. USE_MPI) WRITE(LU_ERR,92) " MPI process ",MYID," of ",N_MPI_PROCESSES-1
  IF (USE_OPENMP .AND. .NOT.USE_MPI) WRITE(LU_ERR,93) " OpenMP thread ",THREAD_ID," of ",OPENMP_USED_THREADS-1,&
        " is running"
  !$OMP END CRITICAL

  !$OMP END PARALLEL

  91 FORMAT(A,I3,A,I3,A,I3,A,I3)
  92 FORMAT(A,I3,A,I3)
