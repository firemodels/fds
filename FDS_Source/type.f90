...
TYPE SPECIES_TYPE
   ...
   CHARACTER(30) :: ID,FORMULA,RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   REAL(EB) :: MW , RCON, ZZ0=0._EB, MASS_EXTINCTION_COEFFICIENT=0._EB,ADJUST_NU=1._EB
   CHARACTER(30), POINTER, DIMENSION(:) :: SPEC_ID
   CHARACTER(30) :: ID='null',FORMULA='null'
   LOGICAL :: DEPOSITING=.FALSE.
...
TYPE REACTION_TYPE
   ...
   CHARACTER(30), DIMENSION(:), POINTER :: SMIX_ID,SMIX_ID_READ
   REAL(EB) :: C,H,N,O,EPUMO2,HEAT_OF_COMBUSTION,HOC_COMPLETE,BOF,E,N_F=0._EB,N_O=0._EB, &
      Y_O2_INFTY,Y_N2_INLET=0._EB,Y_N2_INFTY=0._EB,MW_FUEL,MW_SOOT, &
      CO_YIELD,SOOT_YIELD,H2_YIELD, SOOT_H_FRACTION, &
      CRIT_FLAME_TMP,Y_F_LFL,Y_O2_LL,O2_F_RATIO=0._EB,Z_F=0._EB,Z_F_CONS=0._EB, &
      NU_O2=0._EB,NU_N2,NU_H2O=0._EB,NU_CO2=0._EB,NU_H2=0._EB,NU_CO=0._EB,NU_SOOT=0._EB
   ...
   INTEGER :: FUEL_SMIX_INDEX=-1,MODE,N_COLLISION_SPECIES=0,N_SMIX=0
   INTEGER, DIMENSION(:), POINTER :: COLLISION_SPECIES
