...
TYPE MESH_TYPE
   ...
   INTEGER :: N_WALL_CELLS,N_WALL_CELLS_DIM,N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS
   INTEGER :: N_THIN_WALL_CELLS,N_THIN_WALL_CELLS_DIM
   ...
   INTEGER :: N_BOUNDARY_COORD_DIM,N_BOUNDARY_ONE_D_DIM,N_BOUNDARY_THR_D_DIM,N_BOUNDARY_PROPS_DIM,N_BOUNDARY_RADIA_DIM
...
INTEGER, POINTER, DIMENSION(:,:,:) :: THIN_WALL_INDEX
