...
INTEGER, POINTER, DIMENSION(:) :: DEVC_PIPE_OPERATING
...
TYPE DEVICE_TYPE
   ...
   INTEGER  :: OUTPUT_INDEX,IOR,WALL_INDEX,ORDINAL,I,J,K,MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,I_DEPTH,N_PATH,N_T_E,PROP_INDEX,&
               TRIP_DIRECTION,CTRL_INDEX,N_INPUTS,SURF_INDEX=-1,Z_INDEX=-999,Y_INDEX=-999,PART_INDEX=0,&
               VELO_INDEX=0
   INTEGER  :: DUCT_INDEX=-1,NODE_INDEX(2)=-1,POINT=1,LINE=0,LINE_COORD_CODE=123,PIPE_INDEX=1,LP_TAG=0
...
INTEGER :: N_PROP,N_DEVC,N_DEVC_TIME,N_DEVC_LINE,MAX_DEVC_LINE_POINTS
...
TYPE CONTROL_TYPE
   ...
   REAL(EB) :: SETPOINT(2)=1000000._EB, DELAY=0._EB, T_CHANGE=1000000._EB ,CYCLE_TIME=1000000._EB,CONSTANT=-9.E30_EB,INSTANT_VALUE
...
INTEGER, PARAMETER :: AND_GATE=1, OR_GATE=2, XOR_GATE=3, X_OF_N_GATE=4, TIME_DELAY=5, DEADBAND=6, CYCLING=7, &
                      CUSTOM=8,KILL=9,CORE_DUMP=10,CF_SUM=11,CF_SUBTRACT=12,CF_MULTIPLY=13,CF_DIVIDE=14,CF_POWER=15,&
