...
TYPE SURFACE_TYPE
   ...
   REAL(EB) :: VEG_LSET_IGNITE_T,VEG_LSET_ROS_HEAD,VEG_LSET_ROS00,VEG_LSET_QCON,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK, &
...
TYPE OMESH_TYPE
   ...
   INTEGER :: NICC_S(2)=0, NICC_R(2)=0, NFCC_S(2)=0, NFCC_R(2)=0, NCC_INT_R=0, NFEP_R(3)=0
   REAL(EB), ALLOCATABLE, DIMENSION(:) ::                &
