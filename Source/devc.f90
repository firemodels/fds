...
TYPE SUBDEVICE_TYPE
   REAL(EB) :: INSTANT_VALUE,AVERAGE_VALUE=0._EB,AVERAGE_VALUE2=0._EB,RMS_VALUE=0._EB,RMS_VALUE2=0._EB,COV_VALUE=0._EB,&
               VALUE=0._EB,SMOOTHED_VALUE=-1.E10_EB,X1,X2,Y1,Y2,Z1,Z2,TIME_INTERVAL=0._EB
   INTEGER :: MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1
...
TYPE DEVICE_TYPE
   ...
   REAL(EB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INITIAL_VALUE=-1.E10_EB,INSTANT_VALUE,VALUE=0._EB,SMOOTHED_VALUE=-1.E10_EB, &
               DEPTH,TMP_L,Y_C,OBSCURATION,DELAY,ROTATION,SMOOTHING_FACTOR=0._EB,&
               ...
               TIME_INTERVAL=0._EB,TIME_MIN_VALUE=999._EB,TIME_MAX_VALUE=-999._EB,QUANTITY_RANGE(2),STATISTICS_START=-1.E20_EB,&
               OVEC(3),CELL_L=-1._EB
   ...
   INTEGER  :: N_SUBDEVICES=0,OUTPUT_INDEX,OUTPUT2_INDEX,IOR,IOR_ASSUMED=0,WALL_INDEX=-1,ORDINAL,I,J,K,MESH,&
               ...
               TRIP_DIRECTION,CTRL_INDEX=-1,N_INPUTS,SURF_INDEX=-1,Z_INDEX=-999,Y_INDEX=-999,MATL_INDEX=-999,&
               PART_CLASS_INDEX=0,REAC_INDEX=0,&
               VELO_INDEX=0,NO_UPDATE_DEVC_INDEX=-1,NO_UPDATE_CTRL_INDEX=-1,CFACE_INDEX=-1,FED_ACTIVITY=2,GHOST_CELL_IOR(3)=0
   ...
   CHARACTER(LABEL_LENGTH) :: ID,PROP_ID,QUANTITY,QUANTITY2,CTRL_ID,DEVC_ID,STATISTICS='null',&
                    ...
                    SMOKEVIEW_BAR_LABEL,UNITS='null',XYZ_UNITS='m',DUCT_ID='null',NODE_ID(2)='null',&
