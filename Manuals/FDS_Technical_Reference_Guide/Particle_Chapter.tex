...
\be
    ...
    (\bu_d-\bu) |\bu_d-\bu| - \frac{\bu_d}{m_d} \frac{\d m_d}{\d t}
\ee
...
Catwalk grating, expanded metal mesh, window screens, and similar thin porous materials are commonly found in buildings.  For a
...
\be \frac {\d p}{\d x} \; = \; \frac{K}{\mu} u \; + \; \rho \frac{Y}{\sqrt{K}}u^2\ee
...
\be K \; = \; 3.44 \times 10^{-9}\varepsilon^{1.6} \quad ; \quad Y \; = \; 4.30 \times 10^{-2}\varepsilon^{2.13} \ee
