...
ALLOCATE(M%BOUNDARY_PROPERTY(1:M%N_BOUNDARY_PROPERTY_DIM))
...
ALLOCATE(M%BOUNDARY_PROPERTY_OCCUPANCY(1:M%N_BOUNDARY_PROPERTY_DIM))  ; M%BOUNDARY_PROPERTY_OCCUPANCY = 0
