...
Figures~\ref{Memorial_Tunnel_VF_1} through \ref{Memorial_Tunnel_VF_3} display the measured and predicted volume flow at the uphill entrance of the tunnel (Loop~214).
...
\end{tabular*}
\caption[Memorial Tunnel experiments, volume flow, Tests 501-502]{Memorial Tunnel experiments, volume flow, Tests 501-502.}
\label{Memorial_Tunnel_VF_1}
\end{figure}
...
\end{tabular*}
\caption[Memorial Tunnel experiments, volume flow, Tests 605-615B]{Memorial Tunnel experiments, volume flow, Tests 605-615B.}
\label{Memorial_Tunnel_VF_2}
\end{figure}
...
\end{tabular*}
\caption[Memorial Tunnel experiments, volume flow, Tests 617A-625B]{Memorial Tunnel experiments, volume flow, Tests 617A-625B.}
\label{Memorial_Tunnel_VF_3}
\end{figure}
