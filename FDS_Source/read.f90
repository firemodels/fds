...
NAMELIST /MISC/ AGGLOMERATION,AEROSOL_AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,&
                ...
                SHARED_FILE_SYSTEM,SLIP_CONDITION,SMOKE_ALBEDO,SOLID_HT3D,SOLID_PHASE_ONLY,SOOT_OXIDATION,&
...
NAMELIST /OBST/ ALLOW_VENT,BNDF_FACE,BNDF_OBST,BULK_CONDUCTIVITY,BULK_DENSITY,BULK_SPECIFIC_HEAT,&
                COLOR,CTRL_ID,DEVC_ID,EVACUATION,FYI,ID,MESH_ID,MULT_ID,NOTERRAIN,&
      ...
      K_MULT_LOOP: DO KK=MR%K_LOWER,MR%K_UPPER
         J_MULT_LOOP: DO JJ=MR%J_LOWER,MR%J_UPPER
            I_MULT_LOOP: DO II=MR%I_LOWER,MR%I_UPPER
               ...
               ENDIF
               IF (SOLID_HT3D .AND. &
                  (OB%BULK_CONDUCTIVITY==-1._EB .OR. OB%BULK_DENSITY==-1._EB .OR. OB%BULK_SPECIFIC_HEAT==-1._EB)) THEN
                  WRITE(MESSAGE,'(A,I5,A)')  'ERROR: Problem with OBST number',NN,', SOLID_HT3D requires bulk properties'
               ENDIF
