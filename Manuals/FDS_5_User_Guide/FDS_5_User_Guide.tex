...
\footnotesize
\begin{verbatim}
&DEVC XYZ=..., QUANTITY='DENSITY', SPEC_ID='soot', ID='soot1', DEVC_ID='asp1', FLOWRATE=0.1, DELAY=20 /
&DEVC XYZ=..., QUANTITY='DENSITY', SPEC_ID='soot', ID='soot2', DEVC_ID='asp1', FLOWRATE=0.2, DELAY=10 /
 ...
&DEVC XYZ=..., QUANTITY='DENSITY', SPEC_ID='soot', ID='sootN', DEVC_ID='asp1', FLOWRATE=0.3, DELAY=30 /
...
{\ct OPTICAL DENSITY}                           & $K$ (Section~\ref{info:visibility})           & 1/m            & D,I,P,S      \\ \hline
{\ct OPTICAL DEPTH}                             & $K/2.3$ (Section~\ref{info:visibility})       & 1/m            & D,I,P,S      \\ \hline
