SUBROUTINE FDS2LS_DYNA (CHID,NOMASTER,C_S,TBEG,TEND,TINT,COUNTER,VARIABLE,N,N_AVERAGE,BOUNDARY)
...
INTEGER COUNTER,CURVE,LOCATION
...
DO I=1,V-1
  WRITE (70,'(E12.5,A,E12.5)') V_TIME(I), ", ", TAST(I)
ENDDO
...
ELSE
    ...
    WRITE (70,'(E12.5,A,E12.5)') V_TIME(V)+TINT, ", ", MED
    WRITE (70,'(E12.5,A,E12.5)') 18000.0, ", ", MED
