...
NAMELIST /MISC/ AEROSOL_SCRUBBING, AGGLOMERATION,AEROSOL_AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,&
                ...
                IBLANK_SMV,MAX_LEAK_PATHS,MAXIMUM_GEOMETRY_FACES,MAXIMUM_GEOMETRY_ZVALS,MAXIMUM_VISIBILITY,MPI_TIMEOUT,&
...
NAMELIST /MATL/ A,ABSORPTION_COEFFICIENT,ALLOW_SHRINKING,ALLOW_SWELLING,ALPHA_CHAR,BETA_CHAR,BOILING_TEMPERATURE,&
                ...
                GAS_DIFFUSION_DEPTH,HEATING_RATE,HEAT_OF_COMBUSTION,HEAT_OF_REACTION,HEAT_OF_REACTION_RAMP,ID,MATL_ID,NU_MATL,&
                NU_SPEC,N_REACTIONS,&
                N_S,N_T,N_O2,NU_O2_CHAR,PCR,POROSITY,PYROLYSIS_RANGE,REFERENCE_RATE,REFERENCE_TEMPERATURE,REFRACTIVE_INDEX,RGB,&
