...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Wall_Heat_Flux} \\
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Ceiling_Heat_Flux}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Floor_Heat_Flux} \\
