...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=17,N_WALL_SCALAR_INTEGERS=15,N_WALL_SCALAR_LOGICALS=0
...
TYPE WALL_TYPE
   ...
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,Q_LEAK,U_TAU,UVW_GHOST,UW0,V_DEP,VEL_ERR_NEW,XW,Y_PLUS,YW,ZW,Z_STAR
