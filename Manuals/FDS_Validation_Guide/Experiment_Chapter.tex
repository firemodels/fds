...
The NIST Full Scale Enclosure Experiments are a series of experiments conducted in an ISO-9705 compartment~\cite{Lock:1}. The experiments were designed to study the effects of fuel type, fuel distribution, and vent size on underventilated compartment fires. Twenty-nine experiments were considered as part of the analysis that included 7 different fuels, 3 fuel sources, and 4 ventilation openings. Table~\ref{tab:NIST_FSE_Exp} provides a summary of the experiments. Species concentrations, including CO concentration, were made at the front and rear of the compartment.
...
\hline
Test ID  &  Fuel         &  Fuel Mass (kg) &  \# of Burners  &  Burner Size (m$^2$) &  Doorway (cm)  \\ \hline \hline
