!     Last change:  JEF  25 May 2007   10:28 am
MODULE DEVICE_VARIABLES
 
USE PRECISION_PARAMETERS
IMPLICIT NONE

CHARACTER(255), PARAMETER :: devcid='$Id: devc.f90,v 1.16 2007/03/28 14:28:09 mcgratta Exp $'
...
TYPE PROPERTY_TYPE
   ...
   INTEGER  :: PART_INDEX,FLOW_RAMP_INDEX,SPRAY_PATTERN_INDEX
   CHARACTER(30) :: SMOKEVIEW_ID,PART_ID,ID,QUANTITY,TABLE_ID
...
TYPE DEVICE_TYPE
   ...
   CHARACTER(30) :: ID,PROP_ID,QUANTITY,CTRL_ID, DEVC_ID
