...
\subsubsection{Back Side Boundary Conditions}
...
The burnout time of a reacting solid fuel is calculated automatically based on the
...
\chapter{User-Specified Functions: The \texorpdfstring{{\tt RAMP}}{RAMP} and \texorpdfstring{{\tt TABL}}{TABL} Namelist Groups}
\label{info:RAMP}
\label{info:TABL}
