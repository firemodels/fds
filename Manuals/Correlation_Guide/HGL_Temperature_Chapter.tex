...
This sample case is Test 51 from the LLNL (Lawrence-Livermore National Laboratory) series. The test facility included a simple compartment with an open door, a natural gas burner, and no forced ventilation.
