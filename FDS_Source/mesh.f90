...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: &
            ...
            MU,TMP,Q,Q_AVG,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_VAP, &
   ...
   ! NEW TURB_ARRAYS to prevent ThreadChecker warning
   REAL(EB), POINTER, DIMENSION(:,:,:) :: TURB_WORK13,TURB_WORK14,TURB_WORK15,TURB_WORK16
   REAL(EB), POINTER, DIMENSION(:,:,:) :: TURB_WORK17,TURB_WORK18,TURB_WORK19
...
USE PRECISION_PARAMETERS
USE MESH_VARIABLES
USE GLOBAL_CONSTANTS, ONLY: PERIODIC_TEST,DYNSMAG,FLUX_LIMITER
IMPLICIT NONE
...
IF (DYNSMAG) THEN
   ...
   !NEW ARRAYS to prevent ThreadChecker warnings
