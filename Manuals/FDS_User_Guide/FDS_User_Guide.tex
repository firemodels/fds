...
\hline
Key Parameter                          & Section                        & {\ct 'DNS'} & {\ct 'LES'}  & {\ct 'VLES'}  & {\ct 'VVLES'}  \\ \hline \hline
{\ct BAROCLINIC}                       & \ref{baroclinic_torque}        & T           & T            & T             & F              \\ \hline
{\ct CFL\_VELOCITY\_NORM}              & \ref{info:CFL}                 & 0           & 1            & 1             & 3              \\ \hline
...
\vskip\baselineskip
\noindent
{\ct CFL\_VELOCITY\_NORM=0} (LES and VLES default, corresponds to $L_\infty$ norm of velocity vector)
    \begin{equation}
...
{\ct CFL\_VELOCITY\_NORM=2} ($L_2$ norm of velocity vector)
    ...
    \end{equation}
{\ct CFL\_VELOCITY\_NORM=3} (VVLES default, least restrictive, corresponds to $L_\infty$ norm of velocity vector without the velocity divergence)
    \begin{equation}
    \frac{\|\mathbf{u}\|}{\Delta} = \max \left(\frac{|u|}{\delta x}, \frac{|v|}{\delta y}, \frac{|w|}{\delta z}\right)
    \end{equation}
