...
REAL(EB) :: TEXTURE_HEIGHT, TEXTURE_WIDTH, TEXTURE_CENTER(3)
...
NAMELIST /GEOM/ AZIM, AZIM_DOT, COMPONENT_ONLY, DAZIM, DELEV, DSCALE, DXYZ0, DXYZ, &
                ...
                SCALE_DOT, SURF_ID, TEXTURE_CENTER, TEXTURE_HEIGHT, TEXTURE_MAP, TEXTURE_TYPE, TEXTURE_WIDTH,&
...
READ_GEOM_LOOP: DO N=1,N_GEOMETRY
   ...
   TEXTURE_CENTER = 0.0
   TEXTURE_MAP = 'null'
   TEXTURE_HEIGHT = 1.0_EB
   TEXTURE_WIDTH = 1.0_EB
   TEXTURE_TYPE = 'XY'
