...
REAL(EB) :: DUDX,DUDY,DUDZ,DVDX,DVDY,DVDZ,DWDX,DWDY,DWDZ,SS,S12,S13,S23,DELTA,CS,YY_GET(1:N_TRACKED_SPECIES), &
...
ELSE
   ...
   WW => WS
   RHOP => RHOS
   IF (N_TRACKED_SPECIES > 0 .AND. .NOT.EVACUATION_ONLY(NM)) YYP => YYS
ENDIF
...
REAL(EB) :: UODX,VODY,WODZ,UVW,UVWMAX,R_DX2,MU_MAX,MUTRM,CP,YY_GET(1:N_TRACKED_SPECIES)
...
DEVC_LOOP: DO N=1,N_DEVC
   ...
   IF (.NOT.DV%CURRENT_STATE) CYCLE DEVC_LOOP
