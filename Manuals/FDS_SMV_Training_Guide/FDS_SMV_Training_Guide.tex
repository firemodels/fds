...
\begin{center}
\begin{tabular}{cc}
 \includegraphics[height=2.5in]{scriptfigures/flashover_3dsmoke_fire_150}&
 \includegraphics[height=2.5in]{scriptfigures/flashover_slice_temp_150}\\
...
\begin{center}
\begin{tabular}{c}
 \includegraphics[height=4.0in]{datafigures/MCFRS_Flashover_00_hrr}\\
\end{tabular}
\end{center}
