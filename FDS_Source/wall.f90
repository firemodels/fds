...
USE MATH_FUNCTIONS, ONLY : EVALUATE_RAMP
REAL(EB) :: T,RHO_YY_OTHER(MAX_SPECIES),YY_EXTERIOR(MAX_SPECIES), &
            YY_G,YY_G_ALL(MAX_SPECIES),RHO_G,UN,DD,MFT,TSI,ARO,UWO,RADIUS,AREA,RVC,RHO_NEW,M_DOT_PPP,CP,MW_RATIO,H_G,DELTA_H_G
   ...
   METHOD_OF_MASS_TRANSFER: SELECT CASE(SF%SPECIES_BC_INDEX)
      ...
      CASE (INTERPOLATED_BC) METHOD_OF_MASS_TRANSFER
         ...
         DO KKO=IJKW(12,IW),IJKW(15,IW)
            ...
            ENDDO
         ENDDO
         YY_F(IW,1:N_SPECIES)      = RHO_YY_OTHER(1:N_SPECIES)/RHO_F(IW)
...
REAL(EB) :: DTMP,QNETF,QDXKF,QDXKB,RR,TMP_G,T,RFACF,RFACB,RFACF2,RFACB2, &
            PPCLAUS,PPSURF,TMP_G_B,DT_BC, CP,&
...
REAL(EB) :: SMALLEST_CELL_SIZE(MAX_LAYERS),THICKNESS,YY_G_ALL(1:N_SPECIES),YY_GET(1:N_SPECIES)
