...
CHARACTER(LABEL_LENGTH) :: PART_ID,RAMP_MF(MAX_SPECIES),RAMP_Q,RAMP_V,RAMP_T,MATL_ID(MAX_LAYERS,MAX_MATERIALS),&
                 ...
                 SPEC_ID(MAX_SPECIES),RAMP_TMP_GAS_BACK,RAMP_V_X,RAMP_V_Y,RAMP_V_Z,RAMP_TMP_GAS_FRONT,NEAR_WALL_TURBULENCE_MODEL,&
                 SURF_DEFAULT
...
NAMELIST /SURF/ ADIABATIC,AREA_MULTIPLIER,BACKING,BURN_AWAY,BURN_DURATION,&
                ...
                RAMP_PART,RAMP_Q,RAMP_T,RAMP_TMP_GAS_BACK,RAMP_TMP_GAS_FRONT,RAMP_V,RAMP_V_X,RAMP_V_Y,RAMP_V_Z,&
                REFERENCE_HEAT_FLUX,REFERENCE_HEAT_FLUX_TIME_INTERVAL,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   ALLOCATE(SF%RAMP_INDEX(-10:N_TRACKED_SPECIES),STAT=IZERO)
   ...
   IF (RAMP_TMP_GAS_FRONT/='null') CALL GET_RAMP_INDEX(RAMP_TMP_GAS_FRONT,'TIME',SF%RAMP_INDEX(TIME_TGF))
   IF (RAMP_TMP_GAS_BACK /='null') CALL GET_RAMP_INDEX(RAMP_TMP_GAS_BACK ,'TIME',SF%RAMP_INDEX(TIME_TGB))
