...
PROC_MATL_LOOP: DO N=1,N_MATL
   ...
   IF (ML%I_RAMP_C_S > 0) THEN
      ...
      IF (.NOT.RAMPS(ML%I_RAMP_C_S)%DEP_VAR_UNITS_CONVERTED) THEN
         RAMPS(ML%I_RAMP_C_S)%INTERPOLATED_DATA(:) = RAMPS(NR)%INTERPOLATED_DATA(:)*1000._EB/TIME_SHRINK_FACTOR
   ...
   DO NR=1,ML%N_REACTIONS
      IF (ML%I_RAMP_H_R(NR)>0) THEN
         ...
         ENDIF
         DO I=0,I_MAX_TEMP
            ML%H_R(NR,I)=EVALUATE_RAMP(REAL(I,EB),0._EB,ML%I_RAMP_H_R(I))
         ENDDO
      ENDIF
   ENDDO
...
REAL(EB) :: DEPTH,ORIENTATION(3),ROTATION,SETPOINT,FLOWRATE,BYPASS_FLOWRATE,DELAY,XYZ(3),CONVERSION_FACTOR,CONVERSION_ADDEND, &
            ...
            TIME_PERIOD,FORCE_DIRECTION(3),XI,YJ,ZK,XBP(6),DX,DY,DZ,POINTS_ARRAY_X(100),POINTS_ARRAY_Y(100),POINTS_ARRAY_Z(100)
