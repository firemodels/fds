...
SELECT CASE (SPEC_ID_USE)
   ...
   CASE('ACETYLENE')
      ...
      G_F = 0.00000008_EB*TE**2._EB-0.0554*TE+225.1_EB !kJ/mol
      FUEL = .TRUE.
   CASE('ACROLEIN')
      IF (TE<50._EB) THEN
   ...
   CASE('CARBON DIOXIDE')
      ...
      ENDIF
      G_F = 0.0000007_EB*TE**2._EB-0.0028*TE-393.62_EB !kJ/mol
   ...
   CASE('CARBON MONOXIDE')
      ...
      ENDIF
      G_F = 0.000002_EB*TE**2._EB-0.0903_EB*TE-111.44_EB !kJ/mol
   ...
   CASE('FORMALDEHYDE')
      ...
      G_F = -0.00000000000000006_EB*TE**5+0.000000000001_EB*TE**4-0.000000007_EB*TE**3+0.00002*TE**2-0.0107_EB-114.18_EB !kJ/mol 
   CASE('HYDROGEN')
      IF (TE<100._EB) THEN
   ...
   CASE('WATER VAPOR')
      ...
      ENDIF
      G_F = 0.0000007_EB*TE**2._EB+0.0538*TE-245.25_EB !kJ/mol 
