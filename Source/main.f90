...
TYPE (MPI_REQUEST), ALLOCATABLE, DIMENSION(:) :: REQ,REQ1,REQ2,REQ3,REQ4,REQ5,REQ7,REQ6,REQ9,REQ14,REQ15
...
INTEGER :: N_REQ,N_REQ1=0,N_REQ2=0,N_REQ3=0,N_REQ4=0,N_REQ5=0,N_REQ7=0,N_REQ6=0,N_REQ9=0,N_REQ14=0,N_REQ15=0
...
DO I=1,N_REQ9  ; CALL MPI_REQUEST_FREE(REQ9(I) ,IERR) ; ENDDO
...
INTEGER :: NNN,NN1,NN2,IPC,CNT,II1,II2,JJ1,JJ2,KK1,KK2,NQT2,NN,IOR,NRA,NRA_MAX,AIC,OBST_INDEX,IP,PW,TPW,I,J,K
...
IF (N_MPI_PROCESSES>1 .AND. CODE==55 .AND. N_REQ9>0) THEN
