...
LOGICAL :: A_TMP,L_TMP,CHECK_ATOM_BALANCE,FAST_CHEMISTRY
NAMELIST /REAC/ A,A_RAMP,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                REAC_MASS_ERROR,SOOT_H_FRACTION,SOOT_YIELD,SPEC_ID_N_S,SPEC_ID_NU,SUPPRESSION,TAU_CHEM,TAU_FLAME,&
                Y_P_MIN_EDC
...
NAMELIST /MATL/ A,ABSORPTION_COEFFICIENT,BOILING_TEMPERATURE,CONDUCTIVITY,CONDUCTIVITY_RAMP,DENSITY,E,EMISSIVITY,FYI,&
                ...
                N_S,N_T,N_O2,PCR,PYROLYSIS_RANGE,REFERENCE_RATE,REFERENCE_TEMPERATURE,SPECIFIC_HEAT,SPECIFIC_HEAT_RAMP,SPEC_ID,&
