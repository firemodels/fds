...
ansys150 -b nolist -j h_profile_T_ansys <read_geometry_h_profile.ans> 
../../intel_linux_64/fds2ftmi_linux_64 h_profile 0.05 2 0 30 2 10 h_profile_to_ansys 
ansys150 -b nolist -j h_profile_T_ansys <run_h_profile_T.ans> 
ansys150 -b nolist -j h_profile_M_ansys <run_h_profile_M.ans> 
ansys150 -b nolist -j h_profile_M_ansys <plot_h_profile.ans> 
