...
\begin{figure}[t]
   \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
      \scalebox{1.0}{ \includegraphics[height=2.25in]{FIGURES/ns2d_8_nupt1.pdf} } &
      \scalebox{1.0}{ \includegraphics[height=2.25in]{FIGURES/ns2d_16_nupt1.pdf} } \\
      \scalebox{1.0}{ \includegraphics[height=2.25in]{FIGURES/ns2d_32_nupt1.pdf} } &
      \scalebox{1.0}{ \includegraphics[height=2.25in]{FIGURES/ns2d_64_nupt1.pdf} }
   \end{tabular*}
...
\begin{figure}[t]
   \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
      \scalebox{1.0}{ \includegraphics[height=2.25in]{FIGURES/ns2d_error.pdf} } &
      \scalebox{1.0}{ \includegraphics[height=2.25in]{FIGURES/ns2d_nupt1_error.pdf} }
   \end{tabular*}
   \caption{(Left) Convergence rate for the $u$-component of velocity with $\nu = 0$ showing that the
   advective terms in the FDS code are second-order accurate.  The triangles represent the rms error in the $u$-component for grid spacings of $\delta x = L/N$ where $L = 2\pi$ m
   and $N = \{8,16,32,64\}$. The solid line represents first-order accuracy and the dashed line represents second-order accuracy. The simulation is run to a time of $t = 2\pi$~s
   with a CFL of $0.25$.  The $u$-component at the center of the domain is compared with the analytical solution at the same location.  (Right) Same case, except $\nu=0.1$, showing
   that the viscous terms in the FDS code are second-order accurate.}
...
In this section we present a canonical flow for LES which tests that the subgrid stress model has been coded properly.
...
\begin{figure}
   \begin{center}
      \scalebox{0.8}{\includegraphics{FIGURES/poiseuille_convergence.pdf}}
...
\hline\hline -0.01  & 190     & 95       & 47       & $5.9e4$  & 0.0212   & 0.0202        & 4.8        \\
\hline       -1.    & $1.9e3$ & 950      & 470      & $7.5e5$  & 0.0128   & 0.0122        & 4.6        \\
\hline       -100.  & $1.9e4$ & $9.5e3$  & $4.7e3$  & $9.8e6$  & 0.0077   & 0.0081        & 6.0\\
\hline
\end{tabular}
\end{center}
\end{table}
