...
REAL(EB) :: MW_FUEL=-1,MW_AIR,MW_SOOT,HRRPUA_SHEET,RHO_SOOT,VISIBILITY_FACTOR, SOOT_H_FRACTION ,&
            EC_LL,BETA_EDC=2._EB,Y_P_MIN_EDC=0.01_EB,HRRPUV_AVERAGE, &
            FIXED_MIX_TIME=-1._EB
INTEGER :: N_SPECIES=0,N_REACTIONS,I_FUEL=-1,I_PROG_CO=-1, I_PROG_F=-1, I_PROG_SOOT=-1, &
           I_WATER=-1, I_CO2=-1, I_CO=-1, I_O2=-1,I_SOOT=-1, I_N2=-1,I_H2=-1, &
           N_KAPPA_ARRAY,N_REAC_SPECIES=0,N_TRACKED_SPECIES=0,N_LUMPED_SPECIES=0
REAL(EB) :: RSUM0
REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: Z2Y,Z2CP,Z2CPBAR,Z2K,Z2MU,Z2D
REAL(EB), ALLOCATABLE, DIMENSION(:) :: Z2Y_C,Z2CP_C,Z2CPBAR_C,Z2K_C,Z2MU_C,MW_AVG_Y,Y_MF_SUM_Y,&
                                       Z2KAPPA_M4
