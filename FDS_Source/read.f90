...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,ASSUMED_GAS_TEMPERATURE_RAMP,&
                ...
                COMPUTE_VISCOSITY_TWICE,CONSTANT_H_SOLID,CONSTANT_SPECIFIC_HEAT_RATIO,CORIOLIS_VECTOR,&
                ...
                THERMOPHORETIC_DEPOSITION,THICKEN_OBSTRUCTIONS,TRANSPORT_UNMIXED_FRACTION,TMPA,TURBULENCE_MODEL,&
                TURBULENT_DEPOSITION,TURB_INIT_CLOCK,U0,UVW_FILE,V0,&
...
IF (TRANSPORT_UNMIXED_FRACTION) N_PASSIVE_SCALARS=1
...
K_TMP_Z = -1.E30_EB
ALLOCATE(G_F_TMP_Z(N_TRACKED_SPECIES))
G_F_TMP_Z = -1.E30_EB

ALLOCATE(CPBAR_Z(0:5000,N_TRACKED_SPECIES))
CALL ChkMemErr('READ','CPBAR_Z',IZERO)
CPBAR_Z = 0._EB

ALLOCATE(CP_AVG_Z(0:5000,N_TRACKED_SPECIES))
CALL ChkMemErr('READ','CP_AVG_Z',IZERO)
CP_AVG_Z = 0._EB

ALLOCATE(K_RSQMW_Z(0:5000,N_TRACKED_SPECIES))
CALL ChkMemErr('READ','K_RSQMW_Z',IZERO)
K_RSQMW_Z = 0._EB

ALLOCATE(MU_RSQMW_Z(0:5000,N_TRACKED_SPECIES))
CALL ChkMemErr('READ','MU_RSQMW_Z',IZERO)
MU_RSQMW_Z = 0._EB

ALLOCATE(CP_Z(0:5000,N_TRACKED_SPECIES))
CALL ChkMemErr('READ','CP_Z',IZERO)
CP_Z = 0._EB

ALLOCATE(D_Z(0:5000,N_TRACKED_SPECIES))
CALL ChkMemErr('READ','D_Z',IZERO)
D_Z = 0._EB

ALLOCATE(G_F_Z(0:5000,N_TRACKED_SPECIES))
...
USE MATH_FUNCTIONS, ONLY : GET_RAMP_INDEX
CHARACTER(LABEL_LENGTH) :: FUEL,RADCAL_ID='null',SPEC_ID_NU(MAX_SPECIES),SPEC_ID_N_S(MAX_SPECIES),RAMP_FS
CHARACTER(100) :: FORMULA
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   IF (RN%RAMP_FS/='null') CALL GET_RAMP_INDEX(RN%RAMP_FS,'TEMPERATURE',RN%RAMP_FS_INDEX)
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      IF (TRIM(QUANTITY) == 'UNMIXED FRACTION') TRANSPORT_UNMIXED_FRACTION = .TRUE.
