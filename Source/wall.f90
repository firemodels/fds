...
!$OMP PARALLEL
!$OMP DO PRIVATE(LP, LPC, SF, ONE_D, IIG, JJG, KKG, II, JJ, KK, RADIUS, AREA_SCALING, RVC, ZZ_GET, H_G, CP, DELTA_H_G, &
!$OMP NS, MW_RATIO, M_DOT_PPP_SINGLE, I_FUEL) SCHEDULE(STATIC)
...
RECURSIVE SUBROUTINE CALCULATE_ZZ_F(WALL_INDEX)
