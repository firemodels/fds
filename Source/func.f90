...
IC=IC+1 ; LP%BC_INDEX             = OS%INTEGERS(IC,STORAGE_INDEX)
IC=IC+1 ; LP%OD_INDEX             = OS%INTEGERS(IC,STORAGE_INDEX)
IC=IC+1 ; LP%TAG                  = OS%INTEGERS(IC,STORAGE_INDEX)
IC=IC+1 ; LP%LP_INDEX             = OS%INTEGERS(IC,STORAGE_INDEX)
...
IF (LP%BC_INDEX>0) THEN
   ...
   LP%BC_INDEX = M%N_BOUNDARY_COORD
   BC => M%BOUNDARY_COORD(LP%BC_INDEX)
...
IF (LP%OD_INDEX>0) THEN
   ...
   LP%OD_INDEX = M%N_BOUNDARY_ONE_D
   ONE_D => M%BOUNDARY_ONE_D(LP%OD_INDEX)
