      ...
      CASE (EXPLICIT_EULER) ! Simple chemistry
         ...
         DO SR=0,N_SERIES_REACTIONS
            CALL FIRE_FORWARD_EULER(ZZ_MIXED_NEW,ZETA,ZZ_MIXED,ZETA_0,DT_SUB,TMP_MIXED,TMP_UNMIXED,RHO_HAT,ZZ_UNMIXED,&
                                    CELL_MASS,TAU_MIX,PBAR_0,DELTA,VEL_RMS,EXTINCT)
...
IF (ANY(REACTION(:)%FAST_CHEMISTRY)) THEN
   DO SR = 0,N_SERIES_REACTIONS
      CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,INFINITELY_FAST,PBAR_0,DELTA,VEL_RMS,EXTINCT)
...
IF (.NOT.ALL(REACTION(:)%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,FINITE_RATE,PBAR_0,DELTA,VEL_RMS,EXTINCT)
   ZZ_NEW = ZZ_0 + DZZ
   ...
   IF (TEMPERATURE_DEPENDENT_REACTION) THEN
      ...
      DO ITER = 1,3
         ...
         TMP_MIXED = ( CPBAR_MIXED_0*TMP_MIXED_0 + (1._EB-RADIATIVE_FRACTION)*Q_TEMP )/CPBAR_MIXED ! CGW Eq. (38)
      ENDDO
   ENDIF
ENDIF
...
SUBROUTINE REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_0,TMP_0,KINETICS,PBAR_0,DELTA,VEL_RMS,EXTINCT)
