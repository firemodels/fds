...
SUBROUTINE DUMP_MESH_OUTPUTS(T,DT,NM,VTK_ONLY)
...
IF (WRITE_VTK) THEN
   ...
   IF (VTK_HDF) THEN
      WRITE(*,*) "RANK ", MY_RANK, " INTO DUMP_SLCF_VTK"
      CALL DUMP_SLCF_VTK(T,DT,NM,4)
      WRITE(*,*) "RANK ", MY_RANK, " OUT OF DUMP_SLCF_VTK"
   ELSE
      ! VTK 3-D slices
...
SUBROUTINE DUMP_SLCF_VTK(T,DT,NM,IFRMT)
