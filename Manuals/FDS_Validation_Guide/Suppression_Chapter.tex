...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{FIGURES/Cup_Burner/Cup_Burner_volfrac}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{FIGURES/Cup_Burner/Cup_Burner_massfrac}
\end{tabular}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=3.5in]{FIGURES/ScatterPlots/USCG_HAI_Extinction}
