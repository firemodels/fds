...
%\clearpage
%
%\subsection{NIST Reduced Scale Enclosure (FSE) Test Series, 2008}
%
%The FSE experiments were selected to assess CO production in full-scale under-ventilated compartment fires. There were 29 experiments conducted that included 7 different fuels: heptane, natural gas, nylon, propylene, isopropanol, styrene, and toluene.
