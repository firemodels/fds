...
USE SCRC, ONLY: SCARC_METHOD , SCARC_KRYLOV , SCARC_MULTIGRID, SCARC_SMOOTH  , SCARC_PRECON, &
                ...
                SCARC_MKL, SCARC_MKL_MTYPE, &
                SCARC_COARSE_ITERATIONS, SCARC_COARSE_ACCURACY, SCARC_COARSE_MTYPE
...
ENDIF
IF (PRES_METHOD /= 'SCARC') VELOCITY_TOLERANCE = 1.E-15
...
ENDIF
WRITE(*,*) 'READ: VELOCITY_TOLERANCE=',VELOCITY_TOLERANCE
