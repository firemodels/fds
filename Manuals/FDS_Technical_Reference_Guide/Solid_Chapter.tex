...
This section describes an optional model for the heat transfer coefficient which may be more appropriate for well-resolved LES calculations.  This model is invoked by setting {\ct HEAT\_TRANSFER\_MODEL = 'LOGLAW'} on {\ct MISC}.
