...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           CONSTANT_H_SOLID=.TRUE.,POTENTIAL_TEMPERATURE_CORRECTION=.FALSE.,&
           RTE_SOURCE_CORRECTION=.TRUE.,LAPLACE_PRESSURE_CORRECTION=.FALSE.,&
           CHECK_REALIZABILITY=.FALSE.,NEW_OPEN_BOUNDARY=.FALSE.,WD_PROPS=.FALSE.,TRANSPORT_UNMIXED_FRACTION=.FALSE.,&
           ...
           EQUILIBRIUM_MODEL=.FALSE.,SOLID_HT3D=.FALSE.,HVAC_MASS_TRANSPORT=.FALSE.,EXTERNAL_BOUNDARY_CORRECTION=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            SCALAR_ENERGY_TOLERANCE=1.E-12_EB,DT_MEAN_FORCING=1.E10_EB, &
            ...
            H_V_H2O(0:5000),CHI_R_MIN=0._EB,CHI_R_MAX=1._EB,DRAG_CFL_MAX
...
REAL(EB) :: VELOCITY_TOLERANCE=0._EB,PRESSURE_TOLERANCE=0._EB
...
INTEGER :: ICYC,ICYC_RESTART=0,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,TURB_MODEL=0,SLIP_CONDITION=2,FISHPAK_BC(3)=-1,&
           STOP_AT_ITER=0,HT3D_TEST=0
...
REAL(EB) :: HVAC_PRES_RELAX=0.3_EB,DT_HVAC=-1._EB
