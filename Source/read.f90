...
! Check extinction
IF (N_REACTIONS>=1 .AND. EXTINCT_MOD/=1 .AND. CONSTANT_SPECIFIC_HEAT_RATIO) THEN
   WRITE(MESSAGE,'(A,A,A)') "ERROR: EXTINCTION_MODEL='EXTINCTION 1' must be used CONSTANT_SPECIFC_HEAT_RATIO=.TRUE."
   CALL SHUTDOWN(MESSAGE) ; RETURN
ENDIF
