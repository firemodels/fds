...
Figure~\ref{fig:Fan_Curve} displays a typical fan curve.  Additional examples can be found in the {\ct ashrae7} and {\ct fan\_test} example cases, which are documented in the Verification Guide.
