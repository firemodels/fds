...
SUBROUTINE UPDATE_OUTPUTS(T,NM,MODE)
...
SUBROUTINE UPDATE_DEVICES(T,NM,MODE)
...
INTEGER :: NM,N,I,J,K,STAT_COUNT,IW,IBC,MODE
LOGICAL :: NOT_FOUND
...
DEVICE_LOOP: DO N=1,N_DEVC
   ...
   ! Only reset PRIOR_STATE of the DEVICE if the calculation has started, leave it alone if it was set at t=T_BEGIN.

   IF (MODE > 0) DV%PRIOR_STATE = DV%CURRENT_STATE
