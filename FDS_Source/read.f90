...
REAL(EB) :: VEGETATION_CDRAG,VEGETATION_CHAR_FRACTION,VEGETATION_ELEMENT_DENSITY,VEGETATION_HEIGHT, &
            ...
            FIRELINE_MLR_MAX,VEGETATION_GROUND_TEMP
LOGICAL :: VEGETATION,VEGETATION_NO_BURN,VEGETATION_LINEAR_DEGRAD,VEGETATION_ARRHENIUS_DEGRAD
...
PROCESS_SURF_LOOP: DO N=0,N_SURF
  ...
  ! Determine if the surface is combustible/burning
   ...
   IF (ANY(SF%MASS_FRACTION>=0._EB) .OR. SF%MASS_FLUX_TOTAL < 0._EB) SF%SPECIES_BC_INDEX = SPECIFIED_MASS_FRACTION
