...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION,CONVECTION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,MIXTURE_FRACTION=.FALSE., &
           ...
           MEAN_FORCING(3)=.FALSE.,USE_MAX_FILTER_WIDTH=.FALSE.,CHECK_GR=.FALSE.,NEW_FLUX_LIMITER=.TRUE.,NEW_MIX_TIME=.FALSE., &
           NEW_PARTICLE_METHOD=.FALSE.,WFDS=.FALSE.,PATCH_VELOCITY=.FALSE.,OVERWRITE=.TRUE.,ENSEMBLE_MEAN_CLOSURE=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,TMPM,RHOA,P_INF,P_STP,GRAV,R0,R1, &
            ...
            SCALAR_ENERGY_TOLERANCE=1.E-12_EB,TKE_TOLERANCE=1.E-6_EB,RFAC_FORCING(3)=0.5_EB,C_EMC=0.136_EB
