...
%\begin{tabular}{|c|c|c|}
%\hline
%{\ct DRAG\_LAW}    & Equation               & Section                    \\ \hline
%default (sphere)   & \ref{not documented?}  & \ref{not documented?}      \\ \hline
%{\ct CYLINDER}     & \ref{not documented?}  & \ref{not documented?}      \\ \hline
%{\ct POROUS MEDIA} & \ref{eqn_porous_media} & \ref{info:porous_media}    \\ \hline
%{\ct SCREEN}       & \ref{eqn_screen}       & \ref{info:particle_screen} \\ \hline
%\end{tabular}
%\end{center}
%\end{table}
