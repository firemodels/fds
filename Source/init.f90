...
PRIMARY_WALL_LOOP_1: DO IW=1,M%N_EXTERNAL_WALL_CELLS+M%N_INTERNAL_WALL_CELLS
   ...
   CALL GET_N_LAYER_CELLS(SF%MIN_DIFFUSIVITY(1),SF%SWELL_RATIO*ONE_D%LAYER_THICKNESS(1),SF%STRETCH_FACTOR(1), &
                          SF%CELL_SIZE_FACTOR,SF%N_LAYER_CELLS_MAX(1),ONE_D%N_CELLS_MAX,ONE_D%SMALLEST_CELL_SIZE(1),&
                          ONE_D%DDSUM(1))
   ...
   CALL GET_N_LAYER_CELLS(SF%MIN_DIFFUSIVITY(1),ONE_D%LAYER_THICKNESS(1),SF%STRETCH_FACTOR(1), &
                          SF%CELL_SIZE_FACTOR,SF%N_LAYER_CELLS_MAX(1),ONE_D%N_LAYER_CELLS(1),ONE_D%SMALLEST_CELL_SIZE(1),&
                          ONE_D%DDSUM(1))
