...
\node at (0,3.,0){\tt ORIENTATION(:,6)=0,0,1};
\draw [-stealth](0,-1.5,0) -- (0,-2.5,0);
\node at (0,-3.,0){\tt ORIENTATION(:,5)=0,0,-1};

\draw [-stealth](1.5,0,0) -- (2.5,0,0);
\node at (4.2,.2,0){\tt ORIENTATION(:,2)=1,0,0};
\draw [-stealth](-1.5,0,0) -- (-2.5,0,0);
\node at (-4.2,-.2,0){\tt ORIENTATION(:,1)=-1,0,0};

\begin{pgfonlayer}{foreground layer}
\draw [-stealth](0,0,1.5) -- (0,0,2.5);
\node at (2.5,-1,2.5){\tt ORIENTATION(:,3)=0,-1,0};
\end{pgfonlayer}
