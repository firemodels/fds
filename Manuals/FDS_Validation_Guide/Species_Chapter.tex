...
For the simulations of the NIST Dunes 2000 tests, the smoke yield is specified as one of the test parameters.
The figures on the following page contain comparisons of measured and predicted optical densities at laser-based light extinction measurement stations.

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC02_Optical_Density} &
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC05_Optical_Density} \\
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC07_Optical_Density} &
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC10_Optical_Density} \\
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC33_Optical_Density} &
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC35_Optical_Density} \\
\includegraphics[height=2.2in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_SDC39_Optical_Density}
\end{tabular*}
\end{figure}
...
\subsection{Summary of Optical Density Predictions}

\begin{figure}[h!]
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Optical_Density} \\
\vspace{0.25in} \\
\end{tabular}
\end{center}
\caption[Summary of optical density predictions]
{Summary of optical density predictions.}
\end{figure}
...
A total of 16 aerosol deposition tests were conducted in a straight steel duct with smooth walls for 5
different particle diameters (1~$\mu$m, 3~$\mu$m, 5~$\mu$m, 9~$\mu$m, and 16~$\mu$m) and 3 different air
velocities (2.2~m/s, 5.3~m/s, and 9.0~m/s). In the simulations, the species that contains the aerosol is
tracked explicitly, and the aerosol deposition routines are enabled (refer to the Aerosol Deposition section
...
\hline
Test No.  &  Air Speed (m/s)  &  Particle Diameter ($\mu$m) &  Particle Density (kg/m$^3$)  \\ \hline \hline
1         &  2.2              &  1.0                        &  1,350                        \\ \hline
2         &  2.2              &  2.8                        &  1,170                        \\ \hline
3         &  2.1              &  5.2                        &  1,210                        \\ \hline
4         &  2.2              &  9.1                        &  1,030                        \\ \hline
5         &  2.2              &  16                         &  950                          \\ \hline
6         &  5.3              &  1.0                        &  1,350                        \\ \hline
7         &  5.2              &  1.0                        &  1,350                        \\ \hline
8         &  5.2              &  3.1                        &  1,170                        \\ \hline
9         &  5.4              &  5.2                        &  1,210                        \\ \hline
10        &  5.3              &  9.8                        &  1,030                        \\ \hline
11        &  5.3              &  16                         &  950                          \\ \hline
12        &  9.0              &  1.0                        &  1,350                        \\ \hline
13        &  9.0              &  3.1                        &  1,170                        \\ \hline
14        &  8.8              &  5.4                        &  1,210                        \\ \hline
15        &  9.2              &  8.7                        &  1,030                        \\ \hline
16        &  9.1              &  15                         &  950                          \\ \hline
\end{tabular}
\end{center}
...
\noindent The particle deposition velocity, $V_d$, is calculated by
\be
   V_d = \frac{J_1 + J_2 + J_3 + J_4}{4 \; C_{avg}}
\ee
where $J_1$ through $J_4$ are the deposition fluxes (kg/m$^2$/s) for duct panels 1 through 4 given by
\be
   J = \frac{m_{d}}{A_d \; \Delta t}
\ee
where $m_d$ is the mass of particles on the duct panel (kg), $A_d$ is the area of the duct panel (m$^2$),
and $\Delta t$ is the duration over which the aerosol deposits onto the panel (s). $C_{avg}$ is the
average aerosol concentration in the duct test section (kg/m$^3$) and is given by
\be
   C_{avg} = \frac{C_{upstream} + C_{downstream}}{2}
\ee
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Aerosol_Deposition_Velocity} \\
\vspace{0.25in} \\
\end{tabular}
\end{center}
...
\includegraphics[height=2.2in]{FIGURES/NIST_RSE_1994/NIST_RSE_1994_H2O_Front} &
\includegraphics[height=2.2in]{FIGURES/NIST_RSE_1994/NIST_RSE_1994_H2O_Rear}
\end{tabular*}
\caption[Summary of species concentrations in NIST Reduced Scale Enclosure experiments]{Summary of species concentrations in NIST Reduced Scale Enclosure experiments.}
...
\begin{figure}[h!]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/NIST_RSE_1994/NIST_RSE_1994_TC_Front} &
\includegraphics[height=2.2in]{FIGURES/NIST_RSE_1994/NIST_RSE_1994_TC_Rear} \\
\end{tabular*}
