...
\ee
where $\Delta \rho_{\alpha,dep}$ is the change in aerosol density due to deposition, $\rho_{\alpha}$ is
the ambient density of the aerosol, $\Delta t$ is the size of the time step, and $\Delta x$ is the size
of the grid cell. The accumulated aerosol density that deposits to surfaces,
