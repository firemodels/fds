...
LOGICAL :: PREDEFINED(0:MAX_SPECIES),BACKGROUND
...
! Add for ALIAS species
N_TRACKED_SPECIES = N_TRACKED_SPECIES
...
READ_SMIX_LOOP: DO N=0,N_TRACKED_SPECIES  
   ...
   IF (PREDEFINED(N)) THEN
      ...
      IF (N>N_TRACKED_SPECIES - N_ALIAS - N_SMIX_READ) THEN
         ID = SPEC_ALIAS_ID(N - (N_TRACKED_SPECIES - N_ALIAS - N_SMIX_READ))
         MASS_FRACTION_0 = SPEC_ALIAS_YY0(N - (N_TRACKED_SPECIES - N_ALIAS - N_SMIX_READ))
      ENDIF
   ELSE
