...
%As part of CFAST Validation for buildings with varied natural ventilation, 
...
The enclosure consisted of two compartments stacked one on top of the other. The interior lateral dimensions of each compartment were 119~cm by 121~cm. The height of the lower compartment was 59~cm, and the upper was 61~cm. The enclosure was located inside a room that was approximately 297~cm by 310~cm. The height of the room was 275~cm, with an exhaust duct loacted above the compartment. The room had a tile floor, however, a gypsum board floor was cut to fit and placed within the lower compartment. 
...
%{Thermocouples} ----heights still need to be specified 
%8 K~Type thermocouples were inserted into each floor to measure the vertical temperature profile. The thermocouples were aligned with the center of the right ceiling vent, positioned in a vertical array at x= 
...
%-daq:collecting temperature value every second - averaging to hot layers/depths
...
%\begin{figure}[h]
%\includegraphics[width=\textwidth]{FIGURES/NIST_Vent_Study/Latex_Drawing_4}
%\caption[Geometry of the compartment from the NIST Vent Study]{Geometry of the compartment from the NIST Vent Study}
%\label{NIST_Vent_Study_1}
%\end{figure}
...
%\caption[Geometry of the compartment from the NIST Vent Study: Layer Identification]{Geometry of the compartment from the NIST Vent Study: Layer Identification}
