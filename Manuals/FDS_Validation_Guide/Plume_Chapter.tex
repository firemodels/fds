...
The contour plots on the following page display the predicted plume temperatures for the JIS~A~1310 facade fire test apparatus. In this case, the compartment window is 0.91~m by 0.91~m and the origin of coordinate axes represents the point just above the window. There are three contour plots for each fire size; one aligned with the {\em Middle} of the window, one that is 0.23~m to the {\em Middle-Right}, and one that is 0.41~m to the {\em Right}.
