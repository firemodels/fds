...
INTEGER, PARAMETER :: N_ONE_D_SCALAR_REALS=17,N_ONE_D_SCALAR_INTEGERS=9,N_ONE_D_SCALAR_LOGICALS=2

TYPE ONE_D_M_AND_E_XFER_TYPE
   REAL(EB), POINTER, DIMENSION(:) :: TMP,LAYER_THICKNESS,X,MASSFLUX_ACTUAL,MASSFLUX,IL,ZZ_G,ZZ_F
   ...
   REAL(EB), POINTER :: AREA,HEAT_TRANS_COEF,QCONF,QRADIN,QRADOUT,EMISSIVITY,AREA_ADJUST,T_IGN,TMP_F,TMP_B,UW,UWS,&
                        RSUM_G,TMP_G,RHO_G,U_TANG,RHO_F
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=16,N_WALL_SCALAR_INTEGERS=16,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,AWM_AEROSOL,LP_CPUA,LP_MPUA,RHODW,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,Q_LEAK,RDN,U_TAU,UVW_GHOST,UW0,V_DEP,VEG_HEIGHT,VEL_ERR_NEW,XW,Y_PLUS,YW,ZW
...
TYPE SURFACE_TYPE
   ...
   INTEGER, DIMENSION(10) :: CFACE_REALS_ARRAY_SIZE=0,CFACE_LOGICALS_ARRAY_SIZE=0
...
INTEGER, PARAMETER :: N_CFACE_SCALAR_REALS=4,N_CFACE_SCALAR_INTEGERS=5,N_CFACE_SCALAR_LOGICALS=0

TYPE CFACE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER :: AREA,X,Y,Z
