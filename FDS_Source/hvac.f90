...
REAL(EB) :: YY_SUM(N_GAS_SPECIES),YY_N(1:N_GAS_SPECIES),RHO_SUM,P_SUM,AREA_SUM,AREA,TMP_SUM,H_SUM,H_G,TMP_NEW,CPBAR,TNOW,&
           P_AVE,TMP_WGT!,VEL2
...
REAL(EB) :: AREA_SUM,AREA,CPBAR,H_G,TMP_WGT,TMP_SUM,TMP_NEW,YY_N(1:N_GAS_SPECIES)
TYPE(DUCTNODE_TYPE), POINTER :: DN=>NULL()
