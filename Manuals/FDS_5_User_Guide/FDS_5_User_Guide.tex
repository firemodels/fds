...
\item From the command line (Terminal) change to the directory where you want the new directory of files to appear and enter the following command into the shell prompt. This svn command will create a directory for you named Verification and download all of the example cases into directories within it.
\footnotesize
\begin{verbatim}
svn co http://fds-smv.googlecode.com/svn/trunk/FDS/trunk/Verification Verification
\end{verbatim}
\normalsize
\item Optional: Run the following svn command from within the Verification directory when you want to update your local copy of the files to the latest versions of the test cases in the repository.
\footnotesize
\begin{verbatim}
svn update
\end{verbatim}
