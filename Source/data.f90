...
!NASA AIR Compositon is: N2 78.084,O2 20.9476,Ar .9365,CO2 .0319
IF (TRIM(FORMULA)=='Air') MW = 28.0134_EB*0.78084_EB + 31.9988_EB*0.209476_EB + 39.948_EB*0.009365_EB + 44.0095_EB*0.000319_EB
IF (TRIM(FORMULA)/='null') CALL GET_FORMULA_WEIGHT(FORMULA,MW,ATOM_COUNTS)
