...
IF (WC%NODE_INDEX < 0 .AND. N_TRACKED_SPECIES==1 .AND. (.NOT. SF%SPECIES_BC_INDEX==SPECIFIED_MASS_FLUX) .OR. &
   (SF%SPECIES_BC_INDEX==SPECIFIED_MASS_FLUX .AND. ABS(SF%MASS_FLUX(1))<=TWO_EPSILON_EB)) THEN
   WC%ZZ_F(1) = 1._EB
   RETURN
ENDIF
