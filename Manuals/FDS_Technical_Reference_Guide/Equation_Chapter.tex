...
\be \bp = \rho T \calR \sum_\alpha  \frac{Z_\alpha}{W_\alpha} \equiv \frac{\rho \R T}{\bW}  \label{basicstate1} \ee
...
\be
   \DoD{p}{t} \equiv \frac{\partial p}{\partial t} + \bu \cdot \nabla p \approx
...
\be
   \dod{\bu}{t} - \bu\times\bo + \nabla \calH - \tp \, \nabla \left( \frac{1}{\rho}\right) = \frac{1}{\rho} \Big[ (\rho-\rho_0) \bg + \bof_{\rm b} + \nabla\!\cdot \btau \Big]
\ee
