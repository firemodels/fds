...
\be
\Delta T_0 = \frac{9.1 \left( \frac{T_\infty}{g c\sb{p}^2 \rho_{\infty}^2} \right)^{1/3} \dot Q\sb{c}^{2/3}}{(z-z_0)^{5/3}} \quad ^\circ{\rm C}
\label{eq:Heskestad}
\ee
...
A summary of the comparisons between peak predicted and measured plume temperatures is shown in Fig.~\ref{Plume_Temperature_McCaffrey}.
