...
By default, Smokeview will show slice file data inside obstructions.  This alleviates the need to store a 3D blanking array, which is expensive to load at startup in Smokeview for large cases.  If you wish Smokeview to store this blanking array, set {\ct IBLANK\_SMV=.TRUE.} on {\ct MISC}.
...
{\ct IBLANK\_SMV}                               & Logical       & Section~\ref{info:SLCF}                               &               & {\ct .FALSE.}     \\ \hline
