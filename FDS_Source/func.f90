...
SUBROUTINE ALLOCATE_WALL_ARRAYS(NM,IW,SURF_INDEX)

USE GLOBAL_CONSTANTS, ONLY: RADIATION,SIGMA,TMPA4,OPEN_BOUNDARY,EVACUATION_ONLY,TMPA
INTEGER, INTENT(IN) :: NM,IW,SURF_INDEX
INTEGER :: IZERO
TYPE (MESH_TYPE), POINTER :: M=>NULL()
...
USE GLOBAL_CONSTANTS, ONLY: SIGMA,TMPA4,TMPA,RPI,N_TRACKED_SPECIES,T_BEGIN
