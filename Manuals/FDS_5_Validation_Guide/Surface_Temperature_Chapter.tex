...
\end{tabular}
\end{center}
\caption{Summary of cable surface temperature predictions for the NIST/NRC test series.}
\end{figure}
...
\end{tabular}
\end{center}
\caption{Summary of wall and ceiling temperature predictions for the WTC test series.}
\end{figure}
...
\begin{table}[h!]
\caption{Wall thermocouple positions for the NIST/NRC series. The origin of the coordinate system at the floor in the southwest 
...
\end{tabular}
\end{center}
\caption{Summary of wall, floor and ceiling temperature predictions for the NIST/NRC test series.}
\end{figure}
