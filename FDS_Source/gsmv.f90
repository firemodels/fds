...
PUBLIC GET_TETRABOX_VOLUME, GET_VERTS, TETRAHEDRON_VOLUME
...
CALL GET_VERTS(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,POLYSTART,POLYNUM,NORMAL_INDEX,NPOLYS,BOX_STATE,VERT_STATE)
...
GET_TETRABOX_VOLUME = GET_POLYHEDRON_VOLUME(VERTS,NVERTS,POLYSTART,POLYNUM,NPOLYS)
...
REAL(EB) FUNCTION GET_POLYHEDRON_VOLUME(VERTS,NVERTS,POLYSTART,POLYNUM,NPOLYS)

REAL(EB), DIMENSION(0:599), INTENT(IN), TARGET :: VERTS
INTEGER, INTENT(IN) :: NVERTS, NPOLYS
INTEGER, DIMENSION(0:199), INTENT(IN) :: POLYSTART, POLYNUM
...
SUBROUTINE GET_VERTS(BOX_BOUNDS,VV0,VV1,VV2,VV3,VERTS,NVERTS,POLYSTART,POLYNUM,NORMAL_INDEX,NPOLYS,BOX_STATE,VERT_STATE)
...
INTEGER, DIMENSION(0:199), INTENT(OUT) :: POLYSTART, POLYNUM
INTEGER, DIMENSION(0:9), INTENT(OUT) :: NORMAL_INDEX
INTEGER, INTENT(OUT) :: NVERTS,NPOLYS
