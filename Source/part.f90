...
REAL(EB) :: UBAR,VBAR,WBAR,RVC,UREL,VREL,WREL,QREL,RHO_G,TMP_G,MU_AIR, &
            ...
            GX_LOC,GY_LOC,GZ_LOC,DUMMY,DRAG_MAX(3)=0._EB,SUM_RHO,K_SGS,U_P,L_WAKE,KAPPA_E
...
SELECT CASE(LPC%DRAG_LAW)
   ...
   CASE (SCREEN_DRAG, POROUS_DRAG)
      LP%C_DRAG = DOT_PRODUCT(LPC%DRAG_COEFFICIENT,ORIENTATION_VECTOR(1:3,LPC%ORIENTATION_INDEX))
END SELECT
