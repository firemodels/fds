...
USE MANUFACTURED_SOLUTIONS, ONLY: DIFF_MMS,UF_MMS,WF_MMS,VD2D_MMS_Z_SRC,RHO_0_MMS,RHO_1_MMS,VD2D_MMS_RHO_SRC,VD2D_MMS_DIV,&
                                  VD2D_MMS_Z_SRC_2
   ...
   DO K=1,KBAR
      DO J=1,JBAR
         DO I=1,IBAR
            ...
            XHAT = XC(I) - UF_MMS*TT
            ZHAT = ZC(K) - WF_MMS*TT
            Q_RHO = VD2D_MMS_RHO_SRC(XC(I),ZC(K),TT)
            !Q_Z = VD2D_MMS_Z_SRC(XHAT,ZHAT,TT)
            Q_Z = VD2D_MMS_Z_SRC_2(XC(I),ZC(K),TT)
            DP(I,J,K) = Q_RHO/RHOP(I,J,K) + &
               (1._EB/RHO_1_MMS - 1._EB/RHO_0_MMS) * ( DEL_RHO_D_DEL_Z(I,J,K,1) + Q_Z - ZZP(I,J,K,1)*Q_RHO )
            !DP(I,J,K) = VD2D_MMS_DIV(XHAT,ZHAT,TT)
         ENDDO
      ENDDO
   ENDDO
ENDIF
