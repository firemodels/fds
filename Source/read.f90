...
READ_SURF_LOOP: DO N=0,N_SURF
      ...
      IF (RAMP_Q(NN)/='null' .AND. REFERENCE_HEAT_FLUX(NN) > 0._EB) THEN
         IF (NN>1) THEN
            ...
            IF (REFERENCE_THICKNESS(NN) > 0._EB .AND. REFERENCE_THICKNESS(NN-1) > 0._EB .AND. &
               ABS(1._EB-REFERENCE_THICKNESS(NN-1)/REFERENCE_THICKNESS(NN)) <= 0.1_EB) THEN
   ...
   IF (SF%N_QDOTPP_REF > 0) SF%N_THICK_REF = MIN(1,SF%N_THICK_REF)
   ...
   DO NN = 1,SF%N_QDOTPP_REF
      IF (NN == 1) SF%THICK2QREF(1,0) = 1
      IF (NN > 1 .AND. REFERENCE_THICKNESS(NN) > REFERENCE_THICKNESS(NN-1)) THEN
