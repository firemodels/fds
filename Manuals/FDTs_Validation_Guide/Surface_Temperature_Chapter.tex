...
\be
\Delta T_s = k_i \left( \frac{T_f - T_s}{c_s h \frac{W}{D} + \frac{1}{2} c_i \rho_i h_i^2} \right) \Delta t
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=6.0in]{FIGURES/Scatterplots/Steel_Temperature}
\end{tabular}
\end{center}
