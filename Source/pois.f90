...
DO  K=1,N
  ...
  END DO
END DO
!$OMP PARALLEL DO PRIVATE(JC, K, I)
DO  J=2,MS2
  JC = M+1-J
  DO  K=1,N
    DO  I=1,L
...
IF (MOD(M,2)==0) THEN
  ...
  END DO
END IF
!$OMP PARALLEL DO PRIVATE(JBY2, K, I)
DO  J=2,M-1,2
  JBY2=J/2
  DO  K=1,N
    DO  I=1,L
...
102 IDP2 = IDO+2
!$OMP PARALLEL DO PRIVATE(I, IC, M)
DO  K=1,L1
  DO  I=3,IDO,2
    IC = IDP2-I
    DO  M=1,MP
...
IF (IDO > 2) THEN
   IDP2 = IDO+2
!$OMP PARALLEL DO PRIVATE(I, IC, K)
   DO  M=1,MP
      DO  I=3,IDO,2
         IC = IDP2-I
         DO  K=1,L1
...
IF (NBD > L1) GO TO 107
IS = -IDO
!$OMP PARALLEL DO PRIVATE(IS, IDIJ, I, K, M)
DO  J=2,IP
  IS = IS+IDO
  IDIJ = IS
  DO  I=3,IDO,2
...
GO TO 111
107 IS = -IDO
!$OMP PARALLEL DO PRIVATE(IS, K, IDIJ, I, M)
DO  J=2,IP
  IS = IS+IDO
  DO  K=1,L1
    IDIJ = IS
...
!$OMP PARALLEL DO PRIVATE(JC, K, I, M)
DO  J=2,IPPH
  JC = IPP2-J
  DO  K=1,L1
    DO  I=3,IDO,2
...
!$OMP END PARALLEL DO
GO TO 121
!$OMP PARALLEL DO PRIVATE(JC, I, K, M)
115 DO  J=2,IPPH
  JC = IPP2-J
  DO  I=3,IDO,2
    DO  K=1,L1
...
119 DO  IK=1,IDL1
  ...
  END DO
END DO
!$OMP PARALLEL DO PRIVATE(JC, K, M)
121 DO  J=2,IPPH
  JC = IPP2-J
  DO  K=1,L1
    DO  M=1,MP
...
AR1 = 1._EB
AI1 = 0._EB
! Remove OMP directive PARALLEL DO PRIVATE(LC, AR1H, AI1, AR1, IK, M, DC2, DS2, AR2, AI2, J, JC, AR2H)
DO  L=2,IPPH
  LC = IPP2-L
  ...
  END DO
END DO
! Remove OMP directive END PARALLEL DO
!$OMP PARALLEL DO PRIVATE(IK, J)
DO  M=1,MP
  DO  IK=1,IDL1
    DO  J=2,IPPH
...
END DO
!$OMP END PARALLEL DO
!$OMP PARALLEL DO PRIVATE(JC, J2, K, M)
135 DO  J=2,IPPH
  JC = IPP2-J
  J2 = J+J
  DO  K=1,L1
...
IF (IDO == 1) RETURN
IF (NBD < L1) GO TO 141
!$OMP PARALLEL DO PRIVATE(JC, J2, K, I, IC, M)
DO  J=2,IPPH
  JC = IPP2-J
  J2 = J+J
  DO  K=1,L1
...
!$OMP END PARALLEL DO
RETURN
!$OMP PARALLEL DO PRIVATE(JC, J2, I, IC, K, M)
141 DO  J=2,IPPH
  JC = IPP2-J
  J2 = J+J
  DO  I=3,IDO,2
...
IF (IDO == 1) GO TO 116
IF (NBD < L1) GO TO 112
!$OMP PARALLEL DO PRIVATE(JC, K, I, IC, M)
DO  J=2,IPPH
  JC = IPP2-J
  DO  K=1,L1
    DO  I=3,IDO,2
...
!$OMP END PARALLEL DO
GO TO 116
!$OMP PARALLEL DO PRIVATE(JC, I, IC, K, M)
112 DO  J=2,IPPH
  JC = IPP2-J
  DO  I=3,IDO,2
    IC = IDP2-I
...
IF = 2**KAPPA
IC = 0
!$OMP PARALLEL DO PRIVATE(IRM1, I2, I3, I4, IS, I, IP, J, IPI2, IMI2, IC)
DO  IR = 0,KAPPA - 2
  IRM1 = IR - 1
  I2 = 2**IR
  I3 = I2 + I2/2
...
!$OMP PARALLEL DO PRIVATE(IRM1, I2, I1, I4, I, J, IS, IMI1, IPI1, IMI2, IPI2, IP, IC)
DO  IR = KDO,0,-1
  IRM1 = IR - 1
  I2 = 2**IR
  I1 = I2/2
