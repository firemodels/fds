...
The following equation calculates the temperature rise (above ambient) of an unprotected steel member, using a quasi-stationary approach, iterated for successive time steps of $\Delta t$ (sec)
...
If the thermal capacity of the insulation layer is neglected, the temperature rise (above ambient) in a structural steel element can be calculated using the following equation
