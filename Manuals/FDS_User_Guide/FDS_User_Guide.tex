...
the same across all platform types (Windows, Linux and OSX) and
...
below.  Batch files (Windows) or aliases ( Linux or OSX) may be
...
The installer also defines aliases named fds6 and fds6\_mpi
