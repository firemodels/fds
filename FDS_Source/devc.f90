...
TYPE PROPERTY_TYPE
   ...
   INTEGER  :: PART_INDEX,FLOW_RAMP_INDEX,SPRAY_PATTERN_INDEX,SPEC_INDEX=0,PRESSURE_RAMP_INDEX
...
TYPE DEVICE_TYPE
   ...
   INTEGER  :: OUTPUT_INDEX,IOR,IW,ORDINAL,I,J,K,MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,I_DEPTH,N_PATH,N_T_E,PROP_INDEX,&
               TRIP_DIRECTION,CTRL_INDEX,N_INPUTS,VIRTUAL_WALL_INDEX=0,SURF_INDEX=-1,SPEC_INDEX=0,PART_INDEX=0,VELO_INDEX=0
   INTEGER  :: DUCT_INDEX=-1,NODE_INDEX=-1,POINT=1,LINE=0
   ...
   CHARACTER(30) :: ID,PROP_ID,QUANTITY,CTRL_ID,DEVC_ID,STATISTICS='null',SURF_ID,PART_ID='null',SPEC_ID='null',MATL_ID='null', &
                    SMOKEVIEW_BAR_LABEL,UNITS='null',DUCT_ID='null',NODE_ID='null'
   CHARACTER(60) :: SMOKEVIEW_LABEL
   LOGICAL :: INITIAL_STATE,CURRENT_STATE,LATCH,PRIOR_STATE,GAS_CELL_RAD_FLUX=.FALSE.,DRY=.FALSE.,TIME_AVERAGED=.TRUE.,EVACUATION=.FALSE.
