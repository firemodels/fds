...
Steckler {\em et al.}~\cite{Steckler:NBSIR_82-2520} mapped the doorway/window flows in 55 compartment fire experiments. The test matrix is presented in Table~\ref{Steckler_Table}. Shown on
the following pages are the centerline profiles, compared with model predictions. Off-center profiles are not shown. The vertical spacing of the measurements was approximately 11~cm, with the uppermost velocity probe centered 5.7~cm below the 10~cm thick soffit. The FDS simulations were uniformly gridded with cells of 5~cm on each side. To quantify the difference between prediction and measurement, the maximum outward velocities, which always occurred at the uppermost measurement location, were compared. It has been found that relatively minor changes in the velocity boundary conditions at the edges and bottom of the door soffit can have a noticeable impact on these results. 
...
%\begin{figure}[p]
%\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_Inlet_Velocity} &
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_Outlet_Velocity} \\
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_Inlet_Velocity} &
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_Outlet_Velocity} \\
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_Inlet_Velocity} &
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_Outlet_Velocity}
%\end{tabular*}
...
%\begin{figure}[p]
%\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_Inlet_Velocity} &
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_Outlet_Velocity} \\
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_Inlet_Velocity} &
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_Outlet_Velocity} \\
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_Inlet_Velocity} &
%\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_Outlet_Velocity}
%\end{tabular*}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=5.0in]{FIGURES/ScatterPlots/Velocity}
\end{tabular}
\end{center}
