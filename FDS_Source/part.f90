...
IF (LPC%SOLID_PARTICLE) THEN
   ...
   SCREEN_LPC: IF (LPC%DRAG_LAW==SCREEN_DRAG) THEN
      ...
      AREA = (ABS(LPC%ORIENTATION(1,1))*DY(ONE_D%JJG)*DZ(ONE_D%KKG) + &
              ABS(LPC%ORIENTATION(1,2))*DX(ONE_D%IIG)*DZ(ONE_D%KKG) + &
              ABS(LPC%ORIENTATION(1,3))*DX(ONE_D%IIG)*DY(ONE_D%JJG)) * &
