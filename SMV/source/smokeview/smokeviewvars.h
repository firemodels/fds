...
#endif
SVEXTERN int SVDECL(showtrisurface,1),SVDECL(showtrioutline,1),SVDECL(showtrinormal,1);
...
SVEXTERN float *zonet, *zoneylay, *zonetl, *zonetu, *zonepr, *zoneqfire, *zoneodl, *zoneodu;
...
SVEXTERN vdevice SVDECL(*vdeviceinfo,NULL);
...
SVEXTERN zonedata *zoneinfo;
SVEXTERN zonedata *activezone;
