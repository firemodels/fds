...
TYPE INITIALIZATION_TYPE
   ...
   INTEGER  :: PART_INDEX=0,NUMBER_INITIAL_DROPLETS,WALL_INDEX_START=-1,LU_DROPLET
   LOGICAL :: ADJUST_DENSITY=.FALSE.,ADJUST_TEMPERATURE=.FALSE.,DROPLET_INIT_FILE=.FALSE.
   CHARACTER(30) :: SHAPE,DROPLET_FILENAME
