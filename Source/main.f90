...
LOGICAL  :: EX=.FALSE.,DIAGNOSTICS,EXCHANGE_EVACUATION=.FALSE.,CTRL_STOP_STATUS
...
IF (VEG_LEVEL_SET) THEN
   DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
      CALL INITIALIZE_LEVEL_SET_FIRESPREAD(NM)
   ENDDO
ENDIF
...
MAIN_LOOP: DO
   ...
   CHANGE_TIME_STEP_LOOP: DO
      ...
      COMPUTE_DENSITY_LOOP: DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
         ...
         IF (VEG_LEVEL_SET) CALL LEVEL_SET_FIRESPREAD(T,DT,NM)
      ...
      CALL MESH_EXCHANGE(1)
      IF (VEG_LEVEL_SET) CALL MESH_EXCHANGE(14)
   ...
   OTHER_MESH_LOOP: DO NOM=1,NMESHES
      ...
      INITIALIZATION_IF: IF (CODE==0) THEN
         ...
         IF (M3%NIC_R>0) THEN
            ...
            IF (VEG_LEVEL_SET) ALLOCATE(M3%REAL_RECV_PKG14(4*M3%NIC_R))
   ...
   RECEIVING_MESH_LOOP: DO NOM=1,NMESHES
      ...
      INITIALIZE_SEND_IF: IF (CODE==0) THEN
         ...
         IF (M3%NIC_S>0 .AND. RNODE/=SNODE) THEN
            ...
            IF (VEG_LEVEL_SET) ALLOCATE(M3%REAL_SEND_PKG14(4*M3%NIC_S))
