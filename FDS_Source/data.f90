...
CHARACTER(30) :: GAS_NAME,FORMULA,FORMULAIN
LOGICAL :: ABSORBING
...
IF (MW < 0._EB) CALL GET_FORMULA_WEIGHT(FORMULA,MW,ATOM_COUNTS) 
...
CHARACTER(30),INTENT(IN)::FORMULA
CHARACTER(30) :: SUBFORMULA
REAL(EB),INTENT(INOUT)::WEIGHT_SUM
REAL(EB),INTENT(INOUT)::ATOM_COUNTS(118)
REAL(EB)::SUB_WEIGHT,NUM
INTEGER :: I,J,K,LEN1,LEN2,ELEMENT_INDEX
...
CHARACTER(80), INTENT(IN)::FORMULA
REAL(EB):: NUM_SUB
