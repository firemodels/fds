...
INTEGER :: ARRAY_INDEX,STORAGE_INDEX,I1,I2,I,OLD_INDEX,STORAGE_INDEX_OLD,STORAGE_INDEX_OPEN,N_STORAGE_SLOTS_OLD
LOGICAL :: NEW_SLOT
...
DX_MIN = 0._EB
IF (LAYER_THICKNESS<=ZERO_P) THEN
   N_CELLS = 0
   DX_MIN = 0._EB
   RETURN
ENDIF
...
SHRINK_LOOP: DO N=1,999
   ...
   ENDDO SUM_LOOP
   IF ((LAYER_THICKNESS/DDSUM < CELL_SIZE_FACTOR*SQRT(DIFFUSIVITY)) .OR. (N==999)) THEN
      N_CELLS = N
