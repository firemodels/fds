..\..\..\..\..\Build\impi_intel_win_openmp\fds_impi_intel_win_openmp simple_panel_hot.fds 
%ANSYS% -b nolist -j simple_panel_hot_ansys -i read_geometry_hot.ans -o simple_panel_hot_ansys 
..\..\intel_win\fds2ftmi_win simple_panel_hot 0.05 2 0 600 2 0 0 1 simple_panel_hot_to_ansys 
