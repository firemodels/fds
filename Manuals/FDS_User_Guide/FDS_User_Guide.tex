...
\begin{tabular}{|c|c|c|}
\hline
{\ct DRAG\_LAW}    & Tech.\ Guide Section \\ \hline
default (sphere)   & 8.1                  \\ \hline
{\ct CYLINDER}     & 8.1                  \\ \hline
{\ct POROUS MEDIA} & 8.6.1                \\ \hline % \ref{info:porous_media}
{\ct SCREEN}       & 8.6.1                \\ \hline % \ref{info:particle_screen}
\end{tabular}
\end{center}
\end{table}
