...
SELECT CASE(INDEX)
   ...
   CASE(O2_INDEX)
      Y_MF = (1._EB - Z) * RN%Y_O2_INFTY - Z_3 * RN%Y_F_INLET / RN%MW_FUEL * MW_O2 * RN%NU_O2
...
Y_MF(N2_INDEX) = (1._EB - Z) * RN%Y_N2_INFTY + Z_1 * RN%Y_N2_INLET + (Z_2 + Z_3) * RN%Y_F_INLET / RN%MW_FUEL * MW_N2 * RN%NU_N2

Y_MF(O2_INDEX) = (1._EB - Z) * RN%Y_O2_INFTY - Z_3 * RN%Y_F_INLET / RN%MW_FUEL * MW_O2 * RN%NU_O2
