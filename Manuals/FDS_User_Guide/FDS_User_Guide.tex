...
\begin{equation}
\dot Q(t) = \left\{ \begin{array}{ll} \dot Q_0 \left( \frac{t}{\tau} \right)^2            &  \mbox{if {\ct TAU\_Q} is negative} \\
...
%{\ct SECOND\_ORDER\_INTERPOLATED\_BOUNDARY}     & Logical       & apply O(dx^2) extrapolation at interp bcs (not conservative) &        & {\ct .FALSE.}     \\ \hline
