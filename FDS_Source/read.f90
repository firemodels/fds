...
USE PHYSICAL_FUNCTIONS, ONLY: LES_FILTER_WIDTH,LES_FILTER_WIDTH_2D_MAX,LES_FILTER_WIDTH_2D_GMEAN,LES_FILTER_WIDTH_3D_MAX,&
                              LES_FILTER_WIDTH_3D_GMEAN
...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                MAX_FILTER_WIDTH,MAXIMUM_VISIBILITY,MEAN_FORCING,MIXING_LAYER_H0,MIXING_LAYER_THETA0,MIXING_LAYER_U0,&
...
IF (TWO_D) THEN
   ...
   ELSE
      LES_FILTER_WIDTH=>LES_FILTER_WIDTH_2D_GMEAN
   ENDIF
ELSE
   IF (MAX_FILTER_WIDTH) THEN
      LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_MAX
   ELSE
      LES_FILTER_WIDTH=>LES_FILTER_WIDTH_3D_GMEAN
   ENDIF
ENDIF
