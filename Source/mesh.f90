...
TYPE MESH_TYPE
   ...
   INTEGER :: MESH_PRES_FLAG=0  !< Stores which solver to use per mesh when ULMAT solver selected.
   ...
   INTEGER  :: IUVW_TIMER=1,ISLCF_TIMER=1,IBNDF_TIMER=1,ISL3D_TIMER=1
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   ...
   CSD2,MTR,MSR,WEM,MIX_TIME,CHEM_SUBIT,STRAIN_RATE,D_Z_MAX,Q_DOT_PPP_S,PR_T,TMP_FLAME
...
INTEGER, POINTER :: IUVW_TIMER,ISLCF_TIMER,IBNDF_TIMER,ISL3D_TIMER
...
INTEGER, POINTER ::  N_EXTERNAL_CFACE_CELLS,N_INTERNAL_CFACE_CELLS,N_CFACE_CELLS_DIM
...
JRM=>M%JRM
KRM=>M%KRM
IUVW_TIMER=>M%IUVW_TIMER
ISLCF_TIMER=>M%ISLCF_TIMER
IBNDF_TIMER=>M%IBNDF_TIMER
ISL3D_TIMER=>M%ISL3D_TIMER
