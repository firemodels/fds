...
\usepackage[pdftex,
        ...
        pdftitle={Fire Dynamics Simulator (Version 6) Technical Reference Guide},
        pdfauthor={Kevin McGrattan, Randall McDermott, Simo Hostikka, Jason Floyd},
        pdfsubject={Technical Reference Guide},
...
\item The direct Poisson solver (CRAYFISKPAK) was written by
Roland Sweet of the National Center for Atmospheric Research (NCAR),
Boulder, Colorado.
\item Kuldeep Prasad added the multiple-mesh data
structures, paving the way for parallel processing.
\item Charles Bouldin devised the basic framework of the parallel version of the code.
\item William Grosshandler (retired from NIST) and Tom Cleary (currently at NIST) developed
an enhancement to the smoke detector activation algorithm, originally
conceived by Gunnar Heskestad of Factory Mutual.
\item Steve Olenick of Combustion Science and Engineering (CSE) implemented the
...
\item Chris Lautenberger of the University of California, Berkeley, Jos\'e Torero of the University of Edinburgh, and Guillermo Rein of Imperial College have
