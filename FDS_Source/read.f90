...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,ASSUMED_GAS_TEMPERATURE_RAMP,&
                ...
                DENSITY_TRANSPORT,DNS,ENTHALPY_TRANSPORT,&
                ...
                TENSOR_DIFFUSIVITY,TERRAIN_CASE,TERRAIN_IMAGE,TEST_FILTER_QUADRATURE,TEST_FULL_TRANSPORT,TEXTURE_ORIGIN,&
...
IF (.NOT. TEST_FULL_TRANSPORT) FUEL_SMIX_INDEX=1
IF (      TEST_FULL_TRANSPORT) FUEL_SMIX_INDEX=2
...
IF (SIMPLE_CHEMISTRY) THEN
   IF (.NOT. TEST_FULL_TRANSPORT) MINT_SPECIES = 9
   IF (      TEST_FULL_TRANSPORT) MINT_SPECIES = 10
ELSE
   MINT_SPECIES = 5
ENDIF
REWIND(LU_INPUT) ; INPUT_FILE_LINE_NUMBER = 0
...
IF (SIMPLE_CHEMISTRY) THEN
   ...
   IF (TEST_FULL_TRANSPORT) THEN
      ...
      PREDEFINED_SPEC_ID(6) = 'WATER VAPOR'
      PREDEFINED_SPEC_ID(7) = 'SOOT'
      PREDEFINED_SPEC_ID(8) = 'HELIUM'      
      PREDEFINED_SMIX(0:3) = .TRUE.
