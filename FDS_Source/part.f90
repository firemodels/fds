...
REAL(EB) XI,YJ,ZK,UBAR,VBAR,WBAR,RVC,UREL,VREL,WREL,QREL,TMP_G,RHO_G,RD,RDS,RDC,X_OLD,Y_OLD,Z_OLD,&
         ...
         WE_G,T_BU_BAG,T_BU_STRIP,FP_MASS,HALF_DT2,BETA(3),OBDT,ALPHA,OPA,DTOPA,BDTOA,MPOM,ALBO,SFAC,BREAKUP_RADIUS(0:NDC),&
         DD,DD_X,DD_Y,DD_Z,DW_X,DW_Y,DW_Z,K_SCREEN,Y_SCREEN,C_DRAG(3),A_DRAG(3),HAB(3),PARACOR,QREL2,BETABAR
...
PARTICLE_NON_STATIC_IF: IF (.NOT.LPC%STATIC) THEN
   ...
   BETABAR = (BETA(1) + BETA(2) + BETA(3)) / 3 ! isotropic component of the drag
   OBDT  = 1._EB+BETABAR*DT
   ...
   IF (SECOND_ORDER_PARTICLE_TRANSPORT) THEN
      HAB = ALPHA*BETABAR*HALF_DT2/OPA
...
PARTICLE_STATIC_IF: IF (LPC%STATIC .AND. .NOT. LPC%TREE) THEN
   ...
   BETABAR = (BETA(1) + BETA(2) + BETA(3)) / 3
   OBDT = 1._EB+BETABAR*DT
