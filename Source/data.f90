...
OUTPUT_QUANTITY(61)%NAME = 'PARTICLE DRAG FORCE X'
OUTPUT_QUANTITY(61)%UNITS = 'N/m3'
OUTPUT_QUANTITY(61)%SHORT_NAME = 'fx_drag'

OUTPUT_QUANTITY(62)%NAME = 'PARTICLE DRAG FORCE Y'
OUTPUT_QUANTITY(62)%UNITS = 'N/m3'
OUTPUT_QUANTITY(62)%SHORT_NAME = 'fy_drag'

OUTPUT_QUANTITY(63)%NAME = 'PARTICLE DRAG FORCE Z'
OUTPUT_QUANTITY(63)%UNITS = 'N/m3'
OUTPUT_QUANTITY(63)%SHORT_NAME = 'fz_drag'
