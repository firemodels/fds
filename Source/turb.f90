...
SUBROUTINE NATURAL_CONVECTION_MODEL(H_NATURAL,DELTA_TMP,C_VERTICAL,C_HORIZONTAL,SURF_GEOMETRY_INDEX,IOR)

REAL(EB), INTENT(OUT) :: H_NATURAL
REAL(EB), INTENT(IN) :: DELTA_TMP,C_VERTICAL,C_HORIZONTAL
...
REAL(EB) :: NUSSELT,Q,ZC,NU_G,DS,ALPHA,THETA,Q_OLD,ERROR,C_L,C_T
INTEGER :: ITER
INTEGER, PARAMETER :: RAYLEIGH_MAX_ITER=10
REAL(EB), PARAMETER :: Z_L = 2._EB, Z_T=30._EB
