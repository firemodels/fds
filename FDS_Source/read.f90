...
CHARACTER(30) :: LABEL,MB,ODE_SOLVER,EXTINCTION_MODEL
...
CHARACTER(60) :: TEXTURE_MAP,BOUNDARY_CONDITION_FILENAME,GEOMETRY_COORDINATE_FILENAME,HEAT_TRANSFER_MODEL
CHARACTER(25) :: COLOR
...
NAMELIST /SURF/ ADIABATIC,BACKING,BOUNDARY_CONDITION_FILENAME,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,&
                ...
                FIRELINE_MLR_MAX,FREE_SLIP,FYI,GEOMETRY,GEOMETRY_COORDINATE_FILENAME,HEAT_OF_VAPORIZATION,HEAT_TRANSFER_MODEL,&
...
!  SF%VEG_DEHYDRATION_RATE_MAX = SRF_VEG_DEHYDRATION_RATE_MAX
   ...
   SELECT CASE(BACKING)
      ...
      CASE DEFAULT
         ...
         CALL SHUTDOWN(MESSAGE)
   END SELECT
   SF%BNDC_FILENAME        = BOUNDARY_CONDITION_FILENAME
   SF%GEOC_FILENAME        = GEOMETRY_COORDINATE_FILENAME   
   ...
   IF (TRIM(SF%BNDC_FILENAME)/='null') SF%THERMAL_BC_INDEX = SPECIFIED_TEMPERATURE_FROM_FILE
...
GEOMETRY_COORDINATE_FILENAME = 'null'
BURN_AWAY               = .FALSE.
