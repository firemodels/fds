...
the computation of FED or fractional effective dose slices. Images
are drawn at 30.0~s, 60.0~s and 120.0~s and 240~s.  The FED is
computed using $\mathrm{CO}$, $\mathrm{CO_2}$ and $\mathrm{O_2}$
data slices.  Concentration values are chosen (
$\mathrm{CO}=2000 \mathrm{ppm}$,
$\mathrm{CO_2}=4 $,
$\mathrm{O_2}=7.0875 $) resulting in FED values of 1.5 at 30~s, 3.0 at 60~s, 6.0 at 120~s and 12.0 at 240~s.
...
30.0~s, FED=0.27&60.0~s, FED=0.55\\
