...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: A_I,A_J,A_COEF,L_I,L_J,L_COEF,B_VEC,X_VEC,Y_VEC ! Laplace solve, sparse LU
...
REAL(EB), POINTER, DIMENSION(:) :: A_I,A_J,A_COEF,L_I,L_J,L_COEF,B_VEC,X_VEC,Y_VEC ! Laplace solve, sparse LU
