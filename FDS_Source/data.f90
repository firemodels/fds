...
OUTPUT_QUANTITY(131)%NAME  = 'FLAME TEMPERATURE'
OUTPUT_QUANTITY(131)%UNITS  = 'C'
OUTPUT_QUANTITY(131)%SHORT_NAME  = 'flame temp'

OUTPUT_QUANTITY(132)%NAME  = 'CHEMISTRY SUBITERATIONS'                   
OUTPUT_QUANTITY(132)%UNITS  = ' '                    
OUTPUT_QUANTITY(132)%SHORT_NAME  = 'chem it'

OUTPUT_QUANTITY(133)%NAME  = 'REAC SOURCE TERM'
OUTPUT_QUANTITY(133)%UNITS  = 'kg/s'
OUTPUT_QUANTITY(133)%SHORT_NAME  = 'reac source'
OUTPUT_QUANTITY(133)%SPEC_ID_REQUIRED = .TRUE.
