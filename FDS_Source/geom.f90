...
NAMELIST /GEOM/ AZIM, AZIM_DOT, COMPONENT_ONLY, DAZIM, DELEV, DSCALE, DXYZ0, DXYZ, &
                ...
                MATL_ID, N_LEVELS, SCALE, SCALE_DOT, SPHERE_ORIGIN, SPHERE_RADIUS, SURF_ID, &
...
MAX_VERTS=MAX(MAX_VERTS,10000)
MAX_FACES=MAX(MAX_FACES,10000)
MAX_VOLUS=MAX(MAX_VOLUS,10000)
MAX_IDS=MAX(MAX_IDS,10000)
...
REAL(EB), INTENT(OUT) :: SPHERE_VERTS(3*MAX_VERTS)
REAL(EB), INTENT(OUT), TARGET :: SPHERE_TFACES(6*MAX_FACES)
INTEGER, INTENT(OUT) :: SPHERE_FACES(3*MAX_FACES)
...
REAL(EB), POINTER, DIMENSION(:) :: TFACE
...
TF12 = (TFACE1(1:2) + TFACE1(3:4))/2.0_EB
TF13 = (TFACE1(1:2) + TFACE1(5:6))/2.0_EB
TF23 = (TFACE1(3:4) + TFACE1(5:6))/2.0_EB
