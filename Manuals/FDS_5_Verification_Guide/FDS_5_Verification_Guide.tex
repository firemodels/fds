...
Finally, note that in this example that a water droplet will evaporate until the vapor pressure at the droplet surface is in equilibirum with the vapor pressure in the surronding air. Thus, the relative humidity should be equal to 100~\%, but since FDS does not currently compute condensation, a slight overshoot is not unexpected.
