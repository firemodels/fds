...
a computational fluid dynamics (CFD) model of fire-driven fluid
flow~\cite{FDS_Math_Guide_5,FDS_Users_Guide_5} or CFAST, a zone model of compartment fire phenomena~\cite{Jones:2004A}.
...
\begin{tabular}{cc}
 ...
 \end{tabular}
\end{center}
 \caption[PLOT3D file test]{PLOT3D file test showing a stepped contours in a vertical plane at three different positions.}
...
\begin{tabular}{cc}
 ...
 \end{tabular}
\end{center}
 \caption[PLOT3D file test]{PLOT3D file test showing a velocity vectors shaded by temperature in a vertical plane at three different positions.}
...
\begin{tabular}{cc}
 ...
 \end{tabular}
\end{center}
 \caption[PLOT3D file test]{PLOT3D file test showing a temperature iso-surface for 4 different values.}
