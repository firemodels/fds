...
NAMELIST /MATL/ A,ABSORPTION_COEFFICIENT,ALLOW_SHRINKING,ALLOW_SWELLING,BOILING_TEMPERATURE,COLOR,CONDUCTIVITY,CONDUCTIVITY_RAMP,&
                DENSITY,E,EMISSIVITY,FYI,&
                GAS_DIFFUSION_DEPTH,HEATING_RATE,HEAT_OF_COMBUSTION,HEAT_OF_REACTION,ID,MATL_ID,NU_MATL,NU_SPEC,N_REACTIONS,&
                N_S,N_T,N_O2,PCR,POROSITY,PYROLYSIS_RANGE,REFERENCE_RATE,REFERENCE_TEMPERATURE,RGB,&
