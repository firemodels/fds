...
IF (DT<DT_INITIAL*LIMITING_DT_RATIO .AND. (T+DT)<(T_END-TWO_EPSILON_EB)) STOP_STATUS = INSTABILITY_STOP
...
EXTERNAL_WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS
   ...
   SELECT CASE(IOR)
      ...
      CASE( 1)
         ...
         UU(0,JJ,KK)  = UU_AVG
         OM_UU(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = UU_AVG
      ...
      CASE(-1)
         ...
         OM_UU(EWC%IIO_MIN-1:EWC%IIO_MAX-1,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = UU_AVG
      ...
      CASE( 2)
         ...
         VV(II,0,KK)  = VV_AVG
         OM_VV(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = VV_AVG
      ...
      CASE(-2)
         ...
         OM_VV(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN-1:EWC%JJO_MAX-1,EWC%KKO_MIN:EWC%KKO_MAX) = VV_AVG
      ...
      CASE( 3)
         ...
         WW(II,JJ,0)  = WW_AVG
         OM_WW(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN:EWC%KKO_MAX) = WW_AVG
      ...
      CASE(-3)
         ...
         OM_WW(EWC%IIO_MIN:EWC%IIO_MAX,EWC%JJO_MIN:EWC%JJO_MAX,EWC%KKO_MIN-1:EWC%KKO_MAX-1) = WW_AVG
...
IF ((CFL<CFL_MAX .AND. VN<VN_MAX .AND. PART_CFL<PARTICLE_CFL_MAX .AND. DRAG_CFL < DRAG_CFL_MAX) .OR. LOCK_TIME_STEP) THEN
   ...
   ENDIF
ELSE
   DT_NEW(NM) = 0.9_EB*MIN( CFL_MAX/MAX(UVWMAX,1.E-10_EB) , &
                            PARTICLE_CFL_MAX/MAX(PART_UVWMAX,1.E-10_EB) , &
                            VN_MAX/(2._EB*R_DX2*MAX(MUTRM,1.E-10_EB)) , &
                            DT*DRAG_CFL_MAX/MAX(DRAG_CFL,1.E-10_EB))
   DRAG_CFL = 0._EB
   CHANGE_TIME_STEP_INDEX(NM) = -1
ENDIF
...
SUBROUTINE IBM_VELOCITY_FLUX(DT,NM)
