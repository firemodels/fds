...
Three experiments were conducted in a standard compartment, 3.6~m long by 2.4~m wide by 2.4~m high, with a 0.8~m wide by 2.0~m high door centered on the narrow wall. Each experiment used a constant 450~kW propane burner and a single beam suspended 20~cm below the ceiling along the centerline of the compartment. There were three measurement stations along the beam at lengths of 0.9~m (Position A), 1.8~m (Position B), and 2.7~m (Position C) from the far wall where the fire was either positioned in the corner (Tests 1 and 2), or the center (Test 3). Details can be found in the test report~\cite{Wickstrom_AST}. The gas temperatures reported here were measured at 4 locations surrounding the beam at Position~A, and 2 locations at Positions~B and C.
...
The Hu compartment experiments \cite{Hu:2005} for the prescribed fuel mass flow rate cases were simulated.  The circular vent feature was used.  The background mesh resolution for the (40 cm)$^3$ compartment was $\delta x = 1$ cm.  Near the upper and lower vents the mesh was refined by a factor of 10 for roughly 2 vent heights leading into the compartment domain (see Fig.~\ref{Hu_vent_refinement}).  The fuel is specified as n-heptane with a soot yield of 0.037.  The default radiation parameters in FDS were used.

In Fig.~\ref{Hu_images} below we provide Smokeview renderings of temperature to give the reader a qualitative feel for different dynamics for each case.  The experiments were designed to transition from well-ventilated (Case 1) to completely under-ventilated (Case 4) by varying the size of the vents and the fuel pan diameter, both are visible in the Smokeview images.

\begin{figure}[h]
\centering
\includegraphics[height=3.2in]{FIGURES/Hu_Compartment/Hu_1p_grid_refinement.png} 
\caption[Hu Compartment vent grid refinement]{Hu Compartment Case 1 showing 10:1 mesh refinement around the lower vent.  Green balls represent thermocouple and mass flow virtual sensors.}
\label{Hu_vent_refinement}
\end{figure}

\begin{figure}[h]
\centering
\begin{tabular}{ccc}
\includegraphics[height=2.2in]{FIGURES/Hu_Compartment/Hu_1p_tmp.png} &
\includegraphics[height=2.2in]{FIGURES/Hu_Compartment/Hu_2p_tmp.png} &
\includegraphics[height=2.2in]{FIGURES/Hu_Compartment/Hu_tmp_colorbar.png} \\
\includegraphics[height=2.2in]{FIGURES/Hu_Compartment/Hu_3p_tmp.png} &
\includegraphics[height=2.2in]{FIGURES/Hu_Compartment/Hu_4p_tmp.png} &
\\
\end{tabular}
\caption[Hu Compartment temperature profiles]{Hu Compartment cell-centered slices of temperature toward the end of the simulation.}
\label{Hu_images}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_1_1-4} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_1_5-8} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_1_9-12} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_1_13-16} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_1_17-19} &
\\
\end{tabular*}
\label{Hu_Temp_1}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_2_1-4} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_2_5-8} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_2_9-12} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_2_13-16} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_2_17-19} &
\\
\end{tabular*}
\label{Hu_Temp_2}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_3_1-4} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_3_5-8} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_3_9-12} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_3_13-16} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_3_17-19} &
\\
\end{tabular*}
\label{Hu_Temp_3}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_4_1-4} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_4_5-8} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_4_9-12} &
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_4_13-16} \\
\includegraphics[height=2.2in]{SCRIPT_FIGURES/Hu_Compartment/Hu_Compartment_TC_4_17-19} &
\\
\end{tabular*}
\label{Hu_Temp_4}
\end{figure}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/HGL_Temperature_Natural_Ventilation} \\
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/HGL_Temperature_Forced_Ventilation}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/HGL_Temperature_No_Ventilation} \\
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/HGL_Depth}
\end{tabular}
\end{center}
