...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_DROPLETS,ALLOW_UNDERSIDE_DROPLETS,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                FREEZE_VELOCITY,FYI,GAMMA,GROUND_LEVEL,GVEC,HRRPUVCUT_MAX,HRRPUV_MAX_SMV,IMMERSED_BOUNDARY_METHOD,&
...
REAL(EB) :: MASS_FRACTION_0,MW,SIGMALJ,EPSILONKLJ,VISCOSITY,CONDUCTIVITY,DIFFUSIVITY,MASS_EXTINCTION_COEFFICIENT, &
            ...
            H_V_REFERENCE_TEMPERATURE,MEAN_DIAMETER
...
NAMELIST /SPEC/ ABSORBING,AEROSOL,BACKGROUND,CONDUCTIVITY,DENSITY_LIQUID,DIFFUSIVITY,EPSILONKLJ,FIC_CONCENTRATION,FLD_LETHAL_DOSE,&
...
SPEC_READ_LOOP: DO N=1,N_SPECIES
   ...
   SELECT CASE (ID)
      ...
      CASE('SOOT')
         SOOT_INDEX = N
         IF (SIMPLE_CHEMISTRY) AEROSOL = .TRUE.
      ...
      FIND_SPEC_ID: DO NS2 = 1,N_SPECIES
         IF (TRIM(SPECIES(NS2)%ID) == TRIM(SPEC_ID(NS))) THEN
            ...
            IF (N_SUB_SPECIES==1) THEN
               ...
               IF (SPECIES(NS2)%MODE == AEROSOL_SPECIES) SM%DEPOSITING = .TRUE.
            ENDIF
            EXIT FIND_SPEC_ID
         ENDIF
      ENDDO FIND_SPEC_ID
