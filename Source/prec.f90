...
INTEGER, PARAMETER :: MAX_NUMBER_SPECTRAL_BANDS=9, MAX_NUMBER_FSK_POINTS=32, N_ZONE_POINTS=100
...
INTEGER, PARAMETER :: LABEL_LENGTH=60, MESSAGE_LENGTH=200, FORMULA_LENGTH=255
