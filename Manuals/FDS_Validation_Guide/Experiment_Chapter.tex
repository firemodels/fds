...
Between 2005 and 2008, the French building research laboratory, Centre Scientifique et Technique du B\^{a}timent (CSTB), conducted fire experiments in a tunnel, some of which
involved water mist systems~\cite{Meyrand}. The first aim was to improve the understanding of the interaction between water mist and a tunnel fire. 
...
(8 without water mist and 20 with water mist) with variations in the fuel (heptane pool, wood crib and wood pallet), the longitudinal velocity (with and without back layering), 
and obstructions near the fire.

This tunnel is 43~m long, with a semi-circular cross section whose area is approximately 4~m$^2$. The walls are covered by a fire resistant mortar cement 
with well known thermal properties. The floor is made of concrete. A fan is mounted at the downstream side of the tunnel. 
Measurements were made of the following: fuel mass, gas temperature, air velocity, radiative heat flux and gas composition (CO, CO$_2$ and O$_2$ concentration). 
Sensors were located at 11 positions.  

Tests 2 and 27 have been selected because neither exhibited back layering. The longitudinal velocity in Test~2 was approximately 2.2~m/s and 3.1~m/s in Test~27. All of the
combusted 
The fire load consists of a 0.5~$m^2$ area heptane pool. 
In test 27, a water mist system is manually activated 300~s after ignition. The test duration corresponds to the complete burning of initial heptane quantity. 
Following are some notes concerning the heat release rate and the water mist system :\\
