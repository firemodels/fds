...
REAL(EB) :: Y_FU_0,Y_P_0,Y_LIMITER,A,ETRM,Y_O2_0,Y_CO_0,DYF,DX_FDT,HFAC_F,DTT,DELTA, & 
            ...
            Y_FU_MAX,TMP_F_MIN,Y_F_CORR,Q_BOUND_1,Q_BOUND_2,YY_GET(1:N_TRACKED_SPECIES), &
...
REAL(EB):: ETRM1(1:N_REACTIONS),ETRM,X_I(0:N_TRACKED_SPECIES),X_0(0:N_TRACKED_SPECIES),X_S(0:N_TRACKED_SPECIES),X_N(0:N_TRACKED_SPECIES),&
           ...
           TMPD,DT_ODE,X_MIN,YY_GET(1:N_TRACKED_SPECIES),QFAC
