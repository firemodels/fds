...
REAL(EB), INTENT(IN) :: T
REAL     :: RN
REAL(EB) :: SURFACE_PARTICLE_DIAMETER,XI,YJ,ZK,RD,RDS,RDC,X_OLD,Y_OLD,Z_OLD,THETA_RN,STEP_FRACTION(-3:3)
LOGICAL :: HIT_SOLID
...
REAL(EB) UBAR,VBAR,WBAR,RVC,UREL,VREL,WREL,QREL,RHO_G,TMP_G,MU_AIR, &
         U_OLD,V_OLD,W_OLD,B_1,THROHALF,ZZ_GET(0:N_TRACKED_SPECIES),RDT,WAKE_VEL,DROP_DEN,DROP_VOL_FRAC,RE_WAKE,&
...
INTEGER :: IP,II,JJ,KK,IW,N_LPC,NS,N_SUBSTEPS,ITMP,ITMP2,SURF_INDEX,ITCOUNT,Y_INDEX,Z_INDEX,I_BOIL,I_MELT
REAL(EB), INTENT(IN) :: T
INTEGER, INTENT(IN) :: NM
LOGICAL :: TEMPITER
