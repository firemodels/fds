...
{\ct ASSUMED\_GAS\_TEMPERATURE} & Real          & See Section~\ref{solid_phase_verification}    &               &                   \\ \hline
...
{\ct VN\_MAX}                   & Real          & Von Neumann upper bound                       &               & 1.0               \\ \hline
{\ct VN\_MIN}                   & Real          & Von Neumann lower bound                       &               & 0.8               \\ \hline
\end{tabular*}
\end{table}
%NAMELIST /MISC/
%                C_FORCED,C_VERTICAL,C_HORIZONTAL,H_FIXED,
%                NOISE,
%                GAMMA,HUMIDITY,
...
%                PRESSURE_CORRECTION,CHECK_POISSON,STRATIFICATION
