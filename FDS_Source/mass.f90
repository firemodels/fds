...
USE GLOBAL_CONSTANTS, ONLY: N_GAS_SPECIES,NULL_BOUNDARY,POROUS_BOUNDARY,OPEN_BOUNDARY,INTERPOLATED_BOUNDARY, &
...
CASE(.TRUE.) PREDICTOR_STEP
   ...
   IF (CLIP_MASS_FRACTION) THEN
      YYS(1:IBAR,1:JBAR,1:KBAR,1:N_GAS_SPECIES) = MAX(0._EB,MIN(1._EB,YYS(1:IBAR,1:JBAR,1:KBAR,1:N_GAS_SPECIES)))
   ELSE
...
CASE(.FALSE.) PREDICTOR_STEP
   ...
   IF (CLIP_MASS_FRACTION) THEN
      YY(1:IBAR,1:JBAR,1:KBAR,1:N_GAS_SPECIES) = MAX(0._EB,MIN(1._EB,YY(1:IBAR,1:JBAR,1:KBAR,1:N_GAS_SPECIES)))
   ELSE
      CALL CHECK_MASS_FRACTION
   ENDIF
...
USE GLOBAL_CONSTANTS, ONLY : PREDICTOR, CORRECTOR, N_GAS_SPECIES,RHOMIN,RHOMAX,DEBUG_OPENMP,TWO_D
...
SPECIESLOOP: DO N=1,N_GAS_SPECIES
