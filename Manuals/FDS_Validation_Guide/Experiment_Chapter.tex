...
\begin{sidewaysfigure}[h]
\begin{center}
\includegraphics[width=6.5in]{FIGURES/Harrison_Spill_Plumes/Harrison_Spill_Plumes_Assembly_Drawing}
\end{center}
...
\begin{sidewaysfigure}[h]
\begin{center}
\includegraphics[width=6.5in]{FIGURES/SP_AST/Full_Room_hollowbar}
\end{center}
\caption{Geometry of the Hollowbar room}
...
\end{center}
\caption{Geometry of the I-Beam room}
\label{Room_Drawing}
\end{sidewaysfigure} 
...
\begin{sidewaysfigure}[h]
\begin{center}
\includegraphics[width=6.5in]{FIGURES/Steckler_Compartment/Room_Drawing.pdf}
\end{center}
...
\begin{sidewaysfigure}[h]
\begin{center}
\includegraphics[width=6.5in]{FIGURES/UL_NIST_Vents/UL_NIST_Vents}
\end{center}
