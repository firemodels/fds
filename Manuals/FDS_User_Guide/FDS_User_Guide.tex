...
There are only a small number of species with predefined RadCal absorptivities (See ~\ref{info:RadCal_fuelspecies}).  There are many other species which are absorbing.  For absorbing species not present in Radcal {\ct RADCAL\_ID} can be used to identify a RadCal species to be used as a surrogate. For example:
