...
SUBROUTINE GET_MASS_FRACTION(Y_IN,INDEX,Y_MF)
! Y_MF returns the mass fraction of species INDEX
INTEGER, INTENT(IN) :: INDEX
REAL(EB), INTENT(IN) :: Y_IN(1:N_SPECIES)
REAL(EB) :: Y_MF

Y_MF = Y2Y_C(INDEX) + DOT_PRODUCT(Y2Y(INDEX,:), Y_IN)
Y_MF = MIN(1._EB,MAX(0._EB,Y_MF))

END SUBROUTINE GET_MASS_FRACTION

SUBROUTINE GET_MASS_FRACTION_ALL(Y_IN,Y_MF)
! Y_MF returns the mass fraction of all mixture fraction species
REAL(EB), INTENT(IN) :: Y_IN(1:N_SPECIES)
REAL(EB) :: Y_MF(1:N_Y_ARRAY)
INTEGER :: I

DO I=1,N_Y_ARRAY
   Y_MF(I) = Y2Y_C(I) + DOT_PRODUCT(Y2Y(I,:),Y_IN)
ENDDO
...
D_MF = (Y2D_C(ITMP) + DOT_PRODUCT(Y2D(ITMP,I_Z_MIN:I_Z_MAX),Z))/(Y_MF_SUM_Y_C + DOT_PRODUCT(Y_MF_SUM_Y(I_Z_MIN:I_Z_MAX),Z))

END SUBROUTINE GET_D


SUBROUTINE GET_CP(Y_IN,CP_MF,ITMP)
...
CP_MF = (Y2CP_C(ITMP) + DOT_PRODUCT(Y2CP(ITMP,:),Y_IN))!/(Y_MF_SUM_Y_C + DOT_PRODUCT(Y_MF_SUM_Y,Y_IN))

END SUBROUTINE GET_CP

SUBROUTINE GET_CPBAR(Y_IN,CPBAR_MF,ITMP)
...
CPBAR_MF = (Y2CPBAR_C(ITMP) + DOT_PRODUCT(Y2CPBAR(ITMP,:),Y_IN))!/(Y_MF_SUM_Y_C + DOT_PRODUCT(Y_MF_SUM_Y,Y_IN))

END SUBROUTINE GET_CPBAR

SUBROUTINE GET_H_G(Y_IN,H_G_MF,ITMP)
...
H_G_MF = (Y2H_G_C(ITMP) + DOT_PRODUCT(Y2H_G(ITMP,:),Y_IN))!/(Y_MF_SUM_Y_C + DOT_PRODUCT(Y_MF_SUM_Y,Y_IN))

END SUBROUTINE GET_H_G

SUBROUTINE GET_K(Y_IN,K_MF,ITMP)
...
K_MF = (Y2K_C(ITMP) + DOT_PRODUCT(Y2K(ITMP,:),Y_IN))*MW_MF

END SUBROUTINE GET_K

SUBROUTINE GET_MU(Y_IN,MU_MF,ITMP)
...
MU_MF = (Y2MU_C(ITMP)+DOT_PRODUCT(Y_IN,Y2MU(ITMP,:)))*MW_MF
