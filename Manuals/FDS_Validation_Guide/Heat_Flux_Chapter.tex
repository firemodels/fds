...
Attenuation of thermal radiation was measured at five heights in water sprays produced by seven full-elliptic type hydraulic nozzles. The operating pressure is set to 4~bar, 
the half ejection angles have been measured in a previous study. The initial speed is deduced from the water flow rate and the orifice diameter. The droplet size at the injection point is set by comparing the predicted and measured results at the PDPA measurement location 0.2~m below the nozzles.
...
\begin{figure}[p]
\begin{tabular}{c}
%\includegraphics[width=5.0in]{FIGURES/LEMTA_Spray/LEMTA_Spray_Attenuation}
\end{tabular}
\label{LEMTA_Spray_Attenuation}
\caption[Summary of radiation attenuation, LEMTA Spray test series.]{Summary radiation attenuations in the LEMTA Spray test series.}
\end{figure} 