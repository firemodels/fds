...
TYPE TRIANGULAR_SURFACE_TYPE
   INTEGER :: NODE(3)=0
   REAL(EB) :: NVEC(3)=0._EB
   CHARACTER(30) :: SURF_ID='null'
END TYPE TRIANGULAR_SURFACE_TYPE

TYPE(TRIANGULAR_SURFACE_TYPE), POINTER, DIMENSION(:) :: TRIANGULAR_SURFACE

TYPE TRINODES_TYPE
   REAL(EB) :: X,Y,Z
END TYPE TRINODES_TYPE

TYPE(TRINODES_TYPE), POINTER, DIMENSION(:) :: TRINODES
