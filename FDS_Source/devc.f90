...
TYPE DEVICE_TYPE
   REAL(EB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INITIAL_VALUE=-1.E10_EB,INSTANT_VALUE,AVERAGE_VALUE=0._EB,AVERAGE_VALUE2=0._EB,&
               ...
               STATISTICS_DT=1.E20_EB,STATISTICS_START=-1.E20_EB
   REAL(EB) :: PDPA_NUMER=0._EB,PDPA_DENUM=0._EB
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: D_PATH,TIME_ARRAY,AVERAGE_ARRAY,AVERAGE2_ARRAY,RMS_ARRAY,RMS2_ARRAY,COV_ARRAY
