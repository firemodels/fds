...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=2.5in]{sample_time_history}
\end{center}
...
\begin{figure}[ht!]
\begin{tabular}{ll}
\includegraphics[width=2.8in]{Wall_Temperature_Scatter} &
\includegraphics[width=3.0in]{Wall_Temperature_Normality}
\end{tabular}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=5.in]{bell_curve}
\end{center}
...
\bibitem[Hill et~al.(2007)Hill, Dreisbach, Joglar, Najafi, McGrattan, Peacock,
  and Hamins]{NUREG_1824}
K.~Hill, J.~Dreisbach, F.~Joglar, B.~Najafi, K.~McGrattan, R.~Peacock, and
  A.~Hamins.
\newblock {Verification and Validation of Selected Fire Models for Nuclear
  Power Plant Applications}.
\newblock {NUREG}-1824, United States Nuclear Regulatory Commission,
  Washington, DC, 2007.
\newblock EPRI 1011999.

\bibitem[Nat(2001)]{NFPA_805}
...
\bibitem[Salley and Wachowiak(2007)]{NUREG_1934}
M.H. Salley and R.~Wachowiak.
\newblock {Nuclear Power Plant Fire Modeling Analysis Guidelines}.
\newblock {NUREG}-1934, United States Nuclear Regulatory Commission,
  Washington, DC, 2007.
\newblock EPRI 1023259.

\bibitem[Peacock et~al.(1999)Peacock, Reneke, Davis, and
  Jones]{Peacock:FSJ1999}
R.D. Peacock, P.A. Reneke, W.D. Davis, and W.W. Jones.
\newblock {Quantifying fire model evaluation using functional analysis}.
\newblock \emph{Fire Safety Journal}, 33:\penalty0 167--184, 1999.

\bibitem[Walton and Thomas(2008)]{SFPE:Walton}
...
\bibitem[McGrattan and Toman(2011)]{McGrattan:Metrologia}
K.~McGrattan and B.~Toman.
\newblock Quantifying the predictive uncertainty of complex numerical models.
\newblock \emph{Metrologia}, 48:\penalty0 173--180, 2011.

\bibitem[Oehlert(1992)]{Oehlert:1992}
G.~Oehlert.
\newblock {A Note on the Delta Method}.
\newblock \emph{The American Statistician}, 46\penalty0 (1):\penalty0 27--29,
  1992.

\bibitem[Siu et~al.(1992)Siu, Karydas, and Temple]{Siu:1992}
...
\bibitem[Heskestad(2008)]{SFPE:Heskestad}
G.~Heskestad.
