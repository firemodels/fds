...
\begin{table}[!h]
\caption[Input parameters for FM/SNL cases, plume temperature (Heskestad).]
{Summary of input parameters used for FM/SNL cases, plume temperature (Heskestad).}
...
\begin{table}[!h]
\caption[Input parameters for UL/NFPRF cases, plume temperature (Heskestad).]
{Summary of input parameters used for UL/NFPRF cases, plume temperature (Heskestad).}
...
\begin{table}[!h]
\caption[Input parameters for USN Hawaii cases, plume temperature (Heskestad).]
{Summary of input parameters used for USN Hawaii cases, plume temperature (Heskestad).}
...
\begin{table}[!h]
\caption[Input parameters for VTT Large Hall cases, plume temperature (Heskestad).]
{Summary of input parameters used for VTT Large Hall cases, plume temperature (Heskestad).}
