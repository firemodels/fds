...
In this section, the predicted burning rates of a variety of liquid pool fires are compared with an empirical correlation. The pool fires are assumed to burn in a 1~m by 1~m square tray, and the pool is 10~cm deep. The burning rate of liquid hydrocarbon fuels has been found to correlate well with the ratio of the heat of combustion, $\Delta h_{\rm c}$, and the heat of gasification, $\Delta h_{\rm g}$:
\begin{equation}
...
\begin{tabular}{|l|c|c|c|c|c|c|c|} \hline
        & $\rho$               & $c_p$                        & $k$                &  $\Delta h_{\rm v}$         & $\chi_{\rm r}$       & $y_{\rm s}$          & $T_{\rm b}$  \\
...
Benzene  &  874  &  1.74   & 0.14  &   393   & 0.60 & 0.181 & 80.3 \\ \hline
Butane   &  573  &  2.28   & 0.12  &   385   & 0.31 & 0.029 & 0    \\ \hline
Ethanol  &  794  &  2.44   & 0.17  &   837   & 0.25 & 0.008 & 78.5 \\ \hline
Heptane  &  675  &  2.24   & 0.14  &   317   & 0.33 & 0.037 & 98.5 \\ \hline
Methanol &  796  &  2.48   & 0.20  &   1099  & 0.16 & 0.001 & 64.8 \\ \hline
\end{tabular}
\end{center}
\end{table}
