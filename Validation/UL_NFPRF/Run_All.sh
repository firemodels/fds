...
$QFDS $DEBUG -r $QUEUE -p 16 -d $INDIR UL_NFPRF_P-1.fds
$QFDS $DEBUG -r $QUEUE -p 16 -d $INDIR UL_NFPRF_P-2.fds
$QFDS $DEBUG -r $QUEUE -p 16 -d $INDIR UL_NFPRF_P-3.fds
$QFDS $DEBUG -r $QUEUE -p 16 -d $INDIR UL_NFPRF_P-4.fds
$QFDS $DEBUG -r $QUEUE -p 16 -d $INDIR UL_NFPRF_P-5.fds
