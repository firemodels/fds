...
REAL(EB) :: ZZ_0(1:N_TRACKED_SPECIES),ZZ_NEW(1:N_TRACKED_SPECIES),DZZ(1:N_TRACKED_SPECIES),&
            UNMIXED_MASS_0(1:N_TRACKED_SPECIES),MIXED_MASS(1:N_TRACKED_SPECIES),MIXED_MASS_0(1:N_TRACKED_SPECIES),&
            BOUNDEDNESS_CORRECTION,Q_REAC_OUT(1:N_REACTIONS),TOTAL_MIXED_MASS,TOTAL_MIXED_MASS_0,TOTAL_UNMIXED_MASS_0
INTEGER :: SR
INTEGER, PARAMETER :: INFINITELY_FAST=1,FINITE_RATE=2

! Determine initial state of unmixed and mixed reactor zones

UNMIXED_MASS_0 = CELL_MASS*ZZ_UNMIXED*ZETA_IN
TOTAL_UNMIXED_MASS_0 = SUM(UNMIXED_MASS_0)
TOTAL_MIXED_MASS_0 = CELL_MASS - TOTAL_UNMIXED_MASS_0
MIXED_MASS_0 = TOTAL_MIXED_MASS_0*ZZ_IN
