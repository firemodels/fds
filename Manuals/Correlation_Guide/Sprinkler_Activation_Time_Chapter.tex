...
For a steady-state fire, the correlation of Alpert~\cite{SFPE:Alpert} predicts that the activation time of a sprinkler, $t\sb{act}$, is given by~\cite{NFPA}
\be
t\sb{act} =  \frac{\mathrm{RTI}}{\sqrt{u\sb{jet}}} \ln \left( \frac{T\sb{jet} - T_\infty}{T\sb{jet} - T\sb{act}} \right)\label{eq:Alpert}
\ee
