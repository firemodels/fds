...
USE MATH_FUNCTIONS, ONLY : EVALUATE_RAMP
REAL(EB) :: T,YY_EXTERIOR(MAX_SPECIES),YY_G,RHO_G,UN,DD,MFT,TSI,RADIUS,AREA,RVC,RHO_NEW,M_DOT_PPP,CP,MW_RATIO,H_G,DELTA_H_G
...
REAL(EB) :: DTMP,QNETF,QDXKF,QDXKB,RR,TMP_G,T,RFACF,RFACB,RFACF2,RFACB2,PPCLAUS,PPSURF,TMP_G_B,DT_BC, &
            DXKF,DXKB,REACTION_RATE,QRADINB,RFLUX_UP,RFLUX_DOWN,E_WALLB,RADIUS, &
...
!            MFLUX_S = MF_FRAC(I)*REACTION_RATE/RDX_S(I)/SF%THICKNESS**I_GRAD
            MFLUX_S = MF_FRAC(I)*REACTION_RATE/RDX_S(I)/RADIUS**I_GRAD
