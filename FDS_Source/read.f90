...
USE SCARC_SOLVER, ONLY: SCARC_METHOD, SCARC_DEBUG, SCARC_COMPARE, SCARC_CASE, &
                        SCARC_NIT_CG  , SCARC_PRECON_CG  , SCARC_EPS_CG  , SCARC_OMEGA_CG  , &
                        SCARC_NIT_MG  , SCARC_PRECON_MG  , SCARC_EPS_MG  , SCARC_OMEGA_MG  , &
                        SCARC_NIT_SM  , SCARC_PRECON_SM  , SCARC_EPS_SM  , SCARC_OMEGA_SM  , &
                        SCARC_NIT_CO  , SCARC_PRECON_CO  , SCARC_EPS_CO  , SCARC_OMEGA_CO  , &
                        SCARC_NIT_BICG, SCARC_PRECON_BICG, SCARC_EPS_BICG, SCARC_OMEGA_BICG, &
...
NAMELIST /PRES/ VELOCITY_TOLERANCE,MAX_PRESSURE_ITERATIONS,PRESSIT_RELAX_FACTOR,PRESSIT_ACCELERATOR,PRESSIT_SCALE_FACTOR, &
                ...
                SCARC_METHOD, SCARC_DEBUG, SCARC_COMPARE, SCARC_CASE, &
                SCARC_NIT_CG  , SCARC_PRECON_CG  , SCARC_EPS_CG  , SCARC_OMEGA_CG  , &
                SCARC_NIT_MG  , SCARC_PRECON_MG  , SCARC_EPS_MG  , SCARC_OMEGA_MG  , &
                SCARC_NIT_SM  , SCARC_PRECON_SM  , SCARC_EPS_SM  , SCARC_OMEGA_SM  , &
                SCARC_NIT_CO  , SCARC_PRECON_CO  , SCARC_EPS_CO  , SCARC_OMEGA_CO  , &
