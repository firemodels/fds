...
The figures on the following pages display comparisons of measured and predicted mean (left plot) and root mean square (right plot)  temperatures above a 30~cm diameter methanol pool fire. Each plot displays radial profiles of temperature at heights ranging from 2~cm to 30~cm. Time resolved temperature data was measured using 50~$\mu$m diameter, bare-wire thermocouples (Pt~vs~Pt-10\%~Rh) with known bead diameters in the range of 75~$\mu$m to 100~$\mu$m.
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms temperature, 2~cm to 8~cm above the burner]
{Waterloo Methanol, radial profiles of mean and rms temperature, 2~cm to 8~cm above the burner.}
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms temperature, 10~cm to 16~cm above the burner]
{Waterloo Methanol, radial profiles of mean and rms temperature, 10~cm to 16~cm above the burner.}
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of mean and rms temperature, 18~cm to 30~cm above the burner]
{Waterloo Methanol, radial profiles of mean and rms temperature, 18~cm to 30~cm above the burner.}
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of $T'w'$ and $T'u'$, 2~cm to 8~cm above the burner]
{Waterloo Methanol, radial profiles of $T'w'$ (left) and $T'u'$ (right), 2~cm to 8~cm above the burner.}
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of $T'w'$ and $T'u'$, 10~cm to 16~cm above the burner]
{Waterloo Methanol, radial profiles of $T'w'$ (left) and $T'u'$ (right), 10~cm to 16~cm above the burner.}
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of $T'w'$ and $T'u'$, 18~cm to 30~cm above the burner]
{Waterloo Methanol, radial profiles of $T'w'$ (left) and $T'u'$ (right), 18~cm to 30~cm above the burner.}
