...
TYPE PARTICLE_CLASS_TYPE
   ...
   INTEGER :: NUMBER_INITIAL_DROPLETS,SAMPLING,N_INSERT,SPEC_INDEX,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
              SURF_INDEX=-1,WALL_INDEX_START=-1,DRAG_LAW=1
...
TYPE GEOMETRY_TYPE
   CHARACTER(30) :: SHAPE='SPHERE'
   REAL(EB) :: X0=0._EB,Y0=0._EB,Z0=0._EB,X=0._EB,Y=0._EB,Z=0._EB,RADIUS=0._EB
...
TYPE INITIALIZATION_TYPE
   REAL(EB) :: TEMPERATURE,DENSITY,MASS_FRACTION(MAX_SPECIES),X1,X2,Y1,Y2,Z1,Z2,MASS_PER_VOLUME
