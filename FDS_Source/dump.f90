...
DO N=0,N_PROP
   ...
   WRITE(LU_SMV,'(1X,A)') TRIM(PY%SMOKEVIEW_ID)
   ...
   WRITE(LU_SMV,'(I3)') N_TEXT
   DO NN=1,N_TEXT
      WRITE(LU_SMV,'(1X,A)') PY%TEXTURE_MAP
   ENDDO
ENDDO
...
DO N=1,N_DEVC
   ...
   WRITE(LU_SMV,'(6F12.5,2I3,A,A)') DV%X,DV%Y,DV%Z,DV%ORIENTATION(1:3),0,0,' % ',TRIM(PY%ID)
ENDDO
