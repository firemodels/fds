...
\begin{center}
\includegraphics[height=6.in]{FIGURES/ATF_Corridors/ATF}
\end{center}
...
\begin{center}
\vspace{-2in}
\includegraphics[height=8.8in]{FIGURES/Harrison_Spill_Plumes/Harrison_Spill_Plumes_Assembly_Drawing}
\end{center}
\vspace{-1.5in}
...
\begin{sidewaysfigure}[p]
\begin{center}
\includegraphics[height=6.in]{FIGURES/NBS/NBS_Drawing}
\end{center}
...
The NIST Full Scale Enclosure Experiments consisted of a series of experiments conducted in an ISO-9705 compartment~\cite{Lock:1}. The experiments were designed to study the effects of fuel type, fuel distribution, and vent size on underventilated compartment fires. Over 20 experiments were considered as part of the analysis, which included 7 different fuels, 3 fuel sources, and 4 ventilation openings. Table~\ref{tab:NIST_FSE_Exp} provides a summary of the experiments. Species concentrations and temperature measurements were made at the front and rear of the compartment.
...
\hline
Test ID  &  Fuel         &  Fuel Mass (kg) &  \# of Burners  &  Burner Size (m$^2$) &  Doorway Opening (cm)  \\ \hline \hline
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=6.5in]{FIGURES/SP_AST/Fullroom_Drawing}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=6in]{FIGURES/Steckler_Compartment/Room_Drawing.pdf}
\end{center}
...
Zhang et al.~\cite{Zhang:IAFSS9} measured the heat flux and flame heights from
