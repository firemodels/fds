...
REAL(EB), PARAMETER :: ALMOST_ONE_EB=1._EB-EPSILON(1._EB)     !< Largest number that is < 1 in 8 byte accuracy
REAL(EB), PARAMETER :: MICRON_EB=1.E-6_EB                     !< A relatively small length (m)
