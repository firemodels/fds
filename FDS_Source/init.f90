...
IF (.NOT.EVACUATION_ONLY(NM)) THEN
   ALLOCATE( M%ZZ(0:IBP1,0:JBP1,0:KBP1,N_TRACKED_SPECIES+N_PASSIVE_SCALARS),STAT=IZERO)
   CALL ChkMemErr('INIT','ZZ',IZERO)
   M%ZZ = 0._EB
   ALLOCATE(M%ZZS(0:IBP1,0:JBP1,0:KBP1,N_TRACKED_SPECIES+N_PASSIVE_SCALARS),STAT=IZERO)
   CALL ChkMemErr('INIT','ZZS',IZERO)
   M%ZZS = 0._EB  
   ALLOCATE(M%DEL_RHO_D_DEL_Z(0:IBP1,0:JBP1,0:KBP1,N_TRACKED_SPECIES+N_PASSIVE_SCALARS),STAT=IZERO)
...
ALLOCATE( M%FX(0:IBP1,0:JBP1,0:KBP1,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS),STAT=IZERO)
CALL ChkMemErr('INIT','FX',IZERO)
ALLOCATE( M%FY(0:IBP1,0:JBP1,0:KBP1,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS),STAT=IZERO)
CALL ChkMemErr('INIT','FY',IZERO)
ALLOCATE( M%FZ(0:IBP1,0:JBP1,0:KBP1,1:N_TRACKED_SPECIES+N_PASSIVE_SCALARS),STAT=IZERO)
...
IF (.NOT.EVACUATION_ONLY(NM)) THEN
   ...
   ENDDO
   DO N=N_TRACKED_SPECIES+1,N_TRACKED_SPECIES+N_PASSIVE_SCALARS
