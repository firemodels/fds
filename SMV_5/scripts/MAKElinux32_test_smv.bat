...
Rem  Windows batch file to build a test Smokeview for 32 bit Linux
...
plink %svn_logon% %scriptdir%/ssh_command.csh fire79 %scriptdir% make_smv_linux32test.csh %smv_revision%
