...
Rodney Bryant of NIST performed a series of velocity measurements of the gas
...
to facilitate the laser measurements.

The measurements were made using both bi-directional probes and PIV (Particle Image Velocimetry). Bryant reports that
the bi-directional probe measurements were up to 20~\% greater than the PIV measurements in certain regions of 
the flow, in particular near the top of the doorway. Consequently, only the PIV data was used for comparison to the 
model.
