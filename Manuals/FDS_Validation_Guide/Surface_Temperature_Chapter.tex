...
\subsection{Hasemi LocFire Column}

A brief description of the experiments is given in Section~\ref{Hasemi_LocFire_Column_Description}. The square steel column (0.1 m $\times$ 0.1 m, 3.2 mm thick and 1.6 m tall) is located just beside a 0.3 m square, 0.25 m high propane burner. Four fire experiments were performed, labeled as Tests~1-4.

Figure~\ref{Hasemi_LocFire_Column_Steel1} displays the steel temperatures at the front surface facing the fire source and Figure~\ref{Hasemi_LocFire_Column_Steel2} displays the steel temperatures at other surfaces.  Locations of F5 through B7 were shown in Fig.~\ref{Hasemi_LocFire_Column_Description}. 

\newpage

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_F5-7} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_F8-10} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_F11-13} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_F14-15} \\
\end{tabular*}
\caption[Hasemi LocFire Column, Steel temperatures]{Hasemi LocFire Column, Steel temperatures.}
\label{Hasemi_LocFire_Column_Steel1}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_FS3-5} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_SI5-7} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_SII1-2} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_SII3-4} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_B2-4} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Hasemi_LocFire_Column/Test_1_B5-7} \\
\end{tabular*}
\caption[Hasemi LocFire Column, Steel temperatures]{Hasemi LocFire Column, Steel temperatures.}
\label{Hasemi_LocFire_Column_Steel2}
\end{figure}
