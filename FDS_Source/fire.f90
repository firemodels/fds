...
INTEGRATION_LOOP: DO TIME_ITER = 1,MAX_CHEMISTRY_ITERATIONS
   ...
   IF (SUPPRESSION .AND. TIME_ITER==1) EXTINCT = FUNC_EXTINCT(ZZ_MIXED,TMP_MIXED,TAU_RES)
      ...
      CASE (EXPLICIT_EULER) ! Simple chemistry
         ...
         DO SR=0,N_SERIES_REACTIONS
            CALL FIRE_FORWARD_EULER(ZZ_MIXED_NEW,ZETA,ZZ_MIXED,ZETA_0,DT_SUB,TMP_MIXED,TMP_UNMIXED,RHO_HAT,ZZ_UNMIXED,&
                                    CELL_MASS,TAU_MIX,PBAR_0,DELTA,VEL_RMS)
...
IF (TEMPERATURE_DEPENDENT_REACTION) THEN
   ...
   CALL GET_AVERAGE_SPECIFIC_HEAT(ZZ_0,CPBAR_MIXED_0,TMP_MIXED)
   TMP_MIXED_0 = TMP_MIXED
   DO ITER=1,3
      CALL GET_AVERAGE_SPECIFIC_HEAT(ZZ_0,CPBAR_MIXED,TMP_MIXED)
      TMP_MIXED = ( TOTAL_MIXED_MASS_0*CPBAR_MIXED_0*TMP_MIXED_0 + &
                   (TOTAL_MIXED_MASS-TOTAL_MIXED_MASS_0)*CPBAR_UNMIXED*TMP_UNMIXED ) / TOTAL_MIXED_MASS*CPBAR_MIXED
   ENDDO
ENDIF
