...
TYPE SPECIES_TYPE
   REAL(EB) :: MW,YY0,RCON,MAXMASS,MASS_EXTINCTION_COEFFICIENT,D(5000)
...
TYPE SURFACE_TYPE
   REAL(EB) :: SLIP_FACTOR,TMP_FRONT,TMP_INNER,VEL,PLE,Z0,CONVECTIVE_HEAT_FLUX, NET_HEAT_FLUX, &
               ...
               TMP_IGN,H_V,REGRID_FACTOR,LAYER_DIVIDE,BOUNDARY_LAYER_THICKNESS,ROUGHNESS
...
TYPE OBSTRUCTION_TYPE
   ...
   REAL(EB) :: TRANSPARENCY = 1._EB,BULK_DENSITY=-1._EB
...
TYPE SLICE_TYPE
   ...
   LOGICAL :: TWO_BYTE
   REAL(EB):: SLICE_AGL
   LOGICAL :: TERRAIN_SLICE=.FALSE.,CELL_CENTERED_SLICE=.FALSE., FIRE_LINE=.FALSE.
