...
USE SCARC_SOLVER, ONLY: SCARC_METHOD, SCARC_PRECON, SCARC_COMPARE, SCARC_DEBUG, &
                        SCARC_NIT, SCARC_EPS, SCARC_EPS_REL, SCARC_EPS_STOP, SCARC_PERIODIC
...
NAMELIST /PRES/ VELOCITY_TOLERANCE,MAX_PRESSURE_ITERATIONS,PRESSIT_RELAX_FACTOR, &
                ...
                SCARC_METHOD, SCARC_PRECON, SCARC_COMPARE, SCARC_DEBUG, &
                SCARC_NIT, SCARC_EPS, SCARC_EPS_REL, SCARC_EPS_STOP, SCARC_PERIODIC
