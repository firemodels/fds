...
REAL(EB) :: USER_DRAG_COEFFICIENT,FREE_AREA_FRACTION
...
NAMELIST /PART/ AGE,BREAKUP,BREAKUP_CNF_RAMP_ID,BREAKUP_DISTRIBUTION,BREAKUP_GAMMA_D,BREAKUP_RATIO,&
                ...
                TURBULENT_DISPERSION,USER_DRAG_COEFFICIENT,VERTICAL_VELOCITY,&
...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2), &
            ...
            SPREAD_RATE,XYZ(3),MINIMUM_LAYER_THICKNESS,VEL_GRAD,MASS_FRACTION(MAX_SPECIES),HM_FIXED
...
NAMELIST /SURF/ ADIABATIC,BACKING,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,&
                ...
                HRRPUA,H_FIXED,ID,IGNITION_TEMPERATURE,LAYER_DIVIDE,&
                ...
                EXTERNAL_FLUX_RAMP,TAU_EXTERNAL_FLUX,HM_FIXED ! Backwards compatability??
