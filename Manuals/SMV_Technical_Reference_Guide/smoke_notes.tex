...
b) black body temperature curve 1000~K to 2800~K\\
\includegraphics[width=5.0in]{figures/colorbar_rainbow}\\
c) rainbow
\end{tabular}
\end{center}
\caption[Three example colorbars used to map temperature to color.]
{Three example used to map temperature to color.}
\label{fig:colormaps}
\end{figure}
...
a) view from left&c) view from right\\
\end{tabular}
\end{center}
