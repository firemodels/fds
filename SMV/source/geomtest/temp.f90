...
TYPE GEOMETRY_TYPE ! this TYPE definition will be moved to FDS
   ...
   REAL(EB) :: AZIM, ELEV, XYZ0(3), XYZ(3), SCALE(3)
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: DAZIM, DELEV, DSCALE
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: DXYZ0, DXYZ
...
PRIVATE
PUBLIC :: READ_HEAD,READ_MESH,READ_SURF,GET_SURF_INDEX,N_SURF,NMESHES
