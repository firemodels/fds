...
\underbrace{\mathrm{C_2H_3Cl}}_\text{Fuel} + \underbrace{\mathrm{1.53 \, (O_2+(^{.79}/_{.21}) \, N_2})}_\text{Oxidizer} \rightarrow \\
\nonumber \underbrace{\mathrm{HCl +  H_2O + 0.14\, CO + 0.96\, CO_2 + 0.90\, C + 1.53\,(^{.79}/_{.21}) \, N_2}}_\text{Products}
\end{eqnarray}
