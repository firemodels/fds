...
REAL(EB) :: ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E, &
            ...
            PDPA_HISTOGRAM_LIMITS(2),HISTOGRAM_LIMITS(2), &
            P0,PX(3),PXX(3,3)
EQUIVALENCE(PDPA_HISTOGRAM_LIMITS,HISTOGRAM_LIMITS)
...
INTEGER ::I,N,NN,PDPA_M,PDPA_N,PARTICLES_PER_SECOND,VELOCITY_COMPONENT,PDPA_HISTOGRAM_NBINS,HISTOGRAM_NBINS,FED_ACTIVITY
LOGICAL :: PDPA_INTEGRATE,PDPA_NORMALIZE,HISTOGRAM_NORMALIZE,PDPA_HISTOGRAM,HISTOGRAM, &
           PDPA_HISTOGRAM_CUMULATIVE,HISTOGRAM_CUMULATIVE
EQUIVALENCE(PDPA_HISTOGRAM_NBINS,HISTOGRAM_NBINS)
EQUIVALENCE(PDPA_HISTOGRAM,HISTOGRAM)
EQUIVALENCE(PDPA_HISTOGRAM_CUMULATIVE,HISTOGRAM_CUMULATIVE)
