...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   IF (SF%BLOWING .AND. SF%GEOMETRY==SURF_SPHERICAL) SF%HEAT_TRANSFER_MODEL = H_BLOWING_SPHERE
   IF (SF%BLOWING .AND. SF%GEOMETRY/=SURF_SPHERICAL) SF%HEAT_TRANSFER_MODEL = H_BLOWING_PLATE
