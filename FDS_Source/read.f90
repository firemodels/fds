...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,PRESSURE_RELAX_FACTOR,RELAXATION_FACTOR,FYI, &
                ...
                U0,V0,W0,HUMIDITY, &
                POROUS_FLOOR,SUPPRESSION,CO_PRODUCTION, SOOT_DEPOSITION,&
                ...
                CONSTANT_PROPERTIES,FLUXMAX,DYNSMAG,DSMAG_FREQ,EMBEDDED_MESH,ALLOW_ZONE_BREAKS, &
...
OUTPUT_QUANTITY(50)%NAME = 'RESOLVED_KINETIC_ENERGY'
OUTPUT_QUANTITY(50)%UNITS = 'm2/s2'
OUTPUT_QUANTITY(50)%SHORT_NAME = 'rke'

OUTPUT_QUANTITY(51)%NAME = 'SUBGRID_KINETIC_ENERGY'
OUTPUT_QUANTITY(51)%UNITS = 'm2/s2'
OUTPUT_QUANTITY(51)%SHORT_NAME = 'sgs_tke'

OUTPUT_QUANTITY(52)%NAME = 'TURBULENCE_RESOLUTION'
OUTPUT_QUANTITY(52)%UNITS = '  '
OUTPUT_QUANTITY(52)%SHORT_NAME = 'mtr'
