...
LOGICAL :: L_TMP,CHECK_ATOM_BALANCE,FAST_CHEMISTRY,SERIES_REACTION,REVERSE,THIRD_BODY,REIGNITION_REACTION
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                REAC_MASS_ERROR,REIGNITION_REACTION,RIG_ID,REVERSE,SOOT_H_FRACTION,SOOT_YIELD,&
...
REAC_READ_LOOP: DO NR=1,N_REACTIONS
   ...
   RN%REIGNITION_REACTION       = REIGNITION_REACTION
   RN%REVERSE                   = REVERSE
   RN%RIG_ID                    = RIG_ID
