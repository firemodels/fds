...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=4.0in]{FIGURES/Scatterplots/Plume_Temperature_Heskestad} \\
\includegraphics[width=4.0in]{FIGURES/Scatterplots/Plume_Temperature_McCaffrey}
\end{tabular}
\end{center}
\caption[Summary of plume temperature predictions using the Heskestad method.]
{Summary of plume temperature predictions using the Heskestad (top) and McCaffrey (bottom) method.}
