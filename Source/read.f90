...
LOGICAL :: VECTOR,CELL_CENTERED,DEBUG,UNIQUE_SLICE
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   REWIND(LU_INPUT) ; INPUT_FILE_LINE_NUMBER = 0
   ALLOCATE(M%UNIQUE_SLICE_NAMES(N_SLCF_O))
   DO NN=1,N_SLCF_O
      M%UNIQUE_SLICE_NAMES(NN)=""
   ENDDO
   M%N_UNIQUE_SLCF=0
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      ENDIF
      UNIQUE_SLICE = .TRUE.
      DO I = 1,M%N_UNIQUE_SLCF+1
         IF (SLCF_NAME.EQ.M%UNIQUE_SLICE_NAMES(I)) THEN
            UNIQUE_SLICE = .FALSE.
         ENDIF
      ENDDO
      IF (UNIQUE_SLICE) THEN
         M%N_UNIQUE_SLCF = M%N_UNIQUE_SLCF + 1
         M%UNIQUE_SLICE_NAMES(M%N_UNIQUE_SLCF) = SLCF_NAME
      ENDIF
   ...
   ALLOCATE(M%EMPTY_UNIQUE_SLICE(M%N_UNIQUE_SLCF))
   DO I = 1,M%N_UNIQUE_SLCF
   ...
   DO NN = 1,N_SLCF
      ...
      ENDIF
      DO I = 1,M%N_UNIQUE_SLCF
         IF (SL%SLCF_NAME.EQ.M%UNIQUE_SLICE_NAMES(I)) THEN
            M%EMPTY_UNIQUE_SLICE(I)=.FALSE.
         ENDIF
         !WRITE(*,*) NM, TRIM(SL%SLCF_NAME), TRIM(M%UNIQUE_SLICE_NAMES(I)), M%EMPTY_UNIQUE_SLICE(I)
      ENDDO
   ENDDO
   
   DO I = 1,M%N_UNIQUE_SLCF
      WRITE(*,*) NM, TRIM(M%UNIQUE_SLICE_NAMES(I)), M%EMPTY_UNIQUE_SLICE(I)
   ENDDO
