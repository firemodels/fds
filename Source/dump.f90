         ...
         SOLID_STATS_SELECT: SELECT CASE(DV%SPATIAL_STATISTIC)
            ...
            CASE DEFAULT SOLID_STATS_SELECT
               ...
               WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
                  ...
                  IF (X_CENTER<SDV%X1-MICRON_EB .OR. X_CENTER>SDV%X2+MICRON_EB .OR. &
                      Y_CENTER<SDV%Y1-MICRON_EB .OR. Y_CENTER>SDV%Y2+MICRON_EB .OR. &
                      Z_CENTER<SDV%Z1-MICRON_EB .OR. Z_CENTER>SDV%Z2+MICRON_EB) CYCLE WALL_CELL_LOOP
               ...
               CFACE_LOOP : DO ICF=1,N_CFACE_CELLS
                  ...
                  IF (X_CENTER<SDV%X1-MICRON_EB .OR. X_CENTER>SDV%X2+MICRON_EB .OR. &
                      Y_CENTER<SDV%Y1-MICRON_EB .OR. Y_CENTER>SDV%Y2+MICRON_EB .OR. &
                      Z_CENTER<SDV%Z1-MICRON_EB .OR. Z_CENTER>SDV%Z2+MICRON_EB) CYCLE CFACE_LOOP
                  VALUE = SOLID_PHASE_OUTPUT(NM,ABS(DV%QUANTITY_INDEX(1)),DV%Y_INDEX,DV%Z_INDEX,DV%PART_CLASS_INDEX,&
               ...
               PARTICLE_LOOP: DO IP=1,NLP
                  ...
                  IF (X_CENTER<SDV%X1-MICRON_EB .OR. X_CENTER>SDV%X2+MICRON_EB .OR. &
                      Y_CENTER<SDV%Y1-MICRON_EB .OR. Y_CENTER>SDV%Y2+MICRON_EB .OR. &
                      Z_CENTER<SDV%Z1-MICRON_EB .OR. Z_CENTER>SDV%Z2+MICRON_EB) CYCLE PARTICLE_LOOP
                  VALUE = SOLID_PHASE_OUTPUT(NM,ABS(DV%QUANTITY_INDEX(1)),DV%Y_INDEX,DV%Z_INDEX,DV%PART_CLASS_INDEX,&
