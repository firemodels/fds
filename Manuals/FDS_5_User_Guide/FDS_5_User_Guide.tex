...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=3in]{FIGURES/duct_flow}
\includegraphics[width=3in]{FIGURES/duct_flow_iterations}
\end{center}
...
example (box\_burn\_away), the released gas is fuel (mixture fraction)
and in the second example (box\_burn\_away2) it is an additional
species called 'GAS'. The properties of the block of foam were chosen
...
box\_burn\_away\_devc.csv and box\_burn\_away2\_devc.csv), as well as
...
\includegraphics[width=3.2in]{FIGURES/box_burn_away} &
\includegraphics[width=3.2in]{FIGURES/box_burn_away2}
\end{tabular*}
\caption[Output of {\bf box\_burn\_away} and {\br box\_burn\_away2}
test cases.]{Output of {\bf box\_burn\_away} test cases.}
\label{box_burn_away}
\end{figure}
...
values of {\ct 'AIR'} are assumed.  If the species listed in Table~\ref{tab:gasspecies}, is indicated as a liquid, that means that liquid thermophysical properties do not need to be given for those species.
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{FIGURES/flow_rate_open_nozzles} &
\includegraphics[width=3.2in]{FIGURES/flow_rate_water_mass}
\end{tabular*}
...
\includegraphics[width=2.05in]{FIGURES/activate_vents_5} &
\includegraphics[width=2.05in]{FIGURES/activate_vents_10} &
\includegraphics[width=2.05in]{FIGURES/activate_vents_15}
\end{tabular*}
...
{\ct H\_V\_REFERENCE\_TEMPERATURE}  & Real            & Temperature for Heat of Vaporization    & $^\circ$C &               \\ \hline
...
{\ct EXTERNAL\_FLUX\_RAMP}            & Character       & Ramp ID for external flux         &                     &                         \\ \hline
...
{\ct TAU\_EXTERNAL\_FLUX}             & Real            & Ramp time for external flux       & s                   & 1.                      \\ \hline
