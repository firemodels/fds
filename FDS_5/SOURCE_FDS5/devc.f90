...
LOGICAL :: GAS_CELL_RAD_FLUX=.FALSE.,PDPA_COUNTED(10)=.FALSE.
...
TYPE DEVICE_TYPE
   ...
   INTEGER  :: PDPA_M=3,PDPA_N=2,PDPA_GROUP=1
   ...
   INTEGER  :: OUTPUT_INDEX,IOR,IW,COUNT,ORDINAL,I,J,K,MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,I_DEPTH,N_PATH,N_T_E,PROP_INDEX,&
               TRIP_DIRECTION,CTRL_INDEX,N_INPUTS,VIRTUAL_WALL_INDEX=0,SURF_INDEX=-1
   INTEGER, POINTER, DIMENSION(:) :: DEVC_INDEX
   INTEGER, POINTER, DIMENSION(:) :: I_PATH,J_PATH,K_PATH
   REAL(EB),  POINTER, DIMENSION(:) :: Y_E,T_E
   CHARACTER(30) :: ID,PROP_ID,QUANTITY,CTRL_ID,DEVC_ID,STATISTICS='null',SURF_ID,PART_ID='null'
