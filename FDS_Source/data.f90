...
OUTPUT_QUANTITY(-17)%NAME = 'MASS FLOW WALL'
OUTPUT_QUANTITY(-17)%UNITS= 'kg/s'
OUTPUT_QUANTITY(-17)%SHORT_NAME = 'mflow_wall'
OUTPUT_QUANTITY(-17)%INTEGRATED = .TRUE.

OUTPUT_QUANTITY(-18)%NAME = 'HEAT FLOW WALL'
OUTPUT_QUANTITY(-18)%UNITS= 'kW'
OUTPUT_QUANTITY(-18)%SHORT_NAME = 'hflow_wall'
