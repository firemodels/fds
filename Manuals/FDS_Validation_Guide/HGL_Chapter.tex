...
Eight experiments from the JH/FRA test series are selected for comparison. The HGL temperature and height are calculated using the standard method. The thermocouple arrays located in the northeast and southeast corners are averaged (with an equal weighting for each) for all tests.
...
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_1_1} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_1_2} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_1_3} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_2_1} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_2_2} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_2_3} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_I_1} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/HGL_Temperature_I_2} 
\end{tabular*}
\caption[TUS Facade Experiments, HGL Temperature]
{TUS Facade Experiments, HGL Temperature. Each row consists of a single continuous experiment.}
