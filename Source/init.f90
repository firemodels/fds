...
REAL(EB) :: PX,PY,PZ,T_ACTIVATE,XIN,YIN,ZIN,DIST,XW,YW,ZW,RDN,AW,TSI,&
            ZZ_GET(1:N_TRACKED_SPECIES),RSUM_F,R1,RR,DELTA,XI,YJ,ZK
...
SELECT CASE(BC%IOR)
   CASE(-1) ; CALL GET_IJK(BC%X-SF%BOUNDARY_LAYER_THICKNESS,BC%Y,BC%Z,NM,XI,YJ,ZK,BC%IIS,BC%JJS,BC%KKS)
   CASE( 1) ; CALL GET_IJK(BC%X+SF%BOUNDARY_LAYER_THICKNESS,BC%Y,BC%Z,NM,XI,YJ,ZK,BC%IIS,BC%JJS,BC%KKS)
   CASE(-2) ; CALL GET_IJK(BC%X,BC%Y-SF%BOUNDARY_LAYER_THICKNESS,BC%Z,NM,XI,YJ,ZK,BC%IIS,BC%JJS,BC%KKS)
   CASE( 2) ; CALL GET_IJK(BC%X,BC%Y+SF%BOUNDARY_LAYER_THICKNESS,BC%Z,NM,XI,YJ,ZK,BC%IIS,BC%JJS,BC%KKS)
   CASE(-3) ; CALL GET_IJK(BC%X,BC%Y,BC%Z-SF%BOUNDARY_LAYER_THICKNESS,NM,XI,YJ,ZK,BC%IIS,BC%JJS,BC%KKS)
   CASE( 3) ; CALL GET_IJK(BC%X,BC%Y,BC%Z+SF%BOUNDARY_LAYER_THICKNESS,NM,XI,YJ,ZK,BC%IIS,BC%JJS,BC%KKS)
END SELECT
