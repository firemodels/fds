!     Last change:  JEF   1 Dec 2008    2:37 am
MODULE RADCALV
...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: SPECIE,QW,TTAU,XT,AB,PKPA,AMBDA,ATOT,BCNT,P,UUU,GC,X
...
!     IN NASA SP-3080._EB)
      ...
      ELSE
         ...
         SELECT CASE (I)
            ...
            CASE (3)
              CALL FUEL(OMEGA,TEMP,P(3),PTOT,GC(3),SDWEAK,GDINV,GDDINV)
            CASE (4)
...
REAL(EB) OMEGA,TEMP,GC1,SDWEAK,GDINV,GDDINV,AA,BB,CC,QQ,EE,FF,GG, &
         ...
         DINV,A,B,D,G,W1,DINV1,DINV2,DINV3,Q2OT,TOAZ,T0OT,Q2OT0
...
INTEGER :: ANGLE_INCREMENT,TIME_STEP_INCREMENT,NMIEANG
