...
USE GLOBAL_CONSTANTS, ONLY: LU_ERR,FN_OUTPUT,LU_OUTPUT,CHID,MYID
CHARACTER(*) MESSAGE
LOGICAL :: EX
...
USE GLOBAL_CONSTANTS, ONLY: SIGMA,TMPA4,TMPA,RPI,N_TRACKED_SPECIES,T_BEGIN,DIRICHLET,INITIALIZATION_PHASE,PERIODIC_TEST
...
ITMP = MIN(5000,NINT(TMPG))
G_F_OUT = 1.E-6_EB*DOT_PRODUCT(G_F_Z(ITMP,:),-NU_IN)
