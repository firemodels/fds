...
CALL FDS2LS_DYNA (CHID,NOMASTER,C_SIZE,TBEG,TEND,TINT,NUMEL,VARIABLE,N,N_AVERAGE,BOUNDARY)
!*******************
!!WORKING??
!*********** APPLYING TABLES AS NODAL LOADS **********
...
LOOP_CONV:DO I=1,NUMEL*2
    ...
    WRITE(70,'(I8, A, I8, A, I8)') INT(BOUNDARY(I,3)), ",1.0 , ", INT(BOUNDARY(I,2)), ", 1.0, ", INT(BOUNDARY(I,4))
ENDDO LOOP_CONV
!*******************************
!!WORKING??
EM=0.8
...
LOOP_RAD:DO I=1,NUMEL*2
    ...
    WRITE(70,'(A, E12.5, A, I8, A, I8)') "0, ", EM*5.67E-8, ", ", INT(BOUNDARY(I,1)), ", 1.0, ", INT(BOUNDARY(I,4))
ENDDO LOOP_RAD
!*******************************
!!WORKING??
!*******************************
