...
!$OMP DO PRIVATE(IW,II,JJ,KK,IIG,JJG,KKG,ITMP,MU_WALL,YPLUS) FIRSTPRIVATE(DAMPING_FACTOR)
...
USE TURBULENCE, ONLY: TURBULENT_KINETIC_ENERGY,SUBGRID_SCALAR_VARIANCE,WAVELET_ERROR_ESTIMATOR,COMPRESSION_WAVE
