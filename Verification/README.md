...
7. Run the Python script in `Utilities/Python` called `FDS_verification_script.py`. Make sure you have initialized the fds python environment, see the [Python wiki](https://github.com/firemodels/fds/wiki/Python-Setting-Up-Your-Environment).
