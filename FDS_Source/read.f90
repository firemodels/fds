...
CHARACTER(30) :: ASSUMED_GAS_TEMPERATURE_RAMP,RAMP_GX,RAMP_GY,RAMP_GZ,TURBULENCE_MODEL
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,ASSUMED_GAS_TEMPERATURE_RAMP,&
                BAROCLINIC,BNDF_DEFAULT,CDF_CUTOFF,CFL_MAX,CFL_MIN,CFL_VELOCITY_NORM,CHECK_HT,CHECK_VN,CLIP_MASS_FRACTION,&
                COMPUTE_VISCOSITY_TWICE,CONSTANT_SPECIFIC_HEAT,C_DEARDORFF,C_SMAGORINSKY,C_VREMAN,DNS,&
