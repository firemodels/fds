...
DO NM=1,NMESHES
   IF (MYID==EVAC_PROCESS .AND. .NOT.EVACUATION_ONLY(NM)) THEN
      ...
      IF (N_SPECIES>0) THEN
         ...
         M%YY=0._EB
      ENDIF
      ALLOCATE(M%Y_SUM(0:M%IBP1,0:M%JBP1,0:M%KBP1),STAT=IZERO)
      CALL ChkMemErr('MAIN','Evac Y_SUM',IZERO)
      M%Y_SUM = 0._EB
