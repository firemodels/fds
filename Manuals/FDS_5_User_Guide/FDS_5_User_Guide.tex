...
{\ct MIX\_TIME\_FACTOR} on the {\ct REAC} line. If you do not want to use this model, set {\ct EDDY\_BREAKUP=.FALSE.} on the {\ct REAC} line, in which
...
{\ct EDDY\_BREAKUP}                       & Logical     & See Section~\ref{info:turbulent_combustion}   &                   & {\ct .TRUE.}    \\ \hline
...
{\ct MIX\_TIME\_FACTOR}                   & Real        & See Section~\ref{info:turbulent_combustion}   &                   & 0.1    \\ \hline
