...
DATA_FILE_LOOP: DO DATA_FILE_FLAG=1,4

   IF (.NOT.HAVE_SOOT.AND.DATA_FILE_FLAG==1) CYCLE
   IF (.NOT.HAVE_TEMP.AND.DATA_FILE_FLAG==3) CYCLE
   IF (.NOT.HAVE_CO2.AND.DATA_FILE_FLAG==4) CYCLE
   ...
   CALL SMOKE3D_TO_FILE(LU_SMOKE3D(DATA_FILE_FLAG,NM),LU_SMOKE3D(DATA_FILE_FLAG+4,NM),&
