...
REAL(EB) :: CORIOLIS_VECTOR(3)=0._EB,FORCE_VECTOR(3)=0._EB,OBUKHOV_LENGTH,L,ZZZ,ZETA,Z_0,AERODYNAMIC_ROUGHNESS,SPEED,DIRECTION,&
            ...
            LCC,DT_THETA,TAU_THETA,SIGMA_THETA,SPEED_0
INTEGER :: NM,N
...
NAMELIST /WIND/ CORIOLIS_VECTOR,DIRECTION,DT_MEAN_FORCING,DT_MEAN_FORCING_2,FORCE_VECTOR,FYI,GEOSTROPHIC_WIND,GROUND_LEVEL,L,&
                ...
                SPEED,SPEED_0,SPONGE_CELLS,STRATIFICATION,TAU_THETA,THETA_STAR,TMP_REF,U_STAR,U0,USE_ATMOSPHERIC_INTERPOLATION,&
                V0,W0,Z_0,Z_REF,&
...
IF (SPEED>0._EB) MEAN_FORCING(1:2) = .TRUE.

IF (SPEED_0>0._EB) THEN
   MEAN_FORCING(1:2) = .FALSE.
   SPEED = SPEED_0
ENDIF
