...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=29,N_PARTICLE_SCALAR_INTEGERS=12,N_PARTICLE_SCALAR_LOGICALS=4

TYPE LAGRANGIAN_PARTICLE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   LOGICAL, POINTER :: ALREADY_ALLOCATED,SHOW,SPLAT,IGNITOR
