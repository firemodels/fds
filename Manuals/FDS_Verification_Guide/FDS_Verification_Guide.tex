...
The calculations described in this section check the conservation of mass produced by the aerosol deposition algorithms. The example involves a reaction that invokes an aerosol deposition model in FDS (e.g., soot deposition). For this example propane will be the fuel with a 5 \% soot yield. A {\ct RAMP} is used to specify a burning rate from a propane burner that ramps up linearly to 2.236 g/s from 0 s to 1 s, remains steady at 2.236 g/s from 1s to 4 s, then linearly decreases to 0 g/s from 4 s to 5 s. The total fuel mass released is 8.944 g of propane. Therefore, the expected soot mass should be equal to 0.447 g, or 5 \% of the total amount of fuel. For a case with no aerosol deposition, we would expect the gas phase soot mass to be equal to 0.447 g. For a case with aerosol deposition, we would expect a fraction of the soot to exist in the gas phase and the remainder in the condensed phase (deposited to the wall). The sum of the soot mass in the gas phase and the condensed phase should be equal to 0.447 g.

Figure~\ref{fig:deposition_mass_components} shows the time evolution of soot mass in the gas phase and condensed phase (wall) for five cases. The five cases are (1) all aerosol deposition mechanisms active, (2) no aerosol deposition mechanisms active, (3) gravitational deposition only, (4) thermophoretic deposition only, and (5) turbulent deposition only. Figure~\ref{fig:deposition_mass_total} shows the sum of the gas phase soot mass and condensed phase soot mass.
...
\end{tabular*}
\caption[Soot mass from Propane\_flame\_deposition case]{Time evolution of soot mass components for deposition cases. (Left) Soot mass in gas phase. (Right) Soot mass deposited on condensed phase walls.}
\label{fig:deposition_mass_components}
\end{figure}

\begin{figure}[ht]
\begin{center}
\includegraphics[width=5.0in]{SCRIPT_FIGURES/Propane_flame_deposition_total}
\end{center}
\caption[Soot mass from Propane\_flame\_deposition case]{Time evolution of total soot mass for deposition cases.}
\label{fig:deposition_mass_total}
\end{figure}
