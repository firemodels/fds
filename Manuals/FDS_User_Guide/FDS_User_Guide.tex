...
{\ct C\_SMAGORINSKY}                            & Real          & Section~\ref{info:LES}                                
&               & 0.20              \\ \hline
...
{\ct SOLID\_PHASE\_ONLY}                        & Logical       & Section~\ref{solid_phase_verification}                &               & {\ct .FALSE.}     \\ \hline{\ct STRATIFICATION}                            & Logical       & Section~\ref{info:stratification}                     &               & {\ct .TRUE.}      \\ \hline
...
%Undocumented: GRAV_VISC, HRRPUVCUT_MAX, HRRPUV_MAX_SMV, NEW_EVAP RUN_AVG_FAC, TENSOR_DIFFUSIVIRY,  TERRAIN_IMAGE, THERMOPHORETIC_DEPOSITION, TURBULENT_DEPOSITION, VEG_LEVEL_SET,  , WFDS
...
% CONSTANT_TEMPERATURE, DENSE_VOLUME_FRACTION, ORIENTATION, TREE, TURBULENT_DEPOSITION, 
...
% Undocumented: PRESSIT_ACCELERATOR, PRESSIT_SCALE_FACTOR
...
% Not listed: CO_PRODUCTION, EDCM, FIXED_MIX_TIME, FWD_ID, ODE_SOLVER, REVERSIBLE, SOOT_DEPOSITION, TAU_CHEM, TAU_FLAME, TOL_INT
