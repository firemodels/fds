...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.5in]{FIGURES/Beyler_Hood/Beyler_UHC} &
\includegraphics[height=2.5in]{FIGURES/Beyler_Hood/Beyler_O2} \\
\includegraphics[height=2.5in]{FIGURES/Beyler_Hood/Beyler_CO} &
\includegraphics[height=2.5in]{FIGURES/Beyler_Hood/Beyler_CO2} \\
\end{tabular*}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=5.0in]{FIGURES/RSE_Pitts/RSE_Pitts_CO} \\
\includegraphics[width=5.0in]{FIGURES/RSE_Pitts/RSE_Pitts_CO2}
\end{tabular}
\end{center}
...
in the INERIS test enclosure. The calculations were performed with FDS 5.1.3}
...
For Test A, the release chamber was located in the center of the compartement, the leak consisted of a single hole in 
...
fron wall and the release time was 4 hours (instead of 1 hour as for Test A).


\begin{figure}[h!]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/NIST_He_2009/NIST_He_TestA} &
\includegraphics[height=2.2in]{FIGURES/NIST_He_2009/NIST_He_TestB} \\
\includegraphics[height=2.2in]{FIGURES/NIST_He_2009/NIST_He_TestC} &
\includegraphics[height=2.2in]{FIGURES/NIST_He_2009/NIST_He_TestD} 
\end{tabular*}
\caption[Summary of helium concentration predictions, NIST Reduced Scale Experiments]{Comparisons of predicted and measured helium concentrations at various locations
in the NIST helium release and dispersion experiments performed in a reduced scale garage.}
