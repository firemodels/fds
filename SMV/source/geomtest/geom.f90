...
REAL(EB) :: TEXTURE_HEIGHT, TEXTURE_WIDTH
...
NAMELIST /GEOM/ AZIM, AZIM_DOT, COMPONENT_ONLY, DAZIM, DELEV, DSCALE, DXYZ0, DXYZ, &
                ELEV, ELEV_DOT, FACES, GAXIS, GEOM_TYPE, GROTATE, GROTATE_DOT,GEOM_IDS, ID, SCALE, &
                SCALE_DOT, SURF_ID, TEXTURE_HEIGHT, TEXTURE_MAP, TEXTURE_WIDTH,&
