...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                GRAVITATIONAL_DEPOSITION_CEILING,GROUND_LEVEL,GVEC,HRRPUV_MAX_SMV,HUMIDITY,&
                ...
                STRATIFICATION,TEMPERATURE_DEPENDENT_REACTION,TENSOR_DIFFUSIVITY,TERRAIN_CASE,TERRAIN_IMAGE,&
                TEXTURE_ORIGIN,&
                THERMOPHORETIC_DEPOSITION,THICKEN_OBSTRUCTIONS,TMPA,TURBULENCE_MODEL,TURBULENT_DEPOSITION,U0,UVW_FILE,V0,&
                VEG_LEVEL_SET,VISIBILITY_FACTOR,VN_MAX,VN_MIN,Y_CO2_INFTY,Y_O2_INFTY,W0,WIND_ONLY,&
...
LOGICAL  :: ABSORBING,LUMPED_COMPONENT_ONLY,PREDEFINED(MAX_SPECIES),PREDEFINED_SMIX(0:MAX_SPECIES),AEROSOL,BACKGROUND,&
            DEFINED_BACKGROUND
CHARACTER(30) :: PREDEFINED_SPEC_ID(MAX_SPECIES),RAMP_CP,RAMP_CP_L,RAMP_K,RAMP_MU,RAMP_D,RADCAL_ID,SPEC_ID_READ(MAX_SPECIES),&
                 SPEC_ID(MAX_SPECIES)
CHARACTER(100) :: FORMULA
TYPE(SPECIES_TYPE), POINTER :: SS=>NULL()
TYPE(SPECIES_MIXTURE_TYPE), POINTER :: SM=>NULL()
NAMELIST /SPEC/ ABSORBING,AEROSOL,BACKGROUND,CONDUCTIVITY,CONDUCTIVITY_SOLID, &
                ...
                MASS_EXTINCTION_COEFFICIENT,MASS_FRACTION,MASS_FRACTION_0,MEAN_DIAMETER,MELTING_TEMPERATURE,MW,RADCAL_ID,RAMP_CP,&
                RAMP_CP_L,RAMP_D,RAMP_K,RAMP_MU,REFERENCE_ENTHALPY,REFERENCE_TEMPERATURE,SIGMALJ,SPEC_ID,SPECIFIC_HEAT,&
                SPECIFIC_HEAT_LIQUID,VAPORIZATION_TEMPERATURE,VISCOSITY,VOLUME_FRACTION
...
PRIMITIVE_SPEC_READ_LOOP: DO WHILE (N_SPEC_READ < N_SPEC_READ_2 .OR. N < N_SPECIES)
   ...
   IF (SPEC_ID(1)/='null') CYCLE PRIMITIVE_SPEC_READ_LOOP
   ...
   CALL GAS_PROPS(SS%ID,SS%SIG,SS%EPSK,SS%MW,SS%ABSORBING,SS%FORMULA,SS%LISTED,SS%ATOMS,SS%H_F,SS%RADCAL_ID)  
   ...
   SELECT CASE (ID)
      CASE('WATER VAPOR')
         ...
         ENDIF
         IF (PREDEFINED_SMIX(0)) Y_H2O_INFTY = WATER_VAPOR_MASS_FRACTION(HUMIDITY,TMPA)
      CASE('CARBON DIOXIDE')
         CO2_INDEX = N
...
REAL(EB) :: SOOT_YIELD,CO_YIELD,EPUMO2,A, &
            ...
            AUTO_IGNITION_TEMPERATURE,SOOT_H_FRACTION,N_T
...
NAMELIST /REAC/ A,A_RAMP,AUTO_IGNITION_TEMPERATURE,BETA_EDC,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                REAC_MASS_ERROR,REVERSIBLE,SOOT_H_FRACTION,SOOT_YIELD,SPEC_ID_N_S,SPEC_ID_NU,SUPPRESSION,TAU_CHEM,TAU_FLAME,&
                Y_P_MIN_EDC
...
NAMELIST /DEVC/ BYPASS_FLOWRATE,CONVERSION_FACTOR,CTRL_ID,DELAY,DEPTH,DEVC_ID,DRY,DUCT_ID,EVACUATION,FLOWRATE,FYI,&
                ...
                RELATIVE,ROTATION,SETPOINT,SMOOTHING_FACTOR,SPEC_ID,STATISTICS,SURF_ID,TIME_AVERAGED,TRIP_DIRECTION,&
                UNITS,VELO_INDEX,XB,XYZ,X_ID,Y_ID,Z_ID
