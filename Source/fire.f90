...
CO_EXTINCT_LOOP: DO CO_PASS = 1,N_CO_PASS
   ...
   INTEGRATION_LOOP: DO TIME_ITER = 1,MAX_CHEMISTRY_ITERATIONS
      ...
      IF (SUPPRESSION) CALL CHECK_AUTO_IGNITION(EXTINCT,ZZ_MIXED,TMP_MIXED,AIT_LOC,CO_PASS)
      ...
      INTEGRATOR_SELECT: SELECT CASE (COMBUSTION_ODE_SOLVER)
         ...
         CASE (EXPLICIT_EULER) ! Simple chemistry
            ...
            CALL FIRE_FORWARD_EULER(ZZ_MIXED_NEW,ZZ_MIXED,ZZ_UNMIXED,ZETA,ZETA_0,DT_SUB,TMP_MIXED,TMP_UNMIXED,RHO_HAT,&
                                    CELL_MASS,TAU_MIX,PBAR_0,DELTA,VEL_RMS,Q_REAC_SUB,TIME_ITER,TOTAL_MIXED_MASS)
            ZETA_0 = ZETA
   ...
   IF (SUPPRESSION) THEN
      SELECT CASE(EXTINCT_MOD)
         CASE(EXTINCTION_1); CALL EXTINCT_1(EXTINCT,ZZ_0,ZZ_MIXED,TMP_IN)
...
SUBROUTINE CHECK_AUTO_IGNITION(EXTINCT,ZZ_MIXED_IN,TMP_MIXED,AIT_IN,CO_PASS)
...
SUBROUTINE EXTINCT_1(EXTINCT,ZZ_0_IN,ZZ_IN,TMP_IN)
...
SUBROUTINE FIRE_FORWARD_EULER(ZZ_OUT,ZZ_IN,ZZ_UNMIXED,ZETA_OUT,ZETA_IN,DT_LOC,TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,&
                              PBAR_0,DELTA,VEL_RMS,Q_REAC_LOC,SUB_IT,TOTAL_MIXED_MASS)
USE COMP_FUNCTIONS, ONLY:SHUTDOWN
...
IF (ANY(REACTION(:)%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,INFINITELY_FAST,PBAR_0,DELTA,VEL_RMS,Q_REAC_OUT,SUB_IT)
   ZZ_NEW = ZZ_0 + DZZ
   ZZ_0 = ZZ_NEW
   Q_REAC_LOC = Q_REAC_LOC + Q_REAC_OUT*TOTAL_MIXED_MASS
ENDIF
IF (.NOT.ALL(REACTION(:)%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,FINITE_RATE,PBAR_0,DELTA,VEL_RMS,Q_REAC_OUT,SUB_IT)
   ZZ_NEW = ZZ_0 + DZZ
   Q_REAC_LOC = Q_REAC_LOC + Q_REAC_OUT*TOTAL_MIXED_MASS
ENDIF
...
SUBROUTINE FIRE_RK2(ZZ_OUT,ZZ_IN,ZZ_UNMIXED,ZETA_OUT,ZETA_IN,DT_SUB,N_INC,TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,&
                    PBAR_0,DELTA,VEL_RMS,Q_REAC_OUT,SUB_IT,TOTAL_MIXED_MASS_OUT)
...
INC_LOOP: DO N=1,N_INC
   ...
   CALL FIRE_FORWARD_EULER(ZZ_3,ZZ_2,ZZ_UNMIXED,ZETA_3,ZETA_2, DT_LOC, TMP_MIXED,TMP_UNMIXED,RHO_HAT,CELL_MASS,TAU_MIX,&
                           PBAR_0,DELTA,VEL_RMS,Q_REAC_3,SUB_IT,TOTAL_MIXED_MASS_3)
...
SUBROUTINE REACTION_RATE(DZZ,ZZ_0,DT_SUB,RHO_0,TMP_0,KINETICS,PBAR_0,DELTA,VEL_RMS,Q_REAC_OUT,SUB_IT)
USE COMP_FUNCTIONS, ONLY: SHUTDOWN
