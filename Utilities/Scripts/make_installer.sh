...
cat << EOF >> $INSTALLER
echo ""
echo "*** Add the following line to one of your startup files"
echo "    to complete the installation"
echo ""
echo "source \$FDS_root/bin/FDSVARS.sh"
echo ""
echo "*** See the readme file at \$FDS_root/bin/README.html for"
echo "    notes setting up your environment if you also have a "
echo "    fds git repo."
echo ""
