...
REAL(EB) :: DT_BC,T,DTMP,CP,ZZ_GET(0:N_TRACKED_SPECIES)
   ...
   CUTTCELL_LOOP: DO
      ...
      GEOM_METHOD_OF_HEAT_TRANSFER: SELECT CASE(SF%THERMAL_BC_INDEX)
         ...
         CASE(CONVECTIVE_FLUX_BC)
            ...
            D_GEOMETRY(I,J,K) = D_GEOMETRY(I,J,K) + CL%AREA*SF%CONVECTIVE_HEAT_FLUX/CELL_VOLUME/(RHOP(I,J,K)*CP*TMP(I,J,K))
