...
DO N = 1, NMESHES
   ...
   WRITE(LU_SMV,'(I5)') 0
   DO I=0,M%IBAR
      WRITE(LU_SMV,'(I5,F14.5)') I,(REAL(M%IBAR-I,EB)*M%XB(1)+REAL(I,EB)*M%XB(2))/REAL(M%IBAR,EB)
   ENDDO
   
   WRITE(LU_SMV,'(/A)') 'TRNY'
   WRITE(LU_SMV,'(I5)') 0
   DO I=0,M%JBAR
      WRITE(LU_SMV,'(I5,F14.5)') I,(REAL(M%JBAR-I,EB)*M%XB(3)+REAL(I,EB)*M%XB(4))/REAL(M%JBAR,EB)
   ENDDO

   WRITE(LU_SMV,'(/A)') 'TRNZ'
   WRITE(LU_SMV,'(I5)') 0
   DO I=0,M%KBAR
      WRITE(LU_SMV,'(I5,F14.5)') I,(REAL(M%KBAR-I,EB)*M%XB(5)+REAL(I,EB)*M%XB(6))/REAL(M%KBAR,EB)
   ENDDO
