...
CALL TEST_FILTER(BETAHAT11,BETA11)
CALL TEST_FILTER(BETAHAT22,BETA22)
CALL TEST_FILTER(BETAHAT33,BETA33)
CALL TEST_FILTER(BETAHAT12,BETA12)
CALL TEST_FILTER(BETAHAT13,BETA13)
CALL TEST_FILTER(BETAHAT23,BETA23)
...
CALL TEST_FILTER(MLHAT,ML)
CALL TEST_FILTER(MMHAT,MM)
...
CALL TEST_FILTER(RUU_HAT,RUU)
CALL TEST_FILTER(RVV_HAT,RVV)
CALL TEST_FILTER(RWW_HAT,RWW)
CALL TEST_FILTER(RUV_HAT,RUV)
CALL TEST_FILTER(RUW_HAT,RUW)
CALL TEST_FILTER(RVW_HAT,RVW)
...
CALL TEST_FILTER(RU_HAT,RU)
CALL TEST_FILTER(RV_HAT,RV)
CALL TEST_FILTER(RW_HAT,RW)
