...
REAL(EB), PARAMETER :: Q2      = 1.4388_EB  ! Q2 = SPEED_OF_LIGHT*PLANCK_CNS/BOLTZMANN
REAL(EB), PARAMETER :: WM_C2H6 = 28.0532_EB ! NIST WEBBOOK DATA
INTEGER :: I_BAND, I
...
! COMPUTE AVERAGE LINE SPACING
! ETHANE Belongs to point group D2h with Rotational Constant A = 4.828 cm-1
! B = 1.0012 cm-1, and C = 0.8282 cm-1. We make the assumption B ~ C
DINV_C2H6=1._EB/(2.0_EB*1.0012_EB)
