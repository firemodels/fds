...
USE CC_SCALARS_IBM, ONLY : CCIBM_VELOCITY_FLUX,ROTATED_CUBE_VELOCITY_FLUX,CCIBM_INTERP_FACE_VEL
INTEGER, INTENT(IN) :: NM
...
ELSE FREEZE_VELOCITY_IF
   ...
   IF (CC_IBM) CALL CCIBM_RESCALE_VELOCITY(NM,DT,STORE_FLG=.FALSE.)
   SELECT CASE(PRES_FLAG)
...
ELSE FREEZE_VELOCITY_IF
   ...
   IF (CC_IBM) CALL CCIBM_RESCALE_VELOCITY(NM,DT,.TRUE.)
   SELECT CASE(PRES_FLAG)
   ...
   IF (CC_IBM) CALL CCIBM_RESCALE_VELOCITY(NM,DT,.FALSE.)
   SELECT CASE(PRES_FLAG)
      CASE(GLMAT_FLAG,UGLMAT_FLAG,ULMAT_FLAG,USCARC_FLAG)
