...
Bulk Mass per Unit Area         & kg/m$^3$      & 0.313         & 0.283         \\ \hline
...
\begin{table}
\begin{center}
\caption[Assumed properties for various dried grasses]{Assumed properties for various types of dried grass. Note that the Pyrolysis Temperature is taken to be the temperature at which the mass loss rate peaks in the TGA experiments of Morvan and Dupuy~\cite{Morvan:CF2004}.}
...
Pyrolyis Temperature            & $^\circ$C             & 250                       & \cite{Morvan:CF2004}                  \\ \hline
\end{tabular}
\end{center}
\end{table}
