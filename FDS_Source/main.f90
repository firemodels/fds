...
INTEGER, ALLOCATABLE, DIMENSION(:) :: REQ,REQ1,REQ3,REQ4,REQ5,REQ6,COUNTS,DISPLS,COUNTS2D,DISPLS2D,COUNTS_TIMERS,DISPLS_TIMERS, &
...
INTEGER :: N_REQ,N_REQ1,N_REQ3,N_REQ4,N_REQ5,N_REQ6,N_COMMUNICATIONS,INTEGER_SEND_BUFFER(7),INTEGER_RECV_BUFFER(7)
...
OTHER_MESH_LOOP: DO NOM=1,NMESHES
   ...
   ! CELL_INDEX, SOLID, WALL_INDEX

   IF (CODE==0) THEN
      ALLOCATE(M4%CELL_INDEX(0:M4%IBP1,0:M4%JBP1,0:M4%KBP1))
      ALLOCATE(M4%SOLID(0:CELL_COUNT(NOM)))
      ALLOCATE(M4%WALL_INDEX(0:CELL_COUNT(NOM),-3:3))
...
SENDING_MESH_LOOP: DO NM=1,NMESHES
   ...
   RECEIVING_MESH_LOOP: DO NOM=1,NMESHES
      ...
      ! Exchange CELL_INDEX, SOLID, and WALL_INDEX
