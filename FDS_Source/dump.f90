...
WRITE(S0,'(I3)') 0;    S0 = ADJUSTL(S0)
WRITE(S1,'(I3)') IBAR; S1 = ADJUSTL(S1)
WRITE(S2,'(I3)') JBAR; S2 = ADJUSTL(S2)
WRITE(S3,'(I3)') KBAR; S3 = ADJUSTL(S3)
WRITE(LU_UVW,'(A)') TRIM(S0)//','//TRIM(S1)//','//TRIM(S0)//','//TRIM(S2)//','//TRIM(S0)//','//TRIM(S3)
DO K=0,KBAR
   DO J=0,JBAR
      DO I=0,IBAR
