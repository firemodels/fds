...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ZETA_SOURCE_TERM,EXTINCTION_MODEL,HRRPUV_MAX_SMV,INITIAL_UNMIXED_FRACTION,&
                MAX_CHEMISTRY_SUBSTEPS,N_FIXED_CHEMISTRY_SUBSTEPS,RICHARDSON_ERROR_TOLERANCE,SUPPRESSION,&
                TEMPERATURE_DEPENDENT_REACTION,TRANSPORT_UNMIXED_FRACTION,TRANSPORT_ZETA_SCHEME,WD_PROPS
