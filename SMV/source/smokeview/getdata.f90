...
VOLUME = REAL(GET_TETRABOX_VOLUME(BOX_BOUNDS_EB,V0_EB,V1_EB,V2_EB,V3_EB,AREAS),FB)
...
DO K = 0, KBOX_MAX
   ...
   DO J = 0, JBOX_MAX
      ...
      DO I = 0, IBOX_MAX
         ...
         VOL_BOX = VOL_BOX + GET_TETRABOX_VOLUME(BOX_BOUNDS_IJK_EB,V0_EB,V1_EB,V2_EB,V3_EB,AREAS)
      END DO
   END DO
END DO
