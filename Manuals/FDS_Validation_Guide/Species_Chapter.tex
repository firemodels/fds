...
Mean and rms soot volume fraction measurements were made above a 15.2~cm diameter, 15 kW ethylene burner. The radial profiles are located at heights of 1.0, 1.5, 2.0, 2.5, 3.0, and 3.5 burner diameters, $D$. Figure~\ref{FM_Burner_Soot_PDF} displays the probability distributions (PDFs) at the six heights and radii of 0~cm, 2~cm, 4~cm, 6~cm, and 8~cm.

\begin{figure}[!h]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_Mean_Soot_1p0D} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_RMS_Soot_1p0D} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_Mean_Soot_1p5D} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_RMS_Soot_1p5D} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_Mean_Soot_2p0D} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_RMS_Soot_2p0D}
\end{tabular*}
\caption[FM Burner experiments, plume mean and rms soot volume fraction]
{FM Burner experiments, plume mean and rms soot volume fraction at heights of 1.0, 1.5, and 2.0 burner diameters, D.}
\label{FM_Burner_Soot_1}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_Mean_Soot_2p5D} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_RMS_Soot_2p5D} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_Mean_Soot_3p0D} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_RMS_Soot_3p0D} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_Mean_Soot_3p5D} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/FM_Burner/Radial_RMS_Soot_3p0D}
\end{tabular*}
\caption[FM Burner experiments, plume mean and rms soot voiume fraction]
{FM Burner experiments, plume mean and rms soot volume fraction at heights of 2.5, 3.0, and 2.5 burner diameters, D.}
\label{FM_Burner_Soot_2}
\end{figure}

\begin{sidewaysfigure}[p]
\begin{tabular*}{\textwidth}{ccccc}
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p0D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p0D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p0D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p0D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p0D_r=7cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p5D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p0D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p0D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p0D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p0D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p0D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_2p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_1p5D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p0D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p0D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p0D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p0D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p0D_r=8cm} \\
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p5D_r=0cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p5D_r=2cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p5D_r=4cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p5D_r=6cm} &
\includegraphics[width=1.5in]{SCRIPT_FIGURES/FM_Burner/Soot_PDF_3p5D_r=8cm} \\
\end{tabular*}
...
The mean centerline temperature profiles are found in Section~\ref{NIST_Pool_Fires_Plume_Temps}. The species concentrations are found in Figs.~\ref{NIST_Pool_Fires_Acetone} through~\ref{NIST_Pool_Fires_Methane} on the following pages.
