...
\Huge \flushright{Fire Dynamics Simulator (Version 5) \\ Technical Reference Guide \\ (Draft: August 27, 2007)}
...
\be  \hbox{Fuel} +  \nu_\OTWO \mathrm{O_2}  \rightarrow  \nu_\COTWO \mathrm{CO_2} + \nu_\HTWOO \mathrm{H_2O} + \nu_\CO \mathrm{CO} +
     \nu_\C \mathrm{C}  \label{stoich} \ee
Note that throughout this section, soot is to be regarded as pure carbon, C, for the purpose of developing the combustion model. The
stoichiometric coefficient, $\nu_\C$, represents the number of carbon atoms in the fuel that end up as soot. It is related to the
{\em soot yield}, $y_s$, via the relation:
\be
   \nu_C = \frac{W_\F}{W_\C} \; y_s
\ee
The mixture fraction $Z$ can be defined in terms of the mass fraction of fuel (C$_\xx$H$_\yy$O$_\zz$)
...
oxygen co-exist, a reaction occurs if conditions are favorable in the sense shown in Fig.~\ref{plotsupp}.
...
is also true -- that species are linear combinations of the mixture fraction variables.
The mass fractions of the species in the mixture, $Y_{\alpha}(Z_1,Z_2)$, are found via:
\begin{eqnarray}  Y_\F     &=& Z_1    \\*[.1in]
                  Y_\NTWO  &=& (1 - Z_1 - Z_2) \; Y_\NTWO^\infty   =  (1 - Z) \; Y_\NTWO^\infty    \\*[.1in]
                  Y_\OTWO  &=& (1 - Z_1 - Z_2) \; Y_\OTWO^\infty - W_\OTWO \left[\frac{Y_\COTWO}{W_\COTWO}+\frac{1}{2}
                                \left(\frac{Y_\CO}{W_\CO}+\frac{Y_\HTWOO}{W_\HTWOO} \right) \right]   \\*[.1in]
                           &=& (1 - Z) \; Y_\OTWO^\infty - \frac{W_\OTWO}{W_\F}
                                \left[\nu_\COTWO+\frac{1}{2} \left(\nu_\CO+\nu_\HTWOO \right) \right] \; Z_2   \\*[.1in]
                  Y_\COTWO &=& \frac{\nu_\COTWO W_\COTWO}{W_\F} \; Z_2 \\*[.1in]
                  Y_\HTWOO &=& \frac{\nu_\HTWOO W_\HTWOO}{W_\F} \; Z_2 \\*[.1in]
                  Y_\CO    &=& \frac{\nu_\CO W_\CO}{W_\F} \; Z_2  \\*[.1in]
                  Y_s      &=& \frac{\nu_s W_s}{W_\F} \; Z_2
\end{eqnarray}
...
\hbox{Fuel} +  \nu_\OTWO' \mathrm{O_2}  &\rightarrow&  \nu_\HTWOO \mathrm{H_2O} + (\nu_\CO'+ \nu_\CO) \, \mathrm{CO} +
     \nu_\C \, \mathrm{C}  \\*[.1in]
\mathrm{CO} + \ha \mathrm{O_2} &\rightarrow& \mathrm{CO_2}
\label{3reac} \end{eqnarray}
Note that there are two stoichiometric coefficients for CO -- the first, $\nu_\CO'=\hbox{x}-\nu_\C-\nu_\CO$,
represents CO that is produced in the first
step of the reaction that can potentially be converted to CO$_2$ assuming the conditions are favorable. The second coefficient, $\nu_\CO$,
is the so-called ``well-ventilated,'' or ``post-flame,'' value.


To describe the state of the system, the mixture fraction, $Z$, must be written as the sum of three components:
\begin{eqnarray}  Z_1 &=& Y_\F    \\*[.1in]
                  Z_2 &=& \frac{W_\F}{(\hbox{x}-\nu_\C) \, W_\CO }    \;  Y_\CO \\*[.1in]
                  Z_3 &=& \frac{W_\F}{(\hbox{x}-\nu_\C) \, W_\COTWO } \;  Y_\COTWO  \end{eqnarray}
Here, $\hbox{x}-\nu_\C$ represents the number of carbon atoms in the fuel molecule that are oxidized; that is, the carbon atoms that do
not end up as soot.
...
\begin{eqnarray}  Y_\F     &=& Z_1    \\*[.1in]
                  Y_\NTWO  &=& (1 - Z_1 - Z_2 - Z_3) \; Y_\NTWO^\infty   = (1 - Z) \; Y_\NTWO^\infty    \\*[.1in]
                  Y_\OTWO  &=& (1 - Z) \; Y_\OTWO^\infty - W_\OTWO \left[ \frac{Y_\COTWO}{W_\COTWO}+\frac{1}{2}
                                \left(\frac{Y_\CO}{W_\CO}+\frac{Y_\HTWOO}{W_\HTWOO} \right) \right]   \\*[.1in]
                           &=& (1 - Z) \; Y_\OTWO^\infty - \frac{W_\OTWO}{W_\F} \left[
                               \left( \frac{\nu_\CO'}{2} + \frac{\nu_\HTWOO}{2} \right) \; Z_2 +
                               \left( \nu_\COTWO + \frac{\nu_\CO}{2} + \frac{\nu_\HTWOO}{2} \right) \; Z_3 \right]  \\*[.1in]
                  Y_\COTWO &=& \frac{ \nu_\COTWO W_\COTWO}{W_\F} \; Z_3 \\*[.1in]
                  Y_\HTWOO &=& \frac{\nu_\HTWOO W_\HTWOO}{W_\F} \;  \big(Z_2+Z_3 \big) \\*[.1in]
                  Y_\CO    &=& \frac{W_\CO}{W_\F} \; \big( \nu_\CO'  \; Z_2 + \nu_\CO \; Z_3 \big) \\*[.1in]
                  Y_s      &=& \frac{\nu_\C W_\C}{W_\F} \; \big(Z_2+Z_3\big)
\end{eqnarray}
