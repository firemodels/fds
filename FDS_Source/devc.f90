...
TYPE DEVICE_TYPE
   REAL(EB) :: T,X,Y,Z,X1,X2,Y1,Y2,Z1,Z2,INITIAL_VALUE=-1.E10_EB,INSTANT_VALUE,AVERAGE_VALUE=0._EB,AVERAGE_VALUE2=0._EB,&
               ...
               SETPOINT, T_CHANGE=1.E6_EB,BYPASS_FLOWRATE,DT,TOTAL_FLOWRATE,FLOWRATE,TI_T,TI_VALUE,CONVERSION_FACTOR=1._EB, &
               TIME_INTERVAL,TIME_MIN_VALUE=999._EB,TIME_MAX_VALUE=-999._EB,QUANTITY_RANGE(2)
   ...
   INTEGER  :: OUTPUT_INDEX,OUTPUT2_INDEX,IOR,WALL_INDEX,ORDINAL,I,J,K,MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,&
   ...
   CHARACTER(30) :: ID,PROP_ID,QUANTITY,QUANTITY2,CTRL_ID,DEVC_ID,STATISTICS='null',&
