...
CPU(MY_RANK)%BUFFER_PACKING = CPU(MY_RANK)%BUFFER_PACKING   + CURRENT_TIME() - TNOW
...
CPU(MY_RANK)%BUFFER_UNPACKING = CPU(MY_RANK)%BUFFER_UNPACKING   + CURRENT_TIME() - TNOW
...
WRITE(*,*) 'NM=',MY_RANK+1,' NL=',NL,': THETA=',THETA
...
#ifdef WITH_SCARC_VERBOSE
         ELSE
            WRITE(MSG%LU_VERBOSE,'(I6,A,4I6,6E12.4)') MY_RANK+1,': CONNECTION: NO NEIGHBORS ', &
