...
CUTCELL_DO : DO ICC=1,MESHES(NM)%N_CUTCELL_MESH
   ...
   IF (ONE_UNKH_PER_CUTCELL) THEN
      DO JCC=1,CC%NCELL
         CALL CC_CUTCELL_VELOCITY(NM,PRFCT,ICC,JCC,UVWAV,ATOTV)
   ...
   ELSE
      ...
      DO JCC=1,CC%NCELL
         CALL CC_CUTCELL_VELOCITY(NM,PRFCT,ICC,JCC,UVWAV_AUX,ATOTV_AUX)
         ! Accumulate individual cut-cell averages for this ICC.
         UVWAV = UVWAV + UVWAV_AUX*ATOTV_AUX
...
SUBROUTINE CC_CUTCELL_VELOCITY(NM,PRFCT,ICC,JCC,UVWAV,ATOTV)
