...
if "%platform%" == "linux" (
  ...
  plink %linux_logon% %linux_svn_root%/fds/Utilities/Scripts/BUNDLE_linux64.sh %linux_svn_root% !bundledir! %linux_hostname% %fds_edition%  %fds_version% %smv_version% %mpi_version% %fdssmv_major_version% %compiler_dir% %misc_dir%
...
if "%platform%" == "osx" (
  ...
  plink %osx_logon% %linux_svn_root%/fds/Utilities/Scripts/BUNDLE_osx64.sh %linux_svn_root% !bundledir! %osx_hostname% %fds_edition%  %fds_version% %smv_version% %mpi_version% %fdssmv_major_version% %compiler_dir%
