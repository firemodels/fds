...
\begin{figure}[p]
\begin{center}
\includegraphics[width=5in]{FIGURES/Vettori_Flat_Ceiling/Vettori_Activation_Time}
\end{center}
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=5in]{FIGURES/Vettori_Sloped_Ceiling/Vettori_Sloped_Activation_Time}
\end{center}
