...
IMPLICIT NONE
PRIVATE
PUBLIC INITIALIZE_LEVEL_SET_FIRESPREAD,LEVEL_SET_FIRESPREAD,LEVEL_SET_FIRESPREAD_NEW
...
SUBROUTINE LEVEL_SET_FIRESPREAD_NEW(NM)

INTEGER, INTENT(IN) :: NM
INTEGER :: I,J,IW,IIG,JJG
TYPE(WALL_TYPE), POINTER :: WC=>NULL()
...
WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   WC%ONE_D%PHI_NLS=PHI_NLS(IIG,JJG)

ENDDO WALL_LOOP

END SUBROUTINE LEVEL_SET_FIRESPREAD_NEW
