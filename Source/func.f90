...
#endif
INTEGER :: NM,NOM,IERR,SNODE,N,IPROC
...
DO NM=1,NMESHES
   DO IPROC=1,N_MPI_PROCESSES-1
      IF (MY_RANK==IPROC.AND.IPROC==PROCESS(NM)) THEN
         IF (MY_RANK/=0) THEN
            WRITE(*,*) "RANK ", MY_RANK, "SENDING MESH ", NM, " VAL ", MESHES(NM)%EMPTY_UNIQUE_SLICE
