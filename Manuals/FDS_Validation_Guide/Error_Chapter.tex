...
The uncertainty in pressure measurements is typically small, but depends on the sensor type and calibration. In the NIST/NRC experiments, the differential pressure gauge used was temperature compensated, highly linear, and very stable. A conservative estimate of the systematic relative standard uncertainty is 0.5~\%. However, the average difference between the repeat measurements in the NIST/NRC experiments was about 14~\%. Changes in compartment leakage due to the effects of the fire are a likely explanation for this large difference between replicate tests. A combined relative standard uncertainty of 14~\% is suggested for the measurement of pressure.
