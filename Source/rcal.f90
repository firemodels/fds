...
! FIND I_OMEGA SUCH THAT OMEGA(I_OMEGA)<=OMEGA<OMEGA(I_OMEGA+1)
         I_OMEGA = FLOOR((OMEGA-OMEGA_MIN)/DELTA_OMEGA,EB)+1
...
! CASE OMEGA > 1100 CM-1
         I_OMEGA1 = FLOOR((1100-OMEGA_MIN)/5.0_EB,EB)+1
         I_OMEGA2 = FLOOR((OMEGA-1100)/DELTA_OMEGA,EB)
