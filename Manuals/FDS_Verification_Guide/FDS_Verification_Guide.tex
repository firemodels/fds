...
A lead radiation shield with a thickness of 1 mm is placed in between a ceiling set to 500~$^\circ$C and a floor set to 20~$^\circ$C. The box has dimensions of 10 m x 0.1 m x 1 m. The emissivity, $\varepsilon_{3}$, of the lead shield is 0.48 on both sides.  
