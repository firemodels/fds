...
SUBROUTINE JANAF_TABLE (I_TMP,CP,H,SPEC_ID,RCON,FUEL,G_F,LISTED)
...
LOGICAL,INTENT(OUT) :: FUEL,LISTED
REAL(EB) :: CP2,TE
...
SUBROUTINE CALC_GAS_PROPS(J,N,D_TMP,MU_TMP,K_TMP,CP_TMP,H_TMP,FUEL,G_F_TMP,LISTED)
...
LOGICAL, INTENT(INOUT) :: FUEL,LISTED
...
CALL JANAF_TABLE(J,CP_TMP,H_TMP,SS%ID,SS%RCON,FUEL,G_F_TMP,LISTED)
