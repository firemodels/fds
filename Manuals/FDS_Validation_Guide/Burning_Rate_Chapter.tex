...
A common combustible used in fire research and testing is a wood crib; that is, an array of, usually, pine sticks forming a block of varying porosity. 

\subsection{SP Wood Crib Experiments}

These experiments and the modeling strategy are described in Section~\ref{SP_Wood_Cribs_Description}.
...
\multicolumn{2}{c}{\includegraphics[height=2.2in]{SCRIPT_FIGURES/SP_Wood_Cribs/Test_9_HRR}}
\end{tabular*}
\caption[SP Wood Cribs heat release rates]{SP Wood Cribs heat release rates.}
\label{SP_Wood_Cribs_HRR}
\end{figure}
