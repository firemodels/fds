...
IF(.NOT.(SPECIE(5)<=ZERO_P .AND. TWALL<=ZERO_P)) THEN
   ...
   DO KK=5,KMAX,5
      ...
      ABLONG=ABLONG+XPART/DD*PLANCK(RCT,WL)*DAMBDA*5.5411E7_EB/RCT4
      ABIL=ABIL+XPART/DD*PLANCK(TWALL,WL)*DAMBDA*5.5411E7_EB /(TWALL+.000001_EB)**4
   ...
   DO KK=KMIN,25000,100
      ...
      ABSHRT=ABSHRT+XPART/DD*PLANCK(RCT,WL)*DAMBDA*5.5411E7_EB/RCT4
      ABIS=ABIS+XPART/DD*PLANCK(TWALL,WL)*DAMBDA*5.5411E7_EB/(TWALL+.000001_EB)**4
...
ELSE
   ...
   AMEAN=-1._EB/DD*DLOG((5.5411E7_EB*Q-RCT**4)/(TWALL**4-RCT4))
ENDIF
...
DATA (CPLXREF_FUEL( 1,J), J=1,3) / 0.7_EB, 1.47_EB, 1.37E-07_EB / 
DATA (CPLXREF_FUEL( 2,J), J=1,3) / 0.8_EB, 1.47_EB, 3.90E-07_EB / 
DATA (CPLXREF_FUEL( 3,J), J=1,3) / 0.9_EB, 1.47_EB, 8.16E-07_EB / 
DATA (CPLXREF_FUEL( 4,J), J=1,3) / 1.0_EB, 1.47_EB, 7.91E-07_EB / 
DATA (CPLXREF_FUEL( 5,J), J=1,3) / 1.1_EB, 1.47_EB, 1.22E-06_EB / 
DATA (CPLXREF_FUEL( 6,J), J=1,3) / 1.2_EB, 1.47_EB, 4.30E-06_EB / 
DATA (CPLXREF_FUEL( 7,J), J=1,3) / 1.3_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL( 8,J), J=1,3) / 1.4_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL( 9,J), J=1,3) / 1.5_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(10,J), J=1,3) / 1.6_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(11,J), J=1,3) / 1.7_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(12,J), J=1,3) / 1.8_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(13,J), J=1,3) / 1.9_EB, 1.47_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(14,J), J=1,3) / 2.0_EB, 1.46_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(15,J), J=1,3) / 2.1_EB, 1.46_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(16,J), J=1,3) / 2.2_EB, 1.46_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(17,J), J=1,3) / 2.3_EB, 1.46_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(18,J), J=1,3) / 2.4_EB, 1.46_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(19,J), J=1,3) / 2.5_EB, 1.46_EB, 1.51E-06_EB / 
DATA (CPLXREF_FUEL(20,J), J=1,3) / 2.6_EB, 1.46_EB, 1.62E-04_EB / 
DATA (CPLXREF_FUEL(21,J), J=1,3) / 2.7_EB, 1.45_EB, 1.62E-04_EB / 
DATA (CPLXREF_FUEL(22,J), J=1,3) / 2.8_EB, 1.45_EB, 1.62E-04_EB / 
DATA (CPLXREF_FUEL(23,J), J=1,3) / 2.9_EB, 1.45_EB, 5.41E-05_EB / 
DATA (CPLXREF_FUEL(24,J), J=1,3) / 3.0_EB, 1.45_EB, 5.41E-05_EB / 
DATA (CPLXREF_FUEL(25,J), J=1,3) / 3.1_EB, 1.43_EB, 1.04E-04_EB / 
DATA (CPLXREF_FUEL(26,J), J=1,3) / 3.2_EB, 1.43_EB, 1.04E-04_EB / 
DATA (CPLXREF_FUEL(27,J), J=1,3) / 3.3_EB, 1.40_EB, 6.39E-04_EB / 
DATA (CPLXREF_FUEL(28,J), J=1,3) / 3.4_EB, 1.11_EB, 6.39E-04_EB / 
DATA (CPLXREF_FUEL(29,J), J=1,3) / 3.5_EB, 1.11_EB, 1.39E-01_EB / 
DATA (CPLXREF_FUEL(30,J), J=1,3) / 3.6_EB, 1.11_EB, 1.39E-01_EB / 
DATA (CPLXREF_FUEL(31,J), J=1,3) / 3.7_EB, 1.55_EB, 1.63E-03_EB / 
DATA (CPLXREF_FUEL(32,J), J=1,3) / 3.8_EB, 1.55_EB, 1.02E-03_EB / 
DATA (CPLXREF_FUEL(33,J), J=1,3) / 3.9_EB, 1.52_EB, 1.02E-03_EB / 
DATA (CPLXREF_FUEL(34,J), J=1,3) / 4.0_EB, 1.50_EB, 1.02E-03_EB / 
DATA (CPLXREF_FUEL(35,J), J=1,3) / 4.1_EB, 1.50_EB, 2.13E-04_EB / 
DATA (CPLXREF_FUEL(36,J), J=1,3) / 4.2_EB, 1.50_EB, 2.13E-04_EB / 
DATA (CPLXREF_FUEL(37,J), J=1,3) / 4.3_EB, 1.49_EB, 3.10E-04_EB / 
DATA (CPLXREF_FUEL(38,J), J=1,3) / 4.4_EB, 1.49_EB, 3.10E-04_EB / 
DATA (CPLXREF_FUEL(39,J), J=1,3) / 4.5_EB, 1.49_EB, 2.06E-04_EB / 
DATA (CPLXREF_FUEL(40,J), J=1,3) / 4.6_EB, 1.49_EB, 2.06E-04_EB / 
DATA (CPLXREF_FUEL(41,J), J=1,3) / 4.7_EB, 1.47_EB, 1.88E-04_EB / 
DATA (CPLXREF_FUEL(42,J), J=1,3) / 4.8_EB, 1.47_EB, 1.88E-04_EB / 
DATA (CPLXREF_FUEL(43,J), J=1,3) / 4.9_EB, 1.47_EB, 1.88E-04_EB / 
DATA (CPLXREF_FUEL(44,J), J=1,3) / 5.0_EB, 1.47_EB, 1.88E-04_EB / 
DATA (CPLXREF_FUEL(45,J), J=1,3) / 5.1_EB, 1.47_EB, 4.58E-05_EB / 
DATA (CPLXREF_FUEL(46,J), J=1,3) / 5.2_EB, 1.46_EB, 7.80E-05_EB / 
DATA (CPLXREF_FUEL(47,J), J=1,3) / 5.3_EB, 1.46_EB, 7.80E-05_EB / 
DATA (CPLXREF_FUEL(48,J), J=1,3) / 5.4_EB, 1.46_EB, 7.55E-05_EB / 
DATA (CPLXREF_FUEL(49,J), J=1,3) / 5.5_EB, 1.46_EB, 7.55E-05_EB / 
DATA (CPLXREF_FUEL(50,J), J=1,3) / 5.6_EB, 1.45_EB, 7.55E-05_EB / 
DATA (CPLXREF_FUEL(51,J), J=1,3) / 5.7_EB, 1.45_EB, 1.21E-04_EB / 
DATA (CPLXREF_FUEL(52,J), J=1,3) / 5.8_EB, 1.45_EB, 1.21E-04_EB / 
DATA (CPLXREF_FUEL(53,J), J=1,3) / 5.9_EB, 1.45_EB, 1.21E-04_EB / 
DATA (CPLXREF_FUEL(54,J), J=1,3) / 6.0_EB, 1.45_EB, 1.21E-04_EB / 
DATA (CPLXREF_FUEL(55,J), J=1,3) / 6.1_EB, 1.44_EB, 1.21E-04_EB / 
DATA (CPLXREF_FUEL(56,J), J=1,3) / 6.2_EB, 1.44_EB, 4.21E-04_EB / 
DATA (CPLXREF_FUEL(57,J), J=1,3) / 6.3_EB, 1.44_EB, 4.21E-04_EB / 
DATA (CPLXREF_FUEL(58,J), J=1,3) / 6.4_EB, 1.43_EB, 7.38E-04_EB / 
DATA (CPLXREF_FUEL(59,J), J=1,3) / 6.5_EB, 1.43_EB, 7.38E-04_EB / 
DATA (CPLXREF_FUEL(60,J), J=1,3) / 6.6_EB, 1.42_EB, 1.77E-03_EB / 
DATA (CPLXREF_FUEL(61,J), J=1,3) / 6.7_EB, 1.42_EB, 1.77E-03_EB / 
DATA (CPLXREF_FUEL(62,J), J=1,3) / 6.8_EB, 1.39_EB, 1.77E-03_EB / 
DATA (CPLXREF_FUEL(63,J), J=1,3) / 6.9_EB, 1.29_EB, 3.80E-02_EB / 
DATA (CPLXREF_FUEL(64,J), J=1,3) / 7.0_EB, 1.29_EB, 3.99E-03_EB / 
DATA (CPLXREF_FUEL(65,J), J=1,3) / 7.1_EB, 1.53_EB, 3.99E-03_EB / 
DATA (CPLXREF_FUEL(66,J), J=1,3) / 7.2_EB, 1.53_EB, 2.57E-03_EB / 
DATA (CPLXREF_FUEL(67,J), J=1,3) / 7.3_EB, 1.53_EB, 2.57E-03_EB / 
DATA (CPLXREF_FUEL(68,J), J=1,3) / 7.4_EB, 1.42_EB, 2.57E-03_EB / 
DATA (CPLXREF_FUEL(69,J), J=1,3) / 7.5_EB, 1.50_EB, 3.40E-03_EB / 
DATA (CPLXREF_FUEL(70,J), J=1,3) / 7.6_EB, 1.50_EB, 2.13E-03_EB / 
DATA (CPLXREF_FUEL(71,J), J=1,3) / 7.7_EB, 1.50_EB, 2.13E-03_EB / 
DATA (CPLXREF_FUEL(72,J), J=1,3) / 7.8_EB, 1.47_EB, 2.41E-03_EB / 
DATA (CPLXREF_FUEL(73,J), J=1,3) / 7.9_EB, 1.47_EB, 2.41E-03_EB / 
DATA (CPLXREF_FUEL(74,J), J=1,3) / 8.0_EB, 1.47_EB, 1.00E-03_EB / 
DATA (CPLXREF_FUEL(75,J), J=1,3) / 8.1_EB, 1.47_EB, 1.00E-03_EB / 
DATA (CPLXREF_FUEL(76,J), J=1,3) / 8.2_EB, 1.47_EB, 8.30E-04_EB / 
DATA (CPLXREF_FUEL(77,J), J=1,3) / 8.3_EB, 1.47_EB, 8.30E-04_EB / 
DATA (CPLXREF_FUEL(78,J), J=1,3) / 8.4_EB, 1.47_EB, 6.07E-04_EB / 
DATA (CPLXREF_FUEL(79,J), J=1,3) / 8.5_EB, 1.47_EB, 6.07E-04_EB / 
DATA (CPLXREF_FUEL(80,J), J=1,3) / 8.6_EB, 1.45_EB, 6.07E-04_EB / 
DATA (CPLXREF_FUEL(81,J), J=1,3) / 8.7_EB, 1.45_EB, 1.10E-03_EB / 
DATA (CPLXREF_FUEL(82,J), J=1,3) / 8.8_EB, 1.45_EB, 1.10E-03_EB / 
DATA (CPLXREF_FUEL(83,J), J=1,3) / 8.9_EB, 1.45_EB, 2.48E-03_EB / 
DATA (CPLXREF_FUEL(84,J), J=1,3) / 9.0_EB, 1.45_EB, 2.48E-03_EB / 
DATA (CPLXREF_FUEL(85,J), J=1,3) / 9.1_EB, 1.45_EB, 4.71E-04_EB / 
DATA (CPLXREF_FUEL(86,J), J=1,3) / 9.2_EB, 1.45_EB, 4.71E-04_EB / 
DATA (CPLXREF_FUEL(87,J), J=1,3) / 9.3_EB, 1.45_EB, 1.32E-03_EB / 
DATA (CPLXREF_FUEL(88,J), J=1,3) / 9.4_EB, 1.45_EB, 1.32E-03_EB / 
DATA (CPLXREF_FUEL(89,J), J=1,3) / 9.5_EB, 1.45_EB, 2.05E-03_EB / 
DATA (CPLXREF_FUEL(90,J), J=1,3) / 9.6_EB, 1.45_EB, 2.05E-03_EB / 
DATA (CPLXREF_FUEL(91,J), J=1,3) / 9.7_EB, 1.45_EB, 1.20E-03_EB / 
DATA (CPLXREF_FUEL(92,J), J=1,3) / 9.8_EB, 1.45_EB, 1.69E-03_EB / 
DATA (CPLXREF_FUEL(93,J), J=1,3) / 9.9_EB, 1.45_EB, 1.69E-03_EB / 
DATA (CPLXREF_FUEL(94,J), J=1,3) /10.0_EB, 1.45_EB, 1.69E-03_EB /
...
INTEGER  :: NSB,I,J,IBND,IZERO,NX,NLAMBDALOW(1),NLAMBDAHIGH(1),ND ,CLASS_NUMBER
...
IF (PC%RADIATIVE_PROPERTY_INDEX>0) THEN
   TA => TABLES(PC%RADIATIVE_PROPERTY_INDEX)
   NLMBDMIE = TA%NUMBER_ROWS
ELSEIF (PC%WATER) THEN
   NLMBDMIE = NWATERK
ELSEIF (PC%FUEL) THEN
   NLMBDMIE = NFUELK
ELSE
...
IF (PC%RADIATIVE_PROPERTY_INDEX > 0) THEN
   DO NX = 1,NLMBDMIE
      LMBDMIE(NX)            = TA%TABLE_DATA(NX,1)*1.0E-6_EB
      REAL_REF_INDX(NX)      = TA%TABLE_DATA(NX,2)
      CMPLX_REF_INDX(NX)     = TA%TABLE_DATA(NX,3)
   ENDDO
ELSEIF (PC%WATER) THEN
...
ELSEIF (PC%FUEL) THEN
   LMBDMIE(1:NLMBDMIE)        = CPLXREF_FUEL(1:NLMBDMIE,1)
   REAL_REF_INDX(1:NLMBDMIE)  = CPLXREF_FUEL(1:NLMBDMIE,2)
   CMPLX_REF_INDX(1:NLMBDMIE) = CPLXREF_FUEL(1:NLMBDMIE,3)
ELSE
   LMBDMIE                    = B_WIEN/MAX(TINY(RADTMP),RADTMP)
   REAL_REF_INDX              = PC%REAL_REFRACTIVE_INDEX
   CMPLX_REF_INDX             = PC%COMPLEX_REFRACTIVE_INDEX
ENDIF
...
!         ENDDO
         ...
         CALL INTERPOLATE1D(RDMIE,QSCA(:,J),PC%R50(ND),AVAL)
         CALL INTERPOLATE1D(RDMIE,CHI_F(:,J),PC%R50(ND),BVAL)
         BVAL = (1._EB-BVAL)
         ASUM = AVAL*BVAL
         CALL INTERPOLATE1D(RDMIE,QABS(:,J),PC%R50(ND),BVAL)
         BSUM = BVAL
         ! End Elizabeth's 
