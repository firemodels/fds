...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.0in]{FIGURES/ScatterPlots/Near_Field_Heat_Flux} \\
\vspace{0.25in} \\
\includegraphics[width=3.0in]{FIGURES/ScatterPlots/Far_Field_Heat_Flux}
\vspace{0.25in} 
\end{tabular}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.0in]{FIGURES/Hamins_CH4/Hamins_CH4_Radial}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.0in]{FIGURES/Hamins_CH4/Hamins_CH4_Vertical}
