...
TYPE CFACE_TYPE
   ...
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,Q_LEAK,RAW,RDN,RHO_F,TMP_F_GAS,U_TAU,UVW_GHOST,UW0,V_DEP,VEG_HEIGHT,VEL_ERR_NEW,XW,Y_PLUS,&
                        YW,ZW
   INTEGER, POINTER :: BOUNDARY_TYPE,NODE_INDEX,OBST_INDEX,PRESSURE_BC_INDEX,PRESSURE_ZONE,SURF_INDEX,&
                       SURF_INDEX_ORIG,VENT_INDEX,WALL_INDEX,CUT_FACE_IND1,CUT_FACE_IND2
END TYPE CFACE_TYPE
