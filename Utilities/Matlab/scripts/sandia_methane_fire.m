...
%                -.5,.5,.05,-.5,.5,.1,0,8,1, ...
%                'Sandia_CH4_1m_Test14_W_zp3.csv','ko','Exp', ...
%                'Sandia_CH4_1m_Test17_dx6cm_devc.csv','k--','FDS 3 cm', ...
...
%                -.5,.5,.05,-.5,.5,.1,0,8,1, ...
%                'Sandia_CH4_1m_Test14_W_zp5.csv','ko','Exp', ...
%                'Sandia_CH4_1m_Test17_dx6cm_devc.csv','k--','FDS 3 cm', ...
%                'Sandia_CH4_1m_Test17_dx1p5cm_devc.csv','k-','FDS 1.5 cm')
% 
...
%                -.5,.5,.05,-.5,.5,.1,0,8,1, ...
%                'Sandia_CH4_1m_Test14_W_zp9.csv','ko','Exp', ...
%                'Sandia_CH4_1m_Test17_dx6cm_devc.csv','k--','FDS 3 cm', ...
%                'Sandia_CH4_1m_Test17_dx1p5cm_devc.csv','k-','FDS 1.5 cm')
%            
% % radial velocity
...
%                -.5,.5,.05,-.5,.5,.1,-.8,.8,.2, ...
%                'Sandia_CH4_1m_Test14_U_zp3.csv','ko','Exp', ...
%                'Sandia_CH4_1m_Test17_dx6cm_devc.csv','k--','FDS 3 cm', ...
%                'Sandia_CH4_1m_Test17_dx1p5cm_devc.csv','k-','FDS 1.5 cm')
%            
...
%                -.5,.5,.05,-.5,.5,.1,-.8,.8,.2, ...
%                'Sandia_CH4_1m_Test14_U_zp5.csv','ko','Exp', ...
%                'Sandia_CH4_1m_Test17_dx6cm_devc.csv','k--','FDS 3 cm', ...
%                'Sandia_CH4_1m_Test17_dx1p5cm_devc.csv','k-','FDS 1.5 cm')
% 
...
%                -.5,.5,.05,-.5,.5,.1,-.8,.8,.2, ...
%                'Sandia_CH4_1m_Test14_U_zp9.csv','ko','Exp', ...
%                'Sandia_CH4_1m_Test17_dx6cm_devc.csv','k--','FDS 3 cm', ...
%                'Sandia_CH4_1m_Test17_dx1p5cm_devc.csv','k-','FDS 1.5 cm')
