...
\end{tabular*}
\caption[The \textct{simply\_beam} results]{Temperature evolution at the bottom of the midspam (A) and at bottom with x=0.5m (B).}
...
\end{tabular*}
\caption[The \textct{simply\_beam} results]{Displacements evolution at the bottom of the midspam (A).}
