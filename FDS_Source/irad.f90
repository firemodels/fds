...
INTEGER :: I_MODEL_MMA   ! 1: GOODY, 2: MALKMUS, 3: ELSASSER 
...
REAL(EB), ALLOCATABLE, DIMENSION(:)    :: SD_MMA_TEMP
...
REAL(EB), DIMENSION(:,:), POINTER :: KAPPA_D, GAMMA_D
REAL(EB), DIMENSION(:),   POINTER :: BAND_OMEGA
         ...
         SELECT CASE (I)
            ...
            CASE (3)
               SELECT CASE(RADCAL_ID)
                  ...
                  CASE('METHANOL')    ; CALL CH3OH(  OMEGA,TEMP,P(3),PTOT,GC(3),SDWEAK,A_COLLISION,A_DOPPLER,I_MODEL)
                  ...
                  CASE('MMA')         ; CALL MMA(    OMEGA,TEMP,P(3),PTOT,GC(3),SDWEAK,A_COLLISION,A_DOPPLER,I_MODEL)
...
! COMPUTE AVERAGE LINE SPACING
! USE N-HEPTANE PROPERTIES
DINV_C7H8=1._EB/(2.0_EB*0.024_EB)
...
!==============================================================================
SUBROUTINE CH3OH(OMEGA,TEMP,PCH3OH,PTOT,GC3,SDWEAK,GDINV,GDDINV,I_MODEL)
!==============================================================================
...
!==============================================================================
SUBROUTINE MMA(OMEGA,TEMP,PMMA,PTOT,GC3,SDWEAK,GDINV,GDDINV,I_MODEL)
!==============================================================================
