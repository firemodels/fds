...
a rectangular steel tube filled with an insulation material. The beam in Tests 2 and 3 was an I-beam. A diagram of the room used in Tests 2 and 3 is displayed in Figure~\ref{Room_Drawing}.

%\begin{sidewaysfigure}[ht]
%\begin{center}
%\includegraphics[width=6.in]{FIGURES/SP_AST/Full_Room_hollowbar}
%\end{center}
...
CSTB Tunnel         & 1965 -- 2484  & 0.8           & 1.9   & 3.1 -- 3.9        & 2.0 -- 2.3          & 0.0 -- 0.1    & 1.3         & 28          & 1.6 -- 12.6           & N/A                   \\ \hline
