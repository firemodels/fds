...
CO_EXTINCT: DO CO_PASS = 1,2
   ...
   INTEGRATION_LOOP: DO TIME_ITER = 1,MAX_CHEMISTRY_ITERATIONS
      ...
      IF (DEBUG) WRITE(*,*) EXTINCT_MOD,COMBUSTION_ODE_SOLVER,EXTINCT
      ...
      INTEGRATOR_SELECT: SELECT CASE (COMBUSTION_ODE_SOLVER)
         ...
         CASE (EXPLICIT_EULER) ! Simple chemistry
            ...
            IF (DEBUG) WRITE(*,*) ZZ_MIXED_NEW
            IF (DEBUG) WRITE(*,*) ZZ_UNMIXED
   ...
   NEW_EXTINCT_IF:IF (EXTINCT_MOD == EXTINCTION_5) THEN
      ...
      ENDIF
      CALL EXTINCT_5(ZZ_0,ZZ_MIXED,EXTINCT,TMP_IN,CO_PASS)
   ...
   ELSEIF(EXTINCT_MOD == EXTINCTION_6) THEN NEW_EXTINCT_IF
      CALL EXTINCT_6(ZZ_0,ZZ_MIXED,EXTINCT,TMP_IN)
      IF (.NOT. EXTINCT(1)) THEN
         EXIT CO_EXTINCT
      ELSE
         ZZ_GET = ZZ_0
...
IF (ANY(REACTION(:)%FAST_CHEMISTRY)) THEN
   SELECT CASE (EXTINCT_MOD)
      ...
      CASE(EXTINCTION_4) ! experimental
         ...
         EXTINCT      = FUNC_EXTINCT
      CASE(EXTINCTION_5, EXTINCTION_6) ! experimental
