...
group with a {\ct VOLUME\_FLUX} prescribed can be invoked by either a
...
\footnotesize
\begin{verbatim}
&SURF ID='LOUVER', VOLUME_FLUX=-5.0, VEL_T=2.0,-1.0, COLOR='GREEN' /
&OBST XB=..., SURF_ID6='BRICK','LOUVER','BRICK','BRICK','BRICK','BRICK' /
\end{verbatim}
\normalsize

\noindent
dictates that the forward $x$-facing surface of the obstruction is to have a velocity
equal to 5~m/s divided by the area of the face (as approximated within FDS) flowing into the
