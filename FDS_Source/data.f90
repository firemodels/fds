...
OUTPUT_QUANTITY(-14)%NAME = 'NORMALIZED HEAT FLOW'     
...
OUTPUT_QUANTITY(-16)%NAME = 'NORMALIZED MASS FLUX'
...
OUTPUT_QUANTITY(-26)%NAME= 'NORMALIZED SURFACE DENSITY'
...
OUTPUT_QUANTITY(-40)%OLD_NAME= 'PRESSURE_COEFFICIENT TEST'    
