...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: R_CNF,CNF,CVF,BREAKUP_R_CNF,BREAKUP_CNF,BREAKUP_CVF,W_CNF,R50,LAMBDA
...
TYPE REACTION_TYPE
   ...
   LOGICAL :: IDEAL,CHECK_ATOM_BALANCE,FAST_CHEMISTRY=.FALSE.
...
TYPE FACET_TYPE
   INTEGER :: VERTEX(3)=0,SURF_INDEX=0,PART_INDEX=0,N_PARTICLES=1,BOUNDARY_TYPE
   CHARACTER(30) :: SURF_ID='null',PART_ID='null'
   ...
   TYPE(LINKED_LIST_TYPE), POINTER :: PARTICLE_LIST
   LOGICAL :: ALREADY_INSERTED=.FALSE.
END TYPE FACET_TYPE
