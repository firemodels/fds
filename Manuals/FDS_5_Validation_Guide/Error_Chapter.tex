...
\section{Definitions of Uncertainty}
...
A common technique for assessing parameter uncertainty is to randomly select input parameters
...
$p_i$ are the respective power dependencies, and
