...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, &
         ...
         AL2O3=.FALSE.,UL_PAN_DATA=.FALSE.,EDDY_BREAKUP=.TRUE.,SHARED_FILE_SYSTEM=.TRUE., &
         FREEZE_VELOCITY=.FALSE.,ADJUST_HOR=.TRUE.
...
REAL(EB) :: MW_AIR,MW_SOOT,HRRPUA_SHEET=200._EB,RHO_SOOT,VISIBILITY_FACTOR, &
            MASS_EXTINCTION_COEFFICIENT,EC_LL,MIX_TIME_FACTOR=0.1_EB,HRRPUV_AVERAGE=2000._EB,HRRPUV_AVERAGE_TIME=1._EB
