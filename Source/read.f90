...
NAMELIST /DEVC/ ABSOLUTE_VALUE,BYPASS_FLOWRATE,CONVERSION_FACTOR,CONVERSION_ADDEND,COORD_FACTOR,CELL_L,CTRL_ID,DELAY,DEPTH,&
                ...
                MATL_ID,MOVE_ID,NODE_ID,NO_UPDATE_DEVC_ID,NO_UPDATE_CTRL_ID,ORIENTATION,ORIENTATION_NUMBER,OUTPUT,PART_ID,&
                PIPE_INDEX,&
...
READ_DEVC_LOOP: DO NN=1,N_DEVC_READ
   ...
   IF (MOVE_ID/='null') THEN
      ...
      IF (MOVE_INDEX==0) THEN
         ...
         CALL SHUTDOWN(MESSAGE) ; RETURN
      ENDIF
      IF (XYZ(1)>-1.E5) CALL TRANSFORM_COORDINATES(XYZ(1),XYZ(2),XYZ(3),MOVE_INDEX)
      IF (XB(1) >-1.E5) CALL TRANSFORM_COORDINATES(XB(1),XB(3),XB(5),MOVE_INDEX)
      IF (XB(1) >-1.E5) CALL TRANSFORM_COORDINATES(XB(2),XB(4),XB(6),MOVE_INDEX)
   ENDIF
