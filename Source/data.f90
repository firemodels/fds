...
OUTPUT_QUANTITY(447)%NAME = 'PARTICLE DRAG FORCE X'
OUTPUT_QUANTITY(447)%UNITS = 'm/s2'
OUTPUT_QUANTITY(447)%SHORT_NAME = 'fx_drag'

OUTPUT_QUANTITY(448)%NAME = 'PARTICLE DRAG FORCE Y'
OUTPUT_QUANTITY(448)%UNITS = 'm/s2'
OUTPUT_QUANTITY(448)%SHORT_NAME = 'fy_drag'

OUTPUT_QUANTITY(449)%NAME = 'PARTICLE DRAG FORCE Z'
OUTPUT_QUANTITY(449)%UNITS = 'm/s2'
OUTPUT_QUANTITY(449)%SHORT_NAME = 'fz_drag'

OUTPUT_QUANTITY(434:449)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:449)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:449)%DEVC_APPROPRIATE = .TRUE.
