...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_DROPLETS,ALLOW_UNDERSIDE_DROPLETS,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                WFDS,WIND_ONLY,MIXING_LAYER_U0,MIXING_LAYER_H0,MIXING_LAYER_THETA0
...
LOGICAL :: MASSLESS,STATIC,TREE,MONODISPERSE,EVAPORATE,BREAKUP,CHECK_DISTRIBUTION
...
NAMELIST /PART/ AGE,BREAKUP,BREAKUP_CHILD_DIAMETER,BREAKUP_CHILD_GAMMA_D,BREAKUP_CHILD_SIGMA_D,COLOR,COMPLEX_REFRACTIVE_INDEX,&
                ...
                VEG_STEM,VEG_SV,VERTICAL_VELOCITY,CNF_RAMP_ID,CHILD_CNF_RAMP_ID,DISTRIBUTION,CHILD_DISTRIBUTION,CHECK_DISTRIBUTION
