...
DEVICE_LOOP: DO N=1,N_DEVC
   ...
   MESH_LOOP_2: DO NM=1,NMESHES
      ...
      IF (DV%X1>-1.E5_EB) THEN
         ...
         SDV%I1 =   FLOOR( GINV(SDV%X1-M%XS,1,NM)*M%RDXI + TWO_EPSILON_EB, EB ) + 1
         SDV%I2 = CEILING( GINV(SDV%X2-M%XS,1,NM)*M%RDXI - TWO_EPSILON_EB, EB )
         SDV%J1 =   FLOOR( GINV(SDV%Y1-M%YS,2,NM)*M%RDETA + TWO_EPSILON_EB, EB ) + 1
         SDV%J2 = CEILING( GINV(SDV%Y2-M%YS,2,NM)*M%RDETA - TWO_EPSILON_EB, EB )
         SDV%K1 =   FLOOR( GINV(SDV%Z1-M%ZS,3,NM)*M%RDZETA + TWO_EPSILON_EB, EB ) + 1
         SDV%K2 = CEILING( GINV(SDV%Z2-M%ZS,3,NM)*M%RDZETA - TWO_EPSILON_EB, EB )
