...
If the radiation around the particle is not uniform, it may be useful to split the particle by orientations. This can be done by using the parameter {\ct ORIENTATION(1:3,1:N)} to specify {\ct N} unique directions for the particle. For example,
\begin{lstlisting}
