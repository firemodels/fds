...
\subsection{Special Topic: Specifying a Wind Field}
...
\end{lstlisting}
Note that {\ct PERIODIC\_MESH\_IDS} is an array of three character strings because it is possible to have three periodic boundaries, one in each coordinate direction. For additional information related to periodic boundaries and the pressure solver see Section~\ref{sec:true_periodic_boundaries}.
