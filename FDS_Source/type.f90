...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=17,N_WALL_SCALAR_INTEGERS=12,N_WALL_SCALAR_LOGICALS=0
...
TYPE WALL_TYPE
   ...
   INTEGER, POINTER :: WALL_INDEX,SURF_INDEX,BACK_INDEX,BACK_MESH,BOUNDARY_TYPE,SURF_INDEX_ORIG,OBST_INDEX, &
                       PRESSURE_BC_INDEX,PRESSURE_ZONE,VENT_INDEX,NOM,NODE_INDEX
END TYPE WALL_TYPE
...
TYPE DUCTNODE_TYPE
   ...
   LOGICAL :: UPDATED, FIXED, AMBIENT = .FALSE.,LEAKAGE=.FALSE.,VENT=.FALSE.
