...
EVAC_ONLY3: IF (.NOT. ALL(EVACUATION_ONLY)) THEN
   DO N=1,N_PART
      ...
      IF (PC%SMOKEVIEW_ID.EQ.'null') THEN
         WRITE(LU_SMV,'(1X,A)')     PC%ID      
      ELSE
         WRITE(LU_SMV,'(1X,A,A,A)') PC%ID,'  % ',TRIM(PC%SMOKEVIEW_ID)
      ENDIF
      ...
      ENDDO
      IF (PC%SMOKEVIEW_ID/='null') WRITE(LU_SMV,'(4F9.3)') PC%DIAMETER,0.1,PC%AZIMUTH,PC%ELEVATION
   ENDDO
ENDIF EVAC_ONLY3
