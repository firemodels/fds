...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,PRESSURE_RELAX_FACTOR,RELAXATION_FACTOR,FYI, &
                ...
                MEAN_FORCING,RFAC_FORCING,H_EDDY,H_LOGLAW,LIMITING_DT_RATIO, &
                NOBIAS,VAN_DRIEST,CP_FTMP,HRRPUVCUT_MAX
...
NAMELIST /REAC/ E,BOF,HEAT_OF_COMBUSTION,FYI,FUEL,OXIDIZER,EPUMO2,ID, N_S,&
                ...
                EDDY_DISSIPATION,C_EDC,HRRPUA_SHEET,HRRPUA_SHEET_EXPONENT,HRRPUV_AVERAGE,HRRPUV_AVERAGE_TIME,AIT
...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(0:MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2), &
            ...
            ROUGHNESS,RADIUS,LENGTH,WIDTH,DT_INSERT,H_FIXED,TAU_PART
