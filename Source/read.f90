...
REAL(EB) :: AGL_SLICE
INTEGER :: N,NN,NNN,NM,MESH_NUMBER,N_SLCF_O,NITER,ITER,VELO_INDEX,IOR,IG,TRNF_INDEX,GEOM_INDEX
LOGICAL :: VECTOR,CELL_CENTERED,FACE_CENTERED,EVACUATION,AGL_SLICE_EXISTS
...
NAMELIST /SLCF/ AGL_SLICE,CELL_CENTERED,DB,EVACUATION,FACE_CENTERED,FYI,ID,IOR,MAXIMUM_VALUE,&
...
MESH_LOOP: DO NM=1,NMESHES
   ...
   SLCF_LOOP: DO NN=1,N_SLCF_O
      ...
      IF (AGL_SLICE>=0._EB) THEN
         AGL_SLICE_EXISTS = .FALSE.
         DO NNN=1,N_OBST
            OB => OBSTRUCTION(NNN)
            IF (OB%K2<KBAR) AGL_SLICE_EXISTS = .TRUE.
         ENDDO
         IF (.NOT.AGL_SLICE_EXISTS) THEN
            N_SLCF = N_SLCF - 1
            CYCLE SLCF_LOOP
         ENDIF
      ENDIF
