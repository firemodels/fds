...
USE PHYSICAL_FUNCTIONS, ONLY: GET_AVERAGE_SPECIFIC_HEAT,GET_SPECIFIC_GAS_CONSTANT,GET_ENTHALPY,GET_SPECIFIC_HEAT,&
...
REAL(EB) :: ERR_EST,ERR_TOL,A1(1:N_TRACKED_SPECIES),A2(1:N_TRACKED_SPECIES),A4(1:N_TRACKED_SPECIES),ZETA,ZETA_0,&
            ...
            ZETA_1,ZETA_2,ZETA_4,D_F,TMP_IN,TMP_FLAME,TRI_NUMER,TRI_DENOM,ZETA_FLAME,H_IN,H_FLAME,MW_0,MW_MIXED,VOL_FRAC_FLAME
...
IF (TRI_MODEL .AND. Q_OUT>TWO_EPSILON_EB) THEN
   ...
   CALL GET_FLAME_TEMPERATURE(TMP_FLAME,ZZ_0,ZZ_MIXED,TMP_IN)

   CALL GET_ENTHALPY(ZZ_0,H_IN,TMP_IN)
   CALL GET_ENTHALPY(ZZ_MIXED,H_FLAME,TMP_FLAME)
   ...
   VOL_FRAC_FLAME = ZETA_FLAME * MW_0/MW_MIXED * TMP_FLAME/TMP_IN

   TRI_NUMER = (1._EB-VOL_FRAC_FLAME)*TMP_IN**4 + VOL_FRAC_FLAME*TMP_FLAME**4
   TRI_DENOM = TMP_IN**4

   TRI_COR_OUT = MAX(1._EB, TRI_NUMER/TRI_DENOM)
...
REAL(EB) :: ZZ_HAT_0(1:N_TRACKED_SPECIES),ZZ_HAT(1:N_TRACKED_SPECIES),H_0,TMP_1,TMP_2,H_1,H_2,H_REL_ERROR,PHI_TILDE
INTEGER :: NS,ITER
