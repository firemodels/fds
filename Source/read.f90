...
CALL READ_CATF    ; CALL CHECK_STOP_STATUS
CALL READ_DEAD    ; CALL CHECK_STOP_STATUS
CALL READ_HEAD    ; CALL CHECK_STOP_STATUS
CALL READ_MISC    ; CALL CHECK_STOP_STATUS
CALL READ_MOVE    ; CALL CHECK_STOP_STATUS
CALL READ_MULT    ; CALL CHECK_STOP_STATUS
CALL READ_MESH(1) ; CALL CHECK_STOP_STATUS
CALL READ_EVAC(1) ; CALL CHECK_STOP_STATUS
CALL READ_MESH(2) ; CALL CHECK_STOP_STATUS
CALL READ_TRAN    ; CALL CHECK_STOP_STATUS
CALL READ_TIME(DT); CALL CHECK_STOP_STATUS
CALL READ_PRES    ; CALL CHECK_STOP_STATUS
CALL READ_COMB    ; CALL CHECK_STOP_STATUS
CALL READ_REAC    ; CALL CHECK_STOP_STATUS
CALL READ_SPEC    ; CALL CHECK_STOP_STATUS
CALL PROC_REAC_1  ; CALL CHECK_STOP_STATUS
CALL READ_RADI    ; CALL CHECK_STOP_STATUS
CALL READ_PROP    ; CALL CHECK_STOP_STATUS
CALL READ_DEVC    ; CALL CHECK_STOP_STATUS
CALL READ_PART    ; CALL CHECK_STOP_STATUS
CALL READ_CTRL    ; CALL CHECK_STOP_STATUS
CALL READ_MATL    ; CALL CHECK_STOP_STATUS
CALL READ_SURF    ; CALL CHECK_STOP_STATUS
CALL READ_CSVF    ; CALL CHECK_STOP_STATUS
CALL READ_OBST    ; CALL CHECK_STOP_STATUS
CALL READ_GEOM    ; CALL CHECK_STOP_STATUS
CALL READ_TRNF    ; CALL CHECK_STOP_STATUS
CALL READ_VENT    ; CALL CHECK_STOP_STATUS
CALL READ_ZONE    ; CALL CHECK_STOP_STATUS
CALL READ_EVAC(2) ; CALL CHECK_STOP_STATUS
CALL READ_HVAC    ; CALL CHECK_STOP_STATUS
CALL READ_WIND    ; CALL CHECK_STOP_STATUS
CALL PROC_SURF_1  ; CALL CHECK_STOP_STATUS
CALL READ_INIT    ; CALL CHECK_STOP_STATUS
CALL READ_RAMP    ; CALL CHECK_STOP_STATUS
CALL PROC_SMIX    ; CALL CHECK_STOP_STATUS
CALL PROC_SPEC    ; CALL CHECK_STOP_STATUS
CALL PROC_WIND    ; CALL CHECK_STOP_STATUS
CALL PROC_REAC_2  ; CALL CHECK_STOP_STATUS
CALL PROC_HVAC    ; CALL CHECK_STOP_STATUS
CALL PROC_MATL    ; CALL CHECK_STOP_STATUS
CALL PROC_SURF_2  ; CALL CHECK_STOP_STATUS
CALL READ_DUMP    ; CALL CHECK_STOP_STATUS
CALL READ_CLIP    ; CALL CHECK_STOP_STATUS
CALL PROC_WALL    ; CALL CHECK_STOP_STATUS
CALL PROC_PART    ; CALL CHECK_STOP_STATUS
CALL PROC_INIT    ; CALL CHECK_STOP_STATUS
CALL READ_TABL    ; CALL CHECK_STOP_STATUS
CALL PROC_CTRL    ; CALL CHECK_STOP_STATUS
CALL PROC_PROP    ; CALL CHECK_STOP_STATUS
CALL PROC_DEVC    ; CALL CHECK_STOP_STATUS
CALL PROC_OBST    ; CALL CHECK_STOP_STATUS
CALL READ_PROF    ; CALL CHECK_STOP_STATUS
CALL READ_SLCF    ; CALL CHECK_STOP_STATUS
CALL READ_ISOF    ; CALL CHECK_STOP_STATUS
CALL READ_BNDF    ; CALL CHECK_STOP_STATUS
CALL READ_RADF    ; CALL CHECK_STOP_STATUS
