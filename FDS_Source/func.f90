...
REAL(EB), INTENT(INOUT) :: Y_EQ,T_EQ,M_EQ
...
T_NEV = MIN(SS%TMP_V,TMP_2)
CALL INTERPOLATE1D_UNIFORM(LBOUND(SS%H_V,1),SS%H_V,T_NEV,H_V)
DHOR = H_V*MW_V/R0
X_EQ = MIN(1._EB,P_RATIO*EXP(DHOR*(1._EB/SS%TMP_V-1._EB/T_NEV)))
...
TMP_1 = MIN(SS%TMP_V,TMP_2)
CALL INTERPOLATE1D_UNIFORM(LBOUND(SS%H_V,1),SS%H_V,TMP_1,H_V)
DHOR = H_V*MW_V/R0
X_EQ = MIN(1._EB,P_RATIO*EXP(DHOR*(1._EB/SS%TMP_V-1._EB/TMP_1)))
...
!Compute 
X_MIN = 0._EB
X = MIN(0.5_EB,MAX(0._EB,(0.5_EB*Y_NEV*M_G-M_V0)/(M_L*(1._EB-0.5_EB*Y_NEV)))) ! Guess minimum of half particle mass or one half of Y_EQ for no evaporation
X_OLD = 2._EB
...
FIND_EQ: DO I=1,20
   ...
   DHOR = H_V*MW_V/R0   
   X_EQ = MIN(1._EB,P_RATIO*EXP(DHOR*(1._EB/SS%TMP_V-1._EB/MIN(SS%TMP_V,TMP_2))))
