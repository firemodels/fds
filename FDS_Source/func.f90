...
SUBROUTINE DROPLET_SIZE_DISTRIBUTION(DM,RR,CNF,NPT,GAMMA,SIGMA,DISTRIBUTION)
...
CASE('ROSIN-RAMMLER')
   ...
   DMIN   = (-LOG(1._EB-0.01_EB)/0.693_EB)**(1._EB/GAMMA)*DM/REAL(NPT,EB)
   DD1    =(DD1-DMIN)/REAL(NPT,EB)
...
INTEGER::IND=0
IND=MIN(NBINS,MAX(CEILING((VAL-LIMITS(1))/(LIMITS(2)-LIMITS(1))*NBINS),0))
