...
expressions  for  the thermal conductivity  and  material diffusivity:  \be  k_{\hbox{\tiny LES}}  = \frac{\mu_{\hbox{\tiny  LES}}   \;  c_p}{\PR}
\quad   ;  \quad  (\rho D)_{\hbox{\tiny  LES}}  =\frac{\mu_{\hbox{\tiny  LES}}}{\SC}  \ee  The Prandtl  number  $\PR$  and  the  Schmidt number
...
weighted sum of the material emissivities using the mass fractions in
the first condenced phase grid cell. In the verification test, the
initial material, having emissivity of 1.0, is converted to another
material, having emissivity of 0.0, at constant rate of 0.1 1/s. As a
result, the surface emissivity should change linearly from 1.0 to 0.0
as time goes from 0 s to 10.0 s. 

Comparison of analytical and numerical solutions will be placed here.
