...
Only tests that used a flaming ignition source were considered. The burning behavior of the upholstered
chair and mattress fuel packages were characterized by separate tests conducted by Omega Point
Laboratories (OPL). The upholstered chair was tested in accordance with CAL TB~133 standards (with a
modified ignition source). The mattress was tested in accordance with CAL TB~129 standards (with a
modified ignition source).
