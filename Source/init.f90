...
ALLOCATE(M%U(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','U',IZERO)
ALLOCATE(M%V(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','V',IZERO)
ALLOCATE(M%W(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)     ; CALL ChkMemErr('INIT','W',IZERO)
...
ALLOCATE(M%WORK_U(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WORK_U',IZERO)
ALLOCATE(M%WORK_V(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WORK_V',IZERO)
ALLOCATE(M%WORK_W(-1:IBP1,-1:JBP1,-1:KBP1),STAT=IZERO)    ; CALL ChkMemErr('INIT','WORK_W',IZERO)
