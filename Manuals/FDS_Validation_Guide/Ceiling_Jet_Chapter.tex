...
A description of the experiments is found in Section~\ref{Memorial_Tunnel_Description}. The figures on the following pages show near-ceiling temperatures at locations uphill and downhill from the tunnel fire. 

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A-CJ-North} & 
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_606A-CJ-South} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B-CJ-North} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_612B-CJ-South} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B-CJ-North} &
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Memorial_Tunnel/Test_615B-CJ-South}   
\end{tabular*}
\caption[Memorial Tunnel experiments, ceiling jet, Tests 606A, 612B, 615B]
{Memorial Tunnel experiments, ceiling jet, Tests 606A, 612B, 615B.}
