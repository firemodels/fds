...
\section{BRE Spray Tests, Attenuation of Thermal Radiation in Water Spray}
...
each nozzle. The droplet boundary conditions were determined by assuming $d_m \propto p^{-1/3}$ and $v \propto p^{1/2}$ type of
dependences between the droplet size, speed and pressure, and by comparing the predicted and measured results at the PDPA measurement location
0.7 m below the nozzles. For practical reasons, measured median diameter $d_{v50}$ is compared against mean diameter $d_{43}$. For the vertical velocity,
arithmetic mean of the droplets is used. These results represent a validation of the boundary conditions.
The actual validation of radiation attenuation is performed by comparing the experimental and measured attenuations.
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
...
\begin{figure}[p]
\begin{tabular}{c}
\includegraphics[width=5.0in]{FIGURES/BRE_Spray/BRE_Spray_Attenuation}
\end{tabular}
