...
\ee
where $C$ is the soot concentration (mg/m$^3$), $A/V$ is the surface area to volume ratio (\si{1/m}), and $u_g$ is the gravitational settling velocity (m/s). Equation~\ref{eq:gravitational_settling} has an analytical solution for the dynamic gas-phase soot concentration of the form
\be
