...
TYPE PARTICLE_CLASS_TYPE
   ...
   INTEGER :: SAMPLING,SPEC_INDEX,Y_INDEX,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
...
TYPE SPECIES_TYPE
   REAL(EB) :: MW=0._EB,YY0=0._EB,RCON,MAXMASS,MASS_EXTINCTION_COEFFICIENT,D(5000),SPECIFIC_HEAT=-1._EB,SPECIFIC_ENTHALPY=-1._EB,&
