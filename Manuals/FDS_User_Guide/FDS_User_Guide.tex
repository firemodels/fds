...
The default relative humidity of the background air species is 40\%.  This may be changed by setting {\ct HUMIDITY} (in units of \%) for the background species: 

\footnotesize
\begin{verbatim}
&SPEC ID='AIR', HUMIDITY=20, BACKGROUND=.TRUE./
\end{verbatim}
\normalsize

\noindent Note that {\ct 'AIR'} is the only predefined species mixture.  More on specifying mixtures can be found in Section \ref{info:SMIX}.
