...
\noindent would use the RadCal absorptivities for {\ct METHANOL} when computing the absorptivity of {\ct ETHANOL}.
...
\noindent These inputs define two {\ct CARBON DIOXIDE} species.  Both will use the built in property data for CO$_2$.  The {\ct ALIAS} for each species is then used in the remainder of the input file.
