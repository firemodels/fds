...
PUBLIC INIT_RADCAL,RCALLOC,RCDEALLOC,RCDEALLOC2,PLANCK,SUB_RADCAL
...
! ELSE, PROCEED WITH CALCULATION
   ...
   IF (PATH_LENGTH_CM(I_PATH)<=TWENTY_EPSILON_EB) CYCLE
...
IF (TEMP4 > TWENTY_EPSILON_EB) THEN
...
IF (TWALL**4 > TWENTY_EPSILON_EB) THEN
...
LSPECIES: DO I = 1, N_RADCAL_SPECIES
   IF (P_ATM(I) <= TWENTY_EPSILON_EB) CYCLE LSPECIES
...
Y_DOPPLER   = MAX(1._EB-(X_DOPPLER/XSTAR)**2,TWENTY_EPSILON_EB)
Y_COLLISION = MAX(1._EB-(X_COLLISION/XSTAR)**2,TWENTY_EPSILON_EB)
! SP-3080 EQ. 5-26
...
X_ELSASSER  = -LOG(1.0_EB-ERF(X_COLLISION)+TWENTY_EPSILON_EB)
      ...
      L102: DO J = 1, 20
         ...
         L101: DO K = 1, 10
            ...
            IF(L==2) THEN
               ...
               IF (V<=TWENTY_EPSILON_EB) OMVV3 = 3715._EB-47._EB*V3
            ELSE
               OMVV3 = 3598.0_EB-18.0_EB*V-47.0_EB*V3
               IF (V<=TWENTY_EPSILON_EB) OMVV3 = 3613.0_EB-47.0_EB*V3
            ENDIF
         ...
         L102A: DO J = 1, 20
            ...
            L101A: DO K = 1, 10
               ...
               IF(L==2) THEN
                  ...
                  IF(V<=TWENTY_EPSILON_EB) OMVV3 = 3715.0_EB - 47.0_EB*V3
               ELSE
                  OMVV3 = 3598.0_EB - 18.0_EB*V - 47.0_EB*V3
                  IF(V<=TWENTY_EPSILON_EB) OMVV3 = 3613.0_EB - 47.0_EB*V3
               ENDIF
...
IF(ABS(TEMP)<TWENTY_EPSILON_EB) THEN
   PLANCK = 0._EB
ELSE
   C = TEMP * LAMBDA
   IF (Q2/C > 38._EB) THEN
