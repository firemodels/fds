...
\section{Vettori Sprinkler Experiments}

The Vettori sprinkler experiments considered the effects of fire location, fire growth rate, ceiling slope and ceiling obstructions on the activation time of sprinklers. There were two test series; the first to assess fires under flat ceilings, the second sloped ceilings.

\subsection{Flat Ceiling Series}
\label{Vettori_Flat_Results}

The following figures display the temperature of the ceiling jet at the location of the first two activating sprinklers for each of the 18 scenarios compared with the appropriate experimental data. The experiments consisted of either Smooth or Obstructed ceilings; Slow, Medium or Fast fires; and a burner in the Open, at the Wall, or in the Corner.
