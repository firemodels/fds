...
Figure~\ref{FAA_Cargo_probe_locations} displays the locations of the near-ceiling thermocouples in the Boeing~707 compartment. The TCs were positioned approximately 4~cm below the ceiling. The small numbered squared indicate the fire locations for Tests 1, 2 and 3. 
...
\put( 0.03,3.68){\framebox(0.10,0.10){\small 1}}
\put( 0.38,0.23){\framebox(0.10,0.10){\small 2}}
\put( 0.38,1.75){\framebox(0.10,0.10){\small 3}}
...
\put( 1.65,4.87){Off-Ceiling Beams (3)}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_1-4} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_5-8} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_9-12} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_13-16} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_17-20} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_21-24} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_25-28} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_29-32} 
\end{tabular*}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_33-36} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_1_37-40} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_1-4} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_5-8} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_9-12} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_13-16} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_17-20} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_21-24} 
\end{tabular*}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_25-28} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_29-32} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_33-36} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_2_37-40} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_1-4} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_5-8} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_9-12} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_13-16} 
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_17-20} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_21-24} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_25-28} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_29-32} \\
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_33-36} &
\includegraphics[height=2.2in]{FIGURES/FAA_Cargo_Compartments/FAA_Cargo_Compartments_Jet_Test_3_37-40} 
\end{tabular*}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Flat_Ceiling_Jet_Temperature} \\
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Sloped_Ceiling_Jet_Temperature}
\end{tabular}
\end{center}
...
using the smoke detector model.


\begin{figure}[!ht]
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Smoke_Detector_Activation_Time} \\
\vspace{0.25in}
\end{tabular}
\end{center}
...
Figure~\ref{NIST_Dunes_2000_Scatterplot_Temp_Rise} compares the measured versus predicted smoke detector activation times
using a heat detector/temperature rise approach. Heat detectors were placed in FDS at the same location as the smoke
detectors. The heat detectors were set with an RTI of 5~$\sqrt{\hbox{m}\cdot \hbox{s}}$ and an activation temperature of
\SI{10}{\celsius} above ambient temperature.


\begin{figure}[!ht]
\begin{center}
\begin{tabular}{c}
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Smoke_Detector_Activation_Time_Temp_Rise} \\
\vspace{0.25in}
\end{tabular}
\end{center}
