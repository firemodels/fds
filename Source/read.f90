...
NAMELIST /MISC/ AGGLOMERATION,AEROSOL_AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,&
                ...
                VEG_LEVEL_SET_COUPLED,VEG_LEVEL_SET_UNCOUPLED,VEG_LEVEL_SET_SURFACE_HEATFLUX,VEG_LEVEL_SET_THERMAL_ELEMENTS, &
                VEG_LEVEL_SET_BURNERS_FOR_FIRELINE,VERBOSE,VISIBILITY_FACTOR,VN_MAX,VN_MIN,Y_CO2_INFTY,Y_O2_INFTY,&
                WD_PROPS,WIND_ONLY
