...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: &
            ...
            MU,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN, &
            C_DYNSMAG,MTR,MU_DNS
 
   REAL(EB), POINTER, DIMENSION(:,:,:,:) :: YY,YYS,DEL_RHO_D_DEL_Y,MSR
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: RHODW,YY_F,EDGE_INTERPOLATION_FACTOR
   REAL(EB), POINTER, DIMENSION(:)   :: XW,YW,ZW,TW,AW,RAW,UW0,DUWDT,RDN, &
            QRADIN,QRADOUT,EW,KW,QCONF,AREA_ADJUST,RHO_F,RSUM_F, &
