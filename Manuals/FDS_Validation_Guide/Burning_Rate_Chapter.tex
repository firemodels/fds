...
The thermophysical data is based on several sources. Density, heat of vaporization, specific heat, and boiling temperature are found fron NIST Chemistry Webbook. The radiative fractions and soot yields are from DFPE Webbook.
...
Fuel     & $\rho$ \cite{Webbook:FluidThermo}  & $c_p$ \cite{Webbook:HeatCapacity}  & k \cite{CRCHAndbook} &  $\Delta h_v$  \cite{Webbook:FluidThermo} & $\chi_r$ \cite{Beyler2:SFPE} &  \cite{SFPE:Tewarson}  $Y_s$ \cite{SFPE:Tewarson} & $T_b$ \cite{Webbook:BoilingPoint} \\
\hline \hline 
Acetone &  792  &  2.13   & 0.20  &   501   & 0.27 & 0.014 & 56.3\\ \hline
Benzene &  876  &  1.74   & 0.14  &   393   & 0.35 & 0.181 & 80.3\\ \hline
Butane  &  584  &  2.28   & 0.124 &   361   & 0.30 & 0.029 & 0\\ \hline
Ethanol &  789  &  2.44   & 0.17  &   836   & 0.18 & 0.008 & 78.5\\ \hline
Heptane &  684  &  2.25   & 0.14  &   364   & 0.35 & 0.037 & 98.5\\ \hline
Methanol & 791  &  2.48   & 0.20  &   1,098 & 0.18 & 0.001 & 64.8\\ \hline
\end{tabular}
\end{center}
\end{table}
