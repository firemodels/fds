...
INTEGER  :: IW,IIG,JJG,KKG,IOR,ITMP,IHTMODEL=0
...
ELSE DNS_IF
   ...
   ELSE NO_GAS_CELL_IF
      ...
      SELECT CASE(ABS(IOR))
         CASE(0)
            ...
            IF (IHTMODEL==0) H_NATURAL = HCV*ABS(DELTA_TMP)**ONTH
         CASE(1)
            V2 = 0.25_EB*(VV(IIG,JJG,KKG)+VV(IIG,JJG-1,KKG))**2
            W2 = 0.25_EB*(WW(IIG,JJG,KKG)+WW(IIG,JJG,KKG-1))**2
            VELCON = (V2+W2)**0.4_EB
         ...
         CASE(3)
            ...
            V2 = 0.25_EB*(VV(IIG,JJG,KKG)+VV(IIG,JJG-1,KKG))**2
            VELCON = (U2+V2)**0.4_EB
            IF (IHTMODEL==0) H_NATURAL = HCH*ABS(DELTA_TMP)**ONTH
   ...
   H_DNS = MU_G*CP*RPR*2._EB*RDN(IW)
