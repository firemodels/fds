...
Pressure was measured at three elevations in each room of the ranch-style house. All pressure taps were installed within 0.3~m of a wall and were spaced through the elevation of the house at 0.3~m (1~ft), 1.2~m (4~ft), and 2.1~m (7~ft) from the ceiling. Pressure taps were installed within 0.3~m of a wall in nine locations in the colonial-style house. Pressure taps were located 0.3~m (1~ft), 2.4~m (8~ft), and 4.6~m (15~ft) from the ceiling in family room atrium (9PT), and 0.3~m (1~ft), 1.2~m (4~ft), and 2.1~m (7~ft) from the ceiling for all other rooms. The following plots compare the measured pressures with corresponding model predictions for the ranch-style and colonial-style houses.
...
\end{tabular*}
\caption{UL/NIJ Experiments, Pressure, Ranch-style House Test 1}
...
\end{tabular*}
\caption{UL/NIJ Experiments, Pressure, Ranch-style House Test 2}
...
\end{tabular*}
\caption{UL/NIJ Experiments, Pressure, Ranch-style House Test 5}
...
\end{tabular*}
\caption{UL/NIJ Experiments, Pressure, Colonial-style House Test 1}
...
\end{tabular*}
\caption{UL/NIJ Experiments, Pressure, Colonial-style House Test 4}
...
\includegraphics[height=2.15in]{SCRIPT_FIGURES/UL_NIJ_Houses/UL_NIJ_Two_Story_Gas_6_Pressure_8} \\
\includegraphics[height=2.15in]{SCRIPT_FIGURES/UL_NIJ_Houses/UL_NIJ_Two_Story_Gas_6_Pressure_9}
\end{tabular*}
\caption{UL/NIJ Experiments, Pressure, Colonial-style House Test 6}
