...
SUBROUTINE GETVERTS2(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,FACESTART,FACENUM,NFACES,VOLUME,FLAG,BOX_STATE,ERROR,ERR)
...
CALL GET_VERTS(BOX_BOUNDS_EB,V0_EB,V1_EB,V2_EB,V3_EB,VERTS_EB,NVERTS,FACESTART,FACENUM,NFACES,BOX_STATE)
...
DO K4 = 0, N-1
   ...
   CALL GETVERTS2(BOX_BOUNDS,V0,V1,V2,V3,VERTS,NVERTS,FACESTART,FACENUM,NFACES,VOLUME,FLAG,BOX_STATE,ERROR,ERR)
