...
PUBLIC :: INIT_TURB_ARRAYS, VARDEN_DYNSMAG, &
          ...
          WALE_VISCOSITY, TAU_WALL_IJ, RAYLEIGH_MASS_FLUX_MODEL, TEST_FILTER_LOCAL
...
DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   SELECT CASE(IOR)
      CASE( 1)
         P1%U_NORMAL_S = -U(II,JJ,KK)
      CASE(-1)
         P1%U_NORMAL_S =  U(II-1,JJ,KK)
      CASE( 2)
         P1%U_NORMAL_S = -V(II,JJ,KK)
      CASE(-2)
         P1%U_NORMAL_S =  V(II,JJ-1,KK)
      CASE( 3)
         P1%U_NORMAL_S = -W(II,JJ,KK)
      CASE(-3)
         P1%U_NORMAL_S =  W(II,JJ,KK-1)
   END SELECT
   P1%U_NORMAL = P1%U_NORMAL_S
ENDDO
