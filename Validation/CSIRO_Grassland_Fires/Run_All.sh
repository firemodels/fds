...
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_C064_fine.fds
$QFDS -p 144 -n 8 $DEBUG $QUEUE -d $INDIR Case_F19_fine.fds
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_C064_crude.fds
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_F19_crude.fds

$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_C064_BFM.fds
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_F19_BFM.fds
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_C064_BFM_fine.fds
$QFDS -p 144 -n 8 $DEBUG $QUEUE -d $INDIR Case_F19_BFM_fine.fds
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_C064_BFM_crude.fds
$QFDS -p 36 -n 6 $DEBUG $QUEUE -d $INDIR Case_F19_BFM_crude.fds
