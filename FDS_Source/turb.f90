...
DO K=0,KBP1
   U(:,:,K)   =               0.5_EB*MIXING_LAYER_U0*    TANH(2._EB*MESHES(NM)%ZC(K)/MIXING_LAYER_H0)
   RHO(:,:,K) = RHOA*(1._EB - 0.5_EB*MIXING_LAYER_THETA0*TANH(2._EB*MESHES(NM)%ZC(K)/MIXING_LAYER_H0))
ENDDO
