...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: &
            ...
            MU,MU_DNS,TMP,Q,Q_H_CORR,FRHO,KAPPA,CHI_R,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION,D_GEOMETRY, &
   ...
   REAL(EB) :: CFL,DIVMX,DIVMN,VN,RESMAX,PART_UVWMAX,Q_MAX
...
REAL(EB), POINTER :: CFL,DIVMX,DIVMN,VN,RESMAX,PART_UVWMAX,Q_MAX
