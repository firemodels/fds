...
OUTPUT_QUANTITY(78)%SHORT_NAME = 't_a'

OUTPUT_QUANTITY(79)%NAME = 'RESIDENCE TIME'
OUTPUT_QUANTITY(79)%UNITS = 's'
OUTPUT_QUANTITY(79)%SHORT_NAME = 't_r'
