...
REAL(EB) :: DEPTH,ORIENTATION(3),ROTATION,SETPOINT,FLOWRATE,BYPASS_FLOWRATE,DELAY,XYZ(3),CONVERSION_FACTOR,SMOOTHING_FACTOR,&
            OR_TEMP(3),QUANTITY_RANGE(2),STATISTICS_DT,CONVERSION_FACTOR_COORDINATES
...
READ_DEVC_LOOP: DO NN=1,N_DEVC_READ
   ...
   POINTS_LOOP: DO I_POINT=1,POINTS
      ...
      DV%COORD_FACTOR      = CONVERSION_FACTOR_COORDINATES
      DV%DEPTH             = DEPTH
      DV%IOR               = IOR
      DV%ID                = ID
...
CONVERSION_FACTOR_COORDINATES = 1._EB
DEPTH            = 0._EB
IOR              = 0
ID               = 'null'
