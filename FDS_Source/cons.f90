...
INTEGER, PARAMETER :: LUMPED_SPECIES=1,GAS_SPECIES=2,AEROSOL_SPECIES=3            ! For SPECIES%MODE
...
LOGICAL :: LES,DNS,RADIATION,CONVECTION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,SIMPLE_CHEMISTRY=.FALSE., &
           ...
           FDS6=.TRUE.,VIRTUAL_PARTICLES=.FALSE.,HVAC=.FALSE., &
           H_EDDY=.FALSE.,H_LOGLAW=.FALSE.,H_CHILTON_COLBURN=.FALSE.,BAROCLINIC=.FALSE., &
           VAN_DRIEST=.FALSE., &
           ...
           WFDS=.FALSE.,PATCH_VELOCITY=.FALSE.,OVERWRITE=.TRUE.,VREMAN_EDDY_VISCOSITY=.FALSE.,BUOYANCY_PRODUCTION=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            CHARACTERISTIC_VELOCITY,CFL_MAX,CFL_MIN,VN_MAX,VN_MIN,PR,SC,H_V_W,SMOKE_ALBEDO,GROUND_LEVEL=0._EB, &
...
REAL(EB) :: MW_FUEL,MW_AIR,MW_OTHER,MW_SOOT,HRRPUA_SHEET,RHO_SOOT,VISIBILITY_FACTOR, SOOT_H_FRACTION ,&
            EC_LL,BETA_EDC=1._EB,Y_P_MIN_EDC=0.0001_EB,HRRPUV_AVERAGE, &
...
INTEGER :: N_SPECIES=0,I_WATER,I_CO2,N_REACTIONS,I_FUEL,I_PROG_CO, I_PROG_F, I_PROG_SOOT, I_CO, I_O2,I_SOOT,I_Z_MIN,I_Z_MAX, &
           I_N2,I_H2,N_Y_ARRAY,N_KAPPA_ARRAY,N_MIX_SPECIES=0,N_REAC_SPECIES=0,N_GAS_SPECIES=0,N_LUMPED_SPECIES=0,I_BACKGROUND=0
REAL(EB) :: RSUM0
REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: Y2Y,Y2CP,Y2CPBAR,Y2D,Y2K,Y2MU
REAL(EB), ALLOCATABLE, DIMENSION(:) :: Y2Y_C,Y2CP_C,Y2CPBAR_C,Y2D_C,Y2K_C,Y2MU_C,MW_AVG_Y,Y_MF_SUM_Y,&
                                       Y2KAPPA_M4
REAL(EB) :: MW_AVG_C,Y_MF_SUM_C,MW_AVG_Y_C,Y_MF_SUM_Y_C
INTEGER, ALLOCATABLE, DIMENSION(:) :: KAPPA_INDEX,Y2SPEC
...
REAL(EB), ALLOCATABLE, DIMENSION(:) :: AAS,BBS,CCS,DDS,DDT,DX_S,RDX_S,RDXN_S,DX_WGT_S, &
                                       K_S,RHOCBAR,C_S,RHO_S,Q_S,KAPPA_S,X_S_NEW,R_S,MF_FRAC,YY_AMBIENT
