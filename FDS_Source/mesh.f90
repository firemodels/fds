...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: &
            ...
            CSD2_DYNSMAG,MTR,MSR,MU_DNS,WEM,MIX_TIME, &
            E,ES,ENTHALPY_SOURCE,ENTHALPY_SOURCE_LAGRANGIAN,Q_DISSIPATION
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: RHODW,ZZ_F,EDGE_INTERPOLATION_FACTOR,FW
...
ENTHALPY_SOURCE_LAGRANGIAN=>M%ENTHALPY_SOURCE_LAGRANGIAN
Q_DISSIPATION=>M%Q_DISSIPATION
KRES=>M%KRES
FVX=>M%FVX
FVY=>M%FVY
FVZ=>M%FVZ  
