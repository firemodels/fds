...
MESH_LOOP: DO NM=1,NMESHES
   ...
   DO N=1,M%N_OBST
      ...
      ELSE
         WRITE(LU_SMV,'(8I5,4F13.5)') OB%I1,OB%I2,OB%J1,OB%J2,OB%K1,OB%K2,OB%BCI,OB%BTI, REAL(OB%RGB,FB)/255._FB, OB%TRANSPARENCY
      ENDIF
   ENDDO
   ...
   DO N=1,M%N_VENT
      ...
      ELSE
         WRITE(LU_SMV,'(8I5,4F13.5)') VT%I1,VT%I2,VT%J1,VT%J2,VT%K1,VT%K2,INDX,VT%VTI, REAL(VT%RGB,FB)/255._FB,VT%TRANSPARENCY
      ENDIF
   ENDDO
   DO N=1,NDV
      INDX = 99
...
WRITE(MODULE_DATE,*) dumprev(INDEX(dumprev,':')+1:LEN_TRIM(dumprev)-2)
READ (MODULE_DATE,'(I5)') MODULE_REV
WRITE(MODULE_DATE,*) dumpdate
