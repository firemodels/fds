...
NAMELIST /MISC/ AGGLOMERATION,AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,&
                ...
                GRAVITATIONAL_SETTLING,GROUND_LEVEL,GVEC,H_F_REFERENCE_TEMPERATURE,HRRPUV_AVERAGE,HRRPUV_MAX_SMV,&
                HRRPUA_SHEET,HUMIDITY,IMMERSED_BOUNDARY_METHOD,INITIAL_UNMIXED_FRACTION,ISOTROPIC_PARTICLE_FORCE,&
...
HRRPUV_AVERAGE       = 1.E20_EB ! 2500._EB     ! kW/m^3
...
COUNT_SPEC_LOOP: DO
   ...
   IF (REFERENCE_ENTHALPY > -2.E23_EB .AND. (SPECIFIC_HEAT < 0._EB .AND. RAMP_CP=='null')) THEN
...
NAMELIST /REAC/ A,ALT_REAC_ID,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                ...
                HRRPUA_SHEET,HRRPUV_AVERAGE,ID,IDEAL,N,NU,N_S,N_T,O,ODE_SOLVER,RAMP_FS,REAC_ATOM_ERROR,&
