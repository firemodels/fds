...
IF (LPC%LIQUID_DROPLET) THEN
   CALL INTERPOLATE1D_UNIFORM(LBOUND(SPECIES(LPC%Y_INDEX)%C_P_L_BAR,1),SPECIES(LPC%Y_INDEX)%C_P_L_BAR,TMP_S,GET_PARTICLE_ENTHALPY)
!ELSE - Will add solid particles once basic mechanism is working
ENDIF
