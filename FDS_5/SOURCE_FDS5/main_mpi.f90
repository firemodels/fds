...
IF (REVISION_NUMBER < 100) THEN
   WRITE(VERSION_STRING,'(A,I2)') '5_RC8_',REVISION_NUMBER
ELSEIF (REVISION_NUMBER >=100 .AND. REVISION_NUMBER <1000) THEN
   WRITE(VERSION_STRING,'(A,I3)') '5_RC8_',REVISION_NUMBER
ELSEIF (REVISION_NUMBER >=1000 .AND. REVISION_NUMBER <10000) THEN
   WRITE(VERSION_STRING,'(A,I4)') '5_RC8_',REVISION_NUMBER
ELSE
   WRITE(VERSION_STRING,'(A,I5)') '5_RC8_',REVISION_NUMBER
ENDIF

VERSION_NUMBER = 5.0PARALLEL       = .TRUE.
