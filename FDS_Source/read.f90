   ...
   K_MULT_LOOP: DO KK=MR%K_LOWER,MR%K_UPPER
      J_MULT_LOOP: DO JJ=MR%J_LOWER,MR%J_UPPER
         I_MULT_LOOP: DO II=MR%I_LOWER,MR%I_UPPER
            ...
            IF (M%MESH_LEVEL>0) MESH_REFINEMENT=.TRUE.
...
CHARACTER(LABEL_LENGTH) :: ASSUMED_GAS_TEMPERATURE_RAMP,EXTINCTION_MODEL,RAMP_GX,RAMP_GY,RAMP_GZ,RAMP_U0,RAMP_V0,RAMP_W0,&
                           TURBULENCE_MODEL
...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,ASSUMED_GAS_TEMPERATURE_RAMP,&
                ...
                OVERWRITE,PERIODIC_TEST,POROUS_FLOOR,PR,PROJECTION,P_INF,RAMP_GX,RAMP_GY,RAMP_GZ,RAMP_U0,RAMP_V0,RAMP_W0,&
