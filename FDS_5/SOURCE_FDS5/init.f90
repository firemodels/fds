...
M%D_CORR = 0._EB
M%DS_CORR = 0._EB
ALLOCATE(M%FVX_AVG(M%NEWC),STAT=IZERO)
CALL ChkMemErr('INIT','FVX_AVG',IZERO) 
ALLOCATE(M%FVY_AVG(M%NEWC),STAT=IZERO)
CALL ChkMemErr('INIT','FVY_AVG',IZERO) 
ALLOCATE(M%FVZ_AVG(M%NEWC),STAT=IZERO)
CALL ChkMemErr('INIT','FVZ_AVG',IZERO) 
