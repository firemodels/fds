...
TYPE DROPLET_TYPE
   REAL(EB) :: X,Y,Z,TMP,U,V,W,R,PWT,A_X,A_Y,A_Z,T,RE=0._EB, &
               ...
               VEG_IGN_TOFF,VEG_IGN_TRAMPON,VEG_IGN_TRAMPOFF
   LOGICAL  :: IGNITOR
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT,TMP_INNER,VEL,PLE,Z0,CONVECTIVE_HEAT_FLUX, NET_HEAT_FLUX, &
               ...
               TMP_IGN,H_V,REGRID_FACTOR,LAYER_DIVIDE,ROUGHNESS,RADIUS=-1._EB,LENGTH=-1._EB,WIDTH=-1._EB,DT_INSERT
...
TYPE OBSTRUCTION_TYPE
   ...
   INTEGER :: I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,COLOR_INDICATOR=-1,TYPE_INDICATOR=-1,ORDINAL=0,DEVC_INDEX=-1,CTRL_INDEX=-1,PROP_INDEX=-1
