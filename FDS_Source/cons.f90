...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION, KAPPA_ARRAY=.FALSE.,&
         ...
         STATUS_FILES,DEBUG,SYNCHRONIZE,TIMING,LOCK_TIME_STEP=.FALSE.,RESTRICT_TIME_STEP=.TRUE.,  &
         ...
         CONSTANT_PROPERTIES=.FALSE.,DYNSMAG=.FALSE.,EMBEDDED_MESH=.FALSE.,SPATIAL_GRAVITY_VARIATION=.FALSE.
...
REAL(EB) :: MW_AIR,MW_OTHER,MW_SOOT,HRRPUA_SHEET=200._EB,RHO_SOOT,VISIBILITY_FACTOR, &
            MASS_EXTINCTION_COEFFICIENT,EC_LL,C_EDC=0.10_EB,HRRPUV_AVERAGE=3000._EB,HRRPUV_AVERAGE_TIME=1._EB
INTEGER :: N_SPECIES=0,I_WATER,I_CO2,N_REACTIONS,I_FUEL,I_PROG_CO, I_PROG_F, I_CO, I_O2,I_SOOT,I_Z_MIN,I_Z_MAX, &
           I_N2,I_H2,N_Y_ARRAY,N_KAPPA_ARRAY
REAL(EB) :: RSUM0
