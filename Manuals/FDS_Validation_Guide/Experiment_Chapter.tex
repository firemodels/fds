...
single-story manufactured home. The primary partitioning of the 84.7~m$^2$ floor plan consisted of three bedrooms:
...
in a central location. Five stations (Station A through Station E) containing smoke alarm arrays were mounted parallel to the ceiling.
Note that, in the FDS Guides, smoke detectors and smoke alarms are collectively referred to as
smoke detectors because the same smoke detection algorithm is used to predict activation of
