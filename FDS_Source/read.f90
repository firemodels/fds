...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_DROPLETS,ALLOW_UNDERSIDE_DROPLETS,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                C_FORCED_CYLINDER,C_FORCED_SPHERE,C_HORIZONTAL,C_VERTICAL,DEBUG_OPENMP,DNS,DYNSMAG,ENTHALPY_TRANSPORT,&
                EVACUATION_DRILL,EVACUATION_MC_MODE,EVAC_PRESSURE_ITERATIONS,EVAC_TIME_ITERATIONS,FLUX_LIMITER,FORCE_VECTOR,&
                FREEZE_VELOCITY,FYI,GAMMA,GROUND_LEVEL,GVEC,HRRPUVCUT_MAX,HRRPUV_MAX_SMV,IMMERSED_BOUNDARY_METHOD,LAPSE_RATE,&
                LES,LIMITING_DT_RATIO,MAXIMUM_VISIBILITY,MEAN_FORCING,NEW_COMBUSTION,NEW_EVAP,NOISE,NO_EVACUATION,NSTRATA,&
                ...
                TURBULENT_DEPOSITION,U0,UVW_FILE,V0,VEG_LEVEL_SET,VISIBILITY_FACTOR,VN_MAX,VN_MIN,W0,WFDS,WIND_ONLY
...
NAMELIST /SPEC/ ABSORBING,BACKGROUND,CONDUCTIVITY,DENSITY_LIQUID,DIFFUSIVITY,EPSILONKLJ,FIC_CONCENTRATION,FLD_LETHAL_DOSE,&
                FORMULA,FYI,HEAT_OF_VAPORIZATION,HUMIDITY,H_V_REFERENCE_TEMPERATURE,ID,MASS_EXTINCTION_COEFFICIENT,&
                MASS_FRACTION_0,MELTING_TEMPERATURE,MW,RAMP_CP,RAMP_CP_L,RAMP_D,RAMP_K,RAMP_MU,REFERENCE_ENTHALPY,&
...
NAMELIST /DEVC/ BYPASS_FLOWRATE,CONVERSION_FACTOR,CTRL_ID,DELAY,DEPTH,DEVC_ID,DRY,DUCT_ID,EVACUATION,FLOWRATE,FYI,&
                ...
                RELATIVE,ROTATION,SETPOINT,SPEC_ID,STATISTICS,SURF_ID,TIME_AVERAGED,TRIP_DIRECTION,UNITS,VELO_INDEX,VIRTUAL_INDEX,&
                XB,XYZ,X_ID,Y_ID,Z_ID
