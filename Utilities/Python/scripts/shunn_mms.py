...
if L2_rho<1.99:
    disp(['Matlab Warning: L2_rho = ',L2_rho,' in Shunn 3 MMS temporal order'])
...
if FavreZ_error_64 > 0.01:
   print('Matlab Warning: FavreZ in shunn3_FavreZ_64 is out of tolerance. Error = ',FavreZ_error_64)
