...
yf0 = [0.7247698; 0.0551642; 0.220066; 0.0; 0.0];  % initial mass fraction
...
filename1 = '../../Verification/Species/EDC_Methane_1Step_Species.csv';
...
filename1 = '../../Verification/Species/EDC_Methane_1Step_TempPres.csv';
fid = fopen(filename1,'wt');
fprintf(fid,'%s, %s, %s\n',header1{:});
for j=1:length(tss)
    fprintf(fid,'%f, %f, %f\n',tss(j),Tf(j),dP(j));
