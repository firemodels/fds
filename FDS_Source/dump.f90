...
DO K=1,KBAR
   DO J=1,JBAR
      DO I=1,IBAR
         ...
         Q_DOT(6,NM) = Q_DOT(6,NM) + 0.5_EB*(D_PBAR_S_DT(PRESSURE_ZONE(I,J,K))+D_PBAR_DT(PRESSURE_ZONE(I,J,K)))*VC
...
WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   Q_DOT(4,NM) = Q_DOT(4,NM) - WC%QCONF*WC%AW
...
IF (N_REACTIONS > 0) THEN
   WALL_LOOP2: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS+N_VIRTUAL_WALL_CELLS
      ...
      M_DOT(1,NM) = M_DOT(1,NM) + WC%MASSFLUX_ACTUAL(REACTION(1)%FUEL_SMIX_INDEX)*WC%AW*WC%AREA_ADJUST
   ENDDO WALL_LOOP2
ENDIF
