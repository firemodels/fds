...
The results of the LEMTA Spray Cooling experiment is shown in Fig.~\ref{LEMTA_Spray_Cooling_Fig}.

\begin{figure}[h!]
\centering
\includegraphics[height=2.15in]{SCRIPT_FIGURES/LEMTA_Spray/LEMTA_Spray_Cooling_SU42_Horizontal} 
\caption[LEMTA Spray Cooling steel plate temperature]{Temperature of the bottom of a heated steel plate cooled with a water spray.}
