...
\hline
\end{tabular}
\footnotetext{The absorption coefficient for methanol is calculated assuming that the incoming radiation is blackbody radiation at temperature 1450K. Since methanol flames are usually non-sooty, this assumption does not hold. The correct absorption coefficient to use in pool fire calculations is likely to be closer tot the absorption coefficient of ethanol. }
\label{tbl_abscoeff}
\end{table}
