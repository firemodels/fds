...
WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   DO N=1,N_TRACKED_SPECIES
      ...
      ELSE
         ...
         !WC%RHODW(N) = RHOP(IIG,JJG,KKG)*D_Z(ITMP,N)
   ...
   METHOD_OF_HEAT_TRANSFER: SELECT CASE(SF%THERMAL_BC_INDEX)
      ...
      CASE (INFLOW_OUTFLOW) METHOD_OF_HEAT_TRANSFER 
         ...
         IF (INFLOW) THEN
            ...
            ENDIF
            WC%TMP_F = TMP_EXTERIOR
            WC%HEAT_TRANS_COEF = 0._EB
            IF (N_TRACKED_SPECIES>0) WC%ZZ_F(1:N_TRACKED_SPECIES)=ZZ_EXTERIOR(1:N_TRACKED_SPECIES)
         ELSE
            WC%TMP_F  = TMP(IIG,JJG,KKG)
      ...
      NEW_EVAP_IF: IF (NEW_EVAP) THEN
         ...
         MATERIAL_LOOP2B: DO N=1,SF%N_MATL
            ...
            ELSE
               ...
               RE_L     = MAX(5.E5_EB,RHO_G*VELCON/(WC%RDN*MU_AIR))
               SHERWOOD = SH_FAC_WALL*RE_L**0.8_EB
               H_MASS = SHERWOOD*MU_AIR/SC*WC%RDN*2._EB
            ENDIF
