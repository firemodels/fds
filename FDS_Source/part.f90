...
REAL(EB) :: R_DROP,NUSSELT,K_AIR,H_V,H_V_REF, H_L,&
            ...
            MOMENTUM_SINK_FACTOR,XI,YJ,ZK,UBAR,VBAR,WBAR,QREL
...
!$OMP        REACTION,N_REACTIONS,TMP_BOIL,TMP_MELT,I_BOIL,I_MELT,KINETIC_ENERGY_SOURCE,Q_DOT,CALC_D_LAGRANGIAN, &
