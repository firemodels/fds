...
REAL(EB) :: VEG_LSET_IGNITE_TIME,VEG_LSET_QCON,VEG_LSET_ROS_HEAD,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK, &
            VEG_LSET_WIND_EXP,VEG_LSET_BETA,VEG_LSET_HT,VEG_LSET_SIGMA,VEG_LSET_ROS,VEG_LSET_SURF_LOAD,VEG_LSET_FIREBASE_TIME, &
...
NAMELIST /SURF/ ADIABATIC,BACKING,BURN_AWAY,BURN_DURATION,CELL_SIZE_FACTOR,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   IF (ANY(MOISTURE_FRACTION>0._EB) .OR. ANY(PACKING_RATIO>0._EB) .OR. ANY(SURFACE_VOLUME_RATIO>0._EB)) THEN
      ...
      IF (ANY(PACKING_RATIO>0._EB)) CONVECTION_LENGTH_SCALE = 4._EB/SURFACE_VOLUME_RATIO(1)
   ...
   SF%VEG_LSET_SURF_LOAD    = VEG_LSET_SURF_LOAD !kg/m^2 dry fuel load
   SF%VEG_LSET_FIREBASE_TIME= VEG_LSET_FIREBASE_TIME !s, veg top-to-bottom burntime
...
VEG_LSET_SURF_LOAD      = 0.3_EB
VEG_LSET_FIREBASE_TIME  = 75600._EB/VEG_LSET_SIGMA 
