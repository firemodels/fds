...
REAL (EB) FUNCTION WATER_VAPOR_MASS_FRACTION(HUMIDITY,TEMP)
...
H_V = 3.12479E+06_EB - MAX(MIN(TEMP,373.15_EB),273.15_EB)*2.31985E+03_EB ! J/kg, linear fit of JANAF table
X_SAT  = MIN(1._EB,EXP(H_V*MW_H2O/R0*(1._EB/373.15_EB-1._EB/ MIN(TEMP,373.15_EB))))
...
REAL (EB) FUNCTION RELATIVE_HUMIDITY(Y_H2O,TEMP)

! Compute the relative humidity given the water vapor mass fraction and temperature

REAL (EB), INTENT(IN) :: TEMP,Y_H2O
REAL (EB) :: H_V,X_SAT,MW,X_H2O
