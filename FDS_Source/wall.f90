      ...
      METHOD_OF_HEAT_TRANSFER: SELECT CASE(SF%THERMAL_BC_INDEX)
         ...
         CASE(SPECIFIED_TEMPERATURE)
            ...
            HTC = HEAT_TRANSFER_COEFFICIENT(DTMP,SF%H_FIXED,SF%GEOMETRY,SF%CONV_LENGTH,SF%HEAT_TRANSFER_MODEL,SF%ROUGHNESS,&
                                            FC%SURF_INDEX,FACE_INDEX=N,CUTCELL_INDEX=IC)
         ...
         CASE(THERMALLY_THICK) ! under construction
            ...
            TMP_F = (SF%TMP_BACK + SF%THICKNESS*HTC/ML%K_S*TMP_G)/(1._EB + SF%THICKNESS*HTC/ML%K_S)
...
REAL(EB) :: DUMMY,DTMP,QDXKF,QDXKB,RR,TMP_G,RFACF,RFACB,RFACF2,RFACB2, &
            ...
            MW_G,H_MASS,X_G,Y_G,X_W,D_AIR,MU_AIR,U2,V2,W2,RE_L,SC_AIR,SH_FAC_WALL,SHERWOOD,VELCON,RHO_G,TMP_BACK,TMP_WGT,RDN
