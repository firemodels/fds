...
However, for the purposes of inputting into FDS, since M is neither a product nor a species it would not be specifed in the chemical reaction using either {\ct REACTION} or {\ct NU}.  It would be given a rate exponent using {\ct N\_S} to indicate that its presence is required.
