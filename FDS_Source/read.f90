...
INTEGER :: N,I_DUM
NAMELIST /DUMP/ RENDER_FILE,SMOKE3D,SMOKE3D_QUANTITY,FLUSH_FILE_BUFFERS,MASS_FILE,STATE_FILE, &
...
REAL(EB) :: Y_F_INLET, &
            ...
            FUEL_HEAT_OF_FORMATION,MAXIMUM_VISIBILITY,MW_FUEL,AUTO_IGNITION_TEMPERATURE
NAMELIST /REAC/ E,BOF,HEAT_OF_COMBUSTION,FYI,FUEL,OXIDIZER,EPUMO2,ID, N_S,&
                ...
                CHECK_CHEMICAL_TIME_SCALE,TAU_CHEM,TAU_FLAME,AUTO_IGNITION_TEMPERATURE
...
NAMELIST /MATL/ ID,FYI,SPECIFIC_HEAT,CONDUCTIVITY,CONDUCTIVITY_RAMP,SPECIFIC_HEAT_RAMP, &
                ...
                ABSORPTION_COEFFICIENT,BOILING_TEMPERATURE,INITIAL_VAPOR_FLUX,PCR
...
NAMELIST /PRES/ VELOCITY_TOLERANCE,MAX_PRESSURE_ITERATIONS,PRESSIT_RELAX_FACTOR,PRESSIT_ACCELERATOR,PRESSIT_SCALE_FACTOR, &
                PREDICTOR_RELAX_FACTOR,CORRECTOR_RELAX_FACTOR, &
