...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           GRAVITATIONAL_DEPOSITION_CEILING=.TRUE.,GRAVITATIONAL_DEPOSITION=.TRUE., &
           THERMOPHORETIC_DEPOSITION=.TRUE.,TURBULENT_DEPOSITION=.TRUE.,DRIFT_FLUX=.TRUE., &
           VELOCITY_ERROR_FILE=.FALSE.,&
           CONSTANT_SPECIFIC_HEAT=.FALSE.,NEW_EVAP_DROP=.FALSE.,NEW_CP_WHILE=.FALSE., &
           MEAN_FORCING(3)=.FALSE.,CHECK_HT=.FALSE., &
           PATCH_VELOCITY=.FALSE.,OVERWRITE=.TRUE., &
           INIT_HRRPUV = .FALSE.,WFDS_BNDRYFUEL=.FALSE., &
           TENSOR_DIFFUSIVITY=.FALSE.,&
           UVW_RESTART=.FALSE.,CUTCELL_DATA_FILE=.FALSE.,SECOND_ORDER_PARTICLE_TRANSPORT=.FALSE.,&
           RESEARCH_MODE=.FALSE.,EVAPORATION_DRAG=.FALSE.,KINETIC_ENERGY_SOURCE=.FALSE.,INCOMPRESSIBLE=.FALSE.,&
           COMPUTE_VISCOSITY_TWICE=.TRUE.,PARTICLE_CFL=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            Y_WERNER_WENGLE=11.81_EB,PARTICLE_CFL_MAX=1.0_EB
