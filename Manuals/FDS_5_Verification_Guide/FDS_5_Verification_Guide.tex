...
\subsection{Gas Injection as an Isentropic Process (\texorpdfstring{{\bf isentropic}}{isentropic})}
...
\multicolumn{2}{c}{\includegraphics[width=3.2in]{FIGURES/isentropic_temperature} } 
\end{tabular*}
\caption[The isentropic case.]{Density, pressure and temperature rise due to the injection of nitrogen into a sealed compartment.}
\label{isentropic}
\end{figure}
