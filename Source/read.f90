...
IF (AUTO_IGNITION_TEMPERATURE > -(TMPM+TWO_EPSILON_EB)) THEN
   AUTO_IGNITION_TEMPERATURE = AUTO_IGNITION_TEMPERATURE + TMPM
ELSE
   AUTO_IGNITION_TEMPERATURE = 0._EB
ENDIF
...
NAMELIST /INIT/ BULK_DENSITY_FILE,CELL_CENTERED,CROWN_BASE_HEIGHT,CROWN_BASE_WIDTH,CTRL_ID,DB,DENSITY,DEVC_ID,&
                ...
                N_PARTICLES_PER_CELL,PART_ID,PARTICLE_WEIGHT_FACTOR,PATH_RAMP,RADIATIVE_FRACTION,&
