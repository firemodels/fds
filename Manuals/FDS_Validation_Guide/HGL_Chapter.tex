...
\end{tabular*}
\caption[NIST/NRC Corner Effects experiments, HGL temperature and height, corner experiments]
...
\end{tabular*}
\caption[NIST/NRC Corner Effects experiments, HGL temperature and height, wall experiments]
...
\end{tabular*}
\caption[NIST/NRC Corner Effects experiments, HGL temperature and height, cabinet experiments 1-3]
{NIST/NRC Corner Effects experiments, HGL temperature and height, cabinet experiments 1-3.}
...
\end{tabular*}
\caption[NIST/NRC Corner Effects experiments, HGL temperature and height, cabinet experiments 4-6]
{NIST/NRC Corner Effects experiments, HGL temperature and height, cabinet experiments 4-6.}
