...
INTEGER, PARAMETER :: ATMOSPHERIC_PROFILE=1, PARABOLIC_PROFILE=2, ONED_PARABOLIC_PROFILE=3, &
                      RAMP_PROFILE=4                                                        ! Surface velocity profile
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            C_SMAGORINSKY=0.2_EB,C_DEARDORFF=0.1_EB,C_VREMAN=0.07_EB,C_RNG=0.2_EB, &
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,TURB_MODEL=0,SLIP_CONDITION=2,FISHPAK_BC(3)=-1
...
INTEGER :: N_GEOM=0,N_VERT=0,N_FACE=0,N_VOLU=0
