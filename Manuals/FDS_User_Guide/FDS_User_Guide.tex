...
%{\ct PERIODIC\_X}                        & Logical         & Section~\ref{not yet documented}        &           & {\ct .FALSE.} \\ \hline
%{\ct PERIODIC\_Y}                        & Logical         & Section~\ref{not yet documented}        &           & {\ct .FALSE.} \\ \hline
%{\ct PERIODIC\_Z}                        & Logical         & Section~\ref{not yet documented}        &           & {\ct .FALSE.} \\ \hline
