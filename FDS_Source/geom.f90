...
INTEGER :: N_VERTS, N_FACES, N_ZVALS
INTEGER :: SURF_INDEX
...
NAMELIST /GEOM/ AZIM, AZIM_DOT, COMPONENT_ONLY, DAZIM, DELEV, DSCALE, DXYZ0, DXYZ, &
                ...
                N_LEVELS, SCALE, SCALE_DOT, SPHERE_ORIGIN, SPHERE_RADIUS, SURF_ID, &
                TEXTURE_MAPPING, TEXTURE_ORIGIN, TEXTURE_SCALE, &
                VERTS, XB, XYZ0, XYZ, XYZ_DOT, ZVALS
...
READ_GEOM_LOOP: DO N=1,N_GEOMETRY
   ...
   ! setup a general object (FACES and VERTS keywords)
   
   GEOM_TYPE = 0
   READ(LU_INPUT,GEOM,END=35)
   
   ! check for general object (FACES and VERTS keywords)
...
!    I11   I21      
 ...
 ! make IJK(1), IJK(2), IJK(3) consistent with grid resolution (if not specified on &GEOM line)
  ...
  ! remove duplicate vertices
   ...
   CALL REMOVE_DUP_VERTS(N_VERTS,N_FACES,MAX_VERTS,MAX_FACES,VERTS,FACES)
...
SUBROUTINE REMOVE_DUP_VERTS(N_VERTS,N_FACES,MAX_VERTS,MAX_FACES,SPHERE_VERTS,SPHERE_FACES)
...
INTEGER, DIMENSION(:), INTENT(OUT) :: FACES(3*N_FACES), SURF_IDS(N_FACES)
