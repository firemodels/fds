...
To allow a hole to be controlled with either the {\ct CTRL} or {\ct DEVC} namelist groups, you will need to add the {\ct CTRL\_ID} or {\ct DEVC\_ID} parameter respectively, to the {\ct HOLE} line.\index{HOLE!CTRL\_ID} \index{HOLE!DEVC\_ID}
...
To allow a vent to be controlled with the {\ct CTRL} namelist, you will need to add the {\ct CTRL\_ID} parameter to the {\ct VENT} line.\index{VENT!CTRL\_ID}
...
\end{tabular*}
\end{table}
%NAMELIST /MESH/ POISSON_BC,IBAR2,JBAR2,KBAR2
