...
A chair, mattress, or pan of cooking oil was used as the fire source in each test.
...
Smouldering and cooking ignition sources are not considered. Groups of smoke alarms were
located in the room of fire origin, at least one bedroom, and in a central location. Smoke alarm
arrays were mounted parallel to the ceiling.

\begin{sidewaysfigure}[p]
\begin{center}
\includegraphics[height=3.0in]{FIGURES/NIST_Dunes_2000/NIST_Dunes_2000_Drawing}
\end{center}
