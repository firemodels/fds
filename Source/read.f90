...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            REFERENCE_CONE_THICKNESS,&
            REFERENCE_CONE_EXPOSURE(MAX_CONE_CURVES),REFERENCE_THICKNESS(MAX_CONE_CURVES),&
...
NAMELIST /SURF/ ADIABATIC,AREA_MULTIPLIER,BACKING,BLOWING,BURN_AWAY,BURN_DURATION,&
                ...
                REFERENCE_HEAT_FLUX,REFERENCE_HEAT_FLUX_TIME_INTERVAL,MINIMUM_SCALING_HEAT_FLUX,MAXIMUM_SCALING_HEAT_FLUX,&
                REFERENCE_CONE_THICKNESS,&
                REFERENCE_CONE_EXPOSURE,REFERENCE_THICKNESS,&
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   SF%REFERENCE_CONE_THICKNESS          = REFERENCE_CONE_THICKNESS
   ...
   ALLOCATE(SF%REFERENCE_CONE_EXPOSURE(MAX_CONE_CURVES))
   SF%REFERENCE_CONE_EXPOSURE = REFERENCE_CONE_EXPOSURE*1000._EB
   ALLOCATE(SF%REFERENCE_THICKNESS(MAX_CONE_CURVES))
   SF%REFERENCE_THICKNESS = REFERENCE_THICKNESS
   COUNT_CONE_CURVES: DO NL=1,MAX_CONE_CURVES
      IF (REFERENCE_CONE_EXPOSURE(NL) < 0._EB) EXIT COUNT_CONE_CURVES
      SF%N_CONE_CURVES = SF%N_CONE_CURVES + 1
      SF%REFERENCE_CONE_EXPOSURE(NL) = REFERENCE_CONE_EXPOSURE(NL)*1000._EB
      SF%REFERENCE_THICKNESS(NL) = REFERENCE_THICKNESS(NL)
   ENDDO COUNT_CONE_CURVES
...
REFERENCE_CONE_THICKNESS = -1._EB
