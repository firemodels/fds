...
TYPE PROPERTY_TYPE
   ...
   INTEGER  :: PDPA_M=0,PDPA_N=0,N_SMOKEVIEW_PARAMETERS=0,STATE_INDEX=0,N_INSERT
   ...
   CHARACTER(30) :: SMOKEVIEW_ID,PART_ID,ID,QUANTITY,TABLE_ID,SPEC_ID='null',SMOKEVIEW_PARAMETERS(12)='null'
   CHARACTER(60) :: TEXTURE_MAP='null'
...
TYPE DEVICE_TYPE
   ...
   INTEGER  :: DUCT_INDEX=-1,NODE_INDEX=-1
