...
\noindent
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=3.2in]{SCRIPT_FIGURES/droplet_absorption_cart_surf_cart} &
\includegraphics[width=3.2in]{SCRIPT_FIGURES/droplet_absorption_cart_surf_cyl}\\
\includegraphics[width=3.2in]{SCRIPT_FIGURES/droplet_absorption_cart_surf_sph}
\end{tabular*}
