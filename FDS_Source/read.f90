...
USE GLOBAL_CONSTANTS, ONLY: LU_INPUT,N_VERT
REAL(EB) :: X(3)=0._EB
INTEGER :: I
NAMELIST /VERT/ X
...
USE GLOBAL_CONSTANTS, ONLY: LU_INPUT,N_FACE
USE COMPLEX_GEOMETRY, ONLY: INIT_FACE
INTEGER :: N(3),I
...
USE GLOBAL_CONSTANTS, ONLY: LU_INPUT,N_VOLU
INTEGER :: N(4),I
