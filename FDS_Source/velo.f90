...
!$    SHARED(N_TRACKED_SPECIES,EVACUATION_ONLY,KBAR,JBAR,IBAR,SOLID,CELL_INDEX,ZZP,MU,TMP,STORE_MU_DNS,MU_DNS, &
!$           LES,NM,CSMAG,TWO_D,DX,DY,DZ,USE_MAX_FILTER_WIDTH,RDX,RDY,RDZ,UU,VV,WW,DYNSMAG,RHOP,CSD2_DYNSMAG, &
...
!$    PRIVATE(IW,II,JJ,KK,IIG,JJG,KKG,MU_WALL)
