...
The FSE experiments were selected to assess CO production capability in under-ventilated compartment fires over a range of fuels types and fire sizes in a full-scale ISO 9705 enclosure. This study included more than 20 experiments that featured 7 different fuels: heptane, natural gas, nylon, propylene, isopropanol, styrene, and toluene. Peak heat release rates ranged from approximately 100~kW to 2~MW. Compartment ventilation was varied from a full 80~cm door opening to 40~cm, 20~cm, and 10~cm openings. While the fuel sources in the experiments were either pool fires or spray burners, the model used a mass flux boundary condition based on the experimentally calculated heat release rates found from oxygen consumption calorimetry. The measured values are from the test series performed by Lock et al.~\cite{Lock:1}.

\subsubsection{Fuels Not Pre-defined in FDS}
...
%\begin{figure}[p]
%\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG1_Carbon_Dioxide} &
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG1_Carbon_Monoxide} \\
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG1_Oxygen} &
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG1_Temperature} \\
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG1_HRR}
%\end{tabular*}
%\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Natural Gas.}
%\label{NIST_FSE_1994_ISONG1}
%\end{figure}

%\begin{figure}[p]
%\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG2_Carbon_Dioxide} &
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG2_Carbon_Monoxide} \\
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG2_Oxygen} &
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG2_Temperature} \\
%\includegraphics[height=2.2in]{SCRIPT_FIGURES/NIST_FSE_2008/ISONG2_HRR}
%\end{tabular*}
%\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Natural Gas.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Heptane.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Nylon.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Propylene.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Propanol.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Styrene.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Toluene.}
...
\end{tabular*}
\caption[Summary of species concentrations, temperature, and HRR in NIST FSE experiments]{Summary of species concentrations, temperature, and HRR in NIST FSE experiments for Proponal.}
