...
INTEGER :: N_GEOMETRY=0, GEOMETRY_CHANGE_STATE=0, N_TRAN=0
TYPE(GEOMETRY_TYPE), ALLOCATABLE, TARGET, DIMENSION(:) :: GEOMETRY, GEOMETRY_TRANSFORM
...
TYPE SLICE_TYPE
   INTEGER :: I1,I2,J1,J2,K1,K2,IOR=0,GEOM_INDEX=-1,TRAN_INDEX=-1,INDEX,INDEX2=0,Z_INDEX=-999,Y_INDEX=-999,MATL_INDEX=-999,&
   ...
   CHARACTER(LABEL_LENGTH) :: SMOKEVIEW_BAR_LABEL,ID='null',MATL_ID='null',TRAN_ID='null'
END TYPE SLICE_TYPE
