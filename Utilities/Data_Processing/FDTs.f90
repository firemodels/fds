...
REAL :: ACTIVATION_TEMPERATURE,ALPHA,AREA,A_T,A_V,CHI_R,CONDUIT_DIAMETER,CONDUIT_THICKNESS,CUTOFF_TIME, C_S,D, &
        DELTA,DT,H,H_K,H_V,JACKET_THICKNESS,K_S,L,L_F,LEAK_AREA,MASS_PER_LENGTH,M_DOT,P,Q,Q_STAR,Q_STEP,R, &
        RADIATIVE_FRACTION,RHO_S,RTI,SCALING_FACTOR,T,t_activation,T_END,TMP_A,TMP_G,T_P,T_CLOCK,U_JET,V, &
        V_DOT,W,W_V
