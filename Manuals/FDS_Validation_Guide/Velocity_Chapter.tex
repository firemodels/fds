...
Bi-directional probes were positioned inside two of the four inlet openings and three of the four outlet openings. Inlet probes 1-3 were positioned in the opening just south of the centerline, and the probes 6-8 were positioned in the opening adjacent to the south wall of the compartment.

\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_velo_1-3} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_velo_1-3} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_velo_1-3} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_velo_1-3} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_velo_1-3} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_velo_1-3} 
\end{tabular*}
\label{WTC_velo_1-3}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_velo_6-8} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_velo_6-8} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_velo_6-8} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_velo_6-8} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_velo_6-8} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_velo_6-8} 
\end{tabular*}
\label{WTC_velo_6-8}
\end{figure}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_velo_out_1-5} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_velo_out_1-5} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_velo_out_1-5} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_velo_out_1-5} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_velo_out_1-5} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_velo_out_1-5} 
\end{tabular*}
...
\begin{figure}[p]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_velo_out_6-10} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_velo_out_6-10} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_velo_out_6-10} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_velo_out_6-10} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_velo_out_6-10} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_velo_out_6-10} 
\end{tabular*}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=4.0in]{FIGURES/ScatterPlots/Velocity}
\end{tabular}
\end{center}
