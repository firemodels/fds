...
REAL(EB) RECURSIVE FUNCTION GAS_PHASE_OUTPUT(T,DT,NM,II,JJ,KK,IND,Y_INDEX,Z_INDEX,ELEM_INDX,PART_INDEX,VELO_INDEX,PIPE_INDEX,&
                                             PROP_INDEX,REAC_INDEX,ICC_IN,JCC_IN) RESULT(GAS_PHASE_OUTPUT_RES)
...
INTEGER, INTENT(IN), OPTIONAL :: Y_INDEX,Z_INDEX,ELEM_INDX,PART_INDEX,VELO_INDEX,PIPE_INDEX,PROP_INDEX,REAC_INDEX,ICC_IN,JCC_IN
...
IND_SELECT: SELECT CASE(IND)
   ...
   CASE(114) ! BI-DIRECTIONAL PROBE
      ...
      IF (PY%TC) THEN
         PROBE_TMP = GAS_PHASE_OUTPUT(T,DT,NM,II,JJ,KK,110,PROP_INDEX=PROP_INDEX) + TMPM
      ELSE
