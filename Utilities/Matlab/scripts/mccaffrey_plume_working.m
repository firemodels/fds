...
chid = {'McCaffrey_14_kW_11_line','McCaffrey_22_kW_11_line','McCaffrey_33_kW_11_line','McCaffrey_45_kW_11_line','McCaffrey_57_kW_11_line'};
...
for i=1:n_chid
    ...
    if i==1
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_14_kW_11_line.csv',',',2);
    end 
    if i==2
        M = importdata('../../../Validation/McCaffrey_Plume/Test2/McCaffrey_22_kW_11_line.csv',',',2);
    end
    if i==3
