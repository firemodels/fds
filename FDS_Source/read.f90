...
REAL(EB) :: MW,SIGMALJ,EPSILONKLJ,VISCOSITY,CONDUCTIVITY,DIFFUSIVITY,MASS_EXTINCTION_COEFFICIENT, &
            ...
            H_V_REFERENCE_TEMPERATURE,H_F,MEAN_DIAMETER,CONDUCTIVITY_SOLID,DENSITY_SOLID
...
NAMELIST /SPEC/ ABSORBING,AEROSOL,BACKGROUND,CONDUCTIVITY,CONDUCTIVITY_SOLID,DENSITY_LIQUID,DENSITY_SOLID,DIFFUSIVITY,EPSILONKLJ,&
                ...
                FORMULA,FYI,HEAT_OF_VAPORIZATION,HUMIDITY,H_F,H_V_REFERENCE_TEMPERATURE,ID,MASS_EXTINCTION_COEFFICIENT,&
