...
\begin{figure}[h]
      ...
      \put(-330,-10){(a)}
      \put(-110,-10){(b)}
      \caption[Flux limited interpolation]{Flux limited interpolation: (a)  Regular and cut-cell species densities are available for 4 point stencil fluc limited interpolation to face $RC$.  (b) Lower cell in stencil is within solid region (cell S), therefore inner cell value $\rho Y_2$ is used for this extreme point.}
