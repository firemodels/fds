...
SOLID_PHASE_SELECT: SELECT CASE(INDX)
   ...
   CASE(13) ! GAUGE HEAT FLUX
      ...
      SOLID_PHASE_OUTPUT = (ONE_D%QRADIN/(PY%GAUGE_EMISSIVITY+1.0E-10_EB) - SIGMA*PY%GAUGE_TEMPERATURE**4 + &
   ...
   CASE(22) ! RADIOMETER
      SOLID_PHASE_OUTPUT = ( ONE_D%QRADIN/(PY%GAUGE_EMISSIVITY+1.0E-10_EB) - SIGMA*PY%GAUGE_TEMPERATURE**4 )*0.001_EB
