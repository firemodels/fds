...
REAL(EB) ::ZZ_GET(1:N_TRACKED_SPECIES), MU_Z,K_Z,CP_ZN,H_Z,MAX_CELL_ASPECT_RATIO
...
IF (.NOT.SUPPRESS_DIAGNOSTICS) THEN
   ...
   MESH_LOOP: DO NM=1,NMESHES
      ...
      MAX_CELL_ASPECT_RATIO=MAX(MAX_CELL_ASPECT_RATIO,M%MAX_ASPECT_RATIO)
   ENDDO MESH_LOOP
   WRITE(LU_OUTPUT,'(/A,I9/)'  ) ' Total Number of Grid Cells     ',CELL_COUNT
   WRITE(LU_OUTPUT,'(/A,F9.3)')  ' Maximum Cell Aspect Ratio      ',MAX_CELL_ASPECT_RATIO
