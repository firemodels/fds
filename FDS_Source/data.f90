...
INTEGER, PARAMETER :: N_OUTPUT_QUANTITIES=450,N_Q_DOT=9,N_M_DOT=2
...
OUTPUT_QUANTITY(99)%NAME = 'EQUILIBRIUM VAPOR FRACTION'
OUTPUT_QUANTITY(99)%UNITS = 'kg/kg'
OUTPUT_QUANTITY(99)%SHORT_NAME = 'Y_EQ'

OUTPUT_QUANTITY(90:99)%SPEC_ID_REQUIRED = .TRUE.
...
OUTPUT_QUANTITY(-17)%NAME = 'VOLUME FLOW WALL'
OUTPUT_QUANTITY(-17)%UNITS= 'm^3/s'
OUTPUT_QUANTITY(-17)%SHORT_NAME = 'vflow_wall'
OUTPUT_QUANTITY(-17)%INTEGRATED = .TRUE.

OUTPUT_QUANTITY(-18)%NAME = 'MASS FLOW WALL'
OUTPUT_QUANTITY(-18)%UNITS= 'kg/s'
OUTPUT_QUANTITY(-18)%SHORT_NAME = 'mflow_wall'
OUTPUT_QUANTITY(-18)%INTEGRATED = .TRUE.

OUTPUT_QUANTITY(-19)%NAME = 'HEAT FLOW WALL'
OUTPUT_QUANTITY(-19)%UNITS= 'kW'
OUTPUT_QUANTITY(-19)%SHORT_NAME = 'hflow_wall'
OUTPUT_QUANTITY(-19)%INTEGRATED = .TRUE.
