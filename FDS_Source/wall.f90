...
CASE (SPECIFIED_TEMPERATURE) METHOD_OF_HEAT_TRANSFER
   ...
   ELSE
      ONE_D%HEAT_TRANS_COEF = HEAT_TRANSFER_COEFFICIENT(DTMP,SF%H_FIXED,SF%GEOMETRY,SF%CONV_LENGTH,PARTICLE_INDEX=PARTICLE_INDEX)
   ENDIF
...
REAL(EB) :: RE,U2,V2,W2,H_NATURAL,H_FORCED,NUSSELT
...
! Get velocities, cell indices, etc.
...
INTEGER, INTENT(IN) :: NM
REAL(EB), PARAMETER :: CS=1.147_EB,CT=2.2_EB,CM=1.146_EB,MFP25=0.065E-6_EB,A1=1.257_EB,A2=0.4_EB,A32=1.1_EB,CHI_D=1._EB
...
REAL(EB) :: U_THERM,U_TURB,TGAS,TWALL,MUGAS,Y_AEROSOL,RHOG,ZZ_GET(0:N_TRACKED_SPECIES),YDEP,K_AIR,TMP_FILM,KN,ALPHA,DTMPDX,&
            KN_EXP,TAU_PLUS,SF,DN,U_TAU,TAU_PLUS_C,VEL_W,U2,V2,W2,U_GRAV,MASS_P
...
SMIX_LOOP: DO N=1,N_TRACKED_SPECIES
   ...
   U_TURB=0._EB 
   U_GRAV=0._EB
   IF (GRAVITATIONAL_DEPOSITION) MASS_P = 0.125_EB*FOTHPI*SM%MEAN_DIAMETER**2*SM%DENSITY_SOLID
