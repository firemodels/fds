...
Solve for $z_{int}$:
\be 
   z_{int} = \frac{ T_l(I_1 \, I_2 - H^2)}{I_1+I_2 \, T_l^2 - 2\, T_l \, H} 
\ee
...
\be 
   (H-z_{int})\; T_u = \int_{z_{int}}^H \; T(z) \; dz 
\ee
...
\includegraphics[height=2.2in]{FIGURES/VTT/VTT_02_HGL_Temp} &
\includegraphics[height=2.2in]{FIGURES/VTT/VTT_02_HGL_Height} \\
\includegraphics[height=2.2in]{FIGURES/VTT/VTT_03_HGL_Temp} &
\includegraphics[height=2.2in]{FIGURES/VTT/VTT_03_HGL_Height}
\end{tabular*}
\end{figure}
...
\includegraphics[height=2.2in]{FIGURES/NIST_NRC/NIST_NRC_17_HGL_Height} \\ [1.in]
...
\includegraphics[height=2.2in]{FIGURES/FM_SNL/FM_SNL_05_HGL_Height} \\
\includegraphics[height=2.2in]{FIGURES/FM_SNL/FM_SNL_06_HGL_Temp} &
...
\includegraphics[height=2.2in]{FIGURES/FM_SNL/FM_SNL_09_HGL_Height} \\
\includegraphics[height=2.2in]{FIGURES/FM_SNL/FM_SNL_10_HGL_Temp} &
...
This series of experiments consisted of two relatively small rooms connected by a long corridor. The fire was located in one of the rooms.  Eight vertical arrays of thermocouples were positioned throughout the test space: one in the burn room, one near the door of the burn room, three in the corridor, one in the exit to the outside at the far end of the corridor, one near the door of the other or ``target'' room, and one inside the target room.  Four of the eight arrays have been selected for comparison with model prediction: the array in the burn room (BR), the array in the middle of the corridor (18~ft from the BR), the array at the far end of the corridor (38~ft from the BR), and the array in the target room (TR).  In Tests 100A and 100O, the target room was closed, in which case the array in the exit (EXI) doorway was used. The test director reduced the layer information individually for the eight thermocouple arrays using an alternative method. These results were included in the original data sets. However, in this report the selected TC trees were reduced using the conventional method common to all the experiments considered. 
...
\includegraphics[height=2.2in]{FIGURES/NBS/NBS_100Z_Tree_8_HGL_Temp} &
\includegraphics[height=2.2in]{FIGURES/NBS/NBS_100Z_Tree_8_HGL_Height}
\end{tabular*}
\end{figure}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=3.5in]{FIGURES/ScatterPlots/HGL_Temperature_Natural_Ventilation} \\
\includegraphics[width=3.5in]{FIGURES/ScatterPlots/HGL_Temperature_Forced_Ventilation}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=3.5in]{FIGURES/ScatterPlots/HGL_Temperature_No_Ventilation} \\
\includegraphics[width=3.5in]{FIGURES/ScatterPlots/HGL_Depth}
\end{tabular}
\end{center}
