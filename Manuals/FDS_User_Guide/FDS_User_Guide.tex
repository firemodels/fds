...
\end{center}
\caption[Cartesian particle splitted in two]{Splitting in z-direction for a Cartesian particle.}
\label{cart_split}
\end{figure}
...
\end{center}
\caption[Cylindrical particle splitted in two]{Splitting in y- and z-directions for a cylindrical particle.}
\label{cyl_split}
\end{figure}
...
\end{center}
\caption[Spherical particle splitted in two]{Splitting in x-, y- and z-directions for a spherical particle.}
\label{sphere_split}
\end{figure}
