...
In this experiment, the attenuation of thermal radiation was measured at five heights in water sprays produced by seven full-elliptic type hydraulic nozzles. 
...
\begin{figure}[h!]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[width=2.8in]{FIGURES/LEMTA_Spray/LEMTA_Spray_1} &
\includegraphics[width=2.8in]{FIGURES/LEMTA_Spray/LEMTA_Spray_2} \\
\includegraphics[width=2.8in]{FIGURES/LEMTA_Spray/LEMTA_Spray_3} &
\includegraphics[width=2.8in]{FIGURES/LEMTA_Spray/LEMTA_Spray_4} \\
\includegraphics[width=2.8in]{FIGURES/LEMTA_Spray/LEMTA_Spray_5} &
\end{tabular*}
\label{LEMTA_Spray}
\end{figure}
