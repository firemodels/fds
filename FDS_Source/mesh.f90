...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: &
            ...
            CSD2,CHEM_SUBIT,MIX_TIME,STRAIN_RATE,D_Z_MAX,UNMIXED_FRACTION
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   U,V,W,US,VS,WS,DDDT,D,DS,H,HS,KRES,FVX,FVY,FVZ,RHO,RHOS, &
   MU,MU_DNS,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION,D_GEOMETRY, &
   CSD2,MTR,MSR,WEM,MIX_TIME,CHEM_SUBIT,STRAIN_RATE,D_Z_MAX,UNMIXED_FRACTION
...
MIX_TIME=>M%MIX_TIME
UNMIXED_FRACTION=>M%UNMIXED_FRACTION
Q=>M%Q
QR=>M%QR
QR_W=>M%QR_W
KAPPA=>M%KAPPA 
