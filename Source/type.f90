...
TYPE ONE_D_M_AND_E_XFER_TYPE
   REAL(EB), POINTER, DIMENSION(:) :: TMP,LAYER_THICKNESS,X,MASSFLUX_ACTUAL,MASSFLUX,IL
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=19,N_WALL_SCALAR_INTEGERS=16,N_WALL_SCALAR_LOGICALS=0
...
TYPE IBM_CUTFACE_TYPE
   ...
   INTEGER,  ALLOCATABLE, DIMENSION(:)             :: CFACE_INDEX
END TYPE IBM_CUTFACE_TYPE

! Note: If you change the number of scalar variables in CFACE_TYPE, adjust the numbers below

INTEGER, PARAMETER :: N_CFACE_SCALAR_REALS=6,N_CFACE_SCALAR_INTEGERS=3,N_CFACE_SCALAR_LOGICALS=0

TYPE CFACE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: ZZ_F
   REAL(EB), POINTER :: AREA,RHO_F,TMP_F,X,Y,Z
   INTEGER, POINTER :: CFACE_INDEX,SURF_INDEX,BOUNDARY_TYPE
END TYPE CFACE_TYPE
