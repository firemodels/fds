...
\be
  \frac{F}{F_0} = W \left[ 1 + \frac{\RE}{16} \frac{1}{\left( L / D - 1 \right)^2} \exp \left( - \frac{\RE}{16} \frac{1}{\left( L / D - 1 \right)^{}} \right) \right] \label{eq:dragredfact}
\ee
...
\be
  W = 1 - \frac{C_{\rm d,0}}{2} \left[ 1 - \exp \left( - \frac{\RE}{16} \frac{1}{\left( L / D - 1  \right)} \right) \right] \label{eq:Wake-Vel}
\ee
