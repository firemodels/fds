...
DO IW=1,M%N_EXTERNAL_WALL_CELLS+M%N_INTERNAL_WALL_CELLS
   ...
   ENDIF
   IF (WC%SURF_INDEX_ORIG>0) THEN
      SURFACE(WC%SURF_INDEX_ORIG)%N_WALL_STORAGE_INTEGERS = SF%N_WALL_STORAGE_INTEGERS
      SURFACE(WC%SURF_INDEX_ORIG)%N_WALL_STORAGE_REALS    = SF%N_WALL_STORAGE_REALS
      SURFACE(WC%SURF_INDEX_ORIG)%N_WALL_STORAGE_LOGICALS = SF%N_WALL_STORAGE_LOGICALS
   ENDIF
ENDDO
