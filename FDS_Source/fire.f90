...
INTEGRATION_LOOP: DO TIME_ITER = 1,TIME_ITER_MAX
   RK2_IF: IF (COMBUSTION_ODE /= EDC_RK2) THEN ! Explicit Euler
      ...
      REACTION_LOOP1: DO NR = 1, N_REACTIONS
         RN => REACTION(NR)
         CALL COMPUTE_RATE_CONSTANT_EDC(NR,RATE_CONSTANT(NR),ZZ_0,I,J,K,DT_SUB,ITER,TMP_0)
      ...
      RICH_EX_LOOP: DO RICH_ITER =1,RICH_ITER_MAX
         ...
         ODE_LOOP1: DO NS = 1, SUB_DT1
            ...
            REACTION_LOOP1_2: DO NR = 1, N_REACTIONS
               RN => REACTION(NR)
               CALL COMPUTE_RATE_CONSTANT_EDC(NR,RATE_CONSTANT2(NR),A1,I,J,K,DT_SUB,ITER,TMP_0)
         ...
         ODE_LOOP2: DO NS = 1, SUB_DT2
            ...
            REACTION_LOOP2_2: DO NR = 1, N_REACTIONS
               RN => REACTION(NR)
               CALL COMPUTE_RATE_CONSTANT_EDC(NR,RATE_CONSTANT2(NR),A2,I,J,K,DT_SUB,ITER,TMP_0)
               DZZDT = RN%NU*SPECIES_MIXTURE%MW/SPECIES_MIXTURE(RN%FUEL_SMIX_INDEX)%MW*RATE_CONSTANT2(NR)
         ...
         ODE_LOOP4: DO NS = 1, SUB_DT4
            ...
            REACTION_LOOP4_2: DO NR = 1, N_REACTIONS
               RN => REACTION(NR)
               CALL COMPUTE_RATE_CONSTANT_EDC(NR,RATE_CONSTANT2(NR),A4,I,J,K,DT_SUB,ITER,TMP_0)
               DZZDT = RN%NU*SPECIES_MIXTURE%MW/SPECIES_MIXTURE(RN%FUEL_SMIX_INDEX)%MW*RATE_CONSTANT2(NR)
   ...
   IF (COMBUSTION_ODE /= EDC_RK2) THEN
      ZZ_MIXED = A1
   ELSE   
...
RECURSIVE SUBROUTINE COMPUTE_RATE_CONSTANT_EDC(NR,RATE_CONSTANT,ZZ_MIXED_IN,I,J,K,DT_SUB,ITER,TMP_0)
...
END SUBROUTINE COMPUTE_RATE_CONSTANT_EDC
