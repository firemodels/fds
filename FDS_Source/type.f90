...
TYPE WALL_TYPE
   ...
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,RAW,RDN,RHO_F,U_TAU,UVW_GHOST,UW0,XW,Y_PLUS,YW,ZW,VEG_HEIGHT,VEL_ERR_NEW
...
TYPE REACTION_TYPE
   ...
   INTEGER :: A_RAMP_INDEX=0,E_RAMP_INDEX=0,FUEL_SMIX_INDEX=-1,MODE,N_SMIX,N_SPEC
   LOGICAL :: IDEAL,CHECK_ATOM_BALANCE,EDCM,REVERSIBLE=.FALSE.,FAST_CHEMISTRY=.FALSE.
