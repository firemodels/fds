...
INTEGER :: I,N,PDPA_M,PDPA_N,STATE_INDEX,DROPLETS_PER_SECOND
...
NAMELIST /PROP/ ACTIVATION_OBSCURATION,ACTIVATION_TEMPERATURE,ALPHA_C,ALPHA_E,BETA_C,BETA_E, &
                ...
                CONDUIT_DIAMETER,CONDUIT_THICKNESS,CABLE_MASS_PER_LENGTH,CABLE_DIAMETER, &
                CABLE_JACKET_THICKNESS,CABLE_FAILURE_TEMPERATURE, &
                C_FACTOR,CHARACTERISTIC_VELOCITY,DROPLETS_PER_SECOND,DT_INSERT,ORIFICE_DIAMETER,STATE_INDEX, &
...
CHARACTER(30) :: PART_ID,SHAPE
TYPE(INITIALIZATION_TYPE), POINTER :: IN
NAMELIST /INIT/ XB,TEMPERATURE,DENSITY,MASS_FRACTION,MASS_PER_TIME,MASS_PER_VOLUME,NUMBER_INITIAL_DROPLETS,PART_ID,SHAPE,DT_INSERT
