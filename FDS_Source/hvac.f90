...
NAMELIST /HVAC/ AMBIENT,AREA,CTRL_ID,DAMPER,DEVC_ID,DIAMETER,DUCT_ID,FAN_ID,ID,LENGTH,LOSS,MAX_FLOW,MAX_PRESSURE,NODE_ID,REVERSE, &
                RAMP_ID,ROUGHNESS,TAU_FAN,TAU_VF,TYPE_ID,VENT_ID,VOLUME_FLOW,XYZ !,FILTER_ID,AIRCOIL_ID,ROUND, SQUARE,TABLE_ID,&
