...
SF%N_ONE_D_STORAGE_REALS    = N_ONE_D_SCALAR_REALS    + SUM(SF%ONE_D_REALS_ARRAY_SIZE(1:18))
...
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),ONE_D%Q_IN_SMOOTH,UNPACK_IT)
