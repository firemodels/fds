...
DATA_LOOP: DO DATAFLAG=1,2
   ...
   CALL SMOKE3DTOFILE(TRIM(FN_SMOKE3D(DATAFLAG,NM))//CHAR(0),STIME,DXX,EXTCOEF,DATAFLAG,QQ_PACK,IBP1,JBP1,KBP1)
   DEALLOCATE(QQ_PACK)
...
SELECT CASE(IND)
   ...
   CASE(21)  ! Relative humidity
      ...
      IF (MIXTURE_FRACTION) THEN
         ...
         CALL GET_MASS_FRACTION2(Z_1,Z_2,Z_3,H2O_INDEX,Y_SUM(II,JJ,KK),Y_MF_INT)
      END IF
