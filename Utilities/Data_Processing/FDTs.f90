...
REAL :: ACTIVATION_TEMPERATURE,A_C,ALPHA,AREA,A_T,A_V,C_I,CHI_R,CONDUIT_DIAMETER,CONDUIT_THICKNESS,CUTOFF_TIME,C_PL,C_CJ, &
        C_S,C_STEEL,D,DELTA,DELTA_T_C,DT,EPSILON,F_V,H,H_C,H_K,H_V,JACKET_THICKNESS,K_I,K_S,L,L_F,LEAK_AREA,MASS_PER_LENGTH, &
        M_DOT,P,Q,Q_STAR,Q_STEP,R,RADIATIVE_FRACTION,RHO_AIR,RHO_I,RHO_S,RHO_STEEL,RTI,SCALING_FACTOR,T,t_activation,T_END,T_P, &
        TMP_A,TMP_G,T_CLOCK,U_JET,V,V_DOT,W,W_D,W_V
...
LOGICAL :: PROFILE=.FALSE.,ITER=.TRUE.,TIME_OUTPUT=.FALSE.,FLIP_AXIS=.FALSE.,STEEL_UNPROTECTED=.FALSE., &
           STEEL_PROTECTED=.FALSE., T_SQUARED=.FALSE.
INTEGER :: I,IOS
...
NAMELIST /MQH/ C_S,DELTA,H,H_V,K_S,L,M_DOT,OUTPUT_FILE,PROFILE,Q,RHO_S,T_END,TMP_A,W,W_V, &
               STEEL_UNPROTECTED,STEEL_PROTECTED,F_V,RHO_STEEL,C_STEEL,H_C,EPSILON,K_I,H,W_D,C_I,RHO_I
NAMELIST /BEYLER/ C_S,DELTA,H,K_S,L,OUTPUT_FILE,Q,RHO_S,T_END,TMP_A,W
NAMELIST /RAD/ AREA,CHI_R,OUTPUT_FILE,Q,X,Z,IOR,Z_LABEL,TIME_OUTPUT,FLIP_AXIS
...
NAMELIST /ALPERT/ Q,SCALING_FACTOR,T_END,R_VALUES,H_VALUES,LABEL,TMP_A,OUTPUT_FILE,T_SQUARED,ALPHA
NAMELIST /SPRINKLER/ ALPHA,CUTOFF_TIME,RTI,ACTIVATION_TEMPERATURE,H,R,TMP_A,SCALING_FACTOR,OUTPUT_FILE
...
NAMELIST /MILKE/ ALPHA,CUTOFF_TIME,DELTA_T_C,H,RADIATIVE_FRACTION,OUTPUT_FILE
