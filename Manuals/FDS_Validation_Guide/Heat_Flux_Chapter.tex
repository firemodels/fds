...
A summary of these experiments and modeling is found in Section~\ref{Loughborough_Jet_Fires_Description}.

Figures~\ref{Loughborough_1} through \ref{Loughborough_3} compare measured and predicted heat fluxes to a 0.9~m steel pipe engulfed in a natural gas jet fire. Figure~\ref{Loughborough_Rad} displays heat fluxes in the far-field.
