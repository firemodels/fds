...
\begin{figure}[h!]
   ...
   \end{picture}
   \caption{Vector field of a two-dimensional vortex in a constant flow field.}
...
\begin{figure}[t]
   ...
   \end{tabular*}
   \caption{\label{fig_cbc_smv} Initial and final states of velocity magnitude for the isotropic turbulence field.}
\end{figure}
...
\begin{figure}[h]
   ...
   \end{tabular*}
   \caption{(Left) Comparison of theoretical and numerical results for the Blasius velocity profile ($u$ component). (Right) Error between FDS and Blasius solution for $u(z)$ plotted for each grid resolution.}
   \label{blasius}
\end{figure}
...
\begin{center}
   ...
   \caption{Verification of FDS $y^+$ output for $\delta z=[1/8, 1/16, 1/32]$.}
   \label{fig_yplus}
\end{center}
\end{figure}
...
\caption{\label{fig_solid_energy} Outputs of temperature [left] and pressure [right] for the energy\_budget\_solid case.  Circles represent the correct result.}
\end{figure}
...
\end{tabular}
\end{center}
\caption[Soot mass concentration for soot\_gravitational\_settling case]{Time evolution of soot mass concentration for the soot gravitational settling case.}
...
\begin{table}[ht]
\begin{center}
\caption{Parameters used to test the shrinking and swelling materials.}
\label{shrink_swell}
