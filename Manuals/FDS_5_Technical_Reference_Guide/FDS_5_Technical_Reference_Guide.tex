...
decompose the pressure term $\cH=\cH^0 + \cH'$. Solve
\be \nabla^2 {\cal H}^0 = -\nabla \cdot \bF - \dod{}{t} (\nabla \cdot \bu) \ee
...
\be \frac{d\dot{V}}{dt}  = -\int_{x=x_{\max}} \overline{F}_x \, dy \, dz
...
\be  \frac{d\dot{V}}{dt} =
    - \int_{x=x_{\max}} \left( F_{x,I,jk,m}  + \frac{\cH^0_{I+1,jk,m}-\cH^0_{I,jk,m}}{\dx} \right) \; dy \, dz -
