...
ENTHALPY_IF: IF (ENTHALPY_TRANSPORT) THEN
   ...
   !$OMP DO PRIVATE(IW,II,JJ,KK,IOR,IBC,IIG,JJG,KKG,ZZZ,UN,ZZ_GET,CP,TMP_F,E_F)
...
CASE(.TRUE.) PREDICTOR_STEP
   ...
   !$OMP        TMPMIN,TMPMAX,ENTHALPY_TRANSPORT,E,ES,ENTHALPY_SOURCE)
...
CASE(.FALSE.) PREDICTOR_STEP
   ...
   !$OMP        TMPMIN,TMPMAX,E,ES,ENTHALPY_TRANSPORT,ENTHALPY_SOURCE)
