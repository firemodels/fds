...
EXTERNCPP void get_vdevice_vel(float time, vdevice *devicei, float *vel, unsigned char *valid_vel);
EXTERNCPP float get_device_val(float time, device *devicei, unsigned char *valid);
