...
{\ct MISC}    & {\ct CO\_PRODUCTION}                &              & Eliminated                                  & Section~\ref{info:finite}                \\ \hline
...
{\ct PART}    & {\ct FUEL}                          &              &  Eliminated                                 & Section~\ref{info:fuel_droplets}         \\ \hline
...
{\ct PROP}    & {\ct CABLE\_DIAMETER}               &              & Eliminated                                  & Section~\ref{info:THIEF}      \\ \hline
{\ct PROP}    & {\ct CABLE\_FAILURE\_TEMPERATURE}   &              & Eliminated                                  & Section~\ref{info:THIEF}      \\ \hline
{\ct PROP}    & {\ct CABLE\_JACKET\_THICKNESS}      &              & Eliminated                                  & Section~\ref{info:THIEF}      \\ \hline
{\ct PROP}    & {\ct CABLE\_MASS\_PER\_LENGTH}      &              & Eliminated                                  & Section~\ref{info:THIEF}      \\ \hline
{\ct PROP}    & {\ct CONDUIT\_DIAMETER}             &              & Eliminated                                  & Section~\ref{info:THIEF}      \\ \hline
{\ct PROP}    & {\ct CONDUIT\_THICKNESS}            &              & Eliminated                                  & Section~\ref{info:THIEF}      \\ \hline
