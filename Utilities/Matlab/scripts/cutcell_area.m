...
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '1    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_01_image}   &',   tri_area(1), '&  3     &', cut_area(1), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '2    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_02_image}   &',   tri_area(2), '&  3     &', cut_area(2), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '3    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_03_image}   &',   tri_area(3), '&  3     &', cut_area(3), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '4    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_04_image}   &',   tri_area(4), '&  3     &', cut_area(4), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s\n','\end{tabular}');
fprintf(fid,'%s\n','\end{center}');
fprintf(fid,'%s\n','\end{table}');
fprintf(fid,'\n');
...
fprintf(fid,'%s\n','\begin{tabular}{|c|c|c|c|c|}\hline');
fprintf(fid,'%s\n','Case number  &  Illustration  &  Triangle Area  &  NXP  &  Cutting Area  \\ \hline');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '5    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_05_image}   &',   tri_area(5), '&  1     &', cut_area(5), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '6    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_06_image}   &',   tri_area(6), '&  3     &', cut_area(6), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '7    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_07_image}   &',   tri_area(7), '&  3     &', cut_area(7), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s %s %6.4f %s %6.4f %s\n', '8    &',  '\includegraphics[totalheight=2.in]{SCRIPT_FIGURES/tri_cube_cut_cell_test_08_image}   &',   tri_area(8), '&  3     &', cut_area(8), '\\ \noalign{\smallskip}\hline\noalign{\smallskip}');
fprintf(fid,'%s\n','\end{tabular}');
fprintf(fid,'%s\n','\end{center}');
fprintf(fid,'%s\n','\end{table}');
fprintf(fid,'\n');
