...
IF (ANY(REACTION(:)%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_0,DT_LOC,RHO_HAT,TMP_MIXED,INFINITELY_FAST,Q_REAC_OUT,SUB_IT)
   ZZ_NEW = ZZ_0 + DZZ
   ZZ_0 = ZZ_NEW
...
SUBROUTINE REACTION_RATE(DZZ,ZZ_0,DT_SUB,RHO_0,TMP_0,KINETICS,Q_REAC_OUT,SUB_IT)
