...
\end{equation}
is considered for both a fuel-limiting and oxygen-limiting case with a fixed mixing time, $\tau_{mix}=0.1$~s (Figure \ref{fig:EDM_1Step}).

\begin{figure}[ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{SCRIPT_FIGURES/ReactionRate_EDM_Flim_1Step} &
\includegraphics[width=3.2in]{SCRIPT_FIGURES/ReactionRate_EDM_O2lim_1Step}
\end{tabular*}
