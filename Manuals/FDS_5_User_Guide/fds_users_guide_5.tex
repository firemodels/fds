...
FDS / Smokeview (fds-sv) project page \index{SourceForge.net} hosted at:
...
({\ct TWFIN=0} on the {\ct TIME} line) or a short-time job to test the operation of
{\ct T\_CREATE} and/or {\ct T\_REMOVE}.
...
{\ct DEVC\_NAME}  & Character         & {\ct ID} of {\ct DEViCe} to control hole's existence         &       &           \\ \hline
{\ct CTRL\_NAME}  & Character         & {\ct ID} of {\ct ConTRoL} to control hole's existence         &       &           \\ \hline
{\ct RGB(3)   }     & Real Triplet      & Color indices for obstruction(s) to be cut    &       &           \\ \hline %Bryan What is this?
...
{\ct BNDF\_BLOCK}         & Logical             & Draw Boundary Info                    &    & {\ct .TRUE.}  \\ \hline
{\ct DEVC\_CREATE }       & Character           & {\ct ID} of Controlling {\ct DEViCe}  &    &               \\ \hline
{\ct DEVC\_REMOVE }       & Character           & {\ct ID} of Controlling {\ct DEViCe}  &    &               \\ \hline
...
{\ct RGB(3)}              & Real Triplet        & Color indices                         &    &               \\ \hline
...
{\ct T\_CREATE}           & Real                & Time to Create Obstruction            & s  &               \\ \hline
{\ct T\_REMOVE}           & Real                & Time to Remove Obstruction            & s  &               \\ \hline
...
{\ct RGB(3)}                            & Real Triplet  & Color indices for surface         &                     & \small 255,204,102      \\ \hline
