...
SF%WALL_REALS_ARRAY_SIZE(8) = SF%NVEG_L                     ! VEG_CHARMASS_L
SF%WALL_REALS_ARRAY_SIZE(9) = SF%NVEG_L                     ! VEG_ASHMASS_L
...
WC%VEG_LSET_SURFACE_HEATFLUX => OS%REALS(12,STORAGE_INDEX) ; IF (NEW) WC%VEG_LSET_SURFACE_HEATFLUX = 0._EB
...
I1 = I2+1 ; I2 = I1 + SF%WALL_REALS_ARRAY_SIZE(8) - 1  ; WC%VEG_CHARMASS_L(1:I2-I1+1)  => OS%REALS(I1:I2,STORAGE_INDEX)
I1 = I2+1 ; I2 = I1 + SF%WALL_REALS_ARRAY_SIZE(9) - 1  ; WC%VEG_ASHMASS_L(1:I2-I1+1)   => OS%REALS(I1:I2,STORAGE_INDEX)
