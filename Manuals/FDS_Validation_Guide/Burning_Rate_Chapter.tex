...
\begin{eqnarray}
   \hbox{Polymer}       &\to& \hbox{Intermediate} + \hbox{Gas}  \label{reac1of2} \\
   \hbox{Intermediate}  &\to& \hbox{Char} + \hbox{Gas} \label{reac2of2}
\end{eqnarray}
The properties of the polymer and the reaction kinetics are listed in Table~\ref{Properties_Kydex} and the mass loss rate comparisons are shown on the following page.

\begin{table}[!h]
\caption[Properties of Kydex]{Properties of Kydex~\cite{Li:Thesis}.}
\centering
\begin{tabular}{|l|c|c|}
\hline
...
\begin{eqnarray}
   ...
   \hbox{Melt}          &\to& \hbox{Intermediate} + \hbox{Gas}  \label{reac2of3} \\
   \hbox{Intermediate}  &\to& \hbox{Char} + \hbox{Gas} \label{reac3of3}
\end{eqnarray}
...
\begin{table}[!h]
\caption[Properties of PEI, PET, and POM]{Properties of PEI, PET, and POM~\cite{Li:Thesis}.}
\centering
...
Polymer Spec.~Heat                       & kJ/kg/K       & $-0.04+0.00410  \, T$   & $-0.28+0.00465  \, T$   & $-1.86+0.0099  \, T$     \\ \hline
...
Int.~Cond.                               & W/m/K         & $0.45+0.00019 \, T$     & $0.47+0.00014  \, T$    & $0.19-0.00006 \, T$      \\ \hline
Int.~Spec.~Heat                          & kJ/kg/K       & $1.59+0.00031  \, T$    & $1.43-0.00005  \, T$    & Same as Melt             \\ \hline
