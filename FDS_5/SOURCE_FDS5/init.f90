...
IF (FLUX_LIMITER>=0) THEN
   ALLOCATE(M%SCALAR_WORK1(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
   CALL ChkMemErr('INIT','SCALAR_WORK1',IZERO)
   IF (N_SPECIES>0) THEN
      ALLOCATE(M%SCALAR_WORK2(0:IBP1,0:JBP1,0:KBP1,1:N_SPECIES),STAT=IZERO)
      CALL ChkMemErr('INIT','SCALAR_WORK2',IZERO)
      ALLOCATE(M%SCALAR_WORK3(0:IBP1,0:JBP1,0:KBP1,1:N_SPECIES),STAT=IZERO)
