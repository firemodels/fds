...
NAMELIST /REAC/ E,A,HEAT_OF_COMBUSTION,FYI,FUEL,EPUMO2,ID, N_S, &
                ...
                SOOT_YIELD,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,NU,SOOT_H_FRACTION, &
...
REAC_LOOP: DO NR=1,N_REACTIONS
   ...
   IF (.NOT. SIMPLE_CHEMISTRY) THEN
      ...
      ENDDO
      IF (ANY(ABS(REACTION_BALANCE)>1.E-5_EB)) CALL SHUTDOWN_ATOM(REACTION_BALANCE,NR)
   ENDIF
...
CHARACTER(30) :: SPEC_ID,DEVC_ID,CTRL_ID,QUANTITIES(1:10),SURF_ID,DRAG_LAW,PROP_ID
CHARACTER(25) :: COLOR
