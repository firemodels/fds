...
Air is a lumped species consiting of a mixture of nitrogen, oxgyen, water vapor, and carbon dioxide (carbon dioxide is included to attenuate radiation over large distances and water vapor is included for attenuation and to support simulations with sprinklers).  Products is a lumped species consisting of all the products listed in \ref{stoich} plus the nitrogen, water vapor, and carbon dioxide from the Air that reacted with the fuel.  If we allow for the presence of a diluent gas in the fuel stream, then the Fuel becomes a lumped species consisting of fuel and diluent.  We name these species $Z_0$ for Air, $Z_1$ for Fuel, and $Z_2$ for Products.  When using simple chemistry, FDS tracks the last two species explicitly and $Z_0$ is implicitly tracked as the background species.  The mass fractions of the component gases in these species are given as:
...
The stoichimetric coefficients in the $Z_2$ species yields are:
...
It can be seen from this that the four lumped species are: $Z_0$ for Air, $Z_1$ for Fuel, $Z_2$ for the products of incomplete combustion, and $Z_3$ for the products of copmlete combustion.  The species yields are:
