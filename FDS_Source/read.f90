...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,BAROCLINIC,BNDF_DEFAULT,&
                ...
                SHARED_FILE_SYSTEM,SLIP_CONDITION,SMOKE_ALBEDO,SOLID_PHASE_ONLY,STABILITY_CORRECTION,&
                ...
                VEG_LEVEL_SET,VISIBILITY_FACTOR,VN_MAX,VN_MIN,W0,WFDS,WIND_ONLY, &
...
ELSE
   ...
   IF (VELOCITY_TOLERANCE<TWO_EPSILON_EB) VELOCITY_TOLERANCE = 0.1_EB*MESHES(1)%CELL_SIZE
ENDIF
