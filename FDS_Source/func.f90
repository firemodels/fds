...
TMP = MIN(800._EB,TEMP)
IF (TMP <=500._EB)  THEN
   H_V =  -0.000555869_EB*TMP**3+ 0.424197_EB*TMP**2 - 2451.05_EB*TMP + 3152250_EB ! J/kg, cubic NASA table
ELSE
   H_V = 0.0259212_EB*TMP**3 - 53.7885_EB*TMP**2+ 32140.3_EB*TMP - 3907670_EB ! J/kg, cubic fit of NASA table
ENDIF
X_SAT  = MIN(1._EB,P_STP/PZONE*EXP(H_V*MW_H2O/R0*(1._EB/373.15_EB-1._EB/TMP)))
