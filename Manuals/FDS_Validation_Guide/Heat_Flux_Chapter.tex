...
Hamins~et~al.~\cite{Hamins:CST1994} made heat flux measurements along a radial profile at the surface of a 30.5~cm diameter methanol pool fire originally studied by Weckman at the University of Waterloo~\cite{Weckman:CF1996}.

\begin{figure}[!ht]
\centering
\includegraphics[height=2.15in]{SCRIPT_FIGURES/Waterloo_Methanol/Waterloo_Methanol_Heat_Flux}
\caption[Waterloo Methanol, radial profile of heat flux to the fuel surface]
{Waterloo Methanol, radial profile of heat flux to the fuel surface.}
