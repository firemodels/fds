...
INTEGER, PARAMETER :: N_CFACE_SCALAR_REALS=7+6,N_CFACE_SCALAR_INTEGERS=5+7,N_CFACE_SCALAR_LOGICALS=0

TYPE CFACE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER :: AREA,X,Y,Z,NVEC(:)
   INTEGER, POINTER :: CFACE_INDEX,SURF_INDEX,BOUNDARY_TYPE,CUT_FACE_IND1,CUT_FACE_IND2
   INTEGER, POINTER :: LOCAL_CARTESIAN_LIST(:)       ! This will be of size 7 (N_CARTFACE_CELL=6  +   1)
   REAL(EB), POINTER :: LOCAL_CARTESIAN_AREAS(:)     !   This will be of size N_CARTFACE_CELL=6
END TYPE CFACE_TYPE
