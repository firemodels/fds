...
REAL(EB), DIMENSION(:), POINTER :: RHO_ZZ_F, ZZ_GET, ZZ_GET_OTHER, RHO_ZZ_OTHER
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: OM_ZZP
...
RHO_ZZ_F => SCRATCH_RHO_ZZ_F(1:N_TOTAL_SCALARS,MY_RANK+THREAD_ID)
ZZ_GET => SCRATCH_ZZ_GET(1:N_TRACKED_SPECIES,MY_RANK+THREAD_ID)
ZZ_GET_OTHER => SCRATCH_ZZ_GET_OTHER(1:N_TRACKED_SPECIES,MY_RANK+THREAD_ID)
RHO_ZZ_OTHER => SCRATCH_RHO_ZZ_OTHER(1:N_TOTAL_SCALARS,MY_RANK+THREAD_ID)
