...
TYPE MESH_TYPE
   ...
   INTEGER :: NEXT_AVAILABLE_BOUNDARY_COORD_SLOT,NEXT_AVAILABLE_BOUNDARY_ONE_D_SLOT,NEXT_AVAILABLE_BOUNDARY_THR_D_SLOT, &
              NEXT_AVAILABLE_BOUNDARY_PROP1_SLOT,&
              NEXT_AVAILABLE_BOUNDARY_PROP2_SLOT,&
   ...
   INTEGER, ALLOCATABLE, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_THR_D_OCCUPANCY, &
                                         BOUNDARY_PROP1_OCCUPANCY,BOUNDARY_PROP2_OCCUPANCY,BOUNDARY_RADIA_OCCUPANCY
   INTEGER :: NLP,NLPDIM,PARTICLE_TAG,PARTICLE_LAST
...
INTEGER, POINTER, DIMENSION(:) :: BOUNDARY_COORD_OCCUPANCY,BOUNDARY_ONE_D_OCCUPANCY,BOUNDARY_THR_D_OCCUPANCY, &
                                  BOUNDARY_PROP1_OCCUPANCY,BOUNDARY_PROP2_OCCUPANCY,BOUNDARY_RADIA_OCCUPANCY
INTEGER, POINTER :: NLP,NLPDIM,PARTICLE_TAG,PARTICLE_LAST
