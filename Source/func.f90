...
CALL SET_OUTPUT_CLOCK(DT_SLCF_VTK    ,RAMP_SLCF_VTK_INDEX,  SLCF_VTK_CLOCK, SLCF_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_SL3D_VTK    ,RAMP_SL3D_VTK_INDEX,  SL3D_VTK_CLOCK, SL3D_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_SM3D_VTK    ,RAMP_SM3D_VTK_INDEX,  SM3D_VTK_CLOCK, SM3D_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_BNDF_VTK    ,RAMP_BNDF_VTK_INDEX,  BNDF_VTK_CLOCK, BNDF_VTK_COUNTER,.TRUE. ,.TRUE. )
CALL SET_OUTPUT_CLOCK(DT_PART_VTK    ,RAMP_PART_VTK_INDEX,  PART_VTK_CLOCK, PART_VTK_COUNTER,.TRUE. ,.TRUE. )
...
SUBROUTINE ALLOCATE_HT1D_UTILITY_ARRAYS

USE GLOBAL_CONSTANTS
INTEGER :: IZERO

ALLOCATE(AAS(NWP_MAX),STAT=IZERO)              ; CALL ChkMemErr('INIT','AAS',IZERO)
ALLOCATE(CCS(NWP_MAX),STAT=IZERO)              ; CALL ChkMemErr('INIT','CCS',IZERO)
ALLOCATE(BBS(NWP_MAX),STAT=IZERO)              ; CALL ChkMemErr('INIT','BBS',IZERO)
ALLOCATE(DDS(NWP_MAX),STAT=IZERO)              ; CALL ChkMemErr('INIT','DDS',IZERO)
ALLOCATE(DDT(NWP_MAX),STAT=IZERO)              ; CALL ChkMemErr('INIT','DDT',IZERO)
...
ALLOCATE(DELTA_TMP(0:NWP_MAX+1),STAT=IZERO)    ; CALL ChkMemErr('INIT','DELTA_TMP',IZERO)
...
ALLOCATE(RDXN_S(0:NWP_MAX),STAT=IZERO)         ; CALL ChkMemErr('INIT','RDXN_S',IZERO)
ALLOCATE(R_S(0:NWP_MAX),STAT=IZERO)            ; CALL ChkMemErr('INIT','R_S',IZERO)
ALLOCATE(R_S_NEW(0:NWP_MAX),STAT=IZERO)        ; CALL ChkMemErr('INIT','R_S_NEW',IZERO)
ALLOCATE(DX_WGT_S(0:NWP_MAX),STAT=IZERO)       ; CALL ChkMemErr('INIT','DX_WGT_S',IZERO)
ALLOCATE(LAYER_INDEX(0:NWP_MAX+1),STAT=IZERO)  ; CALL ChkMemErr('INIT','LAYER_INDEX',IZERO)
ALLOCATE(MF_FRAC(1:NWP_MAX),STAT=IZERO)        ; CALL ChkMemErr('INIT','MF_FRAC',IZERO)
ALLOCATE(REGRID_FACTOR(1:NWP_MAX),STAT=IZERO)  ; CALL ChkMemErr('INIT','REGRID_FACTOR',IZERO)

END SUBROUTINE ALLOCATE_HT1D_UTILITY_ARRAYS
