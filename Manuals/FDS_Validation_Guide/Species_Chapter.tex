...
\end{tabular*}
\caption[FM/FPRF Data Center, smoke obscuration, propylene and cable sources]{FM/FPRF Data Center, smoke obscuration, low and high exhaust rate, propylene and cable sources.}
...
The figures on the following pages contain comparisons of measured and predicted smoke transmission along an 80~cm path in an upper corner of the test compartment. The experiments are divided into two. Figure~\ref{smoke_closed} displays the results of the experiments in which the compartment door was closed. Figure~\ref{smoke_open} displays the results of the experiments in which the compartment door was open. The results are significantly different---the simulations of the closed door experiments predict significantly less transmission. The most likely reason for this is that FDS has not accounted for the agglomeration and deposition of the smoke on the walls, something that is far more important when the compartment is not well-ventilated.
...
\end{tabular*}
\caption[NIST/NRC experiments, smoke transmission, closed door experiments]{NIST/NRC experiments, smoke transmission, closed door experiments.}
\label{smoke_closed}
\end{figure}
...
\end{tabular*}
\caption[NIST/NRC experiments, smoke transmission, open door experiments]{NIST/NRC experiments, smoke transmission, open door experiments.}
\label{smoke_open}
\end{figure}
...
\subsection{Summary, Smoke Obscuration}
\label{Smoke Obscuration}

\begin{figure}[!h]
\centering
\includegraphics[height=3.5in]{SCRIPT_FIGURES/Scatterplots/FDS_Smoke_Obscuration}
...
\caption[Summary of aerosol deposition velocity predictions]{Summary of aerosol deposition velocity predictions.}
...
\caption[Summary of aerosol deposited mass predictions]{Summary of aerosol deposited mass predictions.}
...
Species concentrations and temperature measurements were made at the front and rear of the compartment. Details of the experiments are found in Sec.~\ref{NIST_FSE_2008_Description}. Only temperature and HRR data are shown for ISOHept8 as the gas data was anomalous.
