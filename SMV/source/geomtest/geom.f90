...
REAL(EB) :: DAZIM(MAX_IDS), DELEV(MAX_IDS), DSCALE(MAX_IDS), DXYZ0(3,MAX_IDS), DXYZ(3,MAX_IDS)
REAL(EB) :: AZIM, ELEV, SCALE, XYZ0(3), XYZ(3)
...
SUBROUTINE MERGE_GEOMS(VERTS,N_VERTS,FACES,N_FACES)
   ...
   TYPE(GEOMETRY_TYPE), POINTER :: G=>NULL()
   INTEGER :: IZERO
   INTEGER :: I1VERT, I2VERT
   INTEGER :: I1FACE, I2FACE
   ...
   DO I = 0, N_GEOM-1
      ...
      I1VERT = I2VERT + 1
      I2VERT = I1VERT + 3*G%N_VERTS - 1
      IF(G%N_VERTS>0)VERTS(I1VERT:I2VERT) = G%VERTS(1:3*G%N_VERTS)
      
      I1FACE = I2FACE + 1
      I2FACE = I1FACE + 3*G%N_FACES - 1
      IF(G%N_FACES>0)FACES(I1FACE:I2FACE) = G%FACES(1:3*G%N_FACES)+OFFSETS(I)
   END DO
...
DO I = 1, N_GEOM
   ...
   WRITE(6,20)G%SCALE,G%AZIM,G%ELEV
   20 FORMAT('   SCALE=',E11.4,' AZIM=',E11.4,' ELEV=',E11.4)
   WRITE(6,30)G%XYZ0
