...
says that $g(X) \sim N \left( g(\mu) \, , \, (g'(\mu) \, \sigma)^2\right)$~\cite{Oehlert:1992}.} to obtain the approximate distribution
...
The assumption of a non-informative prior implies that we do not have sufficient information about the prior distribution of
...
\be \ln(M)|\theta \sim N \left(\ln(\delta)+\ln(\theta)-\frac{1}{2} \frac{\widetilde{\sigma}_M^2}{\delta^2} \; , \;
    \frac{\widetilde{\sigma}_M^2}{\delta^2} \right) \quad ; \quad \widetilde{\sigma}_M=\frac{\sigma_M}{\theta} \ee
...
\be \ln(M) \sim N \left( \ln(\delta)+\ln(E)-\frac{1}{2} \frac{\widetilde{\sigma}_M^2}{\delta^2} \; , \; \frac{\widetilde{\sigma}_M^2}{\delta^2} +\widetilde{\sigma}_E^2 \right) \ee
...
\be u(M) = \sqrt{\frac{\widetilde{\sigma}_M^2}{\delta^2}+\widetilde{\sigma}_E^2} \approx \sqrt{ \frac{1}{n-1} \sum_{i=1}^n \,
...
\be \frac{\widetilde{\sigma}_M}{\delta} \approx \sqrt{u(M)^2-\widetilde{\sigma}_E^2} \label{model_error} \ee
An estimate of $\ln(\delta)$ is $\overline{M}-\overline{E}+\widetilde{\sigma}_M^2/2\delta^2$, and, thus, the estimate of $\delta$ is
\be \delta \approx \exp \left( \overline{M}-\overline{E}+\frac{\widetilde{\sigma}_M^2}{2 \delta^2} \right) \ee
...
\be 20 + \frac{M}{\delta} = 20 + \frac{330}{1.03} \quad ; \quad  \widetilde{\sigma}_M \, \frac{M}{\delta} = 0.10 \, \frac{330}{1.03} \ee
