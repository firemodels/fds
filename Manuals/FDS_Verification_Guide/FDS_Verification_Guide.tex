...
\begin{figure}[h]
   \begin{center}
      ...
      \caption[Image]{\label{fig_ribbed_channel_image} Ribbed square duct image.}
   \end{center}
\end{figure}
...
\begin{figure}[h!]
   ...
   \end{tabular*}
   \caption[Mean and RMS velocity profiles for ribbed square duct flow]{\label{fig_ribbed_channel} Mean and RMS velocity profiles for ribbed square duct flow. Comparison with PIV data from Casara and Arts \cite{Casara_1}.}
\end{figure}
