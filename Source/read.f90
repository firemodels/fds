...
USE CHEMCONS, ONLY: ODE_MIN_ATOL
REAL(EB) :: ODE_REL_ERROR, EQUIVALENCE_RATIO_CHECK, MIN_EQUIV_RATIO, MAX_EQUIV_RATIO
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE, EQUIVALENCE_RATIO_CHECK, &
                EXTINCTION_MODEL,FINITE_RATE_MIN_TEMP, FIXED_MIX_TIME,FREE_BURN_TEMPERATURE,&
                INITIAL_UNMIXED_FRACTION,MIN_EQUIV_RATIO, MAX_EQUIV_RATIO, MAX_CHEMISTRY_SUBSTEPS,&
