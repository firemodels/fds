...
LOGICAL :: LES,DNS,ISOTHERMAL,RADIATION,CONVECTION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE,MIXTURE_FRACTION=.FALSE., &
           ...
           VAN_DRIEST=.FALSE.,CP_FTMP=.FALSE.
...
REAL(EB) :: MW_AIR,MW_OTHER,MW_SOOT,HRRPUA_SHEET=200._EB,HRRPUA_SHEET_EXPONENT=1._EB,RHO_SOOT,VISIBILITY_FACTOR, SOOT_H_FRACTION ,&
            MASS_EXTINCTION_COEFFICIENT,EC_LL,C_EDC=0.10_EB,HRRPUV_AVERAGE=1200._EB
