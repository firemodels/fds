...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=20,N_WALL_SCALAR_INTEGERS=14,N_WALL_SCALAR_LOGICALS=0
...
TYPE REACTION_TYPE
   CHARACTER(LABEL_LENGTH) :: FUEL,OXIDIZER,PRODUCTS,ID,RAMP_FS
   ...
   INTEGER :: FUEL_SMIX_INDEX=-1,AIR_SMIX_INDEX=-1,MODE,N_SMIX,N_SPEC,RAMP_FS_INDEX=0
...
TYPE OMESH_TYPE
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: MU,RHO,RHOS,U,V,W,US,VS,WS,H,HS,FVX,FVY,FVZ,D,DS,KRES,IL_S,IL_R,UNMIXED_FRACTION
