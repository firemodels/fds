...
The original version of RadCal only included absorption data for methane as a surrogate for any fuel. Thus, the default value
of {\ct RADCAL\_FUEL} is {\ct 'METHANE'}. Work is currently underway to extend the list of fuels.
