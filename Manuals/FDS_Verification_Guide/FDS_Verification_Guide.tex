...
the thermal radiation field is accuratelly converted into increased temperature of the droplets. Considering the total mass of
...
\end{tabular*}
\caption[Radiation absorption by liquid droplets]{Conserversion of absorbed thermal radiation energy into increased average droplet temperature.}
