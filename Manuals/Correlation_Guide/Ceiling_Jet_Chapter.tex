...
\subsection{Temperature Rise Method}
...
\begin{table}[!ht]
\caption[Input parameters, smoke detector activation time (Temperature Rise)]
{Input parameters, smoke detector activation time (Temperature Rise).}
\begin{center}
\begin{tabular}{|l|c|}
\hline
                          &              \\
