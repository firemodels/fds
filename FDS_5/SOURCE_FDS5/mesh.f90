...
CHARACTER(255), PARAMETER :: meshid='$Id: mesh.f90,v 1.13 2007/04/26 12:50:34 mcgratta Exp $'
...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:)   :: XW,YW,ZW,TW, &
            ...
            QRAD,QRADIN,QRADOUT,EW,KW,QCONF,AREA_ADJUST,RHO_W,TMP_W,RSUM_W,RCP_W, &
