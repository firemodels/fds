...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   INTEGER :: SAMPLING,N_QUANTITIES,QUANTITIES_INDEX(10),ARRAY_INDEX=0,RGB(3),RADIATIVE_PROPERTY_INDEX=0, &
              SURF_INDEX=0,DRAG_LAW=1,DEVC_INDEX=0,CTRL_INDEX=0,PROP_INDEX=-1,N_SPLIT=1,SPLIT_PART_INDEX=0,Z_INDEX=-1,&
...
INTEGER, PARAMETER :: N_ONE_D_SCALAR_REALS=7,N_ONE_D_SCALAR_INTEGERS=2,N_ONE_D_SCALAR_LOGICALS=2
...
TYPE ONE_D_M_AND_E_XFER_TYPE
   ...
   INTEGER, POINTER :: ARRAY_INDEX,STORAGE_INDEX
   REAL(EB), POINTER :: AREA,RAREA,HEAT_TRANS_COEF,QCONF,QRADIN,QRADOUT,EMISSIVITY
...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=29,N_PARTICLE_SCALAR_INTEGERS=12,N_PARTICLE_SCALAR_LOGICALS=5

TYPE LAGRANGIAN_PARTICLE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   LOGICAL, POINTER :: ALREADY_ALLOCATED,SHOW,SPLAT,IGNITOR,EVAPORATE
   REAL(EB), POINTER :: TMP_F,X,Y,Z,U,V,W,PWT,ACCEL_X,ACCEL_Y,ACCEL_Z,T,RE,MASS,TMP_B,&
   ...
   INTEGER, POINTER :: TAG,ARRAY_INDEX,STORAGE_INDEX,CLASS_INDEX,IOR,SPLIT_IOR,SURF_INDEX,WALL_INDEX,&
                       IIG,JJG,KKG,VEG_N_TREE_OUTPUT
...
TYPE ISOSURFACE_FILE_TYPE
   INTEGER :: INDEX=1,INDEX2=0,REDUCE_TRIANGLES=0,N_VALUES=1,Y_INDEX=-999,Y_INDEX2=-999,Z_INDEX=-999,Z_INDEX2=-999,&
              VELO_INDEX=0
   REAL(FB) :: VALUE(10)
