...
SUBROUTINE GET_AVERAGE_SPECIFIC_HEAT_DIFF(Z_IN,CPBAR_OUT,TMPG)
...
Z_IN(0) = - SUM(Z_IN(1:N_TRACKED_SPECIES))
CPBAR_OUT = DOT_PRODUCT(CPBAR_Z(ITMP,:),Z_IN)
