...
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_08.fds
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_09.fds
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_10.fds
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_11.fds
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_12.fds
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_13.fds
$QFDS $DEBUG $QUEUE -p 2 -d $INDIR RSE_14.fds
