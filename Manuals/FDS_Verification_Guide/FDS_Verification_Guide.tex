...
This example shows how to define a reaction that invokes an aerosol deposition model in FDS (e.g. soot deposition). For this example propane will be the fuel with a 5 \% soot yield.

Figure~\ref{fig:deposition_mass_components} shows the time evolution of soot mass in the gas phase, condensed phase (wall), and total (sum of soot in the gas and condensed phases) for five cases. The five cases are (1) all soot deposition mechanisms active, (2) no soot deposition mechanisms active, (3) gravitational deposition only, (4) thermophoretic deposition only, and (5) turbulent deposition only. Figure~\ref{fig:deposition_mass_total} shows the sum of the gas phase and condensed phase soot masses.
