...
The default is {\ct 'INERT'}, a cold, non-reacting solid boundary. You do not need to define {\ct 'INERT'} via a {\ct SURF} line.
...
cold, inert wall, and is referred to as {\ct 'INERT'}. If only this
