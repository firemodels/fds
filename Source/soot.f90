...
INTEGER, INTENT(IN) :: NM
REAL(EB), INTENT(IN) :: DT
REAL(EB) :: DUDX,DVDY,DWDZ,ONTHDIV,S11,S22,S33,DUDY,DUDZ,DVDX,DVDZ,DWDX,DWDY,S12,S23,S13,STRAIN_RATE,DISSPATION_RATE
...
GEOMETRY_LOOP:DO K=1,KBAR
   DO J=1,JBAR
      DO I=1,IBAR
         ...
         DISSPATION_RATE = RHOG/MUG*STRAIN_RATE
         N_I = N0
         ...
         DO N=1,N_PARTICLE_BINS
            DO NN=1,N_PARTICLE_BINS
               ...
               PHI_S = PHI_S_FAC(N,NN)*RHOG/MUG*DISSPATION_RATE
               PHI_I = PHI_I_FAC(N,NN)*(RHOG/MUG*DISSPATION_RATE**3)**0.25_EB*VREL/GRAV
