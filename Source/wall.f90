...
REAL(EB), INTENT(IN) :: T,DT
REAL(EB) :: UN,DD,MFT,MFT2,TSI,RSUM_F,MPUA_SUM,RHO_F_PREVIOUS,RN1,RN2,TWOMFT,Q_NEW(MAX_QDOTPP_REF)
...
METHOD_OF_MASS_TRANSFER: SELECT CASE(SPECIES_BC_INDEX)
   ...
   CASE (SPECIFIED_MASS_FLUX) METHOD_OF_MASS_TRANSFER
      ...
      IF (SF%MASS_FLUX_VAR > TWO_EPSILON_EB) THEN
         ...
         DO N=1,N_TRACKED_SPECIES
            B1%M_DOT_G_PP_ADJUST(N) = B1%M_DOT_G_PP_ADJUST(N) * MFT/MFT2
            B1%M_DOT_G_PP_ACTUAL(N) = B1%M_DOT_G_PP_ACTUAL(N) * MFT/MFT2
         ENDDO
      ENDIF
