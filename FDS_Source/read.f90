...
SIMPLE_ID=(/'ETHYLENE','NITROGEN','OXYGEN','CARBON DIOXIDE','CARBON MONOXIDE','WATER VAPOR','HYDROGEN','SOOT'/)
...
READ_SMIX_LOOP: DO N=1,N_LUMPED_SPECIES   
   ...
   WRITE(SM%FORMULA,'(A,I)') 'Z',N-SMIX_OFFSET   
   MASS_FRACTION = -1._EB
