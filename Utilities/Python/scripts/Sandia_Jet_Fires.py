...
expdir = '../../../exp/Sandia_Jet_Fires/'
outdir = '../../../out/Sandia_Jet_Fires/'
figdir = '../../Manuals/FDS_Validation_Guide/SCRIPT_FIGURES/Sandia_Jet_Fires/'

E_file = ['ethane_jet.csv','ethylene_jet.csv','isopentane_jet.csv']
M_file = ['ethane_jet_cat_devc.csv','ethylene_jet_cat_devc.csv','isopentane_jet_cat_devc.csv']

marker = ['ko','ro','go']
label  = ['Ethane','Ethylene','Isopentane']

git_file =  os.path.join(outdir, f'ethane_jet_cat_git.txt')
...
for i in range(3):
    ...
    M = df2.iloc[-1,3:].values  # Last row, all columns
...
# Save as PDF
fig_file =  os.path.join(figdir, f'Sandia_Jets.pdf')
