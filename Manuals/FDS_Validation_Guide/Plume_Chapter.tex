...
\subsection{JIS Facade Experiments}
\label{JIS_Facade_Plume_Temperature}
...
\includegraphics[height=2.1in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_exp_contours_600} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_exp_contours_750} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_exp_contours_900} \\
\includegraphics[height=2.1in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_contours_600} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_contours_750} &
\includegraphics[height=2.1in]{SCRIPT_FIGURES/JIS_Facade/JIS_facade_contours_900}
\end{tabular*}
\caption[JIS Facade, plume temperature, JIS A 1310 configuration]{JIS Facade, plume temperature, JIS A 1310 configuration. The upper three sets of plots display the measured temperature contours; the lower the simulated. The origin of the Height axis corresponds to the top of the 0.91~m by 0.91~m window. These contour plots are based on those shown in Fig.~8 of the paper by Sun~et~al.~\cite{Sun:FAM2024}.}
...
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_1_line_a} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_2_line_a} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_3_line_a} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_1_line_b} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_2_line_b} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_3_line_b} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_1_line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_2_line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_1_3_line_c}
\end{tabular*}
\caption[TUS Facade, plume temperature, Case 1]{TUS Facade, plume temperature, Case 1.}
\label{TUS Facade_Plume_Temp_1}
\end{figure}

\begin{figure}[p]
\begin{tabular*}{\textwidth}{lll}
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_1_line_a} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_2_line_a} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_3_line_a} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_1_line_b} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_2_line_b} & 
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_3_line_b} \\
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_1_line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_2_line_c} &
\includegraphics[width=2in]{SCRIPT_FIGURES/TUS_Facade/TUS_facade_2_3_line_c}
\end{tabular*}
\caption[TUS Facade, plume temperature, Case 2]{TUS Facade, plume temperature, Case 2.}
...
\end{tabular*}
\caption[TUS Facade, plume temperature, Case I]{TUS Facade, plume temperature, Case I.}
\label{TUS Facade_Plume_Temp_I}
\end{figure}
...
\hline
$\dot{Q}^*$       & $\dot{Q}$~(kW) & $D^*$ (m)  & $\dx_5$ (m)  & $\dx_{10}$  & $\dx_{20}$ \\ \hline \hline
...
{Comparison of FDS predictions of flame height from a 1~m square pan fire for $\dot{Q}^*$ values ranging from
0.1 to 10000.}
\label{Flame_Height}
\end{figure}
...
{Flame height predictions from various correlations compared with FDS predictions using two different flame height definitions.  Uncertainty (maximum variation) at $\dot{Q}^*>1$ is $\pm$15~\%.  At $\dot{Q}^*=0.1$, the uncertainty is approximately $\pm$65~\%. Correlation references: Steward \cite{Steward:1970}, Becker and Liang \cite{Becker:1978}, Cox and Chitty \cite{Cox:1985}, Heskestad \cite{SFPE:Heskestad}, Hasemi and Tokunaga \cite{Hasemi:1984}, Cetegen \cite{Cetegen:1984}, Delichatsios \cite{Delichatsios:1984}.}
\label{Flame_Height2}
\end{figure}
