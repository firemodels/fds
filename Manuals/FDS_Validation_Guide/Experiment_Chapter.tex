...
X reduced-scale enclosure experiments were conducted at NIST from May to August, 2017. 

\subsection{Enclosure Geometry}

The enclosure consisted of two compartments stacked one on top of the other. The interior lateral dimensions of each compartment were 119~cm by 122~cm. The height of the lower compartment was 59~cm, and the upper was 61~cm. 
...
The walls, ceiling and floor of each compartment was 1.6~cm (5/8~in) Type~X gypsum board. Wood studs formed the exterior frame. Thermo-physical properties of the gypsum board are given in Ref.~\cite{Manzello:SiF08}.
