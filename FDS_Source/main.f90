...
USE EMBEDDED_MESH_METHOD, ONLY: SCALARF_EMB,VELOCITY_EMB,CHECK_MASS_EMB
...
INTEGER NOM,IMIN,IMAX,JMIN,JMAX,KMIN,KMAX,IW,MAX_LEVEL
...
! Find max embedded mesh level

IF (EMBEDDED_MESH) THEN
   MAX_LEVEL = 0
   DO NM=1,NMESHES
      MAX_LEVEL = MAX(MAX_LEVEL,MESHES(NM)%MESH_LEVEL)
   ENDDO
ENDIF
