...
INTEGER, ALLOCATABLE, DIMENSION(:) :: REQ,REQ1,REQ3,REQ4,REQ5,REQ6,REQ7,REQ8,REQ9,COUNTS,DISPLS,COUNTS2D,DISPLS2D,COUNTS_TIMERS,&
                                      DISPLS_TIMERS, &
...
INTEGER :: N_REQ,N_REQ1,N_REQ3,N_REQ4,N_REQ5,N_REQ6,N_REQ7,N_REQ8,N_REQ9,N_COMMUNICATIONS,&
