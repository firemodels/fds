...
\setlength{\cftsecnumwidth}{0.40in}   % Width of section number in toc (parameter of tocloft package)
\setlength{\cftsubsecnumwidth}{0.6in} % Width of subsection number in toc (parameter of tocloft package)
