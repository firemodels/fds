...
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_cold_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_cold_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_cold_server7_cable.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_hot_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_hot_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_hot_server7_cable.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_noplenum_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_noplenum_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_noplenum_server7_cable.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_plenum_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_plenum_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 100_once_plenum_server7_cable.fds
...
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_cold_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_cold_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_cold_server7_cable.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_hot_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_hot_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_hot_server7_cable.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_noplenum_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_noplenum_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_noplenum_server7_cable.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_plenum_aisle3.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_plenum_crah.fds
$QFDS $DEBUG -p 4 -r $QUEUE -d $INDIR 600_once_plenum_server7_cable.fds
