...
REAL(EB) :: X1,X2,Y1,Y2,Z1,Z2,XX1,XX2,YY1,YY2,ZZ1,ZZ2,PRIMARY_VOLUME,OVERLAP_VOLUME,DXX,DYY,DZZ,WEIGHT_FACTOR,EXTRUDE,&
            SUM_WGT(3)
...
IF (.NOT.SF2%VARIABLE_THICKNESS .OR. WC2%BOUNDARY_TYPE/=SOLID_BOUNDARY) RETURN
