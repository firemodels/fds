...
INTEGER :: IJK(3),NM,MPI_PROCESS,RGB(3)
INTEGER, DIMENSION(0:100) :: I_MG,J_MG,K_MG
LOGICAL :: EVACUATION, EVAC_HUMANS
REAL(EB) :: EVAC_Z_OFFSET,XB(6)
CHARACTER(25) :: COLOR
NAMELIST /MESH/ IJK,FYI,ID,SYNCHRONIZE,EVACUATION,EVAC_HUMANS,CYLINDRICAL,XB,RGB,COLOR,EVAC_Z_OFFSET,MPI_PROCESS,I_MG,J_MG,K_MG
TYPE (MESH_TYPE), POINTER :: M
