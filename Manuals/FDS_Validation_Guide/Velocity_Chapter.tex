...
The figures on the following pages display comparisons of measured and predicted vertical velocities above a 30~cm diameter methanol pool fire. Each plot displays radial profiles of vertical velocity at heights ranging from 2~cm to 30~cm. Time resolved velocity measurements were performed using a two component laser doppler anemometer.
...
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of vertical velocity, 2~cm to 12~cm above the burner]
{Waterloo Methanol, radial profiles of vertical velocity, 2~cm to 14~cm above the burner.}
...
\multicolumn{2}{c}{\includegraphics[height=2.15in]{SCRIPT_FIGURES/Waterloo_Methanol/Waterloo_Methanol_Vertical_Velocity_30_cm}}
\end{tabular*}
\caption[Waterloo Methanol, radial profiles of vertical velocity, 14~cm to 30~cm above the burner]
{Waterloo Methanol, radial profiles of vertical velocity, 14~cm to 30~cm above the burner.}
