...
\usepackage[pdftex,
        ...
        pdftitle={Smokeview (Version 5) - A Tool for Visualizing Fire Dynamics Simulation Data Volume II: Technical Reference Guide},
...
Smokeview version 5 interpolates color indices not colors. As a
...
coordinate.  In general, Smokeview version 5 uses the scheme,
\begin{eqnarray*}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=6.0in]{figures/plume5c_part}&
\includegraphics[height=6.0in]{figures/plume5c_streak}\\
