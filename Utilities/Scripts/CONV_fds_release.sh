...
svn export --quiet --force https://code.google.com/p/fds-smv/source/browse/wiki/Running_FDS_MPI_on_Linux.wiki $bundleinfo/fds_linux.wiki
...
svn export --quiet --force https://code.google.com/p/fds-smv/source/browse/wiki/Running_FDS_MPI_on_OSX.wiki $bundleinfo/fds_osx.wiki
