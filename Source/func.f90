...
SF%N_ONE_D_STORAGE_REALS    = N_ONE_D_SCALAR_REALS    + SUM(SF%ONE_D_REALS_ARRAY_SIZE(1:8))
...
SF%CFACE_REALS_ARRAY_SIZE(1) = N_TOTAL_SCALARS  ! ZZ_F

SF%N_CFACE_STORAGE_REALS    = N_CFACE_SCALAR_REALS    + SUM(SF%CFACE_REALS_ARRAY_SIZE(1:1)) + SF%N_ONE_D_STORAGE_REALS
...
CF%RHO_F              => OS%REALS(2,STORAGE_INDEX) ; IF (NEW) CF%RHO_F = 1._EB
CF%TMP_F              => OS%REALS(3,STORAGE_INDEX) ; IF (NEW) CF%TMP_F = TMPA
CF%X                  => OS%REALS(4,STORAGE_INDEX)
CF%Y                  => OS%REALS(5,STORAGE_INDEX)
CF%Z                  => OS%REALS(6,STORAGE_INDEX)

I1 = N_CFACE_SCALAR_REALS+1 ; I2 = I1 + SF%CFACE_REALS_ARRAY_SIZE(1) - 1  ; CF%ZZ_F(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)

CALL ONE_D_POINTERS(CFACE_INDEX_LOCAL,NEW,N_CFACE_SCALAR_REALS+SUM(SF%CFACE_REALS_ARRAY_SIZE(1:1)), &
