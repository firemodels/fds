...
! Misc Combustion
OUTPUT_QUANTITY(200)%NAME = 'MIXTURE FRACTION'
OUTPUT_QUANTITY(200)%UNITS = 'kg/kg'
OUTPUT_QUANTITY(200)%SHORT_NAME = 'Z'
...
OUTPUT_QUANTITY(-28)%SHORT_NAME= 'depo'
...
OUTPUT_QUANTITY(-37)%NAME= 'PRESSURE COEFFICIENT TEST' 
OUTPUT_QUANTITY(-37)%OLD_NAME= 'PRESSURE_COEFFICIENT'    
OUTPUT_QUANTITY(-37)%UNITS= ' '                       
OUTPUT_QUANTITY(-37)%SHORT_NAME= 'c_p'
...
CALL JANAF_TABLE(J,CP_TMP,H_TMP,SS%DATA_ID,SS%RCON,FUEL)
