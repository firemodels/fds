...
TYPE MESH_TYPE
   ...
   INTEGER, ALLOCATABLE, DIMENSION(:,:) :: LS_KLO_TERRAIN,LS_K_TERRAIN,LS_SURF_INDEX
...
INTEGER, POINTER, DIMENSION(:,:) :: LS_K_TERRAIN,LS_SURF_INDEX
...
LS_Z_TERRAIN  =>M%LS_Z_TERRAIN
LS_K_TERRAIN  =>M%LS_K_TERRAIN
