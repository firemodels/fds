...
approximately quarter scale two-car residential garage with interior dimensions of 1.5 m x 1.5 cm x0.745 m was 
constructed with 1.25 cm thick plexiglas. Helium gas (used as a surrogate for hydrogen, due to safety concerns) was release 
through a burner that 207 mm tall and the exit diameter was 36 mm. Helium flow through the burner was controlled through a  mass 
flow controller and the specified flow rate for 1 hour and 4 hour releases were 14.95 L/min and 3.74 L/min, respectively (flow rate was 
scaled to represent the emptying of a 5 kg of hydrogen fuel tank in 1 or 4 hours). Idealized leaks were chosen to have areas that provide minimum ventilation 
...
two equal openings (each opening was 2.15 cm square) centered horizontally, at the top and bottom of the front face. The figures below show comparison 
between FDS predictions and experimental data for different release locations, leak sizes and release duration. 
