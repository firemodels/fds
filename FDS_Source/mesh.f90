...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: &
            ...
            MU,TMP,Q,Q_AVG,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN, &
            C_DYNSMAG,MTR,MU_DNS
 
   REAL(EB), POINTER, DIMENSION(:,:,:,:) :: YY,YYS,DEL_RHO_D_DEL_Y,AVG_DROP_DEN,AVG_DROP_TMP,AVG_DROP_RAD,MSR
   ...
   INTEGER :: LSAVE,LWORK,LBC,MBC,NBC,ITRN,JTRN,KTRN,IPS,PRESSURE_ITERATIONS
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:,:) :: SCALAR_SAVE1,SCALAR_SAVE2,SCALAR_SAVE3,SCALAR_SAVE4,SCALAR_SAVE5
   
   REAL(EB), POINTER, DIMENSION(:,:,:) :: IBM_SAVE1,IBM_SAVE2,IBM_SAVE3,IBM_SAVE4,IBM_SAVE5
   ...
   REAL(EB), POINTER, DIMENSION(:)   :: XW,YW,ZW,TW,AW,RAW,UW0,DUWDT,RDN, &
            ...
            TMP_F,TMP_B,HEAT_TRANS_COEF,D_CORR,DS_CORR,DUDT_AVG,DVDT_AVG,DWDT_AVG,UVW_SAVE,AWMSOOT
   ...
   REAL(EB) :: RHO_AVG,RHO_LOWER,RHO_UPPER
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: PRHS
REAL(EB), POINTER, DIMENSION(:,:) :: BXS,BXF,BYS,BYF,BZS,BZF, BXST,BXFT,BYST,BYFT,BZST,BZFT
INTEGER, POINTER :: LSAVE,LWORK,LBC,MBC,NBC,ITRN,JTRN,KTRN,IPS,PRESSURE_ITERATIONS
REAL(EB), POINTER, DIMENSION(:) :: P_0,RHO_0,TMP_0,D_PBAR_DT,D_PBAR_S_DT,U_LEAK,U_DUCT
REAL(EB), POINTER, DIMENSION(:,:) :: PBAR,PBAR_S,R_PBAR
INTEGER, POINTER, DIMENSION(:,:,:) :: PRESSURE_ZONE
INTEGER, POINTER, DIMENSION(:) :: PRESSURE_ZONE_WALL,PRESSURE_BC_INDEX
...
REAL(EB), POINTER :: RHO_AVG,RHO_LOWER,RHO_UPPER
INTEGER, POINTER, DIMENSION(:,:,:) :: INTERPOLATED_MESH
CHARACTER(80), POINTER, DIMENSION(:) :: STRING
...
KTRN=>M%KTRN
IPS=>M%IPS
PRESSURE_ITERATIONS=>M%PRESSURE_ITERATIONS
U_LEAK=>M%U_LEAK
U_DUCT=>M%U_DUCT
...
IF (FLUX_LIMITER>=0) THEN
   ...
   SCALAR_SAVE4=>M%SCALAR_SAVE4
   SCALAR_SAVE5=>M%SCALAR_SAVE5
ENDIF
...
RHO_AVG=>M%RHO_AVG
RHO_LOWER=>M%RHO_LOWER
RHO_UPPER=>M%RHO_UPPER
