...
DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
   ...
   IF (PERIODIC_TEST==12) CALL THREED_VORTEX(NM)
...
IF (CC_IBM) CALL CCIBM_RHO0W_INTERP
...
DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
   ...
   IF (CC_IBM) CALL CCREGION_DIVERGENCE_PART_1(T_BEGIN,DT,NM)
ENDDO
...
MAIN_LOOP: DO
   ...
   COMPUTE_DIVERGENCE_2: DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
      ...
      IF (CC_IBM .AND. (N_REACTIONS > 0) ) CALL CCREGION_COMBUSTION(T,DT,NM)
