   ...
   CASE (NSCARC_DIMENSION_TWO)
      ...
      DO IZ = 1, SL%NZ
         DO IX = 1, SL%NX
            ...
            IF (IWNUM == 0 .OR. IWTYPE==INTERPOLATED_BOUNDARY.OR.PRES_ON_WHOLE_DOMAIN) THEN
...
SELECT CASE (NPRECON)
   ...
   CASE (NSCARC_PRECON_PARDISO)
      ...
      DO NM = 1, NMESHES
         ...
         !   !WRITE(LU_SCARC,*) 'PT=',SM%PT
         !   WRITE(LU_SCARC,*) 'NVECTOR1=',NVECTOR1
         !   WRITE(LU_SCARC,*) 'NVECTOR2=',NVECTOR2
         !   WRITE(LU_SCARC,*) 'NC    =',NC
         !   WRITE(LU_SCARC,*) 'MAXFCT=',SM%MAXFCT
         !   WRITE(LU_SCARC,*) 'MNUM=',SM%MNUM
         !   WRITE(LU_SCARC,*) 'MTYPE=',SM%MTYPE
         ...
         !   WRITE(LU_SCARC,*) 'SIZE(AC)=',SIZE(AC)
         !   WRITE(LU_SCARC,*) 'SIZE(AC_ROW)=',SIZE(AC_ROW)
         !   WRITE(LU_SCARC,*) 'SIZE(AC_COL)=',SIZE(AC_COL)
         !   WRITE(LU_SCARC,*) 'PERM=',SM%PERM
         !   WRITE(LU_SCARC,*) 'NRHS=',SM%NRHS
         !   WRITE(LU_SCARC,*) 'MSGLVL=',SM%MSGLVL
         !   WRITE(LU_SCARC,*) 'ERROR2=',SM%ERROR
...
IF ((TYPE_METHOD == NSCARC_METHOD_MKL  .OR. &
     ...
     TYPE_SMOOTH == NSCARC_SMOOTH_CLUSTER) .AND.  N_MPI_PROCESSES > 1) THEN
...
ELSE IF ((TYPE_METHOD == NSCARC_METHOD_MKL  .OR. &
          TYPE_PRECON == NSCARC_PRECON_PARDISO  .OR. &
          TYPE_SMOOTH == NSCARC_SMOOTH_PARDISO) .AND.  N_MPI_PROCESSES > 1) THEN
...
ELSE IF (TYPE_METHOD == NSCARC_METHOD_KRYLOV) THEN
...
ELSE IF (TYPE_METHOD == NSCARC_METHOD_MULTIGRID) THEN
