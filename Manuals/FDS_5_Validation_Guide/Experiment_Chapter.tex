...
The least squares estimate of the standard deviation of $\ln(M_i)$, that is of $\sqrt{(\tilde{\sigma}_M/\delta)^2+\tilde{\sigma}_E^2}$, is
...
\be u(M)^2 = (\tilde{\sigma}_M/\delta)^2 + \tilde{\sigma}_E^2 \ee
Finally, the following expression is an estimate of $\sigma_M/\theta$, the relative model-intrinsic uncertainty with respect to the true value, $\theta$:
\be \tilde{\sigma}_M = \hat{\delta} \, \sqrt{u(M)^2-\tilde{\sigma}_E^2} \ee
