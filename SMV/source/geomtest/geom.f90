...
WRITE(LU_GEOM(1)) STIME
WRITE(LU_GEOM(1)) N_VERT_S_VALS,N_VERT_D_VALS,N_FACE_S_VALS,N_FACE_D_VALS
IF (N_VERT_S_VALS>0) WRITE(LU_GEOM(1)) (REAL(VERTS(I),FB), I=1,3*N_VERT_S_VALS)
IF (N_VERT_D_VALS>0) WRITE(LU_GEOM(1)) (REAL(VERTS(I),FB),I=1,3*N_VERT_D_VALS)
IF (N_FACE_S_VALS>0) WRITE(LU_GEOM(1)) (FACES(I), I=1,3*N_FACE_S_VALS)
IF (N_FACE_D_VALS>0) WRITE(LU_GEOM(1)) (FACES(I),I=1,3*N_FACE_D_VALS)
