...
For example, suppose that a 1~m column of smoke has opacity of 0.5.  Substituting $\Delta x=1$ and $\alpha=1/2$ into (\ref{eq:alpha}) gives $ks=-\ln(1/2)$.  Solving for $\Delta x$ in (\ref{eq:alpha}) using this value of $ks$ and $\alpha=1/255$ gives
\begin{equation}
