...
the {\ct TABL} function.  In the example below, the spray pattern is defined as two 10 m/s and 20 kg/s jets
...
lines.  For a spray pattern, specify one or more {\ct TABL} lines of the format:
...
and flow rate (kg/s) for that solid angle.  The {\ct TABL} lines can be specified in any order.
