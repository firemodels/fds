...
This section contains a description and results for simulations of three Douglas fir tree fires. Measured properties for the specific types of grasses burned in the two experiments are listed in Table~\ref{Properties_Trees}. Properties that were not measured are listed in Table~\ref{Assumed_Properties_Trees}. These assumed properties are typically for wood or cellulosic fuels. The moisture is modeled as water. The vegetation is assumed to be composed primarily of cellulose.

Snapshots of the simulation of the 2~m, 14~\% case are shown in Fig.~\ref{tree_snaps}. The computational domain in this case is 2~m by 2~m by 4~m. The grid cells are 5~cm cubes. The pine needles are represented by 100,000 Lagrangian particles with a cylindrical geometry, or about 25 simulated needles per grid cell. The radius of the cylinder is derived from the measured surface area to volume ratio. Each simulated pine needle represents many more actual needles. The weighting factor is determined from the estimated bulk mass per unit volume.

The results of the simulations are shown in Fig.~\ref{NIST_Douglas_Fir_MLR}. 
...
Crown Height                    & m             & 1.9           & 1.9           & 4.2        \\ \hline
Base Height                     & m             & 0.15          & 0.15          & 0.3        \\ \hline
Base Width                      & m             & 1.7           & 1.7           & 2.9        \\ \hline
Surface Area to Volume Ratio    & m$^{-1}$      & 3940          & 3940          & 3940       \\ \hline
Initial Mass                    & kg            & 9.7           & 13.5          & 57.9       \\ \hline
Bulk Mass per Unit Volume       & kg/m$^3$      & 4.45          & 6.2           & 6.2        \\ \hline
Moisture Fraction               & \%            & 14            & 49            & 26         \\ \hline
\end{tabular}
\end{center}
\end{table}
