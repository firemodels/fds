...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: &
            ...
            CSD2,MIX_TIME,STRAIN_RATE,KFST4,RHO_H_S_OVER_PBAR,D_RHSOP_DT,D_RHSOP_DT_S
   ...
   INTEGER :: N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS,N_GHOST_WALL_CELLS, &
   ...
   TYPE(STORAGE_TYPE), POINTER, DIMENSION(:) :: PARTICLE_STORAGE,ONE_D_WALL_STORAGE
   INTEGER :: NLP,NLPDIM
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
          U,V,W,US,VS,WS,DDDT,D,DS,H,HS,KRES,FVX,FVY,FVZ,RHO,RHOS, &
          MU,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION, &
          CSD2,MTR,MSR,WEM,MIX_TIME,STRAIN_RATE,KFST4,RHO_H_S_OVER_PBAR,D_RHSOP_DT,D_RHSOP_DT_S
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: ZZ,ZZS,DEL_RHO_D_DEL_Z
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: AVG_DROP_DEN,AVG_DROP_TMP,AVG_DROP_RAD,AVG_DROP_AREA
REAL(EB), POINTER, DIMENSION(:,:,:)   :: AVG_DROP_DEN_ALL
REAL(EB), POINTER, DIMENSION(:,:) :: UVW_GHOST
...
INTEGER, POINTER, DIMENSION(:,:) :: WALL_INDEX
LOGICAL, POINTER, DIMENSION(:) :: SOLID,EXTERIOR
INTEGER, POINTER :: N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS,N_GHOST_WALL_CELLS, &
                    CELL_COUNT,WALL_COUNTER
...
TYPE(OMESH_TYPE), POINTER, DIMENSION(:) :: OMESH
TYPE(LAGRANGIAN_PARTICLE_TYPE), POINTER, DIMENSION(:) :: LAGRANGIAN_PARTICLE
TYPE(STORAGE_TYPE), POINTER, DIMENSION(:) :: ONE_D_WALL_STORAGE,PARTICLE_STORAGE
...
D_RHSOP_DT=>M%D_RHSOP_DT
D_RHSOP_DT_S=>M%D_RHSOP_DT_S
KRES=>M%KRES
FVX=>M%FVX
FVY=>M%FVY
FVZ=>M%FVZ  
...
ONE_D_WALL_STORAGE =>M%ONE_D_WALL_STORAGE
NLP=>M%NLP 
NLPDIM=>M%NLPDIM
HUMAN =>M%HUMAN  
N_HUMANS=>M%N_HUMANS  
