...
\begin{center}
\begin{tabular}{l}
\includegraphics[width=6.0in]{FIGURES/Scatterplots/Plume_Temperature_Heskestad} \\
\includegraphics[width=6.0in]{FIGURES/Scatterplots/Plume_Temperature_McCaffrey}
\end{tabular}
\end{center}
