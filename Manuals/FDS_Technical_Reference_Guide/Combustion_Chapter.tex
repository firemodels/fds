...
\end{equation}
where the initial mass fractions of species are 0.4 N$_{2}$, 0.3 O$_2$, and 0.3 CH$_4$. Following the predictor-corrector scheme, the change in methane concentration, $\Delta \hat{Y}_{\rm F}$, is $-$0.3. The corresponding change is oxygen is
