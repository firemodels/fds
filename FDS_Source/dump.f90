...
USE TURBULENCE, ONLY: WAVELET_ERROR_MEASURE,MEASURE_SCALAR_RESOLUTION
REAL(EB), INTENT(IN) :: T
...
SELECT CASE(IND)
   ...
   CASE(51)  ! MSR (measure of scalar resolution)
      GAS_PHASE_OUTPUT = MEASURE_SCALAR_RESOLUTION(II,JJ,KK,SPEC_INDEX,NM)
      
   CASE(52)  ! WEM (wavelet error measure)
      GAS_PHASE_OUTPUT = WAVELET_ERROR_MEASURE(II,JJ,KK,SPEC_INDEX,NM)
