...
! static geometry
  ...
  IF (N_FACE_STATIC>0)  WRITE(LU_GEOM) (FACE1_S(I),FACE2_S(I),FACE3_S(I)),I=1,N_FACE_STATIC)
  IF (N_VERT_DYNAMIC>0) WRITE(LU_GEOM) (Xvert_D(I),Yvert_D(I),Zvert_D(I)),I=1,N_VERT_DYNAMIC)
  IF (N_FACE_DYNAMIC>0) WRITE(LU_GEOM) (FACE1_D(I),FACE2_D(I),FACE3_D(I)),I=1,N_FACE_DYNAMIC)
...
\begin{verbatim}
  ...
  WRITE(LU_GEOM_DATA) N_VERT_STATIC,N_FACE_STATIC,N_VERT_DYNAMIC,NFACE_DYNAMIC
