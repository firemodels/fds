...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ZETA_SOURCE_TERM,EXTINCTION_MODEL,HRRPUV_MAX_SMV,INITIAL_UNMIXED_FRACTION,&
                MAX_CHEMISTRY_SUBSTEPS,N_FIXED_CHEMISTRY_SUBSTEPS,ODE_SOLVER,RADIATIVE_FRACTION,RICHARDSON_ERROR_TOLERANCE,&
                SUPPRESSION,TAU_CHEM,TAU_FLAME,TEMPERATURE_DEPENDENT_REACTION,TRANSPORT_UNMIXED_FRACTION,TRANSPORT_ZETA_SCHEME,&
                WD_PROPS
...
IF (RADIATIVE_FRACTION >=0._EB) THEN
   CALL SHUTDOWN('ERROR: RADIATIVE_FRACTION is now specified on REAC or COMB.')
   RETURN
ENDIF
