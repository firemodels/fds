...
ELSE
   IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),LP%BC_INDEX,UNPACK_IT)
   IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),LP%OD_INDEX,UNPACK_IT)
   IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),LP%TAG,UNPACK_IT)
   IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),LP%LP_INDEX,UNPACK_IT)     
ENDIF
...
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),LP%WALL_INDEX,UNPACK_IT)   
...
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,STORAGE_INDEX),LP%CFACE_INDEX,UNPACK_IT)
...
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),LP%M_DOT,UNPACK_IT)
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),LP%HTC_LIMIT,UNPACK_IT)
...
IF (LPC%N_ORIENTATION>0) THEN
   ...
   DO NN=1,NUMBER_SPECTRAL_BANDS
      ...
      CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , LP%BAND(NN)%ILW(1:NUMBER_RADIATION_ANGLES), UNPACK_IT)
   ENDDO

   I1 = I2+1 ; I2 = I1 + NUMBER_SPECTRAL_BANDS - 1
   CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , LP%IL(1:I2-I1+1), UNPACK_IT)
...
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),WC%WALL_INDEX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),WC%BC_INDEX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),WC%OD_INDEX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),WC%BP_INDEX,UNPACK_IT)
...
IF (WC%BP_INDEX>0) CALL PACK_BOUNDARY_PROPERTY(NM,RC,OS,1,WC%BP_INDEX,UNPACK_IT)
...
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),CFA%CFACE_INDEX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),CFA%BC_INDEX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),CFA%OD_INDEX,UNPACK_IT)
IC=IC+1 ; CALL EQUATE(OS%INTEGERS(IC,1),CFA%BP_INDEX,UNPACK_IT)
...
IF (CFA%BP_INDEX>0) CALL PACK_BOUNDARY_PROPERTY(NM,RC,OS,1,CFA%BP_INDEX,UNPACK_IT)
...
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),ONE_D%RSUM_G,UNPACK_IT)
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),ONE_D%TMP_G,UNPACK_IT)
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),ONE_D%RHO_G,UNPACK_IT)
...
RC=RC+1 ; CALL EQUATE(OS%REALS(RC,STORAGE_INDEX),ONE_D%MU_G,UNPACK_IT)
...
DO NN=1,SF%N_MATL
   ...
   CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , ONE_D%MATL_COMP(NN)%RHO(0:SF%N_CELLS_MAX+1) , UNPACK_IT)
ENDDO
...
CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , ONE_D%ZZ_G(1:I2-I1+1) , UNPACK_IT)
...
CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , ONE_D%K_S(0:SF%N_CELLS_INI+1) , UNPACK_IT)
...
DO NN=1,SF%N_MATL
   I1 = I2+1 ; I2 = I1 + (SF%N_CELLS_MAX+2) - 1
   CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , ONE_D%MATL_COMP(NN)%RHO_DOT(0:SF%N_CELLS_MAX+1) , UNPACK_IT)
ENDDO

DO NN=1,SF%N_SPEC
   I1 = I2+1 ; I2 = I1 + (SF%N_CELLS_MAX+2) - 1
   CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , ONE_D%SPEC_COMP(NN)%RHO_ZZ(0:SF%N_CELLS_MAX+1) , UNPACK_IT)
ENDDO
...
!> \brief Pack or unpack BOUNDARY_PROPERTY components into 1-D arrays
!> \param NM Mesh number
!> \param RC Real Counter
!> \param OS Storage array
!> \param STORAGE_INDEX Column within storage array
!> \param BP_INDEX Index within BOUNDARY_PROPERTY array
!> \param UNPACK_IT Logical indicating whether to pack or unpack

SUBROUTINE PACK_BOUNDARY_PROPERTY(NM,RC,OS,STORAGE_INDEX,BP_INDEX,UNPACK_IT)
...
BP => MESHES(NM)%BOUNDARY_PROPERTY(BP_INDEX)
...
DO NN=1,NUMBER_SPECTRAL_BANDS
   I1 = I2+1 ; I2 = I1 + NUMBER_RADIATION_ANGLES - 1
   CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX),BP%BAND(NN)%ILW(1:NUMBER_RADIATION_ANGLES),UNPACK_IT)
ENDDO

I1 = I2+1 ; I2 = I1 + BOUNDARY_PROPERTY_REALS_ARRAY_SIZE(6) - 1
CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX),BP%IL(1:I2-I1+1),UNPACK_IT)

RC = I2

END SUBROUTINE PACK_BOUNDARY_PROPERTY
