...
The simple test case called {\ct activate\_vents} demonstrates the several of the control functions. Figure~\ref{activate_vents_fig} shows seven
...
\hline \hline
\endhead
%{\ct AUTO\_IGNITION\_TEMPERATURE} & Real              & Auto-ignition temperature                     & \si{\degree C} & {-273.15}     \\ \hline
