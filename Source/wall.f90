...
HTC_MODEL_SELECT: SELECT CASE(SFX%HEAT_TRANSFER_MODEL)
   CASE(DEFAULT_HTC_MODEL)
      ...
      CALL NATURAL_CONVECTION_MODEL(H_NATURAL,DELTA_TMP,SFX%GEOMETRY,BCX%IOR,K_G,CONV_LENGTH)
   CASE(BOUNDARY_FUEL_HTC_MODEL)  ! Same as DEFAULT_HTC_MODEL but for a cylindrical object
      ...
      CALL NATURAL_CONVECTION_MODEL(H_NATURAL,DELTA_TMP,SURF_CYLINDRICAL,BCX%IOR,K_G,CONV_LENGTH)
