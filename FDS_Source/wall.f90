...
USE PHYSICAL_FUNCTIONS, ONLY: GET_CONDUCTIVITY,GET_VISCOSITY
...
REAL(EB) :: RE,U2,V2,W2,H_NATURAL,H_FORCED,NUSSELT,VELCON,FRICTION_VELOCITY,YPLUS,RHO_G,TMP_G,TMP_F,DN,TMP_FILM,MU_G,K_G, &
...
HTC_MODEL_SELECT: SELECT CASE(HT_MODEL)
   ...
   CASE(H_LOGLAW)
      H_NATURAL = 0._EB
      CALL HEAT_FLUX_MODEL(H_FORCED,YPLUS,FRICTION_VELOCITY,K_G,RHO_G,CP_Z(ITMP,1),MU_G)
   CASE(H_ABL)
      H_NATURAL = 0._EB
