...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:,:) :: SCALAR_SAVE1,SCALAR_SAVE2,SCALAR_SAVE3,SCALAR_SAVE5 !!,SCALAR_SAVE4
...
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: SCALAR_SAVE1,SCALAR_SAVE2,SCALAR_SAVE3,SCALAR_SAVE5 !!,SCALAR_SAVE
