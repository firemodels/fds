...
!$OMP PRIVATE(TAU_D,TAU_G,TAU_U,DUDX,DUDY,DUDZ,DVDX,DVDY,DVDZ,DWDX,DWDY,DWDZ,SS2,S12,S13,S23,EPSK,KSGS) SCHEDULE(DYNAMIC)
DO K=1,KBAR
   DO J=1,JBAR
      DO I=1,IBAR
         IC = CELL_INDEX(I,J,K)
...
CONVERT_CO: IF (CO_PRODUCTION) THEN 
   ...
   !$OMP DO COLLAPSE(3) PRIVATE(K,J,I,Y_O2_0,Y_CO_0,DYCO,RHOX,X_FU_0,X_O2_0,X_FU,X_O2,ETRM) &
