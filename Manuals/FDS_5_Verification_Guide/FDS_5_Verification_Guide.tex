...
Figure~\ref{water_evaporation} displays the average enthalpy, humidity, density, pressure, temperature and mass of water of the gas. The horizontal lines denote the
...
energy of the system that is conserved:
\be \Delta e = \Delta h - \Delta(p/\rho) \ee
Because the volume of the enclosure is 1~m$^3$, the enthalpy decrease of the liquid water droplets is equal to the enthalpy gain of the gas minus the pressure increase if the
pressure is expressed in units of kPa.
Finally, note that in this example the water droplets evaporate until the air is saturated. Thus, the relative humidity should be equal to 100~\%, but since FDS does not currently compute condensation, a slight overshoot is not unexpected.
