...
SUBROUTINE RNG_EDDY_VISCOSITY(MU_EFF,MU_DNS,RHO,STRAIN_RATE,DELTA)
...
REAL(EB), INTENT(IN) :: MU_DNS,STRAIN_RATE,DELTA,RHO
REAL(EB) :: MU_S,MU2,MU3,MU_EFF_OLD
REAL(EB), PARAMETER :: C_CUTOFF=10._EB
INTEGER :: ITER
...
IF (MU3>TWO_EPSILON_EB) THEN
   DO ITER=1,MAX_IT
      MU_EFF_OLD = MU_EFF
      MU_EFF = MU_DNS*( 1._EB + MAX(0._EB, MU2*MU_EFF/MU3 - C_CUTOFF) )**ONTH
      !print *, ITER, MU_EFF
