...
LOGICAL  :: ABSORBING,LUMPED_SPECIES_ONLY,BACKGROUND
...
COUNT_SPEC_LOOP: DO
   ...
   IF (BACKGROUND) THEN 
      IF (LUMPED_SPECIES_ONLY) THEN
         WRITE(MESSAGE,'(A)') 'ERROR: Cannot define a LUMPED_SPECIES_ONLY species as the BACKGROUND species'
         CALL SHUTDOWN(MESSAGE)
      ENDIF
   ...
   ENDIF
   IF (LUMPED_SPECIES_ONLY .AND. MASS_FRACTION_0 > 0._EB) THEN
         WRITE(MESSAGE,'(A)') 'ERROR: Cannot define MASS_FRACTION_0 for a LUMPED_SPECIES_ONLY species'
         CALL SHUTDOWN(MESSAGE)
   ENDIF
...
SPEC_READ_LOOP: DO N=1,N_SPEC_READ
   ...
   IF (.NOT. BACKGROUND .AND. .NOT. LUMPED_SPECIES_ONLY) THEN
   ...
   SELECT CASE (ID)
      ...
      CASE('CARBON DIOXIDE')
         CO2_INDEX = N
         IF (.NOT. LUMPED_SPECIES_ONLY) I_CO2   = SS%Y_INDEX
      CASE('CARBON MONOXIDE')
         CO_INDEX = N
         IF (.NOT. LUMPED_SPECIES_ONLY) I_CO    = SS%Y_INDEX
      CASE('OXYGEN')
         O2_INDEX = N
         IF (.NOT. LUMPED_SPECIES_ONLY) I_O2    = SS%Y_INDEX
      CASE('NITROGEN')
         N2_INDEX = N
         IF (.NOT. LUMPED_SPECIES_ONLY) I_N2    = SS%Y_INDEX
      CASE('HYDROGEN')
         H2_INDEX = N
         IF (.NOT. LUMPED_SPECIES_ONLY) I_H2    = SS%Y_INDEX
      CASE('SOOT')
         SOOT_INDEX = N
         IF (.NOT. LUMPED_SPECIES_ONLY) I_SOOT  = SS%Y_INDEX
