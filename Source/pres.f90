...
#endif
#ifdef WITH_PETSC
INTEGER :: IROW, JCOL, DUM1(1), DUM2(1)
#endif
!.. All other variables
...
CALL MATCREATESEQAIJ(PETSC_COMM_SELF,ZM%NUNKH,ZM%NUNKH,NNZ_7PT_H,PETSC_NULL_INTEGER_ARRAY,ZM%PETSC_MZ%A_H,PETSC_IERR)
...
DO IROW=1,ZM%NUNKH
   DO JCOL=1,NNZ_H_MAT(IROW)
      ...
      CALL MATSETVALUES(ZM%PETSC_MZ%A_H,1,DUM1(1),1,DUM2(1),D_H_MAT(JCOL,IROW),INSERT_VALUES,PETSC_IERR)
   ENDDO
ENDDO
