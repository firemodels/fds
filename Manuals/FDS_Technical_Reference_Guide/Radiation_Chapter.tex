...
\displaystyle\int_{\om_{\rm min}}^{\om_{\rm max}}{I^o_{b\om}(T)
...
$\bar{\kappa}_i$ is the spectral absorptivity of the $i^{th}$ participating species, in units of
${\rm atm^{-1}cm^{-2}}$. The Planck function, $I^o_{b\om}(T)$ represents the 
intensity of blackbody radiation at temperature $T$ and at a wavenumber $\om$.
It has for expression:
\be
I^o_{b\om}(T) = \dfrac{2h c^2\om^3}{\exp\left(\dfrac{hc\om}{k_BT}\right)-1}
\ee
where $h$ is the Planck constant, $c$ is the speed of light in vacuum, $k_B$ is the
Boltzmann constant.
...
\be
  \alpha_i(T) = \displaystyle\int_{Band}\bar{\kappa}_i(T) \; d\om,
\ee
...
Carbon Dioxide, $\rm CO_2$, is a linear molecule and has four vibrational modes, but only two fundamental IR vibration frequencies. It has five distinct bands that are included in RADCAL, see Table \ref{Table::CO2}.
\begin{table}[ht]
    \centering
...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
      \hline
      Band \# & \multicolumn{2}{|l|}{Bounds (cm$\rm ^{-1}$) } & Method & Assignment & $\alpha(T=296K)$\\
      \cline{1-6}
    ...
    \end{tabular}
\end{table}
Band~1 is the strongest absorbing band with an integrated band intensity of $366\;\rm {atm^{-1}cm^{-2}}$. Band~4 has the second strongest integrated band intensity: $\alpha = 183\;\rm {atm^{-1}cm^{-2}}$.
...
\begin{table} [ht]
    ...
    \end{tabular}
\end{table}
Band~3 corresponds to the stretching of $\rm CH$ and is the strongest absorbing band. At standard temperature and pressure,
its integrated band intensity is $\alpha = 761\;\rm {atm^{-1}cm^{-2}}$. This is more than 10 times the value of 
Band~2: $\alpha = 64\;\rm {atm^{-1}cm^{-2}}$, and more than 20 times the value of Band~1: $\alpha = 29\;\rm {atm^{-1}cm^{-2}}$.
...
\begin{table}[ht]
   ...
   \end{tabular}
\end{table}
Band~3 corresponds to the stretching of $\rm CH$ and is the strongest of all Propylene absorbing bands. At standard temperature and pressure, its integrated band intensity is equal to $509\;\rm {atm^{-1}cm^{-2}}$. Bands~1 and 2 have similar lower integrated intensities: $296\;\rm {atm^{-1}cm^{-2}}\;and\; 271\;\rm {atm^{-1}cm^{-2}}$, respectively.
...
\begin{table}[ht]
   ...
   \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    Band \# & \multicolumn{2}{|l|}{Bounds (cm$\rm ^{-1}$) } & Method & Assignment & $\alpha(T=295K)$ \\
    \cline{1-6}
   ...
   \end{tabular}
\end{table}
Band~2 corresponds to the stretching of $\rm CH_3$ and $\rm CH_2$ and is the strongest of all propane absorbing bands. At standard temperature and pressure, its integrated band intensity is $1186\;\rm {atm^{-1}cm^{-2}}$. For similar conditions, Band~1 has a much lower integrated band intensity: $\alpha = 121\;\rm {atm^{-1}cm^{-2}}$.
...
\begin{table}[ht]
   ...
   \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    Band \# & \multicolumn{2}{|l|}{Bounds (cm$\rm ^{-1}$) } & Method & Assignment & $\alpha(T=300K)$\\
    \cline{1-6}
   ...
   \end{tabular}
\end{table}
Band~5 corresponds to the stretching of $\rm CH_3$ and $\rm CH$, and it is the strongest absorbing band. At 300~K, its integrated band intensity is $510\;\rm {atm^{-1}cm^{-2}}$. At similar conditions, the integrated band intensity of Band~1 is less than half of that of Band~5: $237\;\rm {atm^{-1}cm^{-2}}$. Bands~3, 4, and 2 have integrated intensities of 166$\;\rm {atm^{-1}cm^{-2}}$, 101$\;\rm {atm^{-1}cm^{-2}}$, and $40\;\rm {atm^{-1}cm^{-2}}$, respectively.
...
\begin{table}[ht]
   ...
   \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    Band \# & \multicolumn{2}{|l|}{Bounds (cm$\rm ^{-1}$) } & Method & Assignment & $\alpha(T=293K)$\\
    \cline{1-6}
   ...
   \end{tabular}
\end{table}
Band~2 corresponds to the stretching of $\rm CH_3$ and $\rm CH_2$ groups, and is the strongest absorbing band. At 293~K, its integrated band intensity is equal to $3055\;\rm {atm^{-1}cm^{-2}}$. At similar conditions, the integrated band intensity of Band~1 is less than ten times that of Band~2: $\alpha = 298\;\rm {atm^{-1}cm^{-2}}$.
...
\begin{table}[ht]
   ...
   \end{tabular}
\end{table}
Band~3 corresponds to the stretching of the $\rm CH_3$ group and is the strongest absorbing band. 
At 293~K, its integrated band intensity is $684\;\rm {atm^{-1}cm^{-2}}$. Second in intensity, 
Band~1 corresponds to the stretching of the $\rm C-O$ group and has an integrated band intensity of
 $593\;\rm {atm^{-1}cm^{-2}}$. Bands~2 and 4 have lesser integrated intensities,
 $197\;\rm {atm^{-1}cm^{-2}}$ and $112\;\rm {atm^{-1}cm^{-2}}$, respectively.
...
\begin{table}[ht]
   ...
   \label{Table::C5H8O2}
    \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    Band \# & \multicolumn{2}{|l|}{Bounds (cm$\rm ^{-1}$) } & Method & Assignment &  $\alpha(T=396K)$ \\
    \cline{1-6}
   ...
   \end{tabular}
\end{table}
Band~3 corresponds to the stretching of the $\rm C-O$ group and has the highest integrated band intensity.
At 396~K, $\alpha = 800\;\rm {atm^{-1}cm^{-2}}$. Band~5 corresponds to the stretching of
the $\rm C=O$ and $\rm C=C$ groups, and has the second highest integrated
intensity: $538\;\rm {atm^{-1}cm^{-2}}$.
...
$\bar{\kappa}_i(T)$. Narrow band models are a category of mathematical
approaches circumventing the intractability of using a line-by-line model to
compute accurately the IR spectrum of radiating species when solving for the RTE
in engineering applications. In the narrow band approach, the whole spectrum is
divided into small spectral bands (typically several $\rm cm^{-1}$), and
different statistical approaches are considered to compute the average radiative
...
species partial pressure), is given by the relation:
\be\label{eq::Elsasser}
    \bar{\tau}_{\om} = 1- \erf \left(\displaystyle\frac{\sqrt{\pi} \bar{
    \kappa}_i U }{\sqrt{1 + \displaystyle\frac{\pi\bar{\kappa}_i U
    }{4 \bar{\gamma}_i P_T}}}  \right),
\ee
with $\bar{\gamma}_i$ being the spectral fine structure parameter of the narrow
band, its units are in $\rm atm^{-1}$, and $\bar{\kappa}_i$ is the spectral absorption coefficient of the narrow
band its units are in $\rm atm^{-1}cm^{-1}$.

The Goody model assumes all the lines to have the same shape, but to be randomly
spaced within the narrow band, and their line strength follows an exponential
distribution. In this model, the spectral transmissivity, $\bar{\tau}_{\om}$, of a homogeneous isothermal column filled
with only some gas of species $i$,
at a total pressure $P_T$ and with an optical pathlength $U = P_i L$ ($L$
being the column physical length and $P_i$ the $i^{th}$ participating radiating
species partial pressure), is given by the relation:
\be\label{eq::Goody}
    \bar{\tau}_{\om} = \exp\left(-\displaystyle\frac{\bar{\kappa}_i U}
    {\displaystyle\sqrt{1+\displaystyle\frac{\bar{\kappa}_i U}{4 P_T
\bar{\gamma}_i}}}\right),
\ee
with $\bar{\gamma}_i$ being the spectral fine structure parameter of the narrow
band, its units are in $\rm atm^{-1}$, and $\bar{\kappa}_i$ is the spectral absorption coefficient of the narrow
...
For both models, the two narrow band spectral quantities of the $i^{th}$ species ($\bar{\kappa}_i \;\&\;
...
$\bar{\kappa}_i \;\&\; \bar{\gamma}_i$ in temperature and/or in wavenumber is
