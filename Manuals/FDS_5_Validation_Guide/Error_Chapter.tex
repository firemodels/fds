...
\be \ln(E)|\theta \sim N \left( \ln(\theta)- \frac{\widetilde{\sigma}_E^2}{2} \, , \,\widetilde{\sigma}_E^2 \right) \label{eeq} \ee
...
\be \ln(\theta)|E \sim N \left( \ln(E)+ \frac{\widetilde{\sigma}_E^2}{2} \, , \, \widetilde{\sigma}_E^2 \right) \label{thetaeq} \ee
...
\be \ln(M)|\theta \sim N \left(\ln(\delta)+\ln(\theta)-\frac{\widetilde{\sigma}_M^2}{2} \; , \;
    \widetilde{\sigma}_M^2 \right) \quad ; \quad \widetilde{\sigma}_M=\frac{\sigma_M}{\delta \, \theta} \ee
...
\be \ln(M) \sim N \left( \ln(\delta)+\ln(E)- \frac{\widetilde{\sigma}_M^2}{2}+\frac{\widetilde{\sigma}_E^2}{2} \; ,
...
\be u(M) = \sqrt{\widetilde{\sigma}_M^2+\widetilde{\sigma}_E^2} \approx \sqrt{ \frac{1}{n-1} \sum_{i=1}^n \,
     \left[ (\ln(M_i)-\overline{M}) - (\ln(E_i) - \overline{E})  \right]^2 } \ee
Note that $u(M)$ is the {\em total relative uncertainty} of $M$.
Next, compute the estimate for the model error:
\be \widetilde{\sigma}_M \approx \sqrt{u(M)^2-\widetilde{\sigma}_E^2} \label{model_error} \ee
...
\be \hat{\delta} \approx \exp \left( \overline{M}-\overline{E}+\frac{\widetilde{\sigma}_M^2}{2}-\frac{\widetilde{\sigma}_E^2}{2} \right) \ee
...
\be \theta \sim N \left( \frac{M}{\hat{\delta}} \; , \; \left( M \, \widetilde{\sigma}_M \right)^2 \right) \label{truth} \ee
...
\be \mu = 20 + \frac{M}{\delta} = 20 + \frac{330}{1.03} = 340.4 \; ^\circ \hbox{C}  \quad ; \quad  \sigma = \widetilde{\sigma}_M \, M = 0.10 \times 330 = 33 \; ^\circ \hbox{C}  \ee
