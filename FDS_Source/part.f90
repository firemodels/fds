...
Y_EQ_Z_LOOP: DO NS = 1,N_TRACKED_SPECIES
   ...
   CALL INTERPOLATE1D_UNIFORM(LBOUND(SS%C_P_L_BAR,1),SS%C_P_L_BAR,TMP_MELT,H_L_REF)
...
!$OMP        TMPA,AVG_DROP_DEN,PI,OMRAF,NU_FAC_WALL,SH_FAC_WALL,QR_W) &
   ...
   !$OMP         H_V_REF,PRESSURE_ZONE,MU_LIQUID,GVEC,CONSTANT_H_SOLID,PBAR,BETA_LIQUID,P_STP)
