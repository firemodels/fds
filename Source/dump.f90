...
DEVICE_LOOP: DO N=1,N_DEVC
   ...
   SELECT CASE (DV%TEMPORAL_STATISTIC)
      ...
      CASE('COV')
         ...
         DV%COV_VALUE = (1._EB-WGT)*DV%COV_VALUE + WGT*(DV%INSTANT_VALUE-DV%AVERAGE_VALUE)*(DV%VALUE_2-DV%AVERAGE_VALUE2)
      ...
      CASE('CORRCOEF')
         ...
         DV%COV_VALUE  = (1._EB-WGT)*DV%COV_VALUE + WGT*(DV%INSTANT_VALUE-DV%AVERAGE_VALUE)*(DV%VALUE_2-DV%AVERAGE_VALUE2)
         DV%RMS_VALUE  = (1._EB-WGT)*DV%RMS_VALUE + WGT*(DV%INSTANT_VALUE-DV%AVERAGE_VALUE )**2
         DV%RMS_VALUE2 = (1._EB-WGT)*DV%RMS_VALUE2+ WGT*(DV%VALUE_2      -DV%AVERAGE_VALUE2)**2
