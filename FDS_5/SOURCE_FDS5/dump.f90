...
SELECT CASE(IND)
   ...
   CASE(41:49,141:149,151:154) ! Mixture Fraction Related Quantities
      ...
      CALL GET_MASS_FRACTION2(Z_1,Z_2,Z_3,INDX,Y_SUM(II,JJ,KK),Y_MF_INT)
      SELECT CASE(IND)
   ...
   CASE(155) ! path obscuration
      ...
      DO NN=1,DV%N_PATH
         ...
         CALL GET_MASS_FRACTION2(Z_1,Z_2,Z_3,SOOT_INDEX,Y_SUM(I,J,K),Y_MF_INT)
   ...
   CASE(158) ! spot obscuration
      ...
      ELSE
         Z_2 = 0._EB
      ENDIF
      CALL GET_MASS_FRACTION2(YY(I,J,K,I_FUEL),Z_2,YY(I,J,K,I_PROG_F),SOOT_INDEX,Y_SUM(I,J,K),Y_E)
      VEL2 = 0.25_EB*( (U(I,J,K)+U(I-1,J,K))**2 + (V(I,J,K)+V(I,J-1,K))**2 + (W(I,J,K)+W(I,J,K-1))**2 )
...
REAL(EB) :: VC,Z_1,Z_2,Z_F,Y_MF_INT(9)
INTEGER, INTENT(IN) :: NM
INTEGER :: I,J,K,N,NN
