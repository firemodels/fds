...
TYPE PROPERTY_TYPE
   REAL(EB) :: BEAD_DENSITY,BEAD_DIAMETER,BEAD_EMISSIVITY,BEAD_H_FIXED,BEAD_SPECIFIC_HEAT,RTI, &
               ...
               CONDUIT_DIAMETER,CONDUIT_THICKNESS,DT_INSERT,P0=0._EB,PX(3)=0._EB,PXX(3,3)=0._EB
   INTEGER  :: PDPA_M=0,PDPA_N=0,N_SMOKEVIEW_PARAMETERS=0,N_SMOKEVIEW_IDS=0,N_INSERT,I_VEL=0
