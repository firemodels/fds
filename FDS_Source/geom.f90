...
MAIN_MESH_LOOP : DO NM=1,NMESHES
   ...
   IBM_CUTCELLS_FOUND_MESH = NXB * NYB * NZB ! Beast approach. NEED TO REFINE THIS.
      ...
      DO K=KLO,KHI
         DO J=JLO,JHI
            DO I=ILO,IHI
               ...
               !    print*, ' '
               !    print*, ISEG,', nbcross=',IBM_BODINT_PLANE%NBCROSS(ISEG)
               !    DO ICROSS=1,IBM_BODINT_PLANE%NBCROSS(ISEG)
               !       print*, ISEG,', ibcross=',ICROSS,', ',IBM_BODINT_PLANE%SVAR(ICROSS,ISEG)
               !    ENDDO
               ! ENDDO
               ! print*, "NCUTEDGE=",MESHES(NM)%IBM_NCUTEDGE_MESH
               ! pause
               ...
               !
               ! print*, "NCUTEDGE 2=",MESHES(NM)%IBM_NCUTEDGE_MESH
               ! pause
...
ENDDO
IBM_MAX_NBCROSS = 1 * CEILING(MAX_LEDGE/MIN(DX2_MIN, DX3_MIN)) ! Rough estimate. Might need to increase 
                                                               ! the 1 factor.
...
INTEGER :: ILO,IHI,JLO,JHI,KLO,KHI
INTEGER :: I,J,K,II,II2,JJ,KK, CEI
...
INTEGER :: ICF1, ICF2, ICF_PT, IPT, NP, NP2, NFACE2
         ...
         DO JJ=X2LO,X2HI
          ...
          IF( CEI > 0 ) THEN ! There are inboundary cut-edges
             ...
             DO IEDGE=1,NEDGE
                ...
                NSEG = NSEG + 1
                SEG_FACE(NOD1:NOD2,NSEG) = (/ INOD1, INOD2 /)
                DX3 = XYZVERT(INOD2,X3AXIS)-XYZVERT(INOD1,X3AXIS)
                DX2 = XYZVERT(INOD2,X2AXIS)-XYZVERT(INOD1,X2AXIS)
