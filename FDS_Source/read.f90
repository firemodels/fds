...
NAMELIST /MISC/ PR,SC,TMPA,GVEC,PRESSURE_RELAX_FACTOR,RELAXATION_FACTOR,FYI, &
                ...
                VEG_LEVEL_SET,CP_FTMP,HRRPUV_MAX_SMV,EXTINCTION2,TERRAIN_IMAGE, &
                MEAN_FORCING_U,MEAN_FORCING_V,MEAN_FORCING_W,RFAC_FORCING
...
IF (MEAN_FORCING_U) MEAN_FORCING=.TRUE.
IF (MEAN_FORCING_V) MEAN_FORCING=.TRUE.
IF (MEAN_FORCING_W) MEAN_FORCING=.TRUE.
...
NAMELIST /SLCF/ XB,QUANTITY,FYI,PBX,PBY,PBZ,VECTOR,MESH_NUMBER,RLE,MAXIMUM_VALUE,MINIMUM_VALUE,TWO_BYTE,SPEC_ID, &
                AGL_SLICE,PART_ID,CELL_CENTERED,FIRE_LINE,EVACUATION,VELO_INDEX,LEVEL_SET_FIRE_LINE
