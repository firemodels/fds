...
IF (TREE_CASE .AND. T > VEG_CLOCK) THEN
!      CALL MPI_GATHERV(VEG_TOTAL_DRY_MASS(DISP),  CNT,MPI_DOUBLE_PRECISION,VEG_TOTAL_DRY_MASS,COUNTS,DISPLS,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
!      CALL MPI_GATHERV(VEG_TOTAL_MOIST_MASS(DISP),CNT,MPI_DOUBLE_PRECISION,VEG_TOTAL_MOIST_MASS,COUNTS,DISPLS,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,IERR)
