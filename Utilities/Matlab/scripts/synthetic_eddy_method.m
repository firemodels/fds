...
if umean_error>error_tolerance
    display(['Warning: sem_flat_leddy_p2.fds umean_error = ',umean_error])
end
    
urms_error = norm(umean+urms-1.1*uprof)/u0/length(umean);
if urms_error>error_tolerance
    display(['Warning: sem_flat_leddy_p2.fds urms_error = ',urms_error])
end
...
if umean_error>error_tolerance
    display(['Warning: sem_par_leddy_p2.fds umean_error = ',umean_error])
end

urms_error = norm(umean+urms-1.1*uprof)/umax/length(umean);
if urms_error>error_tolerance
    display(['Warning: sem_par_leddy_p2.fds urms_error = ',urms_error])
end
...
umean_error = norm(umean-uprof)/u0/length(umean);
if umean_error>error_tolerance
    display(['Warning: sem_atm_leddy_p2.fds umean_error = ',umean_error])
end

urms_error = norm(umean+urms-1.1*uprof)/u0/length(umean);
if urms_error>error_tolerance
    display(['Warning: sem_atm_leddy_p2.fds urms_error = ',urms_error])
end
