...
REAL(EB) :: ARO,ZZ_GET(1:N_TRACKED_SPECIES),RHO_OTHER,RHO_ZZ_OTHER(1:N_TOTAL_SCALARS),&
            RSUM_TMP,RHO_OTHER_2,RHO_ZZ_OTHER_2(1:N_TOTAL_SCALARS)
INTEGER :: IIO,JJO,KKO,II2,JJ2,KK2
...
! Assign RHOP and ZZP to the second ghost cell
...
TMP(BC%II2,BC%JJ2,BC%KK2) = PBAR_P(BC%KK,B1%PRESSURE_ZONE)/(RSUM_TMP*RHOP(BC%II2,BC%JJ2,BC%KK2))
         ...
         IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
            SELECT CASE(BC%IOR)
               CASE( 1)
                  ...
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%II-1,BC%JJ,BC%KK,1:N_TRACKED_SPECIES)
               CASE(-1)
                  ZZ_GET(1:N_TRACKED_SPECIES) = ZZP(BC%IIG-1,BC%JJG,BC%KKG,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%II+1,BC%JJ,BC%KK,1:N_TRACKED_SPECIES)
               CASE( 2)
                  ZZ_GET(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG+1,BC%KKG,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%II,BC%JJ-1,BC%KK,1:N_TRACKED_SPECIES)
               CASE(-2)
                  ZZ_GET(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG-1,BC%KKG,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%II,BC%JJ+1,BC%KK,1:N_TRACKED_SPECIES)
               CASE( 3)
                  ZZ_GET(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG,BC%KKG+1,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%II,BC%JJ,BC%KK-1,1:N_TRACKED_SPECIES)
               CASE(-3)
                  ZZ_GET(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG,BC%KKG-1,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%II,BC%JJ,BC%KK+1,1:N_TRACKED_SPECIES)
            END SELECT
      ...
      SELECT CASE(BC%IOR)
         CASE( 1)
            IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
               ...
               RHO_OTHER_2 = RHOP(BC%II-1,BC%JJ,BC%KK)
            ENDIF
            ...
            IF (FLUX_LIMITER_SINGLE_COEF) THEN
               B_TEMP(1,1,1) = BFX(BC%II,BC%JJ,BC%KK)
         ...
         CASE( 2)
            IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
               ...
               RHO_OTHER_2 = RHOP(BC%II,BC%JJ-1,BC%KK)
            ENDIF
            ...
            IF (FLUX_LIMITER_SINGLE_COEF) THEN
               B_TEMP(1,1,1) = BFY(BC%II,BC%JJ,BC%KK)
         ...
         CASE( 3)
            IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
               ...
               RHO_OTHER_2 = RHOP(BC%II,BC%JJ,BC%KK-1)
            ENDIF
            ...
            IF (FLUX_LIMITER_SINGLE_COEF) THEN
               B_TEMP(1,1,1) = BFZ(BC%II,BC%JJ,BC%KK)
            ...
            SELECT CASE(BC%IOR)
               CASE( 1)
                  IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
                     ...
                     RHO_ZZ_OTHER_2 = RHOP(BC%II-1,BC%JJ,BC%KK)*ZZP(BC%II-1,BC%JJ,BC%KK,N)
                  ENDIF
               ...
               CASE( 2)
                  IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
                     ...
                     RHO_ZZ_OTHER_2 = RHOP(BC%II,BC%JJ-1,BC%KK)*ZZP(BC%II,BC%JJ-1,BC%KK,N)
                  ENDIF
               ...
               CASE( 3)
                  IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
                     ...
                     RHO_ZZ_OTHER_2 = RHOP(BC%II,BC%JJ,BC%KK-1)*ZZP(BC%II,BC%JJ,BC%KK-1,N)
                  ENDIF
