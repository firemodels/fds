...
!      GAS_PHASE_OUTPUT_RES = REAL(P_MASK(II,JJ,KK),EB)
   ...
   CASE(513)  ! DHDX
      GAS_PHASE_OUTPUT_RES = RDXN(II)*(H(II+1,JJ,KK)-H(II,JJ,KK))
   CASE(514)  ! DHDY
      GAS_PHASE_OUTPUT_RES = RDYN(JJ)*(H(II,JJ+1,KK)-H(II,JJ,KK))
   CASE(515)  ! DHDZ
      GAS_PHASE_OUTPUT_RES = RDZN(KK)*(H(II,JJ,KK+1)-H(II,JJ,KK))
