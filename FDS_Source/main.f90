...
ARR(1:3) = (/ 1, 2, 3 /)
write(*,*) 'Shift=',0,", ARR(SHFT)=",ARR
DO SHFT=1,2
ARR(1:3)=CSHIFT(ARR,1)
...
OTHER_MESH_LOOP: DO NOM=1,NMESHES
   ...
   ! is not connected at the external boundary of mesh NM. The variable CONNECTED_MESHES is needed to save this information.
