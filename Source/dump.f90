...
QQ_TOA=REAL(1.E10,FB)

! Average (mask out points where no fire arrival detected)
DO J=J1,J2
   DO I=I1,I2
      TOA_SUM=SUM(TOA(I:I+1,J:J+1), MASK=TOA(I:I+1,J:J+1)<1.E10)
      TOA_COUNT=REAL(COUNT(TOA(I:I+1,J:J+1)<1.E10),FB)
...
SLICE_MAX = MAXVAL(QQ_TOA,MASK=(QQ_TOA<1.E10))
