...
IF (MY_RANK==0) ALLOCATE(EMPTY_UNIQUE_SLICE(MESHES(1)%N_UNIQUE_SLCF),ALL_SLICE_QUANTITIES(MESHES(1)%N_SLCF_O*3))
...
IF (MESHES(1)%N_UNIQUE_SLCF>0) THEN
   ...
   ENDDO
ENDIF
IF (MY_RANK==0) DEALLOCATE(EMPTY_UNIQUE_SLICE,ALL_SLICE_QUANTITIES)
