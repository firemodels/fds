...
REAL(EB) :: RE,U2,V2,W2,H_NATURAL,H_FORCED,NUSSELT,ZZ_GET(0:N_TRACKED_SPECIES),CP,VELCON,FRICTION_VELOCITY,YPLUS,MU_DNS,KW
...
HTC_MODEL_SELECT: SELECT CASE(HT_MODEL)
   CASE(LOGLAW)
      ...
      H_NATURAL = 0._EB
      CALL HEAT_FLUX_MODEL(H_FORCED,YPLUS,FRICTION_VELOCITY,KW,RHOP(IIG,JJG,KKG),CP,MU_DNS)
   CASE DEFAULT
