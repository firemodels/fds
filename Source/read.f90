...
SELECT CASE(N)
   ...
   CASE(3)
      ...
      RN%NU_N2           = 0.5_EB*REACTION(1)%N - 0.5_EB*RN%NU_HCN
   ...
   CASE(4)
      ...
      RN%NU_CO           = (REACTION(1)%C-RN%NU_HCN)*FUEL_C_TO_CO_FRACTION
      IF (ABS(RN%NU_CO)<TWO_EPSILON_EB) RN%NU_CO = 0._EB
      RN%NU_SOOT         = (REACTION(1)%C-RN%NU_HCN)*(1._EB-FUEL_C_TO_CO_FRACTION)/(1._EB-REACTION(1)%SOOT_H_FRACTION)
      IF (ABS(RN%NU_SOOT)<TWO_EPSILON_EB) RN%NU_SOOT = 0._EB
      RN%NU_H2           = (REACTION(1)%H-RN%NU_HCN)*FUEL_H_TO_H2_FRACTION*0.5_EB
      IF (ABS(RN%NU_H2)<TWO_EPSILON_EB) RN%NU_H2 = 0._EB
      RN%NU_H2O          = 0.5_EB*REACTION(1)%H - 0.5_EB*(RN%NU_SOOT*REACTION(1)%SOOT_H_FRACTION+RN%NU_HCN) - RN%NU_H2
      IF (ABS(RN%NU_H2O)<TWO_EPSILON_EB) RN%NU_H2O = 0._EB
