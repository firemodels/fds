...
The surface heat flux predictions are divided into two categories depending on whether the fire is or is not directly impinging on the surface. Figure~\ref{Summary_Surface_Heat_Flux} summarizes the non-impinging heat flux predictions. Figure~\ref{Summary_Impinging_Heat_Flux} summarizes the non-impinging heat flux predictions.
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{SCRIPT_FIGURES/ScatterPlots/FDS_Flame_Impinging_Heat_Flux}
\end{tabular}
\end{center}
