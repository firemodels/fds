   ...
   DO J=1,JBAR
      ILOOP: DO I=1,IBAR
         ...
         IF (CHECK_REALIZABILITY) THEN
            ...
            IF (.NOT.REALIZABLE) CALL SHUTDOWN('ERROR: Unrealizable mass fractions input to COMBUSTION_MODEL')
         ENDIF
         CALL CHECK_REACTION
         ...
         IF (CHECK_REALIZABILITY) THEN
            REALIZABLE=IS_REALIZABLE(ZZ_GET)
            IF (.NOT.REALIZABLE) CALL SHUTDOWN('ERROR: Unrealizable mass fractions after COMBUSTION_MODEL')
         ENDIF
