...
IF (DYNSMAG) THEN
   ...
   M%TURB_WORK20 = 0._EB
   ALLOCATE(M%TURB_WORK21(MAX(NX,NY,NZ)),STAT=IZERO)
   CALL ChkMemErr('INIT_TURB_ARRAYS','TURB_WORK21',IZERO)
   M%TURB_WORK21 = 0._EB
   ALLOCATE(M%TURB_WORK22(MAX(NX,NY,NZ)),STAT=IZERO)
   CALL ChkMemErr('INIT_TURB_ARRAYS','TURB_WORK22',IZERO)
   M%TURB_WORK22 = 0._EB
ENDIF
...
SUBROUTINE RESTRICT_MASS_EMB(NM1,NM2)
IMPLICIT NONE
...
SUBROUTINE RESTRICT_DIV_EMB(NM1,NM2)
IMPLICIT NONE
...
SUBROUTINE MATCH_VELOCITY_EMB(NM1,NM2)
IMPLICIT NONE
...
SUBROUTINE SCALAR_GHOST_EMB(NM1,NM2)
IMPLICIT NONE
