...
to verify that Smokeview is working as expected.  The FDS generated data is presumed
to be correct.  FDS has its own set of verification cases to test the correctness of the data.
The purpose of the cases here is to confirm that the data is drawn correctly.
