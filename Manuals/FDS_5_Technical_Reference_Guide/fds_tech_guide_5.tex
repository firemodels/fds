...
is also true: that species are linear combinations of the mixture fraction variables.  The mass fractions of the species in the mixture, $Y_{\alpha}(Z_1,Z_2)$,are found via
:   
\begin{eqnarray}  Y_F      &=& Z_1    \\*[.1in]
                  Y_\NTWO  &=& (1 - Z_1 - Z_2) Y_\NTWO^\infty    \\*[.1in]
                           &=& (1 - Z) Y_\NTWO^\infty    \\*[.1in]
                  Y_\OTWO  &=& (1 - Z_1 - Z_2) Y_\OTWO^\infty - W_\OTWO(\frac{Y_\COTWO}{W_\COTWO}+\frac{1}{2} 
(\frac{Y_\CO}{W_\CO}+\frac{Y_{H_2O}}{W_{H_2O}}))   \\*[.1in]
                           &=& (1 - Z) Y_\OTWO^\infty - \frac{W_\OTWO Z_2}{W_\F} (\nu_\COTWO+\frac{1}{2} 
(\nu_\CO+\nu_{H_2O}))   \\*[.1in]
                  Y_\COTWO &=& Z_2 \frac{\nu_\COTWO W_\COTWO}{W_\F} \\*[.1in]
                  Y_{H_2O} &=& Z_2 \frac{\nu_{H_2O} W_{H_2O}}{W_\F} \\*[.1in]
                  Y_\CO    &=& Z_2 \frac{\nu_\CO W_\CO}{W_\F} \\*[.1in]
                  Y_s      &=& Z_2 \frac{\nu_s W_s}{W_\F}
\end{eqnarray}
...
The decomposition of $Z$ into three components is numerically convenient. However, the recovery of the individual species mass fractions requires some care. We desire to allow the user to
specify some amount of CO to survive Reaction 3.  The mass fraction of any species in the mixture, $Y_{\alpha}(Z_1,Z_2,Z_3)$,are still found via
linear combinations of the mixture fraction variables; however, those combinations are somewhat more complex.  In the equations below, 
the subscripted number on the $\nu_{\alpha}$ denotes the reaction number from above:

\begin{eqnarray}  Y_F      &=& Z_1    \\*[.1in]
                  Y_\NTWO  &=& (1 - Z_1 - Z_2 - Z_3) Y_\NTWO^\infty    \\*[.1in]
                           &=& (1 - Z) Y_\NTWO^\infty    \\*[.1in]
                  Y_\OTWO  &=& (1 - Z_1 - Z_2 - Z_3) Y_\OTWO^\infty - W_\OTWO(\frac{Y_\COTWO}{W_\COTWO}+\frac{1}{2} 
(\frac{Y_\CO}{W_\CO}+\frac{Y_{H_2O}}{W_{H_2O}}))   \\*[.1in]
                           &=& (1 - Z) Y_\OTWO^\infty - \frac{W_\OTWO}{W_\F} (Z_3 \nu_{\COTWO , 3}+\frac{1}{2}
((Z_2 \nu_{\CO , 2} + Z_3 \nu_{\CO , 3})+(Z_2 \nu_{H_2O , 2} + Z_3 \nu_{H_2O , 3}))))   \\*[.1in]
                  Y_\COTWO &=& Z_3 \frac{\nu_{\COTWO , 3} W_\COTWO}{W_\F} \\*[.1in]
                  Y_{H_2O} &=& (Z_2 \nu_{H_2O , 2} + Z_3 \nu_{H_2O , 3})\frac{W_{H_2O}}{W_\F} \\*[.1in]
                  Y_\CO    &=& (Z_2 \nu_{\CO , 2} + Z_3 \nu_{\CO , 3}) \frac{W_\CO}{W_\F} \\*[.1in]
                  Y_s      &=& (Z_2 + Z_3) \frac{\nu_s W_s}{W_\F}
\end{eqnarray}

As with the single step with extinction formulation, note that the definitions of $Z_1$, $Z_2$, and $Z_3$, unlike the single parameter model,
do not imply anything regarding the rate of combustion, only that the combustion occurs in two steps.
